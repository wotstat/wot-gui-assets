  ...
  var __webpack_modules__ = {
      ...
      654: (e, u, t) => {
                      ...
                      m = e({
                        ...
                        observableModel: {
                          ...
                          primitives: (e, u) => {
                            const r = l(u);
                            if (Array.isArray(e)) {
                              const n = e.reduce((e, u) => ((e[u] = J.LO.box(r[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, J.aD)((u) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                s = a.reduce((e, [u, t]) => ((e[t] = J.LO.box(r[u], {})), e), {});
                              return (
                                "real" === t &&
                                  o.subscribe(
                                    (0, J.aD)((e) => {
        ...
        const Te = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          return n || o
            ? s().createElement(pe, Se({}, u, { contentId: n || o }), r)
        ...
        const Lu = (0, a.memo)(
          ...
          Iu = (0, a.memo)(
            ({
              ...
              return s().createElement(
                "div",
                { className: B()(ou.base, ou[`base__${t}`]), style: ku(u) },
          ...
          zt = ({
            ...
            return (l = {}) => {
              ...
              return (0, a.useMemo)(
                ...
                [F.scrollPosition, C, B, v, _.off, _.on, b, h, D, d.step.clampedArrowStepTimeout],
              );
            };
          },
          Gt = zt({
            ...
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Yt, onDrag: r = Xt }) => {
              ...
              return s().createElement(
                ...
                s().createElement("div", {
                  ...
                  onMouseDown: (e) => {
                    e.target.classList.contains(qt) || 0 !== e.button || (H("play"), p(Ut.Next));
                  },
                  onMouseUp: C,
                  ref: o,
                  onMouseEnter: h,
                ...
                s().createElement("div", {
                  ...
                  onMouseDown: (e) => {
                    e.target.classList.contains(qt) || 0 !== e.button || (H("play"), p(Ut.Prev));
                  },
                  onMouseUp: C,
                  ref: i,
                  onMouseEnter: h,
        ...
        const hr = (0, Y.Pi)(({ isCompleted: e, isActive: u, rewards: t }) => {
            const r = Ge(t),
              n = r.parsedRewards,
              a = r.imageSize,
              o = B()(
        ...
        const kr = (e, u) => ("number" == typeof u ? u : e.offsetLeft),
          Nr = (e) => {
            let u = e.api,
              t = e.value,
              r = e.maxValue,
        ...
        const Ur = (0, Y.Pi)(({ api: e }) => {
            ...
            return (
              ...
              (0, a.useEffect)(() => gu(() => w(p.goal), 0), [E, p.goal, w]),
              s().createElement(
                "div",
                {
                  className: B()(
