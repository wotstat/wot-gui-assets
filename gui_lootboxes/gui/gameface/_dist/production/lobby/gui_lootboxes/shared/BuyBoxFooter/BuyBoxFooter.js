(() => {
      ...
      8055: (u, e, t) => {
            ...
            const g = (0, n.useRef)({
              ...
              y = (0, n.useCallback)(() => {
                (g.current.isVisible && g.current.timeoutId) ||
                  (D(t, c, { isMouseEvent: !0, on: !0, arguments: a(A) }, f),
                  b && b(),
                    ...
                    Object.assign(
                      {
                        ...
                        onClick: ((u) => (e) => {
                          (!1 === _ && O(), null == i || i(e), null == u || u(e));
                        })(e.props.onClick),
                        onMouseDown: ((u) => (e) => {
                          (!1 === _ && O(), null == o || o(e), null == u || u(e));
                        })(e.props.onMouseDown),
                      },
                      p,
                    ),
        ...
        const l = R.views.common.tooltip_window.simple_tooltip_content,
          c = (u) => {
            ...
            const s = (0, n.useMemo)(() => {
              const u = Object.assign({}, i, { body: t, header: F, note: E, alert: o });
          ...
          const c = (0, n.useRef)(null),
            ...
            U = E()(
              ...
              h[`base__${F}`],
              {
                ...
                [h[`base__${e}`]]: e,
                [h.base__focus]: v,
                [h.base__highlightActive]: g,
                [h.base__firstHover]: O,
              },
              i,
            ),
            H = E()(h.state, h.state__default);
          return (
            (0, n.useEffect)(
              () => (
        ...
        ((0, n.memo)(({ onMouseEnter: u, onClick: e, onMouseLeave: t, disabled: n }) => {
          const F = A().createElement(
            ...
            R.strings.gui_lootboxes.footer.button.buy(),
          );
          return n
            ? A().createElement(
                c,
                { body: R.strings.gui_lootboxes.storageScreen.tooltip.offBoxes.content() },
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8055));
