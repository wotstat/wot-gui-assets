  ...
  var u,
    e = {
      ...
      1459: (u, e, t) => {
        ...
        const au = V.client.getSize("rem"),
          nu = au.width,
          Bu = au.height,
          iu = Object.assign({ width: nu, height: Bu }, Du(nu, Bu, Fu)),
          Cu = (0, U.createContext)(iu),
          lu = ["children"],
          ou = (u) => {
            let e = u.children,
              t = (function (u, e) {
        ...
        const bu = {
          ...
          Lu = xu((u) => {
            let e = u.className,
              ...
              R = u.shrink,
              H = u.flex,
              T = void 0 === H ? (y || R ? `${y ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : H,
              O = u.style,
              P = u.children,
              W = (function (u, e) {
                if (null == u) return {};
            ...
            const N = (0, U.useMemo)(() => {
              ...
              }, [t, A, r, n, i, l, O, T, w, d, M, p, b]),
              G = N.computedStyle,
              I = N.computedClassNames;
            return Y().createElement(
              "div",
              vu({ className: a()(fu.base, ...I, e), style: G }, W),
              P,
            );
          });
        let Mu;
        ...
        const yu = (u, e, t) => {
          ...
          Hu = (u, e, t = Mu.left) => u.split(e).reduce(t === Mu.left ? yu : Ru, []),
          Tu = (() => {
            const u = new RegExp(
                  ...
                  e.split("\n").map((e, E) =>
                    Y().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        Y().createElement(U.Fragment, { key: `${e}-${u}` }, u),
                      ),
                    ),
                  ),
                );
              ...
              ju(
                {
                  ...
                  style: g,
                  mt: !0 === D ? Ku[t || "paragraph-P16"].mt : D,
                  mr: !0 === B ? Ku[t || "paragraph-P16"].mr : B,
                  mb: !0 === C ? Ku[t || "paragraph-P16"].mb : C,
                  ml: !0 === o ? Ku[t || "paragraph-P16"].ml : o,
                },
                d,
              ),
        ...
        const Ju = (u) => (0 === u ? window : window.subViews.get(u)),
          ...
          Ae = {
            base: "Header_base_7c",
            headerName: "Header_headerName_89",
            headerDescription: "Header_headerDescription_62",
            boxIcon: "Header_boxIcon_a2",
            boxIcon__tier1: "Header_boxIcon__tier1_09",
            boxIcon__tier2: "Header_boxIcon__tier2_f4",
            boxIcon__tier3: "Header_boxIcon__tier3_48",
            boxIcon__tier4: "Header_boxIcon__tier4_3e",
            infoBoxes: "Header_infoBoxes_13",
            headerDescriptionDivider: "Header_headerDescriptionDivider_d8",
          },
          Ee = R.strings.gui_lootboxes,
          Fe = R.strings.lootboxes,
          re = Y().memo(({ userNameKey: u, tier: e, count: t }) =>
            Y().createElement(
              "div",
              { className: Ae.base },
              Y().createElement(Uu, {
                text: Fe.userName.$dyn(u).replace("\n", " "),
                format: { classMix: Ae.headerName },
              }),
              Y().createElement(
                "div",
                { className: Ae.headerDescription },
                Y().createElement("div", { className: a()(Ae.boxIcon, Ae[`boxIcon__tier${e}`]) }),
                Y().createElement(Uu, {
                  text: Ee.tier.$dyn(`tier_${e}`),
                  format: { classMix: Ae.infoBoxes },
                }),
                t >= 0 &&
                  Y().createElement(
                    Y().Fragment,
                    null,
                    Y().createElement("div", { className: Ae.headerDescriptionDivider }),
                    Y().createElement(Uu, {
                      text: Ee.optional.count(),
                      format: { binding: { count: t }, classMix: Ae.infoBoxes },
                    }),
                  ),
              ),
            ),
          ...
          ae = (0, Yu.observer)(() => {
            ...
            return Y().createElement(
              ...
              Y().createElement(
                "div",
                { className: "App_headerWrapper_0b" },
                Y().createElement(re, { userNameKey: E, tier: A, count: t, descriptionKey: e }),
              ),
              Y().createElement(Uu, {
                text: De.desctiptions.$dyn(e),
                format: { classMix: "App_description_4f" },
              }),
            );
          });
        engine.whenReady.then(() => {
          eu().render(
            Y().createElement(ee, null, Y().createElement(J, null, Y().createElement(ae, null))),
