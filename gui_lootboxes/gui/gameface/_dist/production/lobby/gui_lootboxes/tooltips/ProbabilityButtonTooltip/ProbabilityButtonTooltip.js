(() => {
  var u,
    e = {
      ...
      243: (u, e, A) => {
        "use strict";
        var F = {};
        (A.r(F), A.d(F, { mouse: () => l, onResize: () => n }));
        var t = {};
        (A.r(t),
          A.d(t, {
            events: () => F,
        ...
        var E = {};
        (A.r(E), A.d(E, { getBgUrl: () => g, getTextureUrl: () => d }));
        var D = {};
        (A.r(D),
          A.d(D, {
            addModelObserver: () => S,
        ...
        const J = Y().forwardRef(function (u, e) {
          ...
          return (
            ...
            Y().createElement(
              "div",
              Z({}, D, {
                className: a()(q.base, q[`base__theme-${E}`], F),
                ref: function (u) {
        ...
        const Fu = (u, e, A) => {
          ...
          Eu = (u, e, A = Au.left) => u.split(e).reduce(A === Au.left ? Fu : tu, []),
          Du = (() => {
            const u = new RegExp(
          ...
          au = ({ binding: u, text: e = "", classMix: A, alignment: F = Au.left }) =>
            null === e
              ...
              : Y().createElement(
                  ...
                  e.split("\n").map((e, t) =>
                    Y().createElement(
                      "div",
                      { className: a()("FormatText_base_d0", A), key: `${e}-${t}` },
                      ((u, e, A) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                          A && u in A
                            ? A[u]
          ...
          nu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          Cu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          lu = (0, K.memo)(({ text: u, binding: e, classMix: A }) => {
            const F = (0, K.useCallback)((u) => ({ color: `#${u}` }), []),
              t = (0, K.useMemo)(() => e || {}, [e]);
            let E = iu.exec(u),
              D = u,
              r = 0;
                ...
                ((D = D.replace(A, `%(${E})`)),
                  (t[E] = Bu[u]
                    ? Y().createElement(
                        "span",
                        { className: Bu[u] },
                        Y().createElement(au, { text: i, binding: e }),
                      )
                    : Y().createElement(
                        "span",
                        { style: F(u) },
            ...
            return Y().createElement(au, { text: D, classMix: A, binding: t });
          });
        var ou = A(9887),
          mu = A.n(ou);
        const su = (u, e, A) =>
        ...
        const cu = $.client.getSize("rem"),
          hu = cu.width,
          xu = cu.height,
          pu = Object.assign({ width: hu, height: xu }, _u(hu, xu, du)),
          fu = (0, K.createContext)(pu),
          vu = ["children"],
          wu = (u) => {
            let e = u.children,
              A = (function (u, e) {
            ...
            const F = (0, K.useContext)(fu),
              ...
              _ = { extraLarge: o, large: m, medium: s, small: d, extraSmall: g };
            if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
              ...
              if (A.extraLargeWidth && B) return su(e, A, _);
              if (A.largeWidth && i) return su(e, A, _);
              if (A.mediumWidth && n) return su(e, A, _);
              if (A.smallWidth && C) return su(e, A, _);
              if (A.extraSmallWidth && l) return su(e, A, _);
              if (!(
                A.extraLargeWidth ||
                A.largeWidth ||
                A.mediumWidth ||
        ...
        let Su, bu, Tu;
        ((0, K.memo)(({ children: u }) => {
          const e = (0, K.useContext)(fu),
            A = (0, K.useState)(e),
            F = A[0],
            t = A[1],
            E = (0, K.useCallback)((u, e) => {
              const A = $.view.pxToRem(u),
                F = $.view.pxToRem(e);
              t(Object.assign({ width: A, height: F }, _u(A, F, du)));
            }, []);
          (((u) => {
          ...
          return Y().createElement(fu.Provider, { value: D }, u);
        }),
          (function (u) {
        ...
        const Lu = ["xl", "lg", "md", "sm", "xs"],
          ...
          Ru = [Su.ExtraLarge, Su.Large, Su.Medium, Su.Small, Su.ExtraSmall],
          Hu = (u, e) =>
            ...
            const A = (
              ...
              (A) => {
                const F = (() => {
                  ...
                  t = (0, K.useMemo)(() => e(A, F), [A, F]);
                return Y().createElement(u, t);
              }
            )(u, e);
            return Y().memo((e) =>
        ...
        const Gu = {
          ...
          ju = yu((u) => {
            let e = u.className,
              ...
              w =
                void 0 === v
                  ? (g ? "flex-start" : _ && "center") || (c && "flex-end") || void 0
                  : v,
              S = u.alignSelf,
              b = u.wrap,
              T = u.flexWrap,
              ...
              R = u.shrink,
              H = u.flex,
              y = void 0 === H ? (M || R ? `${M ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : H,
              O = u.style,
              W = u.children,
              P = (function (u, e) {
                if (null == u) return {};
            ...
            const G = (0, K.useMemo)(() => {
                const u = { mt: D, mr: B, mb: n, ml: l },
                  e = ((u) =>
                    Nu.reduce((e, A) => {
                      const F = u[A];
                      return F && "number" != typeof F ? e.concat(Gu[!0 === F ? "MD" : F][A]) : e;
                    }, []))(u),
                  t = ((u) =>
                    Nu.reduce((e, A) => {
                      const F = u[A];
                      return ("number" == typeof F && (e[Xu[A]] = F + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [A, F, D, B, n, l, O, y, S, d, L, f, w]),
              N = G.computedStyle,
              X = G.computedClassNames;
            return Y().createElement(
              "div",
              Pu({ className: a()(Ou.base, ...X, e), style: N }, P),
              W,
            );
          });
        var zu = A(3532),
          ...
          Ju = yu((u) => {
            ...
            const g = (0, K.useMemo)(() => {
                const u = Zu(t),
                  ...
                  A = u.colorStyle,
                  F = void 0 === A ? {} : A;
                return { computedStyle: Object.assign({}, m, F), colorClassName: e };
              }, [m, t]),
              _ = g.computedStyle,
              c = g.colorClassName;
            return Y().createElement(
              ...
              Uu(
                {
                  className: a()(ku.base, A && ku[A], c, F),
                  style: _,
                  mt: !0 === r ? Qu[A || "paragraph-P16"].mt : r,
                  mr: !0 === i ? Qu[A || "paragraph-P16"].mr : i,
                  mb: !0 === C ? Qu[A || "paragraph-P16"].mb : C,
                  ml: !0 === o ? Qu[A || "paragraph-P16"].ml : o,
                },
                d,
              ),
              void 0 !== s ? Y().createElement(au, Uu({}, s, { text: e })) : e,
            );
          }),
          ue = R.strings.gui_lootboxes.tooltips.probabilityButton,
          ee = () =>
            Y().createElement(
              "div",
              { className: "App_base_92" },
              Y().createElement(Ju, { text: ue.title(), format: { classMix: "App_title_22" } }),
              Y().createElement(
                "div",
                { className: "App_description_ce" },
                Y().createElement(lu, { text: ue.description() }),
              ),
            );
        engine.whenReady.then(() => {
          eu().render(
            Y().createElement(J, null, Y().createElement(ee, null)),
  ...
  function F(u) {
    ...
    var E = (A[u] = { exports: {} });
    return (e[u].call(E.exports, E, E.exports, F), E.exports);
  }
  ((F.m = e),
    (u = []),
    (F.O = (e, A, t, E) => {
      if (!A) {
        ...
        for (i = 0; i < u.length; i++) {
          for (var [A, t, E] = u[i], r = !0, a = 0; a < A.length; a++)
            (!1 & E || D >= E) && Object.keys(F.O).every((u) => F.O[u](A[a]))
              ? A.splice(a--, 1)
              : ((r = !1), E < D && (D = E));
          if (r) {
            u.splice(i--, 1);
    ...
    (F.d = (u, e) => {
      for (var A in e)
        F.o(e, A) && !F.o(u, A) && Object.defineProperty(u, A, { enumerable: !0, get: e[A] });
    }),
    (F.g = (function () {
    ...
    (() => {
      ...
      var e = (e, A) => {
          ...
          for (e && e(A); B < D.length; B++)
            ((E = D[B]), F.o(u, E) && u[E] && u[E][0](), (u[E] = 0));
          return F.O(i);
        },
        A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
    })());
  var t = F.O(void 0, [503], () => F(243));
  t = F.O(t);
})();
