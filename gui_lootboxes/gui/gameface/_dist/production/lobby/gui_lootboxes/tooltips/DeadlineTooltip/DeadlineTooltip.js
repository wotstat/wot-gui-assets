(() => {
  var __webpack_modules__ = {
      ...
      4179: (u, e, t) => {
        "use strict";
        t.d(e, { kH: () => B, Z5: () => a, lf: () => l, cy: () => F, ry: () => d });
        class r {
          constructor() {
            ((this.entries = []),
              (this._listenMouse = !1),
      ...
      9289: (u, e, t) => {
        ...
        const l = (u) => (0 === u ? window : window.subViews.get(u)),
          B = (u) => {
            return null !== u && "object" == typeof u
              ? "CoherentArrayProxy" === u.constructor.name
                ? ((e = u),
                  (t = (u) => ("object" == typeof u ? B(u) : u)),
                  Array.isArray(e) ? e.map(t) : e.map((u, e, r) => t(null == u ? void 0 : u.value)))
                : Array.isArray(u)
                  ? u.map((u) => ("object" == typeof u ? B(u) : u))
                  : Object.fromEntries(
                      Object.entries(u).map(([u, e]) => [u, "object" == typeof e ? B(e) : e]),
                    )
              : u;
            var e, t;
          },
          s = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: e, children: A, mocks: a }) {
                const F = (0, r.useRef)([]),
                  s = (u, e, t) => {
                    var r;
                    const E = (function ({
                        ...
                        return {
                          subscribe: (t, A) => {
                            const F = "string" == typeof A ? `${r}.${A}` : r,
                              n = D.O.view.addModelObserver(F, e, !0);
                      ...
                      _ = (({ observableModel: u }) => {
                        const e = { root: u.object(), lootboxes: u.array("lootboxes") },
                          t = ((r = e.lootboxes.get()), B(r));
                        var r;
                        return Object.assign({}, e, { computes: { lootboxes: t } });
                      })({
                        mode: u,
                        readByPath: a,
                        externalModel: A,
                      ...
                      C = { mode: u, model: _, externalModel: A, cleanup: s };
                    return {
                      model: _,
                  ...
                  m = C[0],
                  c = C[1],
                  d = (0, r.useState)(() => s(u, e, a)),
                  h = d[0],
                  g = d[1];
                return (
                  (0, r.useEffect)(() => {
                    _.current ? g(s(m, e, a)) : (_.current = !0);
                  }, [a, m, e]),
                  (0, r.useEffect)(() => {
                    c(u);
                  }, [u]),
                  (0, r.useEffect)(
                    () => () => {
                      (h.externalModel.dispose(), F.current.forEach((u) => u()));
                    },
                    [h],
                  ),
        ...
        const x = D.O.client.getSize("rem"),
          w = x.width,
          f = x.height,
          T = Object.assign({ width: w, height: f }, b(w, f, p)),
          S = (0, r.createContext)(T),
          M = ["children"],
          O = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.mediumWidth && l) return g(e, t, h);
              if (t.smallWidth && B) return g(e, t, h);
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(S),
            ...
            F = (0, r.useCallback)((u, e) => {
              ...
              a(Object.assign({ width: t, height: r }, b(t, r, p)));
            }, []);
          (((u) => {
          ...
          return E().createElement(S.Provider, { value: n }, u);
        }),
          (function (u) {
        ...
        const H = ["xl", "lg", "md", "sm", "xs"],
          N = (u) => u.includes("_") && ((u) => H.includes(u))(u.split("_").at(-1)),
          k = [L.ExtraLarge, L.Large, L.Medium, L.Small, L.ExtraSmall],
          W = (u, e) =>
        ...
        const K = {
          ...
          V = I((u) => {
            ...
            const I = (0, r.useMemo)(() => {
              ...
              }, [t, A, n, D, l, s, N, H, S, d, L, w, T]),
              V = I.computedStyle,
              z = I.computedClassNames;
            return E().createElement("div", j({ className: c()(U.base, ...z, e), style: V }, W), k);
          });
        let z;
        !(function (u) {
        ...
        const q = (u, e, t) => {
          ...
          Z = (u, e, t = z.left) => u.split(e).reduce(t === z.left ? q : $, []),
          Q = (() => {
            const u = new RegExp(
              ...
              Au(
                {
                  ...
                  style: g,
                  mt: !0 === i ? Du[t || "paragraph-P16"].mt : i,
                  mr: !0 === o ? Du[t || "paragraph-P16"].mr : o,
                  mb: !0 === B ? Du[t || "paragraph-P16"].mb : B,
                  ml: !0 === _ ? Du[t || "paragraph-P16"].ml : _,
                },
                d,
              ),
              void 0 !== m ? E().createElement(uu, Au({}, m, { text: e })) : e,
            );
          });
        let Bu;
        !(function (u) {
        ...
        const _u = (u, e, t) => {
            switch (e) {
              ...
              case Bu.SHORT_DATE_TIME:
                return t
                  ? `${su.Z5.getDateFormat(u, su.kH.SHORT_FORMAT)}, ${su.Z5.getTimeFormat(u, su.lf.SHORT_FORMAT)}`
                  : su.cy.getTimeFormat("%d.%m.%y, %I:%M %p", u, !0);
              case Bu.FULL_DATE:
                return t
              ...
              case Bu.FULL_DATE_TIME:
                return t
                  ? `${su.Z5.getDateFormat(u, su.kH.LONG_FORMAT)}, ${su.Z5.getTimeFormat(u, su.lf.SHORT_FORMAT)}`
                  : su.cy.getTimeFormat("%B %d, %Y, %I:%M %p", u, !0);
              case Bu.MONTH:
              ...
              case Bu.WEEK_DAY_TIME:
                return t
                  ? `${su.cy.getTimeFormat("%A", u, !0)} ${su.Z5.getTimeFormat(u, su.lf.SHORT_FORMAT)}`
                  : su.cy.getTimeFormat("%A, %I:%M %p", u, !0);
              case Bu.YEAR:
          ...
          Cu = R.images.gui_lootboxes.gui.maps.lootboxes.c_48x48,
          mu = R.strings.gui_lootboxes.deadlineTooltip,
          cu = (0, F.observer)(() => {
            const u = C().model.computes.lootboxes;
            return E().createElement(
              "div",
              { className: "App_base_b3" },
              E().createElement(lu, { text: mu.title(), className: "App_title_b6" }),
              E().createElement(
                "div",
                { className: "App_list_d0" },
                u.map((u) =>
                  E().createElement(
                    "div",
                    { className: "App_itemWrapper_75", key: u.id },
                    E().createElement(
                      "div",
                      { className: "App_item_b3" },
                      E().createElement("div", {
                        className: "App_itemIcon_a1",
                        style: { backgroundImage: `url(${Cu.$dyn(u.type)})` },
                      }),
                      E().createElement(
                        "div",
                        { className: "App_itemText_75" },
                        E().createElement(lu, { text: u.name, className: "App_itemTitle_2b" }),
                        E().createElement(lu, {
                          text: u.date ? mu.lootboxStatisticDate() : mu.noDateText(),
                          format: { binding: { date: _u(u.date, Bu.SHORT_DATE, !0) } },
                          className: "App_itemValue_91",
                        }),
                      ),
                    ),
                  ),
              ...
              E().createElement("div", { className: "App_divider_3d" }),
              E().createElement(lu, { text: mu.alert(), className: "App_alertText_0b" }),
            );
          });
        const du = {
        ...
        const pu = E().forwardRef(function (u, e) {
          ...
          return (
            ...
            E().createElement(
              "div",
              gu({}, n, {
                className: c()(du.base, du[`base__theme-${F}`], A),
                ref: function (u) {
        ...
        engine.whenReady.then(() => {
          a().render(
            E().createElement(_, null, E().createElement(pu, null, E().createElement(cu, null))),
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, r) => {
      ...
      r = r || 0;
      for (var n = deferred.length; n > 0 && deferred[n - 1][2] > r; n--)
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9289));
