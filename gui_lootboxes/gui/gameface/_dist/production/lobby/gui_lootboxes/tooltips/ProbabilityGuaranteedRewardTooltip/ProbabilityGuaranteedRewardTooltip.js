  ...
  var u,
    e = {
      ...
      8103: (u, e, t) => {
        ...
        const J = K().forwardRef(function (u, e) {
          let t = u.children,
            A = u.className,
            F = u.theme,
        ...
        const bu = {
          ...
          Lu = xu((u) => {
            ...
            const G = (0, q.useMemo)(() => {
              ...
              }, [t, A, r, n, i, l, O, H, w, d, y, p, b]),
              N = G.computedStyle,
              j = G.computedClassNames;
            return K().createElement(
              "div",
              vu({ className: a()(fu.base, ...j, e), style: N }, W),
              P,
            );
          });
        let yu;
                  ...
                  e.split("\n").map((e, F) =>
                    K().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        K().createElement(q.Fragment, { key: `${e}-${u}` }, u),
                      ),
                    ),
                  ),
                );
          ...
          ue = (u) => {
            return null !== u && "object" == typeof u
              ? "CoherentArrayProxy" === u.constructor.name
                ? ((e = u),
                  (t = (u) => ("object" == typeof u ? ue(u) : u)),
                  Array.isArray(e) ? e.map(t) : e.map((u, e, A) => t(null == u ? void 0 : u.value)))
                : Array.isArray(u)
                  ? u.map((u) => ("object" == typeof u ? ue(u) : u))
                  : Object.fromEntries(
                      Object.entries(u).map(([u, e]) => [u, "object" == typeof e ? ue(e) : e]),
                    )
              : u;
            var e, t;
          };
        ...
        const te = ((u, e) => {
                    ...
                    const E = (function ({
                      ...
                      D =
                        "real" === u
                          ...
                          : Object.assign({}, E, {
                              readByPath:
                                null != (F = null == A ? void 0 : A.getter) ? F : () => {},
                            }),
                      a = (e) =>
                        "mocks" === u ? (null == A ? void 0 : A.getter(e)) : D.readByPath(e),
                      n = (u) => r.current.push(u),
                      B = (({ observableModel: u }) => {
                        const e = { guaranteedFrequencies: u.array("guaranteedFrequencies", []) },
                          t = (0, ee.computedFn)(
                            () => {
                              return ((u = e.guaranteedFrequencies.get()), ue(u));
                              var u;
                            },
                            { equals: Yu },
                          );
                        return Object.assign({}, e, { computes: { getGuaranteedFrequencies: t } });
                      })({
                        mode: u,
                        readByPath: a,
                        externalModel: D,
          ...
          Ae = te[0],
          Fe = te[1],
          Ee = "App_description_71",
          re = R.strings.gui_lootboxes.probabilityGuaranteedRewardTooltip,
          De = (0, Ku.observer)(() => {
            const u = Fe().model.computes.getGuaranteedFrequencies(),
              e = (0, q.useMemo)(
                () =>
                  u.length > 1
                    ? u.map((u, e) =>
            ...
            return K().createElement(
              ...
              K().createElement(qu, { text: re.title(), className: "App_title_1f" }),
              K().createElement(
                "div",
                { className: Ee },
                K().createElement(qu, { text: re.text1() }),
              ),
              K().createElement(
                "div",
                { className: Ee },
                K().createElement(qu, { text: re.text2(), format: { binding: { bonus: e } } }),
              ),
            );
          });
        engine.whenReady.then(() => {
          eu().render(
            K().createElement(Ae, null, K().createElement(J, null, K().createElement(De, null))),
