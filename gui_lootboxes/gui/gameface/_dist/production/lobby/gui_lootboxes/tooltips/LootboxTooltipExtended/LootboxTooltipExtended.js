(() => {
      ...
      2382: (u, e, t) => {
            ...
            const x = (0, r.useRef)({
              ...
              w = (0, r.useCallback)(() => {
                (x.current.isVisible && x.current.timeoutId) ||
                  (p(t, D, { isMouseEvent: !0, on: !0, arguments: g(n) }, S),
                  h && h(),
                        ...
                        onMouseEnter:
                          ...
                          (u) => {
                            (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                              ((x.current.timeoutId = window.setTimeout(w, l ? 100 : 400)),
                              a && a(u),
                              P && P(u));
                          }),
                        onMouseLeave: ((u) => (e) => {
        ...
        const U = ["engravings", "backgrounds"],
          ...
          X = ({
            ...
            const C = ((u) => {
              ...
              p = ((u, e) => {
                ...
                switch (e) {
                  ...
                  case l.CURRENCY:
                  case l.NUMBER:
                    return n().createElement(M, { format: "integral", value: Number(u) });
                  case l.PREMIUM_PLUS: {
                    const e = Number(u);
            ...
            return n().createElement(
              "div",
              { className: B()(W.base, W[`base__${r}`], D), style: o },
              n().createElement(
                O,
                { tooltipArgs: m, className: W.tooltipWrapper },
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(
                    "div",
                    { className: B()(W.image, null == _ ? void 0 : _.image) },
                    C &&
                      n().createElement("div", {
                        className: B()(W.highlight, null == _ ? void 0 : _.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: B()(W.icon, null == _ ? void 0 : _.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    g &&
                      n().createElement("div", {
                        className: B()(W.overlay, null == _ ? void 0 : _.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: d },
                  n().createElement("div", {
                    className: B()(W.timer, null == _ ? void 0 : _.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const Q = Y.O.client.getSize("rem"),
          Z = Q.width,
          J = Q.height,
          uu = Object.assign({ width: Z, height: J }, K(Z, J, V)),
          eu = (0, r.createContext)(uu),
          tu = ["children"],
          ru = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && l) return q(e, t, g);
              if (t.largeWidth && A) return q(e, t, g);
              if (t.mediumWidth && c) return q(e, t, g);
              if (t.smallWidth && F) return q(e, t, g);
              if (t.extraSmallWidth && D) return q(e, t, g);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(eu),
            ...
            s = (0, r.useCallback)((u, e) => {
              ...
              i(Object.assign({ width: t, height: r }, K(t, r, V)));
            }, []);
          (((u) => {
          ...
          return n().createElement(eu.Provider, { value: o }, u);
        }),
          (function (u) {
        ...
        const su = ["xl", "lg", "md", "sm", "xs"],
          ou = (u) => u.includes("_") && ((u) => su.includes(u))(u.split("_").at(-1)),
          Eu = [nu.ExtraLarge, nu.Large, nu.Medium, nu.Small, nu.ExtraSmall],
          lu = (u, e) =>
        ...
        const _u = {
          ...
          du = Au((u) => {
            ...
            const H = (0, r.useMemo)(() => {
              ...
              }, [t, a, o, l, c, D, k, N, R, C, O, S, f]),
              G = H.computedStyle,
              W = H.computedClassNames;
            return n().createElement(
              "div",
              Du({ className: B()(cu.base, ...W, e), style: G }, U),
              I,
            );
          });
        let Cu;
        ...
        const gu = (u, e, t) => {
          ...
          hu = (u, e, t = Cu.left) => u.split(e).reduce(t === Cu.left ? gu : pu, []),
          bu = (() => {
            const u = new RegExp(
          ...
          xu = ({ binding: u, text: e = "", classMix: t, alignment: a = Cu.left }) =>
            null === e
        ...
        const Pu = Object.keys(wu()),
          ...
          ku = Au((u) => {
            ...
            return n().createElement(
              ...
              Tu(
                {
                  className: B()(fu.base, t && fu[t], h, a),
                  style: p,
                  mt: !0 === E ? Lu[t || "paragraph-P16"].mt : E,
                  mr: !0 === A ? Lu[t || "paragraph-P16"].mr : A,
                  mb: !0 === F ? Lu[t || "paragraph-P16"].mb : F,
                  ml: !0 === _ ? Lu[t || "paragraph-P16"].ml : _,
                },
                C,
              ),
              void 0 !== d ? n().createElement(xu, Tu({}, d, { text: e })) : e,
            );
          }),
            ...
            Hu
              ...
              : (function (u) {
                  ...
                  for (let t = Uu.length - 1; t >= 0; t--)
                    for (; u >= Uu[t];) ((e += Iu[t]), (u -= Uu[t]));
                  return e;
                })(u);
        var Wu = t(3282);
        (s.Vehicles, s.TmanToken, s.CollectionItem);
        const Xu = (u, e = E.Small) => {
          const t = (u.vehicleName || "").replace(/-/g, "_");
          if (u.name === s.Vehicles)
            switch (e) {
              case E.Mini:
              case E.Small:
              case E.S48x48:
          ...
          return (
            u.name === s.DogTagType && e === E.S180x135 && (e = E.S232x174),
            ((u, e = E.Small) => {
              const t = u.name,
                r = u.type,
                n = u.value,
        ...
        const Ku = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: a, children: i, mocks: s }) {
                      ...
                      l = (({ observableModel: u }) => {
                        const e = {
                          ...
                          t = (0, zu.computedFn)(() =>
                            Vu(e.slots.get(), (u) =>
                              Object.assign({}, u, {
                                bonuses: Vu(u.bonuses, (u) => Object.assign({}, u)),
                              }),
                            ),
                          ),
                          r = (0, zu.computedFn)(() => {
                            ...
                            return Object.assign({}, u, {
                              vehicleNames: Vu(u.vehicleNames, (u) => u),
                            });
                          });
                        return Object.assign({}, e, {
                          computes: { getLootbox: t, getSpecialVehicles: r },
                        });
                      })({
                        mode: u,
                        readByPath: s,
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : s(e),
                              n = ju.observable.box(r, { equals: $u });
                            return (
                              "real" === u &&
                                i.subscribe(
                                  (0, ju.action)((u) => n.set(u)),
                                  e,
                                ),
                              n
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                s = a.reduce(
                                  (u, [e, t]) => ((u[t] = ju.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                ...
                return (
                  (0, r.useEffect)(() => {
                    l.current ? m(E(c, a, s)) : (l.current = !0);
                  }, [s, c, a]),
                  (0, r.useEffect)(() => {
                    F(u);
                  }, [u]),
          ...
          Qu = Ku[0],
          Zu = Ku[1],
          Ju = "App_textHightlight_84",
          ue = "App_probabilityTitleWrapper_7f",
          ee = "App_probabilityTitle_01";
        function te() {
          return (
            (te =
              Object.assign ||
        ...
        const re = R.strings.lootboxes,
          ne = (0, Wu.observer)(() => {
            const u = Zu().model,
              e = u.root.get(),
              t = e.lootboxName,
              r = e.description,
              a = e.rotationsToGuaranteedVehicle,
              i = u.computes.getSpecialVehicles(),
              s = i.vehicleNames,
              A = i.minLevel,
              c = i.maxLevel,
              F = i.garant,
              D = i.probability,
              _ = u.computes.getLootbox(),
              m = c === A ? Gu(A) : `${Gu(A)}-${Gu(c)}`,
              d = {
                level: n().createElement(ku, { text: m, className: "App_hightlight_77" }),
                probability: n().createElement(ku, { text: `${D}%`, className: Ju }),
                containersCount: n().createElement(ku, {
                  text: re.lootboxExtendedTooltip.containersCount(),
                  className: Ju,
                  format: { binding: { count: F } },
                }),
              };
            return n().createElement(
              "div",
              { className: "App_base_4a" },
              n().createElement(ku, { text: re.userName.$dyn(t), className: "App_title_7b" }),
              r && n().createElement(ku, { text: r, className: "App_description_89" }),
              n().createElement(ku, {
                text: re.lootboxTooltip.slotTitle(),
                className: "App_slotTitle_d6",
              }),
              n().createElement(
                "div",
                { className: ue },
                n().createElement(ku, {
                  text: re.lootboxExtendedTooltip.specialSlot(),
                  format: { binding: d, classMix: ee },
                }),
              ),
              n().createElement(
                "div",
                { className: "App_specialSlotWrapper_fc" },
                n().createElement("div", { className: "App_vehicleImg_18" }),
                n().createElement(ku, { text: s.join(", "), className: "App_vehicleNames_64" }),
              ),
              n().createElement(
                "div",
                { className: "App_counter_17" },
                n().createElement("div", { className: "App_counterBg_32" }),
                n().createElement(ku, { text: String(a), className: "App_guaranteedNumber_af" }),
                n().createElement(ku, {
                  text: re.lootboxTooltip.guaranteedCounter(a),
                  className: "App_counterDescription_75",
                }),
              ),
              _.map(({ description: u, bonuses: e, probability: t }, r) => {
                const a = (
                  (i = e).length > 0 && i[0].name === o.Customizations
                    ? Array.from(new Map(i.map((u) => [u.value, u])).values())
                    : i
                ).map((u) => {
                  return {
                    name: u.name,
                ...
                var i;
                const s = r === _.length - 1;
                return n().createElement(
                  n().Fragment,
                  null,
                  n().createElement("div", { className: "App_separator_a1" }),
                  n().createElement(
                    "div",
                    { key: r, className: "App_row_2e" },
                    n().createElement(
                      "div",
                      { className: ue },
                      n().createElement(ku, { text: u, className: ee }),
                      n().createElement(ku, {
                        text: R.strings.cosmicEvent.cosmicLootboxTooltipExtended.percentage(),
                        format: { binding: { percent: t } },
                        className: "App_probabilityValue_4e",
                      }),
                    ),
                    n().createElement(
                      "div",
                      { className: B()("App_rewardsWrapper_a6", s && "App_lastElementWrapper_68") },
                      a.map((u, e) => {
                        const t = e === a.length - 1;
                        return n().createElement(
                          "div",
                          { className: "App_rewardItemWrapper_76", key: e },
                          t && !s && n().createElement("div", { className: "App_rewardGlow_a1" }),
                          n().createElement(
                            X,
                            te({ size: E.Small, className: "App_reward_1e" }, u),
                          ),
                        );
                      }),
                      s &&
                        n().createElement(ku, {
                          text: re.lootboxExtendedTooltip.rewardExtraText(),
                          className: "App_rewardsExtraText_35",
                        }),
                    ),
                  ),
                );
        ...
        const oe = n().forwardRef(function (u, e) {
          let t = u.children,
            a = u.className,
            i = u.theme,
          ...
          return (
            ...
            n().createElement(
              "div",
              se({}, o, {
                className: B()(ae.base, ae[`base__theme-${s}`], a),
                ref: function (u) {
                  ((l.current = u), "function" == typeof e ? e(u) : e && (e.current = u));
                },
              }),
              n().createElement("div", { className: ae.decorator }, t),
            )
          );
        });
        engine.whenReady.then(() => {
          i().render(
            n().createElement(Qu, null, n().createElement(oe, null, n().createElement(ne, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2382));
