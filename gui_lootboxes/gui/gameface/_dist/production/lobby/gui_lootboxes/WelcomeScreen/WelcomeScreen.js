(() => {
      ...
      1991: (u, e, t) => {
        ...
        const tu = {
          ...
          nu = Q((u) => {
            ...
            return a().createElement(
              "div",
              eu({ className: d()(J.base, ...U, e), style: G }, I),
              N,
            );
          });
        let Eu;
        ...
        const mu = Object.keys(_u()),
          ...
          xu = (0, r.memo)(({ title: u, description: e, image: t, imageSmall: r }) => {
            ...
            return a().createElement(
              ...
              a().createElement(vu, { text: u, format: { classMix: "ContentItem_title_8b" } }),
              a().createElement(vu, {
                text: e,
                format: { classMix: "ContentItem_description_3d" },
              }),
            );
          });
        function fu() {
          ...
          yu = ({ mainText: u, secondText: e }) =>
            a().createElement(
              ...
              a().createElement(
                ...
                a().createElement(vu, {
                  text: u,
                  format: { classMix: "Header_mainHeaderText_ec" },
                }),
                e &&
                  a().createElement(vu, {
                    text: e,
                    format: { classMix: "Header_secondHeaderText_76" },
                  }),
              ),
            );
        function Hu() {
        ...
        const Nu = (u) => (0 === u ? window : window.subViews.get(u)),
          ...
          Wu = Iu[0],
          Gu = Iu[1],
          Uu = R.strings.gui_lootboxes.welcomeScreen,
          ju = [
            {
              itemKey: 1,
          ...
          Xu = (0, K.observer)(() => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement("div", { className: "App_vignette_b4" }),
                a().createElement(
                  "div",
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1991));
