  ...
  var __webpack_modules__ = {
      ...
      1039: (e, u, t) => {
        ...
        const c = (0, n.memo)(({ children: e }) => {
          ...
          return r().createElement(a.Y.Provider, { value: E }, e);
        });
      },
      6010: (e, u, t) => {
        "use strict";
        ...
        const D = Object.keys(s()),
          ...
          b = (0, d.ZP)((e) => {
            ...
            return E().createElement(
              ...
              void 0 !== f ? E().createElement(a.z, F({}, f, { text: u })) : u,
            );
          });
      },
      2056: (e, u, t) => {
      ...
      1943: (e, u, t) => {
        ...
        const o = ["action", "timeLimit"],
          ...
          d = (e) => {
            ...
            return [(e) => t(e), (e) => m(e), () => o(), (e) => c(e), (e) => d(e)];
          },
          m = (e, u) => {
            const t = d(e),
              a = t[0],
      ...
      3234: (e, u, t) => {
                        ...
                        return {
                          subscribe: (t, o) => {
                            const i = "string" == typeof o ? `${n}.${o}` : n,
                              s = m.O.view.addModelObserver(i, u, !0);
                          ...
                          t = (0, D.computedFn)(
                            (e) => {
                              ...
                              return null ==
                                ...
                                : t.rewards.map((e) => {
                                    var u;
                                    return null != (u = Object.assign({}, e.value)) ? u : [];
                                  });
                            },
                            { equals: c },
                          ),
                                    ...
                                    null == (t = e.rewards)
                                      ...
                                      : t.map((e) =>
                                          Object.assign({}, e.value, {
                                            name:
                                              "premium_plus" === e.value.name
                                                ? "premium_plus_universal"
                                                : e.value.name,
                                            label:
                                              "premium_plus" === e.value.name ||
                                              "premium_plus_universal" === e.value.name
                                                ? "Танковый премиум"
                                                : e.value.label,
                                          }),
                                        ))
                          ...
                          r = (0, D.computedFn)(
                            (e) =>
                              F(
                                u[e].get(),
                                (e) =>
                                  e.bonusGroup !== g && e.bonusGroup !== B && e.bonusGroup !== C,
                              ).flatMap((e) => {
                                var u;
                                return null != (u = { name: e.bonusGroup, value: e.rewardCount })
                                  ? u
                                  : [];
                              }),
                            { equals: c },
                          ...
                          primitives: (u, t) => {
                            ...
                            }
                            {
                              const r = u,
                                o = Object.entries(r),
                                i = o.reduce(
                                  (e, [u, t]) => ((e[t] = d.observable.box(n[u], {})), e),
                                  {},
                                );
                              return (
                                "real" === e &&
        ...
        const L = ({
          ...
          const F = (0, o.useRef)(null),
            ...
            O = (0, o.useCallback)(
              (e) => {
                r || (null !== l && (0, w.G)(l), m && m(e), t && y(), h(!0));
              },
              [r, l, m, y, t],
            ),
            I = (0, o.useCallback)(
          ...
          (0, o.useEffect)(() => {
            ...
            function n(n) {
              if (n.keyCode === e) {
                ...
                (m.O.view.setEventHandled(), u(n), t && n.stopPropagation());
              }
            }
          }, [u, e, t]);
        }
        ...
        let ae, ie, se, le, ce, de, me, Ee, _e;
        var Ae, Fe, De;
        let Ce;
        ((oe.defaultProps = { format: "integral" }),
          ...
          ((Ae = me || (me = {})).BATTLE_BOOSTER = "battleBooster"),
        ...
        const ye = {
          ...
          We = (0, o.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Oe, onDrag: n = Ie }) => {
              const r = (0, o.useRef)(null),
                ...
                F = () => {
                  ...
                  const o = e.animationScroll.scrollPosition.get(),
                    a = Math.min(1, n / r),
                    d = ve(0, 1, o / (r - n)),
                    m = (u.offsetWidth - He(u, a)) * d;
                  ((t.style.transform = `translateX(${0 | m}px)`),
                    ((e) => {
                      if (i.current && s.current && l.current && c.current) {
                        if (0 === e)
                          return (i.current.classList.add(Pe), void s.current.classList.remove(Pe));
                        if (
                          ((u = l.current),
                          (t = c.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (i.current.classList.remove(Pe), void s.current.classList.add(Pe));
                        var u, t;
                ...
                (0, o.useEffect)(() => {
                  ...
                  const u = (u) => {
                      ...
                      const o = l.current,
                        a = c.current;
                      if (!r || !o || !a) return;
                      const i = u.screenX - E.offset - o.getBoundingClientRect().x,
              ...
              return a().createElement(
                "div",
                {
                  className: S()("HorizontalBar_base_49", u.base),
                  ref: r,
                ...
                a().createElement(
                  ...
                  a().createElement("div", {
                    ref: c,
                    className: S()("HorizontalBar_thumb_fd", u.thumb),
                  }),
          ...
          Ue = ({
            ...
            return a().createElement(
              ...
              a().createElement(
                ...
                a().createElement(Xe, { className: s, api: m, classNames: i }, e),
              ),
        ...
        const ze = Le({
          ...
          Je = (0, o.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Ze, onDrag: n = je }) => {
              const r = (0, o.useRef)(null),
                i = (0, o.useRef)(null),
                s = (0, o.useRef)(null),
                l = (0, o.useRef)(null),
                ...
                D = Se(() => {
                  ...
                  const o = e.animationScroll.scrollPosition.get(),
                    a = Math.min(1, n / r),
                    d = ve(0, 1, o / (r - n)),
                    m = (u.offsetHeight - Ke(u, a)) * d;
                  ((t.style.transform = `translateY(${0 | m}px)`),
                    ((e) => {
                      if (i.current && s.current && l.current && c.current) {
                        if (0 === e)
                          return (i.current.classList.add($e), void s.current.classList.remove($e));
                        if (
                          ((u = l.current),
                          (t = c.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (i.current.classList.remove($e), void s.current.classList.add($e));
                        var u, t;
              ...
              return a().createElement(
                "div",
                {
                  className: S()("VerticalBar_base_f3", u.base),
                  ref: r,
                  onWheel: e.handleMouseWheel,
                },
                a().createElement("div", {
          ...
          eu = ({
            ...
            return a().createElement(
              ...
              a().createElement(
                ...
                a().createElement(uu, { className: i, classNames: s, api: m }, e),
              ),
        ...
        const Au = (e, u = se.Small) => {
          ...
          Su = {
            ...
            otherRewardIcon__accountCustomizations:
              "Content_otherRewardIcon__accountCustomizations_ec",
            ...
            otherRewardIcon__vehicleCustomizations:
              "Content_otherRewardIcon__vehicleCustomizations_e0",
            ...
            otherRewardIcon__lootboxStageRotation:
              "Content_otherRewardIcon__lootboxStageRotation_6d",
          },
                                    ...
                                    a().createElement(
                                      ...
                                      v
                                        ? a().createElement(Du, {
                                            ...
                                            shortVehicleLabel: u.shortVehicleLabel,
                                            isRent:
                                              u.isRent ||
                                              Boolean(u.rentDays) ||
                            ...
                            a().createElement(
                              ...
                              a().createElement(
                                ...
                                u.map((e) => {
                                  var u, n, r, o;
                                  const i =
                                    !t && (null == (u = Bu[e.name]) ? void 0 : u.subtitleDisabled);
                                  return a().createElement(
                                    cu,
                                    {
                                      header: null == (n = Bu[e.name]) ? void 0 : n.title,
                                      body: i
                                        ? null == (r = Bu[e.name])
                                          ? void 0
                                          : r.subtitleDisabled
                                    ...
                                    a().createElement(
                                      "div",
                                      {
                                        ...
                                        onClick: () => {
                                          (w.$.playYes(),
                                            h(e.name === Fu ? "premium" : "currency"));
                                        },
                                        onMouseEnter: b,
                                      },
                                      a().createElement("div", {
                                        className: Su.currencyIcon,
                                        style: { backgroundImage: `url(${Au(e, se.Big)})` },
                                      }),
                                      a().createElement(
                                        "div",
                                        ...
                                        a().createElement(
                                          ...
                                          a().createElement(oe, { value: Number(e.value) }),
                                          e.name === Fu &&
                                            a().createElement(H.ZP, {
                                    ...
                                    a().createElement(
                                      ...
                                      a().createElement(
                                        ...
                                        a().createElement(
                                          ...
                                          a().createElement(oe, { value: e.value }),
                                          a().createElement(H.ZP, {
                                            text: "ед.",
                                            className: Su.text,
                                          }),
        ...
        const Ou = (0, V.observer)(() => {
          const e = v(),
            ...
            E = u.computes.getCurrenciesRewards(p.CurrentRewards),
        ...
        const Xu = {
            [Eu.fd.ExtraSmall]: "",
            [Eu.fd.Small]: Wu().SMALL_WIDTH,
            [Eu.fd.Medium]: `${Wu().SMALL_WIDTH} ${Wu().MEDIUM_WIDTH}`,
            [Eu.fd.Large]: `${Wu().SMALL_WIDTH} ${Wu().MEDIUM_WIDTH} ${Wu().LARGE_WIDTH}`,
            [Eu.fd.ExtraLarge]:
          ...
          zu = {
            ...
            [Eu.Aq.Large]: `${Wu().SMALL_HEIGHT} ${Wu().MEDIUM_HEIGHT} ${Wu().LARGE_HEIGHT}`,
            [Eu.Aq.ExtraLarge]:
          ...
          Vu = {
            ...
            [Eu.cJ.Large]: `${Wu().SMALL} ${Wu().MEDIUM} ${Wu().LARGE}`,
            [Eu.cJ.ExtraLarge]: `${Wu().SMALL} ${Wu().MEDIUM} ${Wu().LARGE} ${Wu().EXTRA_LARGE}`,
          },
          $u = (e) => {
            let u = e.children,
              t = e.className,
      ...
      9918: (e, u, t) => {
        ...
        const m = ({ mixClass: e, soundClick: u = "play", onCloseCallback: t }) => {
