  ...
  var __webpack_modules__ = {
      ...
      3102: (u, e, t) => {
        ...
        const w = {
          ...
          M = (u) => {
            ...
            const a = f(),
              ...
              o = a.mediaHeight,
              l = a.mediaSize;
            return n().createElement("div", y({ className: C()(t, w[i], S[o], T[l]) }, r), e);
          },
          L = ["children"],
          P = (u) => {
            let e = u.children,
                    ...
                    const a = (function ({
                      ...
                      c = (({ observableModel: u }) => {
                        const e = {
                          ...
                          t = (0, bu.computedFn)(() => hu(e.bundles.get(), Du), { equals: Bu }),
                          r = (0, bu.computedFn)(
                            () =>
                              t().map((u) =>
                                Object.assign({}, u, {
                          ...
                          i = (0, bu.computedFn)(() => hu(e.tokenPrice.get().defPrice, Du), {
                            equals: Bu,
                          }),
                          o = (0, bu.computedFn)(() => hu(e.tokenPriceCrystal.get().price, Du), {
                            equals: Bu,
                          }),
                          l = (0, bu.computedFn)(() => hu(e.tokenPriceCrystal.get().defPrice, Du), {
                            equals: Bu,
                          }),
                          s = (0, bu.computedFn)(() => hu(e.tokenPriceCrystal.get().defPrice, Du), {
                            equals: Bu,
                          }),
                          E = (0, bu.computedFn)(
                            () =>
          ...
          Nu = ({
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                { className: E },
                A,
                n().createElement(ku, { value: i, format: r === Pu.gold ? "gold" : "integral" }),
              ),
        ...
        const ae = (u) => (u < 0.5 ? 4 * u * u * u : (u - 1) * (2 * u - 2) * (2 * u - 2) + 1),
          ...
          oe = { config: { duration: 450, easing: ae } },
          ...
          pe = "WHITE_SPANISH",
          he = "CREAM",
          be = n().memo(({ levelCount: u, discountPercent: e, price: t, type: a, discount: i }) => {
            const o = t.price.find((u) => u.name === lu.Gold),
              l = (0, r.useState)(!1),
              s = l[0],
              E = l[1],
              c = (0, ne.useTransition)(s, Object.assign({ key: s }, ie)),
              _ = (0, ne.useTransition)(
                s,
                Object.assign({ key: s }, ie, { enter: { opacity: 1 } }),
              ),
              A = (0, ne.useTransition)(
                s,
                Object.assign({ key: s }, ie, { enter: { opacity: 0.7 } }),
              ),
              F = (0, ne.useTransition)(
                s,
                Object.assign({ key: s }, ie, { enter: { opacity: 0.8 } }),
              ),
              m = (0, ne.useSpring)({ scale: s ? 1.06 : 1, INCREASE_CONFIG: oe }),
              d = (0, ne.useSpring)({
                maskImage: s
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement(re, {
                    ...
                    text: ge.discount(),
                    format: {
                      binding: { discount: n().createElement(re, { text: String(e), color: pe }) },
                    },
                    color: pe,
                  }),
                  B === h.ExtraLarge
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement(Hu, {
                    type: String(null == i ? void 0 : i.name),
                ...
                n().createElement(
                  ...
                  n().createElement(re, {
                    text: ge.buyBundle(),
                    className: "Bundle_buttonText_16",
                  }),
                ),
              ),
            );
        ...
        const Me = R.views.common.tooltip_window.simple_tooltip_content,
          ...
          Ne = n().memo(({ price: u, crystalPrice: e, onBuyTokens: t }) => {
            const a = f().mediaSize,
              ...
              o = i[0],
              l = i[1],
              s = (0, ne.useTransition)(o, Object.assign({ key: o }, ie)),
              E = (0, ne.useSpring)({ scale: o ? 1.06 : 1, INCREASE_CONFIG: oe }),
              c = (0, r.useCallback)(() => {
        ...
        const qe = "Timer_timerText_18",
          ...
          Qe = n().memo(({ endTime: u, currentTime: e }) =>
            n().createElement(
              ...
              n().createElement(re, {
                className: "Timer_availableText_12",
                text: Ve.bundlesAvailable(),
              }),
                      ...
                      ? n().createElement(
                          ...
                          n().createElement(re, {
                            ...
                            format: {
                              binding: {
                                hour: n().createElement(re, { text: String(t.hours), color: Ke }),
                                min: n().createElement(re, { text: String(t.minutes), color: Ke }),
                              },
                            },
                            color: Ke,
                          }),
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement(
                    ...
                    n().createElement(We, { currentLevel: o + 1 }),
                  ),
                  n().createElement(
                    K,
