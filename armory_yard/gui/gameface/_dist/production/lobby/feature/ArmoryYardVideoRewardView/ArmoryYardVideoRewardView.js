(() => {
  var __webpack_modules__ = {
      ...
      4802: (u, e, t) => {
        ...
        const A = i.O.client.getSize("rem"),
          l = A.width,
          F = A.height,
          c = Object.assign({ width: l, height: F }, o(l, F, E)),
        ...
        const L = {
          ...
          M = (u) => {
            ...
            const n = f(),
              ...
              E = n.mediaHeight,
              s = n.mediaSize;
            return a().createElement("div", x({ className: C()(t, L[i], S[E], y[s]) }, r), e);
          },
          T = ["children"],
          O = (u) => {
            let e = u.children,
            ...
            const c = (0, r.useRef)(null),
              ...
              h = (0, r.useMemo)(() => {
                const u = ((u, e, t, r) => {
                  const a = u / e;
                  return t / r > a
                    ? { width: t, height: Math.round(t / a) }
                    : { width: Math.round(r * a), height: r };
                })(n, i, B, m);
              ...
              v = (0, r.useCallback)(() => {
                ...
                u &&
                  (s
                    ? ((u.currentTime = u.duration - o), u.removeEventListener("play", g), u.play())
                    : u.pause());
              }, [g, s, o]);
            return (
              (0, r.useEffect)(() => {
                const u = c.current;
                return (
                  u && (u.addEventListener("play", g), u.addEventListener("ended", v)),
                  () => {
                    u && (u.removeEventListener("play", g), u.removeEventListener("ended", v));
                  }
                );
              }, [v, g]),
              (0, r.useEffect)(() => {
                ...
                u && (E ? u.pause() : u.play());
                const e = setInterval(() => {
                  u && l && l(Math.round(u.currentTime), Math.round(u.duration));
                }, 500);
              ...
              a().createElement(
                ...
                a().createElement("video", {
                  ref: c,
                  src: u,
                  className: C()("Video_video_71", d && "Video_video__visible_2e"),
                  loop: !1,
                  style: h,
                  autoPlay: t,
                  onError: F,
            ...
            return [
              function ({ mode: u = "real", options: n, children: E, mocks: s }) {
                const o = (0, r.useRef)([]),
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : s(e),
                              a = X.observable.box(r, { equals: Y });
                            return (
                              "real" === u &&
                                E.subscribe(
                                  (0, X.action)((u) => a.set(u)),
                                  e,
                                ),
                              a
                            );
                  ...
                  c = F[0],
                  d = F[1],
                  D = (0, r.useState)(() => A(u, n, s)),
                  _ = D[0],
                  B = D[1];
                return (
                  (0, r.useEffect)(() => {
                    l.current ? B(A(c, n, s)) : (l.current = !0);
                  }, [s, c, n]),
                  (0, r.useEffect)(() => {
                    d(u);
                  }, [u]),
        ...
        const iu = ({
          ...
          const _ = (0, r.useRef)(null),
            ...
            p = b[1],
            x = (0, r.useCallback)(() => {
              i || (_.current && (_.current.focus(), h(!0)));
            }, [i]),
            L = (0, r.useCallback)(
              (u) => {
            ...
            k = C()(
              ...
              ru[`base__${n}`],
              {
                ...
                [ru[`base__${e}`]]: e,
                [ru.base__focus]: m,
                [ru.base__highlightActive]: v,
                [ru.base__firstHover]: f,
              },
              E,
            ),
            P = C()(ru.state, ru.state__default);
          return (
            (0, r.useEffect)(
              () => (
        ...
        const Eu = (0, r.memo)(iu),
          ...
          cu = (0, U.observer)(() => {
            const u = eu(),
              ...
              E = r.vehicleType,
              s = r.isElite,
              o = `${((A = E), A.replace(/-/g, "_"))}${s ? "_elite" : ""}`;
            var A;
            const l = R.images.gui.maps.icons.vehicleTypes.big.$dyn(o),
              F = f().mediaSize < v.Medium ? nu.small : nu.medium;
            return a().createElement(
              "div",
              { className: "Footer_base_14" },
              a().createElement(
                "div",
                { className: "Footer_title_88" },
                a().createElement(
                  "span",
                  { className: "Footer_level_4b" },
                  ((c = i),
                  Au
                    ? `${c}`
                    : (function (u) {
                        ...
                        for (let t = ou.length - 1; t >= 0; t--)
                          for (; u >= ou[t];) ((e += su[t]), (u -= ou[t]));
                        return e;
                      })(c)),
                ),
                a().createElement("div", {
                  className: "Footer_type_8c",
              ...
              a().createElement(
                "div",
                { className: "Footer_buttons_ee" },
                a().createElement(
                  Eu,
                  { type: au.primary, size: F, mixClass: lu, onClick: t.showVehicle },
                  Fu.toHangar(),
                ),
                a().createElement(
                  Eu,
                  { type: au.primary, size: F, mixClass: lu, onClick: t.close },
                  Fu.back(),
                ),
              ),
            );
          ...
          du = R.strings.armory_yard.videoRewardView,
          Du = () =>
            a().createElement(
              "div",
              { className: "Header_base_23" },
              a().createElement(
                "span",
                { className: "Header_featureName_cb" },
        ...
        const _u = (0, U.observer)(() => {
          ...
          const m = (0, r.useCallback)(() => {
            e.onError(`R.videos.armory_yard.${E}`);
          }, [e, E]);
          return a().createElement(
            "div",
            ...
            a().createElement(
              "div",
              { className: C()("App_bg_7e", o && "App_bg__visible_4c") },
            ...
            E &&
              a().createElement(q, {
                src: R.videos.armory_yard.$dyn(E),
            ...
            a().createElement(
              "div",
              { className: C()("App_header_89", o && "App_header__visible_7b") },
            ...
            a().createElement(
              "div",
              {
                className: C()(
                  ...
                  o && "App_glowWhiteAnimate1__visible_80",
                ),
              },
            ...
            a().createElement(
              "div",
              { className: C()("App_footer_b0", o && "App_footer__visible_88") },
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4802));
