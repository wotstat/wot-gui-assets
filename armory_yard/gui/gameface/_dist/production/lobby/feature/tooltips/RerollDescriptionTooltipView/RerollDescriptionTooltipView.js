      ...
      8900: (u, e, t) => {
        ...
        const Iu = Object.keys(Gu()),
          ...
          qu = (0, K.memo)(({ text: u, isColored: e = !1 }) =>
            Y().createElement(
              "div",
              { className: n()("ConditionItem_base_af", e && "ConditionItem_base__colored_93") },
              Y().createElement(Ku, {
                text: Yu.conditionListPoint(),
                className: "ConditionItem_conditionListPoint_cb",
              }),
              Y().createElement(Ku, { text: u, className: "ConditionItem_conditionText_ee" }),
            ),
          ),
          Qu = R.strings.armory_yard.tooltip.rerollView.description,
          Zu = ["bodyCondition_1", "bodyCondition_2", "bodyCondition_3"],
          Ju = () =>
            Y().createElement(
              "div",
              { className: "App_base_d3" },
              Y().createElement(Ku, { className: "App_title_f5", text: Qu.header() }),
              Zu.map((u) => Y().createElement(qu, { key: "body_" + u, text: String(Qu.$dyn(u)) })),
            );
        function ue() {
          return !1;
        }
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const F = e,
                                E = Object.entries(F),
                                r = E.reduce(
                                  (u, [e, t]) => ((u[t] = ee.observable.box(A[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
        ...
        (Fe[1],
          engine.whenReady.then(() => {
            eu().render(
              Y().createElement(Ee, null, Y().createElement(J, null, Y().createElement(Ju, null))),
