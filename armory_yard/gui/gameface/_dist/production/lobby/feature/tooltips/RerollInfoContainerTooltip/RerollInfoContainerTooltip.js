    ...
    e = {
      ...
      1713: (u, e, t) => {
        ...
        const Xu = Object.keys(Gu()),
          ...
          Ku = xu((u) => {
            ...
            return Y().createElement(
              ...
              void 0 !== s ? Y().createElement(Pu, Iu({}, s, { text: e })) : e,
            );
          }),
          Yu = R.strings.armory_yard.tooltip.mainView.rerollButton,
          qu = (0, K.memo)(({ text: u, isColored: e = !1 }) =>
            Y().createElement(
              "div",
              { className: n()("ConditionItem_base_85", e && "ConditionItem_base__colored_09") },
              Y().createElement(Ku, {
                text: Yu.conditionListPoint(),
                className: "ConditionItem_conditionListPoint_f6",
              }),
              Y().createElement(Ku, { text: u, className: "ConditionItem_conditionText_96" }),
            ),
          ),
          Qu = R.strings.armory_yard.tooltip.mainView.rerollInfoContainer,
          Zu = R.strings.armory_yard.tooltip.mainView.rerollButton,
          Ju = ["condition_5", "condition_6", "condition_7"],
          ue = (0, K.memo)(() =>
            Y().createElement(
              "div",
              { className: "App_base_66" },
              Y().createElement(Ku, { className: "App_title_a0", text: Qu.title() }),
              Ju.map((u) => Y().createElement(qu, { key: "top_" + u, text: String(Zu.$dyn(u)) })),
            ),
          );
        function ee() {
          return !1;
          ...
          Ee = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: A, children: F, mocks: E }) {
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const F = e,
                                E = Object.entries(F),
                                r = E.reduce(
                                  (u, [e, t]) => ((u[t] = te.observable.box(A[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                ...
                return (
                  (0, K.useEffect)(() => {
                    n.current ? o(D(B, A, E)) : (n.current = !0);
                  }, [E, B, A]),
                  (0, K.useEffect)(() => {
                    i(u);
                  }, [u]),
        ...
        (Ee[1],
          engine.whenReady.then(() => {
            eu().render(
              Y().createElement(re, null, Y().createElement(J, null, Y().createElement(ue, null))),
