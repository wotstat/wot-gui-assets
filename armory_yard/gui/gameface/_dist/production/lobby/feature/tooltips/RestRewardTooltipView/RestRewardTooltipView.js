(() => {
  var __webpack_modules__ = {
      ...
      5865: (u, e, t) => {
        ...
        const l = s().forwardRef(function (u, e) {
          ...
          return (
            ...
            s().createElement(
              "div",
              A({}, D, {
                className: n()(E.base, E[`base__theme-${F}`], r),
                ref: function (u) {
        ...
        const P = ["engravings", "backgrounds"],
          O = ["engraving", "background"],
          M = (u, e = B.Small) => {
            const t = u.name,
              r = u.type,
              n = u.value,
            ...
            const h = (0, i.useRef)({
              ...
              v = (0, i.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (k(t, c, { isMouseEvent: !0, on: !0, arguments: N(r) }, b),
                  C && C(),
        ...
        const $ = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            if (e.header || e.body) return s().createElement(q, e, r);
            const n = e.contentId,
              a = e.args,
              i = null == a ? void 0 : a.contentId;
            return n || i
              ? s().createElement(I, Y({}, e, { contentId: n || i }), r)
              : s().createElement(G, e, r);
          },
          V = {
            base: "Reward_base_ea",
          ...
          z = ({
            ...
            const c = ((u) => {
              ...
              p = ((u, e) => {
                ...
                switch (e) {
                  ...
                  case m.CURRENCY:
                  case m.NUMBER:
                    return s().createElement(v, { format: "integral", value: Number(u) });
                  case m.PREMIUM_PLUS: {
                    const e = Number(u);
            ...
            return s().createElement(
              "div",
              { className: n()(V.base, V[`base__${r}`], A), style: o },
              s().createElement(
                $,
                ...
                s().createElement(
                  ...
                  s().createElement(
                    "div",
                    { className: n()(V.image, null == l ? void 0 : l.image) },
                    c &&
                      s().createElement("div", {
                        className: n()(V.highlight, null == l ? void 0 : l.highlight),
                        style: {
                    ...
                    e &&
                      s().createElement("div", {
                        className: n()(V.icon, null == l ? void 0 : l.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      s().createElement("div", {
                        className: n()(V.overlay, null == l ? void 0 : l.overlay),
                        style: {
              ...
              t &&
                s().createElement(
                  ...
                  { tooltipArgs: D },
                  s().createElement("div", {
                    className: n()(V.timer, null == l ? void 0 : l.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const tu = a.O.client.getSize("rem"),
          ru = tu.width,
          nu = tu.height,
          au = Object.assign({ width: ru, height: nu }, eu(ru, nu, J)),
          iu = (0, i.createContext)(au),
          su = ["children"],
          Eu = (u) => {
            let e = u.children,
              t = (function (u, e) {
        ...
        ((0, i.memo)(({ children: u }) => {
          const e = (0, i.useContext)(iu),
            ...
            E = (0, i.useCallback)((u, e) => {
              ...
              n(Object.assign({ width: t, height: r }, eu(t, r, J)));
            }, []);
          (((u) => {
          ...
          const o = (0, i.useMemo)(() => Object.assign({}, r), [r]);
          return s().createElement(iu.Provider, { value: o }, u);
        }),
          (function (u) {
        ...
        const gu = {
          ...
          bu = Bu((u) => {
            ...
            const H = (0, i.useMemo)(() => {
              ...
              }, [t, r, o, l, D, _, k, N, R, C, O, S, f]),
              G = H.computedStyle,
              W = H.computedClassNames;
            return s().createElement(
              "div",
              Cu({ className: n()(mu.base, ...W, e), style: G }, U),
              I,
            );
          });
        let vu;
        ...
        const wu = (u, e, t) => {
          ...
          xu = (u, e, t = vu.left) => u.split(e).reduce(t === vu.left ? wu : Su, []),
          fu = (() => {
            const u = new RegExp(
          ...
          Tu = ({ binding: u, text: e = "", classMix: t, alignment: r = vu.left }) =>
            null === e
        ...
        const Nu = Object.keys(Ou()),
          ...
          Wu = Bu((u) => {
            ...
            return s().createElement(
              ...
              Lu(
                {
                  className: n()(Mu.base, t && Mu[t], h, r),
                  style: p,
                  mt: !0 === A ? Hu[t || "paragraph-P16"].mt : A,
                  mr: !0 === F ? Hu[t || "paragraph-P16"].mr : F,
                  mb: !0 === c ? Hu[t || "paragraph-P16"].mb : c,
                  ml: !0 === B ? Hu[t || "paragraph-P16"].ml : B,
                },
                C,
              ),
              void 0 !== d ? s().createElement(Tu, Lu({}, d, { text: e })) : e,
            );
          });
        var Xu = t(3282);
        function ju() {
        ...
        const zu = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: r, children: n, mocks: E }) {
                const o = (0, i.useRef)([]),
                  A = (u, t, r) => {
                    var n;
                    const i = (function ({
                      ...
                      l = (({ observableModel: u }) => {
                        const e = { root: u.object(), rewards: u.array("rewards", []) },
                          ...
                          r = (0, Vu.computedFn)(() => t().length, { equals: ju });
                        return Object.assign(
                          { computes: { getRewards: t, getRewardsLength: r } },
                          e,
                        );
                      })({
                        mode: u,
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : E(e),
                              n = qu.observable.box(r, { equals: ju });
                            return (
                              "real" === u &&
                                s.subscribe(
                                  (0, qu.action)((u) => n.set(u)),
                                  e,
                                ),
                              n
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                i = a.reduce(
                                  (u, [e, t]) => ((u[t] = qu.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                  ...
                  D = F[0],
                  c = F[1],
                  _ = (0, i.useState)(() => A(u, r, E)),
                  B = _[0],
                  m = _[1];
                return (
                  (0, i.useEffect)(() => {
                    l.current ? m(A(D, r, E)) : (l.current = !0);
                  }, [E, D, r]),
                  (0, i.useEffect)(() => {
                    c(u);
                  }, [u]),
          ...
          Zu = (0, Xu.observer)(() => {
            const u = Qu().model,
              ...
              t = u.computes.getRewardsLength() > 10;
            return s().createElement(
              "div",
              { className: n()("App_base_91", t && "App_base__wide_75") },
              s().createElement("div", { className: "App_background_2e" }),
              s().createElement(
                "div",
                ...
                s().createElement(
                  ...
                  e.map((u) => {
                    return s().createElement(
                      "div",
                      { className: "App_reward_c2", key: u.index },
                      s().createElement(z, {
                        name: u.name,
                        value: u.value,
                      ...
                      s().createElement(Wu, { className: "App_description_09", text: u.label }),
                    );
                    var e;
                  }),
                ),
        ...
        engine.whenReady.then(() => {
          D().render(
            s().createElement(Ku, null, s().createElement(l, null, s().createElement(Zu, null))),
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, r) => {
      ...
      r = r || 0;
      for (var E = deferred.length; E > 0 && deferred[E - 1][2] > r; E--)
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5865));
