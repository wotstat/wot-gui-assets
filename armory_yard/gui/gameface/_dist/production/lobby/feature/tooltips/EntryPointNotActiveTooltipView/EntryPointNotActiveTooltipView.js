    ...
    e = {
      ...
      2283: (u, e, t) => {
        ...
        const bu = {
          ...
          Lu = xu((u) => {
            ...
            const N = (0, K.useMemo)(() => {
              ...
              }, [t, A, r, n, i, l, O, H, w, d, M, f, b]),
              G = N.computedStyle,
              j = N.computedClassNames;
            return Y().createElement(
              "div",
              vu({ className: a()(pu.base, ...j, e), style: G }, W),
              P,
            );
          });
        let Mu;
        ...
        const Iu = Object.keys(Nu()),
          ...
          Yu = R.strings.armory_yard.entryPoint.widget.tooltips.disabled,
          qu = Y().memo(() =>
            Y().createElement(
              "div",
              { className: "App_base_97" },
              Y().createElement("div", { className: "App_bg_24" }),
              Y().createElement(
                "div",
                { className: "App_content_be" },
                Y().createElement(Ku, { text: Yu.header(), className: "App_header_7d" }),
                Y().createElement(Ku, { text: Yu.body(), className: "App_body_32" }),
                Y().createElement("div", { className: "App_separator_5d" }),
                Y().createElement(
                  "div",
                  { className: "App_warningWrapper_8c" },
                  Y().createElement("div", { className: "App_warningIcon_87" }),
                  Y().createElement(Ku, { text: Yu.warning(), className: "App_warning_db" }),
                ),
              ),
            ),
          );
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const E = e,
                                F = Object.entries(E),
                                r = F.reduce(
                                  (u, [e, t]) => ((u[t] = Zu.observable.box(A[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
        ...
        (ee[1],
          engine.whenReady.then(() => {
            eu().render(
              Y().createElement(te, null, Y().createElement(J, null, Y().createElement(qu, null))),
