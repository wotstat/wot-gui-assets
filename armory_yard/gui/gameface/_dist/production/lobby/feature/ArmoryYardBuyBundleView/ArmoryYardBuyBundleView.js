(() => {
      ...
      4540: (u, e, t) => {
        ...
        const Y = {
          ...
          K = X((u) => {
            ...
            const U = (0, r.useMemo)(() => {
              ...
              }, [t, a, s, E, _, F, I, k, y, B, L, f, S]),
              G = U.computedStyle,
              W = U.computedClassNames;
            return n().createElement("div", q({ className: C()($.base, ...W, e), style: G }, H), N);
          });
        function Q(u) {
        ...
        const su = {
          ...
          lu = ({
            ...
            const E = C()(su.value, su[`value__${r}`], !a && su.value__notEnough),
              c = C()(su.icon, su[`icon__${r}-${t}`]),
              _ = C()(su.stock, o && su.stock__indent, e && su.stock__interactive),
              A = s && i > 0 && "+",
              F = C()(su.base, su[`base__${t}`]);
            return n().createElement(
              ...
              n().createElement(
                ...
                { className: E },
                A,
                n().createElement(ou, { value: i, format: r === nu.gold ? "gold" : "integral" }),
              ),
        ...
        const _u = (u, e, t) => {
          ...
          Fu = (u, e, t = cu.left) => u.split(e).reduce(t === cu.left ? _u : Au, []),
          mu = (() => {
            const u = new RegExp(
          ...
          du = ({ binding: u, text: e = "", classMix: t, alignment: a = cu.left }) =>
            null === e
        ...
        const bu = Object.keys(Cu()),
          ...
          yu = X((u) => {
            ...
            return n().createElement(
              ...
              hu(
                {
                  className: C()(gu.base, t && gu[t], h, a),
                  style: p,
                  mt: !0 === l ? wu[t || "paragraph-P16"].mt : l,
                  mr: !0 === c ? wu[t || "paragraph-P16"].mr : c,
                  mb: !0 === A ? wu[t || "paragraph-P16"].mb : A,
                  ml: !0 === m ? wu[t || "paragraph-P16"].ml : m,
                },
                B,
              ),
              void 0 !== d ? n().createElement(du, hu({}, d, { text: e })) : e,
            );
          }),
          Tu = {
        ...
        class Mu extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              A = C()(Tu.base, Tu[`base__${i}`], Tu[`base__${a}`], null == o ? void 0 : o.base),
              F = C()(Tu.icon, Tu[`icon__${i}`], Tu[`icon__${a}`], null == o ? void 0 : o.icon),
              m = C()(Tu.glow, null == o ? void 0 : o.glow),
              D = C()(Tu.caption, Tu[`caption__${i}`], null == o ? void 0 : o.caption),
              d = C()(Tu.goto, null == o ? void 0 : o.goto);
            return n().createElement(
              "div",
              Lu(
                {
        ...
        function ku(u = Pu.n.NONE, e = Ou, t = !1) {
          (0, r.useEffect)(() => {
            if (u !== Pu.n.NONE)
              return (
        ...
        const Yu = [
            ...
            Nu.Comp7TokenCouponReward,
            Nu.BattleBoosterGift,
            Nu.CosmicLootboxCommon,
            Nu.CosmicLootboxSilver,
            Nu.SelectableBonus,
            Nu.PostStamp,
        ...
        const Zu = ["engravings", "backgrounds"],
          ...
          te = R.images.armory_yard.gui.maps.icons.buy.bundles,
          re = {
            [h.ExtraSmall]: "c_260x260",
            [h.Small]: "c_260x260",
            [h.Medium]: "c_320x320",
            [h.Large]: "c_440x440",
            [h.ExtraLarge]: "c_660x660",
          },
          ne = (u, e) => (te[re[e]].$dyn(u) ? te[re[e]].$dyn(u) : te[re[e]].default());
        function ae() {
          return !1;
        }
        console.log;
        ...
        const _e = ((u, e) => {
                  ...
                  E = (u, t, r) => {
                    ...
                    const a = (function ({
                      ...
                      c = (({ observableModel: u }) => {
                        const e = { root: u.object(), rewards: u.array("rewards") },
                          t = (0, ce.computedFn)(() =>
                            (function (u, e) {
                              ...
                              Ee(e.root.get().price.price, (u) => Object.assign({}, u)),
                              (u) => u.name === Nu.Gold,
                            ),
                          ),
                          r = (0, ce.computedFn)(
                              ...
                              Ee(e.rewards.get(), (u) => {
                                return Object.assign(
                                  ...
                                  Object.assign({}, e, {
                                        ...
                                        switch (t) {
                                          ...
                                          case "dogTagComponents":
                                            return ((u, e, t) => {
                                              const r = Zu[u];
                                              if (r) {
                                                const n = R.images.gui.maps.icons.dogtags
                                                    .$dyn(e)
                                                    .$dyn(r),
                                                  a = n.$dyn(t);
                                                return a ? `${a}` : `${n.$dyn(Ju[u])}`;
                                              }
                                              return (
                                                console.error(
                                    ...
                                    size: Uu.Small,
                                    value: e.name === Nu.Vehicles ? e.label : e.value,
                                    valueType:
                                      ((t = e.name),
                                      Yu.includes(t)
                                        ? Gu.MULTI
                                        : zu.includes(t)
                                          ...
                                          : Vu.includes(t)
                                            ...
                                            : Ku.includes(t)
                                              ...
                                              : Gu.STRING),
                                    tooltipArgs: ue(
                                      { tooltipId: e.tooltipId, tooltipType: Ne },
                        ...
                        return Object.assign({}, e, { computes: { getRewards: r, getPrice: t } });
                      })({
                        mode: u,
                        readByPath: s,
                        externalModel: o,
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                i = a.reduce(
                                  (u, [e, t]) => ((u[t] = ie.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
            ...
            buyBundle: u.createCallbackNoArgs("onBuyBundle"),
          })),
          Ae = _e[0],
          Fe = _e[1],
          me = R.strings.armory_yard.buyBundle,
          De = n().memo(({ startLevel: u, endLevel: e }) =>
            n().createElement(
              K,
              { row: !0, className: "DescriptionLevels_base_a4" },
              n().createElement("div", { className: "DescriptionLevels_startLine_50" }),
              n().createElement("div", { className: "DescriptionLevels_checkIcon_95" }),
              n().createElement(yu, { text: me.description() }),
              n().createElement(yu, {
                className: "DescriptionLevels_descriptionLevels_27",
                text: me.descriptionLevels(),
                format: { binding: { startLevel: u, endLevel: e } },
              }),
              n().createElement("div", { className: "DescriptionLevels_endLine_86" }),
            ),
          ),
          de = [
            "children",
            ...
            const h = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (Ce(t, F, { isMouseEvent: !0, on: !0, arguments: Be(n) }, b),
                  C && C(),
              ...
              f = (0, r.useCallback)((u) => {
                h.current.isVisible &&
                  ...
                  (h.current.hideTimerId = window.setTimeout(() => {
                    ...
                    e && !e.isSameNode(h.current.prevTarget) && x();
                  }, 200)));
              }, []);
            return (
              (0, r.useEffect)(() => {
        ...
        const ye = ({ children: u, tooltipArgs: e, className: t }) => {
            if (!e) return u;
            const r = n().createElement("div", { className: t }, u);
            if (e.header || e.body) return n().createElement(we, e, r);
            const a = e.contentId,
              i = e.args,
              o = null == i ? void 0 : i.contentId;
            return a || o
              ? n().createElement(ge, Se({}, e, { contentId: a || o }), r)
              : n().createElement(be, e, r);
          },
          Te = {
            base: "Reward_base_ea",
          ...
          Re = ({
            ...
            const A = ((u) => {
              ...
              m = ((u, e) => {
                ...
                switch (e) {
                  ...
                  case Gu.CURRENCY:
                  case Gu.NUMBER:
                    return n().createElement(ou, { format: "integral", value: Number(u) });
            ...
            return n().createElement(
              "div",
              { className: C()(Te.base, Te[`base__${r}`], l), style: s },
              n().createElement(
                ye,
                { tooltipArgs: c, className: Te.tooltipWrapper },
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(
                    "div",
                    { className: C()(Te.image, null == E ? void 0 : E.image) },
                    A &&
                      n().createElement("div", {
                        className: C()(Te.highlight, null == E ? void 0 : E.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: C()(Te.icon, null == E ? void 0 : E.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    F &&
                      n().createElement("div", {
                        className: C()(Te.overlay, null == E ? void 0 : E.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: _ },
                  n().createElement("div", {
                    className: C()(Te.timer, null == E ? void 0 : E.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const Me = (u) => Math.sqrt(1 - Math.pow(u - 1, 2)),
          Pe = ({ index: u = 0, delay: e = 0, children: t }) => {
            const r = (0, Le.useSpring)({
              ...
              delay: e + 900 + 200 * u,
              config: { duration: 400, easing: Me },
              onStart: () => {
                Q(R.sounds.gui_random_reward_appear());
              },
            });
            return n().createElement(
              Le.animated.div,
              { className: "AnimatedReward_base_d0", style: r },
              t,
            );
          };
        function Oe() {
        ...
        const ke = n().memo(({ rewards: u, showDelay: e = 0 }) => {
            const t = x().mediaSize < h.Medium ? Uu.Small : Uu.Big;
            return n().createElement(
              "div",
              { className: "RewardList_base_94" },
              u.map((u, r) =>
                n().createElement(
                  Pe,
                  { key: r, index: r, delay: e },
                  n().createElement(
                    Re,
                    Oe({}, u, { image: u.image(t), size: t, className: "RewardList_reward_c7" }),
                  ),
                ),
              ),
            );
          ...
          Ne = "mergedReward",
          He = R.strings.armory_yard.buyBundle,
          Ue = (0, Iu.observer)(() => {
            ...
            const u = Fe(),
              ...
              E = o.type,
              c = o.levelCount,
              _ = t.computes.getRewards(),
              A = t.computes.getPrice();
            !(function ({
              key: u = Pu.n.ESCAPE,
            ...
            const F = (0, r.useCallback)(() => 100, []);
            return n().createElement(
              K,
              { className: "App_base_bd", center: !0 },
              n().createElement(
                K,
                { className: "App_back_9e" },
                n().createElement(Mu, {
                  caption: He.backCaption(),
                  goto: He.backGoto(),
                  onClick: e.back,
                }),
              ),
              n().createElement(
                K,
                { className: "App_content_d3", column: !0, center: !0 },
                n().createElement("div", { className: "App_glow_39" }),
                n().createElement(K, {
                  className: "App_icon_02",
                  style: { backgroundImage: `url(${ne(E, a)})` },
                }),
                n().createElement(yu, { className: "App_subtitle_63", text: He.subtitle() }),
                n().createElement(yu, {
                  className: "App_title_7a",
                  text: He.bundleTitle(c),
                  format: { binding: { levelCount: c } },
                }),
                n().createElement(
                  "div",
                  { className: "App_description_54" },
                  n().createElement(De, { startLevel: s, endLevel: l }),
                ),
                n().createElement(
                  K,
                  { className: "App_rewards_7b", row: !0 },
                  n().createElement(ke, { rewards: _, showDelay: F() }),
                ),
                n().createElement("div", { className: "App_bottomLine_65" }),
              ),
              n().createElement(
                K,
                { className: "App_footer_ba", column: !0, center: !0 },
                n().createElement(
                  K,
                  { className: "App_price_9b" },
                  n().createElement(yu, {
                    text: He.price(),
                    format: {
                      binding: {
                        label: n().createElement(yu, {
                          text: He.priceLabel(),
                          className: "App_priceLabel_fe",
                        }),
                        price: n().createElement(Eu, {
                          isEnough: null == A ? void 0 : A.isEnough,
                          type: null == A ? void 0 : A.name,
                          value: Number(null == A ? void 0 : A.value),
                          size: ru.small,
                        }),
                      },
                    },
                ...
                n().createElement(
                  K,
                  { className: "App_controls_12", row: !0 },
                  n().createElement(
                    tu,
                    { type: J.main, size: uu.medium, onClick: e.buyBundle },
                    n().createElement(yu, { text: He.controlBuy(), className: Ie }),
                  ),
                  n().createElement(
                    tu,
                    { type: J.primary, size: uu.medium, onClick: e.back },
                    n().createElement(yu, { text: He.controlBack(), className: Ie }),
                  ),
                ),
              ),
              n().createElement(
                K,
                { className: "App_alert_2e", row: !0, center: !0 },
                n().createElement("div", { className: "App_lip_6a" }),
                n().createElement("div", { className: "App_alertIcon_70" }),
                n().createElement(yu, { className: "App_alertText_8e", text: He.alert() }),
              ),
            );
          });
        let Ge;
        ...
        const We = {
            ...
            price: {
              priceID: "",
              price: [{ isEnough: !0, value: 1e3, name: "gold" }],
              defPrice: [],
              discount: [],
            },
            levelCount: 0,
        ...
        engine.whenReady.then(() => {
          k().render(
            n().createElement(
              Ae,
              { mocks: Xe, mode: "real" },
              n().createElement(P, null, n().createElement(Ue, null)),
            ),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4540));
