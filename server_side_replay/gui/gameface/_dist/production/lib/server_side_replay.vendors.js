/*! For license information please see server_side_replay.vendors.js.LICENSE.txt */
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
  ["lib/server_side_replay.vendors"],
  {
    311: (e, t, n) => {
      "use strict";
      n.d(t, {
          ...
          const o = { applyAnimatedValues: t, createAnimatedStyle: n, getComponentProps: i },
            s = (e) => {
              ...
              return (
                ((e = r.is.str(e)
                  ? s[e] || (s[e] = b(e, o))
                  : e[m] || (e[m] = b(e, o))).displayName = `Animated(${t})`),
                e
              );
            };
          return (
    ...
    216: (e, t, n) => {
      ...
      class G extends N {
            ...
            actions: {
              pause: () => {
                q(this) ||
                  (F(this, !0),
                  (0, r.bl)(a.pauseQueue),
                  Z(this, "onPause", j(this, z(this, this.animation.to)), this));
              },
              resume: () => {
                q(this) &&
                  (F(this, !1),
                  ...
                  Z(this, "onResume", j(this, z(this, this.animation.to)), this));
              },
        ...
        _merge(e, t, n) {
          ...
          const C = r.is.und(t.reset) ? s && !t.default : !r.is.und(b) && d(t.reset, a),
            ...
            D = !S && (!N || d(u.immediate || t.immediate, a));
          if (B) {
            const e = (0, o.sb)(_);
            if (e !== R.constructor) {
              if (!D)
          ...
          if (!Q) {
            const e = C || (!L(this) && U);
            ((B || e) && ((F = (0, r.Xy)(m(V), I)), (Q = !F)),
              (((0, r.Xy)(l.immediate, D) || D) &&
                (0, r.Xy)(A.decay, T) &&
                (0, r.Xy)(A.velocity, E)) ||
                (Q = !0));
          }
        ...
        _onStart() {
          const e = this.animation;
          e.changed || ((e.changed = !0), Z(this, "onStart", j(this, z(this, e.to)), this));
        }
        _onChange(e, t) {
        ...
        _stop(e, t) {
          if (M(this)) {
            ...
            const i = t ? x(this.get()) : j(this.get(), z(this, null != e ? e : n.to));
            ((0, r.bl)(this._pendingCalls, i),
              n.changed && ((n.changed = !1), Z(this, "onRest", i, this)));
          }
        }
      }
      function z(e, t) {
      ...
      const J = ["onStart", "onRest", "onChange", "onPause", "onResume"];
      function Y(e, t, n) {
      ...
      const ee = ["onStart", "onChange", "onRest"];
      let te = 1;
      class ne {
        constructor(e, t) {
          ((this.id = te++),
      ...
      class ye extends N {
        ...
        _start() {
          this.idle &&
            ...
            r.OH.skipAnimation
              ? (r.Wn.batchedUpdates(() => this.advance()), Oe(this))
              : r.fT.start(this));
        }
        _attach() {
          let e = 1;
    ...
    398: (e, t, n) => {
      ...
      const M = {
        ...
        start(e) {
          L > e.priority ? (I.add(e), i.onStart(q)) : (Q(e), i(G));
        },
        advance: G,
        sort(e) {
    ...
    187: (e, t, n) => {
      ...
      n.d(t, { A: () => r });
      const r =
        "lobby/MetaReplaysView/MetaReplaysView" == n.j
          ? [
    ...
    354: (e, t, n) => {
      "use strict";
      if ((n.d(t, { D4: () => g }), "lobby/MetaReplaysView/MetaReplaysView" == n.j)) var r = n(187);
      const i = {
        "BB2:108120": 1817,
        "BP2:OO": 790,
        "UB3:107": 714,
      ...
      if ("lobby/MetaReplaysView/MetaReplaysView" == n.j) var o = n(657);
      function s(e, t) {
        var n = ("undefined" != typeof Symbol && e[Symbol.iterator]) || e["@@iterator"];
        if (n) return (n = n.call(e)).next.bind(n);
        if (
      ...
      if ("lobby/MetaReplaysView/MetaReplaysView" == n.j) var f = n(422);
      function p(e, t) {
        (null == t || t > e.length) && (t = e.length);
        for (var n = 0, r = Array(t); n < t; n++) r[n] = e[n];
        return r;
    ...
    484: (e, t, n) => {
      ...
      function w(e, t) {
        ...
        return (
          ...
          Object.keys(s).forEach(function (e) {
            U[e] || Object.defineProperty(u, e, Object.getOwnPropertyDescriptor(s, e));
          }),
          (n.displayName = c),
          n
        );
      ...
      var O,
        U = { $$typeof: !0, render: !0, compare: !0, type: !0 };
      ((O = s.unstable_batchedUpdates) ||
        (O = function (e) {
          e();
        }),
    ...
    305: (e, t, n) => {
      ...
      function fe(e, t, n, r) {
        ...
        if (r !== e.target_ && "function" == typeof n.value)
          return w(n.value)
            ...
            : ((null == (s = this.options_) ? void 0 : s.autoBind) ? Pt.bound : Pt).make_(
                e,
                t,
                n,
                r,
      ...
      var ge = ae("observable"),
        ...
        ye = ae("observable.shallow", {
          enhancer: function (e, t, n) {
            return null == e || zn(e) || Pn(e) || Vn(e) || Dn(e)
              ? e
              : Array.isArray(e)
      ...
      var We,
        ...
        Ae = "computed",
        Te = ie(Ae),
        Pe = ie("computed.struct", { equals: z.structural }),
        je = function (e, t) {
        ...
        Me = (function (e) {
          ...
          return (
            ...
            (n.prepareNewValue_ = function (e) {
              if (ln(this)) {
                var t = hn(this, { object: this, type: gn, newValue: e });
            ...
            (n.setNewValue_ = function (e) {
              ...
              ((this.value_ = e),
                this.reportChanged(),
                dn(this) && pn(this, { type: gn, object: this, newValue: e, oldValue: t }));
            }),
            (n.get = function () {
      ...
      var vt = (function () {
          ...
          return (
            ...
            (t.schedule_ = function () {
              this.isScheduled_ || ((this.isScheduled_ = !0), at.pendingReactions.push(this), bt());
            }),
            ...
            (t.dispose = function () {
              this.isDisposed_ ||
                ((this.isDisposed_ = !0), this.isRunning_ || (ht(), Je(this), dt()));
            }),
      ...
      function bt() {
        at.inBatch > 0 || at.isRunningReactions || gt(yt);
      }
      function yt() {
      ...
      (Object.assign(Pt, Bt), (Tt.bound = L(Wt)), (Pt.bound = L(St)));
      var kt = function (e) {
        return e();
      };
      function Et(e) {
      ...
      function nn(e) {
        return (function (e, t) {
          return (
            !!e &&
            (void 0 !== t
              ? !!zn(e) && e[q].values_.has(t)
              : zn(e) || !!e[q] || F(e) || mt(e) || Ge(e))
          );
        })(e);
      }
      function rn(e) {
          ...
          return (
            ...
            (t.set_ = function (e, t) {
              ...
              if (e < n.length) {
                ...
                var i = n[e];
                if (ln(this)) {
                  var o = hn(this, { type: gn, object: this.proxy_, index: e, newValue: t });
                  if (!o) return;
                  t = o.newValue;
                }
        ...
        Cn = (function () {
          ...
          return (
            ...
            (t.set = function (e, t) {
              var n = this.has_(e);
              if (ln(this)) {
                var r = hn(this, { type: n ? gn : xn, object: this, newValue: t, name: e });
                if (!r) return this;
                t = r.newValue;
              }
            ...
            (t.delete = function (e) {
              var t = this;
              if ((this.keysAtom_, ln(this) && !hn(this, { type: kn, object: this, name: e })))
                return !1;
              if (this.has_(e)) {
                var n = dn(this),
                  r = n
      ...
      function ur(e) {
        return Pn(e) ? e.slice() : B(e) || Vn(e) || S(e) || Dn(e) ? Array.from(e.entries()) : e;
      }
      function lr(e) {
