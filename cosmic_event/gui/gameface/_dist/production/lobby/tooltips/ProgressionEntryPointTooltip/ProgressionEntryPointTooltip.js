(() => {
  var __webpack_modules__ = {
      ...
      9992: (u, e, t) => {
        ...
        const D = m.O.client.getSize("rem"),
          B = D.width,
          g = D.height,
          C = Object.assign({ width: B, height: g }, d(B, g, F)),
          p = (0, r.createContext)(C),
          h = ["children"],
          b = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            const n = (0, r.useContext)(p),
              ...
              b = { extraLarge: d, large: D, medium: B, small: g, extraSmall: C };
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(p),
            ...
            i = (0, r.useCallback)((u, e) => {
              ...
              s(Object.assign({ width: t, height: r }, d(t, r, F)));
            }, []);
          (((u) => {
        ...
        const S = ["xl", "lg", "md", "sm", "xs"],
          x = (u) => u.includes("_") && ((u) => S.includes(u))(u.split("_").at(-1)),
        ...
        const k = {
          ...
          U = P((u) => {
            ...
            const z = (0, r.useMemo)(() => {
              ...
              }, [t, a, o, c, m, _, $, W, T, g, P, v, x]),
              Y = z.computedStyle,
              q = z.computedClassNames;
            return n().createElement("div", M({ className: l()(L.base, ...q, e), style: Y }, X), j);
          });
        let H;
        function G(u, e) {
        ...
        const W = (u) => u.replace(/&nbsp;/g, " "),
          ...
          X = (u, e, t = H.left) => u.split(e).reduce(t === H.left ? $ : j, []),
          z = (() => {
            const u = new RegExp(
          ...
          Y = ["zh_cn", "zh_sg", "zh_tw"],
          q = ({ binding: u, text: e = "", classMix: t, alignment: a = H.left }) =>
            null === e
              ...
              : n().createElement(
                  ...
                  e.split("\n").map((e, s) =>
                    n().createElement(
                      "div",
                      { className: l()("FormatText_base_d0", t), key: `${e}-${s}` },
                      ((u, e, t) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                          t && u in t
                            ? t[u]
        ...
        const uu = Object.keys(K()),
          ...
          su = P((u) => {
            ...
            return n().createElement(
              ...
              J(
                {
                  className: l()(Q.base, t && Q[t], h, a),
                  style: p,
                  mt: !0 === E ? nu[t || "paragraph-P16"].mt : E,
                  mr: !0 === A ? nu[t || "paragraph-P16"].mr : A,
                  mb: !0 === F ? nu[t || "paragraph-P16"].mb : F,
                  ml: !0 === d ? nu[t || "paragraph-P16"].ml : d,
                },
                g,
              ),
              void 0 !== B ? n().createElement(q, J({}, B, { text: e })) : e,
            );
          });
        const iu = {
        ...
        const Eu = n().forwardRef(function (u, e) {
          ...
          return (
            ...
            n().createElement(
              "div",
              lu({}, o, {
                className: l()(iu.base, iu[`base__theme-${i}`], a),
                ref: function (u) {
            ...
            const h = (0, r.useRef)({
              ...
              f = (0, r.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (Fu(t, F, { isMouseEvent: !0, on: !0, arguments: mu(n) }, b),
                  g && g(),
        ...
        const fu = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return n().createElement(hu, e, r);
          const a = e.contentId,
            s = e.args,
            i = null == s ? void 0 : s.contentId;
          return a || i
            ? n().createElement(_u, bu({}, e, { contentId: a || i }), r)
        ...
        const Ru = {
            [Tu.NBSP]: Su.NoBreakSymbol,
            [Tu.ZWNBSP]: Su.NoBreakSymbol,
            [Tu.NEW_LINE]: Su.LineBreak,
          },
          yu = {
          ...
          Lu = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return r
              ? yu[r]
                ? n().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, className: yu[r] },
                    u,
                  )
                : n().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: Pu(r) },
                    u,
                  )
          ...
          Ou = {
            [Su.Word]: Lu,
            [Su.NoBreakSymbol]: Lu,
            [Su.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
              n().createElement(
                "span",
            ...
            [Su.LineBreak]: ({ key: u }) =>
              n().createElement("span", {
                key: u,
                "data-block-type": Su.LineBreak,
                className: "renderers_lineBreak_b5",
              }),
            [Su.NewLine]: ({ elementList: u, key: e }) =>
              n().createElement(
                "span",
                { key: e, "data-block-type": Su.NewLine, className: "renderers_newLine_bd" },
                u,
              ),
            [Su.NoBreakWrapper]: ({ elementList: u, key: e }) =>
              n().createElement(
                "span",
                {
                  key: e,
                  "data-block-type": Su.NoBreakWrapper,
              ...
              u.childList.forEach((n, a) => {
                ...
                if (((u) => void 0 !== u.childList)(n)) {
                  const u = n,
                    ...
                    t = Mu(u, Ou[e], s);
                  r.push(...t);
                } else r.push(e({ elementList: [n], textBlock: u, key: s }));
              }),
              r
            );
          },
          ...
          Iu = (u, e = "") => {
            ...
            return (
              ku(
                ...
                /(\n+|[\xa0\ufeff]+)/g,
                (u) => {
                  t.push({ blockType: Su.Word, colorTag: e, childList: Nu(u) });
                },
                (u) => {
                  const r = u[0],
                    n = Ru[r.charAt(0)];
                  n === Su.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: Su.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
          ...
          Hu = (u, e) => {
            ...
            if (u.blockType === Su.NoBreakWrapper) (u.childList.push(r), t.push(u));
            else {
              const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
              (u.childList.length > 0 && t.push(u),
                t.push({ blockType: Su.NoBreakWrapper, colorTag: "", childList: [e, r] }));
            }
          ...
          Xu = (u, e, t, r, a, s) => {
            ...
            for (let l = t; l >= 0; l--) {
              ...
              if (E === Su.LineBreak || E === Su.NewLine || E === Su.Binding) continue;
              ...
              if (!(t.childElementCount > 1)) {
                ...
                const m = c.slice(0, c.length - A) + s,
                  F = e[l];
                ((o = n().cloneElement(F, F.props, m)), (i = l));
                break;
              }
              {
                const u = t.children,
                  E = e[l],
                  A = E.props.children,
                  m = Xu(u, A, u.length - 1, r, a, s),
                  F = m[0],
                  _ = m[1];
                if (!(F < 0)) {
                  const u = A.slice(0, F);
                  ((o = n().cloneElement(E, E.props, u, _)), (i = l));
                  break;
                }
                a -= c.length;
              }
          ...
          zu = n().memo(
            ({
              ...
              targetId: o,
              justifyContent: E = xu.FlexStart,
              alignContent: c = xu.FlexStart,
              truncateIdentify: A = "...",
            }) => {
              const m = (0, r.useRef)(null),
                ...
                p = (0, r.useMemo)(() => ({ justifyContent: E, alignContent: c }), [c, E]);
              return (
                ((u, e, t = !0) => {
                ...
                n().createElement(
                  ...
                  n().createElement("div", { className: "ExtendedText_unTruncated_b8", ref: m }, B),
                  n().createElement(
                    fu,
                    { tooltipArgs: g },
                    n().createElement(
                      ...
                      d.isTruncateFinished && i ? d.elementList : B,
                    ),
                  ),
                )
              );
        ...
        const Ku = ({ size: u = qu.Default, classMix: e }) =>
            n().createElement("div", { className: l()(Yu.background, Yu[`background__${u}`], e) }),
          Qu = {
          ...
          ue = (0, r.memo)(
            ({
              ...
              return n().createElement(
                "div",
                { className: i, style: r, ref: e },
                n().createElement("div", { className: Ju.pattern }),
                n().createElement("div", { className: Ju.gradient }),
                o && n().createElement(Zu, { size: u }),
              );
            },
          ),
        ...
        const ae = (0, r.memo)(
          ...
          Ee = (0, r.memo)(
            ({
              ...
              const h = (0, r.useMemo)(
                  () => Object.assign({ width: "100%" }, le(u), ie(A)),
                  [A, u],
                ),
                b = (0, r.useMemo)(() => Object.assign({ width: "0%" }, le(u), ie(A)), [A, u]),
                f = (0, r.useMemo)(
                  () => Object.assign({ width: "0%" }, oe(A, a), le(u)),
                  [a, A, u],
                ),
                w = (0, r.useMemo)(
                  () => Object.assign({ width: `${Math.abs(i - a)}%` }, oe(A, a), le(u)),
                  [a, A, i, u],
                );
              if (d) return null;
              const v = l()(
        ...
        const Fe = (0, r.memo)((u) => {
            ...
            switch (a.animationSettings.type) {
              case Vu.Simple:
                return n().createElement(se, me({}, a, { onEndAnimation: l, isComplete: i }));
              case Vu.Growing:
                return n().createElement(ce, me({}, a, { onEndAnimation: l, isComplete: i }));
              default:
                return null;
            }
          }),
        ...
        const De = (0, r.memo)((u) => {
          ...
          return (
            (a.current.from = i),
            n().createElement(Fe, de({}, t, { onEndAnimation: s, key: `${i}-${t.to}`, from: i }))
          );
        });
        function Be() {
          return (
        ...
        const ge = (0, r.memo)(
            ({
              ...
              return s.withStack
                ...
                : n().createElement(Fe, Be({ key: `${a}-${e}` }, E));
            },
          ),
          Ce = (u) => ({
          ...
          we = (0, r.memo)(
            ({
              ...
              const d = ((u, e, t) =>
                (0, r.useMemo)(() => {
                  const r = (pe(0, e, u) / e) * 100;
                  return { value: r, deltaFrom: he(r, e, t) };
                }, [t, e, u]))(E, u, c);
              return n().createElement(
                "div",
                { className: l()(Yu.base, Yu[`base__${t}`]), style: Ce(e) },
                !i && n().createElement(Ku, { size: t, classMix: o }),
                n().createElement(ge, {
                  size: t,
                  lineRef: A,
                  disabled: s,
        ...
        let ve, Se, xe, Te, Re, ye, Pe, Le, Oe;
        (!(function (u) {
          ((u.Items = "items"),
        ...
        const ke = [
          ...
          Ne = [ve.Gold, ve.Credits, ve.Crystal, ve.FreeXp],
          Ie = [ve.BattlePassPoints],
          Ue = [ve.PremiumPlus, ve.Premium];
        let He;
        !(function (u) {
          ((u.s16 = "16"),
            (u.s32 = "32"),
        ...
        const Ge = ["engravings", "backgrounds"],
          ...
          $e = (u, e = xe.Small) => {
            ...
            switch (t) {
              ...
              case ve.LbStyleProgress:
                return Xe(a, e, Oe.ProgressionStyle);
              default:
          ...
          Ye = ({
            ...
            return n().createElement(
              "div",
              { className: l()(ze.base, ze[`base__${r}`], E), style: o },
              n().createElement(
                fu,
                { tooltipArgs: A, className: ze.tooltipWrapper },
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(
                    "div",
                    { className: l()(ze.image, null == c ? void 0 : c.image) },
                    F &&
                      n().createElement("div", {
                        className: l()(ze.highlight, null == c ? void 0 : c.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: l()(ze.icon, null == c ? void 0 : c.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      n().createElement("div", {
                        className: l()(ze.overlay, null == c ? void 0 : c.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: m },
                  n().createElement("div", {
                    className: l()(ze.timer, null == c ? void 0 : c.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const Qe = (u) => (0 === u ? window : window.subViews.get(u));
        var Ze = t(6517);
        const Je = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: a, children: s, mocks: i }) {
                const o = (0, r.useRef)([]),
                    ...
                    const a = (function ({
                      ...
                      E = (({ observableModel: u }) => {
                        const e = {
                            ...
                            isLevelUp: u.primitives(["isSomethingHappeningWithArtefact"]),
                            time: u.primitives(["seasonEnd"]),
                            progression: u.primitives([
                              "currentProgressSectionIndex",
                              "isProgressionFinished",
                              "marsPoints",
                              "marsPointsLimit",
                            ]),
                          },
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : i(e),
                              n = Ve.observable.box(r, { equals: qe });
                            return (
                              "real" === u &&
                                s.subscribe(
                                  (0, Ve.action)((u) => n.set(u)),
                                  e,
                                ),
                              n
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const n = e.reduce(
                                (u, e) => ((u[e] = Ve.observable.box(r[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                i = a.reduce(
                                  (u, [e, t]) => ((u[t] = Ve.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      c = { mode: u, model: E, externalModel: s, cleanup: l };
                    return {
                      model: E,
                  ...
                  A = c[0],
                  F = c[1],
                  _ = (0, r.useState)(() => l(u, a, i)),
                  d = _[0],
                  D = _[1];
                return (
                  (0, r.useEffect)(() => {
                    E.current ? D(l(A, a, i)) : (E.current = !0);
                  }, [i, A, a]),
                  (0, r.useEffect)(() => {
                    F(u);
                  }, [u]),
        ...
        let nt;
        var at;
        (((rt = tt || (tt = {})).Hovered = "Hovered"),
          (rt.Active = "Active"),
          (rt.UnFocused = "UnFocused"),
          ((at = nt || (nt = {})).SHORT_DATE = "short-date"),
          ...
          const e =
            u >= 0
              ? (t = (function (u = 0) {
                ...
                ? G(R.strings.common.duration.days(), { days: t.days })
                : t.hours > 0
                  ? G(R.strings.common.duration.hours(), { hours: t.hours })
                  : t.minutes > 0
                    ? G(R.strings.common.duration.minutes(), { minutes: t.minutes })
                    : G(R.strings.common.duration.seconds(), { seconds: t.seconds })
        ...
        const ot = R.strings.cosmicEvent.artefact.tooltip,
          lt = (0, i.observer)(() => {
            const u = et().model,
              e = u.progression,
              t = u.time,
              r = e.currentProgressSectionIndex,
              a = e.marsPoints,
              s = e.marsPointsLimit,
              i = e.isProgressionFinished,
              o = u.computes.getBonuses(),
              l = i.get(),
              E = r + 1,
              c = {
                time: n().createElement(
                  "span",
                  { className: "App_highlight_97" },
                  n().createElement(st, { duration: t.seasonEnd.get() }),
                ),
              },
              A = {
                points: cu.Z5.getNumberFormat(a.get(), cu.B3.GOLD),
                pointsLimit: n().createElement(
                  "span",
                  { className: "App_points_max_57" },
                  cu.Z5.getNumberFormat(s.get(), cu.B3.GOLD),
                ),
              };
            return n().createElement(
              Eu,
              ...
              n().createElement(
                "div",
                { className: "App_base_0e" },
                n().createElement("div", { className: "App_bg_cubes_4f" }),
                n().createElement("div", { className: "App_bg_glow_b6" }),
                n().createElement(su, { className: "App_header_8c", text: ot.title() }),
                n().createElement(q, {
                  classMix: "App_description_f3",
                  text: ot.timeTillEnd(),
                  binding: c,
                }),
                l
                  ? n().createElement(
                      ...
                      null,
                      n().createElement(su, {
                        className: "App_progressionDoneTitle_c4",
                        text: ot.investigationDone(),
                      }),
                      n().createElement("img", {
                        src: R.images.cosmic_event.gui.maps.icons.tooltip.artefact_bg(),
                        className: "App_artefactImg_0d",
                        alt: "",
                      }),
                      n().createElement(su, {
                        className: "App_progressionDoneDesc_a4",
                        text: ot.investigationDesc(),
                      }),
                    )
                  : n().createElement(
                      n().Fragment,
                      null,
                      n().createElement(su, { className: "App_currentLevel_3d", text: String(E) }),
                      n().createElement(su, {
                        className: "App_currentStep_bf",
                        text: ot.currentStep(),
                      }),
                      n().createElement(
                        "div",
                        { className: "App_progressBarContainer_20" },
                        n().createElement(we, { value: a.get(), maxValue: s.get() }),
                      ),
                      n().createElement(
                        "div",
                        { className: "App_pointsContainer_b0" },
                        n().createElement(zu, {
                          classMix: "App_points_c0",
                          text: R.strings.cosmicEvent.artefact.points(),
                          binding: A,
                        }),
                        n().createElement("img", {
                          src: R.images.cosmic_event.gui.maps.icons.event_icon.c_14x14(),
                          className: "App_icon_d6",
                        }),
                      ),
                      n().createElement(
                        "div",
                        { className: "App_rewardsContainer_1d" },
                        n().createElement(su, {
                          className: "App_rewardTitle_4a",
                          text: ot.currentRewards(),
                        }),
                        n().createElement(
                          "div",
                          { className: "App_rewards_c1" },
                          ((m = o),
                          m.map((u) => {
                            return {
                              name: u.name,
                            ...
                            n().createElement(Ye, it({ key: e, className: "App_reward_de" }, u)),
                          ),
                        ),
                      ),
                    ),
        ...
        engine.whenReady.then(() => {
          s().render(
            n().createElement(ut, null, n().createElement(lt, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9992));
