  ...
  var u,
    e = {
      ...
      1619: (u, e, A) => {
        ...
        const s = C.O.client.getSize("rem"),
          d = s.width,
          g = s.height,
          c = Object.assign({ width: d, height: g }, o(d, g, l)),
          _ = (0, E.createContext)(c),
          h = ["children"],
          x = (u) => {
            let e = u.children,
              A = (function (u, e) {
            ...
            const F = (0, E.useContext)(_),
              ...
              g = F.mediumHeight,
              c = F.smallHeight,
              x = F.extraSmallHeight,
              p = { extraLarge: s, large: d, medium: g, small: c, extraSmall: x };
            if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
              if (A.extraLarge && t) return e;
              if (A.large && D) return e;
              if (A.medium && r) return e;
              if (A.small && B) return e;
              if (A.extraSmall && a) return e;
            } else {
              if (A.extraLargeWidth && i) return n(e, A, p);
              if (A.largeWidth && C) return n(e, A, p);
              if (A.mediumWidth && l) return n(e, A, p);
              if (A.smallWidth && m) return n(e, A, p);
              if (A.extraSmallWidth && o) return n(e, A, p);
              if (!(
                A.extraLargeWidth ||
                A.largeWidth ||
                A.mediumWidth ||
        ...
        ((0, E.memo)(({ children: u }) => {
          const e = (0, E.useContext)(_),
            ...
            t = A[0],
            D = A[1],
            r = (0, E.useCallback)((u, e) => {
              const A = C.O.view.pxToRem(u),
                E = C.O.view.pxToRem(e);
              D(Object.assign({ width: A, height: E }, o(A, E, l)));
            }, []);
          (((u) => {
            ...
            (0, E.useEffect)(() => () => engine.off("clientResized", r), [r]));
          const B = (0, E.useMemo)(() => Object.assign({}, t), [t]);
          return F().createElement(_.Provider, { value: B }, u);
        }),
          (function (u) {
        ...
        const S = ["xl", "lg", "md", "sm", "xs"],
          ...
          b = [p.ExtraLarge, p.Large, p.Medium, p.Small, p.ExtraSmall],
          L = (u, e) =>
            Object.keys(u).reduce((A, E) => {
              ...
              return (
                void 0 === F ||
                  ((u, e) => S.some((A) => void 0 !== e[`${u}_${A}`]))(E, u) ||
                  (A[E] = F),
                A
              );
            }, {}),
        ...
        const O = {
          ...
          G = M((u) => {
            let e = u.className,
              ...
              d = u.row,
              g = u.flexDirection,
              c = void 0 === g ? (s ? "column" : d && "row") || void 0 : g,
              _ = u.flexStart,
              h = u.center,
              x = u.flexEnd,
              p = u.spaceBetween,
              ...
              R = u.wrap,
              M = u.flexWrap,
              G = void 0 === M ? (R ? "wrap" : void 0) : M,
              N = u.grow,
              X = u.shrink,
              j = u.flex,
              z = void 0 === j ? (N || X ? `${N ? 1 : 0} ${X ? 1 : 0} auto` : void 0) : j,
              I = u.style,
              k = u.children,
              U = (function (u, e) {
                if (null == u) return {};
            ...
            const V = (0, E.useMemo)(() => {
                const u = { mt: a, mr: n, mb: l, ml: o },
                  e = ((u) =>
                    P.reduce((e, A) => {
                      const E = u[A];
                      return E && "number" != typeof E ? e.concat(O[!0 === E ? "MD" : E][A]) : e;
                    }, []))(u),
                  E = ((u) =>
                    P.reduce((e, A) => {
                      const E = u[A];
                      return ("number" == typeof E && (e[W[A]] = E + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [A, t, a, n, l, o, I, z, L, c, G, S, b]),
              K = V.computedStyle,
              $ = V.computedClassNames;
            return F().createElement("div", y({ className: B()(T.base, ...$, e), style: K }, U), k);
          });
        let N;
        !(function (u) {
        ...
        const X = (u, e, A) => {
          ...
          z = (u, e, A = N.left) => u.split(e).reduce(A === N.left ? X : j, []),
          I = (() => {
            const u = new RegExp(
          ...
          k = ["zh_cn", "zh_sg", "zh_tw"],
          U = ({ binding: u, text: e = "", classMix: A, alignment: t = N.left }) =>
            null === e
          ...
          Eu = M((u) => {
            ...
            const _ = (0, E.useMemo)(() => {
                const u = Au(D),
                  ...
                  A = u.colorStyle,
                  E = void 0 === A ? {} : A;
                return { computedStyle: Object.assign({}, d, E), colorClassName: e };
              }, [d, D]),
              h = _.computedStyle,
              x = _.colorClassName;
            return F().createElement(
              ...
              q(
                {
                  className: B()($.base, A && $[A], x, t),
                  style: h,
                  mt: !0 === i ? eu[A || "paragraph-P16"].mt : i,
                  mr: !0 === C ? eu[A || "paragraph-P16"].mr : C,
                  mb: !0 === m ? eu[A || "paragraph-P16"].mb : m,
                  ml: !0 === s ? eu[A || "paragraph-P16"].ml : s,
                },
                c,
              ),
              void 0 !== g ? F().createElement(U, q({}, g, { text: e })) : e,
            );
          }),
          Fu = () =>
            F().createElement(
              "div",
              { className: "App_base_53" },
              F().createElement(Eu, {
                text: R.strings.cosmicEvent.tooltip.shopEntry.description(),
                className: "App_description_39",
              }),
            );
        var tu = A(6711);
