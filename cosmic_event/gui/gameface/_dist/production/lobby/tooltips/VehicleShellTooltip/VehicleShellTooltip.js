    ...
    e = {
      ...
      2535: (u, e, t) => {
        ...
        const c = l.O.client.getSize("rem"),
          ...
          p = (u) => {
            ...
            const E = (0, A.useContext)(h),
              ...
              p = { extraLarge: s, large: c, medium: d, small: g, extraSmall: _ };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && B) return C(e, t, p);
              if (t.largeWidth && i) return C(e, t, p);
              if (t.mediumWidth && l) return C(e, t, p);
              if (t.smallWidth && o) return C(e, t, p);
              if (t.extraSmallWidth && m) return C(e, t, p);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, A.memo)(({ children: u }) => {
          ...
          return E().createElement(h.Provider, { value: a }, u);
        }),
          (function (u) {
        ...
        const P = {
          ...
          G = y((u) => {
            let e = u.className,
              ...
              j = u.shrink,
              X = u.flex,
              I = void 0 === X ? (G || j ? `${G ? 1 : 0} ${j ? 1 : 0} auto` : void 0) : X,
              z = u.style,
              k = u.children,
              U = (function (u, e) {
                if (null == u) return {};
        ...
        const Z = Object.keys(K()),
          ...
          Fu = "App_subTitle_b1",
          ru = R.strings.artefacts.cosmic.ability.tooltip.shell,
          Du = (0, D.observer)(() =>
            E().createElement(
              "div",
              { className: "App_base_89" },
              E().createElement(
                "div",
                { className: "App_header_8a" },
                E().createElement("img", {
                  src: R.images.cosmic_event.gui.maps.icons.battle.ability_panel.icons.shell(),
                  className: "App_img_6b",
                  alt: "",
                }),
                E().createElement(
                  "div",
                  null,
                  E().createElement(Eu, { text: ru.name(), className: "App_title_c5" }),
                  E().createElement(Eu, {
                    text: R.strings.cosmicEvent.abilities.tooltip.subTitle(),
                    className: Fu,
                  }),
                ),
              ),
              E().createElement("div", { className: "App_divider_16" }),
              E().createElement(
                "div",
                { className: "App_footer_f3" },
                E().createElement(Eu, {
                  text: R.strings.cosmicEvent.abilities.tooltip.description(),
                  className: "App_infoTitle_48",
                }),
                E().createElement(Eu, { text: ru.descr(), className: Fu }),
              ),
            ),
          );
        function au() {
                ...
                const D = (0, A.useRef)([]),
                  a = (u, e, t) => {
                    ...
                    const E = (function ({
                        ...
                        return {
                          subscribe: (t, F) => {
                            const D = "string" == typeof F ? `${A}.${F}` : A,
                              a = l.O.view.addModelObserver(D, e, !0);
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const A = null != t ? t : r(e),
                              E = nu.observable.box(A, { equals: au });
                            return (
                              "real" === u &&
                                F.subscribe(
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const E = e,
                                r = Object.entries(E),
                                D = r.reduce(
                                  (u, [e, t]) => ((u[t] = nu.observable.box(A[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      B = { mode: u, model: n, externalModel: F, cleanup: a };
                    return {
                      model: n,
                  ...
                  i = B[0],
                  C = B[1],
                  o = (0, A.useState)(() => a(u, e, r)),
                  m = o[0],
                  s = o[1];
                return (
                  (0, A.useEffect)(() => {
                    n.current ? s(a(i, e, r)) : (n.current = !0);
                  }, [r, i, e]),
                  (0, A.useEffect)(() => {
                    C(u);
                  }, [u]),
        ...
        engine.whenReady.then(() => {
          r().render(
            E().createElement(lu, null, E().createElement(ou.c, null, E().createElement(Du, null))),
