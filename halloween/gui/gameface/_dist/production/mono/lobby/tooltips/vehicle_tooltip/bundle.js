...
import { n as u } from "../../chunks/vendor.js";
import { n as j } from "../../chunks/hangar_carousel_vehicle_view_model.js";
var [w, f] = a()(
    ({ observableModel: e }) => ({
      ...e.primitives([
        "vehicleName",
        ...
        "userDescription",
        "isElite",
        "isDailyKeyQuestVisible",
        "isStatusVisible",
      ]),
      slots: e.arrayClone("crewSlots"),
    }),
    p,
  ),
  H = e(l(), 1),
  ...
  V = 331,
  y = 9,
  L = "R.images.halloween.gui.maps.icons.library.tooltip_divider",
  T = (0, H.memo)(function ({ className: e }) {
    return (0, N.jsx)(d, { path: L, width: V, height: y, className: e });
  }),
  b = "Earnings_94dd8e9c",
  M = "Earnings_icon_1455b4c4",
  R = "Earnings_bonusTitle_41f6d8a2",
  Z = "Earnings_bonusDescription_8869599a",
  E = c.resolve("strings");
function k({ className: e }) {
  return (0, N.jsxs)("div", {
    ...
    children: [
      (0, N.jsx)(d, {
        path: "R.images.halloween.gui.maps.icons.key.keys_orange_70x70",
        className: M,
        width: 70,
        height: 70,
      }),
      (0, N.jsx)("div", {
        className: R,
        children: E.readOrEmpty("halloween_tooltips.vehicle.bonusTitle"),
      }),
      (0, N.jsx)("div", {
        className: Z,
        children: E.readOrEmpty("halloween_tooltips.vehicle.eventBonus"),
      }),
    ],
  });
}
(t.lightTank, t.mediumTank, t.heavyTank, t.SPG, t["AT-SPG"]);
var A = "crewRoles",
  B = "TankmanRole_3bb08c81",
  D = {
    [_.commander]: (e) =>
      (0, N.jsx)("svg", {
        width: 18,
        ...
        children: [
          ...
          (0, N.jsx)("defs", {
            children: (0, N.jsx)("clipPath", {
              ...
              children: (0, N.jsx)("rect", { width: 18, height: 18, fill: "white" }),
            }),
          }),
        ],
      }),
...
function P({ role: e = "", className: i }) {
  const l = D[e];
  if (l) return (0, N.jsx)(l, { className: s(B, i) });
  console.error(`Unknown role type ${e}`);
}
var S = "Row_title_6c4bc0c8",
  O = "Row_title__colon_6c475686",
  $ = o("Row", "Row_a52ddf2a");
function F({ className: e, title: l, params: a, children: t }) {
  ...
  return (0, N.jsxs)($, {
    ...
    children: [
      void 0 !== l &&
        (0, N.jsxs)(N.Fragment, {
          children: [
            (0, N.jsx)(i, { className: S, path: `tooltips.vehicle.${l}`, params: a }),
            (0, N.jsx)("div", {
              className: s(S, O),
...
var I = "Crew_2339425e",
  Q = "Crew_79af07ed",
  G = "Crew_icon_26258836",
  K = "Crew_sign_a456f030",
  z = c.resolve("strings");
function U({ className: e, slots: i }) {
  return (0, N.jsx)(F, {
    title: A,
    ...
    children: n(i, (e) =>
      (0, N.jsxs)(
        "div",
        {
          className: Q,
          children: [
            (0, N.jsx)(P, { role: r(e.roles, 0), className: G }),
            e.roles.length > 1 &&
              (0, N.jsx)("div", { className: K, children: z.readOrEmpty("crew_perks.sign.plus") }),
          ],
        },
        e.id,
      ),
...
var W = "Header_c890a2dc",
  X = "Header_vehicleType_2f8016be",
  q = "Header_name_6445d707",
  J = "Header_description_c9393f08",
  Y = u(function ({ className: e }) {
    const { model: i } = f(),
      l = g(i.vehicleType.get());
    return (0, N.jsxs)("div", {
      className: s(W, e),
      children: [
        ((a = l),
        "string" == typeof a &&
          a in t &&
          (0, N.jsx)(x, { type: l, size: C.x64x64, premium: i.isElite.get(), className: X })),
        (0, N.jsx)("div", { className: q, children: i.userName.get() }),
        (0, N.jsx)("div", { className: J, children: i.userDescription.get() }),
        (0, N.jsx)(U, { slots: i.slots.get() }),
      ],
    });
    var a;
  }),
  ee = "Highlight_94f24c6a",
  se = "Highlight_highLightBg_d94a1117",
  ie = "Highlight_dividerTop_cf849559",
  le = "Highlight_dividerBottom_646c45ac";
function ae({ className: e, children: i }) {
  return (0, N.jsxs)("div", {
    className: s(ee, e),
    children: [
      (0, N.jsx)("div", { className: se }),
      (0, N.jsx)(T, { className: ie }),
      i,
      (0, N.jsx)(T, { className: le }),
    ],
  });
}
var te = "VehicleFeature_a07ec3e0",
  ce = "VehicleFeature_icon_1db75070",
  re = "VehicleFeature_featureName_58f0c4f8",
  ne = "VehicleFeature_featureDescription_6a0032a4",
  oe = c.resolve("strings");
function he({ className: e, vehicleName: i }) {
  return (0, N.jsxs)("div", {
    className: s(te, e),
    children: [
      (0, N.jsx)(d, {
        path: `R.images.halloween.gui.maps.icons.ttcType.c_48x48.${i}`,
        width: 48,
        height: 48,
        className: ce,
      }),
      (0, N.jsx)("div", {
        className: re,
        children: oe.readOrEmpty(`halloween_tooltips.vehicle.ttcType.${i}.title`),
      }),
      (0, N.jsx)("div", {
        className: ne,
        children: oe.readOrEmpty(`halloween_tooltips.vehicle.ttcType.${i}.description`),
      }),
    ],
  });
}
var Ce = "VehicleTooltipApp_cornerIcon_b39a0f52",
  de = "VehicleTooltipApp_62676031",
  pe = "VehicleTooltipApp_base__withDaily_c5c3efe8",
  me = "VehicleTooltipApp_header_9f31768c",
  _e = "VehicleTooltipApp_feature_fa65c6f3",
  ve = "VehicleTooltipApp_highlight_a0eca3a0",
  ge = "VehicleTooltipApp_earning_f3a4e20",
  xe = "VehicleTooltipApp_divider_4f9c8429",
  ue = "VehicleTooltipApp_state_57c51cb3",
  je = (e) => {
    switch (e) {
      case j.Default:
        return "#7ab300";
  ...
  we = u(function () {
    const { model: e } = f(),
      l = e.isElite.get(),
      a = e.isDailyKeyQuestVisible.get(),
      t = e.isStatusVisible.get(),
      c = e.vehicleState.get();
    return (0, N.jsx)(m, {
      children: (0, N.jsxs)(m.Decorator, {
        children: [
          (0, N.jsx)(d, {
            path: "tooltip." + (l ? "topElite" : "topStandart"),
            className: Ce,
            width: 328,
            height: 200,
          }),
          (0, N.jsxs)("div", {
            className: s(de, a && pe),
            children: [
              (0, N.jsx)(Y, { className: me }),
              (0, N.jsx)(ae, {
                className: ve,
                children: (0, N.jsx)(he, { vehicleName: e.vehicleName.get(), className: _e }),
              }),
              a && (0, N.jsx)(k, { className: ge }),
              a && t && (0, N.jsx)(T, { className: xe }),
              t &&
                (0, N.jsx)(i, {
                  style: { color: je(c) },
                  className: ue,
                  path: `halloween_tooltips.vehicle.state.${c}.title`,
                }),
            ],
          }),
        ],
...
h((0, N.jsx)(w, { children: (0, N.jsx)(we, {}) }));
