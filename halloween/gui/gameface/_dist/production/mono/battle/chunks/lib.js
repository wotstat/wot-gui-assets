...
var require_react_production = __commonJSMin((e) => {
      ...
      (e.unstable_scheduleCallback = function (r, a, o) {
        ...
        return (
          ...
          o > i
            ? ((r.sortIndex = o),
              t(l, r),
              null === n(s) && r === n(l) && (h ? (v(S), (S = -1)) : (h = !0), O(E, o - i)))
  ...
  require_react_dom_client_production = __commonJSMin((e) => {
    ...
    var U,
      ...
      V = I(null);
    function H(e, t) {
      switch ((L(W, t), L(z, e), L(j, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function Q(e) {
      (z.current === e && (M(j), M(z)), V.current === e && (M(V), (sf._currentValue = P)));
    }
    function K(e) {
      if (void 0 === U)
        try {
    ...
    var be = Math.clz32
        ? Math.clz32
        : function (e) {
            return 0 === (e >>>= 0) ? 32 : (31 - ((ve(e) / _e) | 0)) | 0;
          },
      ve = Math.log,
      _e = Math.LN2;
    var ye = 256,
    ...
    var Me = Math.random().toString(36).slice(2),
      ...
      He = "__reactMarker$" + Me;
    function Ge(e) {
      (delete e[Le], delete e[Ue], delete e[je], delete e[ze], delete e[We]);
    }
    function qe(e) {
      var t = e[Le];
      if (t) return t;
    ...
    var hn = Qt(
      ...
      vn = Qt(c({}, Zt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      _n = Qt(
        c({}, nn, {
          deltaX: function (e) {
    ...
    function Wn() {
      Rn && (Rn.detachEvent("onpropertychange", Vn), (Nn = Rn = null));
    }
    function Vn(e) {
    ...
    function Hn(e, t, n) {
      "focusin" === e
        ? (Wn(), (Nn = n), (Rn = t).attachEvent("onpropertychange", Vn))
        : "focusout" === e && Wn();
    }
    function Gn(e) {
    ...
    function Tr(e) {
      if (50 < jl) throw ((jl = 0), (zl = null), Error(a(185)));
    ...
    function Ur(e, t, n, r, o, i) {
      ...
      if (((r = e), "function" == typeof e)) Ir(e) && (u = 1);
        ...
        e: switch (e) {
          ...
          case y:
            return (((e = Nr(13, n, t, o)).elementType = y), (e.lanes = i), e);
          case E:
    ...
    function lo(e) {
      ...
      function h(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          ...
          if (k(t) || D(t)) return (((t = $r(t, e.mode, n, null)).return = e), t);
          if ("function" == typeof t.then) return h(e, io(t), n);
          if (t.$$typeof === v) return h(e, ka(e, t), n);
          so(e, t);
        }
        return null;
      }
      function g(e, t, n, r) {
        ...
        if ("object" == typeof n && null !== n) {
          ...
          if (k(n) || D(n)) return null !== a ? null : d(e, t, n, r, null);
          if ("function" == typeof n.then) return g(e, t, io(n), r);
          if (n.$$typeof === v) return g(e, t, ka(e, n), r);
          so(e, n);
        }
        return null;
      }
      function b(e, t, n, r, a) {
        ...
        if ("object" == typeof r && null !== r) {
          ...
          if (k(r) || D(r)) return d(t, (e = e.get(n) || null), r, a, null);
          if ("function" == typeof r.then) return b(e, t, n, io(r), a);
          if (r.$$typeof === v) return b(e, t, n, ka(t, r), a);
          so(t, r);
        }
        return null;
      }
        ...
        if (
          ...
          if (D(c)) {
            ...
            return (function (o, u, s, l) {
              ...
              for (
                var c = null, d = null, f = u, p = (u = 0), m = null, v = s.next();
                null !== f && !v.done;
                p++, v = s.next()
              ) {
                f.index > p ? ((m = f), (f = null)) : (m = f.sibling);
                var _ = g(o, f, v.value, l);
                if (null === _) {
                  null === f && (f = m);
                  break;
                }
              ...
              if (v.done) return (n(o, f), sa && ta(o, p), c);
              if (null === f) {
                for (; !v.done; p++, v = s.next())
                  null !== (v = h(o, v.value, l)) &&
                    ((u = i(v, u, p)), null === d ? (c = v) : (d.sibling = v), (d = v));
                return (sa && ta(o, p), c);
              }
              for (f = r(f); !v.done; p++, v = s.next())
                null !== (v = b(f, o, p, v.value, l)) &&
          ...
          if ("function" == typeof c.then) return _(s, l, io(c), d);
          if (c.$$typeof === v) return _(s, l, ka(s, c), d);
          so(s, c);
        }
    ...
    var Fo = I(null),
      Co = I(0);
    function Do(e, t) {
      (L(Co, (e = _l)), L(Fo, t), (_l = e | t.baseLanes));
    }
    function Bo() {
      (L(Co, _l), L(Fo, Fo.current));
    }
    function xo() {
      ((_l = Co.current), M(Fo), M(Co));
    }
    var ko = I(null),
      Oo = null;
    function To(e) {
      ...
      (L(Mo, 1 & Mo.current),
        L(ko, e),
        null === Oo && (null === t || null !== Fo.current || null !== t.memoizedState) && (Oo = e));
    }
    function Po(e) {
      (L(Mo, Mo.current), L(ko, e), null === Oo && (Oo = e));
    }
    function Ro(e) {
      22 === e.tag ? (L(Mo, Mo.current), L(ko, e), null === Oo && (Oo = e)) : No();
    }
    function No() {
      (L(Mo, Mo.current), L(ko, ko.current));
    }
    function Io(e) {
      (M(ko), Oo === e && (Oo = null), M(Mo));
    }
    var Mo = I(0);
    function Lo(e) {
      for (var t = e; null !== t;) {
    ...
    function Jo(e) {
      ...
      if (((Uo = 0), (zo = jo = $o = null), (Wo = !1), (qo = 0), (Qo = null), t))
        throw Error(a(300));
      null === e || ku || (null !== (e = e.dependencies) && Da(e) && (ku = !0));
    }
    function ei(e, t, n, r) {
      $o = e;
      var o = 0;
      do {
        ...
        if (((o += 1), (zo = jo = null), null != e.updateQueue)) {
          var i = e.updateQueue;
          ((i.lastEffect = null),
            (i.events = null),
            (i.stores = null),
    ...
    function ti() {
      ...
      return (
        ...
        (e = e.useState()[0]),
        (null !== jo ? jo.memoizedState : null) !== e && ($o.flags |= 1024),
        t
      );
    }
    function ni() {
    ...
    function ai(e) {
      ...
      ((Uo = 0), (zo = jo = $o = null), (Vo = !1), (qo = Go = 0), (Qo = null));
    }
    function oi() {
      var e = { memoizedState: null, baseState: null, baseQueue: null, queue: null, next: null };
      return (null === zo ? ($o.memoizedState = zo = e) : (zo = zo.next = e), zo);
    }
    function ii() {
      if (null === jo) {
        var e = $o.alternate;
      ...
      var t = null === zo ? $o.memoizedState : zo.next;
      if (null !== t) ((zo = t), (jo = e));
      else {
        if (null === e) {
        ...
        ((e = {
          ...
          null === zo ? ($o.memoizedState = zo = e) : (zo = zo.next = e));
      }
      return zo;
    }
    function ui(e) {
    ...
    function fi(e, t, n) {
      ...
      if (((i = e.baseState), null === o)) e.memoizedState = i;
        ...
        if (
          (null === l ? (u = i) : (l.next = s),
          !Kn(i, e.memoizedState) && ((ku = !0), d && null !== (n = ja)))
        )
          throw n;
    ...
    function mi(e, t, n) {
      ...
      if (
        ...
        o.getSnapshot !== t || u || (null !== zo && 1 & zo.memoizedState.tag))
      ) {
        if (
          ((r.flags |= 2048),
    ...
    function gi(e, t, n, r) {
      ((t.value = n), (t.getSnapshot = r), vi(t) && _i(e));
    }
    function bi(e, t, n) {
      return n(function () {
        vi(t) && _i(e);
    ...
    function Oi(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          (($o.flags |= 2048), Ri(9, { destroy: void 0 }, Ti.bind(null, a, n), null)),
        [r, o, e]
      );
    }
    function Ti(e, t) {
    ...
    function Mi(e, t, n, r) {
      ...
      null !== jo && null !== r && Xo(r, jo.memoizedState.deps)
        ...
        : (($o.flags |= e), (a.memoizedState = Ri(1 | t, o, n, r)));
    }
    function Li(e, t) {
      Ii(8390656, 8, e, t);
    }
    ...
    function Qi(e, t, n) {
      return void 0 === n || (1073741824 & Uo && !(261930 & pl))
        ? (e.memoizedState = t)
        : ((e.memoizedState = n), (e = Vl()), ($o.lanes |= e), (El |= e), n);
    }
    function Ki(e, t, n, r) {
      return Kn(n, t)
        ? n
    ...
    var pu = {
        ...
        useImperativeHandle: function (e, t, n) {
          ((n = null != n ? n.concat([e]) : null), Ii(4194308, 4, Wi.bind(null, t, e), n));
        },
    ...
    var bu = {
      enqueueSetState: function (e, t, n) {
        ...
        ((a.payload = t),
          null != n && (a.callback = n),
          null !== (t = bo(e, a, r)) && (Hl(t, e, r), vo(t, e, r)));
      },
      ...
      enqueueForceUpdate: function (e, t) {
        ...
        ((r.tag = 2),
          null != t && (r.callback = t),
          null !== (t = bo(e, r, n)) && (Hl(t, e, n), vo(t, e, n)));
      },
    };
    function vu(e, t, n, r, a, o, i) {
    ...
    function Nu(e, t, n, r) {
      ...
      if (
        ...
        null !== o
          ? (Ga(0, o.cachePool), Do(t, o), No(), (t.memoizedState = null))
          : (null !== e && Ga(0, null), Bo(), No());
      ...
      if (null !== l && null !== (s = l.dehydrated)) {
        if (u)
          ...
          ((r = c),
            ((o = Error(a(419))).stack = ""),
            (o.digest = r),
            va({ value: o, source: null, stack: null }),
            (t = Xu(e, t, n)));
        } else if ((ku || Ca(e, t, n, !1), (r = 0 !== (n & e.childLanes)), ku || r)) {
        ...
        case 3:
          e: {
            ...
            if (
              ...
              if (r !== o) {
                (va((o = Hr(Error(a(424)), t))), (t = Vu(e, t, r, n)));
                break e;
              }
        ...
        case 27:
          return (
            ...
            null === e &&
              ...
              (ca = !0),
              (o = ua),
              wd(t.type) ? ((Od = o), (ua = kd(r.firstChild))) : (ua = o)),
        ...
        case 31:
          return (function (e, t, n) {
            ...
            if (null !== i) {
              ...
              else if ((ku || Ca(e, t, n, !1), (o = 0 !== (n & e.childLanes)), ku || o)) {
              ...
              : (0 !== (e.lanes & n) && (ho(e, t), Ao(t, null, null, n), Eo()),
                ...
                o.parent !== r
                  ? ((o = { parent: r, cache: r }),
                    ...
                    Aa(0, Na, r))
                  : ((r = i.cache), Aa(0, Na, r), r !== o.cache && Fa(t, [Na], n, !0))),
            Ou(e, t, t.pendingProps.children, n),
            t.child
          );
        case 29:
      ...
      switch ((aa(t), t.tag)) {
        ...
        case 27:
          if ((Q(t), (n = W.current), (o = t.type), null !== e && null != t.stateNode))
            ...
            ((e = j.current), ha(t) ? pa(t) : ((e = Rd(o, r, n)), (t.stateNode = e), as(t)));
          }
          return (ls(t), null);
        case 5:
    ...
    function ys(e, t, n) {
      try {
        ...
        (!(function (e, t, n, r) {
          ...
          for (var v in n)
            ((p = n[v]),
              n.hasOwnProperty(v) && null != p && !r.hasOwnProperty(v) && ud(e, t, v, null, r, p));
          for (f in r)
            ((p = r[f]),
              (m = n[f]),
    ...
    function Os(e, t, n) {
      ...
      switch (n.tag) {
        ...
        case 26:
        case 5:
          (Hs(e, n), null === t && 4 & r && _s(n), 512 & r && bs(n, n.return));
          break;
        case 12:
          Hs(e, n);
          break;
        ...
        case 22:
          if (!(r = null !== n.memoizedState || Cs)) {
            ...
            var o = Ds;
            ((Cs = r),
              (Ds = t) && !o ? qs(e, n, !!(8772 & n.subtreeFlags)) : Hs(e, n),
              (Cs = a),
              (Ds = o));
          }
          break;
    ...
    function Is(e, t, n) {
      ...
      switch (n.tag) {
        ...
        case 1:
          (Ds ||
            (vs(n, t), "function" == typeof (r = n.stateNode).componentWillUnmount && gs(n, t, r)),
            Ns(e, t, n));
          break;
        case 21:
          Ns(e, t, n);
    ...
    function zs(e, t) {
      ...
      switch (e.tag) {
        ...
        case 14:
        case 15:
          ($s(t, e), Ws(e), 4 & r && (ms(3, e, e.return), ps(3, e), ms(5, e, e.return)));
          break;
        case 1:
          ($s(t, e),
            Ws(e),
            512 & r && (Ds || null === n || vs(n, n.return)),
            64 & r &&
              Cs &&
        ...
        case 26:
          var o = js;
          if (($s(t, e), Ws(e), 512 & r && (Ds || null === n || vs(n, n.return)), 4 & r)) {
        ...
        case 27:
          ...
          break;
        case 5:
          if (($s(t, e), Ws(e), 512 & r && (Ds || null === n || vs(n, n.return)), 32 & e.flags)) {
            o = e.stateNode;
            try {
              Et(o, "");
            } catch (h) {
        ...
        case 3:
          ...
          break;
        case 4:
          ((r = js), (js = Ld(e.stateNode.containerInfo)), $s(t, e), Ws(e), (js = r));
          break;
        case 12:
        default:
          ($s(t, e), Ws(e));
        ...
        case 22:
          ...
          var l = null !== n && null !== n.memoizedState,
            c = Cs,
            d = Ds;
          if (((Cs = c || o), (Ds = d || l), $s(t, e), (Ds = d), (Cs = c), Ws(e), 8192 & r))
            e: for (
              t = e.stateNode,
                t._visibility = o ? -2 & t._visibility : 1 | t._visibility,
                o && (null === n || l || Cs || Ds || Gs(e)),
                n = null,
                t = e;
              ;
            ) {
      ...
      for (n = n && !!(8772 & t.subtreeFlags), t = t.child; null !== t;) {
        ...
        switch (o.tag) {
          ...
          case 1:
            ...
            (n && 64 & i && hs(o), bs(o, o.return));
            break;
          case 27:
            Fs(o);
          case 26:
          case 5:
            (qs(a, o, n), n && null === r && 4 & i && _s(o), bs(o, o.return));
            break;
          case 12:
            qs(a, o, n);
            break;
          ...
          case 13:
            ...
            break;
          case 22:
            (null === o.memoizedState && qs(a, o, n), bs(o, o.return));
            break;
          case 30:
            break;
          default:
    ...
    function nl(e, t, n) {
      switch (e.tag) {
        ...
        case 4:
          var r = js;
          ((js = Ld(e.stateNode.containerInfo)), tl(e, t, n), (js = r));
          break;
        case 22:
          null === e.memoizedState &&
    ...
    function Vl() {
      ...
      return (null !== (e = ko.current) && (e.flags |= 32), Sl);
    }
    function Hl(e, t, n) {
        ...
        var r = (!n && !(127 & t) && 0 === (t & e.expiredLanes)) || Fe(e, t),
          o = r
            ? (function (e, t) {
                ...
                var r = tc(),
                  o = nc();
                dl !== e || pl !== t ? ((Tl = null), (Ol = oe() + 500), Zl(e, t)) : (bl = Fe(e, t));
                e: for (;;)
                  try {
                    if (0 !== ml && null !== fl) {
                      t = fl;
        ...
        if (((n = e.current.alternate), !i || Ql(n))) {
          ...
          e: {
            ...
            if ((62914560 & t) === t && 10 < (o = xl + 300 - oe())) {
              ...
              ((Ml = t),
                (r.timeoutHandle = vd(
                  ql.bind(null, r, n, Dl, Tl, Bl, t, Sl, Al, Fl, gl, i, "Throttled", -0, 0),
                  o,
                )));
            } else ql(r, n, Dl, Tl, Bl, t, Sl, Al, Fl, gl, i, null, -0, 0);
          }
          break;
        }
        ((o = ac(e, t, !1)), (i = !1));
    ...
    function rc() {
      ((yl = 4),
        gl || ((4194048 & pl) !== pl && null !== ko.current) || (bl = !0),
          ...
          if (0 !== ml && null !== fl) {
            ...
            switch (ml) {
              ...
              case 6:
                null === ko.current && (t = !0);
                var l = ml;
                if (((ml = 0), (hl = null), lc(e, u, s, l), n && bl)) {
                  i = 0;
                  break e;
                }
                break;
        ...
        if (
          (function (e, t, n, r, o) {
            if (
              ...
              if ((null !== (t = n.alternate) && Ca(t, n, o, !0), null !== (n = ko.current))) {
                switch (n.tag) {
                  case 31:
                  case 13:
                    return (
              ...
              return (
                null !== (t = ko.current)
                  ? (!(65536 & t.flags) && (t.flags |= 256),
                    (t.flags |= 65536),
                    (t.lanes = o),
                    r !== da && va(Hr((e = Error(a(422), { cause: r })), n)))
                  : (r !== da && va(Hr((t = Error(a(423), { cause: r })), n)),
                    ((e = e.current.alternate).flags |= 65536),
                    (o &= -o),
                    (e.lanes |= o),
                    (r = Hr(r, n)),
                    _o(e, (o = Cu(e.stateNode, r, o))),
                    4 !== yl && (yl = 2)),
                !1
              );
    ...
    function hc() {
      if (4 === Rl || 3 === Rl) {
        ...
        (3 & Ml && bc(),
          Tc(e),
          (a = e.pendingLanes),
          261930 & n && 42 & a ? (e === zl ? jl++ : ((jl = 0), (zl = e))) : (jl = 0),
          Pc(0, !1));
      }
    }
    function gc(e, t) {
    ...
    function _c(e, t, n) {
      ((t = Hr(n, t)), null !== (e = bo(e, (t = Cu(e.stateNode, t, 2)), 2)) && (xe(e, 2), Tc(e)));
    }
    function yc(e, t, n) {
      if (3 === e.tag) _c(e, e, n);
      else
        for (; null !== t;) {
          ...
          if (1 === t.tag) {
            ...
            if (
              ...
              ((e = Hr(n, e)),
                null !== (r = bo(t, (n = Du(2)), 2)) && (Bu(n, r, t, e), xe(r, 2), Tc(r)));
              break;
            }
          }
          t = t.return;
    ...
    function Ec(e, t, n) {
      ...
      a.has(n) || ((vl = !0), a.add(n), (e = Ac.bind(null, e, t, n)), t.then(e, e));
    }
    function Ac(e, t, n) {
      var r = e.pingCache;
      (null !== r && r.delete(t),
    ...
    function wc(e, t) {
      (0 === t && (t = De()), null !== (e = kr(e, t)) && (xe(e, t), Tc(e)));
    }
    function Sc(e) {
      var t = e.memoizedState,
        n = 0;
    ...
    function Nc() {
      ...
      0 !== Oc &&
        ...
        (e = Oc);
      for (var t = oe(), n = null, r = Cc; null !== r;) {
        var a = r.next,
          o = Ic(r, t);
        (0 === o
      ...
      It(function () {
        ...
        if (!(7 & t)) {
          ...
          switch (
            ...
            case "focusin":
              (Tn(_) || "true" === _.contentEditable) && ((rr = _), (ar = r), (or = null));
              break;
            case "focusout":
              or = ar = rr = null;
              break;
          ...
          (E &&
            (Fn &&
              ...
              (kn || "onCompositionStart" !== E
                ...
                : ((zt = "value" in (jt = a) ? jt.value : jt.textContent), (kn = !0))),
            0 < (_ = ed(r, E)).length &&
            ...
            (function (e, t, n, r, a) {
              if ("submit" === t && n && n.stateNode === a) {
                var o = $c((a[Ue] || null).action),
                  i = r.submitter;
                i &&
                  null !==
                    (t = (t = i[Ue] || null) ? $c(t.formAction) : i.getAttribute("formAction")) &&
                  ((o = t), (i = null));
      ...
      switch (t) {
        ...
        case "select":
          ...
          return (
            ...
            (n = u),
            (e.multiple = !!o),
            void (null != t ? vt(e, !!o, t, !1) : null != n && vt(e, !!o, n, !0))
          );
        case "textarea":
    ...
    var bd = null;
    var vd = "function" == typeof setTimeout ? setTimeout : void 0,
    ...
    function cf(e, t, n, r, a, o) {
      ((a = (function (e) {
        ...
        null !== (n = bo(e, r, t)) && (Hl(n, 0, t), vo(n, e, t)));
    }
    function df(e, t) {
    ...
    function vf(e, t, n, r) {
      if (hf) {
        ...
        if (null === a) (Zc(e, t, r, yf, n), Of(e, r));
          ...
          r.stopPropagation();
        else if ((Of(e, r), 4 & t && -1 < kf.indexOf(e))) {
          for (; null !== a;) {
            var o = Qe(a);
            if (null !== o)
              switch (o.tag) {
            ...
            if ((null === (o = _f(r)) && Zc(e, t, r, yf, n), o === a)) break;
            a = o;
          }
    ...
    ((Wf.prototype.render = zf.prototype.render =
      function (e) {
        var t = this._internalRoot;
        if (null === t) throw Error(a(409));
        cf(t.current, Wl(), e, t, null, null);
      }),
      (Wf.prototype.unmount = zf.prototype.unmount =
        function () {
...
var BailSignal = class extends Error {
  ...
  SpringValue = class extends FrameValue {
          ...
          if (!c) {
            ...
            if (is.und(o.duration))
              if (o.decay) {
                ...
                for (
                  let e = 0;
                  e < b && ((m = Math.abs(i) > t), m || ((c = Math.abs(l - d) <= f), !c));
                  ++e
                ) {
    ...
    _merge(e, t, n) {
      ...
      if (!v || is.und(c)) return n(getFinishedResult(this, !0));
      const _ = is.und(t.reset) ? a && !t.default : !is.und(d) && matchProp(t.reset, o),
        y = _ ? d : this.get(),
        E = computeGoal(c),
      ...
      const S = v.constructor;
      let F = hasFluidValue(c),
        C = !1;
      if (!F) {
        const e = _ || (!hasAnimated(this) && f);
        ((p || e) && ((C = isEqual(computeGoal(y), E)), (F = !C)),
          ((isEqual(u.immediate, w) || w) && isEqual(h.decay, g) && isEqual(h.velocity, b)) ||
            (F = !0));
      }
      if (
        ...
        (flushCalls(this._pendingCalls, r),
          ...
          u.changed &&
            raf.batchedUpdates(() => {
              ((u.changed = !_), e?.(r, this), _ ? callProp(i.onRest, r) : u.onStart?.(r, this));
            }));
      }
      (_ && this._set(y),
        m
...
var initializeModelWithContext =
  ...
  (t, n, r) => {
    ...
    function o(o) {
      ...
      const [_, y] = (0, import_react.useState)(() => h(b, u, f));
      return (
        (0, import_react.useEffect)(() => {
          g.current ? y(h(b, u, f)) : (g.current = !0);
        }, [h, f, b, u?.context, u?.initializer, u?.getRoot, u?.rootId]),
        (0, import_react.useEffect)(
          () => () => {
    ...
    return (u = {}) => {
      const { settings: s = defaultSettings } = u,
        ...
        _ = (0, import_react.useCallback)(
          ...
          [g.scrollPosition, b, s.animationConfig, h],
        ),
        ...
        A = (0, import_react.useCallback)(
          function () {
            const e = d.current;
            e && (_(i(e, g.scrollPosition.goal), { immediate: !0 }), m.trigger("resizeHandled"));
          },
          [_, g.scrollPosition.goal, m],
        );
      ...
      const w = useEvent(function () {
          ...
          if (p.current.container !== n || p.current.wrapper !== r) {
            ...
            (e !== g.scrollPosition.goal && _(e, { immediate: !0 }),
...
var rail$1 = "HorizontalBar_rail_37858d8f",
  base$20 = "HorizontalBar_4df27ac3",
  ...
  base$19 = "HorizontalScroll_5b201d2b",
...
function Base({ settings: e, children: t }) {
...
var base$16 = "MultilineOverflow_ec9f8e47",
  content$1 = "MultilineOverflow_content_b539970d",
  multiline_overflow_module_default = { base: base$16, content: content$1 };
...
var MultilineOverflow = (0, import_react.forwardRef)(function (
    ...
    const v = (0, import_react.useRef)(null),
  ...
  cva = (e, t) => (n) => {
    ...
    if (null == (null == t ? void 0 : t.variants))
      return cx$6(e, null == n ? void 0 : n.class, null == n ? void 0 : n.className);
...
var sizes$3 = { small: "small", medium: "medium" },
  types$1 = { bubble: "bubble", discount: "discount", custom: "custom" },
  imageSizes = { [sizes$3.small]: 48, [sizes$3.medium]: 60 };
function getImagePath(e, t, n) {
  return e === types$1.bubble || e === types$1.discount ? `library.notification.${e}_${t}x${t}` : n;
}
function Icon({ className: e, size: t = sizes$3.small, type: n, imagePath: r }) {
  const a = imageSizes[t];
  return (0, import_jsx_runtime.jsx)(Image$1, {
    width: a,
    height: a,
    path: getImagePath(n, a, r),
    className: e,
  });
}
var base$15 = "Value_880359b5",
  base__small$4 = "Value_base__small_533886b2",
...
var base$14 = "Bubble_df22310d",
  base__hidden = "Bubble_base__hidden_1700314d",
  bubble_module_default = { base: base$14, base__hidden: base__hidden },
  Bubble = {
  ...
  Slot = import_react.forwardRef((e, t) => {
    const { children: n, ...r } = e,
      a = import_react.Children.toArray(n),
      o = a.find(isSlottable);
    if (o) {
      const e = o.props.children,
        n = a.map((t) =>
          t === o
            ? import_react.Children.count(e) > 1
              ? import_react.Children.only(null)
              : import_react.isValidElement(e)
                ? e.props.children
                : null
            : t,
        );
      return (0, import_jsx_runtime.jsx)(SlotClone, {
        ...r,
        ref: t,
        children: import_react.isValidElement(e) ? import_react.cloneElement(e, void 0, n) : null,
      });
    }
    return (0, import_jsx_runtime.jsx)(SlotClone, { ...r, ref: t, children: n });
  });
Slot.displayName = "Slot";
var SlotClone = import_react.forwardRef((e, t) => {
  const { children: n, ...r } = e;
  if (import_react.isValidElement(n)) {
    const e = getElementRef(n),
      a = mergeProps(r, n.props);
    return (
      n.type !== import_react.Fragment && (a.ref = t ? assignRefs([t, e]) : e),
      import_react.cloneElement(n, a)
    );
  }
...
function isSlottable(e) {
  return import_react.isValidElement(e) && e.type === Slottable;
}
...
function createTooltipComponent(e, t) {
  function n({ asChild: t, params: n, disabled: r, ...a }) {
    const o = t ? Slot : "div",
      i = e(r ? { ...n, disabled: r } : n);
    return (0, import_jsx_runtime.jsx)(o, { ...a, ...i });
  }
  ...
  PlayerNickname = ({
    ...
    const f = R.images.gui.maps.icons.library.badges.strips.$dyn(suffixBadgeStripeFolders[l]),
      ...
      b = (0, import_classnames.default)(
        ...
        o && PlayerNickname_module_default.base__inverted,
      ),
      v = (0, import_classnames.default)(PlayerNickname_module_default.userName, c),
    ...
    return (0, import_jsx_runtime.jsx)("div", { className: b, children: o ? A.reverse() : A });
  },
  types = {
...
export {
  ...
  useSounds as F,
  configure as G,
  useKeydownListener as H,
  createSoundPlay as I,
  observable as J,
  getDependencyTree as K,
  useSimpleTooltip as L,
  JSXBuilder as M,
  computedFn as N,
  useVerticalScroll as O,
  initializeModelWithContext as P,
  require_jsx_runtime as Q,
  useTooltip as R,
  MultilineOverflow as S,
  Base as T,
  Reaction as U,
  useCallbackOnEsc as V,
  action as W,
  MediaWrapper as X,
  useUpscale as Y,
  useMedia as Z,
