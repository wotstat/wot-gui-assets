(() => {
  ...
  var __webpack_modules__ = {
      ...
      5664: (u, e, t) => {
            ...
            const f = (0, n.useRef)({
              ...
              y = (0, n.useCallback)(() => {
                (f.current.isVisible && f.current.timeoutId) ||
                  (C(t, D, { isMouseEvent: !0, on: !0, arguments: B(r) }, g),
                  m && m(),
        ...
        const y = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return r().createElement(f, e, n);
          const o = e.contentId,
            i = e.args,
          ...
          X = r().memo(
            ({
              ...
              const l = (0, n.useRef)(null),
                ...
                v = (0, n.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
              return (
                ((u, e, t = !0) => {
                ...
                const a = (0, n.useRef)([]),
                  A = (u, t, n) => {
                    ...
                    const o = (function ({
                      ...
                      F = (({ observableModel: u }) => ({ points: u.object("points") }))({
                        mode: u,
                        readByPath: s,
                        externalModel: i,
                        observableModel: {
              ...
              e = (0, n.useMemo)(
                () => ({
                  points: r().createElement(
                    "span",
                    { className: "NotEnoughPointsApp_points_9a" },
                    u,
                  ),
                  icon: r().createElement("div", { className: "NotEnoughPointsApp_icon_02" }),
                }),
                [u],
              );
            return r().createElement(
              ...
              r().createElement(
                "div",
                { className: "NotEnoughPointsApp_base_82" },
                r().createElement(
                  "span",
                  { className: "NotEnoughPointsApp_title_a2" },
                  R.strings.fl_tooltips.notEnoughPoints.header(),
                ),
                r().createElement(
                  "span",
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(5664));
