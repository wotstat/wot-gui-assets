(() => {
  ...
  var __webpack_modules__ = {
      527: (u, e, t) => {
        (t.r(e), t.d(e, { mouse: () => s, onResize: () => o }));
        var n = t(2472),
          r = t(1176);
      ...
      2674: (u, e, t) => {
        ...
        const l = r().forwardRef(function (u, e) {
            ...
            return (
              ...
              r().createElement(
                "div",
                c({}, l, {
                  className: a()(A.base, A[`base__theme-${s}`], o),
                  ref: function (u) {
          ...
          B = ["ko", "no"].includes(R.strings.settings.LANGUAGE_CODE()),
          C = (u) =>
            B
              ? `${u}`
              : (function (u) {
        ...
        const k = R.views.common.tooltip_window.simple_tooltip_content,
          T = (u) => {
            ...
            const A = (0, n.useMemo)(() => {
              const u = Object.assign({}, a, { body: t, header: o, note: i, alert: s });
        ...
        const L = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return r().createElement(T, e, n);
          const o = e.contentId,
            i = e.args,
            s = null == i ? void 0 : i.contentId;
          return o || s
            ? r().createElement(m, O({}, e, { contentId: o || s }), n)
            : r().createElement(w, e, n);
        };
        var x = t(9050),
          M = t.n(x);
        let P;
        ...
        const U = {
            [I.NBSP]: N.NoBreakSymbol,
            [I.ZWNBSP]: N.NoBreakSymbol,
            [I.NEW_LINE]: N.LineBreak,
          },
          W = {
          ...
          j = ({ elementList: u, textBlock: e, key: t }) => {
            ...
            return n
              ? W[n]
                ? r().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, className: W[n] },
                    u,
                  )
                : r().createElement(
                    "span",
                    { key: t, "data-block-type": e.blockType, style: V(n) },
                    u,
                  )
          ...
          G = (u, e = "") => {
            ...
            return (
              H(
                ...
                /(\n+|[\xa0\ufeff]+)/g,
                (u) => {
                  t.push({ blockType: N.Word, colorTag: e, childList: z(u) });
                },
                (u) => {
                  const n = u[0],
                    r = U[n.charAt(0)];
                  r === N.LineBreak
                    ? t.push(
                        ...((u) => {
                          const e = [
                            { blockType: N.LineBreak, colorTag: "", childList: [u.charAt(0)] },
                          ];
          ...
          Q = (u, e) => u.offsetLeft + u.offsetWidth - e,
          J = (u, e, t) => {
            ...
            for (let E = t; E >= 0; E--) {
              ...
              if (!(t.childElementCount > 1)) {
                ...
                const l = F.slice(0, F.length - c) + i,
                  D = e[E];
                ((a = r().cloneElement(D, D.props, l)), (s = E));
                break;
              }
              {
                const u = t.children,
                  A = e[E],
                  c = A.props.children,
                  l = uu(u, c, u.length - 1, n, o, i),
                  D = l[0],
                  d = l[1];
                if (!(D < 0)) {
                  const u = c.slice(0, D);
                  ((a = r().cloneElement(A, A.props, u, d)), (s = E));
                  break;
                }
                o -= F.length;
              }
            ...
            ({
              ...
              return (
                ...
                r().createElement(
                  ...
                  r().createElement("div", { className: "ExtendedText_unTruncated_b8", ref: l }, _),
                  r().createElement(
                    L,
                    { tooltipArgs: v },
                    r().createElement(
                      "div",
                      {
                        className: a()(
                          ...
                          !B.isTruncateFinished && s && "ExtendedText_truncated__hide_31",
                        ),
                        style: h,
                      },
        ...
        const iu = (u) => (0 === u ? window : window.subViews.get(u)),
                ...
                const a = (0, n.useRef)([]),
                  A = (u, t, n) => {
                    ...
                    const o = (function ({
                        ...
                        return {
                          subscribe: (t, o) => {
                            const s = "string" == typeof o ? `${n}.${o}` : n,
                              a = E.O.view.addModelObserver(s, e, !0);
                            return (r.set(a, t), u && t(i(o)), a);
                          },
                          readByPath: i,
                          createCallback: (u, e) => {
                            const t = i(e);
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const n = null != t ? t : s(e),
                              r = ru.observable.box(n, { equals: nu });
                            return (
                              "real" === u &&
                                i.subscribe(
                                  (0, ru.action)((u) => r.set(u)),
                                  e,
                                ),
                              r
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const r = e.reduce(
                                (u, e) => ((u[e] = ru.observable.box(n[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const r = e,
                                o = Object.entries(r),
                                s = o.reduce(
                                  (u, [e, t]) => ((u[t] = ru.observable.box(n[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      c = { mode: u, model: F, externalModel: i, cleanup: A };
                    return {
                      model: F,
                  ...
                  l = c[0],
                  D = c[1],
                  d = (0, n.useState)(() => A(u, o, s)),
                  B = d[0],
                  C = d[1];
                return (
                  (0, n.useEffect)(() => {
                    F.current ? C(A(l, o, s)) : (F.current = !0);
                  }, [s, l, o]),
                  (0, n.useEffect)(() => {
                    D(u);
                  }, [u]),
          ...
          au = su[0],
          Eu = su[1],
          Au = "LevelReservesApp_divider_ef",
          Fu = (0, tu.observer)(() => {
            const u = Eu().model.levels.get(),
              e = (u) =>
                R.strings.fl_common.levelReservesTooltip.$dyn(u ? "level" : "levelAvailable");
            return r().createElement(
              l,
              null,
              r().createElement(
                "div",
                { className: "LevelReservesApp_base_b8" },
                r().createElement(
                  "div",
                  { className: "LevelReservesApp_title_80" },
                  R.strings.fl_common.levelReservesTooltip.title(),
                ),
                r().createElement(
                  "div",
                  { className: "LevelReservesApp_desc_0c" },
                  R.strings.fl_common.levelReservesTooltip.desc(),
                ),
                r().createElement(
                  "div",
                  ...
                  (n = (u, t) =>
                    r().createElement(
                      ...
                      r().createElement(
                        "div",
                        { className: "LevelReservesApp_levelContainer_8a" },
                        r().createElement(
                          "div",
                          { className: "LevelReservesApp_levelTitle_eb" },
                          r().createElement(eu, {
                        ...
                        r().createElement(
                          "div",
                          { className: "LevelReservesApp_levelDesc_bf" },
                          r().createElement(eu, {
                            text: e(t),
                            binding: { lvl: R.strings.fl_info_page.progression.ranksTable.$dyn(u) },
                          }),
                        ),
                      ),
                      r().createElement("div", { className: Au }),
                  ...
                  Array.isArray(t)
                    ? t.map(n)
                    : t.map((u, e, t) => n(null == u ? void 0 : u.value, e))),
                ),
                r().createElement(
                  "div",
                  { className: "LevelReservesApp_footer_d3" },
                  r().createElement("div", { className: "LevelReservesApp_infoIcon_80" }),
                  r().createElement("span", null, R.strings.fl_common.levelReservesTooltip.info()),
                ),
              ),
            );
            var t, n;
        ...
        engine.whenReady.then(() => {
          i().render(
            r().createElement(au, null, r().createElement(Fu, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2674));
