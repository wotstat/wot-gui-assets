        ...
        const s = ["children"],
          o = (e) => {
            ...
            const o = (0, n.useContext)(i.Y),
              ...
              R = { extraLarge: p, large: v, medium: b, small: f, extraSmall: S };
            ...
            const x = (0, i.useRef)({
              ...
              O = (0, i.useCallback)(() => {
                (x.current.isVisible && x.current.timeoutId) ||
                  (l(r, p, { isMouseEvent: !0, on: !0, arguments: o(a) }, y),
                  R && R(),
                        ...
                        onMouseEnter:
                          ...
                          (e) => {
                            (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                              ((x.current.timeoutId = window.setTimeout(O, g ? 100 : 400)),
                              c && c(e),
                              M && M(e));
                          }),
                        onMouseLeave: ((e) => (t) => {
                      ...
                      observableModel: {
                        ...
                        primitives: (e, t) => {
                          ...
                          }
                          {
                            const i = e,
                              s = Object.entries(i),
                              o = s.reduce((e, [t, r]) => ((e[r] = a.LO.box(n[t], {})), e), {});
                            return (
                              "real" === r &&
                                u.subscribe(
                                  (0, a.aD)((e) => {
