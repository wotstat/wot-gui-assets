/*! For license information please see fall_tanks.vendors.js.LICENSE.txt */
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
  ["lib/fall_tanks.vendors"],
  {
    311: (e, t, n) => {
      "use strict";
      n.d(t, {
          ...
          const o = { applyAnimatedValues: t, createAnimatedStyle: n, getComponentProps: i },
            s = (e) => {
              ...
              return (
                ((e = r.is.str(e)
                  ? s[e] || (s[e] = m(e, o))
                  : e[b] || (e[b] = m(e, o))).displayName = `Animated(${t})`),
                e
              );
            };
          return (
    ...
    216: (e, t, n) => {
      "use strict";
      n.d(t, { Globals: () => r.OH, useSpring: () => be, useTransition: () => We });
      var r = n(398),
        i = n(363),
        o = n(311);
      ...
      function k(e, { key: t, props: n, defaultProps: i, state: o, actions: s }) {
        return new Promise((a, u) => {
          ...
          function g() {
            f > 0 && !r.OH.skipAnimation
              ? ((p = r.Wn.setTimeout(m, f)), o.pauseQueue.add(_), o.timeouts.add(p))
              : m();
          }
          function m() {
      ...
      class H extends M {
              ...
              if (!d) {
                ...
                if (r.is.und(s.duration))
                  if (s.decay) {
                    ...
                    for (
                      let e = 0;
                      e < m && ((v = Math.abs(a) > i), v || ((d = Math.abs(h - f) <= t), !d));
                      ++e
                    )
        ...
        _merge(e, t, n) {
          ...
          let v = e.to,
            ...
            g = e.from,
            m = void 0 === g ? p : g;
          if ((!s || i || (t.default && !r.is.und(_)) || (_ = m), t.reverse)) {
            var y = [m, _];
            ((_ = y[0]), (m = y[1]));
          }
          const U = !(0, r.Xy)(m, p);
          (U && (l.from = m), (m = (0, r.je)(m)));
          const O = !(0, r.Xy)(_, f);
          O && this._focus(_);
          const w = W(t.to),
            S = l.config,
          ...
          let k = (0, o.ys)(this);
          if (!k || r.is.und(_)) return n(E(this, !0));
          const j = r.is.und(t.reset) ? s && !t.default : !r.is.und(m) && d(t.reset, a),
            N = j ? m : this.get(),
            V = b(_),
            I = r.is.num(V) || r.is.arr(V) || (0, r.Df)(V),
            L = !w && (!I || d(u.immediate || t.immediate, a));
          if (O) {
            const e = (0, o.sb)(_);
            if (e !== k.constructor) {
              if (!L)
                throw Error(
                  `Cannot animate between ${k.constructor.name} and ${e.name}, as the "to" prop suggests`,
                );
              k = this._set(V);
            }
          }
          const D = k.constructor;
          let M = (0, r.j$)(_),
            q = !1;
          if (!M) {
            const e = j || (!Q(this) && U);
            ((O || e) && ((q = (0, r.Xy)(b(N), V)), (M = !q)),
          ...
          if (
            ...
            !w &&
              ((M || (0, r.j$)(f)) &&
                ((l.values = k.getPayload()),
                (l.toValues = (0, r.j$)(_) ? null : D == o.eC ? [1] : (0, r.qo)(V))),
              l.immediate != L && ((l.immediate = L), L || j || this._set(f)),
              M))
          ) {
            const e = l.onRest;
            ...
            ((0, r.bl)(this._pendingCalls, i),
              ...
              l.changed &&
                r.Wn.batchedUpdates(() => {
                  ((l.changed = !j),
                    null == e || e(i, this),
                    j ? h(u.onRest, i) : null == l.onStart || l.onStart(i, this));
                }));
          }
          (j && this._set(N),
            w
      ...
      function ue() {
        return (
          (ue = a(function* (e, t, n) {
              ...
              f.push(
                k(++e._lastAsyncId, {
                  ...
                  actions: {
                    ...
                    resume: r.ZT,
                    start(t, n) {
                      v ? (N(d, e._lastAsyncId), n(R(e))) : ((t.onRest = u), n(C(h, t, d, e)));
                    },
                  },
                }),
              ),
            ...
            const _ = j(e, yield Promise.all(f));
      ...
      const pe = ["children"],
        ...
        _e =
          ((ge = ve),
          (me = {}),
          Object.assign(ge, i.createContext(me)),
            ...
            ((0, r.bt)(() => {
              ...
              (e.length && ((l.queue = []), (0, r.S6)(e, (e) => e())),
                (0, r.S6)(h.current, (e, t) => {
                  (null == s || s.add(e), m && e.start({ default: _ }));
                  const n = d[t];
      ...
      function We(e, t, n) {
        const o = r.is.fun(t) && t,
          ...
          g = s.ref,
          m = s.config,
          b = (0, i.useMemo)(() => (o || 3 == arguments.length ? ye() : void 0), []),
          W = (0, r.qo)(e),
          B = [],
          S = (0, i.useRef)(null),
          T = a ? null : S.current;
        ...
        const A = (function (e, { key: t, keys: n = t }, i) {
            if (null === n) {
              const t = new Set();
              return e.map((e) => {
          ...
          (T &&
            (0, r.S6)(T, (e, t) => {
              e.expired
                ...
                : ~(t = k[t] = A.indexOf(e.key)) && (B[t] = e);
            }),
          (0, r.S6)(W, (e, t) => {
            B[t] ||
              ((B[t] = { key: A[t], item: e, phase: Ue.MOUNT, ctrl: new oe() }),
              (B[t].ctrl.item = e));
          }),
          k.length)
        ) {
        ...
        (0, r.S6)(B, (e, n) => {
          ...
          j += d;
          const v = c({}, E, { delay: f + j, ref: g, immediate: a.immediate, reset: !1 }, u);
          ...
          const b = le(e.ctrl, v);
          R.set(e, { phase: l, springs: b, payload: v });
        });
      ...
      class we extends M {
        ...
        advance(e) {
          ...
          ((0, r.Xy)(t, n) || ((0, o.ys)(this).setValue(t), this._onChange(t, this.idle)),
            !this.idle && Se(this._active) && Te(this));
        }
        _get() {
        ...
        _start() {
          this.idle &&
            ...
            r.OH.skipAnimation
              ? (r.Wn.batchedUpdates(() => this.advance()), Te(this))
              : r.fT.start(this));
        }
        _attach() {
          let e = 1;
    ...
    398: (e, t, n) => {
      ...
      function g() {
        ...
        d = i.now();
        let t = c(d);
        (t && (y(l.splice(0, t), (e) => e.handler()), (b.count -= t)),
          s.flush(),
      ...
      const M = {
        ...
        start(e) {
          D > e.priority ? (V.add(e), i.onStart(q)) : (Q(e), i($));
        },
        advance: $,
        sort(e) {
      ...
      function $(e) {
        ...
        return ((D = 0), (L = I), (L.length = 0), (I = t), I.length > 0);
      }
      const z = {
          transparent: 0,
      ...
      const Ae = /rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,
        ...
        ke = (e) => {
          Te || (Te = E ? new RegExp(`(${Object.keys(E).join("|")})(?!\\w)`, "g") : /^\b$/);
          const t = e.output.map((e) => _e(e).replace(Be, ce).replace(Te, ce)),
          ...
          return (e) => {
            ...
            let o = 0;
            return t[0].replace(we, () => `${r[o++](e)}${i || ""}`).replace(Ae, xe);
          };
        },
        je = "react-spring: ",
        Pe = (e) => {
        ...
        Ee = Pe(console.warn);
      function Re() {
        Ee(`${je}The "interpolate" function is deprecated in v9 (use "to" instead)`);
      }
      const Ce = Pe(console.warn);
      function Ne() {
        Ce(
    ...
    45: (e, t, n) => {
      ...
      class b extends s.rS {
        constructor(e) {
          ...
          ((t || n || r) &&
            (s.push([t || 0, n || 0, r || 0]),
            u.push((e) => [`translate3d(${e.map((e) => m(e, "px")).join(",")})`, y(e, 0)])),
            (0, o.rU)(i, (e, t) => {
              if ("transform" === t) (s.push([e || ""]), u.push((e) => [e, "" === e]));
                ...
                (s.push((0, o.qo)(e)),
                  u.push(
                    "rotate3d" === t
                      ? ([e, t, r, i]) => [`rotate3d(${e},${t},${r},${m(i, n)})`, y(i, 0)]
                      : (e) => [
                          `${t}(${e.map((e) => m(e, n)).join(",")})`,
    ...
    187: (e, t, n) => {
      ...
      n.d(t, { A: () => r });
      const r =
        "battle/FallTanksBattleWidgetView/FallTanksBattleWidgetView" == n.j
          ? [
    ...
    484: (e, t, n) => {
      ...
      var c = 1e4,
        ...
        f = h.recordReactionAsCommitted,
        p = (h.resetCleanupScheduleForTests, h.forceCleanupTimerToRunNowForTests, !1);
      function v() {
        return p;
      }
      var _ = function (e, t) {
      ...
      function U(e, t) {
        ...
        return (
          ...
          (n = l.forwardRef ? (0, i.memo)((0, i.forwardRef)(h)) : (0, i.memo)(h)),
          (s = e),
          (u = n),
          Object.keys(s).forEach(function (e) {
            O[e] || Object.defineProperty(u, e, Object.getOwnPropertyDescriptor(s, e));
          }),
          (n.displayName = c),
          n
        );
      ...
      ((W = s.unstable_batchedUpdates) ||
        (W = function (e) {
          e();
        }),
        (0, r.jQ)({ reactionScheduler: W }));
    },
    305: (e, t, n) => {
      "use strict";
      function r(e) {
      ...
      function $(e, t, n) {
        ...
        var r = new Q(e);
        return (t !== _ && Et(kt, r, t, undefined), n !== _ && Pt(r, n), r);
      }
      var z = {
      ...
      function fe(e, t, n, r) {
        ...
        if (r !== e.target_ && "function" == typeof n.value)
          return U(n.value)
            ...
            : ((null == (s = this.options_) ? void 0 : s.autoBind) ? Tt.bound : Tt).make_(
                e,
                t,
                n,
                r,
      ...
      var ge = ae("observable"),
        me = ae("observable.ref", { enhancer: H }),
        ye = ae("observable.shallow", {
          enhancer: function (e, t, n) {
            return null == e || Cn(e) || mn(e) || Bn(e) || An(e)
              ? e
              : Array.isArray(e)
      ...
      var we,
        ...
        Se = s(Oe, {
          ...
          array: function (e, t) {
            var n = _e(t);
            return (!1 === ot.useProxies || !1 === n.proxy ? Fn : ln)(e, We(n), n.name);
          },
          map: function (e, t) {
            var n = _e(t);
        ...
        ke = function (e, t) {
          if (m(t)) return M(e, t, Ae);
          if (b(e)) return D(ie(Te, e));
          var n = b(t) ? t : {};
          return ((n.get = e), n.name || (n.name = e.name || ""), new Qe(n));
        };
      (Object.assign(ke, Ae), (ke.struct = D(xe)));
      var je,
        Pe = 0,
        Ee = 1,
        Re =
          ...
          case Me.POSSIBLY_STALE_:
            for (var t = Je(!0), n = Ye(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
              ...
              if (Fe(s)) {
                ...
                if (e.dependenciesState_ === Me.STALE_) return (Ze(n), et(t), !0);
              }
            }
          ...
          return (
            ...
            (t.runReaction_ = function () {
              if (!this.isDisposed_) {
                ...
                var e = ot.trackingContext;
                if (((ot.trackingContext = this), Ge(this))) {
            ...
            (t.dispose = function () {
              this.isDisposed_ ||
                ((this.isDisposed_ = !0), this.isRunning_ || (lt(), Ke(this), ct()));
            }),
      ...
      var mt = w("Reaction", ft),
        yt = "action",
        bt = "autoAction",
        Ut = X(yt),
        Wt = X("action.bound", { bound: !0 }),
        Ot = X(bt, { autoAction: !0 }),
        wt = X("autoAction.bound", { autoAction: !0, bound: !0 });
      function Bt(e) {
        return function (t, n) {
          return g(t)
            ? Ne(t.name || "<unnamed action>", t, e)
            : g(n)
              ? Ne(t, n, e)
              : m(n)
                ? M(t, n, e ? Ot : Ut)
      ...
      (Object.assign(Tt, Ot), (St.bound = D(Wt)), (Tt.bound = D(wt)));
      var xt = function (e) {
        return e();
      };
      var kt = "onBO",
      ...
      var Xt = {
        ...
        set: function (e, t, n) {
          var r;
          return !!m(t) && (null == (r = Kt(e).set_(t, n, !0)) || r);
        },
        deleteProperty: function (e, t) {
          var n;
          return !!m(t) && (null == (n = Kt(e).delete_(t, !0)) || n);
        },
      ...
      var vn,
        _n,
        gn = w("ObservableArrayAdministration", un);
      function mn(e) {
        return y(e) && gn(e[q]);
      }
      var yn = {},
        ...
        wn = (function () {
          ...
          return (
            ...
            (t.set = function (e, t) {
              var n = this.has_(e);
              if (Yt(this)) {
                var r = Jt(this, { type: n ? sn : bn, object: this, newValue: t, name: e });
                if (!r) return this;
                t = r.newValue;
              }
            ...
            (t.delete = function (e) {
              var t = this;
              if ((this.keysAtom_, Yt(this) && !Jt(this, { type: Un, object: this, name: e })))
                return !1;
              if (this.has_(e)) {
                var n = en(this),
                  r = n
            ...
            (t.replace = function (e) {
              ...
              return (
                Ht(function () {
                  ...
                  for (var c, h = I(i.entries()); !(c = h()).done;) {
                    var d = c.value,
                      f = d[0],
                      p = d[1],
                      v = t.data_.has(f);
                  ...
                  if (!s)
                    if (t.data_.size !== o.size) t.keysAtom_.reportChanged();
                      ...
                      for (
                        var g = t.data_.keys(), m = o.keys(), y = g.next(), U = m.next();
                        !y.done;
                      ) {
                        if (y.value !== U.value) {
                          t.keysAtom_.reportChanged();
      ...
      var Tn = (function () {
          ...
          return (
            ...
            (t.add = function (e) {
              var t = this;
              if ((this.atom_, Yt(this) && !Jt(this, { type: bn, object: this, newValue: e })))
                return this;
              if (!this.has(e)) {
                Ht(function () {
            ...
            (t.delete = function (e) {
              var t = this;
              if (Yt(this) && !Jt(this, { type: Un, object: this, oldValue: e })) return !1;
              if (this.has(e)) {
                var n = en(this),
                  r = n
                    ? {
        ...
        jn = (function () {
          ...
          return (
            ...
            (t.get_ = function (e) {
              return (
                ot.trackingDerivation && !k(this.target_, e) && this.has_(e),
                this.target_[e]
              );
            }),
      ...
      var En = w("ObservableObjectAdministration", jn);
      function Rn(e) {
        return (
          xn[e] ||
          (xn[e] = {
      ...
      ((Vn = Dn),
        ...
        Object.setPrototypeOf
          ? Object.setPrototypeOf(Vn.prototype, In)
          : void 0 !== Vn.prototype.__proto__
            ? (Vn.prototype.__proto__ = In)
            : (Vn.prototype = In));
      var Mn = (function (e) {
        function t(t, n, r, i) {
          var o;
      ...
      function $n(e, t) {
        if ("object" == typeof e && null !== e) {
          if (mn(e)) return (void 0 !== t && r(23), e[q].atom_);
          if (An(e)) return e[q];
          if (Bn(e)) {
      ...
      function Xn(e, t, n, r, i) {
        ...
        if ((r.push(e), i.push(t), a)) {
          ...
          for (; c--;) if (!Xn(e[c], t[c], n - 1, r, i)) return !1;
        } else {
          var h,
            d = Object.keys(e);
          if (((c = d.length), Object.keys(t).length !== c)) return !1;
          for (; c--;) if (!k(t, (h = d[c])) || !Xn(e[h], t[h], n - 1, r, i)) return !1;
        }
        return (r.pop(), i.pop(), !0);
      }
      function Yn(e) {
        return mn(e) ? e.slice() : B(e) || Bn(e) || S(e) || An(e) ? Array.from(e.entries()) : e;
      }
      function Zn(e) {
