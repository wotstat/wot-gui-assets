(() => {
  var e,
    t = {
      ...
      129: (e, t, n) => {
        ...
        var i = {};
        (n.r(i), n.d(i, { getBgUrl: () => D, getTextureUrl: () => W }));
        var l = {};
        (n.r(l),
          n.d(l, {
            addModelObserver: () => N,
        ...
        const f = g("clientResized"),
          ...
          E = g("clientMinimized"),
          w = (e, t) => engine.on(e, t),
          x = (e, t) => engine.off(e, t),
          b = { down: g("mousedown"), up: g("mouseup"), move: g("mousemove") },
          L = (function () {
        ...
        const H = {
          ...
          I = Object.keys(T).reduce((e, t) => ((e[t] = () => S(T[t])), e), {}),
          P = { play: Object.assign({}, I, { sound: S }), setRTPC: p },
        ...
        const he = { view: l, client: a, sound: P, intl: M };
        function fe(e, t) {
        ...
        const ve = (e) => (0 === e ? window : window.subViews.get(e)),
              ...
              function ({ mode: e = "real", options: r, children: a, mocks: i }) {
                const l = (0, o.useRef)([]),
                  u = (e, n, r) => {
                      ...
                      d = (({ observableModel: e }) => e.primitives(["isFinished"]))({
                        ...
                        observableModel: {
                          ...
                          primitives: (t, n) => {
                            const r = s(n);
                            if (Array.isArray(t)) {
                              const a = t.reduce((e, t) => ((e[t] = m.LO.box(r[t], {})), e), {});
                              return (
                                "real" === e &&
                                  o.subscribe(
                                    (0, m.aD)((e) => {
                            ...
                            }
                            {
                              const a = t,
                                i = Object.entries(a),
                                l = i.reduce((e, [t, n]) => ((e[n] = m.LO.box(r[t], {})), e), {});
                              return (
                                "real" === e &&
                                  o.subscribe(
                                    (0, m.aD)((e) => {
                    ...
                    return {
                      model: d,
                      controls: "mocks" === e && r ? r.controls(g) : t(g),
                      externalModel: o,
                      mode: e,
                    };
                  },
                  ...
                  h = g[0],
                  f = g[1],
                  v = (0, o.useState)(() => u(e, r, i)),
                  E = v[0],
                  w = v[1];
                return (
                  (0, o.useEffect)(() => {
                    d.current ? w(u(h, r, i)) : (d.current = !0);
                  }, [i, h, r]),
                  (0, o.useEffect)(() => {
                    f(e);
                  }, [e]),
                  ...
                  s().createElement(n.Provider, { value: E }, a)
                );
              },
              () => (0, o.useContext)(n),
            ];
          ...
          xe = Ee[1];
        var be = n(484);
        const Le = ({ headerText: e, descriptionText: t }) =>
          s().createElement(
            "div",
            { className: "Hint_base_f0b7c" },
            s().createElement("div", { className: "Hint_header_bdfc5" }, e),
            s().createElement("div", { className: "Hint_description_f1614" }, t),
          );
        var Se = n(849),
          pe = n.n(Se),
          ye = n(374);
        const _e = {
          ...
          He = ({ btnText: e, hasBlinkAnimation: t = !1, isBlinking: n = !1, isSmall: r = !1 }) => {
            const a = (0, o.useState)(!1),
              i = a[0],
              l = a[1],
              u = pe()(_e.btnOuter, _e.btnOuter__blink),
              d = pe()(_e.btnInner, _e.btnInner__blink),
              c = (0, ye.useSpring)({
                loop: !0,
                reset: i,
            ...
            return (
              ...
              s().createElement(
                "div",
                { className: pe()(_e.base, r && _e.__small) },
                s().createElement(
                  "div",
                  { className: _e.btnContainer },
                  s().createElement(
                    "div",
                    { className: _e.btnOuter },
                    s().createElement("div", { className: _e.btnInner }, e),
                  ),
                ),
                t &&
                  n &&
                  s().createElement(
                    ye.animated.div,
                    { className: _e.animationContainer, style: c },
                    s().createElement(
                      "div",
                      { className: u },
          ...
          Me = R.strings.ingame_gui.postmortem.tips.exitHangar,
          Te = (0, be.Pi)(() => {
            const e = xe().model.isFinished.get();
            return s().createElement(
              "div",
              { className: "App_base_cc021" },
              e &&
                s().createElement(
                  "div",
                  { className: "App_container_c9769" },
                  s().createElement(
                    "div",
                    { className: "App_btnContainer_eed8b" },
                    s().createElement(He, { btnText: Me.button() }),
                  ),
                  s().createElement(Le, { headerText: Me.label(), descriptionText: Me.text() }),
                ),
            );
          }),
          Re = (e, t, n) =>
        ...
        function Pe(e = he.client.getSize("rem")) {
          const t = e.width,
            n = e.height;
        ...
        (0, o.memo)((e) => {
          ...
          const r = (0, o.useContext)(Oe),
            ...
            b = { extraLarge: f, large: v, medium: E, small: w, extraSmall: x };
          if (n.extraLarge || n.large || n.medium || n.small || n.extraSmall) {
            ...
            if (n.extraLargeWidth && d) return Re(t, n, b);
            if (n.largeWidth && c) return Re(t, n, b);
            if (n.mediumWidth && m) return Re(t, n, b);
            if (n.smallWidth && g) return Re(t, n, b);
            if (n.extraSmallWidth && h) return Re(t, n, b);
            if (!(
              n.extraLargeWidth ||
              n.largeWidth ||
              n.mediumWidth ||
        ...
        const De = ({ children: e }) => {
          ...
          return (
            (0, o.useLayoutEffect)(() => {
              function e() {
                r((e) => {
                  ...
                  return e.width === t.width && e.height === t.height ? e : Pe(t);
                });
              }
              return (
                e(),
            ...
            s().createElement(Oe.Provider, { value: n }, i && e)
          );
        };
        var Ce = n(184),
          Ge = n.n(Ce);
        let $e = (function (e) {
            return (
              (e[(e.ExtraSmall = Ie.extraSmall.width)] = "ExtraSmall"),
              (e[(e.Small = Ie.small.width)] = "Small"),
              (e[(e.Medium = Ie.medium.width)] = "Medium"),
              (e[(e.Large = Ie.large.width)] = "Large"),
              (e[(e.ExtraLarge = Ie.extraLarge.width)] = "ExtraLarge"),
              e
            );
          })({}),
          ze = (function (e) {
          ...
          ke = (function (e) {
            return (
              (e[(e.ExtraSmall = Ie.extraSmall.height)] = "ExtraSmall"),
              (e[(e.Small = Ie.small.height)] = "Small"),
              (e[(e.Medium = Ie.medium.height)] = "Medium"),
              (e[(e.Large = Ie.large.height)] = "Large"),
              (e[(e.ExtraLarge = Ie.extraLarge.height)] = "ExtraLarge"),
              e
            );
          })({});
        ...
        const Be = {
            [ze.ExtraSmall]: "",
            [ze.Small]: Ge().SMALL_WIDTH,
            [ze.Medium]: `${Ge().SMALL_WIDTH} ${Ge().MEDIUM_WIDTH}`,
            [ze.Large]: `${Ge().SMALL_WIDTH} ${Ge().MEDIUM_WIDTH} ${Ge().LARGE_WIDTH}`,
            [ze.ExtraLarge]: `${Ge().SMALL_WIDTH} ${Ge().MEDIUM_WIDTH} ${Ge().LARGE_WIDTH} ${Ge().EXTRA_LARGE_WIDTH}`,
          },
          Fe = {
            [ke.ExtraSmall]: "",
            [ke.Small]: Ge().SMALL_HEIGHT,
            [ke.Medium]: `${Ge().SMALL_HEIGHT} ${Ge().MEDIUM_HEIGHT}`,
            [ke.Large]: `${Ge().SMALL_HEIGHT} ${Ge().MEDIUM_HEIGHT} ${Ge().LARGE_HEIGHT}`,
            [ke.ExtraLarge]: `${Ge().SMALL_HEIGHT} ${Ge().MEDIUM_HEIGHT} ${Ge().LARGE_HEIGHT} ${Ge().EXTRA_LARGE_HEIGHT}`,
          },
          Ne = {
            [$e.ExtraSmall]: "",
            [$e.Small]: Ge().SMALL,
            [$e.Medium]: `${Ge().SMALL} ${Ge().MEDIUM}`,
            [$e.Large]: `${Ge().SMALL} ${Ge().MEDIUM} ${Ge().LARGE}`,
            [$e.ExtraLarge]: `${Ge().SMALL} ${Ge().MEDIUM} ${Ge().LARGE} ${Ge().EXTRA_LARGE}`,
          },
          Ve = (e) => {
            let t = e.children,
              n = e.className,
            ...
            const a = (() => {
              ...
              l = a.mediaHeight,
              u = a.mediaSize;
            return s().createElement("div", je({ className: pe()(n, Be[i], Fe[l], Ne[u]) }, r), t);
          },
          Xe = ["children"],
          qe = (e) => {
            let t = e.children,
            ...
            return s().createElement(De, null, s().createElement(Ve, n, t));
          };
        engine.whenReady.then(() => {
          d().render(
            s().createElement(qe, null, s().createElement(we, null, s().createElement(Te, null))),
  ...
  ((r.m = t),
    ...
    (r.O = (t, n, a, i) => {
      if (!n) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [n, a, i] = e[d], o = !0, s = 0; s < n.length; s++)
    ...
    (r.j = "battle/FallTanksPostmortemInfoView/FallTanksPostmortemInfoView"),
    (() => {
      ...
      var t = (t, n) => {
          ...
          for (t && t(n); u < l.length; u++)
            ((i = l[u]), r.o(e, i) && e[i] && e[i][0](), (e[i] = 0));
          return r.O(d);
        },
        n = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (n.forEach(t.bind(null, 0)), (n.push = t.bind(null, n.push.bind(n))));
    })());
  var a = r.O(void 0, ["lib/fall_tanks.vendors"], () => r(129));
  a = r.O(a);
})();
