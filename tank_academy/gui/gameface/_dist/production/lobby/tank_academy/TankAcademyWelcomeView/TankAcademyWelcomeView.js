(() => {
  var __webpack_modules__ = {
      ...
      970: (u, e, t) => {
                ...
                const F = (0, r.useRef)([]),
                  o = (u, t, r) => {
                    ...
                    const E = (function ({
                      ...
                      D = (({ observableModel: u }) => ({
                        primitives: u.primitives(["vehiclesCount"]),
                      }))({
                        mode: u,
                        readByPath: i,
                        externalModel: A,
        ...
        class Z extends a().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              l = d()(V.base, V[`base__${n}`], V[`base__${E}`], null == A ? void 0 : A.base),
              _ = d()(V.icon, V[`icon__${n}`], V[`icon__${E}`], null == A ? void 0 : A.icon),
              B = d()(V.glow, null == A ? void 0 : A.glow),
              C = d()(V.caption, V[`caption__${n}`], null == A ? void 0 : A.caption),
              c = d()(V.goto, null == A ? void 0 : A.goto);
        ...
        const tu = ["xl", "lg", "md", "sm", "xs"],
          ...
          au = [p.ExtraLarge, p.Large, p.Medium, p.Small, p.ExtraSmall],
          Eu = (u, e) =>
            ...
            const W = (0, r.useMemo)(() => {
                const u = { mt: i, mr: o, mb: s, ml: _ },
                  ...
                  r = ((u) =>
                    Du.reduce((e, t) => {
                      const r = u[t];
                      return ("number" == typeof r && (e[su[t]] = r + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [t, E, i, o, s, _, k, P, L, m, O, f, M]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return a().createElement(
              "div",
              Fu({ className: d()(Au.base, ...U, e), style: G }, I),
              N,
            );
          });
        let _u;
        ...
        const Bu = (u, e, t) => {
          ...
          hu = ({ binding: u, text: e = "", classMix: t, alignment: E = _u.left }) =>
            null === e
        ...
        const fu = Object.keys(pu()),
          ...
          Ou = nu((u) => {
            ...
            return a().createElement(
              ...
              xu(
                {
                  className: d()(vu.base, t && vu[t], p, E),
                  style: g,
              ...
              void 0 !== c ? a().createElement(hu, xu({}, c, { text: e })) : e,
            );
          }),
          Ru = {
            ...
            const C = (0, r.useRef)(null),
              ...
              P = d()(
                ...
                Ru[`base__${E}`],
                {
                  ...
                  [Ru.base__firstHover]: x,
                },
                A,
              ),
              k = d()(Ru.state, Ru.state__default);
            return (
              (0, r.useEffect)(
                () => (
        ...
        const Hu = (0, r.memo)(yu),
          Pu = () => {
            ...
            return (
              (0, r.useEffect)(() => {
                (i(!0), z(R.sounds.ta_intro_open()));
              }, []),
              (F = t.onClose),
              I(k.n.ESCAPE, F),
              a().createElement(
                "div",
                { className: d()("App_base_00", A && "App_base__visible_4c") },
                a().createElement("div", { className: "App_background_6b" }),
                a().createElement(
                  "div",
                  { className: "App_close_07" },
                  a().createElement(Z, {
                    caption: R.strings.tank_academy.welcomeView.button.closeButton(),
                    type: "close",
                    side: "right",
                    onClick: t.onClose,
                  }),
                ...
                a().createElement(
                  "div",
                  { className: "App_content_b3" },
                  a().createElement(Ou, {
                    className: "App_title_39",
                    text: R.strings.tank_academy.welcomeView.title(),
                  }),
                  a().createElement(Ou, {
                    className: "App_subtitle_8e",
                    text: R.strings.tank_academy.welcomeView.subtitle(),
                    format: { binding: { count: e.primitives.vehiclesCount.get() } },
                  }),
                ),
                a().createElement(
                  "div",
                  { className: "App_buttons_cb" },
                  a().createElement(
                    Hu,
                    {
                      mixClass: "App_continueButton_0b",
                      type: Q.primary,
                      size: E < p.Medium ? J.small : J.medium,
                      onClick: t.onClose,
                    },
                    a().createElement(Ou, {
                      text: R.strings.tank_academy.welcomeView.button.continueButton(),
                    }),
                  ),
                ),
              )
        ...
        engine.whenReady.then(() => {
          P().render(
            a().createElement(y, null, a().createElement(K, null, a().createElement(Pu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(970));
