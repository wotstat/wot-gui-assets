(() => {
  ...
  var __webpack_modules__ = {
      ...
      139: (u, e, t) => {
          ...
          f = (0, n.forwardRef)(
            (
              ...
              const a = (0, n.useRef)(null),
                ...
                D = c[1],
                d = (0, n.useCallback)(() => {
                  (b.playClick(), v.O.view.sendEvent.close());
                }, []),
                B = (0, n.useCallback)(() => {
                  b.playHighlight();
                }, []),
                g = E()(w.arrow, w[`arrow${h[l]}`]);
              m(
                () => (
        ...
        const H = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: r, children: i, mocks: a }) {
                const E = (0, n.useRef)([]),
                  A = (u, t, n) => {
                    var o;
                    const r = (function ({
                      ...
                      F = (({ observableModel: u }) => {
                        ...
                        return {
                          computes: {
                            getTypes: (0, V.computedFn)(() => U(e.types.get(), S)),
                            getNations: (0, V.computedFn)(() => U(e.nations.get(), S)),
                          },
                        };
                      })({
                        mode: u,
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const o = e.reduce(
                                (u, e) => ((u[e] = N.observable.box(n[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const o = e,
                                r = Object.entries(o),
                                a = r.reduce(
                                  (u, [e, t]) => ((u[t] = N.observable.box(n[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      s = { mode: u, model: F, externalModel: i, cleanup: A };
                    return {
                      model: F,
                  ...
                  c = s[0],
                  l = s[1],
                  D = (0, n.useState)(() => A(u, r, a)),
                  d = D[0],
                  B = D[1];
                return (
                  (0, n.useEffect)(() => {
                    F.current ? B(A(c, r, a)) : (F.current = !0);
                  }, [a, c, r]),
                  (0, n.useEffect)(() => {
                    l(u);
                  }, [u]),
            ...
            toggleType: u.createCallback((u) => ({ type: u }), "onToggleFilter"),
        ...
        const Y = () => {},
          X = o().memo(
            ({
              ...
              className: e,
              children: t,
              toggleType: r = q.Button,
              toggleButtonType: i = K.secondary,
              onClick: a,
              disabled: A,
              soundClick: F = "play",
              ...
              const B = (0, n.useCallback)(
                ...
                v = E()(G.base, e, G[`base__${r}`], u && G.base__active, A && G.base__disabled);
              return o().createElement(
                "div",
                {
                  className: v,
                ...
                o().createElement("div", { className: G.content }, t),
                r === q.Button &&
                  o().createElement(
                    o().Fragment,
                    null,
                    o().createElement("div", {
                      className: E()(G.background, G[`background__${i}`]),
                    }),
                    o().createElement("div", { className: G.texture }),
                  ),
                o().createElement("div", { className: G.overlay }),
                o().createElement("div", { className: G.indicator }),
              );
            },
          ),
          $ = [],
          Z = ({ name: u, isSelected: e, toggleIconResolver: t, onToggleClick: r }) => {
            const i = (function (u) {
              ...
              return (
                ...
                (0, n.useCallback)((...u) => (0, e.current)(...u), $)
              );
            })(() => r(u));
            return o().createElement(
              "div",
              { className: "Toggle_base_b8" },
              o().createElement(
                X,
                { onClick: i, active: e },
                o().createElement("div", {
                  className: "Toggle_icon_f3",
                  style: { backgroundImage: `url(${t(u)})` },
                }),
              ),
            );
          },
          Q = ({ toggles: u, title: e, className: t, onToggleClick: n, toggleIconResolver: r }) =>
            o().createElement(
              "div",
              { className: E()("FilterSection_base_69", t) },
              o().createElement("div", { className: "FilterSection_title_ab" }, e),
              o().createElement(
                "div",
                { className: "FilterSection_controls_b6" },
                u.map((u, e) =>
                  o().createElement(
                    "div",
                    { key: e, className: "FilterSection_toggle_20" },
                    o().createElement(Z, {
                      name: u.name,
          ...
          J = R.strings.tank_academy.vehiclesSelection.filterPopover,
          uu = (u) => R.images.gui.maps.icons.vehicleTypes.$dyn(P(u)),
          eu = (u) => R.images.gui.maps.icons.filters.nations.$dyn(P(u)),
          tu = (0, M.observer)(() => {
            const u = W(),
              e = u.model,
              t = u.controls,
              ...
              a = r[1],
              E = (0, n.useRef)(null),
              F = e.computes.getTypes(),
              s = e.computes.getNations(),
              c = (0, n.useMemo)(() => ({ arrow: { left: `${i}%` } }), [i]);
            return (
              ...
              o().createElement(
                ...
                o().createElement(
                  ...
                  o().createElement(
                    "div",
                    { ref: E, className: "App_base_0f" },
                    o().createElement(
                      "div",
                      { className: "App_header_6b" },
                      o().createElement("div", { className: "App_title_87" }, J.title()),
                    ),
                    o().createElement("div", { className: "App_divider_50" }),
                    o().createElement(
                      "div",
                      { className: "App_body_0a" },
                      o().createElement(Q, {
                        toggles: F,
                        toggleIconResolver: uu,
                        title: J.type(),
                        onToggleClick: t.toggleType,
                        className: "App_section_e3",
                      }),
                      o().createElement(Q, {
                        toggles: s,
                        toggleIconResolver: eu,
                        title: J.nation(),
        ...
        engine.whenReady.then(() => {
          i().render(
            o().createElement(j, null, o().createElement(tu, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(139));
