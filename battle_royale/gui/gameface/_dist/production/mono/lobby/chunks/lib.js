...
function compose(e, t, s, r, n, a, u, o, i) {
  switch (arguments.length) {
    case 1:
      return e;
    case 2:
    ...
    case 7:
      return function () {
        return u(a(n(r(s(t(e.apply(this, arguments)))))));
      };
    case 8:
      return function () {
        return o(u(a(n(r(s(t(e.apply(this, arguments))))))));
      };
    case 9:
      return function () {
        return i(o(u(a(n(r(s(t(e.apply(this, arguments)))))))));
      };
  }
}
...
function eq(e, t, s, r, n) {
  ...
  const u = toString.call(e);
  if (u !== toString.call(t)) return !1;
  switch (u) {
    case "[object RegExp]":
    case "[object String]":
  ...
  if ((r.push(e), n.push(t), l)) {
    ...
    for (; c--;) if (!eq(o[c], i[c], s - 1, r, n)) return !1;
  } else {
    ...
    for (; c--;) {
      ...
      if (!Object.prototype.hasOwnProperty.call(i, t) || !eq(o[t], i[t], s - 1, r, n)) return !1;
    }
  }
...
const justCall = (e) => e(),
  ...
  usePreloadImagesState = (e, t) => {
    const [s, r] = reactExports.useState("pending");
    return (
      reactExports.useLayoutEffect(() => {
        let t = 0,
          s = 0;
        const n = () => {
          t + s === e.length && r(0 === t ? "success" : "error");
        };
        e.forEach((e) => {
          const r = new Image();
          ((r.src = e),
    ...
    const e = (e) => {
      i((n) => {
        ...
        return (
          isDuration(r) &&
            ("countdown" === t
              ? lt(subtract(a, s), r) && ((u.current = r), (u.running = !1))
              : gt(add(a, s), r) && ((u.current = r), (u.running = !1))),
          u
        );
      });
    };
    l.current = window.setInterval(() => {
      o.running ? e(s) : window.clearInterval(l.current);
    }, u);
...
function useTooltip({
  ...
  const u = reactExports.useRef({ status: statuses.idle, resId: e, timeoutId: 0 }),
    [o, i] = reactExports.useMemo(() => {
      ...
      function i() {
        r ||
          ("display" === u.current.status &&
            (sendEvent$1.tooltip.hide(e, t, s), (u.current.status = statuses.idle)),
...
const DELAY = 950;
function useServerTimePolling(e, t, s, r = DELAY) {
  useInterval(
    () => {
      s();
    },
...
function cloneModel(e, { shallow: t = !0, depth: s = 0, maxDepth: r = 32 } = {}) {
  ...
  if (Array.isArray(n)) return n.map((e) => cloneModel(e, u));
  if ("object" === a) {
    ...
    const a = {};
    for (const e of Object.keys(n)) a[e] = cloneModel(n[e], u);
    return a;
  }
...
const initializeModelWithContext =
    ...
    (t, s, r) => {
      ...
      function a(a) {
        const { mode: u, options: o, children: i, mocks: l } = a,
          c = useMockContext(),
          d = u ?? c.mode,
          m = l ?? c.mocks,
          ...
          E = r?.useRequires?.(),
          _ = useEvent((n, u, o) => {
            const i = "real" !== n && o ? createMockInstance(o.getter, u) : create(u, { name: e }),
              l = (e) => ("mocks" === n ? o?.getter(e, u) : i.readByPath(e)),
              ...
              _ = { ...d, mode: n, model: m, externalModel: i, cleanup: c, requires: E },
              g = "mocks" === n && o?.controls ? o.controls(_) : {};
            return {
              model: m,
              controls: { ...s?.(_), ...g },
              externalModel: i,
          ...
          [x, f] = reactExports.useState(d);
        reactExports.useEffect(() => {
          f(d);
        }, [d]);
        const [h, b] = reactExports.useState(() => _(x, o, m));
        return (
          reactExports.useEffect(() => {
            g.current ? b(_(x, o, m)) : (g.current = !0);
          }, [_, m, x, o?.context, o?.initializer, o?.getRoot, o?.rootId]),
          reactExports.useEffect(
            () => () => {
          ...
          jsxRuntimeExports.jsx(n.Provider, { value: h, children: i })
        );
      }
      return (
        (a.displayName = e),
...
async function runView(
  ...
  const a = s ? MediaWrapper : React.Fragment,
    u = window?.engine?.whenReady ?? Promise.resolve();
...
const base$x = "HeadlessButton_df8536fc",
  styles$D = { base: base$x },
  ...
  Button = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(HeadlessButton, {
      ...
      className: clsx(
        styles$C.base,
        styles$C[`base__size-${t}`],
        styles$C[`base__theme-${s}`],
        r ? styles$C.base__disabled : styles$C.base__enabled,
        o,
        u?.base,
      ),
      onClick: function (e) {
      ...
      children: [
        jsxRuntimeExports.jsx("div", { className: clsx(styles$C.background, u?.background) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$C.border, u?.border) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$C.overlay, u?.overlay) }),
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$C.content, a && styles$C.content__fontAligned, u?.content),
          children: e,
        }),
      ],
    });
...
const base$v = "CloseButton_7488a1b8",
  base__medium$1 = "CloseButton_base__medium_97d04067",
  base__small$6 = "CloseButton_base__small_c1b29bae",
...
function CloseButton({
  ...
  const u = useUpscale(styles$B[`base__${e}`], styles$B[`base__${upscaleImageSizes[e]}`]);
  return jsxRuntimeExports.jsx("div", {
    className: cx(styles$B.base, u, r),
    onMouseEnter: () => {
      (play.sound(t), n?.());
    },
    onClick: () => {
  ...
  getRewardImage$1 = (e, t = ImageSize$1.Small) => {
    ...
    switch (s) {
      ...
      case "dogTagComponents":
        return getDogTypeImage$1(o, t, a);
      case "dossier_badge":
...
const handleViewEvent = (e, t, s = {}, r = 0) => {
  ...
  Reward$1 = ({
    ...
    const p = getBottomHighlight$1(r, n),
      E = getOverlay$1(n),
      _ = getFormattedValue$1(a, u);
    return jsxRuntimeExports.jsxs("div", {
      className: cx(
        styles$A.base,
        styles$A[`base__${r}`],
        NORMALIZE_OVERLAYS_LIST.includes(e) && styles$A.base__normalize,
        l,
      ),
      style: i,
      children: [
        jsxRuntimeExports.jsx(DynamicTooltipWrapper, {
          tooltipArgs: d,
          className: styles$A.tooltipWrapper,
          children: jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [
              jsxRuntimeExports.jsxs("div", {
                className: cx(styles$A.image, c?.image),
                children: [
                  p &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$A.highlight, c?.highlight),
                      style: {
                  ...
                  t &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$A.icon, c?.rewardIcon),
                      style: { backgroundImage: `url(${t})` },
                    }),
                  E &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$A.overlay, c?.overlay),
                      style: {
              ...
              _ &&
                jsxRuntimeExports.jsx("div", {
                  className: cx(
                    styles$A.info,
                    styles$A[`info__${e}`],
                    u === ValueTypes$1.MULTI && styles$A.info__multi,
                    c?.info,
                  ),
                  children: _,
                }),
              o &&
                jsxRuntimeExports.jsx("div", {
                  className: cx(styles$A.title, c?.title),
                  children: o,
                }),
            ],
          }),
        ...
        s &&
          jsxRuntimeExports.jsx(DynamicTooltipWrapper, {
            ...
            children: jsxRuntimeExports.jsx("div", {
              className: cx(styles$A.timer, c?.periodicIcon),
            }),
          }),
      ],
    });
...
function createGridImgSourceGetter(e) {
  ...
  return (r) => {
    const n = r % s,
      a = (n % t.columns) * e.width,
      u = Math.trunc(n / t.columns) * e.height;
    return { path: e.getChunkPath(Math.trunc(r / s)), x: a, y: u };
  };
}
...
const CanvasSequence = reactExports.memo(function ({
    ...
    frameCount: r,
    onAnimate: n,
    frameTime: a = DEFAULTS.FRAME_TIME,
    initialFrameIndex: u = DEFAULTS.INITIAL_FRAME_INDEX,
    lastFrameIndex: o = r - 1,
    loop: i = DEFAULTS.LOOP,
    ...
    return (
      reactExports.useEffect(
        () => createLayoutReadyInEffect$1(() => createLayoutReadyInEffect$1(() => x(!1))),
        [],
      ),
      reactExports.useEffect(() => {
        const e = _.current;
        ...
        switch (l) {
          case "play":
            return (function () {
              const e = generateImages(u, o, s),
                t = createFrameCounter(u, o, c),
                l = window.setInterval(() => {
                  const s = t(),
                    a = e.get(s);
                  a
                    ? (n?.(s, a), r(a), s === o && (m?.(), i || (d?.(), window.clearInterval(l))))
          ...
          case "stop":
            return (function () {
              const e = 0 === u && p ? { path: p, x: 0, y: 0 } : s(u),
                t = new Image();
              t.src = e.path;
              const n = () => r(createFrameImage(e, t));
      ...
      }, [g, a, s, u, o, i, n, m, d, p, c, l]),
      jsxRuntimeExports.jsx("canvas", { ...E, width: e, height: t, ref: _ })
    );
  }),
  createFrameCounter = (e, t, s = e) => {
    let r = s;
    return () => {
      const s = r;
      return ((r += 1), r > t && (r = e), s);
    };
  },
  ...
  generateImages = (e, t, s) => {
    ...
    for (let a = e; a <= t; a++) {
      const e = s(a),
        t = n[e.path];
      if (t) r.set(a, createFrameImage(e, t));
      else {
        const t = new Image();
        ((n[e.path] = t),
          (t.src = e.path),
          (t.onerror = () => {
            console.error(`[CanvasSequence] Error loading image(${a})`, e.path, `(${e.x},${e.y})`);
          }),
          r.set(a, createFrameImage(e, t)));
      }
    }
    return r;
  };
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, " "),
  ...
  base$t = "Formattext_bb80854d",
  styles$z = { base: base$t },
  FormatText$1 = ({
    binding: e,
    text: t = "",
    classMix: s,
...
const themes = { primary: "primary", custom: "custom" },
  ...
  Base$7 = defineStyledComponent("Tabs", styles$y.base, {
    variants: {
      size: {
        [sizes$5.large]: styles$y["base__size-large"],
        [sizes$5.medium]: styles$y["base__size-medium"],
        [sizes$5.small]: styles$y["base__size-small"],
      },
      theme: { [themes.primary]: styles$y["base__theme-primary"], [themes.custom]: void 0 },
    },
  }),
  Switcher = reactExports.forwardRef(function ({ children: e, classNames: t, ...s }, r) {
    ...
    return jsxRuntimeExports.jsx(Base$7, {
      ...
      children: jsxRuntimeExports.jsxs("div", {
        className: clsx(styles$y.outerBorder, t?.outerBorder),
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$y.outerBorderImage, t?.outerBorderImage),
          }),
          jsxRuntimeExports.jsxs("div", {
            className: clsx(styles$y.mainBorder, t?.mainBorder),
            children: [
              jsxRuntimeExports.jsx("div", {
                className: clsx(styles$y.mainBorderImage, t?.mainBorderImage),
              }),
              jsxRuntimeExports.jsx("div", {
  ...
  background$4 = "Tab_background_4c9b3eb9",
  ...
  Base$6 = defineStyledComponent("Tab", styles$x.base, {
    variants: {
      size: {
        [sizes$5.large]: styles$x["base__size-large"],
        [sizes$5.medium]: styles$x["base__size-medium"],
        [sizes$5.small]: styles$x["base__size-small"],
      },
      theme: { [themes.primary]: styles$x["base__theme-primary"], [themes.custom]: void 0 },
  ...
  HeadlessTab = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Base$6, {
      ...
      onMouseEnter: function (e) {
        (r !== s && l.play("mouse-enter", { target: Base$6.displayName, original: e }), u?.(e));
      },
      onClick: function (e) {
        (r !== s && l.play("click", { target: Base$6.displayName, original: e }), a?.(e));
      },
      children: n,
    });
  });
function Tab({ tabId: e, classNames: t, className: s, children: r, ...n }) {
  ...
  return jsxRuntimeExports.jsxs(HeadlessTab, {
    ...
    children: [
      jsxRuntimeExports.jsx("div", { className: clsx(styles$x.background, t?.background) }),
      jsxRuntimeExports.jsx("div", {
        className: clsx(styles$x.backgroundPattern, t?.backgroundPattern),
      }),
      jsxRuntimeExports.jsx("div", { className: clsx(styles$x.border, t?.border) }),
      jsxRuntimeExports.jsx("div", { className: clsx(styles$x.innerBorderImage, t?.borderImage) }),
      jsxRuntimeExports.jsx("div", { className: clsx(styles$x.content, t?.content), children: r }),
    ],
  });
}
    ...
    return (o = {}) => {
      const { settings: i = defaultSettings } = o,
        ...
        h = reactExports.useCallback(
          ...
          [g.scrollPosition, x, i.animationConfig, _],
        ),
        ...
        A = reactExports.useCallback(
          ...
          [g.scrollPosition, b, E, l],
        ),
        F = reactExports.useCallback(
          function () {
            const e = d.current;
            e && (h(u(e, g.scrollPosition.goal), { immediate: !0 }), E.trigger("resizeHandled"));
          },
          [h, g.scrollPosition.goal, E],
        );
      useRefResizeObserver(m, (e) => {
        const t = e.target;
        if (!(t instanceof HTMLElement)) return;
        const s = n(t);
        p.current.wrapper !== s && F();
      });
      const D = useEvent(function () {
          const t = d.current;
          if (!t) return;
          const s = e(t),
            r = m.current ? n(m.current) : 0;
          if (p.current.container !== s || p.current.wrapper !== r) {
            const e = u(t, g.scrollPosition.goal);
            (e !== g.scrollPosition.goal && h(e, { immediate: !0 }),
        ...
        y = useSkipFrame();
      reactExports.useEffect(() => addEventListener(window, "resize", () => y.run(F)), [F, y]);
      return reactExports.useMemo(
        () => ({
...
function Thumb(e) {
  ...
  reactExports.useEffect(() => {
    s || e.dragging
      ? u.start({
          to: e.styles.opened,
          onRest() {
            t.current?.classList.add(styles$w.base__active);
          },
        })
      : u.start({
          to: e.styles.closed,
          delay: 500,
          onRest() {
            t.current?.classList.remove(styles$w.base__active);
          },
        });
  ...
  return (
    ...
    jsxRuntimeExports.jsxs(animated.div, {
      ...
      className: clsx(styles$w.base, styles$w[`base__${e.direction}`], e.className),
      style: a,
      onMouseEnter: () => r(!0),
      onMouseLeave: () => r(!1),
      children: [
        jsxRuntimeExports.jsx("div", { className: styles$w.background }),
        jsxRuntimeExports.jsx("div", { className: styles$w.border }),
        jsxRuntimeExports.jsx("div", { className: styles$w.innerBorder }),
        jsxRuntimeExports.jsx("div", { className: styles$w.icon }),
      ],
    })
  );
}
  ...
  const d = reactExports.useCallback(
    ...
    p = reactExports.useCallback(
      (i) => {
        ...
        const _ = getCoordinate(i, l, c, p, E, u),
        ...
        if (g) a({ pending: !0, offset: _.occurredEvent - _.thumb.start });
        else if (x) {
        ...
        o.play("click", { target: "Scroll:" + (g ? "thumb" : x ? "button" : ""), original: i });
      },
      [e, t, s, r, o, u, a, d, m, n],
    ),
...
const rail$1 = "HorizontalBar_rail_37858d8f",
  ...
  Bar$1 = reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop }) {
    ...
    const m = useEvent(
      ...
      g = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
        ...
        ((n.style.width = `${t - l + s}px`),
          (u.style.width = r.offsetWidth - e - t - l - s + "px"));
      }),
      { handleMouseEnter: x, handleMouseDownTrack: f } = useBarHandlers(
        s,
        u,
        n,
        r,
    ...
    return jsxRuntimeExports.jsxs("div", {
      className: clsx(styles$v.base, e.base),
      ref: s,
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          ref: r,
          className: clsx(styles$v.button, styles$v.button__left, e.leftButton),
        }),
        jsxRuntimeExports.jsxs("div", {
          ref: a,
          className: clsx(styles$v.track, e.track),
          children: [
            jsxRuntimeExports.jsx("div", {
              ref: o,
              className: clsx(styles$v.rail, styles$v.rail__left, e.leftRail),
            }),
            ...
            jsxRuntimeExports.jsx("div", {
              ref: i,
              className: clsx(styles$v.rail, styles$v.rail__right, e.rightRail),
            }),
          ],
        }),
        jsxRuntimeExports.jsx("div", {
          ref: n,
          className: clsx(styles$v.button, styles$v.button__right, e.rightButton),
        }),
      ],
    });
  }),
  ...
  styles$u = { base: base$o, wrapper: wrapper$2, defaultScrollArea: defaultScrollArea },
  DefaultScroll$1 = ({
    children: e,
    className: t,
    barClassNames: s,
    ...
    const { api: o } = useHorizontalScroll(),
      i = reactExports.useMemo(() => {
        const e = s || {};
        return { ...e, base: clsx(styles$u.base, e.base) };
      }, [s]);
    return jsxRuntimeExports.jsxs("div", {
      className: clsx(styles$u.defaultScroll, t),
      onWheel: o.handleMouseWheel,
      children: [
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$u.defaultScrollArea, r),
...
function Area$1({ className: e, classNames: t, children: s }) {
  ...
  return jsxRuntimeExports.jsx("div", {
    className: clsx(styles$u.base, e),
    children: jsxRuntimeExports.jsx("div", {
      className: clsx(styles$u.wrapper, t?.wrapper),
      onWheel: r.handleMouseWheel,
      ref: r.wrapperRef,
      children: jsxRuntimeExports.jsx("div", {
        className: clsx(styles$u.content, t?.content),
        ref: r.contentRef,
        children: s,
      }),
    }),
  ...
  return (
    ...
    reactExports.useEffect(() => {
      ...
      const r = mouse.move(([e]) => {
        ...
        u = mouse.up(() => m({ type: "scrollComplete" }));
      return () => {
        (r(), u());
      };
    }, [i.scrollPosition, n, p, t, d, _, a]),
    reactExports.useEffect(() => {
      ...
      const e = mouse.move(([e, r]) => {
        ...
        const E = c.offsetLeft,
          _ = "inside" === r ? p : p - E,
          g = d.positionFrom - _,
          x = d.previousScrollPosition + g;
        u.start({
          scrollPosition: o(l, x),
    ...
    }, [i.scrollPosition, o, n, d, u, a, s, t]),
    reactExports.useEffect(() => {
...
const DEFAULT_VERTICAL_API_CONFIG = {
  ...
  Bar = reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop }) {
    ...
    const m = useEvent((e) => e - (a.current.offsetHeight - u.current.offsetHeight) >= -0.5),
      ...
      g = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
        ...
        ((n.style.height = `${t - l + s}px`),
          (u.style.height = r.offsetHeight - e - t - l - s + "px"));
      }),
      { handleMouseEnter: x, handleMouseDownTrack: f } = useBarHandlers(
        s,
        u,
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          ref: r,
          className: clsx(styles$t.button, styles$t.button__top, e.topButton),
        }),
        jsxRuntimeExports.jsxs("div", {
          ref: a,
          ...
          children: [
            jsxRuntimeExports.jsx("div", {
              ref: o,
              className: clsx(styles$t.rail, styles$t.rail__top, e.topRail),
            }),
            jsxRuntimeExports.jsx(Thumb, {
              dragging: l,
              api: d,
            ...
            jsxRuntimeExports.jsx("div", {
              ref: i,
              className: clsx(styles$t.rail, styles$t.rail__bottom, e.bottomRail),
            }),
          ],
        }),
        jsxRuntimeExports.jsx("div", {
          ref: n,
          className: clsx(styles$t.button, styles$t.button__bottom, e.bottomButton),
        }),
      ],
    });
  }),
  ...
  styles$s = { content: content$1, defaultScroll: defaultScroll, area: area },
  DefaultScroll = ({
    children: e,
    className: t,
    barClassNames: s,
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$s.area, r),
  ...
  Area = ({ className: e, classNames: t, children: s, ...r }) => {
    ...
    return (
      ...
      jsxRuntimeExports.jsx("div", {
        className: clsx(styles$s.base, t?.wrapper, e),
        ref: n.wrapperRef,
...
const Sound = {
  ...
  ContextMenu = ({
    ...
    return (
      ...
      a ? reactExports.cloneElement(e, { onMouseDown: l }) : e
    );
  },
    ...
    return (
      ...
      jsxRuntimeExports.jsx(SimpleTooltip, {
        ...
        children: jsxRuntimeExports.jsx("div", {
          ...r,
          ref: n,
          className: cx(styles$r.base, s, t),
          children: e,
        }),
      })
    );
...
const base$l = "Progressbar_a6e35bd7",
  ...
  ProgressBarBackground = ({ size: e = Size.Default }) => {
    const t = cx(styles$q.background, styles$q[`background__${e}`]);
  ...
  styles$p = { base: base$k, base__small: base__small$3 },
  ProgressBarBlink = ({ size: e }) => {
    const t = cx(styles$p.base, styles$p[`base__${e}`]);
    return jsxRuntimeExports.jsx("div", { className: t });
  },
  ...
  ProgressLineImposeComponent = ({
    ...
    const u = cx(
        ...
        n && styles$o.base__finished,
        a && styles$o.base__withoutBounce,
      ),
      o = !s && !n;
    return jsxRuntimeExports.jsxs("div", {
      className: u,
      ...
      ref: t,
      children: [
        jsxRuntimeExports.jsx("div", { className: styles$o.pattern }),
        jsxRuntimeExports.jsx("div", { className: styles$o.gradient }),
...
const base$i = "Progressbardeltagrow_c42a7a2c",
  ...
  styles$n = { base: base$i, base__withoutBounce: base__withoutBounce, glow: glow$1 },
  ...
  ProgressBarDeltaGrowComponent = ({
    ...
    reactExports.useEffect(() => {
      if (!s)
        return p
          ? x(GrowAnimationState.Grow, t)
          : E
            ? x(GrowAnimationState.Shrink, e)
            : _
              ? x(GrowAnimationState.End, e)
              : void (m && u && u());
    }, [x, s, m, E, p, _, u, t, e]);
    ...
    if (m) return null;
    const F = cx(styles$n.base, i, l && 0 === a && styles$n.base__withoutBounce);
    return jsxRuntimeExports.jsx("div", {
      style: p ? b : A,
      className: F,
      children: jsxRuntimeExports.jsx("div", {
  ...
  styles$m = { base: base$h, delta: delta$1 },
  ProgressBarDeltaSimpleComponent = ({
    ...
    (reactExports.useEffect(() => {
      ...
      reactExports.useEffect(() => {
        if (d) {
          return createTimeoutInEffect(() => {
            (u && u(), E(SimpleAnimationState.End));
          }, e + t);
        }
      }, [E, d, u, t, e]));
...
const defaultTheme = Orange,
  ...
  ProgressBarComponent = ({
    ...
    const E = useCalculatePercents(u, e, o);
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$q.base, p, styles$q[`base__${s}`]),
      style: createSkin(t),
      children: [
...
(sizes$4.extraSmall, sizes$4.small, sizes$4.medium, sizes$4.large, sizes$4.extraLarge, sizes$4.xxl);
const base$g = "Currency_72d4be39",
  ...
  Base$3 = defineStyledComponent("Currency", styles$l.base, {
...
function Currency({
  ...
  return jsxRuntimeExports.jsxs(Base$3, {
    ...o,
    className: clsx(r?.base, u ? styles$l[`base__${t}`] : styles$l.base__notEnough, s),
    children: [
      m &&
        jsxRuntimeExports.jsx(Image$1, { width: i, height: i, path: n ?? p, className: r?.icon }),
...
const roles = {
  ...
  Base$2 = defineStyledComponent("VehicleImage", {
    ...
    cva: {
      variants: {
        size: {
          [sizes$3.x120x96]: styles$k.base__x120x96,
          [sizes$3.x190x152]: styles$k.base__x190x152,
          [sizes$3.x380x304]: styles$k.base__x380x304,
        },
      },
    },
  });
function UnknownVehicleImage({ size: e = sizes$3.x380x304, ...t }) {
  return jsxRuntimeExports.jsx(Base$2, { ...t, size: e, path: `vehicle.${e}.tank_empty` });
}
const VehicleImage = reactExports.forwardRef(function (
  { size: e = sizes$3.x380x304, name: t, width: s, height: r, className: n, ...a },
  u,
) {
  const o = resources.resolve("images"),
...
const VehicleLevel = reactExports.forwardRef(function ({ value: e, numberType: t, ...s }, r) {
  ...
  return jsxRuntimeExports.jsx("div", {
    ...
    className: clsx(styles$j.base, s.className),
    ref: r,
    children: n,
  });
});
...
const SvgAssaultX16X16 = (e) =>
  ...
  VehicleRole = reactExports.forwardRef(function (
    { roleKey: e, size: t = sizes$2.x24x24, classNames: s, ...r },
    n,
  ) {
...
const sizes$1 = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
  ...
  VehicleType = reactExports.forwardRef(function (
    { type: e, size: t = sizes$1.x48x48, premium: s = !1, fit: r = "contain", ...n },
    a,
  ) {
    const u = useUpscale(sizes$1[t], upscaledSizes[t]);
    return jsxRuntimeExports.jsx(Image$1, {
      ...
      className: clsx(
        styles$g.base,
        s ? styles$g[`base__premium__${t}`] : styles$g[`base__${t}`],
        n.className,
      ),
      path: `ui_kit.vehicle_type.${u}.${s ? "premium_" : ""}${normalizeResource(mapTypes[e])}_${u}`,
    });
  });
...
const base$b = "VehicleInfo_1732f1f0",
  ...
  VehicleInfo = reactExports.forwardRef(function (e, t) {
    return jsxRuntimeExports.jsx("div", {
      ...e,
      ref: t,
      className: clsx(styles$f.base, e.className),
    });
  });
...
const COLORS =
  ...
  base$a = "FormatText_db904f12",
  base__fullSize = "FormatText_base__fullSize_a514958e",
  nowrap = "FormatText_nowrap_ff69eca3",
  styles$e = { COLORS: COLORS, base: base$a, base__fullSize: base__fullSize, nowrap: nowrap },
  legacyColors = new Set(styles$e.COLORS?.split(", ") ?? []);
let keyId = 0;
function takeKey() {
  return ++keyId;
}
...
const defaultBrackets = { start: "{{", end: "}}" },
  FormatText = reactExports.memo(function (e) {
    const {
      ...
      E = clsx(styles$e.base, a && styles$e.base__fullSize, l.className);
    return e.inline
      ? (console.warn(
...
function calculateRangeRows(e, t, s) {
  ...
  const a = Math.ceil((n / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    u = Math.max(0, Math.ceil(r / s) - Math.floor(a * SAFETY_FACTOR));
  return [u, Math.min(t, u + a)];
}
...
function calculateRangeItems(e, t, s) {
  ...
  const a = Math.ceil((n / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    u = clamp$1(0, t, Math.ceil(r / s) - Math.floor(a * SAFETY_FACTOR));
  return [u, Math.min(t, u + a)];
}
const initVisibleRange = [0, 0];
function useVisibleRange(e, t, s, r, n) {
  const [a, u] = reactExports.useState(initVisibleRange),
    o = reactExports.useRef(initVisibleRange),
    ...
    p = useEvent(() => {
      d.call(() => {
        const e = r();
        (o.current[0] === e[0] && o.current[1] === e[1]) || ((o.current = e), i || m());
      });
    });
  return (
    reactExports.useEffect(() => {
      c && !i && ((o.current[0] === a[0] && o.current[1] === a[1]) || m());
    }, [i, c, m, a]),
    reactExports.useLayoutEffect(
      () => (
...
function HorizontalList({
  ...
  className: a,
  renderElement: u,
  asyncRenderEnabled: o = !1,
  renderScroll: i = renderScrollDefault$1,
}) {
  const l = useVisibleRange(s, t, o, () => calculateRangeItems(s, e, r), e),
  ...
  return i(
    {
      ...
      children: jsxRuntimeExports.jsxs(d, {
        children: [
          ...
          mapRange(_, Math.max(E, _), (e) => jsxRuntimeExports.jsx(c, { children: u(e) }, e)),
...
function VerticalList({
  ...
  const c = Math.ceil(s / n),
    d = useVisibleRange(e, u, o, () => calculateRangeRows(e, c, r));
  reactExports.useEffect(e.recalculateContent, [e, d]);
  const [m, p] = d,
    E = a?.Element ?? reactExports.Fragment,
  ...
  return l(
    {
      ...
      children: jsxRuntimeExports.jsxs(_, {
        children: [
          ...
          mapRange(x, Math.max(x, g), (e) => jsxRuntimeExports.jsx(E, { children: i(e) }, e)),
          jsxRuntimeExports.jsx("div", {
...
const base$9 = "SceneWrapper_52fcfc1e",
...
function SceneWrapper({
  ...
  return (
    ...
    jsxRuntimeExports.jsx("div", {
      ...
      className: clsx(
        styles$d.base,
        o && styles$d.base__down,
        !n && styles$d.base__moveSpaceDisabled,
        a,
      ),
      onMouseDown: function (e) {
        (e.preventDefault(), g(e) && (i(!0), c(!0), m({ x: e.clientX, y: e.clientY })));
      },
      ...
      onMouseOver: function (e) {
        (s({ isOver3dScene: !0 }), g(e) && (i(!0), m({ x: e.clientX, y: e.clientY })));
      },
      onMouseOut: function () {
...
const base$8 = "MultilineOverflow_ec9f8e47",
  content = "MultilineOverflow_content_b539970d",
  styles$c = { base: base$8, content: content };
...
const MultilineOverflow = reactExports.forwardRef(function (
  ...
  reactExports.useEffect(() => {
    ...
    function n() {
      ...
      (r.remove(),
        (r.className = clsx(styles$c.content, t.children[0].className)),
        (r.innerHTML = ""),
      ...
      if (a === n) A(!1);
        ...
        (u.removeAttribute("style"), r.appendChild(u), t.appendChild(r));
      }
    }
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...g,
    onMouseEnter: function (e) {
      (u?.(e), b && !l && y.onMouseEnter(e));
    },
    onClick: function (e) {
      (i?.(e), l || y.onClick());
    },
    onMouseLeave: function (e) {
      (o?.(e), l || y.onMouseLeave());
    },
    ref: assignRefs([x, f]),
    className: clsx(styles$c.base, d, m?.base),
    style: { ...p, ...E },
    children: [
  ...
  for (let r = 0; r < t.items.length; ++r)
    (t.separator &&
      ...
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          { className: cx(styles$b.detailedSeparator, styles$b[`detailedSeparator__${e}`]) },
          "separator",
        ),
      ),
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          {
            className: cx(styles$b.item, styles$b[`item__${e}`]),
            children: t.items[r]
              ?.split(" ")
              .map((t, s) =>
                jsxRuntimeExports.jsx(
                  "span",
                  { className: cx(styles$b.part, styles$b[`part__${e}`]), children: t },
                  `part_${s}`,
                ),
              ),
          },
...
function Timer({
  ...
  return jsxRuntimeExports.jsxs("div", {
    className: cx(styles$a.base, o),
    children: [
      jsxRuntimeExports.jsx("div", {
        className: cx(styles$a.icon, styles$a[`icon__${r}`], styles$a[`icon__${n}`], i?.icon),
      }),
      a !== formats.superCompact &&
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$a.label, styles$a[`label__${r}`], styles$a[`label__${n}`], i?.label),
                  ...
                  n.forEach((t, r) => {
                    void 0 !== n[r] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        ...
                        return e({ time: t, name: `${u ? s : `${DEFAULT_NAME_KEYFRAME}_${r}`}` });
                      });
                  });
                }
              });
  ...
  Filled = reactExports.forwardRef(function ({ className: e, classNames: t, ...s }, r) {
    ...
    return jsxRuntimeExports.jsx("div", {
      ...
      children: jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$9.fill, t?.fill),
...
function ProgressBar({
  ...
  return jsxRuntimeExports.jsx(ProgressBarProvider, {
    ...
    children: jsxRuntimeExports.jsxs(Base$1, {
      ...
      className: t,
      children: [
        jsxRuntimeExports.jsx("div", { className: clsx(styles$8.background, s?.background) }),
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$8.backgroundPattern, s?.backgroundPattern),
        }),
...
const multiValueTypes = [
  ...
  Reward = ({
    ...
    const E = SIZE_MAP.has(n) ? SIZE_MAP.get(n) : n,
      ...
      h = useSimpleTooltip({ header: p?.header, body: p?.body });
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$7.base, styles$7[`base__${n}`], !r && styles$7.base__dynamicBox, c),
      style: l,
      ...f,
      children: [
        jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            jsxRuntimeExports.jsxs("div", {
              className: cx(
                styles$7.image,
                r ? styles$7.image__fixedBox : styles$7[`image__${n}`],
                d?.image,
              ),
              children: [
                _ &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$7.highlight, d?.highlight),
                    style: {
                      backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${E}.${_}_highlight`)})`,
                    },
                  }),
                t &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$7.icon, d?.rewardIcon),
                    style: { backgroundImage: `url(${t})` },
                  }),
                g &&
                  jsxRuntimeExports.jsx("div", {
                    className: cx(styles$7.overlay, d?.overlay),
                    style: {
                      backgroundImage: `url(${images.readOrEmpty(`quests.bonuses.${E}.${g}_overlay`)})`,
                    },
                  }),
              ],
            }),
            x &&
              jsxRuntimeExports.jsx("div", {
                className: cx(
                  styles$7.info,
                  styles$7[`info__${e}`],
                  o === ValueTypes.MULTI && styles$7.info__multi,
                  d?.info,
                ),
                children: x,
              }),
            i && jsxRuntimeExports.jsx("div", { className: styles$7.title, children: i }),
          ],
        }),
        s && jsxRuntimeExports.jsx("div", { className: cx(styles$7.timer, d?.periodicIcon), ...h }),
      ],
    });
  },
...
const base$4 = "RewardsList_b956755b",
  ...
  Rewards$1 = reactExports.memo(function ({
    ...
    return jsxRuntimeExports.jsx("div", {
      className: cx(styles$6.base, r && styles$6.base__vertical, a),
      children:
        void 0 !== p
          ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                e
                  ...
                  .map((e, n) =>
                    jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: cx(styles$6.reward, r && styles$6.reward__vertical, u),
                ...
                jsxRuntimeExports.jsx("div", {
                  ...
                  children: jsxRuntimeExports.jsx(Reward, {
                    ...
                    value: E,
                    tooltipArgs: o,
                    className: cx(styles$6.boxRewardClassName, l),
                    classNames: c,
                  }),
                }),
              ],
    ...
    reactExports.forwardRef(function (
      ...
      return (
        ...
        jsxRuntimeExports.jsxs("div", {
          ...a,
          ref: assignRefs([u, o]),
          className: clsx(a.className, styles$5.delta),
          children: [
            d && jsxRuntimeExports.jsx("div", { className: clsx(styles$5.glow, n?.glow), ref: i }),
            a.children,
          ],
        })
      );
          ...
          const n = Date.now(),
            u = setInterval(
              () => {
                ...
                null !== s && t <= s ? (a(s), r && r(), clearInterval(u)) : a(t);
              },
...
const base$2 = "Countdown_99fa8328",
  ...
  Countdown = ({
    ...
    const o = n ?? (s !== CountdownStyle.Description ? 1 : void 0),
      i = useCountdown(e, o),
      l = useScaleState();
    r && r[i] && r[i]();
  ...
  OptimizedProgressBar = ({
    ...
    const u = reactExports.useRef(null),
      ...
      c = reactExports.useCallback(
        (e) => {
          (i.current && u.current && moveBackground(e, u.current, i.current),
            o.current && u.current && moveLine(e, l, { line: o.current, container: u.current }));
        },
        [l],
      ),
...
export {
  ...
  intl$1 as E,
  FormatText$1 as F,
  createLayoutReadyInEffect$1 as G,
  sendEvent$1 as H,
  ImageSize$1 as I,
  ...
  Image$1 as Y,
  VehicleInfo as Z,
  isTypeValidValue as _,
  createGridImgSourceGetter as a,
  useLazyModel as a$,
  useUpscale as a0,
  FormatString as a1,
  useTooltip as a2,
  useSpecialContextMenu as a3,
  useScrollByDragElements as a4,
  Area$1 as a5,
  dragDirections as a6,
  ...
  calcPercent as aF,
  delay as aG,
  useIsFirstRender as aH,
  Video as aI,
  ProgressBar as aJ,
  MS_IN_SECOND$1 as aK,
  MAX_i32 as aL,
  mapFilter as aM,
  ImageSize as aN,
  capitalize as aO,
  ...
  formats as aQ,
  Reward as aR,
  getRewardValueType as aS,
  getRewardImage as aT,
  formatPrintf as aU,
  forEach as aV,
  some as aW,
  chunks as aX,
  ...
  useSkipFrame as ac,
  useAdaptive as ad,
  useHorizontalScroll as ae,
  ErrorHandler as af,
  LazyModel as ag,
  Base$5 as ah,
  useBackdropTooltip as ai,
  useParamTooltip as aj,
  assignRefs as ak,
  normalizeResource as al,
  useSimpleTooltip as am,
  useSpecialTooltip as an,
  SceneWrapper as ao,
  ...
  onRescale as av,
  isEmptyObject as aw,
  useSoundsOptional as ax,
  comparer as ay,
  filterMap as az,
  addChunkIndexToEndPath as b,
  ...
  getRegionalDateTime$1 as bD,
  getRewardTooltipConfig as bE,
  Rewards$1 as bF,
  identity as bG,
  ONE_DAY$1 as bH,
  format$1 as bI,
  ...
  play as t,
  useMedia as u,
  defaultAnimationSettings as v,
  createTimeoutInEffect$1 as w,
  BackportTooltip as x,
  types$2 as y,
  Tooltip$1 as z,
};
