import { t as e, j as s, f as n } from "../../../../chunks/vendor.js";
import { i, n as t, F as a, r as o, U as r, bw as _ } from "../../../../chunks/lib.js";
/* empty css                        */ const [c, l] = i()(
    ({ observableModel: e }) => ({
      root: e.object(),
  ...
  p = e(function () {
    const { model: e } = l(),
      { currencyType: i, hasPremiumBonus: t } = e.root.get(),
      { hasDailyBonus: o, dailyBonusFactor: r } = e.dailyBonus.get(),
      _ = e.eventInfo.get().subMode;
    return s.jsxs("div", {
      className: n(d.base, d[`base__${_}`], d[`base__${i}`]),
      children: [
        s.jsxs("div", {
          className: d.content,
          children: [
            s.jsx("div", { className: d.icon }),
            s.jsxs("div", {
              className: d.textContent,
              children: [
                s.jsx(a, {
                  text: `${R.strings.battle_royale_extention.rewardCurrencyTooltip.header.$dyn(i)}`,
                  classMix: d.title,
                }),
                s.jsx(a, {
                  text: `${R.strings.battle_royale_extention.rewardCurrencyTooltip.body.$dyn(i)}`,
        ...
        t &&
          s.jsxs("div", {
            ...
            children: [
              s.jsx("div", { className: d.premiumIcon }),
              s.jsx(a, {
                text: `${R.strings.battle_royale_extention.rewardCurrencyTooltip.premiumBonus.$dyn(i)}`,
          ...
          s.jsxs("div", {
            ...
            children: [
              s.jsxs("div", {
                ...
                children: [
                  s.jsx("div", { className: d.dailyBonusIcon }),
                  s.jsx("div", { className: d.dailyBonusQuantifier, children: `x${r}` }),
                ],
              }),
              s.jsx(a, {
                text: `${R.strings.battle_royale_extention.rewardCurrencyTooltip.dailyBonus.$dyn(i)}`,
                binding: { count: r },
...
o(
  s.jsx(r, {
    children: s.jsx(c, {
      children: s.jsx(_, { children: s.jsx(_.Decorator, { children: s.jsx(p, {}) }) }),
    }),
  }),
);
