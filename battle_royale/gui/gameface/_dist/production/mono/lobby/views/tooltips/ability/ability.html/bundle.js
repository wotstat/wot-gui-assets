...
const h = "App_21e3a147",
  ...
  $ =
    ((L = d(S)),
    function () {
      return _().model.computes.params(L);
    });
var L;
const O = i.resolve("strings"),
  C = s(function () {
    const { title: s, iconName: e, cooldownSeconds: t, description: c } = $(),
      o = j(O.readOrEmpty("tooltips.battle_royale.hangar.tankSetupPanel.ability.cooldownTime")),
      r = j(c);
    return a.jsx(p, {
          ...
          children: a.jsxs("div", {
            ...
            children: [
              a.jsxs("div", {
                className: b,
                children: [
                  a.jsx("div", { className: v, style: { backgroundImage: `url(${w.$dyn(e)})` } }),
                  a.jsxs("div", {
                    className: g,
                    children: [
...
m(a.jsxs(x, { children: [a.jsx(u, { children: a.jsx(C, {}) }), ","] }));
