  ...
  var __webpack_modules__ = {
      ...
      4179: (u, e, t) => {
        ...
        function B(u, e, t, r, a, i, n) {
          ...
          s.done ? e(E) : Promise.resolve(E).then(r, a);
        }
        const m = (u) => ({
      ...
      9264: (u, e, t) => {
          ...
          return (
            l(() => {
              if (
                ...
                C.current = d.addCallback(r, t, o, e === _.Deep);
              }
            }),
            (0, r.useEffect)(() => {
              if (e !== _.None)
        ...
        const k = f.O.client.getSize("rem"),
          ...
          I = (u) => {
            ...
            const a = (0, r.useContext)(N),
              ...
              h = { extraLarge: c, large: D, medium: B, small: m, extraSmall: C };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && o) return x(e, t, h);
              if (t.largeWidth && A) return x(e, t, h);
              if (t.mediumWidth && F) return x(e, t, h);
              if (t.smallWidth && d) return x(e, t, h);
              if (t.extraSmallWidth && _) return x(e, t, h);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        const U = (0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(N),
            ...
            s = (0, r.useCallback)((u, e) => {
              ...
              n(Object.assign({ width: t, height: r }, T(t, r, M)));
            }, []);
          (l(() => {
          ...
          return a().createElement(N.Provider, { value: E }, u);
        });
        let G, V, $;
        (!(function (u) {
        ...
        const Q = (0, r.createContext)({}),
          J = (0, r.memo)(
            ({
              ...
              const l = (0, r.useRef)(null),
                ...
                P = f === R && !t,
                W = 1 !== R,
                I = (0, r.useMemo)(() => ({ isAnimationDisabled: M }), [M]),
                U = (function () {
                  var u = Z(function* () {
                    if (l && l.current) {
                      (y(!0), yield (0, o.Eu)());
                      const u = viewEnv.getScale();
                      (h(l.current.offsetWidth / u),
                        w(l.current.querySelector(`.${Y.slide__active}`).offsetWidth / u),
                        setTimeout(() => {
                          y(!1);
                        }, 100));
                    }
              ...
              ((0, r.useEffect)(() => {
                ...
                (0, r.useEffect)(() => {
                  if (t) {
                    const u = _.concat();
                    (u.unshift(...u.splice(-2, _.length)), c(u));
                  }
                }, []),
                (0, r.useEffect)(
                  () => (
              ...
              const z = (0, r.useMemo)(
                ...
                uu = B()(Y.counter, !W && Y.counter__disabled);
              return a().createElement(
                "div",
                { className: q },
                W &&
                ...
                a().createElement(
                  ...
                  a().createElement(
                    ...
                    _.map((u, e) => {
                      ...
                      let n;
                      i ? (n = V) : r && (n = G);
                      let s = B()(Y.slide, F && Y.slide__large, e + 1 === f && Y.slide__active);
                      return (
                        t &&
                          (s = B()(
                            Y.slide,
                            Y.slide__carousel,
                            F && Y.slide__large,
                            e + 1 === f && Y.slide__active,
                            r && Y.slide__beforeActive,
                            r && F && Y.slide__beforeActiveLarge,
                            i && Y.slide__afterActive,
                            i && F && Y.slide__afterActiveLarge,
                            e + 2 < f && Y.slide__leftEdge,
                            e + 2 < f && F && Y.slide__leftEdgeLarge,
                            e > f && Y.slide__rightEdge,
                            e > f && F && Y.slide__rightEdgeLarge,
                          )),
                        a().createElement(
                          "div",
          ...
          ru = ({
            ...
            const A = (0, r.useState)(!1),
              ...
              L = h.mediaHeight,
              x = tu[w],
              M = L >= $.Medium && f <= V.Small,
              y = L <= $.Small ? v.small : v.medium,
              T = B()(
                "IntroView_base_b9",
                M && "IntroView_base__high_98",
                F && "IntroView_base__video_bb",
              );
            (0, r.useEffect)(
              () =>
                ((u) => {
            ...
            return (
              ...
              a().createElement(
                ...
                a().createElement("div", { className: "IntroView_shadow_d5" }),
                ...
                a().createElement(
                  ...
                  a().createElement(
                    J,
                    { arrowsTopPosition: x, withCounter: !0 },
                    i.map(
                      ({ value: u }, e) =>
                        u &&
                        a().createElement(q, {
        ...
        const ou = {
          ...
          Fu = {
            [G.ExtraSmall]: "",
            [G.Small]: su().SMALL,
            [G.Medium]: `${su().SMALL} ${su().MEDIUM}`,
            [G.Large]: `${su().SMALL} ${su().MEDIUM} ${su().LARGE}`,
            [G.ExtraLarge]: `${su().SMALL} ${su().MEDIUM} ${su().LARGE} ${su().EXTRA_LARGE}`,
          },
          du = (u) => {
            let e = u.children,
              t = u.className,
            ...
            const i = z(),
              ...
              s = i.mediaHeight,
              E = i.mediaSize;
            return a().createElement("div", lu({ className: B()(t, ou[n], Au[s], Fu[E]) }, r), e);
          },
          _u = ["children"],
          cu = (u) => {
            let e = u.children,
            ...
            return a().createElement(U, null, a().createElement(du, t, e));
          };
        engine.whenReady.then(() => {
          n().render(
            a().createElement(cu, null, a().createElement(iu, null)),
    ...
    (__webpack_require__.O = (u, e, t, r) => {
      if (!e) {
        ...
        for (E = 0; E < deferred.length; E++) {
          for (var [e, t, r] = deferred[E], i = !0, n = 0; n < e.length; n++)
            (!1 & r || a >= r) &&
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); E < i.length; E++)
            ((a = i[E]), __webpack_require__.o(u, a) && u[a] && u[a][0](), (u[a] = 0));
