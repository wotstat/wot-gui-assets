  ...
  var __webpack_modules__ = {
      ...
      290: (e, u, t) => {
        ...
        const X = ({ children: e, tooltipArgs: u, className: t }) => {
            ...
            const r = u.contentId;
            return r
              ? o().createElement(V, K({}, u, { contentId: r }), n)
              : o().createElement(j, u, n);
          },
          Z = (e) => {
            let u,
              t = null;
        ...
        const Ae = {
          ...
          ve = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = pe, onDrag: n = be }) => {
              ...
              return o().createElement(
                "div",
                {
                  className: B()("HorizontalBar_base_fa517", u.base),
                  ref: r,
        ...
        const xe = De({
          ...
          Le = (0, a.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Re, onDrag: n = Pe }) => {
              const r = (0, a.useRef)(null),
                s = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                c = (0, a.useRef)(null),
                ...
                C = J(() => {
                  ...
                  ((t.style.transform = `translateY(${0 | _}px)`),
                    ((e) => {
                      if (s.current && l.current && c.current && d.current) {
                        if (0 === Math.round(e))
                          return (s.current.classList.add(Oe), void l.current.classList.remove(Oe));
                        if (
                          ((u = c.current),
                          (t = d.current),
                          e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (s.current.classList.remove(Oe), void l.current.classList.add(Oe));
                        var u, t;
              ...
              return o().createElement(
                "div",
                {
                  className: B()("VerticalBar_base_b5610", u.base),
                  ref: r,
                  onWheel: e.handleMouseWheel,
                },
                o().createElement("div", {
