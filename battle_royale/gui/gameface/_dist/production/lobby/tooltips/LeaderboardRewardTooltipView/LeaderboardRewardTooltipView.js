    ...
    A = {
      9480: (u, A, F) => {
        function E(u, A) {
          return Array.isArray(u)
            ? u.map(A)
            : u.map((u, F, E) => A(null == u ? void 0 : u.value, F, E));
        }
        F.d(A, { UI: () => E });
      },
      1526: (u, A, F) => {
        ...
        const s = (u, A, F) => {
          ...
          c = (u, A, F = i.left) => u.split(A).reduce(F === i.left ? s : l, []),
          d = (() => {
            const u = new RegExp(
          ...
          m = ["zh_cn", "zh_sg", "zh_tw"],
          v = ({ binding: u, text: A = "", classMix: F, alignment: E = i.left }) =>
            null === A
        ...
        function $(u = "rem") {
          ...
          return "rem" === u ? A : { x: Q(A.x), y: Q(A.y) };
        }
        function U() {
        ...
        const Au = Object.keys(P).reduce(
            (u, A) => ((u[A] = () => viewEnv.getShowingStatus() === P[A]), u),
            {},
          ),
          Fu = {
            set: (u, A) => {
        ...
        const tu = t().forwardRef(function (u, A) {
          let F = u.children,
            E = u.className,
            e = u.theme,
          ...
          return (
            ...
            t().createElement(
              "div",
              Cu({}, B, {
                className: a()(Du.base, Du[`base__theme-${D}`], E),
                ref: function (u) {
                  ((r.current = u), "function" == typeof A ? A(u) : A && (A.current = u));
                },
              }),
              t().createElement("div", { className: Du.decorator }, F),
            )
          );
        });
        var nu = F(3282),
            ...
            return [
              function ({ mode: u = "real", options: A, children: E, mocks: e }) {
                const D = (0, C.useRef)([]),
                  B = (u, A, F) => {
                    ...
                    const e = (function ({
                        ...
                        return {
                          subscribe: (F, D) => {
                            const C = "string" == typeof D ? `${E}.${D}` : E,
                              t = eu.view.addModelObserver(C, A, !0);
                      ...
                      r = { mode: u, model: n, externalModel: B, cleanup: t };
                    return {
                      model: n,
                      controls: "mocks" === u && F ? F.controls(r) : ou,
                      externalModel: B,
                      mode: u,
                    };
                  },
                ...
                return (
                  ...
                  t().createElement(F.Provider, { value: s }, E)
                );
              },
              () => (0, C.useContext)(F),
            ];
      ...
      5801: (u, A, F) => {
        ...
        var E = F(6483),
          ...
          B = F(6179),
          C = F.n(B);
        const t = "Column_separator_99",
          n = ({ battleType: u, mode: A, isNotFirstColumn: F }) =>
            C().createElement(
              "div",
              { className: e()("Column_base_a8", F && "Column_base__notFirstColumn_74") },
              C().createElement("div", { className: t }),
              C().createElement("div", { className: "Column_battleType_38" }, u),
              D.UI(A, ({ place: u, points: F }, E) => {
                const D = A.length - 1 === E;
                return C().createElement(
                  ...
                  C().createElement(
                    "div",
                    { className: e()("Column_row_97", D && "Column_row__last_4d") },
                    C().createElement("div", { className: "Column_place_90" }, u),
                    F
                      ? C().createElement(
                          "div",
                          { className: "Column_pointContainer_30" },
                          C().createElement("div", { className: "Column_point_1b" }, F),
                          C().createElement("div", { className: "Column_reward_c1" }),
                        )
                      : C().createElement(
                          "div",
      ...
      5210: (u, A, F) => {
        ...
        var E = F(9480),
          ...
          D = F.n(e),
          B = F(5801);
        const C = ({ battleModes: u, battleType: A }) =>
          D().createElement(
            "div",
            { className: "Table_base_ce" },
            D().createElement("div", { className: "Table_battleTypeBg_12" }),
            D().createElement(
              "div",
              { className: "Table_table_a9" },
              E.UI(u, (u, F) => {
                const E = F > 0;
                return D().createElement(B.s, {
                  key: F,
                  mode: u,
                  battleType: A[F],
                  isNotFirstColumn: E,
