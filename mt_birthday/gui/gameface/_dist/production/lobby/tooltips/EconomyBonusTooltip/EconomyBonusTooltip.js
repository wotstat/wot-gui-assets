        ...
        const vu = {
          ...
          Tu = xu((u) => {
            let e = u.className,
              ...
              v =
                void 0 === b
                  ? (c ? "flex-start" : _ && "center") || (g && "flex-end") || void 0
                  : b,
              S = u.alignSelf,
              w = u.wrap,
              T = u.flexWrap,
            ...
            return Y().createElement(
              "div",
              bu({ className: D()(pu.base, ...G, e), style: j }, P),
              W,
            );
          });
        var Lu = t(280),
                      ...
                      i = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = D(t);
                            if (Array.isArray(e)) {
                              const A = e.reduce((u, e) => ((u[e] = Uu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, Uu.aD)((u) => {
                            ...
                            }
                            {
                              const A = e,
                                E = Object.entries(A),
                                F = E.reduce((u, [e, t]) => ((u[t] = Uu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, Uu.aD)((u) => {
