        ...
        const vu = {
          ...
          wu = hu((u) => {
            ...
            return K().createElement(
              "div",
              fu({ className: a()(xu.base, ...j, e), style: N }, P),
              W,
            );
          });
        var Tu = t(280),
                      ...
                      i = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const A = a(t);
                            if (Array.isArray(e)) {
                              const E = e.reduce((u, e) => ((u[e] = $u.LO.box(A[e], {})), u), {});
                              return (
                                "real" === u &&
                                  D.subscribe(
                                    (0, $u.aD)((u) => {
                            ...
                            }
                            {
                              const E = e,
                                F = Object.entries(E),
                                r = F.reduce((u, [e, t]) => ((u[t] = $u.LO.box(A[e], {})), u), {});
                              return (
                                "real" === u &&
                                  D.subscribe(
                                    (0, $u.aD)((u) => {
