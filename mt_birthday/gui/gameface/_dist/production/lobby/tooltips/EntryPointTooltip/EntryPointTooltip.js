      ...
      1052: (u, e, t) => {
                    ...
                    const i = (function ({
                      ...
                      c = (({ observableModel: u }) => {
                        const e = {
                          ...
                          t = (0, p.Om)(
                            () =>
                              C(e.levels.get()).map((u) =>
                                Object.assign({}, u, { rewards: u.rewards.map((u) => Au(u)) }),
                              ),
                            { equals: F },
                          ),
                          ...
                          a = (0, p.Om)(
                            () =>
                              t().find((u) => u.number === e.root.get().progression.currentLevel),
                            { equals: F },
                          ),
                          i = (0, p.Om)(
                            () => {
                              ...
                              return (
                                (null ==
                                (u = t().find(
                                  (u) => u.number === e.root.get().progression.currentLevel - 1,
                                ))
                                  ? void 0
                                  : u.maxPoints) || 0
                              );
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                i = a.reduce((u, [e, t]) => ((u[t] = d.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  s.subscribe(
                                    (0, d.aD)((u) => {
        ...
        const Mu = (0, i.memo)(
          ...
          Uu = (0, i.memo)(
            ({
              ...
              const h = (0, i.useMemo)(
                  () => Object.assign({ width: "100%" }, Iu(u), ku(A)),
                  [A, u],
                ),
                b = (0, i.useMemo)(() => Object.assign({ width: "0%" }, Iu(u), ku(A)), [A, u]),
                f = (0, i.useMemo)(
                  () => Object.assign({ width: "0%" }, Nu(A, r), Iu(u)),
                  [r, A, u],
                ),
                v = (0, i.useMemo)(
        ...
        const Te = {
          ...
          Pe = ve((u) => {
            ...
            return s().createElement(
              "div",
              xe({ className: n()(we.base, ...W, e), style: H }, U),
              I,
            );
          });
        var Oe = t(280),
