(() => {
      ...
      4343: (u, e, t) => {
        ...
        const A = o().forwardRef(function (u, e) {
          ...
          return (
            ...
            o().createElement(
              "div",
              l({}, c, {
                className: a()(s.base, s[`base__theme-${F}`], r),
                ref: function (u) {
            ...
            const h = (0, i.useRef)({
              ...
              S = (0, i.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (x(t, D, { isMouseEvent: !0, on: !0, arguments: w(r) }, b),
                  C && C(),
                        ...
                        onMouseEnter:
                          ...
                          (u) => {
                            (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                              ((h.current.timeoutId = window.setTimeout(S, l ? 100 : 400)),
                              a && a(u),
                              P && P(u));
                          }),
                        onMouseLeave: ((u) => (e) => {
        ...
        const M = R.views.common.tooltip_window.simple_tooltip_content,
          L = (u) => {
            ...
            const l = (0, i.useMemo)(() => {
              const u = Object.assign({}, s, { body: t, header: r, note: a, alert: n });
        ...
        const k = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return o().createElement(L, e, r);
          const a = e.contentId,
            n = e.args,
            i = null == n ? void 0 : n.contentId;
          return a || i
            ? o().createElement(S, N({}, e, { contentId: a || i }), r)
            : o().createElement(P, e, r);
        };
        ...
        const U = [
            ...
            D.SelectableBonus,
            D.PostStamp,
            D.PremiumPlusUniversal,
            D.GoldenTicket,
            D.RewardsSlots,
          ],
          H = [D.Gold, D.Credits, D.Crystal, D.FreeXp],
          G = [D.BattlePassPoints],
          W = [D.PremiumPlus, D.Premium];
        let X;
        !(function (u) {
          ((u.s16 = "16"),
            (u.s32 = "32"),
        ...
        const j = ["engravings", "backgrounds"],
          ...
          Y = (u, e = m.Small) => {
            ...
            switch (t) {
              ...
              case D.StyleProgress:
              case D.LbStyleProgress:
                return $(n, e, h.ProgressionStyle);
              default:
          ...
          z = ({
            ...
            return o().createElement(
              "div",
              { className: a()(V.base, V[`base__${r}`], l), style: E },
              o().createElement(
                k,
                { tooltipArgs: F, className: V.tooltipWrapper },
                o().createElement(
                  o().Fragment,
                  null,
                  o().createElement(
                    "div",
                    { className: a()(V.image, null == A ? void 0 : A.image) },
                    D &&
                      o().createElement("div", {
                        className: a()(V.highlight, null == A ? void 0 : A.highlight),
                        style: {
                    ...
                    e &&
                      o().createElement("div", {
                        className: a()(V.icon, null == A ? void 0 : A.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      o().createElement("div", {
                        className: a()(V.overlay, null == A ? void 0 : A.overlay),
                        style: {
              ...
              t &&
                o().createElement(
                  ...
                  { tooltipArgs: c },
                  o().createElement("div", {
                    className: a()(V.timer, null == A ? void 0 : A.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const tu = n.O.client.getSize("rem"),
          ru = tu.width,
          au = tu.height,
          nu = Object.assign({ width: ru, height: au }, eu(ru, au, J)),
          iu = (0, i.createContext)(nu),
          ou = ["children"],
          su = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && l) return Z(e, t, g);
        ...
        ((0, i.memo)(({ children: u }) => {
          const e = (0, i.useContext)(iu),
            ...
            s = (0, i.useCallback)((u, e) => {
              ...
              a(Object.assign({ width: t, height: r }, eu(t, r, J)));
            }, []);
          (((u) => {
          ...
          return o().createElement(iu.Provider, { value: E }, u);
        }),
          (function (u) {
        ...
        const Fu = ["xl", "lg", "md", "sm", "xs"],
          cu = (u) => u.includes("_") && ((u) => Fu.includes(u))(u.split("_").at(-1)),
          Du = [Eu.ExtraLarge, Eu.Large, Eu.Medium, Eu.Small, Eu.ExtraSmall],
          _u = (u, e) =>
        ...
        const gu = {
          ...
          bu = mu((u) => {
            ...
            const H = (0, i.useMemo)(() => {
              ...
              }, [t, r, E, A, c, _, k, N, T, C, O, x, f]),
              G = H.computedStyle,
              W = H.computedClassNames;
            return o().createElement(
              "div",
              Cu({ className: a()(Bu.base, ...W, e), style: G }, U),
              I,
            );
          });
        let vu;
        ...
        const wu = (u, e, t) => {
          ...
          Su = (u, e, t = vu.left) => u.split(e).reduce(t === vu.left ? wu : xu, []),
          fu = (() => {
            const u = new RegExp(
          ...
          Ru = ({ binding: u, text: e = "", classMix: t, alignment: r = vu.left }) =>
            null === e
        ...
        const Nu = Object.keys(Ou()),
          ...
          Wu = mu((u) => {
            ...
            return o().createElement(
              ...
              Lu(
                {
                  className: a()(yu.base, t && yu[t], h, r),
                  style: p,
                  mt: !0 === l ? Hu[t || "paragraph-P16"].mt : l,
                  mr: !0 === F ? Hu[t || "paragraph-P16"].mr : F,
                  mb: !0 === D ? Hu[t || "paragraph-P16"].mb : D,
                  ml: !0 === m ? Hu[t || "paragraph-P16"].ml : m,
                },
                C,
              ),
              void 0 !== d ? o().createElement(Ru, Lu({}, d, { text: e })) : e,
            );
          });
        var Xu = t(3403);
        const ju = {
          ...
          Yu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          $u = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          Vu = (0, i.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((s = s.replace(t, `%(${n})`)),
                  (a[n] = ju[u]
                    ? o().createElement(
                        "span",
                        { className: ju[u] },
                        o().createElement(Ru, { text: A, binding: e }),
                      )
                    : o().createElement(
                        "span",
                        { style: r(u) },
            ...
            return o().createElement(Ru, { text: s, classMix: t, binding: a });
          });
        function zu() {
          return !1;
        }
        ...
        const ee = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: r, children: a, mocks: s }) {
                const E = (0, i.useRef)([]),
                  l = (u, t, r) => {
                    var a;
                    const i = (function ({
                      ...
                      A = (({ observableModel: u }) => {
                        const e = {
                          ...
                          t = (0, ue.Om)(() => {
                            return ((u = e.slots.get()), Ju(u)).map((u) => {
                              return Object.assign({}, u, {
                                bonuses:
                                  ...
                                  e.map((u) => {
                                    return {
                                      name: u.name,
                                      image: Y(u, u.name === D.LbStyleProgress ? m.Big : m.Small),
                                      value: u.value,
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = s(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((u, e) => ((u[e] = Ku.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  o.subscribe(
                                    (0, Ku.aD)((u) => {
                            ...
                            }
                            {
                              const a = e,
                                n = Object.entries(a),
                                i = n.reduce((u, [e, t]) => ((u[t] = Ku.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  o.subscribe(
                                    (0, Ku.aD)((u) => {
                  ...
                  c = F[0],
                  _ = F[1],
                  d = (0, i.useState)(() => l(u, r, s)),
                  C = d[0],
                  g = d[1];
                return (
                  (0, i.useEffect)(() => {
                    A.current ? g(l(c, r, s)) : (A.current = !0);
                  }, [s, c, r]),
                  (0, i.useEffect)(() => {
                    _(u);
                  }, [u]),
        ...
        const ne = R.strings.mt_birthday.LootboxTooltipExtended,
          ie = R.images.mt_birthday.gui.maps.icons.tooltips,
          oe = (0, Xu.Pi)(() => {
            const u = re().model,
            ...
            return o().createElement(
              "div",
              { className: "App_base_f0" },
              o().createElement(
                "div",
                { className: "App_title_f8" },
                o().createElement("div", {
                  className: "App_background_b6",
                  style: { backgroundImage: `url(${ie.$dyn(t)})` },
                }),
                o().createElement(Wu, { text: R.strings.lootboxes.userName.$dyn(t) }),
              ),
              o().createElement(Wu, { text: ne.slotTitle(), className: "App_slotTitle_98" }),
              e.map(({ bonuses: u, probability: e, vehicleNames: t }, r) => {
                const n = 0 === r,
                  i = Boolean(t.length);
                return o().createElement(
                  "div",
                  { className: "App_slotWrapper_01", key: r },
                  !n && o().createElement("div", { className: "App_separator_d9" }),
                  o().createElement(
                    "div",
                    {
                      key: r,
                    ...
                    o().createElement(
                      "div",
                      { className: "App_probabilityTitleWrapper_56" },
                      o().createElement(Vu, {
                        text: ne.slotDescription(),
                        classMix: "App_probabilityTitle_0b",
                        binding: { percent: e, index: r + 1 },
                      }),
                    ),
                    i &&
                      o().createElement(
                        ...
                        o().createElement("div", { className: "App_vehicleImg_d4" }),
                        o().createElement(Wu, {
                          text: t.join(ne.separator()),
                          className: "App_vehicleNames_d9",
                        }),
                      ),
                    o().createElement(
                      "div",
                      { className: "App_rewardsWrapper_03" },
                      u.map((u, e) =>
                        o().createElement(
                          "div",
                          { className: "App_rewardItemWrapper_9b", key: e },
                          o().createElement(
                            z,
                            ae({ size: m.Small, className: "App_reward_bf" }, u),
                          ),
                        ),
                      ),
                    ),
        ...
        engine.whenReady.then(() => {
          c().render(
            o().createElement(te, null, o().createElement(A, null, o().createElement(oe, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4343));
