(() => {
  var __webpack_modules__ = {
      ...
      6255: (u, e, t) => {
        ...
        const o = a().forwardRef(function (u, e) {
          let t = u.children,
            r = u.className,
            o = u.theme,
        ...
        const h = A.O.client.getSize("rem"),
          g = h.width,
          p = h.height,
          v = Object.assign({ width: g, height: p }, d(g, p, c)),
          b = (0, F.createContext)(v),
          w = ["children"],
          x = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.mediumWidth && B) return _(e, t, g);
              if (t.smallWidth && l) return _(e, t, g);
        ...
        ((0, F.memo)(({ children: u }) => {
          const e = (0, F.useContext)(b),
            ...
            n = (0, F.useCallback)((u, e) => {
              ...
              E(Object.assign({ width: t, height: r }, d(t, r, c)));
            }, []);
          (((u) => {
          ...
          const i = (0, F.useMemo)(() => Object.assign({}, r), [r]);
        ...
        const W = {
          ...
          G = P((u) => {
            ...
            const z = (0, F.useMemo)(() => {
              ...
              }, [t, r, i, o, l, C, j, G, M, d, T, x, S]),
              V = z.computedStyle,
              Y = z.computedClassNames;
            return a().createElement("div", k({ className: E()(N.base, ...Y, e), style: V }, K), X);
          });
        let j;
        !(function (u) {
        ...
        const X = (u, e, t) => {
          ...
          z = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? X : K, []),
          V = (() => {
            const u = new RegExp(
                  ...
                  e.split("\n").map((e, A) =>
                    a().createElement(
                      ...
                      ((u, e, t) =>
                        ...
                        a().createElement(F.Fragment, { key: `${e}-${u}` }, u),
                      ),
                    ),
                  ),
                );
        ...
        const eu = Object.keys(Z()),
          ...
          au = P((u) => {
            ...
            return a().createElement(
              ...
              void 0 !== m ? a().createElement(q, uu({}, m, { text: e })) : e,
            );
          });
        let nu;
        var iu;
        ...
        const _u = (u) => (0 === u ? window : window.subViews.get(u)),
                ...
                const i = (0, F.useRef)([]),
                  D = (u, t, r) => {
                    ...
                    const F = (function ({
                        ...
                        return {
                          subscribe: (t, F) => {
                            const n = "string" == typeof F ? `${r}.${F}` : r,
                              i = A.O.view.addModelObserver(n, e, !0);
                            return (E.set(i, t), u && t(a(F)), i);
                          },
                          readByPath: a,
                          createCallback: (u, e) => {
                            const t = a(e);
                      ...
                      o = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = n(t);
                            if (Array.isArray(e)) {
                              const E = e.reduce((u, e) => ((u[e] = su.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, su.aD)((u) => {
                            ...
                            }
                            {
                              const E = e,
                                A = Object.entries(E),
                                F = A.reduce((u, [e, t]) => ((u[t] = su.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  a.subscribe(
                                    (0, su.aD)((u) => {
                      ...
                      B = { mode: u, model: o, externalModel: a, cleanup: D };
                    return {
                      model: o,
                  ...
                  l = B[0],
                  s = B[1],
                  C = (0, F.useState)(() => D(u, r, n)),
                  _ = C[0],
                  c = C[1];
                return (
                  (0, F.useEffect)(() => {
                    o.current ? c(D(l, r, n)) : (o.current = !0);
                  }, [n, l, r]),
                  (0, F.useEffect)(() => {
                    s(u);
                  }, [u]),
          ...
          mu = cu[0],
          du = cu[1],
          hu = R.strings.mt_birthday.playerSelect.tooltips,
          gu = (0, ou.Pi)(() => {
            ...
            return a().createElement(
              "div",
              { className: "App_base_62" },
              a().createElement(au, { className: "App_header_39", text: F.$dyn("header") }),
              a().createElement(au, { className: "App_body_6c", text: F.$dyn("body") }),
              n &&
                a().createElement(
                  a().Fragment,
                  null,
                  a().createElement("div", { className: "App_divider_b9" }),
                  a().createElement(
                    "div",
                    { className: "App_alert_6c" },
                    a().createElement("div", { className: "App_alertIcon_f3" }),
                    a().createElement(au, {
                      className: "App_alertText_81",
                      text: F.$dyn("warning"),
                      format: {
                        binding: {
                          time: a().createElement(au, {
                            text: F.$dyn("time"),
                            format: { binding: { hours: Du(E), minutes: Du(A) } },
                          }),
                        },
                      },
                    }),
        ...
        engine.whenReady.then(() => {
          l().render(
            a().createElement(mu, null, a().createElement(o, null, a().createElement(gu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6255));
