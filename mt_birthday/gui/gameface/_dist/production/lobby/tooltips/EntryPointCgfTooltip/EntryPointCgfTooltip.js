    ...
    A = {
      280: (u, A, F) => {
        ...
        var e = F(6179),
          ...
          t = F(3649),
          C = F(5287);
        const n = ({ binding: u, text: A = "", classMix: F, alignment: D = t.v2.left }) =>
          null === A
            ...
            : E().createElement(
                ...
                A.split("\n").map((A, n) =>
                  E().createElement(
                    "div",
                    { className: B()(C.Z.base, F), key: `${A}-${n}` },
                    (0, t.Uw)(A, D, u).map((u, A) =>
                      E().createElement(e.Fragment, { key: `${A}-${u}` }, u),
                    ),
                  ),
                ),
              );
      ...
      3649: (u, A, F) => {
        ...
        const E = (u, A, F) => {
          ...
          B = (u, A, F = e.left) => u.split(A).reduce(F === e.left ? E : D, []),
          t = (() => {
            const u = new RegExp(
                    ...
                    return C.includes(F)
                      ...
                      : ((u, A = e.left) => {
                          ...
                          const E =
                            ...
                            D = u.replace(/&nbsp;/g, " ");
                          return (
                            B(D, /( )/, A).forEach((u) => (F = F.concat(B(u, E, e.left)))),
                            F
                          );
                        })(u, A);
                  })(u, A),
      ...
      7075: (u, A, F) => {
        ...
        const B = {
          ...
          C = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          n = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          r = (0, E.memo)(({ text: u, binding: A, classMix: F }) => {
            ...
            return D().createElement(e.z, { text: a, classMix: F, binding: o });
          });
      },
      1294: (u, A, F) => {
        var e = {};
        ...
        function O(u = "rem") {
          ...
          return "rem" === u ? A : { x: W(A.x), y: W(A.y) };
        }
        function P() {
        ...
        const Y = Z().forwardRef(function (u, A) {
          let F = u.children,
            e = u.className,
            E = u.theme,
          ...
          return (
            ...
            Z().createElement(
              "div",
              X({}, B, {
                className: C()(J.base, J[`base__theme-${D}`], e),
                ref: function (u) {
                  ((n.current = u), "function" == typeof A ? A(u) : A && (A.current = u));
                },
              }),
              Z().createElement("div", { className: J.decorator }, F),
            )
          );
        });
        var uu = F(493),
        ...
        let eu;
        !(function (u) {
          ((u.QuestGiver = "questGiver"),
            (u.PostOffice = "postOffice"),
            (u.GoldWagon = "goldWagon"),
            (u.OnPause = "onPause"));
        })(eu || (eu = {}));
        var Eu = F(7075);
        function Du() {
        ...
        const Cu = (u) => (0 === u ? window : window.subViews.get(u)),
            ...
            return [
              function ({ mode: u = "real", options: e, children: E, mocks: D }) {
                      ...
                      r = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (A, F) => {
                            const e = C(F);
                            if (Array.isArray(A)) {
                              const E = A.reduce((u, A) => ((u[A] = Bu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === u &&
                                  t.subscribe(
                                    (0, Bu.aD)((u) => {
                            ...
                            }
                            {
                              const E = A,
                                D = Object.entries(E),
                                B = D.reduce((u, [A, F]) => ((u[F] = Bu.LO.box(e[A], {})), u), {});
                              return (
                                "real" === u &&
                                  t.subscribe(
                                    (0, Bu.aD)((u) => {
                ...
                return (
                  ...
                  Z().createElement(F.Provider, { value: a }, E)
                );
              },
              () => (0, Q.useContext)(F),
            ];
          ...
          iu = {
            ...
            base__questGiver: "App_base__questGiver_ca",
            base__goldWagon: "App_base__goldWagon_f7",
            base__postOffice: "App_base__postOffice_1f",
            description: "App_description_e4",
          },
          au = R.strings.mt_birthday.entryPointCgfTooltip,
          su = (0, Fu.Pi)(() => {
            const u = ou().model.root.get(),
              A = u.cgfEntryPoint,
              F = u.isPaused ? eu.OnPause : eu[A],
              e = au.$dyn(F);
            return Z().createElement(
              "div",
              { className: C()(iu.base, F && iu[`base__${F}`]) },
              Z().createElement(Eu.R, { classMix: iu.header, text: e.$dyn("title") }),
              Z().createElement(Eu.R, { classMix: iu.description, text: e.$dyn("desc") }),
            );
          });
        engine.whenReady.then(() => {
          Au().render(
            Z().createElement(ru, null, Z().createElement(Y, null, Z().createElement(su, null))),
