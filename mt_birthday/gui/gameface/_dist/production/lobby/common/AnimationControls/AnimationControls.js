    ...
    e = {
        ...
        const l = {
          ...
          s = (0, B.ZP)((u) => {
            let e = u.className,
              ...
              y =
                void 0 === T
                  ? (S ? "flex-start" : w && "center") || (b && "flex-end") || void 0
                  : T,
              O = u.alignSelf,
              P = u.wrap,
              W = u.flexWrap,
            ...
            const U = (0, r.useMemo)(() => {
              ...
              }, [A, F, B, d, _, h, z, X, O, v, G, H, y]),
              Y = U.computedStyle,
              $ = U.computedClassNames;
            return a().createElement(
              "div",
              n({ className: E()(i.Z.base, ...$, e), style: Y }, k),
              I,
            );
          });
      },
        ...
        (0, F.memo)(({ children: u }) => {
          const e = (0, F.useContext)(D.Y),
            ...
            n = (0, F.useCallback)((u, e) => {
              ...
              C(Object.assign({ width: A, height: F }, (0, r.T)(A, F, B.j)));
            }, []);
          ((0, t.Z)(() => {
            engine.on("clientResized", n);
          }),
            (0, F.useEffect)(() => () => engine.off("clientResized", n), [n]));
          const l = (0, F.useMemo)(() => Object.assign({}, i), [i]);
              ...
              s(
                {
                  ...
                  style: b,
                  mt: !0 === i ? h[A || "paragraph-P16"].mt : i,
                  mr: !0 === d ? h[A || "paragraph-P16"].mr : d,
                  mb: !0 === _ ? h[A || "paragraph-P16"].mb : _,
                  ml: !0 === f ? h[A || "paragraph-P16"].ml : f,
                },
                S,
              ),
                    ...
                    return r.includes(A)
                      ...
                      : ((u, e = F.left) => {
                          ...
                          const E =
                            ...
                            t = u.replace(/&nbsp;/g, " ");
                          return (
                            D(t, /( )/, e).forEach((u) => (A = A.concat(D(u, E, F.left)))),
                            A
                          );
                        })(u, e);
                  })(u, e),
      ...
      883: (u, e, A) => {
        ...
        var F = A(6483),
          ...
          B = A(6179),
          r = A.n(B);
        const a = R.strings.mt_birthday.mail.animationControls;
        (0, B.memo)(({ isActiveAnimation: u, onToggle: e }) => {
          const A = E()(
            "AnimationControls_base_87",
            !u && "AnimationControls_base__disabledAnimadion_e5",
          );
          return r().createElement(
            ...
            r().createElement(
              ...
              r().createElement("div", { className: "AnimationControls_icon_12" }),
              r().createElement(t.ZP, {
                className: "AnimationControls_text_ff",
                text: u ? a.animationOffText() : a.animationOnText(),
              }),
            ),
          );
        });
    ...
    (F.O = (e, A, E, t) => {
      if (!A) {
        ...
        for (i = 0; i < u.length; i++) {
          for (var [A, E, t] = u[i], B = !0, r = 0; r < A.length; r++)
