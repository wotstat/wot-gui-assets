      ...
      544: (e, u, t) => {
                      ...
                      f = (({ observableModel: e }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, t) => {
                            const n = A(t);
                            if (Array.isArray(u)) {
                              const r = u.reduce((e, u) => ((e[u] = o.LO.box(n[u], {})), e), {});
                              return (
                                "real" === e &&
                                  s.subscribe(
                                    (0, o.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                i = a.reduce((e, [u, t]) => ((e[t] = o.LO.box(n[u], {})), e), {});
                              return (
                                "real" === e &&
                                  s.subscribe(
                                    (0, o.aD)((e) => {
        ...
        const P = {
          ...
          I = (e) => {
            ...
            const r = M(),
              ...
              o = r.mediaHeight,
              i = r.mediaSize;
            return s().createElement("div", O({ className: w()(t, P[a], N[o], H[i]) }, n), u);
          },
          W = ["children"],
          z = (e) => {
            let u = e.children,
        ...
        const q = (e) => {
          ...
          return s().createElement(
            ...
            n &&
              s().createElement("div", { className: w()($.goto, null == r ? void 0 : r.goto) }, n),
          );
        };
        var X = t(41);
        const Y = (e, u) => {
        ...
        const we = {
          ...
          Oe = (0, i.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Re, onDrag: n = Me }) => {
                  ...
                  ((t.style.transform = `translateX(${0 | E}px)`),
                    ((e) => {
                      if (a.current && o.current && c.current && d.current) {
                        if (0 === e)
                          return (a.current.classList.add(Te), void o.current.classList.remove(Te));
                        if (
                          ((u = c.current),
                          (t = d.current),
                          e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (a.current.classList.remove(Te), void o.current.classList.add(Te));
                        var u, t;
              ...
              return s().createElement(
                "div",
                {
                  className: w()("HorizontalBar_base_fa517", u.base),
                  ref: r,
          ...
          Ne = ({
            ...
            const d = (0, i.useMemo)(() => {
                const e = n || {};
                return Object.assign({}, e, { base: w()(Pe.base, e.base) });
              }, [n]),
              E = (0, i.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
            return s().createElement(
              "div",
              { className: w()(Pe.defaultScroll, t), onWheel: u.handleMouseWheel },
              s().createElement(
                "div",
                { className: w()(Pe.defaultScrollArea, r) },
          ...
          He = ({ api: e, className: u, classNames: t, children: n }) => (
            ...
            s().createElement(
              "div",
              { className: w()(Pe.base, u) },
              s().createElement(
                "div",
                {
                  className: w()(Pe.wrapper, null == t ? void 0 : t.wrapper),
                  onWheel: e.handleMouseWheel,
                  ref: e.wrapperRef,
                },
                s().createElement(
                  "div",
                  { className: w()(Pe.content, null == t ? void 0 : t.content), ref: e.contentRef },
                  n,
                ),
              ),
            )
          );
        ((He.Bar = Oe), (He.Default = Ne));
        const Ie = ye({
          ...
          qe = (0, i.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = $e, onDrag: n = Ge }) => {
              const r = (0, i.useRef)(null),
                a = (0, i.useRef)(null),
                o = (0, i.useRef)(null),
                c = (0, i.useRef)(null),
              ...
              return s().createElement(
                "div",
                {
                  className: w()("VerticalBar_base_b5610", u.base),
                  ref: r,
                  onWheel: e.handleMouseWheel,
                },
                s().createElement("div", {
        ...
        const Eu = ({ position: e, visible: u }) =>
            s().createElement("div", {
              className: w()(cu.base, cu[`base__${e}`], u && cu.base__show),
            }),
                ...
                o
                  ? s().createElement(
                      ...
                      s().createElement(
                        ...
                        s().createElement("div", { className: "Footer_rewardsSelectedIcon_dbf0d" }),
                      ),
                    )
                  : s().createElement(
                      "div",
        ...
        engine.whenReady.then(() => {
          U().render(
            s().createElement(
              z,
              null,
              s().createElement(F, { options: Lu }, s().createElement(Tu, null)),
            ),
