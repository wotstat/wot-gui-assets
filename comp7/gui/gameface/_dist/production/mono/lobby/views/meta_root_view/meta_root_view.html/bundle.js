  ...
  Za = ({ isHover: s, size: t, disabled: r = !1 }) =>
    e.jsx("div", {
      ...
      children: r
        ...
        : e.jsxs(e.Fragment, {
            children: [
              e.jsx("div", { className: Ja.border }),
              e.jsx("div", { className: Ja.borderHover }),
            ],
          }),
    }),
  es = {
    ...
    return e.jsx(p, {
      ...
      children: e.jsxs("div", {
        className: a(
          es.base,
          es[`base__${i}`],
          r ? es.base__disabled : es.base__hasAppearAnimation,
        ),
        onMouseEnter: () => {
        ...
        children: [
          ...
          e.jsx("div", {
            className: es.count,
            children: e.jsx(x, { format: "integral", value: t }),
          }),
          e.jsx("div", {
            className: es.label,
            children: R.strings.comp7_ext.awardsWidget.title(t),
          }),
          !r &&
            e.jsxs(e.Fragment, {
              children: [
...
const Bs = { None: "none", Active: "active" },
        ...
        e.jsx("div", { className: a(ys.screwIcon, ys.screwIcon__left) }),
        {
          ...
          Active: e.jsxs(e.Fragment, {
            children: [
              ...
              e.jsx("div", {
                className: a(ys.cell, ys.cell__battles),
                children: e.jsx(x, { value: c }),
              }),
              e.jsx("div", {
                className: a(ys.cell, ys.cell__score),
                children: e.jsx(x, { value: d }),
              }),
            ],
          }),
        }[s],
  ...
  $s = ({ children: a, isEnabled: s, contextMenuArgs: t }) =>
    s ? e.jsx(y, { args: t, children: a }) : a,
  qs = {
    base: "Row_c0c9eb7f",
      ...
      children: [
        ...
        T(d, (r) => {
          const n = ((e, a, s) => {
            ...
            o = ((e, a) => (Number.isInteger(e) ? (a === e ? "active" : "inactive") : "disabled"))(
              n,
              t,
            );
          return e.jsx(
  ...
  ht = r(
    ({
      ...
      const C = s.useCallback(() => {
          x !== As.None &&
            (b.yes1(), d.getTableRecords(t, l - (l % t)), n({ type: "personalPosition" }));
        }, [d, t, x, l, n]),
        k = s.useCallback(
          (e) => {
...
var xt = ((e) => ((e.Active = "active"), (e.Inactive = "inactive"), (e.Disabled = "disabled"), e))(
  xt || {},
);
const bt = {
                ...
                children: [
                  e.jsxs(pt, {
                    ...
                    children: [
                      ...
                      e.jsx(ma, { seasonName: t, rank: s, size: ua.x64, className: bt.rankEmblem }),
                    ],
                  }),
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          ...
          children: e.jsx("div", {
            className: a(Ct.image, Ct[`image__season_${i.season.name.get()}`]),
          }),
        }),
        e.jsx("div", {
          className: Ct.title,
...
const [Ht, Ut] = w()(
    ({ observableModel: e }) => {
      const a = {
        ...
        o = t(
          (e) => ({
            division: Y(r(e), (e) => e.state === Na.Current)?.name,
            hasInfo: !ha(s(e).rank),
          }),
          { equals: i.shallow },
        ),
          ...
          Kr,
          {
            ...
            children: [
              ...
              e.jsxs("div", {
                ...
                children: [
                  o &&
                    e.jsx("div", { className: li, children: R.strings.comp7_ext.division.note() }),
...
function Xn({
  value: s,
  iconSlot: t = e.jsx("div", { className: On }),
  tooltipArgs: r,
  className: i,
  children: n,
}) {
...
function Kn({ value: s, className: t }) {
  return e.jsxs("div", {
    ...
    children: [
      ...
      e.jsx("div", { className: Vn, children: e.jsx(ya, { value: s }) }),
    ],
  });
}
function Jn() {
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className: mo,
          style: {
            backgroundImage: `url(${R.images.gui.maps.icons.vehicle.x120x96.$dyn(`${s}`)})`,
          },
        }),
        a
          ? e.jsx(La, {
...
const fo = "ProgressionLayout_b39a022a",
  ...
  Lo = r(({ index: a, className: s }) => {
    ...
    return e.jsx(
      za,
      { state: i.state, className: s, size: r >= S.ExtraLarge ? "x234" : "x173" },
      a,
    );
  }),
  ...
  Mo = r(({ className: s }) => {
    ...
    return e.jsx("div", {
      className: a(Eo, s),
      children: T(t.qualificationBattles.get().length, (a) =>
        e.jsx(Lo, { index: a, className: zo }, a),
      ),
    });
  }),
  Wo = (e) => {
...
const nd = [Va.Locked, Va.ReadyToPurchase],
  ...
  [cd, dd] = w()(
    ({ observableModel: e, mode: a }) => {
      const s = e.array("rankDiscounts"),
        ...
        x = t(
          () => C(s.get(), (e) => ({ ...e, divisions: Mt(C(e.divisions, (e) => ({ ...e }))) })),
          { equals: N },
        ),
        b = t(
          (e) => {
          ...
          e.jsx(se, {
            classNames: {
              wrapper: a(
                ld.areaWrapper,
                r?.areaWrapper,
                "hidden" !== h && ld.areaWrapper__hasScroll,
              ),
  ...
  hd = r(({ index: s, className: t }) => {
    ...
    return e.jsx("div", {
      className: a(md, t),
      style: { backgroundImage: `url('${ud.$num(i.id)}')` },
    });
  }),
        ...
        children: [
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsx("div", {
                className: a(Ad.corner, Ad.corner__top, Ad.corner__right, r?.corner),
              }),
              e.jsx("div", {
                className: a(Ad.corner, Ad.corner__bottom, Ad.corner__left, r?.corner),
              }),
              e.jsx("div", {
                className: a(Ad.corner, Ad.corner__bottom, Ad.corner__right, r?.corner),
              }),
            ],
          }),
  ...
  Bl = r(({ className: s }) => {
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx("div", {
          className: Il,
          children: T(t.computes.rankDiscountsLength(), (a) =>
            e.jsx(Pl, { index: a, className: yl }, a),
          ),
        }),
                ...
                t.computes.hasLimitedQuantity() &&
                  e.jsx("div", {
                    ...
                    children: e.jsx(Q, {
                      ...
                      binding: {
                        count: e.jsx("span", { className: e_.count, children: r.limitedQuantity }),
                      },
                    }),
                  }),
              ],
  ...
  [Y_, G_] = w()(
    ({ observableModel: e }) => {
      ...
      return {
        ...a,
        computes: {
          questCardsLength: t((e) => s(e).length),
          questCard: r,
          questRewards: i,
          isQuestLocked: n,
        },
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsx(cm, {
              current: n,
              total: o,
              isDisabled: i !== O_.ACTIVE,
              className: _m.progress,
            }),
            e.jsx("div", { className: _m.description, children: c }),
            e.jsx(Ce, {
              data: r.computes.questRewards(s, t, _),
              size: _,
              rewardItemClassMix: _m.reward,
            }),
          ],
        }),
...
const pm = ({ type: s }) =>
    "sideLeft" === s || "sideRight" === s
      ...
      : e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("div", {
              className: hm.arrowContainer,
              children: e.jsx("div", { className: hm.arrow }),
            }),
  ...
  Nm = {
    wrapper: "QuestsList_contentWrapper_71c1145a",
    content: "QuestsList_scrollContent_c8f7fb3d",
  },
  Cm = r(({ className: t }) => {
  ...
  Mm = ({ reward: s, onClick: t, isDisabled: r, className: i }) => {
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx("div", {
          className: Em.claimRewardsButton,
          children: e.jsx(Lm, { isDisabled: r, onClick: t }),
        }),
...
const [Eu, zu] = w()(
    ({ observableModel: e }) => {
      const a = {
        ...
        c = t((e) =>
          [...ve(a.cards.get(), 0, e)].reduce((e, a) => (e += a.seasonPoints.length), 0),
        ),
        l = t((e) =>
          X(
            a.cards.get(),
        ...
        j = t(() => {
          ...
          return Je(a.cards.get(), (a, t) =>
            Je(a.rewards, (a) =>
              Lu({ reward: a, bannerState: e, cardIndex: t, maxAchievedCardIndex: s }),
            ),
          );
        }),
        w = t(() => {
  ...
  Wu = r(({ className: s }) => {
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx("div", {
          className: a(Mu.overlay, Mu.overlay__full, o && d === c && Mu.overlay__achieved),
        }),
      ],
    });
  }),
  ...
  $u = ({ isAnimated: s, visible: t, hasDelay: r, className: i }) => {
    ...
    return e.jsx(c.div, {
      className: a(Uu, i),
      style: n,
      children: e.jsx(ka, { className: Qu, animated: s }),
    });
  },
  ...
  ih = r(({ cardIndex: a, pointIndex: s, size: t, className: r, classNames: i }) => {
    ...
    return e.jsx(V, {
      ...
      children: e.jsx("div", {
        className: r,
        children: e.jsx(Oa, { ...o, className: i?.point, size: t }),
      }),
    });
  }),
      ...
      children: [
        ...
        e.jsxs("div", {
          ...
          children: [
            ...
            e.jsx("div", {
              className: wh.arrowContainer,
              children: e.jsx("div", { className: wh.arrow }),
            }),
            e.jsxs("div", {
  ...
  Th = r(({ className: t }) => {
    const { model: r } = zu(),
      ...
      c = Z(),
      d =
        i.year.state.get() === Pc.Finished
          ? r.computes.maxAchievedCardIndex()
          : r.computes.activeCardIndex(),
    ...
    return (
      ...
      e.jsxs("div", {
        ...
        children: [
          ...
          !i &&
            e.jsxs(e.Fragment, {
              children: [e.jsx(Th, { className: $h }), e.jsx(Sh, { className: qh })],
            }),
          e.jsx(c.div, {
            style: d,
            className: a(Qh, n && Gh),
    ...
    const { model: t } = sg(),
      {
        ...
        state: n,
        hasTentativeDates: o,
      } = t.computes.seasonScheduleInfo(s);
    return e.jsx("div", {
      className: a(hg),
      children: (() => {
        switch (n) {
  ...
  Mg = r(({ index: s, className: t }) => {
    ...
    return e.jsxs(
      "div",
      {
        className: a(
          zg.cardWrapper,
          0 === s && zg.cardWrapper__left,
          s === n - 1 && zg.cardWrapper__right,
        ),
        children: [
  ...
  Vg = {
    ...
    [ia.YearlyRewards]: () =>
      e.jsx(Eu, {
        options: ns.YEARLY_REWARDS_PAGE,
        children: e.jsx(Nu, { children: e.jsx(Zh, {}) }),
      }),
    [ia.Shop]: () => e.jsx(cd, { options: ns.SHOP_PAGE, children: e.jsx(q_, {}) }),
    [ia.YearlyStatistics]: () =>
      e.jsx(ag, { options: ns.YEARLY_STATISTICS_PAGE, children: e.jsx(Wg, {}) }),
  },
  Hg = ({ pageView: a }) => {
    const s = Vg[a];
    ...
    return e.jsxs("div", {
      ...
      children: [
        ...
        e.jsx(_s, {
          ...
          children: e.jsx(xs, {
            pageView: n,
            className: a(Ug.sidebar, i.isMedium && Ug.sidebar__medium),
          }),
        }),
        c > 0 &&
          e.jsx("div", {
...
aa(
  e.jsx(sa, {
    children: e.jsx(os, { children: e.jsx(ra, { options: ns.SCHEDULE, children: e.jsx(Qg, {}) }) }),
  }),
  { fullScreen: !0 },
);
