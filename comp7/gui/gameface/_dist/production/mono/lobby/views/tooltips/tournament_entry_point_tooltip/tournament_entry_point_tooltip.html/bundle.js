import { V as e, j as t, W as a } from "../../../../chunks/vendor.js";
import { i as s, F as n, ck as i, r as p } from "../../../../chunks/lib.js";
...
const [c, d] = s()(({ observableModel: e }) => ({ root: e.object() })),
  ...
  v = e(() => {
    const { model: e } = d(),
      {
        state: s,
        timeLeftUntilLiveMatch: p,
        timeLeftUntilNextShowMatchDay: o,
        tournamentName: c,
      } = e.root.get();
    return t.jsxs("div", {
        ...
        t.jsxs("div", {
          ...
          children: [
            ...
            h.includes(s) &&
              t.jsxs(t.Fragment, {
                children: [
                  t.jsx("div", { className: a(_.divider, m.divider) }),
                  t.jsx("div", {
