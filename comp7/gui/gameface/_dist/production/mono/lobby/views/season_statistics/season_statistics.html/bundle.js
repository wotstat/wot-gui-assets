...
const $ = [
  ...
  [L, Q] = _()(
    ({ observableModel: s }) => {
      const i = { root: s.object() },
        ...
        n = s.array("vehicleStatistics"),
        r = ((a = $) => ({ animationState: e.box(), config: O(a) }))(),
        c = ((e) => ({
          isStepActive: a((a) => e.config[e.animationState.get()].order >= e.config[a].order),
          stepDelay: a((a) => e.config[a].delay),
          getAnimationStepStyles: a((a, s = "base") =>
            o(
      ...
      children: [
        i.jsx("div", {
          ...
          children: i.jsx(p, {
            ...
            binding: {
              seasonNameUpper: `${R.strings.comp7_ext.seasonStatistics.seasonNameUpper.$dyn(n)}`,
            },
          }),
        }),
        i.jsx("div", {
  ...
  X = "HeaderSection_77242b5b",
  Y = "HeaderSection_line_9ff9a7df",
  Z = "HeaderSection_line__leftSide_7b657e5f",
  ee = "HeaderSection_line__left_e530d3ea",
  ae = "HeaderSection_line__right_12252ce6",
  se = "HeaderSection_line__rightSide_a7a3b84e",
  ie = "HeaderSection_text_7ce99c9f",
  te = ({ text: e, className: a }) =>
    i.jsxs("div", {
      className: t(X, a),
      children: [
        i.jsx("div", { className: t(Y, Z) }),
        i.jsx("div", { className: t(Y, ee) }),
        i.jsx("div", { className: ie, children: e }),
        i.jsx("div", { className: t(Y, ae) }),
        i.jsx("div", { className: t(Y, se) }),
      ],
    });
var ne = ((e) => (
  (e.Battles = "battles"),
...
const re = "LineDivider_2b197ae0",
  ...
  le = "Card_3b7c47bf",
  me = "Card_icon_c599d364",
  pe = "Card_mainValue_5bcd3830",
  he = "Card_mainDescription_27dfcf75",
  fe = "Card_divider_67c3e269",
  be = "Card_additional_78599c02",
  ge = (e, a) => {
    switch (e) {
      case ne.Battles:
        return D({ value: a, isPercentage: !0 });
      case ne.Damage:
        return Math.trunc(a);
      default:
        return D({ value: a });
  ...
  ue = s(({ index: e, className: a }) => {
    const { model: s } = Q(),
      ...
      h = n({
        ...
        to: { opacity: 1 },
        delay: m * e,
        pause: !c.computes.isStepActive(W.ShowSummary),
      });
    return i.jsxs(r.div, {
      className: t(le, a),
      style: h,
    ...
    return i.jsxs("div", {
      ...
      children: [
        ...
        i.jsxs("div", {
          className: xe.cards,
          children: [
            u(a.computes.summaryStatisticsLength(), (e) =>
              i.jsxs(
                c.Fragment,
                {
                  children: [
                    i.jsx("div", { className: xe.separator }),
                    i.jsx(ue, { index: e, className: xe.card }),
                  ],
                },
                e,
              ),
  ...
  He = s(({ index: e }) => {
    ...
    return i.jsxs(r.div, {
      ...
      children: [
            ...
            i.jsxs("div", {
              ...
              children: [
                ...
                c
                  ? i.jsx("div", {
                      className: Re,
                      children: D({ value: c.winsPercent, isPercentage: !0 }),
                    })
                  : i.jsx("div", {
                      className: Re,
        ...
        i.jsx("div", { className: ke, style: { backgroundImage: `url(${o})` } }),
      ],
    });
  }),
  Ve = {
  ...
  Ue = s(() => {
    ...
    return i.jsxs("div", {
      className: t(Ce.base, Ce[`base__${c}Season`], n.computes.getAnimationStepStyles(Ce)),
      children: [
        i.jsx(E, { className: Ce.header }),
        i.jsxs("div", {
        ...
        i.jsx("div", {
          className: Ce.buttonWrapper,
          children: i.jsx(S, {
            theme: S.themes.primary,
            size: N(s),
            onClick: e.close,
            className: Ce.button,
            children: String(R.strings.comp7_ext.seasonStatistics.button.$dyn(k(r))),
          }),
        }),
        i.jsx(j, { className: Ce.close, onClick: e.close }),
      ],
    });
  });
