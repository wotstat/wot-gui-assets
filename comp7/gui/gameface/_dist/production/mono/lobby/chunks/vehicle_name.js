...
var r = ((e) => ((e.x16 = "16x16"), (e.x24 = "24x24"), (e.x32 = "32x32"), (e.x48 = "32x32"), e))(
  r || {},
);
function o({ role: i, size: _ = "24x24", roleIconFolderPath: c, className: r, classNames: o }) {
  ...
  return e.jsx("div", {
    ...
    children: c
      ? e.jsx("div", {
          className: a(n.icon, o?.icon),
          style: { backgroundImage: `url(${c?.$dyn(h)})` },
        })
...
var t = ((e) => ((e.x24 = "24x24"), (e.x48 = "48x48"), (e.x64 = "64x64"), (e.x96 = "96x96"), e))(
  t || {},
);
