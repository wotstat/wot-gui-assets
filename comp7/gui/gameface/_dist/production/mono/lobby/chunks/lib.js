  ...
  __using = (e, t, s) => {
    ...
    null != t
      ? ("object" != typeof t && "function" != typeof t && __typeError("Object expected"),
        s && (a = t[__knownSymbol("asyncDispose")]),
        void 0 === a && ((a = t[__knownSymbol("dispose")]), s && (r = a)),
        "function" != typeof a && __typeError("Object not disposable"),
        r &&
          (a = function () {
            try {
              r.call(this);
  ...
  __callDispose = (e, t, s) => {
    var a =
        "function" == typeof SuppressedError
          ...
          : function (e, t, s, a) {
              return (
                ((a = Error(s)).name = "SuppressedError"),
                (a.error = e),
                (a.suppressed = t),
                a
              );
            },
      r = (e) => (t = s ? new a(e, t, "An error was suppressed during disposal") : ((s = !0), e)),
      n = (a) => {
        for (; (a = e.pop());)
          try {
            var o = a[1] && a[1].call(a[2]);
            if (a[0]) return Promise.resolve(o).then(n, (e) => (r(e), n()));
          } catch (i) {
            r(i);
          }
        if (s) throw t;
...
import {
  ...
  J as is,
  K as custom,
  L as useLocalObservable,
  M as runInAction$1,
  N as useReactTable,
  O as observable$1,
  P as getPaginationRowModel,
  Q as getSortedRowModel,
  S as getCoreRowModel,
  T as observer,
  U as easings$1,
} from "./vendor.js";
...
class ImagesRClassProvider {
  ...
  readOr(e, t, s = "silent") {
    const a = e.startsWith("R.images") ? e : concatWithPath(this.prefix, e),
      r = readFromR$2(e.startsWith("R.images") ? window : this.root, a);
    return void 0 === r
      ? ("silent" !== s && logBySeverity$1(`Resource not found: ${a}`, s), t())
      : r;
  }
...
class StringsRClassProvider {
  ...
  readOr(e, t, s = "silent") {
    const a = e.startsWith("R.strings") ? e : concatWithPath(this.prefix, e),
      r = readFromR$1(a, void 0, e.startsWith("R.strings") ? window : this.root);
    return void 0 === r
      ? ("silent" !== s && logBySeverity$1(`Resource not found: ${a}`, s), t())
      : r;
  }
...
class VideosRClassProvider {
  ...
  readOr(e, t, s = "silent") {
    const a = e.startsWith("R.videos") ? e : concatWithPath(this.prefix, e),
      r = readFromR(e.startsWith("R.videos") ? window : this.root, a);
    return void 0 === r
...
const easings = {
  ...
  bezier: (e, t, s, a) => (r) =>
    ...
    3 * (1 - r) * r * r * s +
    r * r * r * a,
  cubicBezier: (e, t, s, a) => (r) => {
    const n = findTForX(r, e, s);
...
function findTForX(e, t, s, a = 1e-5) {
  let r = e;
  for (let n = 0; n < 8; n++) {
    const n = bezierX(r, t, s) - e;
    if (Math.abs(n) < a) return r;
    const o = bezierXDerivative(r, t, s);
    if (Math.abs(o) < a) break;
    r -= n / o;
  }
  return r;
}
...
const convert = (e, t) => {
  const s = toMillis(e),
    a = (0, fromMs[t])(s);
  return { [typeId]: typeId, value: a, unit: t };
};
function now() {
...
const DAYS_IN_WEEK$1 = 7,
  ...
  MS_IN_SECOND$1 = 1e3,
  ONE_MINUTE$1 = 60,
  ONE_HOUR$1 = 60 * ONE_MINUTE$1,
  ONE_DAY$1 = HOURS_IN_DAY$1 * ONE_HOUR$1,
  ONE_WEEK = DAYS_IN_WEEK$1 * ONE_DAY$1;
        ...
        (t[s] = (function (t) {
          return (s) => {
            ...
            return (
              ...
              a(),
              () => {
                (n(), window.removeEventListener(r, o), (e.listeners -= 1), a());
              }
            );
          };
        })(s)),
...
function addPreloadTexture$1(e) {
...
function initExternalPaddings$1(e) {
  function t() {
    const { top: t, right: s, bottom: a, left: r } = viewEnv.getExternalPaddingsRem();
...
function pipe(e, t, s, a, r, n, o, i, u) {
  switch (arguments.length) {
    case 1:
      return e;
    case 2:
    ...
    case 6:
      return n(r(a(s(t(e)))));
    case 7:
      return o(n(r(a(s(t(e))))));
    case 8:
      return i(o(n(r(a(s(t(e)))))));
    case 9:
      return u(i(o(n(r(a(s(t(e))))))));
    default: {
      let e = arguments[0];
...
function create(
  { initializer: e = !0, rootId: t = 0, getRoot: s = getRootDefault, context: a = "model" } = {},
  { name: r = "DataLayer" } = {},
) {
  const n = new Map(),
  ...
  function u() {
    try {
      ...
      throw new Error(`Failure get root of ${r}. Root id: ${t}. Context: ${a}`);
    }
  }
  const l = (e) => {
    const s = u();
    ...
    try {
      ...
      throw new Error(`Failure readByPath in ${r}. Root id: ${t}. Context: ${a}:\n${n}\n`);
    }
  };
  function c(e) {
  ...
  return {
    subscribe: (s, r) => {
      const o = addModelObserver$1("string" == typeof r ? `${a}.${r}` : a, t, !0);
      return (n.set(o, s), e && s(l(r), []), o);
    },
    readByPath: l,
    readSafeByPath: (e) => {
      const t = u();
...
function createMockInstance(e, t) {
  return {
    ...
    readByPath: e,
    createCallback: (s, a) => {
      const r = e(resolvePath(a, t));
      return (...e) => {
        r(s(...e));
      };
    },
    createCallbackNoArgs: (s) => {
      const a = e(resolvePath(s, t));
      return () => {
        a();
      };
    },
...
function addEventListener(e, t, s, a) {
  ...
  (function () {
    ...
    function d(e, t) {
      ...
      if (
        ...
        (this.method = ((a = t.method || "GET"), (r = a.toUpperCase()), s.indexOf(r) > -1 ? r : a)),
...
class Iter {
  ...
  map(e) {
    ...
    return new Iter({
      *[Symbol.iterator]() {
        for (const a of s) yield e(a, t.index++);
      },
    });
  }
  reverse() {
  ...
  filter(e) {
    ...
    return new Iter({
      *[Symbol.iterator]() {
        for (const a of s) e(a, t.index++) && (yield a);
      },
    });
  }
  nonNullables() {
  ...
  skip(e) {
    ...
    return new Iter({
      *[Symbol.iterator]() {
        for (const a of s) t.index++ < e || (yield a);
      },
    });
  }
  chunk(e) {
    ...
    return new Iter({
      *[Symbol.iterator]() {
        let s = [];
        for (const a of t) (s.push(a), s.length >= e && (yield s, (s = [])));
        s.length > 0 && (yield s);
      },
    });
  }
  reduce(e, t) {
    let s = t;
    for (const a of this.iterable) s = e(s, a, this.index++);
    return s;
  }
  count() {
    let e = 0;
...
function map(e, t) {
  return Array.isArray(e) ? e.map(t) : e.map((e, s, a) => t(e?.value, s, a));
}
function toArray(e) {
...
function slice(e, t = 0, s = e.length - 1) {
  return {
    [Symbol.iterator]() {
      let a = Math.max(t, 0);
      const r = Math.min(s, lastIndexZero(e));
      return {
        next: function () {
...
function arabicToRoman(e) {
  ...
  for (let s = ARABIC$1.length - 1; s >= 0; s--) {
    let a = ARABIC$1[s];
    for (; void 0 !== a && e >= a;) ((t += ROMAN$1[s]), (e -= a));
  }
  return t;
}
function toRoman(e) {
...
const LOWER_ALPHABET = "abcdefghijklmnopqrstuvwxyz",
  ...
  createString =
    ...
    (t, s = int(-Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER)) => {
      const a = e.length;
      let r = s;
      const n = () => ((r = (9301 * r + 49297) % 233280), r / 233280);
      let o = "";
      for (let i = 0; i < t; i++) {
        const t = Math.abs(Math.floor(n() * a));
        o += e[t % e.length];
      }
      return o;
    };
...
function throttle$1(e, t, s, a) {
  ...
  return (
    "boolean" != typeof t && ((a = s), (s = t), (t = void 0)),
    (u.cancel = function () {
      (i(), (n = !0));
    }),
    u
...
function eq(e, t, s, a, r) {
  ...
  (s < 0 && (s = -1), (r = r || []));
  let c = (a = a || []).length;
  for (; c--;) if (a[c] === i) return r[c] === u;
  if ((a.push(e), r.push(t), l)) {
    if (((c = i.length), c !== u.length)) return !1;
    for (; c--;) if (!eq(i[c], u[c], s - 1, a, r)) return !1;
  } else {
    ...
    for (; c--;) {
      ...
      if (!Object.prototype.hasOwnProperty.call(u, t) || !eq(i[t], u[t], s - 1, a, r)) return !1;
    }
  }
...
function addSpaceAndMap(e, t, s) {
  return langsWithoutSpace.has(t)
    ? e.map(s)
    : e.map((e, t, a) => (t === a.length - 1 ? s(e, t, a) : s(`${e} `, t, a)));
}
...
function generateMediaClasses(e, t) {
  const s = t["width" === e ? "height" : "width"],
    a = new Set(t[e].classes),
    r = new Set(
      s.classes.filter((e) => !(!e.endsWith("Width") && !e.endsWith("Height")) || a.has(e)),
    );
  return Array.from(new Set([...a, ...r])).join(" ");
}
function calculateMedia(e, t, s) {
  const a = BREAKPOINTS.reduce(
      (s, a) => (
        a.width <= e &&
          (s.width.classes.push(a.className, `${a.className}Width`),
          s.width.names.push(a.name),
          (s.width.weight += 1)),
        a.height <= t &&
          (s.height.classes.push(a.className, `${a.className}Height`),
          s.height.names.push(a.name),
          (s.height.weight += 1)),
        s
      ),
      {
    ...
    r = a.width.weight <= a.height.weight ? "width" : "height",
    n = a[r],
    o = n.names[n.names.length - 1] ?? breakpoints.extraSmall,
...
function MediaWrapperElement({ children: e, className: t, ...s }) {
  const { mediaClass: a, upscale: r } = useMedia();
  return jsxRuntimeExports.jsx("div", {
    className: clsx(t, "media-wrapper", a, r && "media-upscale"),
    ...s,
    children: e,
  });
}
...
function useAdaptiveMemo(e, t) {
  ...
  return reactExports.useMemo(() => {
    const [t, a] = e();
    return accumulate(s, t, a);
  }, [s.breakpoint.name, s.breaks, ...t]);
}
...
function useAdaptiveWidth(e, t) {
  ...
  return t
    ? Object.values(breakpointsByType).reduce(
        (e, a) => (t[a.name] && s.sides.width >= a.width ? { ...e, ...t[a.name] } : e),
        e,
      )
    : e;
}
const mediaWrapper = Object.freeze(
...
function useDebounce(e, t, s) {
  const a = reactExports.useMemo(() => debounce(s, e), t);
  return (reactExports.useEffect(() => a.cancel, [a]), a);
}
function useEmitter() {
  return reactExports.useMemo(() => {
    const e = {},
    ...
    return {
      on: (e, a) => (t(e).add(a), () => s(e, a)),
      off: s,
      trigger: (e, ...s) => {
        for (const a of t(e).values()) a(...s);
      },
    };
  }, []);
}
...
const createApi = () => {
    ...
    return {
      ...
      register: function (e, a) {
        ...
        const r = t(e);
        return (r.includes(a) || r.push(a), () => s(e, a));
      },
      unregister: s,
...
function useHandleKey(e, t, s, a = !1) {
  const r = normalizeKeyCode(e),
    n = useEvent((e) => {
      isEventHandled$1() || (s(e), setEventHandled$1(), a && e.stopPropagation());
    }),
    o = useApi$2(),
    i = reactExports.useMemo(() => o[t].register(r, n), [o, t, r, n]);
...
function Provider$1(e) {
  ...
  reactExports.useEffect(() => {
    ...
    return (
      ...
      () => {
        (window.removeEventListener("keydown", e), window.removeEventListener("keyup", a));
      }
    );
  }, [t, s]);
  ...
  return jsxRuntimeExports.jsx(Context$7.Provider, { value: a, children: e.children });
}
...
function useKeydownListener(e = keyStringCodes.ESCAPE, t = defaultCallback, s = !1) {
  ...
  reactExports.useEffect(() => {
    if (a !== keyStringCodes.NONE)
      return (
        window.addEventListener("keydown", e, s),
        () => window.removeEventListener("keydown", e, s)
      );
    function e(e) {
      e.code !== a || isEventHandled$1() || (t(e), setEventHandled$1(), s && e.stopPropagation());
    }
  }, [t, a, s]);
}
  ...
  useMouseCoordinatesSprings = (e) => {
    const t = reactExports.useCallback(
        (t) => {
          ...
          return 0 !== t.clientX && 0 !== t.clientY && t.clientX <= s - 2 && t.clientY <= a - 2;
        },
        [e],
      ),
      s = useSpring(() => ({ ...getMouseGlobalPosition("px") }), []);
    return (
      reactExports.useEffect(() => {
        const e = (e) => {
          if (!t(e)) return;
          const [, a] = s;
          a.start({ x: e.clientX, y: e.clientY });
        };
        return (
...
function useRepeatCallback(e, t, s = []) {
  ...
  return [
    reactExports.useCallback((s) => {
      (0 !== a.current && r(), (a.current = window.setInterval(() => e(s, !0), t)), e(s, !1));
    }, n),
    r,
  ];
}
...
function useThrottle(e, t, s) {
  const a = reactExports.useMemo(() => throttle(s, e), t);
  return (reactExports.useEffect(() => a.cancel, [a]), a);
}
...
const justCall = (e) => e(),
  ...
  usePreloadImagesState = (e, t) => {
    const [s, a] = reactExports.useState("pending");
    return (
      reactExports.useLayoutEffect(() => {
        let t = 0,
          s = 0;
        const r = () => {
          t + s === e.length && a(0 === t ? "success" : "error");
        };
        e.forEach((e) => {
          const a = new Image();
          ((a.src = e),
...
function useTicker(e) {
  const { type: t, tick: s, limit: a } = e,
    r = e.autostart ?? !1,
    n = e.start ?? zero,
    o = toMillis(s),
    [i, u] = reactExports.useState({ current: n, running: r }),
  ...
  reactExports.useEffect(() => {
    const e = (e) => {
      u((r) => {
        ...
        const n = "countdown" === t ? subtract(r.current, e) : add$1(r.current, e),
          o = { ...r, current: n };
        return (
          isDuration(a) &&
            ("countdown" === t
              ? lt(subtract(n, s), a) && ((o.current = a), (o.running = !1))
              : gt(add$1(n, s), a) && ((o.current = a), (o.running = !1))),
          o
        );
      });
    };
...
function watchResizes(e, t) {
  ...
  function r() {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      isEqual(o, r) || ((a[t] = o), (n = !0));
    }
    (n && t(a), (s = requestAnimationFrame(r)));
  }
  return {
    start() {
      r();
    ...
    [i, u] = reactExports.useMemo(() => {
      ...
      function u() {
        a ||
          ...
          (o.current.timeoutId = window.setTimeout(l, n)));
      }
      function l() {
      ...
      const d = {
        ...
        show: l,
        rerun: function () {
          o.current.status !== statuses$1.idle && (a ? d.hide() : u());
        },
      };
      return [
        d,
...
function useSimpleTooltip({
  ...
  return useTooltip({
    ...
    args: reactExports.useMemo(() => ({ body: t, header: s, note: a, alert: e }), [e, t, s, a]),
  });
}
...
const Context$6 = reactExports.createContext(null);
function SoundsProvider({ severity: e = "warn", overrides: t, silent: s = !1, children: a }) {
    ...
    n = reactExports.useMemo(
      () => ({
        play: function (t, a) {
          if (s) return;
          const n = r[t];
          n ? n(a) : logBySeverity(`There is no sound for event: ${t}`, e);
        },
        settings: { plays: r, severity: e, silent: s },
      }),
      [r, e, s],
    );
  return jsxRuntimeExports.jsx(Context$6.Provider, { value: n, children: a });
}
function useSounds() {
...
function useContextMenu({
  ...
  const o = useSounds(),
    [{ hide: i }, u] = reactExports.useMemo(() => {
      function i() {
        r || sendEvent$1.contextMenu.open(e, t, s, a);
      }
      return [
        {
          hide: function () {
          ...
          onMouseDown: (e) => {
            isRightClick$1(e) &&
              (o.play("show-context-menu", {
                target: n ?? "react-toolkit:use_context_menu",
                original: e,
              }),
              i());
          },
...
function useSpecialContextMenu(e, t, s) {
  return useContextMenu(
    reactExports.useMemo(() => {
      const a = { menuId: e, menuArgs: JSON.stringify(t), ...s?.args };
      return {
        ...s,
...
function calculate(e, t) {
  return e + (e % 2) * ("extend" === t ? 1 : -1);
}
function useAdjustScreenWidth(e = "extend") {
  const t = useScreenSize(),
    [s, a] = reactExports.useState(calculate(t.width, e));
  return (
    reactExports.useEffect(() => {
      a(calculate(t.width, e));
    }, [e, t.width]),
    s
  );
}
function useExternalPaddings(e = "px") {
  const [t, s] = reactExports.useState(viewEnv.getExternalPaddingsRem()),
    a = useEvent(() => s(viewEnv.getExternalPaddingsRem())),
    r = useScaleState$1();
  return (
    reactExports.useEffect(() => events$3.onExternalPaddingsUpdated(a), [a]),
    reactExports.useMemo(
      () => ({
...
function cloneModel(e, { shallow: t = !0, depth: s = 0, maxDepth: a = 32 } = {}) {
  const r = e,
    n = typeof e;
  if (s > a) throw new Error(`Too deeply nested to copy. Max is ${a}.`);
  if (nonConvertingTypes.has(n)) return r;
  if (null === r) return r;
  const o = { depth: s + 1, maxDepth: a };
  if (Array.isArray(r)) return r.map((e) => cloneModel(e, o));
  if ("object" === n) {
    const a = r.constructor?.name ?? "UNKNOWN";
    if (Array.isArray(e)) return e.map((e) => cloneModel(e, o));
    if ("CoherentArrayProxy" === a) return e.map((e) => cloneModel(e.value, o));
    if ("Dict" === a) return;
    if ("UNKNOWN" === a) return;
    if (a.includes(":ViewModel:") || "Object" === a) {
      ...
      }
      {
        ...
        for (const t in r) {
          ...
          bindingsForbidden.has(a) || (e[t] = cloneModel(s, o));
        }
        return e;
      }
    }
    const n = {};
    for (const e of Object.keys(r)) n[e] = cloneModel(r[e], o);
    return n;
  }
...
class DLDict {
  constructor(e, t = DEFAULT_OPTIONS) {
    ...
    ((this._keys = observable.set(new Set(a))), (this._data = observable.box(s, MOBX_OPTIONS)));
  }
  _data;
  _keys;
  get keys() {
  ...
  map(e) {
    const t = [],
      s = this._data.get();
    for (const a of this.keys.values()) t.push(e(s[a].get(), a));
    return t;
  }
  reduce(e, t) {
    let s = t;
    const a = this._data.get();
    for (const r of this.keys.values()) s = e(s, a[r].get(), r);
    return s;
  }
  takeItem(e, t) {
    const s = e.get(t);
...
function createSimpleGetter(e) {
  return (t, s) => {
    const a = resolvePath(t, s);
    return a ? readByPath(a, e) : e;
  };
}
...
function createObservableModel(e, t, s) {
  ...
  const r = (r, n, o = DEFAULT_BOX_CONFIG) => {
      const i = observable.box(r(s(n)), o);
      return ("real" === t && e.subscribe((e) => a.push(() => i.set(r(e))), n), i);
    },
    n = (r, n) => {
      const o = new DLDict(s(r), n);
      return ("real" === t && e.subscribe((e, t) => a.push(() => o.update(e, t)), r), o);
    },
    o = (r, n) => {
      const o = observable.box(s(r) ?? n, DEFAULT_BOX_CONFIG);
      return ("real" === t && e.subscribe((e) => a.push(() => o.set(e)), r), o);
    };
  return {
    dict: n,
    ...
    primitives: (r, n) => {
      const o = s(n);
      if (Array.isArray(r)) {
        const s = r.reduce((e, t) => ((e[t] = observable.box(o[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              a.push(() =>
    ...
    (t, s, a) => {
      ...
      function n(n) {
        ...
        return (
          ...
          jsxRuntimeExports.jsx(r.Provider, { value: E, children: u })
        );
      }
      return (
        (n.displayName = e),
  ...
  render(e) {
    return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
      children: this.items.reduceRight(
        (e, [t, s], a) => reactExports.createElement(t, { ...s, key: a }, e),
        e,
      ),
    });
  }
...
function injectShowModel() {
  const e = (t = window.model, { depth: s = 16, convertArrays: a = !0 } = {}) => {
    if (s < 0)
      return (
        console.warn(
    ...
    switch (typeof t) {
      ...
      case "object": {
        ...
        switch (!0) {
          ...
          default: {
            const s = {};
            for (const a in t) Object.prototype.hasOwnProperty.call(t, a) && (s[a] = e(t[a], r));
            return s;
          }
        }
      }
...
async function runView(
  ...
  (r && engine.enableImmediateLayout(!0),
    ...
    ReactDOM.createRoot(t).render(
      jsxRuntimeExports.jsx(n, { children: jsxRuntimeExports.jsx(Provider$1, { children: e }) }),
    ),
    a && (initExternalPaddings$1(t), enableFullScreenModeSupported$1()));
}
...
function ModelRouterProvider({
  ...
  const o = reactExports.useRef([]),
    ...
    u = reactExports.useMemo(
      () => create({ context: s, getRoot: a, initializer: r, rootId: n }),
      [s, a, r, n],
    ),
        ...
        return events$3.onDisplayChanged((t, s) => {
          ...
          a &&
            (s === displayStatus$1.hidden
              ? ((e = a.paused), a.pause())
              : e || s !== displayStatus$1.shown || a.play());
        });
      }),
      useMount$1(() => {
        let e = !1;
      ...
      reactExports.useEffect(() => {
        if (c && d.current) {
          const e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: noop$1 },
            t = () => {
              let t = 0;
              const [s, a] = createLoop$1(() => {
                if (d.current) {
                  const { currentTime: s, duration: a } = d.current;
                  if (
                    (t !== s &&
                      (e.changeTimeHandlers.forEach((e) => e({ currentTime: s, duration: a })),
                      (t = s)),
                  ...
                  r.forEach((t, a) => {
                    void 0 !== r[a] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        const s = Object.keys(o ?? {})[a];
                        return e({ time: t, name: `${o ? s : `${DEFAULT_NAME_KEYFRAME$1}_${a}`}` });
                      });
                  });
                }
              });
...
function defineStyledComponent(e, t, s) {
  const a = "object" == typeof t && "cva" in t ? t.cva?.variants : s?.variants,
    r = a ? Object.keys(a) : [];
  if ("object" == typeof t) {
    const s = t,
      a = cva(s.className, s.cva),
      n = s.element,
  ...
  HeadlessButton = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(HeadlessButtonBase, {
      ...
      onMouseEnter: function (e) {
        (r || n || u.play("mouse-enter", { target: a || "Button", original: e }), s?.(e));
      },
      onClick: function (e) {
        r || (n || u.play("click", { target: a || "Button", original: e }), t?.(e));
      },
      children: e,
    });
  }),
        ...
        (t[s] = (function (t) {
          return (s) => {
            ...
            return (
              ...
              a(),
              () => {
                r && (o(), window.removeEventListener(n, i), (e.listeners -= 1), a(), (r = !1));
              }
            );
          };
        })(s)),
...
function getBrowserTexturePath(e, t, s, a = 1) {
...
class DataTracker {
  ...
  addCallback(e, t, s = 0, a = !0) {
    void 0 === this._updateHandler &&
      (this._updateHandler = engine.on("viewEnv.onDataChanged", this._emmitDataChanged, this));
    const r = env.view.addModelObserver(e, s, a);
    return (
      r > 0
        ? ((this._callbacks[r] = t),
...
function dumpViewModel(e) {
  ...
  for (const s in e)
    if (Object.prototype.hasOwnProperty.call(e, s)) {
      const a = Object.prototype.toString.call(e[s]);
      if (a.startsWith("[object CoherentArrayProxy]")) {
        const a = e[s];
        t[s] = [];
        for (let e = 0; e < a.length; e++) t[s].push({ value: dumpViewModel(a[e].value) });
      } else
...
const makeGlobalBoundingBox = (e) => ({
  ...
  sendShowPopOverEvent = (e, t, s, a, r = R.invalid("resId"), n) => {
...
const handleViewEvent = (e, t, s = {}, a = 0) => {
    viewEnv.handleViewEvent({
  ...
  Tooltip$2 = ({
    ...
    const f = reactExports.useRef({
      ...
      g = reactExports.useMemo(() => d || getFromCallStack().resId, [d]),
...
const UB_SIMPLE_TOOLTIPS = R.views.common.tooltip_window.simple_tooltip_content,
  ...
  SimpleTooltip = ({ children: e, body: t, header: s, note: a, alert: r, args: n, ...o }) => {
    const i = reactExports.useMemo(() => {
      const e = { ...n, body: t, header: s, note: a, alert: r };
  ...
  base__medium$9 = "Checkbox_base__medium_70ef629e",
  ...
  styles$V = {
    ...
    base__medium: base__medium$9,
    base__checked: base__checked,
    checkIcon: checkIcon,
    check: check,
  },
  Check = reactExports.forwardRef(function ({ classNames: e, children: t, ...s }, a) {
    return jsxRuntimeExports.jsxs("div", {
      ...s,
      ref: a,
  ...
  HeadlessCheckbox = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Base$o, {
      ...
      onMouseEnter: function (e) {
        (l.play("mouse-enter", { target: Base$o.displayName, original: e }), r?.(e));
      },
      onClick: function (t) {
        (l.play("click", { target: Base$o.displayName, original: t }), n?.(t), o(!e));
      },
      children: a,
    });
  });
...
function UnknownVehicleImage({ size: e = sizes$c.x380x304, ...t }) {
  return jsxRuntimeExports.jsx(Base$n, { ...t, size: e, path: `vehicle.${e}.tank_empty` });
}
const VehicleImage = reactExports.forwardRef(function (
  { size: e = sizes$c.x380x304, name: t, width: s, height: a, className: r, ...n },
  o,
) {
  ...
  return i.has(u)
    ...
    : (console.warn(`Fail to retrieve icon maps/icons/vehicle/${e}/${getVehicleImageKey(t)}`),
      jsxRuntimeExports.jsx(UnknownVehicleImage, { size: e, className: r, width: s, height: a }));
});
function useCalculateLeftTime(e) {
  ...
  const a = seconds(t);
  return greaterThan(a, days(1))
    ? convert(a, "days")
    : greaterThan(a, hours(1))
      ? convert(a, "hours")
      : greaterThan(a, seconds(1))
        ? hours(1)
        : hours(0);
}
...
function calculateRangeRows(e, t, s) {
  ...
  const n = Math.ceil((r / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    o = Math.max(0, Math.ceil(a / s) - Math.floor(n * SAFETY_FACTOR));
  return [o, Math.min(t, o + n)];
}
...
function calculateRangeItems(e, t, s) {
  ...
  const a = e.animationScroll.scrollPosition.get(),
    r = e.getWrapperSize();
  if ("number" != typeof r || 0 === r || Number.isNaN(a)) return [0, 0];
  const n = Math.ceil((r / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    o = clamp$1(0, t, Math.ceil(a / s) - Math.floor(n * SAFETY_FACTOR));
  return [o, Math.min(t, o + n)];
}
const initVisibleRange = [0, 0];
function useVisibleRange(e, t, s, a, r) {
  const [n, o] = reactExports.useState(initVisibleRange),
...
const scriptRel = (function () {
  ...
  __vitePreload = function (e, t, s) {
    ...
    if (t && t.length > 0) {
      ...
      a = e(
        t.map((e) => {
          if ((e = assetsURL(e, s)) in seen) return;
          seen[e] = !0;
  ...
  keyValue = (e) =>
    intl$1.toUpperCase(strings.readOr(`readable_key_names.KEY_${e}`, () => EMPTY_VALUE)),
  EMPTY_VALUE = intl$1.toUpperCase(strings.readOrEmpty("readable_key_names.KEY_NONE_ALT")),
  keyCodeValue = {
...
function Base$m({ children: e, onClick: t, onMouseEnter: s, ...a }) {
  ...
  return jsxRuntimeExports.jsx(StyledBase, {
    ...a,
    onMouseEnter: function (e) {
      (o || r.play("mouse-enter", { target: n, original: e }), s?.(e));
    },
    onClick: function (e) {
      (o || r.play("click", { target: n, original: e }), t?.(e));
    },
    children: e,
  });
}
function KeyButtonProvider({
  ...
  useHandleKeyup(r ? keyStringCodes.NONE : normalizeKeyCode(e), t);
  const o = reactExports.useMemo(
    () => ({ keyCode: e, onActive: t, silent: s, soundTarget: a, idle: r }),
    [e, t, a, s, r],
  );
  return jsxRuntimeExports.jsx(KeyButtonContext.Provider, { value: o, children: n });
}
function Code() {
...
function ScrollVelocityGuardContent({
  ...
  return (
    useMount$1(() =>
      e.events.on("change", () => {
        n(Math.abs(e.animationScroll.scrollPosition.velocity) > s);
      }),
    ),
...
const base$K = "Cbutton_24fc9a0c",
  ...
  base__small$d = "Cbutton_base__small_a71bc2a9",
  base__medium$8 = "Cbutton_base__medium_d82a1b14",
  base__large$1 = "Cbutton_base__large_f02aee17",
  base__disabled$6 = "Cbutton_base__disabled_96f239bb",
  ...
  styles$O = {
    ...
    base__small: base__small$d,
    base__medium: base__medium$8,
  ...
  Button = ({
    ...
    return (
      reactExports.useEffect(() => {
        function e(e) {
          f && null !== m.current && !m.current.contains(e.target) && g(!1);
        }
        return (
  ...
  Waiting = ({
    ...
    isError: s = !1,
    errorMessage: a = "",
    errorBtnLabel: r = R.strings.dialogs.disconnected.cancel(),
    overlayAlpha: n = "0.8",
  }) => {
...
const background$4 = "Switcher_background_a88161d0",
  border$4 = "Switcher_border_a19f907",
  ...
  Switcher$1 = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(SwitcherContext.Provider, {
      ...
      children: jsxRuntimeExports.jsxs(Base$l, {
        ...
        onMouseEnter: function (e) {
          (g.play("mouse-enter", { target: Base$l.displayName, original: e }), s?.(e));
        },
        onClick: function (e) {
...
const sizes$a = {
  ...
  Base$k = defineStyledComponent("LoadoutItem", { element: Image$1 });
...
const LoadoutItem = reactExports.forwardRef(function (
  ...
  const _ =
    ...
    p = (() => {
      ...
      const e = a === sizes$a.s64x64 ? sizes$a.s80x80 : a;
      return overlayTypesWithoutLevel.includes(r)
        ? `components.loadout_item.overlays.${e}.${r}`
        : n
          ? `components.loadout_item.overlays.${e}.${r}_${n}_level`
    ...
    return (
      reactExports.useEffect(() => {
        ...
        return (
          r.setupDragArea(e),
          () => {
            r.setupDragArea(null);
          }
        );
      }, [r]),
      jsxRuntimeExports.jsx("div", { ...t, ref: assignRefs([a, s]), children: e })
    );
  }),
...
function DragAndDrop({
  ...
  (useEmitterSubscribe(o, "onStart", s),
    useEmitterSubscribe(o, "onMove", a),
    useEmitterSubscribe(o, "onOver", r),
    useEmitterSubscribe(o, "onDrop", n),
    reactExports.useEffect(
      () => () => {
  ...
  const l = reactExports.useMemo(() => {
    function e(e, s) {
      const a = u.dragArea ?? document.body,
        r = pxToRem$1(e.clientX - u.startPoint.x),
        n = pxToRem$1(e.clientY - u.startPoint.y);
      return t
        ? (function (e, t, s, a) {
            const r = e.getBoundingClientRect(),
              n = t.getBoundingClientRect(),
              o = r.left - (u.startPoint.x - u.offsetPoint.x),
              i = r.top - (u.startPoint.y - u.offsetPoint.y);
            return {
              x: clamp$1(o, r.width - n.width + o, s),
              y: clamp$1(i, r.height - n.height + i, a),
            };
          })(a, s, r, n)
        : { x: r, y: n };
    }
    function s(t) {
      ...
      if (s) {
        ...
        (runInAction(() => {
          s &&
            ((s.style.transform = `translate(${a}px, ${r}px)`),
            (u.currentPosition = { x: a, y: r }));
        }),
    ...
    function r(e) {
      const t = u.virtualItem,
        s = e.target,
        r = u.dropAreas.find((e) => e === s || e.contains(s)) ?? null;
      (a(), o.trigger("onDrop", e, r, t, u));
    }
    function n(e) {
      const t = e.target;
    ...
    return {
      ...
      start(e) {
        ...
        if (t instanceof HTMLElement && null !== l && null !== c) {
          ...
          (m.addEventListener("mousemove", s),
            m.addEventListener("mouseup", r),
            m.addEventListener("mouseover", n),
            i.current.add(() => {
              (m.removeEventListener("mousemove", s),
                m.removeEventListener("mouseup", r),
                m.removeEventListener("mouseover", n));
            }));
        }
      },
      reset: a,
  ...
  reactExports.useEffect(() => {
    ...
    function r() {
      ...
      if (n === r) $(!1);
        ...
        for (
          a.style.visibility = "", a.style.left = `${r.x}px`, a.style.top = `${r.y}px`;
          n >= 0;
          n--
        ) {
        ...
        for (let t = 0; t <= n; t++) {
          ...
          const r = cloneNode(s);
          r ? a.appendChild(r) : console.warn("Unexpected type of target node", s);
        }
        const o = s.cloneNode(!0);
        (o.removeAttribute("style"), a.appendChild(o), t.appendChild(a));
      }
    }
...
function detailedFormatter(e) {
  const [t, ...s] = e,
    a = s.join(COLON);
  return { separator: !0, items: Number(t) > 0 ? [LOCALE_FORMATTERS[DAYS_FORMAT]?.(t), a] : [a] };
}
...
function compactFormatter(e, t) {
  const s = e.length,
    ...
    r = { separator: !1, items: [] };
  for (let n = 0; n < s; ++n)
    if (Number(e[n]) > 0) return ((r.items = [LOCALE_FORMATTERS[a[n]]?.(e[n])]), r);
...
function ProgressBarProvider$1(e) {
  const [t, s] = reactExports.useState(Math.min(e.value, e.maxValue)),
    [a, r] = reactExports.useState(e.maxValue),
    n = usePrevious(t),
    o = usePrevious(a),
  ...
  const d = reactExports.useMemo(
    ...
    [t, a, i, r, c, e.size, e.animationEnabled],
  );
...
function ProgressBar$2({
  ...
  return jsxRuntimeExports.jsx(ProgressBarProvider$1, {
    size: e,
    ...n,
    children: jsxRuntimeExports.jsxs(Base$i, {
      size: e,
      className: t,
      children: [
...
const multiValueTypes$1 = [
  ...
  getDogTypeImage$1 = (e, t, s) => {
    const a = DOG_TAG_FOLDER_NAMES$1[e];
    if (a) {
      const r = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(a),
        n = r.$dyn(s);
      return !n && DOG_TAG_DEFAULT_ICON_NAME$1[e]
        ? `${r.$dyn(DOG_TAG_DEFAULT_ICON_NAME$1[e])}`
        : `${n}`;
    }
    return (
      console.error(
  ...
  getRewardImage$1 = (e, t = ImageSize$1.Small) => {
    const { name: s, type: a, value: r, icon: n, item: o, dogTagType: i } = e,
    ...
    switch (s) {
      ...
      case "dogTagComponents":
        return getDogTypeImage$1(i, u, n);
      case "dossier_badge":
  ...
  base__small$b = "Reward_base__small_3eddf28d",
  base__s80x80$1 = "Reward_base__s80x80_21f091ec",
  base__big$2 = "Reward_base__big_e23f2c77",
  ...
  Rewards$1 = reactExports.memo(function ({
    data: e,
    isFixedBoxSize: t,
...
const base$w = "Progressbardeltagrow_c42a7a2c",
  ...
  ProgressBarDeltaGrowComponent = ({
    ...
    const h = reactExports.useMemo(
      ...
      x = reactExports.useMemo(
        () => ({ width: "0%", ...getBaseSideWithReverse(l, a), ...getAnimationStyles(e) }),
        [a, l, e],
      ),
      $ = reactExports.useMemo(
        () => ({
          width: `${Math.abs(n - a)}%`,
          ...getBaseSideWithReverse(l, a),
  ...
  WithAnimationLineComponent = ({ onComplete: e, onEndAnimation: t, ...s }) => {
    const [a, r] = reactExports.useState(!1),
  ...
  WithStackAnimationLineComponent = ({ onEndAnimation: e, ...t }) => {
    const s = reactExports.useRef({}),
      ...
      r = "number" == typeof s.current.from ? s.current.from : t.from;
    return (
      (s.current.from = r),
      reactExports.createElement(WithAnimationLine, {
        ...t,
        onEndAnimation: a,
        key: `${r}-${t.to}-${t?.additionalKey}`,
        from: r,
      })
    );
  },
  WithStackAnimationLine = reactExports.memo(WithStackAnimationLineComponent),
  WithoutAnimationLine = ({ size: e, value: t, lineRef: s, disabled: a, onComplete: r }) => {
  ...
  ProgressBarLineComponent = ({
    ...
    if (r === t)
      return jsxRuntimeExports.jsx(
        ...
        { size: e, value: t, lineRef: s, disabled: a, onComplete: l },
        `${r}-${t}-${n}`,
      );
    const c = {
      from: r,
    ...
    return o.withStack
      ...
      : jsxRuntimeExports.jsx(WithAnimationLine, { ...c }, `${r}-${t}-${n}`);
  },
...
function useCalculatePercents(e, t, s) {
  return reactExports.useMemo(() => {
    const a = (clamp(0, t, e) / t) * 100;
    return { value: a, deltaFrom: prepareDeltaFrom(a, t, s) };
  }, [s, t, e]);
}
const defaultTheme = Orange,
  ...
  ProgressBarComponent = ({
    ...
    size: s = Size.Default,
    animationSettings: a = defaultAnimationSettings,
    disabled: r = !1,
...
function SceneWrapper$1({
  ...
  function g(e) {
    return e.buttons === MOUSE_BUTTONS_LEFT$1 && f(e) && r;
  }
  return (
    reactExports.useEffect(() => {
      m(i && l);
    ...
    jsxRuntimeExports.jsx("div", {
      ...
      onWheel: function (e) {
        if ((e.preventDefault(), !r || !f(e))) return;
        const s = e.deltaY < 0;
...
const themes = { primary: "primary", custom: "custom" },
  ...
  base$s = "HorizontalTabs_69e3c6f3",
  ...
  Base$g = defineStyledComponent("Tabs", styles$t.base, {
    variants: {
      size: {
        [sizes$7.large]: styles$t["base__size-large"],
        [sizes$7.medium]: styles$t["base__size-medium"],
        [sizes$7.small]: styles$t["base__size-small"],
      },
      theme: { [themes.primary]: styles$t["base__theme-primary"], [themes.custom]: void 0 },
    },
  }),
  Switcher = reactExports.forwardRef(function ({ children: e, classNames: t, ...s }, a) {
    ...
    return jsxRuntimeExports.jsx(Base$g, {
      ...
      children: jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$t.outerBorderImage, t?.outerBorderImage),
          }),
          jsxRuntimeExports.jsxs("div", {
  ...
  Base$f = defineStyledComponent("Tab", styles$s.base, {
    variants: {
      size: {
        [sizes$7.large]: styles$s["base__size-large"],
        [sizes$7.medium]: styles$s["base__size-medium"],
        [sizes$7.small]: styles$s["base__size-small"],
      },
      theme: { [themes.primary]: styles$s["base__theme-primary"], [themes.custom]: void 0 },
  ...
  HeadlessTab = reactExports.forwardRef(function (
    { theme: e, size: t, tabId: s, active: a, children: r, onClick: n, onMouseEnter: o, ...i },
    u,
  ) {
    const l = useSounds();
    return jsxRuntimeExports.jsx(Base$f, {
      ...
      theme: e,
      size: t,
      state: a === s ? "active" : "inactive",
      onMouseEnter: function (e) {
        (a !== s && l.play("mouse-enter", { target: Base$f.displayName, original: e }), o?.(e));
      },
      onClick: function (e) {
        (a !== s && l.play("click", { target: Base$f.displayName, original: e }), n?.(e));
      },
      children: r,
    });
  });
function Tab$1({ tabId: e, classNames: t, className: s, children: a, ...r }) {
  ...
  return jsxRuntimeExports.jsxs(HeadlessTab, {
    ...
    children: [
      ...
      jsxRuntimeExports.jsx("div", {
        className: clsx(styles$s.backgroundPattern, t?.backgroundPattern),
      }),
      ...
      jsxRuntimeExports.jsx("div", { className: clsx(styles$s.content, t?.content), children: a }),
    ],
  });
}
function Tabs({ active: e, theme: t, size: s, children: a, onActiveChange: r }) {
  const [n, o] = reactExports.useState(e),
    i = reactExports.useRef(e),
    u = reactExports.useMemo(() => ({ active: n, theme: t, size: s, change: o }), [n, s, t]);
  return (
    reactExports.useLayoutEffect(() => {
      o(e);
    }, [e]),
    reactExports.useEffect(() => {
      i.current !== n && ((i.current = n), r?.(n));
    }, [n, r]),
    jsxRuntimeExports.jsx(TabsContext.Provider, { value: u, children: a })
  );
}
((Tabs.Switcher = Switcher), (Tabs.Tab = Tab$1), (Tabs.Content = Content));
...
function SliderProvider({
  ...
  const { value: i, percentage: u, maxValue: l, setValue: c } = useProgressBar$1(),
    ...
    h = useEvent((e) => {
      if (e.buttons === MOUSE_BUTTONS_LEFT) {
        const t = g(m(e.clientX));
        f(i, t, e, BASE_COMPONENT_NAME, !0);
      }
    });
  reactExports.useEffect(() => {
    if (d)
  ...
  const E = useEvent(function (t) {
      const s = g(i + e * Math.sign(t.deltaY));
      f(i, s, t);
    }),
    x = useEvent(function (e, t) {
      ((t = g(t)), f(i, t, e, "Controls", !0));
    }),
    $ = useEvent(function (e) {
      const t = g(m(e.clientX));
      f(i, t, e);
    ...
    y = reactExports.useMemo(
      () => ({
        ...
        changeValue: g,
        handleWheel: E,
        handleControlClick: x,
        handleSliderClick: $,
      }),
      [e, t, s, a, m, b, g, i, l, u, r, E, x, $],
    );
  return jsxRuntimeExports.jsx(Context$1.Provider, { value: y, children: n });
}
const base$q = "Controls_9c96becc",
  ...
  Base$e = defineStyledComponent("Controls", styles$r.base),
      ...
      : jsxRuntimeExports.jsxs(Base$e, {
          ...
          children: [
            ...
            jsxRuntimeExports.jsx(Image$1, {
              ...
              className: clsx(
                styles$r.button,
                styles$r.button__plus,
                r >= u && styles$r.button__disabled,
                e?.button,
                e?.plusButton,
              ),
              onClick: (e) => i(e, r + a),
  ...
  base$p = "InteractiveArea_8d75e351",
  styles$q = { base: base$p },
  InteractiveArea = reactExports.forwardRef(function (
    { className: e, onClick: t, onMouseDown: s, ...a },
    r,
  ) {
    const { disabled: n, handleDragStart: o, handleWheel: i, handleSliderClick: u } = useSlider();
    return n
      ? null
      : jsxRuntimeExports.jsx("div", {
          ...a,
          ref: r,
          className: clsx(styles$q.base, e),
          onClick: (e) => {
            (u(e), t?.(e));
          },
          onMouseDown: (e) => {
  ...
  base$o = "LimitationArea_2c45b7ff",
  base__disabled$3 = "LimitationArea_base__disabled_fc664e1d",
  wrapper = "LimitationArea_wrapper_d530fcbf",
  base__small$7 = "LimitationArea_base__small_87cf0441",
  pattern$1 = "LimitationArea_pattern_33f143bb",
  base__medium$6 = "LimitationArea_base__medium_87cf0441",
  fadeIn$g = "LimitationArea_fadeIn_87cf0441",
  fadeInThreeQuarters$g = "LimitationArea_fadeInThreeQuarters_87cf0441",
  fadeInHalf$g = "LimitationArea_fadeInHalf_87cf0441",
  fadeOut$g = "LimitationArea_fadeOut_87cf0441",
  fadeInWithScale$g = "LimitationArea_fadeInWithScale_87cf0441",
  slideUp$g = "LimitationArea_slideUp_87cf0441",
  scale$g = "LimitationArea_scale_87cf0441",
  raysAppearance$g = "LimitationArea_raysAppearance_87cf0441",
  rotate$g = "LimitationArea_rotate_87cf0441",
  glowAppearance$g = "LimitationArea_glowAppearance_87cf0441",
  highlightAppearance$g = "LimitationArea_highlightAppearance_87cf0441",
  blink$g = "LimitationArea_blink_87cf0441",
  slideUpIn$g = "LimitationArea_slideUpIn_87cf0441",
  styles$p = {
    base: base$o,
  ...
  LimitationArea = reactExports.forwardRef(function ({ className: e, classNames: t, ...s }, a) {
    const { limit: r, size: n, maxValue: o, disabled: i } = useSlider();
    if (r <= 0) return null;
    const u = r / o;
    return jsxRuntimeExports.jsx("div", {
      ...s,
      ref: a,
      className: clsx(styles$p.base, styles$p[`base__${n}`], i && styles$p.base__disabled, e),
      children: jsxRuntimeExports.jsx("div", {
        className: clsx(styles$p.wrapper, t?.wrapper),
        children: jsxRuntimeExports.jsx("div", {
          className: clsx(styles$p.pattern, t?.pattern),
          style: { width: u >= 1 ? "100%" : 100 * u + "%" },
        }),
      }),
    });
  }),
  base$n = "Thumb_94183346",
  base__small$6 = "Thumb_base__small_ecf8adad",
  thumb = "Thumb_caea3cfd",
  base__medium$5 = "Thumb_base__medium_830942bb",
  grip = "Thumb_grip_b0aabe58",
  base__full = "Thumb_base__full_830942bb",
  content = "Thumb_content_efe659d0",
  fadeIn$f = "Thumb_fadeIn_830942bb",
  fadeInThreeQuarters$f = "Thumb_fadeInThreeQuarters_830942bb",
  fadeInHalf$f = "Thumb_fadeInHalf_830942bb",
  fadeOut$f = "Thumb_fadeOut_830942bb",
  fadeInWithScale$f = "Thumb_fadeInWithScale_830942bb",
  slideUp$f = "Thumb_slideUp_830942bb",
  scale$f = "Thumb_scale_830942bb",
  raysAppearance$f = "Thumb_raysAppearance_830942bb",
  rotate$f = "Thumb_rotate_830942bb",
  glowAppearance$f = "Thumb_glowAppearance_830942bb",
  highlightAppearance$f = "Thumb_highlightAppearance_830942bb",
  blink$f = "Thumb_blink_830942bb",
  slideUpIn$f = "Thumb_slideUpIn_830942bb",
  styles$o = {
    base: base$n,
  ...
  Base$d = defineStyledComponent("Base", styles$o.base, {
    variants: {
      size: {
        small: styles$o.base__small,
        medium: styles$o.base__medium,
        full: styles$o.base__full,
      },
    },
  }),
  Thumb = reactExports.forwardRef(function (
    { className: e, classNames: t, buttonClassNames: s, onMouseDown: a, ...r },
    n,
  ) {
    ...
    return jsxRuntimeExports.jsx(Base$d, {
      ...
      children: jsxRuntimeExports.jsx(Button$1, {
        ...
        disabled: i,
        theme: "primary",
        className: clsx(styles$o.thumb, t?.thumb, styles$o[`thumb__${o}`], e),
        classNames: { ...s, content: clsx(styles$o.content, s?.content) },
        style: { left: 100 * u + "%" },
        onMouseDown: (e) => {
          (l(e), a?.(e));
        },
        onWheel: c,
        children: jsxRuntimeExports.jsx("div", { className: clsx(styles$o.grip, t?.grip) }),
      }),
    });
  }),
  hover = "Slider_hover_9553506b",
  base$m = "Slider_2f883184",
  base__disabled$2 = "Slider_base__disabled_913c9ec5",
  base__small$5 = "Slider_base__small_263edf46",
  base__medium$4 = "Slider_base__medium_263edf46",
  ...
  border$2 = "Slider_border_4aa39164",
  styles$n = {
    hover: hover,
    base: base$m,
  ...
  Base$c = defineStyledComponent(BASE_COMPONENT_NAME, styles$n.base, {
    variants: {
      size: {
  ...
  Slider = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(Base$c, {
      ...
      children: [
        !l && jsxRuntimeExports.jsx("div", { className: clsx(styles$n.hover, i?.hover) }),
        jsxRuntimeExports.jsx(ProgressBar$2, {
          value: e,
          size: t,
          maxValue: s,
          ...
          classNames: {
            ...i,
            backgroundPattern: clsx(styles$n.backgroundPattern, i?.backgroundPattern),
            border: clsx(styles$n.border, i?.border),
          },
          filledClassNames: {
...
const base$l = "Frame_8333acf3",
  base__small$4 = "Frame_base__small_4e740586",
  base__medium$3 = "Frame_base__medium_61f5e331",
  border$1 = "Frame_border_1889217e",
  border__top = "Frame_border__top_11cb1594",
  border__bottom = "Frame_border__bottom_41c75343",
  arrow = "Frame_arrow_1996d5b1",
  fadeIn$e = "Frame_fadeIn_aa0eb5bc",
  fadeInThreeQuarters$e = "Frame_fadeInThreeQuarters_aa0eb5bc",
  fadeInHalf$e = "Frame_fadeInHalf_aa0eb5bc",
  fadeOut$e = "Frame_fadeOut_aa0eb5bc",
  fadeInWithScale$e = "Frame_fadeInWithScale_aa0eb5bc",
  slideUp$e = "Frame_slideUp_aa0eb5bc",
  scale$e = "Frame_scale_aa0eb5bc",
  raysAppearance$e = "Frame_raysAppearance_aa0eb5bc",
  rotate$e = "Frame_rotate_aa0eb5bc",
  glowAppearance$e = "Frame_glowAppearance_aa0eb5bc",
  highlightAppearance$e = "Frame_highlightAppearance_aa0eb5bc",
  blink$e = "Frame_blink_aa0eb5bc",
  slideUpIn$e = "Frame_slideUpIn_aa0eb5bc",
  styles$m = {
    base: base$l,
    ...
    rotate: rotate$e,
    "reverse-rotate": "Frame_reverse-rotate_aa0eb5bc",
    glowAppearance: glowAppearance$e,
    highlightAppearance: highlightAppearance$e,
    blink: blink$e,
    slideUpIn: slideUpIn$e,
  },
  Frame = React.forwardRef(function (
    { classNames: e, arrowRef: t, size: s = "medium", className: a },
    r,
  ) {
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$m.base, styles$m[`base__${s}`], a),
      ref: r,
      children: [
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$m.border, styles$m.border__top, e?.border, e?.borderTop),
        }),
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$m.border, styles$m.border__bottom, e?.border, e?.borderBottom),
        }),
        jsxRuntimeExports.jsx("div", { className: cx(styles$m.arrow, e?.arrow), ref: t }),
      ],
    });
  }),
  base$k = "Tab_f023f60c",
  base__small$3 = "Tab_base__small_16f0b915",
  base__medium$2 = "Tab_base__medium_ee9dc247",
  base__active = "Tab_base__active_7fd68b73",
  highlight$1 = "Tab_highlight_dbeadf40",
  icon$3 = "Tab_icon_955f2594",
  icon__small$1 = "Tab_icon__small_814721a6",
  icon__medium = "Tab_icon__medium_217e7065",
  notification = "Tab_notification_d9b03d29",
  notification__symbol = "Tab_notification__symbol_46b30834",
  notification__small = "Tab_notification__small_c29a759e",
  notification__dot = "Tab_notification__dot_79016c7a",
  notification__medium = "Tab_notification__medium_0",
  notification__large = "Tab_notification__large_310049e4",
  fadeIn$d = "Tab_fadeIn_0",
  fadeInThreeQuarters$d = "Tab_fadeInThreeQuarters_0",
  fadeInHalf$d = "Tab_fadeInHalf_0",
  fadeOut$d = "Tab_fadeOut_0",
  fadeInWithScale$d = "Tab_fadeInWithScale_0",
  slideUp$d = "Tab_slideUp_0",
  scale$d = "Tab_scale_0",
  raysAppearance$d = "Tab_raysAppearance_0",
  rotate$d = "Tab_rotate_0",
  glowAppearance$d = "Tab_glowAppearance_0",
  highlightAppearance$d = "Tab_highlightAppearance_0",
  blink$d = "Tab_blink_0",
  slideUpIn$d = "Tab_slideUpIn_0",
  styles$l = {
    base: base$k,
    ...
    notification__symbol: notification__symbol,
    notification__small: notification__small,
    notification__dot: notification__dot,
    notification__medium: notification__medium,
    notification__large: notification__large,
    fadeIn: fadeIn$d,
    ...
    rotate: rotate$d,
    "reverse-rotate": "Tab_reverse-rotate_0",
    glowAppearance: glowAppearance$d,
    highlightAppearance: highlightAppearance$d,
    blink: blink$d,
    slideUpIn: slideUpIn$d,
  },
  defaultSounds = { mouseEnter: "highlight", click: "play" },
  Tab = React.forwardRef(function (
    {
      id: e,
      isActive: t,
      className: s,
      classNames: a,
      sounds: r = defaultSounds,
      notification: n,
      icon: o,
      size: i,
      additionContent: u,
    ...
    const m = (e, s) => {
      ...
      f = jsxRuntimeExports.jsxs("div", {
        className: cx(
          styles$l.base,
          styles$l[`base__${i}`],
          t && cx(styles$l.base__active, a?.activeTab),
          s,
        ),
        onClick:
          ((g = e),
        ...
        children: [
          ...
          "function" == typeof o && i
            ? o(i)
            : jsxRuntimeExports.jsx("div", {
                className: cx(styles$l.icon, styles$l[`icon__${i}`], a?.icon),
                style: { backgroundImage: `url(${o})` },
              }),
          u && u({ id: e, size: i, isActive: t }),
          n &&
            jsxRuntimeExports.jsx("div", {
              className: cx(
                styles$l.notification,
                styles$l[`notification__${n.type}`],
                n.size ? styles$l[`notification__${n.size}`] : styles$l.notification__medium,
                a?.notification,
              ),
              children: "dot" !== n.type && n.value,
            }),
        ],
      });
    var g;
  ...
  group = "Verticaltabs_group_b6009a68",
  group__small = "Verticaltabs_group__small_48d59e18",
  group__medium = "Verticaltabs_group__medium_667c5345",
  fadeIn$c = "Verticaltabs_fadeIn_86b616cf",
  fadeInThreeQuarters$c = "Verticaltabs_fadeInThreeQuarters_86b616cf",
  fadeInHalf$c = "Verticaltabs_fadeInHalf_86b616cf",
  fadeOut$c = "Verticaltabs_fadeOut_86b616cf",
  fadeInWithScale$c = "Verticaltabs_fadeInWithScale_86b616cf",
  slideUp$c = "Verticaltabs_slideUp_86b616cf",
  scale$c = "Verticaltabs_scale_86b616cf",
  raysAppearance$c = "Verticaltabs_raysAppearance_86b616cf",
  rotate$c = "Verticaltabs_rotate_86b616cf",
  glowAppearance$c = "Verticaltabs_glowAppearance_86b616cf",
  highlightAppearance$c = "Verticaltabs_highlightAppearance_86b616cf",
  blink$c = "Verticaltabs_blink_86b616cf",
  slideUpIn$c = "Verticaltabs_slideUpIn_86b616cf",
  styles$k = {
    base: base$j,
    title: title$1,
    group: group,
    group__small: group__small,
    group__medium: group__medium,
    fadeIn: fadeIn$c,
      ...
      [, b] = useSpring$1(() => ({
        ...
        onStart: () => {
          (f.start({ from: { marginLeft: 12 }, to: { marginLeft: 0 }, config: { duration: 50 } }),
            g.start({ from: { opacity: 1 }, to: { opacity: 0 }, config: { duration: 50 } }));
        },
        onRest: () => {
          (f.start({ from: { marginLeft: 0 }, to: { marginLeft: 12 }, config: { duration: 150 } }),
            g.start({ from: { opacity: 0 }, to: { opacity: 1 }, config: { duration: 150 } }));
        },
      })),
...
const base$i = "Badge_b4595e01",
  base__default$1 = "Badge_base__default_6aaca100",
  base__x48$1 = "Badge_base__x48_2b129eae",
  fadeIn$b = "Badge_fadeIn_8bc2e1a2",
  fadeInThreeQuarters$b = "Badge_fadeInThreeQuarters_8bc2e1a2",
  fadeInHalf$b = "Badge_fadeInHalf_8bc2e1a2",
  fadeOut$b = "Badge_fadeOut_8bc2e1a2",
  fadeInWithScale$b = "Badge_fadeInWithScale_8bc2e1a2",
  slideUp$b = "Badge_slideUp_8bc2e1a2",
  scale$b = "Badge_scale_8bc2e1a2",
  raysAppearance$b = "Badge_raysAppearance_8bc2e1a2",
  rotate$b = "Badge_rotate_8bc2e1a2",
  glowAppearance$b = "Badge_glowAppearance_8bc2e1a2",
  highlightAppearance$b = "Badge_highlightAppearance_8bc2e1a2",
  blink$b = "Badge_blink_8bc2e1a2",
  slideUpIn$b = "Badge_slideUpIn_8bc2e1a2",
  styles$j = {
    base: base$i,
    ...
    raysAppearance: raysAppearance$b,
    rotate: rotate$b,
    "reverse-rotate": "Badge_reverse-rotate_8bc2e1a2",
    glowAppearance: glowAppearance$b,
    highlightAppearance: highlightAppearance$b,
    blink: blink$b,
    slideUpIn: slideUpIn$b,
  ...
  Badge$1 = ({ badgeID: e, size: t = IconSize.default, className: s }) => {
    const a = R.images.gui.maps.icons.library.badges.$dyn(badgeFolders$1[t]);
    return jsxRuntimeExports.jsx("div", {
      className: cx(styles$j.base, styles$j[`base__${t}`], s),
  ...
  fadeIn$a = "Playernickname_fadeIn_4dc1c796",
  fadeInThreeQuarters$a = "Playernickname_fadeInThreeQuarters_4dc1c796",
  fadeInHalf$a = "Playernickname_fadeInHalf_4dc1c796",
  fadeOut$a = "Playernickname_fadeOut_4dc1c796",
  fadeInWithScale$a = "Playernickname_fadeInWithScale_4dc1c796",
  slideUp$a = "Playernickname_slideUp_4dc1c796",
  scale$a = "Playernickname_scale_4dc1c796",
  raysAppearance$a = "Playernickname_raysAppearance_4dc1c796",
  rotate$a = "Playernickname_rotate_4dc1c796",
  glowAppearance$a = "Playernickname_glowAppearance_4dc1c796",
  highlightAppearance$a = "Playernickname_highlightAppearance_4dc1c796",
  blink$a = "Playernickname_blink_4dc1c796",
  slideUpIn$a = "Playernickname_slideUpIn_4dc1c796",
  styles$i = {
    base: base$h,
    userName: userName,
    igrIcon: igrIcon,
    ...
    raysAppearance: raysAppearance$a,
    rotate: rotate$a,
    "reverse-rotate": "Playernickname_reverse-rotate_4dc1c796",
    glowAppearance: glowAppearance$a,
    highlightAppearance: highlightAppearance$a,
    blink: blink$a,
    slideUpIn: slideUpIn$a,
  ...
  UsernameAnonymizerComponent = ({ tooltipHeaderName: e }) => {
    ...
    return jsxRuntimeExports.jsx(SimpleTooltip, {
      header: t,
      body: s,
      children: jsxRuntimeExports.jsx("div", { className: styles$i.anonymizedIcon }),
    });
  },
  ...
  PlayerNickname = ({
    ...
    const _ = R.images.gui.maps.icons.library.badges.strips.$dyn(suffixBadgeStripeFolders[l]),
      ...
      f = reactExports.useMemo(
        () => ({ backgroundImage: `url(${m.$dyn(`badge_${r.badgeID}`)})` }),
        [r, m],
      ),
      g = t ? `[${t}]` : "",
      b = cx(styles$i.base, styles$i[`base__${l}`], n && styles$i.base__inverted),
      h = cx(styles$i.userName, c),
      E = cx(styles$i.clanTag, d),
      x = e !== u,
      $ = o ? `${u}${g}` : u,
      y =
        Boolean(a.badgeID) && reactExports.createElement(Badge$1, { size: l, ...a, key: "badge" }),
      A = Date.now(),
      v = [
        y,
        [
          jsxRuntimeExports.jsx(
            "div",
            { className: h, children: jsxRuntimeExports.jsx(TextOverflow, { content: e }, A) },
            "userName",
          ),
          !o &&
            Boolean(g) &&
            jsxRuntimeExports.jsx("div", { className: E, children: g }, "clanTag"),
        ],
        0 !== s && jsxRuntimeExports.jsx("div", { className: styles$i.igrIcon }, "igrType"),
        Boolean(r.badgeID) &&
          jsxRuntimeExports.jsxs(
            "div",
            {
        ...
        i && x && jsxRuntimeExports.jsx(UsernameAnonymizer, { tooltipHeaderName: $ }, "anonymizer"),
      ];
    return jsxRuntimeExports.jsx("div", { className: b, children: n ? v.reverse() : v });
  },
        ...
        return env.view.events.onDisplayChanged((t, s) => {
          ...
          a &&
            (s === env.view.displayStatus.hidden
              ? ((e = a.paused), a.pause())
              : e || s !== env.view.displayStatus.shown || a.play());
        });
      }),
      useMount(() => {
        let e = !1;
                ...
                if (d.current) {
                  ...
                  r.forEach((t, a) => {
                    void 0 !== r[a] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        const s = Object.keys(o ?? {})[a];
                        return e({ time: t, name: `${o ? s : `${DEFAULT_NAME_KEYFRAME}_${a}`}` });
                      });
                  });
                }
              });
...
const getCssStyle = (e, t) => window.getComputedStyle(e, null).getPropertyValue(t),
  makeCanvasFont = (e) =>
    `${getCssStyle(e, "font-weight")} ${getCssStyle(e, "font-size")} ${getCssStyle(e, "font-family")}`,
  getTextWidth = (e, t, s) => {
    const a = s.getContext("2d");
    if (!a) return 0;
    a.font = makeCanvasFont(t);
  ...
  calculateFitLength = (e) => {
    ...
    const t = Math.floor((e.start + e.end) / 2),
      ...
      a = Math.ceil(getTextWidth(s, e.element, e.canvas) / getElementWidth(e.element));
    return calculateFitLength(a <= 1 ? { ...e, start: t } : { ...e, end: t });
  },
  base$g = "Multilineoverflow_c23f658d",
  ...
  line = "Multilineoverflow_line_e6b06631",
  styles$h = {
    base: base$g,
  ...
  MultilineOverflow = reactExports.forwardRef(function (
    ...
    const u = reactExports.useRef(null),
      ...
      x = reactExports.useCallback(() => {
        if (E(u.current) <= t) return d(!1);
        d(!0);
        const s = splitWords(e, n) || [],
          a = Array.from(new Array(t)).reduce((e, a, r) => {
            if (!u.current) return e;
            const n = e.reduce((e, t) => e + t.length, 0),
              o = s.slice(n);
            if (r === t - 1) return (e.push(o), e);
            const i = calculateFitLength({
              start: 0,
              end: o.length,
              words: o,
              element: u.current,
    ...
    return (
      ...
      jsxRuntimeExports.jsxs("div", {
        ...o,
        ref: i,
        className: cx(styles$h.base, s, c && styles$h.base__truncated),
        children: [
          jsxRuntimeExports.jsx("div", {
            ref: u,
            className: styles$h.text,
            style: { maxHeight: `${m}rem` },
            children: e,
          }),
          jsxRuntimeExports.jsx("div", {
  ...
  MultilineOverflowWithTooltip = reactExports.forwardRef(function (e, t) {
    const [s, a] = reactExports.useState(!1);
    return jsxRuntimeExports.jsx(SimpleTooltip, {
      isEnabled: s,
      body: e.text,
      children: jsxRuntimeExports.jsx(MultilineOverflow, { ...e, ref: t, onChange: a }),
    });
  }),
  DynamicTooltipWrapper = ({ children: e, tooltipArgs: t, className: s }) => {
    if (!t) return e;
    const a = jsxRuntimeExports.jsx("div", { className: s, children: e });
...
const NORMALIZE_OVERLAYS_LIST = ["attachment"],
  ...
  getDogTypeImage = (e, t, s) => {
    ...
    if (a) {
      const r = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(a),
        n = r.$dyn(s);
      return n ? `${n}` : `${r.$dyn(DOG_TAG_DEFAULT_ICON_NAME[e])}`;
    }
    return (
      console.error(
        "Unreachable branch: add dogTagType and icon folder for corresponding icon matching",
  ...
  getRewardImage = (e, t = ImageSize.Small) => {
    ...
    switch (s) {
      ...
      case "premium":
      case "premium_plus":
        return `R.images.gui.maps.icons.quests.bonuses.${t}.${s}_${r}`;
      case "items":
  ...
  fadeIn$9 = "Reward_fadeIn_ab59d545",
  fadeInThreeQuarters$9 = "Reward_fadeInThreeQuarters_ab59d545",
  fadeInHalf$9 = "Reward_fadeInHalf_ab59d545",
  fadeOut$9 = "Reward_fadeOut_ab59d545",
  fadeInWithScale$9 = "Reward_fadeInWithScale_ab59d545",
  slideUp$9 = "Reward_slideUp_ab59d545",
  scale$9 = "Reward_scale_ab59d545",
  raysAppearance$9 = "Reward_raysAppearance_ab59d545",
  rotate$9 = "Reward_rotate_ab59d545",
  glowAppearance$9 = "Reward_glowAppearance_ab59d545",
  highlightAppearance$9 = "Reward_highlightAppearance_ab59d545",
  blink$9 = "Reward_blink_ab59d545",
  slideUpIn$9 = "Reward_slideUpIn_ab59d545",
  styles$g = {
    base: base$f,
    ...
    rotate: rotate$9,
    "reverse-rotate": "Reward_reverse-rotate_ab59d545",
            ...
            children: [
              jsxRuntimeExports.jsxs("div", {
                ...
                children: [
                  ...
                  t &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$g.icon, c?.rewardIcon),
                      style: { backgroundImage: `url(${t})` },
                    }),
                  m &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$g.overlay, c?.overlay),
                      style: {
              ...
              i &&
                jsxRuntimeExports.jsx("div", {
                  className: cx(styles$g.title, c?.title),
                  children: i,
                }),
            ],
          }),
  ...
  label$1 = "Iconbutton_label_bd93b7a9",
  ...
  fadeIn$8 = "Iconbutton_fadeIn_81e1e86b",
  fadeInThreeQuarters$8 = "Iconbutton_fadeInThreeQuarters_81e1e86b",
  fadeInHalf$8 = "Iconbutton_fadeInHalf_81e1e86b",
  fadeOut$8 = "Iconbutton_fadeOut_81e1e86b",
  fadeInWithScale$8 = "Iconbutton_fadeInWithScale_81e1e86b",
  slideUp$8 = "Iconbutton_slideUp_81e1e86b",
  scale$8 = "Iconbutton_scale_81e1e86b",
  raysAppearance$8 = "Iconbutton_raysAppearance_81e1e86b",
  rotate$8 = "Iconbutton_rotate_81e1e86b",
  glowAppearance$8 = "Iconbutton_glowAppearance_81e1e86b",
  highlightAppearance$8 = "Iconbutton_highlightAppearance_81e1e86b",
  blink$8 = "Iconbutton_blink_81e1e86b",
  slideUpIn$8 = "Iconbutton_slideUpIn_81e1e86b",
  styles$e = {
    base: base$d,
    ...
    rotate: rotate$8,
    "reverse-rotate": "Iconbutton_reverse-rotate_81e1e86b",
  ...
  IconButton = ({
    ...
    const [b, h] = reactExports.useState(!1),
      [E, x] = reactExports.useState(!1),
      $ = reactExports.useRef(null),
      y = () => !1 === r,
      A = (e) => y() && ((e) => e.button === MOUSE_BUTTON_CODES.LEFT)(e),
      v = makeOptionalCaller(y, (e) => {
        l?.(e);
      }),
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      className: cx(
        styles$e.base,
        r && styles$e.base__disabled,
        n && styles$e.base__visibleLabel,
        !r && b && styles$e.base__mouseDown,
        !r && E && styles$e.base__hovered,
        s,
      ),
      onClick: v,
      onMouseEnter: w,
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          className: cx(styles$e.icon, styles$e[`icon__${u}`], styles$e[`icon__${e}`], a?.icon),
        }),
        t &&
          jsxRuntimeExports.jsx("div", {
            className: cx(styles$e.label, styles$e[`label__${u}`], a?.label),
            children: t,
          }),
      ],
    });
  },
  base$c = "Scenewrapper_3300715",
  base__down = "Scenewrapper_base__down_c00dec83",
  base__moveSpaceDisabled = "Scenewrapper_base__moveSpaceDisabled_99b7a953",
  styles$d = {
    base: base$c,
  ...
  SceneWrapper = ({
    ...
    onMouseOver3dScene: s,
    onDragStateChange: a,
    isMoveSpaceEnabled: r = !0,
  }) => {
    const [n, o] = reactExports.useState(!1),
      [i, u] = reactExports.useState({ x: 0, y: 0 }),
      l = reactExports.createRef(),
      c = reactExports.useCallback(() => {
        (o(!1), a?.(!1));
      }, [a]);
    reactExports.useEffect(
    ...
    const d = reactExports.useCallback(
        (e) => {
          if (!l.current) return;
          const { width: t, height: s } = l.current.getBoundingClientRect();
        ...
        (e) => {
          (e.preventDefault(),
            e.button === LEFT_MOUSE_BUTTON &&
              d(e) &&
              r &&
              (o(!0), a?.(!0), u({ x: e.clientX, y: e.clientY })));
        },
        [d, r, a],
      ),
      p = reactExports.useCallback(
        (e) => {
          if ((e.preventDefault(), n)) {
            if (!d(e)) return;
            const s = e.clientX !== i.x ? e.clientX - i.x : 0,
              a = e.clientY !== i.y ? e.clientY - i.y : 0;
            (u({ x: e.clientX, y: e.clientY }), t({ dx: s, dy: a, dz: 0 }));
          }
        },
        [d, n, i.x, i.y, t],
      ),
      m = reactExports.useCallback(
        (e) => {
          if ((e.preventDefault(), !r || !d(e))) return;
          const s = e.deltaY < 0;
          t({ dx: 0, dy: 0, dz: s ? -DZ : DZ });
        },
        [d, r, t],
      ),
  ...
  sizes$5 = { small: "small", medium: "medium" },
  base$b = "Value_880359b5",
  base__small$1 = "Value_base__small_533886b2",
  base__text = "Value_base__text_3c091067",
  base__medium$1 = "Value_base__medium_c1f8595d",
  value$1 = "Value_29975a5b",
  value__small = "Value_value__small_f3df7ae5",
  value__medium = "Value_value__medium_62a482c",
  fadeIn$7 = "Value_fadeIn_75b9f355",
  fadeInThreeQuarters$7 = "Value_fadeInThreeQuarters_75b9f355",
  fadeInHalf$7 = "Value_fadeInHalf_75b9f355",
  fadeOut$7 = "Value_fadeOut_75b9f355",
  fadeInWithScale$7 = "Value_fadeInWithScale_75b9f355",
  slideUp$7 = "Value_slideUp_75b9f355",
  scale$7 = "Value_scale_75b9f355",
  raysAppearance$7 = "Value_raysAppearance_75b9f355",
  rotate$7 = "Value_rotate_75b9f355",
  glowAppearance$7 = "Value_glowAppearance_75b9f355",
  highlightAppearance$7 = "Value_highlightAppearance_75b9f355",
  blink$7 = "Value_blink_75b9f355",
  slideUpIn$7 = "Value_slideUpIn_75b9f355",
  styles$c = {
    base: base$b,
...
function Value({
  classNames: e,
  size: t = sizes$5.small,
  value: s,
  maxValue: a = DEFAULT_MAX_VALUE,
}) {
  return jsxRuntimeExports.jsx("div", {
    className: clsx(
      styles$c.base,
      styles$c[`base__${t}`],
      "string" == typeof s && styles$c.base__text,
      e?.valueContainer,
    ),
    children: jsxRuntimeExports.jsx("div", {
      className: clsx(styles$c.value, styles$c[`value__${t}`], e?.value),
      children: getValue(s, a),
    }),
  });
}
const base$a = "Bubble_df22310d",
  base__hidden$1 = "Bubble_base__hidden_1700314d",
  styles$b = { base: base$a, base__hidden: base__hidden$1 },
  Bubble = {
    Root: defineStyledComponent("Bubble", styles$b.base, {
...
const schema = object({ default: object({ plugin: pluginFunc() }) });
async function loadPlugin(e) {
  ...
  try {
    ...
    const s = makeId(e);
    if (loading.has(s)) return loading.get(s);
    if (plugins.has(s)) return plugins.get(s);
    const a = promiseWithResolvers();
    loading.set(s, a);
    __using(
      t,
      defer(() => loading.delete(s)),
    );
    const r = await import(e);
    if (!is(schema, r)) throw new Error(`Not is plugin ${e}`);
    const n = await r.default.plugin({ id: s, url: e });
    return (
      plugins.set(s, n),
      a.resolve(n),
      {
        ...
        init: n.init,
        destroy: async () => {
          (plugins.delete(s), await n.destroy());
        },
      }
    );
  } catch (r) {
...
const textOverlay = "GradientText_textOverlay_2d67fbb8",
  base$9 = "GradientText_5009d812",
  styles$a = { textOverlay: textOverlay, base: base$9 },
  GradientText = reactExports.forwardRef(function ({ classNames: e, children: t }, s) {
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        ...
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$a.textOverlay, e?.textOverlay),
          children: t,
        }),
      ],
    });
...
function TableProvider({
  ...
  const u = reactExports.useRef({ header: [], body: [], footer: [] }),
    ...
    m = reactExports.useCallback(
      (e, s, a, r) => {
        ...
        Array.isArray(u.current[e][a]) || (u.current[e][a] = new Array(t.length));
        const n = u.current[e][a];
        void 0 !== n && (n[r] = s);
      },
      [t.length],
    );
  (useUnmount$1(() => {
    ...
    reactExports.useLayoutEffect(
      () =>
        createLayoutReadyInEffect$1(function () {
  ...
  const f = useReactTable({
      ...
      getSortedRowModel: a ? getSortedRowModel() : void 0,
      getPaginationRowModel: r ? getPaginationRowModel() : void 0,
      initialState: o,
      state: { sorting: a, rowSelection: n, pagination: r },
      ...i,
    }),
    g = reactExports.useMemo(
      () => ({
...
const base$8 = "Table_85be883a",
  ...
  Base$b = defineStyledComponent("ContentResponsiveTableCell", styles$9.cell),
  ContentResponsiveCell = observer(function (e) {
    ...
    const { className: t, style: s, cell: a, ...r } = e,
      n = reactExports.useRef(null),
      o = a.column.getCanSort(),
      {
        cellRefs: i,
        columnSizes: u,
        handleCellRefsSet: l,
    ...
    return (
      reactExports.useLayoutEffect(() => {
        const e = i.current?.[a.tablePart][a.rowIndex]?.[a.index];
        if (null == e)
          return void console.warn(
            `Ref is not assigned for content responsive cell at tablePart ${a.tablePart}, row index ${a.rowIndex}, cell index ${a.index}`,
          );
        n.current = new ResizeObserver(function () {
          let e = 0;
          for (const t of tablePartValues)
            for (const s of i.current[t]) {
              const t = s[a.index]?.scrollWidth ?? 0;
              e = Math.max(e, t);
            }
          c(a.index, e);
        });
      ...
      }, [a.index, a.rowIndex, a.tablePart, c]),
      jsxRuntimeExports.jsx(
        Base$b,
        {
          className: clsx(
            a.column.columnDef.meta?.className,
            o && tableParts.header === a.tablePart && styles$9.sortable,
            t,
          ),
          style: {
            ...s,
          ...
          ...r,
          children: jsxRuntimeExports.jsx("div", {
            className: styles$9.contentResponsiveCellWrapper,
            ref: reactExports.useCallback(
              (e) => l(a.tablePart, e, a.rowIndex, a.index),
              [a.tablePart, a.rowIndex, a.index, l],
            ),
            children: e.children,
          }),
        },
  ...
  Base$a = defineStyledComponent("ScreenResponsiveTableCell", styles$9.cell);
function ScreenResponsiveCell(e) {
  ...
  return (
    ...
    jsxRuntimeExports.jsx(
      ...
      {
        ref: reactExports.useCallback(
          (e) => u(a.tablePart, e, a.rowIndex, a.index),
          [a.tablePart, a.rowIndex, a.index, u],
        ),
        className: clsx(
          a.column.columnDef.meta?.className,
          i && tableParts.header === a.tablePart && styles$9.sortable,
          t,
        ),
        style: {
          ...s,
...
const Base$9 = defineStyledComponent("StaticTableCell", styles$9.cell);
function StaticCell(e) {
  ...
  return (
    ...
    jsxRuntimeExports.jsx(Base$9, {
      ...
      style: { ...s, width: a.size, opacity: n ? 1 : 0 },
      ...r,
      children: e.children,
    })
  );
...
function Cell(e) {
  ...
  switch (t.column.behaviour) {
    case columnBehaviours.static:
      return jsxRuntimeExports.jsx(StaticCell, { ...a, cell: { ...s, size: t.column.size } });
...
const Base$8 = defineStyledComponent("Table", styles$9.base),
  Header = defineStyledComponent("TableHeader", styles$9.header),
  Body = defineStyledComponent("TableBody", styles$9.body),
  Footer = defineStyledComponent("TableFooter", styles$9.footer),
  Row = defineStyledComponent("TableRow", styles$9.row),
  ...
  AnonymizerIcon = reactExports.forwardRef(function (
    {
      ...
      height: a = sizesConfig$5[e].height,
      className: r,
      ...n
    },
    o,
...
const base$7 = "PlayerInfo_89eea88b",
  ...
  fadeIn$6 = "PlayerInfo_fadeIn_56d02918",
  fadeInThreeQuarters$6 = "PlayerInfo_fadeInThreeQuarters_56d02918",
  fadeInHalf$6 = "PlayerInfo_fadeInHalf_56d02918",
  fadeOut$6 = "PlayerInfo_fadeOut_56d02918",
  fadeInWithScale$6 = "PlayerInfo_fadeInWithScale_56d02918",
  slideUp$6 = "PlayerInfo_slideUp_56d02918",
  scale$6 = "PlayerInfo_scale_56d02918",
  raysAppearance$6 = "PlayerInfo_raysAppearance_56d02918",
  rotate$6 = "PlayerInfo_rotate_56d02918",
  glowAppearance$6 = "PlayerInfo_glowAppearance_56d02918",
  highlightAppearance$6 = "PlayerInfo_highlightAppearance_56d02918",
  blink$6 = "PlayerInfo_blink_56d02918",
  slideUpIn$6 = "PlayerInfo_slideUpIn_56d02918",
  styles$8 = {
    base: base$7,
    badge: badge,
    name: name,
  ...
  Badge = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Base$6, {
      ...
      width: a,
      height: r,
      className: clsx(styles$8.badge, n),
    });
  });
function ClanTag({ size: e, className: t, children: s, ...a }) {
  return jsxRuntimeExports.jsx("div", {
    ...a,
    className: clsx(styles$8.clanTag, e && styles$8[`clanTag__${e}`], t),
    children: s,
  });
}
Badge.sizes = sizes$3;
  ...
  IgrIcon = reactExports.forwardRef(function (
    {
      ...
      height: a = sizesConfig$3[e].height,
      className: r,
      ...n
    },
    o,
...
function Name({ size: e, className: t, children: s }) {
  return jsxRuntimeExports.jsx("div", {
    className: clsx(styles$8.name, e && styles$8[`name__${e}`], t),
    children: s,
  });
}
...
const sizes$1 = { default: "default", regular: "regular", medium: "medium", big: "big" },
  ...
  StripeBadgeIcon = reactExports.forwardRef(function (
    {
      ...
      badgeId: t,
      stripeExists: s,
      path: a = `library.badges.${badgeFolders[e]}.badge_${t}`,
      width: r = sizesConfig$2[e].width,
      height: n = sizesConfig$2[e].height,
  ...
  StripeIcon = reactExports.forwardRef(function (
    {
      ...
      badgeId: t,
      stripeExists: s,
      path: a = `library.badges.strips.${stripeFolders[e]}.strip_${t}`,
      width: r = sizesConfig$1[e].width,
      height: n = sizesConfig$1[e].height,
      className: o,
      ...i
    },
    u,
    ...
    return s
      ? jsxRuntimeExports.jsx(Base$3, {
          ...
          width: r,
          height: n,
          className: clsx(styles$8.stripeBadge, o),
        })
      : null;
  }),
  sizesConfig = { badge: sizesConfig$2, stripe: sizesConfig$1 },
  Base$2 = defineStyledComponent("PlayerInfoStripe", styles$8.stripe),
  Stripe = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(Base$2, {
      ...o,
      ref: i,
      className: clsx(c && styles$8[`stripe__${e}`], a),
      children: [
...
const Base$1 = defineStyledComponent("AccountInfo", styles$8.base),
  Wrapper = defineStyledComponent("AccountInfoWrapper", styles$8.base),
...
function getBaseAnimationConfig({
  ...
  return {
    ...
    to: { width: t },
    config: n ?? {
      duration: (s === animations.simple && a) || (!a && r) ? 0 : DURATION,
...
const base$6 = "BackgroundPattern_8df99ec8",
  ...
  return (
    ...
    jsxRuntimeExports.jsx("div", {
      ...
      children: jsxRuntimeExports.jsx(Image$1, {
        className: clsx(
          e,
          styles$7.backgroundPattern,
          0 === s.percentage
            ? styles$7.backgroundPattern__noProgress
            : styles$7[`backgroundPattern__${s.size}`],
        ),
        repeat: "repeat",
        position: "left top",
  ...
  return useEvent((r) => {
    if (r)
      switch (s.animationType) {
        ...
        case "grow":
          !(function (r) {
            if ("growing" === r) return a.play("progressSimple", { target: t });
            if ("shrinking" === r) {
              if (s.progressCompleted) return a.play("increaseDeltaMax", { target: t });
  ...
  const t = useProgressBar(),
    ...
    n = useEvent(() => {
      t.status !== statuses.doneInactive && t.progressCompleted
        ? a.play("increaseDeltaMax", { target: s })
        : a.play("progressSimple", { target: s });
    });
  return useEvent(({ step: e } = {}) => {
    if (!t.silent)
      return t.activeComponents.has("delta") ? r(e) : t.activeComponents.has("fill") ? n() : void 0;
  });
}
const delta = "Delta_eb295acb",
  ...
  Delta = reactExports.memo(
    reactExports.forwardRef(function (
      ...
      const l = reactExports.useRef(null),
        ...
        [$, y] = reactExports.useState(b ?? "done"),
        A = (c.value - e) / c.maxValue,
        v = useProgressBarSounds(A);
      ...
      return (
        reactExports.useEffect(() => {
          ...
          const a = 100 * Math.max(0, c.percentage - Math.max(0, A)),
            r = 100 * Math.abs(A);
          return (
            e.classList.toggle(styles$6.delta__increase, A > 0),
            "growing" === $
        ...
        jsxRuntimeExports.jsxs(animated.div, {
          ...i,
          ref: assignRefs([u, l]),
          className: clsx(r, styles$6.delta),
            ...
            jsxRuntimeExports.jsxs(animated.div, {
              ...
              children: [
                jsxRuntimeExports.jsx(animated.div, {
                  ...
                  className: clsx(a?.inside, styles$6.inside, A > 0 && styles$6.inside__increase),
                }),
                i.children,
              ],
            }),
  ...
  Done = reactExports.memo(function ({ animationConfig: e, classNames: t }) {
    const s = useProgressBar(),
      ...
      r = 100 * s.percentage,
      n = 100 * (s.previous?.percentage ?? 0),
      o = void 0 === s.previous ? r : n,
        ...
        children: [
          jsxRuntimeExports.jsx(AnimatedImage$1, {
            ...
            className: clsx(
              t?.done,
              styles$5.done,
              !s.progressCompleted && styles$5.done__hidden,
              s.progressCompleted && (i ? styles$5.done__doneStatic : styles$5.done__visible),
            ),
            repeat: "repeat",
            position: "left top",
          ...
          !i &&
            jsxRuntimeExports.jsx(AnimatedImage$1, {
              ...
              className: clsx(
                t?.doneComplete,
                styles$5.complete,
                s.progressCompleted && styles$5.complete__visible,
              ),
              repeat: "repeat",
              position: "left top",
              style: { width: l.width.to((e) => `${e}%`) },
  ...
  Filled = reactExports.memo(function ({ filledPattern: e, animationConfig: t, className: s }) {
    const a = useProgressBar(),
      ...
      n = useSkipFrame$1(),
      o = 100 * a.percentage,
      i = 100 * (a.previous?.percentage ?? 0),
      u = void 0 === a.previous ? o : i,
    ...
    return (
      ...
      }, [c, u, a.animationType, r, o, t, n]),
      jsxRuntimeExports.jsx(AnimatedImage, {
        path: e || `ui.progressbar.bg_pattern_base_filled_${a.size}`,
        className: clsx(
          s,
          styles$5.filled,
          a.status && styles$5[`filled__${a.status}`],
          a.progressCompleted && styles$5.filled__hidden,
        ),
        repeat: "repeat",
        position: "left top",
        style: { width: l.width.to((e) => `${e}%`) },
          ...
          r.children ??
            jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                ...
                jsxRuntimeExports.jsx(Done, { classNames: t, animationConfig: a }),
              ],
            }),
          jsxRuntimeExports.jsx(animated.div, {
            className: clsx(
              t?.edge,
              styles$5.edge,
              0 === n.percentage && styles$5.edge__noProgress,
...
function Step({ position: e, value: t, children: s, className: a, classNames: r }) {
  const n = useProgressBar();
  return jsxRuntimeExports.jsxs("div", {
    className: clsx(styles$4.step, styles$4[`step__${e}`], a),
    style: { left: (t / n.maxValue) * 100 + "%" },
    children: [
      e === positions.below &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$4.indicator, r?.indicator) }),
      void 0 !== s &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$4.label, r?.label), children: s }),
      e === positions.above &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$4.indicator, r?.indicator) }),
    ],
  });
}
const Indicators = defineStyledComponent("Indicators", styles$4.base),
    ...
    return (
      ...
      jsxRuntimeExports.jsx(Indicators, {
        children: mapRange(e.count, (s) => {
          const a = (s / (e.count - 1)) * 100,
            r = t.value >= a && 0 !== t.value;
          return jsxRuntimeExports.jsx(
            Step,
            {
              position: e.position,
              value: a,
              className: clsx(e.classNames?.step, r && e.classNames?.completed),
              classNames: e.classNames?.stepClassNames,
              children: e.children ? e.children(s, a, r) : void 0,
            },
            s,
          );
        }),
...
const base$3 = "PreviewDelta_86b01c3e",
  ...
  PreviewDelta = reactExports.forwardRef(function ({ value: e, classNames: t, ...s }, a) {
    const r = useProgressBar();
    useRegisterComponent("previewDelta");
    const n = e - r.value,
      o = n < 0 ? "negative" : n > 0 ? "positive" : "neutral";
    if ("neutral" === o) return null;
    const i = Math.abs(n) / r.maxValue,
      u = n < 0 ? i : 0,
      l = 100 * (r.percentage - u),
      c = 100 * i;
    return jsxRuntimeExports.jsxs("div", {
      ...s,
      "data-name": "PreviewDelta",
      ref: a,
      className: clsx(styles$3.base, s.className),
      children: [
        jsxRuntimeExports.jsx("div", {
          ...
          className: clsx(
            t?.negative,
            styles$3.negative,
            "negative" === o && styles$3.negative__visible,
          ),
        }),
        jsxRuntimeExports.jsx("div", {
          style: { left: `${l}%`, width: `${c}%`, ...s.style },
          className: clsx(
            t?.positive,
            styles$3.positive,
            "positive" === o && styles$3.positive__visible,
          ),
        }),
      ],
    });
...
function ProgressBarProvider(e) {
  ...
  return jsxRuntimeExports.jsx(Context.Provider, { value: m, children: e.children });
}
const background = "ProgressBar_background_b4143753",
  base$2 = "ProgressBar_27c2305c",
  ...
  Base = defineStyledComponent("ProgressBar", styles$2.base, {
    variants: { size: { medium: styles$2.base__medium, large: styles$2.base__large } },
  }),
  ProgressBar = function ({
    ...
    return jsxRuntimeExports.jsx(ProgressBarProvider, {
      ...
      children: jsxRuntimeExports.jsxs(Base, {
        ...
        className: clsx(
          a,
          n.value === n.maxValue && s !== statuses.doneInactive && styles$2.base__done,
        ),
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$2.border, styles$2[`border__${e}`], r?.border),
          }),
...
const CanvasSequence = reactExports.memo(function ({
  ...
  fadeIn$1 = "Counter_fadeIn_f40ddf91",
  fadeInThreeQuarters$1 = "Counter_fadeInThreeQuarters_f40ddf91",
  fadeInHalf$1 = "Counter_fadeInHalf_f40ddf91",
  fadeOut$1 = "Counter_fadeOut_f40ddf91",
  fadeInWithScale$1 = "Counter_fadeInWithScale_f40ddf91",
  slideUp$1 = "Counter_slideUp_f40ddf91",
  scale$1 = "Counter_scale_f40ddf91",
  raysAppearance$1 = "Counter_raysAppearance_f40ddf91",
  rotate$1 = "Counter_rotate_f40ddf91",
  glowAppearance$1 = "Counter_glowAppearance_f40ddf91",
  highlightAppearance$1 = "Counter_highlightAppearance_f40ddf91",
  blink$1 = "Counter_blink_f40ddf91",
  slideUpIn$1 = "Counter_slideUpIn_f40ddf91",
  styles$1 = {
    base: base$1,
    show: show,
    base__big: base__big,
    ...
    rotate: rotate$1,
    "reverse-rotate": "Counter_reverse-rotate_f40ddf91",
  ...
  Counter = ({
    ...
    const c = u && !l && u > o,
      d = cx(
        styles$1.base,
        styles$1[`base__${a}`],
        r && styles$1.base__animated,
        n && styles$1.base__hidden,
        !u && styles$1.base__pattern,
        t && styles$1.base__empty,
        s,
      );
    return jsxRuntimeExports.jsxs("div", {
      className: d,
      ...i,
      children: [
        jsxRuntimeExports.jsx("div", { className: styles$1.bg }),
        jsxRuntimeExports.jsx("div", { className: styles$1.pattern }),
        jsxRuntimeExports.jsxs("div", {
          className: cx(styles$1.value, l && styles$1.value__text),
          children: [
            c ? o : u,
            c && jsxRuntimeExports.jsx("span", { className: styles$1.plus, children: "+" }),
          ],
        }),
      ],
    });
  ...
  fadeIn = "Textbutton_fadeIn_599b35e4",
  fadeInThreeQuarters = "Textbutton_fadeInThreeQuarters_599b35e4",
  fadeInHalf = "Textbutton_fadeInHalf_599b35e4",
  fadeOut = "Textbutton_fadeOut_599b35e4",
  fadeInWithScale = "Textbutton_fadeInWithScale_599b35e4",
  slideUp = "Textbutton_slideUp_599b35e4",
  scale = "Textbutton_scale_599b35e4",
  raysAppearance = "Textbutton_raysAppearance_599b35e4",
  rotate = "Textbutton_rotate_599b35e4",
  glowAppearance = "Textbutton_glowAppearance_599b35e4",
  highlightAppearance = "Textbutton_highlightAppearance_599b35e4",
  blink = "Textbutton_blink_599b35e4",
  slideUpIn = "Textbutton_slideUpIn_599b35e4",
  styles = {
    base: base,
    ...
    rotate: rotate,
    "reverse-rotate": "Textbutton_reverse-rotate_599b35e4",
  ...
  TextButton = ({
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        ...
        jsxRuntimeExports.jsx("div", {
          className: cx(styles.icon, styles[`icon__${l}`], styles[`icon__${u}`], a?.icon),
          children: jsxRuntimeExports.jsx("div", { className: cx(styles.glow, a?.glow) }),
        }),
        jsxRuntimeExports.jsx("div", {
          className: cx(styles.caption, styles[`caption__${l}`], a?.caption),
          children: e,
        }),
        s && jsxRuntimeExports.jsx("div", { className: cx(styles.goto, a?.goto), children: s }),
      ],
    });
  };
export {
  ...
  compare as eD,
  greaterThanOrEqual as eE,
  days as eF,
  CountdownStyle as eG,
  Counter as eH,
  TextButton as eI,
  fromMs as eJ,
  TableProvider as ea,
  ...
  ONE_MINUTE$1 as el,
  roundTo as em,
  getRewardImage as en,
  getRegionalDateTime$1 as eo,
  arabicToRoman as ep,
  ProgressBar$1 as eq,
  BlueNoise as er,
  Tooltip as es,
  Rewards$1 as et,
  createGridImgSourceGetter as eu,
  CanvasSequence as ev,
  addChunkIndexToEndPath as ew,
  KEY_CODES as ex,
  env as ey,
  lastElement as ez,
