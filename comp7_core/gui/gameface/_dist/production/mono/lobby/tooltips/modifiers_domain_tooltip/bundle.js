import { n as __exportAll, r as __toESM } from "../../chunks/rolldown-runtime.js";
import {
  S as require_react,
  _ as convertNbsp,
  a as computedFn,
  ...
  m as map,
  n as UIProvider,
  o as initializeModelWithContext,
  p as get,
  r as Tooltip,
  t as Image,
  v as format$1,
...
import { t as observer } from "../../chunks/vendor.js";
var import_react = __toESM(require_react()),
  decorator = "TooltipDecorator_decorator_81525906",
  decoratorInner = "TooltipDecorator_decoratorInner_ed88e863",
  tooltip_decorator_module_default = { decorator: decorator, decoratorInner: decoratorInner },
  import_jsx_runtime = require_jsx_runtime();
function TooltipDecorator({ children: u, classNames: e }) {
  return (0, import_jsx_runtime.jsx)(Tooltip, {
    children: (0, import_jsx_runtime.jsx)("div", {
      className: clsx(tooltip_decorator_module_default.decorator, e?.decoratorInner),
      children: (0, import_jsx_runtime.jsx)("div", {
        className: clsx(tooltip_decorator_module_default.decoratorInner, e?.decoratorInner),
        children: u,
      }),
    }),
  });
}
var [ModifiersTooltipModelProvider, useModifiersTooltipModel] = initializeModelWithContext()(
    ({ observableModel: u }) => {
      const e = {
  ...
  ModUseType = (function (u) {
    return ((u.UNDEFINED = "undefined"), (u.VAL = "val"), (u.MUL = "mul"), (u.ADD = "add"), u);
  })({}),
  Conditions = class {
    static useType = {
      oneOf:
      ...
      (e, t) => (
        (e[t] = (function (e) {
          return (t) => {
            ...
            let o = !0;
            const r = `mouse${e}`,
              n = internalMouse[e]((u) => t([u, "outside"]));
            function a(u) {
              t([u, "inside"]);
            }
            return (
              ...
              i(),
              () => {
                o && (n(), window.removeEventListener(r, a), (u.listeners -= 1), i(), (o = !1));
              }
            );
          };
        })(t)),
...
function getSize$1(u = "px") {
  return "rem" === u ? viewEnv.getClientSizeRem() : viewEnv.getClientSizePx();
}
function getMouseGlobalPosition(u = "px") {
...
var SystemLocale = {
  ...
  sendShowPopOverEvent = (u, e, t, i, o = R.invalid("resId"), r) => {
    const n = env.view.getViewGlobalPosition(),
      { x: a, y: s, width: E, height: A } = t.getBoundingClientRect(),
      F = {
        x: env.view.pxToRem(a) + n.x,
        y: env.view.pxToRem(s) + n.y,
...
var DAYS_IN_WEEK = 7,
  ...
  ToStringFormatters = class {
    ...
    static time = (u, e, t) =>
      convertNbsp(
        `${u >= 0 ? t : "-"}${getRoundedTimeUnitDescription(getTimeUnits(Math.abs(u)), !1)}`,
      );
  },
  formatterConfig = {
    generalOverrides: [
      ...
      {
        condition: all(
          Conditions.useType.oneOf(ModUseType.MUL),
          Conditions.value.isPositiveInteger,
        ),
  ...
  Formatter = class {
    ...
    formatModifier = (u) => {
      ...
      let t = e.defaultFormatter,
        ...
        r = formatterConfig.defaultPrefixForPositiveValue;
      for (const n of [formatterConfig.generalOverrides, e.overrides])
        for (const e of n)
          e.condition(u) &&
            ((t = e.formatter || t),
            (i = e.valueConverter || i),
            (o = e.numberOfDecimals ?? o),
            (r = e.prefixForPositiveValue ?? r));
      return t(i(u.value), o, r);
    };
  },
  base$2 = "Parameter_daf80af7",
  ...
  renderRestriction = (u, e) => {
    ...
    return null === t
      ...
      : (0, import_jsx_runtime.jsx)("div", {
          className: parameter_module_default.restrictBlock,
          children: t,
        });
  };
function Parameter({ value: u }) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    className: parameter_module_default.base,
    children: [
      (0, import_jsx_runtime.jsx)("div", {
        className: clsx(
          parameter_module_default.value,
          parameter_module_default[`value__${u.gameplayImpact}`],
        ),
        children: e.formatModifier(u),
      }),
      (0, import_jsx_runtime.jsxs)("div", {
        className: parameter_module_default.name,
        children: [
          (0, import_jsx_runtime.jsx)("div", { children: getModifiersName(u.resName) }),
...
var base$1 = "ParamsList_2c6a5cbd",
  title$1 = "ParamsList_title_33a7e322",
  list = "ParamsList_list_7553c85f",
  params_list_module_default = { base: base$1, title: title$1, list: list };
function ParamsList({ modelGetter: u, title: e, itemsCount: t }) {
  return u
    ? (0, import_jsx_runtime.jsxs)("div", {
        className: params_list_module_default.base,
        children: [
          (0, import_jsx_runtime.jsx)("div", {
            className: params_list_module_default.title,
            children: e,
          }),
          (0, import_jsx_runtime.jsx)("div", {
            className: params_list_module_default.list,
            children: Array.from({ length: t }, (e, t) =>
              (0, import_jsx_runtime.jsx)(Parameter, { value: u(t) }, t),
            ),
          }),
        ],
      })
  ...
  app_default = observer(function () {
    ...
    return (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            (0, import_jsx_runtime.jsx)(Image, {
              ...
              className: app_module_default.icon,
            }),
            (0, import_jsx_runtime.jsxs)("div", {
              className: app_module_default.headerText,
              children: [
                (0, import_jsx_runtime.jsx)("div", {
                ...
                (0, import_jsx_runtime.jsx)("div", {
                  className: app_module_default.description,
        ...
        (0, import_jsx_runtime.jsx)("div", { className: app_module_default.separator }),
        (0, import_jsx_runtime.jsx)(ParamsList, {
...
runView(
  (0, import_jsx_runtime.jsx)(ModifiersTooltipModelProvider, {
    children: (0, import_jsx_runtime.jsx)(UIProvider, {
      children: (0, import_jsx_runtime.jsx)(TooltipDecorator, {
