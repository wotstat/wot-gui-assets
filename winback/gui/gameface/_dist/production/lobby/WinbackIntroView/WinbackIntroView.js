(() => {
      ...
      8886: (u, e, t) => {
        ...
        const M = {
          ...
          T = (u) => {
            ...
            const n = x(),
              ...
              A = n.mediaHeight,
              i = n.mediaSize;
            return a().createElement("div", w({ className: d()(t, M[E], L[A], S[i]) }, r), e);
          },
          O = ["children"],
          y = (u) => {
            let e = u.children,
        ...
        const J = {
          ...
          tu = q((u) => {
            ...
            return a().createElement("div", Q({ className: d()(Y.base, ...U, e), style: G }, I), N);
          });
        let ru;
        !(function (u) {
        ...
        const au = (u, e, t) => {
          ...
          Fu = ({ binding: u, text: e = "", classMix: t, alignment: n = ru.left }) =>
            null === e
        ...
        const Bu = Object.keys(su()),
          ...
          gu = q((u) => {
            ...
            return a().createElement(
              ...
              _u(
                {
                  className: d()(Du.base, t && Du[t], p, n),
                  style: g,
        ...
        class xu extends a().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              l = d()(pu.base, pu[`base__${E}`], pu[`base__${n}`], null == A ? void 0 : A.base),
              _ = d()(pu.icon, pu[`icon__${E}`], pu[`icon__${n}`], null == A ? void 0 : A.icon),
              B = d()(pu.glow, null == A ? void 0 : A.glow),
              c = d()(pu.caption, pu[`caption__${E}`], null == A ? void 0 : A.caption),
                ...
                const F = (0, r.useRef)([]),
                  o = (u, t, r) => {
                    ...
                    const n = (function ({
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const a = e,
                                n = Object.entries(a),
                                E = n.reduce(
                                  (u, [e, t]) => ((u[t] = Tu.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      D = { mode: u, model: s, externalModel: A, cleanup: o };
                    return {
                      model: s,
                  ...
                  l = D[0],
                  _ = D[1],
                  B = (0, r.useState)(() => o(u, n, i)),
                  c = B[0],
                  C = B[1];
                return (
                  (0, r.useEffect)(() => {
                    s.current ? C(o(l, n, i)) : (s.current = !0);
                  }, [i, l, n]),
                  (0, r.useEffect)(() => {
                    _(u);
                  }, [u]),
        ...
        const Nu = (u) => {
            const e = (0, r.useState)(ku.Pending),
              t = e[0],
              a = e[1];
            return (
              (0, r.useEffect)(() => {
                const e = { errors: 0, loaded: 0 },
                  t = () => {
                    e.errors + e.loaded === u.length
                      ? a(e.errors ? ku.Failure : ku.Success)
                      : a(ku.Pending);
                  };
                return ((r) => {
                  let a,
          ...
          Iu = ["first", "second", "third"],
          Wu = R.strings.winback.winbackIntro,
          Gu = [R.images.winback.gui.maps.icons.intro.bg()],
          Uu = (0, Lu.observer)(() => {
            const u = Pu().controls,
              e = Nu(Gu) !== ku.Pending;
            return (
              Mu(fu.n.ESCAPE, u.close),
              a().createElement(
                "div",
                { className: d()("App_base_e3", !e && "App_base__hidden_7c") },
                e &&
                  a().createElement(
                    a().Fragment,
                    null,
                    a().createElement(
                      "div",
                      { className: "App_closeButton_1e" },
                      a().createElement(xu, {
                        side: "right",
                        type: "close",
                        caption: Wu.buttonClose(),
                        onClick: u.close,
                      }),
                    ),
                    a().createElement(
                      "div",
                      { className: "App_header_8a" },
                      a().createElement(gu, { className: "App_title_53", text: Wu.title() }),
                      a().createElement(gu, { className: "App_subtitle_c0", text: Wu.subtitle() }),
                    ),
                    a().createElement(
                      "div",
                      { className: "App_container_04" },
                      a().createElement(
                        "div",
                        { className: "App_cardsContainer_9e" },
                        Iu.map((u, e) =>
                          a().createElement(
                            "div",
                            { className: "App_card_5c", key: u },
                            2 !== e && a().createElement("div", { className: "App_arrow_5b" }),
                            a().createElement("div", {
                              className: "App_cardImage_99",
                              style: {
                                backgroundImage: `url(R.images.winback.gui.maps.icons.intro.cards.${u})`,
                              },
                            }),
                            a().createElement(gu, {
                              className: "App_cardTitle_85",
                              text: Wu.cardTitle.$dyn(u),
                            }),
                            a().createElement(gu, {
                              className: "App_cardDescription_f3",
                              text: Wu.cardDescription.$dyn(u),
                            }),
                          ),
                        ),
                      ),
                      a().createElement(
                        U,
                        {
                          mixClass: "App_continueButton_65",
                          onClick: u.close,
                          type: I.primary,
                          size: W.medium,
                        },
        ...
        engine.whenReady.then(() => {
          P().render(
            a().createElement(Hu, null, a().createElement(y, null, a().createElement(Uu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8886));
