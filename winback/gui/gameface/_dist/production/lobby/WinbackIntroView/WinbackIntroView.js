(() => {
        ...
        const Bu = Object.keys(Du()),
          ...
          gu = V((u) => {
            ...
            return a().createElement(
              ...
              _u(
                {
                  className: d()(su.base, t && su[t], p, n),
                  style: g,
          ...
          yu = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: n, children: A, mocks: i }) {
                      ...
                      D = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            const r = i(t);
                            if (Array.isArray(e)) {
                              const a = e.reduce((u, e) => ((u[e] = Tu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  A.subscribe(
                                    (0, Tu.aD)((u) => {
                            ...
                            }
                            {
                              const a = e,
                                n = Object.entries(a),
                                E = n.reduce((u, [e, t]) => ((u[t] = Tu.LO.box(r[e], {})), u), {});
                              return (
                                "real" === u &&
                                  A.subscribe(
                                    (0, Tu.aD)((u) => {
                ...
                return (
                  (0, r.useEffect)(() => {
                    D.current ? C(o(l, n, i)) : (D.current = !0);
                  }, [i, l, n]),
                  (0, r.useEffect)(() => {
                    _(u);
                  }, [u]),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(886));
