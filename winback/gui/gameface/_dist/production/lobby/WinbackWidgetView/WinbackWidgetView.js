        ...
        const D = n.O.client.getSize("rem"),
          ...
          C = (u) => {
            ...
            const E = (0, r.useContext)(B),
              ...
              b = { extraLarge: m, large: d, medium: h, small: g, extraSmall: v };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && o) return a(e, t, b);
              if (t.largeWidth && l) return a(e, t, b);
              if (t.mediumWidth && s) return a(e, t, b);
            ...
            const v = (0, r.useRef)({
              ...
              p = (0, r.useCallback)(() => {
                (v.current.isVisible && v.current.timeoutId) ||
                  (W(t, B, { isMouseEvent: !0, on: !0, arguments: N(E) }, b),
                  d && d(),
                        ...
                        onMouseEnter:
                          ...
                          (u) => {
                            (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                              ((v.current.timeoutId = window.setTimeout(p, D ? 100 : 400)),
                              a && a(u),
                              f && f(u));
                          }),
                        onMouseLeave: ((u) => (e) => {
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : i(e),
                              E = X.observable.box(r, { equals: j });
                            return (
                              "real" === u &&
                                A.subscribe(
                                  (0, X.action)((u) => E.set(u)),
                                  e,
                                ),
                              E
                            );
        ...
        const nu = {
          ...
          Fu = tu((u) => {
            let e = u.className,
              ...
              L =
                void 0 === f
                  ? (h ? "flex-start" : g && "center") || (v && "flex-end") || void 0
                  : f,
              S = u.alignSelf,
              M = u.wrap,
              T = u.flexWrap,
            ...
            return E().createElement(
              "div",
              au({ className: d()(ru.base, ...U, e), style: G }, N),
              I,
            );
          });
        let Du;
