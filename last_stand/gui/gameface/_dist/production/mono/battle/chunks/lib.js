...
class ImagesRClassProvider {
  ...
  readOr(e, u, t = "silent") {
    ...
    return void 0 === s
      ? ("silent" !== t && logBySeverity$1(`Resource not found: ${n}`, t), u())
      : s;
  }
...
function readFromR$1(e, u, t) {
  const n = e.split("."),
    s = n[n.length - 1];
  if (!s) return;
  const r = n.slice(0, -1).reduce((e, u) => {
    if ("object" == typeof e?.[u]) return e[u];
  }, t);
  return r && "function" == typeof r[s] ? (u ? r[s](u) : r[s]()) : void 0;
}
class StringsRClassProvider {
  ...
  pluralOr(e, u, t, n = "silent") {
    const s = e.startsWith("R.strings") ? e : concatWithPath(this.prefix, e),
      r = readFromR$1(s, u, e.startsWith("R.strings") ? window : this.root);
    return void 0 === r
      ? ("silent" !== n && logBySeverity$1(`Resource not found: ${s}`, n), t())
      : r;
  }
...
class VideosRClassProvider {
  ...
  readOr(e, u, t = "silent") {
    ...
    return void 0 === s
      ? ("silent" !== t && logBySeverity$1(`Resource not found: ${e}`, t), u())
      : s;
  }
  readOrEmpty(e, u = "warn") {
    return this.readOr(e, () => "", u);
...
const sounds$1 = { highlight: "highlight", click: "play", yes1: "yes1" },
  plays$1 = Object.keys(sounds$1).reduce(
    (e, u) => ((e[u] = () => playSound$1(sounds$1[u])), e),
    {},
  ),
    ...
    contextMenu: {
      open(e, u, t = 0, n) {
        (sendViewEvent$1(viewEventTypes$1.contextMenu, {
          ...
          openedContextMenus.set(`${e}-${u}`, { targetID: e, contentID: u }));
      },
      hide(e, u, t = 0) {
        (sendViewEvent$1(viewEventTypes$1.contextMenu, {
          contentID: u,
...
function pipe(e, u, t, n, s, r, o, a, i) {
  switch (arguments.length) {
    ...
    case 6:
      return r(s(n(t(u(e)))));
    case 7:
      return o(r(s(n(t(u(e))))));
    case 8:
      return a(o(r(s(n(t(u(e)))))));
    case 9:
      return i(a(o(r(s(n(t(u(e))))))));
    default: {
      let e = arguments[0];
...
function create(
  ...
  return {
    subscribe: (t, s) => {
      const o = addModelObserver$1("string" == typeof s ? `${n}.${s}` : n, u, !0);
      return (r.set(o, t), e && t(l(s), []), o);
    },
    readByPath: l,
    readSafeByPath: (e) => {
      const u = i();
    ...
    dispose: function () {
      if (0 === u || ids().includes(u)) for (const e of r.keys()) d(e);
      a.then((e) => e());
    },
    unsubscribe: d,
    events: o,
...
function relativeOffset(e, u) {
  return { x: u.x - e.x, y: u.y - e.y };
}
function noop() {}
function identity(e) {
  return e;
...
function addEventListener(e, u, t, n) {
  return (e.addEventListener(u, t, n), () => e.removeEventListener(u, t, n));
}
...
("symbol" != typeof Symbol.dispose &&
  ...
  (function () {
    if (!self.fetch) {
      ((o.prototype.append = function (e, u) {
        ((e = s(e)), (u = r(u)));
        var t = this.map[e];
      ...
      (d.call(c.prototype),
        ...
        (self.fetch = function (u, t) {
          var s;
          return (
            (s = c.prototype.isPrototypeOf(u) && !t ? u : new c(u, t)),
    ...
    function p(e, u) {
      (u || (u = {}),
        ...
        (this.headers = u.headers instanceof o ? u.headers : new o(u.headers)),
        (this.url = u.url || ""));
    }
  })());
...
function mapRange(e, u, t) {
  return "function" == typeof u
    ? _mapRange(0, e, u)
    : (assert(void 0 !== t, "fn must be defined"), _mapRange(e, u, t));
}
function _mapRange(e, u, t) {
  const n = new Array(u - e);
  for (let s = e; s < u; s++) n[s] = t(s);
  return n;
}
(new Set(Object.values(keyStringCodes)),
  (assert.log = function (e, u) {
    e || console.error(u || "Assertion failed");
  }));
...
function calculateMedia(e, u, t) {
  const n = BREAKPOINTS.reduce(
    ...
    a = breakpointsByType[o],
    i = n.width.names,
    l = n.height.names,
    d = i[i.length - 1] ?? breakpoints.extraSmall,
    c = l[l.length - 1] ?? breakpoints.extraSmall,
    E = { width: breakpointsByType[d].width, height: breakpointsByType[c].height };
  return {
...
function MediaWrapperElement({ children: e, className: u, ...t }) {
  ...
  return jsxRuntimeExports.jsx("div", {
    className: clsx(u, "media-wrapper", n, s && "media-upscale"),
    ...t,
    children: e,
  });
}
...
function useHandleKey(e, u, t, n = !1) {
  const s = normalizeKeyCode(e),
    r = useEvent((e) => {
      isEventHandled$1() || (t(e), setEventHandled$1(), n && e.stopPropagation());
    }),
    o = useApi(),
    a = reactExports.useMemo(() => o[u].register(s, r), [o, u, s, r]);
  reactExports.useEffect(() => a, [a]);
}
function useHandleKeydown(e, u, t = !1) {
  return useHandleKey(normalizeKeyCode(e), "keydown", u, t);
}
function Provider(e) {
  ...
  return jsxRuntimeExports.jsx(Context$2.Provider, { value: n, children: e.children });
}
...
function useTooltip({
    ...
    [a, i] = reactExports.useMemo(() => {
      ...
      function a() {
        ("display" === o.current.status &&
          (sendEvent$1.tooltip.hide(e, u, t), (o.current.status = statuses$1.idle)),
          (o.current.status = statuses$1.await),
          window.clearTimeout(o.current.timeoutId),
          (o.current.timeoutId = window.setTimeout(i, r)));
      }
      function i() {
        ((o.current.status = statuses$1.display),
          sendEvent$1.tooltip.open(e, u, t, s),
          n && displayedTooltips.set(n, d));
      }
      function l() {
        if (
          (window.clearTimeout(o.current.timeoutId),
          o.current.status === statuses$1.display && sendEvent$1.tooltip.hide(e, u, t),
          (o.current.status = statuses$1.idle),
          n)
        ) {
          displayedTooltips.delete(n);
      ...
      const d = {
        ...
        show: i,
        rerun: function () {
          o.current.status !== statuses$1.idle && a();
        },
      };
      return [
        d,
  ...
  return (
    ...
    useUnmount(useEvent(a.hide)),
    i
  );
}
function useParamTooltip(e, u, t) {
  return useTooltip({
    ...t,
    disabled: t?.disabled,
    contentId: resources.resolve("aliases").read((e) => e.common.tooltip.Param("resId")),
    args: reactExports.useMemo(
      () => ({ type: e, params: JSON.stringify(u), resId: u.resId }),
      [u, e],
    ),
  });
}
...
function SoundsProvider({ severity: e = "warn", overrides: u, silent: t = !1, children: n }) {
  const s = reactExports.useMemo(() => ({ ...soundConfig, ...u }), [u]),
    r = reactExports.useMemo(
      () => ({
        play: function (u, n) {
          if (t) return;
          const r = s[u];
          r ? r(n) : logBySeverity(`There is no sound for event: ${u}`, e);
        },
        settings: { plays: s, severity: e, silent: t },
      }),
      [s, e, t],
    );
  return jsxRuntimeExports.jsx(Context$1.Provider, { value: r, children: n });
}
function useSounds() {
...
function useContextMenu({
  ...
  const o = useSounds(),
    [{ hide: a }, i] = reactExports.useMemo(() => {
      function a() {
        s || sendEvent$1.contextMenu.open(e, u, t, n);
      }
      return [
        {
          hide: function () {
            sendEvent$1.contextMenu.hide(e, u, t);
          },
          show: a,
        },
        {
          onMouseDown: (e) => {
            isRightClick(e) &&
              (o.play("show-context-menu", {
                target: r ?? "react-toolkit:use_context_menu",
                original: e,
              }),
              a());
          },
    ...
    if (n.includes(":ViewModel:") || "Object" === n) {
      ...
      }
      {
        ...
        for (const u in s) {
          ...
          bindingsForbidden.has(n) || (e[u] = cloneModel(t, o));
        }
        return e;
      }
    }
    ...
    for (let n = 0; n < u.length; n++) {
      ...
      s in t
        ? null === r
          ...
          : t[s].set(r)
        : null !== r && ((t[s] = observable.box(r, MOBX_OPTIONS)), this._keys.add(s), this.set(t));
    }
  }
  entries() {
...
function createObservableModel(e, u, t) {
  ...
  const s = (s, r, o = DEFAULT_BOX_CONFIG) => {
      const a = observable.box(s(t(r)), o);
      return ("real" === u && e.subscribe((e) => n.push(() => a.set(s(e))), r), a);
    },
    r = (s, r) => {
      const o = new DLDict(t(s), r);
      return ("real" === u && e.subscribe((e, u) => n.push(() => o.update(e, u)), s), o);
    },
    o = (s, r) => {
      const o = observable.box(t(s) ?? r, DEFAULT_BOX_CONFIG);
      return ("real" === u && e.subscribe((e) => n.push(() => o.set(e)), s), o);
    };
  return {
    dict: r,
    ...
    primitives: (s, r) => {
      const o = t(r);
      if (Array.isArray(s)) {
        const t = s.reduce((e, u) => ((e[u] = observable.box(o[u], {})), e), {});
        return (
          "real" === u &&
            e.subscribe((e) => {
              n.push(() =>
      ...
      }
      {
        const t = s,
          a = Object.entries(t),
          i = a.reduce((e, [u, t]) => ((e[t] = observable.box(o[u], {})), e), {});
        return (
          "real" === u &&
            e.subscribe((e) => {
              n.push(() =>
...
const initializeModelWithContext =
    ...
    (u, t, n) => {
      ...
      function r(r) {
        const { mode: o, options: a, children: i, mocks: l } = r,
          d = useMockContext(),
          c = o ?? d.mode,
          E = l ?? d.mocks,
          ...
          p = n?.useRequires?.(),
          A = useEvent((s, o, a) => {
            const i = "real" !== s && a ? createMockInstance(a.getter, o) : create(o, { name: e }),
              l = (e) => ("mocks" === s ? a?.getter(e, o) : i.readByPath(e)),
              d = (e) => m.current.push(e),
              c = "initial" in r && { initial: n?.initial?.(r.initial) },
              E = u({
                ...c,
                mode: s,
                readByPath: l,
              ...
              A = { ...c, mode: s, model: E, externalModel: i, cleanup: d, requires: p },
              F = "mocks" === s && a?.controls ? a.controls(A) : {};
            return {
              model: E,
              controls: { ...t?.(A), ...F },
              externalModel: i,
          ...
          [D, g] = reactExports.useState(c);
        reactExports.useEffect(() => {
          g(c);
        }, [c]);
        const [h, f] = reactExports.useState(() => A(D, a, E));
        return (
          reactExports.useEffect(() => {
            F.current ? f(A(D, a, E)) : (F.current = !0);
          }, [A, E, D, a?.context, a?.initializer, a?.getRoot, a?.rootId]),
          reactExports.useEffect(
            () => () => {
          ...
          jsxRuntimeExports.jsx(s.Provider, { value: h, children: i })
        );
      }
      return (
        (r.displayName = e),
  ...
  const e = (u = window.model, { depth: t = 16, convertArrays: n = !0 } = {}) => {
    ...
    switch (typeof u) {
      ...
      case "function":
        return "function";
      case "object": {
        const s = { depth: t - 1, convertArrays: n },
          r = u.constructor?.name ?? "UNKNOWN";
        switch (!0) {
          case r.includes("CoherentArrayProxy"):
            return [...u.values()].map((u) => e(s.convertArrays ? u.value : u, s));
          case "Dict" === r:
            return [...u.entries()].reduce((u, [t, n]) => ((u[t] = e(n, s)), u), {
              $$type: "Dict",
            });
          case "UNKNOWN" === r:
            return "UNKNOWN_TYPE";
          ...
          default: {
            const t = {};
            for (const n in u) Object.prototype.hasOwnProperty.call(u, n) && (t[n] = e(u[n], s));
            return t;
          }
        }
      }
...
function defineStyledComponent(e, u, t) {
  ...
  if ("object" == typeof u) {
    const t = u,
      n = cva(t.className, t.cva),
      r = t.element,
      o = reactExports.forwardRef(function (e, u) {
    ...
    return ((o.displayName = e), t.cva && (o.cva = t.cva), o);
  }
  const r = cva(u, t),
...
function getBaseAnimationConfig({
  baseValue: e,
  newValue: u,
  animationType: t = animations.simple,
  deltaVisible: n = !1,
  ...
  return {
    ...
    to: { width: u },
    config: r ?? {
      duration: (t === animations.simple && n) || (!n && s) ? 0 : DURATION,
...
function withResolvePath(e) {
  ...
  return reactExports.forwardRef(function (e, t) {
    const n = useAdaptive(e, e.adaptive),
      { path: s, ...r } = n,
      o = n.images ?? resources.resolve("images"),
      a = { ...r, ref: t };
    {
      const e = s ? o.readOr(s, undef, "warn") : void 0;
      return e
        ? jsxRuntimeExports.jsx(u, { ...a, src: e })
        : jsxRuntimeExports.jsx(u, { ...a, unknown: !0 });
    }
  });
}
...
withResolvePath(
  reactExports.forwardRef(function (e, u) {
    const {
      ...
      unselectable: r,
      unknown: o,
      unknownStyle: a = defaultUnknownStyle,
      ...i
    } = e;
    return e.unknown
      ? jsxRuntimeExports.jsx("div", { ...i, style: { width: e.width, height: e.height, ...a } })
      : jsxRuntimeExports.jsx("img", { ...i, ref: u, src: s, width: t, height: n });
  }),
);
...
function useRegisterComponent(e) {
  const { activeComponents: u } = useProgressBar();
  reactExports.useEffect(
    () => (
      u.add(e),
      () => {
...
const root$8 = "BackgroundPattern_root_9cb0a5ae",
  base$e = "BackgroundPattern_8df99ec8",
...
function getIconPath(e, u) {
  return u === statuses.disabled
    ? `ui.progressbar.bg_pattern_base_disabled_${e}`
    : `ui.progressbar.bg_pattern_base_${e}`;
}
const BackgroundPattern = reactExports.memo(function ({ className: e, backgroundPattern: u }) {
  ...
  return (
    ...
    jsxRuntimeExports.jsx("div", {
      ...
      children: jsxRuntimeExports.jsx(Image, {
        className: clsx(
          e,
          styles$f.backgroundPattern,
          0 === t.percentage
            ? styles$f.backgroundPattern__noProgress
            : styles$f[`backgroundPattern__${t.size}`],
        ),
        repeat: "repeat",
        position: "left top",
        path: u ?? getIconPath(t.size, t.status),
      }),
    })
  );
});
function useDeltaSound(e, u) {
  const t = useProgressBar(),
    n = useSounds();
  return useEvent((s) => {
    if (s)
      switch (t.animationType) {
        case "simple":
          t.progressCompleted
            ? n.play("increaseDeltaMax", { target: u })
            : n.play("progressSimple", { target: u });
          break;
        case "grow":
          !(function (s) {
            if ("growing" === s) return n.play("progressSimple", { target: u });
            if ("shrinking" === s) {
              if (t.progressCompleted) return n.play("increaseDeltaMax", { target: u });
              if (e > 0) return n.play("increaseDelta", { target: u });
              if (e < 0) n.play("decreaseDelta", { target: u });
            }
          })(s);
          break;
        case "growFreeze":
...
function useProgressBarSounds(e = 0) {
  const u = useProgressBar(),
    t = u.soundTarget ?? PROGRESS_BAR_TARGET,
    n = useSounds(),
    s = useDeltaSound(e, t),
    r = useEvent(() => {
      u.status !== statuses.doneInactive && u.progressCompleted
        ? n.play("increaseDeltaMax", { target: t })
        : n.play("progressSimple", { target: t });
    });
  return useEvent(({ step: e } = {}) => {
    if (!u.silent)
      return u.activeComponents.has("delta") ? s(e) : u.activeComponents.has("fill") ? r() : void 0;
  });
}
const delta = "Delta_eb295acb",
  ...
  Delta = reactExports.memo(
    reactExports.forwardRef(function (
      {
        from: e,
        growAnimationConfig: u,
        shrinkAnimationConfig: t,
        classNames: n,
        className: s,
        steps: r,
        onState: o,
      ...
      const l = reactExports.useRef(null),
        d = useProgressBar(),
        [c, E] = useSpring(() => ({ width: 0 })),
        [m, p] = useSpring(() => ({ width: 0 })),
        [A, F] = useSpring(() => ({ left: 0, width: 0 })),
        [D, ...g] = r,
        [h, f] = reactExports.useState(g),
        [B, _] = reactExports.useState(D ?? "done"),
        C = (d.value - e) / d.maxValue,
        x = useProgressBarSounds(C);
      ...
      const b = useEvent(o ?? noop);
      reactExports.useEffect(() => b(B), [B, b]);
      const v = useEvent(() => {
        const [e, ...u] = h;
        void 0 !== e ? (_(e), f(u)) : _("done");
      });
      return (
        reactExports.useEffect(() => {
          const e = l.current;
          if (!e || 0 === C)
            return (p.set({ width: 0 }), E.set({ width: 0 }), _("done"), void f([]));
          const n = 100 * Math.max(0, d.percentage - Math.max(0, C)),
            s = 100 * Math.abs(C);
          return (
            e.classList.toggle(styles$e.delta__increase, C > 0),
            "growing" === B
              ? (F.set({ left: n, width: s }),
                p.set({ width: 100 }),
                void E.start({
                  from: { width: 0 },
                  to: { width: 100 },
                  config: u ?? ANIMATION_CONFIG,
                  onRest: v,
                  onStart: () => x({ step: B }),
                }))
              : "shrinking" === B
        ...
        }, [F, d.percentage, C, u, E, v, p, x, t, B]),
        jsxRuntimeExports.jsxs(animated.div, {
          ...a,
          ref: assignRefs([i, l]),
          className: clsx(s, styles$e.delta),
          style: { left: A.left.to((e) => `${e}%`), width: A.width.to((e) => `${e}%`) },
          children: [
            jsxRuntimeExports.jsxs(animated.div, {
              ...a,
              style: { width: m.width.to((e) => `${e}%`) },
              className: clsx(n?.outside, styles$e.outside, C > 0 && styles$e.outside__increase),
              children: [
                jsxRuntimeExports.jsx(animated.div, {
                  style: { width: c.width.to((e) => `${e}%`) },
                  className: clsx(n?.inside, styles$e.inside, C > 0 && styles$e.inside__increase),
                }),
                a.children,
              ],
            }),
  ...
  root$7 = "Fill_root_43ad874e",
  base$d = "Fill_d056f825",
  ...
  Done = reactExports.memo(function ({ animationConfig: e, classNames: u }) {
    const t = useProgressBar(),
      { activeComponents: n } = useProgressBar(),
      s = 100 * t.percentage,
      r = 100 * (t.previous?.percentage ?? 0),
      o = void 0 === t.previous ? s : r,
      a = t.status === statuses.doneStatic,
      i = useSkipFrame(),
      [l, d] = useSpring(() => ({ width: o }));
    return (
      reactExports.useEffect(() => {
        i.run(() =>
          d.start(
        ...
        children: [
          jsxRuntimeExports.jsx(AnimatedImage$1, {
            ...
            className: clsx(
              u?.done,
              styles$d.done,
              !t.progressCompleted && styles$d.done__hidden,
              t.progressCompleted && (a ? styles$d.done__doneStatic : styles$d.done__visible),
            ),
            repeat: "repeat",
            position: "left top",
          ...
          !a &&
            jsxRuntimeExports.jsx(AnimatedImage$1, {
              ...
              className: clsx(
                u?.doneComplete,
                styles$d.complete,
                t.progressCompleted && styles$d.complete__visible,
              ),
              repeat: "repeat",
              position: "left top",
              style: { width: l.width.to((e) => `${e}%`) },
  ...
  Filled = reactExports.memo(function ({ filledPattern: e, animationConfig: u, className: t }) {
    const n = useProgressBar(),
      { activeComponents: s } = useProgressBar(),
      r = useSkipFrame(),
      o = 100 * n.percentage,
      a = 100 * (n.previous?.percentage ?? 0),
      i = void 0 === n.previous ? o : a,
      [l, d] = useSpring(() => ({ width: i }));
    return (
      reactExports.useEffect(() => {
        r.run(() =>
          d.start(
      ...
      }, [d, i, n.animationType, s, o, u, r]),
      jsxRuntimeExports.jsx(AnimatedImage, {
        path: e || `ui.progressbar.bg_pattern_base_filled_${n.size}`,
        className: clsx(
          t,
          styles$d.filled,
          n.status && styles$d[`filled__${n.status}`],
          n.progressCompleted && styles$d.filled__hidden,
        ),
        repeat: "repeat",
        position: "left top",
        style: { width: l.width.to((e) => `${e}%`) },
    ...
    (useRegisterComponent("fill"),
      reactExports.useEffect(() => {
        "growFreeze" === r.animationType &&
          ...
          o();
      }, [r.activeComponents, r.animationType, r.progressCompleted, o]));
    const [E, m] = useSpring(() => ({ width: c }));
    return (
      reactExports.useEffect(() => {
        a.run(() =>
          m.start({
      ...
      }, [n, m, c, r.animationType, i, l, o, a]),
      jsxRuntimeExports.jsxs("div", {
        className: clsx(styles$d.base, t),
        children: [
          jsxRuntimeExports.jsx(animated.div, {
            className: u?.fill,
            style: { width: E.width.to((e) => `${e}%`) },
          }),
          s.children ??
            jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                jsxRuntimeExports.jsx(Filled, {
                  filledPattern: e,
                  className: u?.filledPattern,
                  animationConfig: n,
                }),
                jsxRuntimeExports.jsx(Done, { classNames: u, animationConfig: n }),
              ],
            }),
          jsxRuntimeExports.jsx(animated.div, {
            className: clsx(
              u?.edge,
              styles$d.edge,
              0 === r.percentage && styles$d.edge__noProgress,
              !i.has("previewDelta") && !r.progressCompleted && styles$d.edge__visible,
              r.status && styles$d[`edge__${r.status}`],
            ),
            style: { left: E.width.to((e) => `${e}%`) },
          }),
        ],
      })
    );
...
const positions = { above: "above", below: "below" },
  root$6 = "Indicators_root_4533c96b",
  base$c = "Indicators_f2e99d31",
...
function Step({ position: e, value: u, children: t, className: n, classNames: s }) {
  const r = useProgressBar();
  return jsxRuntimeExports.jsxs("div", {
    className: clsx(styles$c.step, styles$c[`step__${e}`], n),
    style: { left: (u / r.maxValue) * 100 + "%" },
    children: [
      e === positions.below &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$c.indicator, s?.indicator) }),
      void 0 !== t &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$c.label, s?.label), children: t }),
      e === positions.above &&
        jsxRuntimeExports.jsx("div", { className: clsx(styles$c.indicator, s?.indicator) }),
    ],
  });
}
const Indicators = defineStyledComponent("Indicators", styles$c.base),
  NumberIndicators = function (e) {
    const u = useProgressBar();
    return (
      useRegisterComponent("stepIndicators"),
      jsxRuntimeExports.jsx(Indicators, {
        children: mapRange(e.count, (t) => {
          const n = (t / (e.count - 1)) * 100,
            s = u.value >= n && 0 !== u.value;
          return jsxRuntimeExports.jsx(
            Step,
            {
              position: e.position,
              value: n,
              className: clsx(e.classNames?.step, s && e.classNames?.completed),
              classNames: e.classNames?.stepClassNames,
              children: e.children ? e.children(t, n, s) : void 0,
            },
            t,
          );
        }),
...
const base$b = "PreviewDelta_86b01c3e",
  ...
  PreviewDelta = reactExports.forwardRef(function ({ value: e, classNames: u, ...t }, n) {
    const s = useProgressBar();
    useRegisterComponent("previewDelta");
    const r = e - s.value,
      o = r < 0 ? "negative" : r > 0 ? "positive" : "neutral";
    if ("neutral" === o) return null;
    const a = Math.abs(r) / s.maxValue,
      i = r < 0 ? a : 0,
      l = 100 * (s.percentage - i),
      d = 100 * a;
    return jsxRuntimeExports.jsxs("div", {
      ...t,
      ...
      children: [
        jsxRuntimeExports.jsx("div", {
          style: { left: `${l}%`, width: `${d}%`, ...t.style },
          className: clsx(
            u?.negative,
            styles$b.negative,
            "negative" === o && styles$b.negative__visible,
          ),
        }),
        jsxRuntimeExports.jsx("div", {
          style: { left: `${l}%`, width: `${d}%`, ...t.style },
          className: clsx(
            u?.positive,
            styles$b.positive,
            "positive" === o && styles$b.positive__visible,
          ),
        }),
      ],
    });
...
function ProgressBarProvider(e) {
  const [u, t] = reactExports.useState(Math.min(e.value, e.maxValue)),
    [n, s] = reactExports.useState(e.maxValue),
    r = usePrevious(u),
    o = usePrevious(n),
    a = reactExports.useRef(new Set()),
    i = useEvent((u) => t(Math.min(u, e.maxValue))),
    l = useEvent((e) => a.current.has(e));
  (reactExports.useLayoutEffect(() => {
    i(e.value);
  }, [e.value, i]),
    reactExports.useLayoutEffect(() => {
  ...
  const d = useEvent((u) => e.onValueChange?.(u));
  reactExports.useEffect(() => {
    d(u);
  }, [d, u]);
  const c = useEvent((u) => e.onMaxValueChange?.(u));
  reactExports.useEffect(() => {
    c(n);
  }, [c, n]);
  const E = reactExports.useMemo(() => {
    if (void 0 !== r && void 0 !== o) return { value: r, maxValue: o, percentage: r / o };
  }, [r, o]);
  assert(n > 0, "ProgressBar: maxValue must be greater than 0");
  const m = reactExports.useMemo(() => {
      const t = u / n === 1 && e.status !== statuses.doneInactive;
      return e.animationType === animations.growFreeze ? t && e.maxValueAchieved : t;
    }, [n, e.animationType, e.maxValueAchieved, e.status, u]),
...
const root$5 = "ProgressBar_root_13ab2776",
  background$1 = "ProgressBar_background_b4143753",
  base$a = "ProgressBar_27c2305c",
  ...
  Base = defineStyledComponent("ProgressBar", styles$a.base, {
    variants: { size: { medium: styles$a.base__medium, large: styles$a.base__large } },
  }),
  ProgressBar = function ({
    ...
    return jsxRuntimeExports.jsx(ProgressBarProvider, {
      ...
      children: jsxRuntimeExports.jsxs(Base, {
        ...
        className: clsx(
          n,
          r.value === r.maxValue && t !== statuses.doneInactive && styles$a.base__done,
        ),
        children: [
          jsxRuntimeExports.jsx("div", {
            className: clsx(styles$a.border, styles$a[`border__${e}`], s?.border),
          }),
          jsxRuntimeExports.jsx("div", { className: clsx(styles$a.background, s?.background) }),
...
const base$9 = "HeadlessButton_df8536fc",
  styles$9 = { base: base$9 },
  ...
  HeadlessButton = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(HeadlessButtonBase, {
      ...
      onMouseEnter: function (e) {
        (s || r || i.play("mouse-enter", { target: n || "Button", original: e }), t?.(e));
      },
      onClick: function (e) {
        s || (r || i.play("click", { target: n || "Button", original: e }), u?.(e));
      },
      children: e,
    });
  }),
...
function CloseButton({
  ...
  const o = useUpscale(styles$8[`base__${e}`], styles$8[`base__${upscaleImageSizes[e]}`]);
  return jsxRuntimeExports.jsx("div", {
    className: classNames(styles$8.base, o, n),
    onMouseEnter: () => {
      (play.sound(u), s?.());
    },
    onClick: () => {
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, " "),
  ...
  splitAndFormat = (e, u, t = 0) =>
    e.split(u).reduce(0 === t ? addSeparatorToRight : addSeparatorToLeft, []),
  splitEuropean = (e, u = 0) => {
    let t = [];
    const n = new RegExp(
      ...
      children: r
        ...
        .map((u, s) =>
          jsxRuntimeExports.jsx(
            "div",
            {
              className: classNames(styles$7.base, t),
      ...
      (u, t) => (
        (u[t] = (function (u) {
          return (t) => {
            ...
            let s = !0;
            const r = `mouse${u}`,
              o = internalMouse[u]((e) => t([e, "outside"]));
            function a(e) {
              t([e, "inside"]);
            }
            return (
              ...
              n(),
              () => {
                s && (o(), window.removeEventListener(r, a), (e.listeners -= 1), n(), (s = !1));
              }
            );
          };
        })(t)),
...
function arabic2roman$1(e) {
  ...
  for (let t = ARABIC.length - 1; t >= 0; t--)
    for (; e >= ARABIC[t];) ((u += ROMAN[t]), (e -= ARABIC[t]));
  return u;
}
...
const makeGlobalBoundingBox = (e) => ({
  ...
  sendShowPopOverEvent = (e, u, t, n, s = R.invalid("resId"), r) => {
    const o = env.view.getViewGlobalPosition(),
      { x: a, y: i, width: l, height: d } = t.getBoundingClientRect(),
      c = {
        x: env.view.pxToRem(a) + o.x,
...
const handleViewEvent = (e, u, t = {}, n = 0) => {
  ...
  Tooltip = ({
    ...
    const A = reactExports.useRef({
      ...
      F = reactExports.useMemo(() => c || getFromCallStack().resId, [c]),
      D = reactExports.useCallback(() => {
        (A.current.isVisible && A.current.timeoutId) ||
          (handleViewEvent(
            u,
            l,
            { isMouseEvent: !0, on: !0, arguments: getViewEventArguments(t) },
            F,
          ),
          E && E(),
      ...
      h = reactExports.useCallback((e) => {
        A.current.isVisible &&
          ...
          (A.current.hideTimerId = window.setTimeout(() => {
            ...
            u && !u.isSameNode(A.current.prevTarget) && g();
          }, 200)));
      }, []);
    (reactExports.useEffect(() => {
          ...
          onMouseEnter:
            ...
            (e) => {
              (e.clientX === window.innerWidth && e.clientY === window.innerHeight) ||
                ...
                (A.current.timeoutId = window.setTimeout(
                  D,
                  a ? SHOW_DELAY_MIN : SHOW_DELAY_DEFAULT,
                )),
                n && n(e),
                f && f(e));
            }),
  ...
  SimpleTooltip = ({ children: e, body: u, header: t, note: n, alert: s, args: r, ...o }) => {
    const a = reactExports.useMemo(() => {
      const e = { ...r, body: u, header: t, note: n, alert: s };
  ...
  Button = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(HeadlessButton, {
      ...
      className: clsx(
        styles$6.base,
        styles$6[`base__size-${u}`],
        styles$6[`base__theme-${t}`],
      ...
      children: [
        jsxRuntimeExports.jsx("div", { className: clsx(styles$6.background, o?.background) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$6.border, o?.border) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$6.overlay, o?.overlay) }),
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$6.content, r && styles$6.content__fontAligned, o?.content),
          children: e,
        }),
      ],
    });
...
const root$2 = "Badge_root_8bc2e1a2",
  base$5 = "Badge_b4595e01",
  base__default$1 = "Badge_base__default_6aaca100",
  base__x48$1 = "Badge_base__x48_2b129eae",
  styles$5 = { root: root$2, base: base$5, base__default: base__default$1, base__x48: base__x48$1 },
  badgeFolders = {
  ...
  Badge = ({ badgeID: e, size: u = IconSize.default, className: t }) => {
    ...
    return jsxRuntimeExports.jsx("div", {
      className: classNames(styles$5.base, styles$5[`base__${u}`], t),
    ...
    return (
      ...
      jsxRuntimeExports.jsx(SimpleTooltip, {
        ...
        children: jsxRuntimeExports.jsx("div", {
          ...n,
          ref: s,
          className: classNames(styles$4.base, t, u),
          children: e,
        }),
      })
    );
  },
  root$1 = "Playernickname_root_4dc1c796",
  ...
  UsernameAnonymizerComponent = ({ tooltipHeaderName: e }) => {
    ...
    return jsxRuntimeExports.jsx(SimpleTooltip, {
      header: u,
      body: t,
      children: jsxRuntimeExports.jsx("div", { className: styles$3.anonymizedIcon }),
    });
  },
  ...
  PlayerNickname = ({
    ...
    const E = R.images.gui.maps.icons.library.badges.strips.$dyn(suffixBadgeStripeFolders[l]),
      ...
      F = u ? `[${u}]` : "",
      D = classNames(styles$3.base, styles$3[`base__${l}`], r && styles$3.base__inverted),
      g = classNames(styles$3.userName, d),
      h = classNames(styles$3.clanTag, c),
      f = e !== i,
      B = o ? `${i}${F}` : i,
      _ = Boolean(n.badgeID) && reactExports.createElement(Badge, { size: l, ...n, key: "badge" }),
      C = Date.now(),
      x = [
        _,
        [
          ...
          !o &&
            Boolean(F) &&
            jsxRuntimeExports.jsx("div", { className: h, children: F }, "clanTag"),
        ],
        0 !== t && jsxRuntimeExports.jsx("div", { className: styles$3.igrIcon }, "igrType"),
        Boolean(s.badgeID) &&
          jsxRuntimeExports.jsxs(
            "div",
            {
              className: styles$3.suffixBadgeWrapper,
              children: [
                jsxRuntimeExports.jsx("div", { className: styles$3.suffixBadgeStripe, style: m }),
                jsxRuntimeExports.jsx("div", { className: styles$3.suffixBadge, style: A }),
              ],
            },
            "suffixBadge",
          ),
        a && f && jsxRuntimeExports.jsx(UsernameAnonymizer, { tooltipHeaderName: B }, "anonymizer"),
      ];
    return jsxRuntimeExports.jsx("div", { className: D, children: r ? x.reverse() : x });
  },
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    if (l === u.start[0] && e.slice(i, i + u.start.length) === u.start) {
      if (s) {
        ...
        } else t.push({ type: NodeTypes.Text, value: s });
        s = "";
      }
      ...
      if (e.startsWith("@")) {
        const u = e.slice(1).trim(),
          s = { type: NodeTypes.Tag, attrs: u.split("|"), instanceId: ++a, children: [] };
        if (n.length > 0) {
          n[n.length - 1].node.children.push(s);
        } else t.push(s);
        n.push({ node: s, startIndex: t.length });
      } else if ("/" === e) n.length > 0 && n.pop();
      else {
        const u = { type: NodeTypes.Var, instanceId: ++a, name: e };
        if (n.length > 0) {
...
const COLORS =
  ...
  styles$2 = { COLORS: COLORS, base: base$2, base__fullSize: base__fullSize, nowrap: nowrap },
  legacyColors = new Set(styles$2.COLORS?.split(", ") ?? []);
let keyId = 0;
function takeKey() {
  return ++keyId;
}
        ...
        reactExports.Fragment,
        {
          children: [
            jsxRuntimeExports.jsxs("span", {
              className: styles$2.nowrap,
              children: [split(n), s[0]],
            }),
            r,
          ],
        },
...
function applyFunction(e, u, t, n) {
  const s = t.map((u) => {
      if ("string" != typeof u) return u;
      const t = u.trim();
      if (t.startsWith("(") && t.endsWith(")")) {
        const [u, ...s] = t.slice(1, -1).split(" ");
        return u ? applyFunction(e, u, s, n) : e;
      }
      return t.startsWith("'") && t.endsWith("'") ? t.slice(1, -1) : t;
    }),
    r = n[u];
  return r ? r(e, ...s) : (console.error(`Function ${u} is not registered`), e);
}
function applyFunctions(e, u, t) {
  return e.reduce((e, u) => {
    const [n, ...s] = parseArguments(u.trim());
    return n ? applyFunction(e, n, s, t) : e;
  }, u);
}
function isEnd(e) {
...
function resolveAttrParams(e, u) {
  for (let t = 0; t < e.length; t++) {
    if ("$" === e[t]) {
      ...
      const s = e.slice(t + 1, n),
        r = u[s];
      if (r) return resolveAttrParams(e.replace(`$${s}`, String(r)), u);
    }
  }
  return e;
}
function resolveAttrsParams(e, u) {
  const t = [];
  for (let n = 0; n < e.length; n++) t[n] = resolveAttrParams(e[n], u);
  return t;
}
const primitives = ["number", "string", "undefined"];
function render(e, u, t = {}, n = !0) {
  n && (keyId = 0);
  const s = [];
  function r(e) {
    if (primitives.includes(typeof e)) {
      const u = s.at(-1);
      if ("string" == typeof u) return void (s[s.length - 1] = u + e);
    }
    s.push(e);
  }
  for (const o of e)
    if (o.type === NodeTypes.Text) r(o.value);
      ...
      null === t[o.name] || primitives.includes(typeof t[o.name])
        ? r(t[o.name] ?? `{{${o.name}}}`)
        : s.push(
            jsxRuntimeExports.jsx(
              reactExports.Fragment,
      ...
      const e = render(o.children, u, t, !1),
        n = applyFunctions(resolveAttrsParams(o.attrs, t), e, u);
      s.push(n);
    }
  return s;
}
...
const defaultBrackets = { start: "{{", end: "}}" },
  FormatText = reactExports.memo(function (e) {
    const {
      ...
      E = reactExports.useMemo(() => parse(i ? `{{@ split}}${d}{{/}}` : d, u), [u, d, i]),
      m = reactExports.useMemo(() => render(E, c, e.params), [E, c, e.params]),
      p = clsx(styles$2.base, r && styles$2.base__fullSize, l.className);
    return e.inline
      ? (console.warn(
...
const MultilineOverflow = reactExports.forwardRef(function (
  ...
  reactExports.useEffect(() => {
    ...
    function s() {
      ...
      if (!e) return console.warn("MultilineOverflow can't get first child to handle it", u);
      (n.remove(),
        (n.className = clsx(styles$1.content, u.children[0].className)),
        (n.innerHTML = ""),
      ...
      for (; r >= 0; r--) {
        ...
        if (t instanceof HTMLElement && !(t.offsetTop + t.offsetHeight > u.clientHeight)) break;
      }
      if (r === s) B(!1);
      else {
        B(!0);
        const s = relativeOffset(u.getBoundingClientRect(), e.getBoundingClientRect());
        for (
          n.style.visibility = "", n.style.left = `${s.x}px`, n.style.top = `${s.y}px`;
          r >= 0;
          r--
        ) {
          ...
          if (
            ...
            !(u.offsetLeft + u.offsetWidth + t.offsetWidth > e.clientWidth)
          )
            break;
        }
        for (let u = 0; u <= r; u++) {
          const t = e.childNodes[u];
          if (!(t instanceof HTMLElement)) continue;
          const s = cloneNode(t);
          s ? n.appendChild(s) : console.warn("Unexpected type of target node", t);
        }
        const o = t.cloneNode(!0);
        (o.removeAttribute("style"), n.appendChild(o), u.appendChild(n));
      }
    }
  ...
  const _ = isSerializableParams(t),
    C = useParamTooltip(
      "format_text",
      reactExports.useMemo(
        () => ({
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...F,
    onMouseEnter: function (e) {
      (o?.(e), f && !l && x.onMouseEnter(e));
    },
    onClick: function (e) {
      (i?.(e), l || x.onClick());
    },
    onMouseLeave: function (e) {
      (a?.(e), l || x.onMouseLeave());
    },
    ref: assignRefs([D, g]),
    className: clsx(styles$1.base, c, E?.base),
    style: { ...m, ...p },
    children: [
      jsxRuntimeExports.jsx(FormatText, {
        ...
        formatters: n,
        className: E?.text,
        style: { ...A, visibility: f ? "hidden" : void 0 },
      }),
      jsxRuntimeExports.jsx("div", {
        ref: h,
...
function FormatTextSplited({ className: e, ...u }) {
  return jsxRuntimeExports.jsx("div", {
    className: e,
    children: u.text
      .split("\n")
      .map((e) => jsxRuntimeExports.jsx(FormatText, { ...u, text: e }, e)),
  });
}
function ExtendedText(e) {
  ...
  const u = e.isTruncationAvailable || e.truncateIdentify ? MultilineOverflow : FormatTextSplited;
  return jsxRuntimeExports.jsx(u, {
    split: e.split ?? !0,
    text: e.text,
    params: e.binding,
...
Object.values(types);
const sizes = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
  ...
  VehicleType = reactExports.forwardRef(function (
    { type: e, size: u = sizes.x48x48, premium: t = !1, fit: n = "contain", ...s },
    r,
  ) {
    const o = useUpscale(sizes[u], upscaledSizes[u]);
    return jsxRuntimeExports.jsx(Image, {
      ...
      className: clsx(
        styles.base,
        t ? styles[`base__premium__${u}`] : styles[`base__${u}`],
        s.className,
      ),
      path: `ui_kit.vehicle_type.${o}.${t ? "premium_" : ""}${normalizeResource(mapTypes[e])}_${o}`,
    });
  });
...
export {
  ...
  SimpleTooltip as j,
  useBackportContextMenu as k,
  PlayerNickname as l,
  mapRange as m,
  noop as n,
  getNumberFormat as o,
  play as p,
