...
import { M as Ks } from "../../../chunks/sound.js";
import { t as Qs, a as Ys, b as Js } from "../../../chunks/sounds.js";
import {
  N as en,
  R as tn,
  P as an,
...
import { D as fn, u as vn, S as bn } from "../../../chunks/common.js";
import { S as xn } from "../../../chunks/story_point.js";
import { P as yn, V as Cn } from "../../../chunks/index.js";
const [wn, Nn] = V("VehiclesDailyProvider")(({ observableModel: e }) => {
    const t = e.dict("dailyVehicles"),
      a = O.structural((e) => t.get(e));
  ...
  Mn = "isCommonProgression",
  An = [F.assault, F.universal, F.break, F.sniper, F.scout, F.support],
  Ln = [
    "bonus",
    "favorite",
    "premium",
  ...
  Dn = [z.lightTank, z.mediumTank, z.heavyTank, z["AT-SPG"], z.SPG],
  Tn = H(1, 12, q),
  Bn = "vehicle_types",
  Vn = "nations",
  Rn = "levels",
  On = "specials",
  zn = "battle_pass",
  Hn = { heavy_tank: Z, medium_tank: $, light_tank: W, at_spg: U };
function Fn(e, t) {
  return e === Mn && t.status !== K.UNSUITABLE_TO_QUEUE && t.bpProgress < t.maxBpScore;
}
function qn(e, t, a, s) {
  switch (t) {
    case "elite":
...
const Un = {
  [Rn]: (e, t) => !e.levels || e.levels.includes(`level_${t.level}`),
  [Vn]: (e, t) => !e.nations || e.nations.includes(X(t.nationId)),
...
function Wn(e, t, a) {
  ...
  for (const r of n)
    if ("rented" !== r) {
      if (!qn(n, r, t, a)) return !1;
    } else s = !0;
  if (!s && G(t) && !a?.fromWotPlus) return !1;
  if (a && e.battle_pass && e.battle_pass.length > 0)
    for (const r of e.battle_pass) if (!Fn(r, a)) return !1;
  for (const r of Object.keys(e)) if (r in Un && !Un[r](e, t)) return !1;
  return ((e, t) => {
    const a = Q(t.role);
    let s = !1;
...
function $n(e, { shortName: t, fullName: a }) {
...
function Gn(e, t) {
  return "regular" === t.type
    ...
    : Object.keys(Hn).reduce((e, a) => {
        const s = Hn[a].find((e) => e.includes(t.role));
        return s
          ? Zn(
              e,
              a,
...
const [Kn, Qn] = V("FilterVehiclesProvider")(
    ({ observableModel: t, readByPath: a }) => {
      ...
      const { text_search: n, ...r } = s(a("filters")),
        ...
        o = O.structural(() => s(i.defaultFilters.get())),
        l = {
      ...
      return {
        ...l,
        computes: {
          hasFilters: O.primitive(
            () => !Y.structural(o(), l.filters.get()) || l.searchName.get().length > 0,
          ),
          nations: () => l.nations.get(),
          nationToIndex: O.shallow(() => l.nations.get().reduce((e, t, a) => ((e[t] = a), e), {})),
          default: o,
        },
      };
    },
    ({ cleanup: e, model: s, externalModel: n }) => {
      ...
      return (
        ...
        ),
        {
          ...
          change: a((e) => {
            s.filters.set(Gn(s.filters.get(), e));
          }),
  ...
  Yn = [z.lightTank, z.mediumTank, z.heavyTank, z["AT-SPG"], z.SPG].reduce(
    (e, t, a) => ((e[t] = a), e),
    {},
  ),
  [Jn, er] = V("VehicleStatisticsProvider")(({ observableModel: e }) => {
    const t = e.dict("statistics"),
      a = O.structural((e) => t.get(e));
    return { ids: O.primitive(() => t.keys), get: a };
  }),
  [tr, ar] = V("VehiclesProvider")(
    ({ observableModel: e }) => {
      ...
      return {
        ...
        has: O.primitive((e) => Boolean(t.vehicles.get(e))),
        ids: O.shallow(() => [...t.vehicles.keys.values()]),
        amount: O.primitive(() => t.vehicles.length),
        list: O.shallow(() => {
          let e = [];
    ...
    ee,
    { useRequires: () => ({ statistics: er() }) },
  ),
  [sr, nr] = V("MyVehiclesProvider")(
    (e) => {
      ...
      return { get: a, getAll: s, amount: O.primitive(() => s().length), ids: t };
    },
    ee,
    { useRequires: () => ({ vehicles: ar(), statistic: er() }) },
  ),
  rr = te.resolve("strings");
const ir = ae(re + ie),
  or = () => `${Date.now().toString(16)}_${ir(3)}`;
function lr(e, t, a = 1) {
  const s = se(t, { count: a });
  return e.has(s) ? lr(e, t, a + 1) : s;
}
function cr(e = "", t = []) {
  return {
    title: "" !== e ? e : rr.readOrEmpty("playlists.defaultName"),
    createdAt: Date.now(),
    modifiedAt: Date.now(),
    list: t,
  };
}
const dr = (e) => ({ type: "ok", value: e }),
  ur = (e, t) => ({ type: "error", error: { tag: e, msg: t } });
function mr(e) {
...
const pr = "delete",
  ...
  fr = "new",
  vr = "existing",
  br = s({ id: n(c(), l(1)), playlistState: r(i([o(vr), o(fr)])) }),
  [xr, yr, { Context: Cr }] = V("PlaylistsProvider")(
    ({ requires: t, observableModel: a }) => {
      const s = a.dict("storage"),
        ...
        o = O.shallow(() => s.keys),
        l = O.primitive(() => h(gr, n.selectedID.get())),
        c = O.structural((e) => {
          try {
            const t = s.get(e);
            if (!t) return dr(void 0);
            const a = h(hr, JSON.parse(t)),
              n = new Set();
            for (const e of a.list)
              if (oe[e]) {
                const t = oe[e].find((e) => Boolean(i.myVehicles.get(e.toString())));
                n.add(t ?? e);
              } else n.add(e);
            return dr({ ...a, list: [...n.values()] });
          } catch (t) {
            return (
              console.error(`Error getting playlist with ${e} id`, t),
              ur("PARSE_ERROR", String(t))
            );
          }
        }),
        d = O.shallow(() =>
        ...
        g = O.shallow(() => {
          ...
          return ce(t.myVehicles.model.getAll(), (t, a) => Xn(e, Yn, t, a));
        }),
        f = O.primitive((e) => {
          const t = m(e),
            a = b();
          ...
          for (let n = 0; n < a.length; n += 1) {
            ...
            if (de(e) && s.has(e)) return n;
          }
        }),
        v = O.primitive(
          () => !1 === Y.structural(r(), i.filters.get()) || i.searchName.get().length > 0,
        ),
        b = O.shallow(() => {
        ...
        x = O.primitive((e) => Boolean(t.statistic.model.get(e)?.elite)),
        y = O.shallow((e) => {
          const a = t.vehicles.model.get(e);
          return a?.imageKey;
        }),
        C = O.primitive(() => b().length),
        w = O.shallow(() => _()?.list.map(i.vehicles.get));
      return {
        ...i,
        current: _,
        titles: d,
    ...
    ({ model: e, externalModel: t }) => {
      ...
      return {
        filters: ue({
          update: (t) => {
            e.filters.set(Gn(e.filters.get(), t));
          },
          reset: () => {
        ...
        create: a((t) => {
          const { id: a = or(), vehicleIds: n = [], skipRedirect: r = !1 } = t ?? {};
          s({ id: a, initial: cr(lr(e.titles(), "playlists.defaultName"), n), skipRedirect: r });
        }),
        edit: {
        ...
        openDeleteConfirm: t.createCallback(
          (e, t) => ({ id: e, type: pr, params: JSON.stringify({ title: t }) }),
          "openDeleteConfirm",
        ),
      };
    },
    { useRequires: () => ({ vehicles: ar(), myVehicles: nr(), filters: Qn(), statistic: er() }) },
  ),
  wr = () => g.useContext(Cr),
  Nr = an,
  jr = tn,
  Ir = sn,
  [kr, Sr] = V("VehiclesInventoryProvider")(
    (a) => {
      const s = a.observableModel.primitives([
        ...
        c = O.primitive(() => -1 !== r.intCD.get()),
        d = O.shallow((e) => me(e, (e) => u.get(String(e)))),
        u = a.requires.myVehicles.model,
        m = O.structural(() => a.requires.vehicles.model.list().filter((e) => e.rent.isRented)),
        p = O.primitive(() =>
        ...
        _ = O.primitive(() => {
          ...
          return (e.sort((e, a) => Xn(t, Yn, e, a)), e);
        });
      return (
        a.cleanup(
          t(() => {
            const e = a.requires.filters.model.filters.get(),
              ...
              i = (s ? d(s.list) : _()).filter(
                (s) =>
                  !1 !== r.has(s.id) &&
                  !!Wn(e, s, a.requires.statistic.model.get(s.id)) &&
                  $n(t, s),
              );
            f(() => n.set(i));
          }),
        ),
        {
          ...
          current: {
            ...
            amount: O.primitive(() => n.get().length),
            list: () => n.get(),
            ids: O.shallow(() => n.get().map((e) => e.id)),
  ...
  Mr = "DifficultyApp_8d3524d3",
  Ar = "DifficultyApp_items_10ba5e15",
  Lr = "DifficultyApp_items__searching_3a590255",
  Dr = "DifficultyApp_item_80f31962",
  Tr = v(function ({
    className: e,
    onAnimStart: t,
    ...
    return b.jsx("div", {
      ...
      children: b.jsx("div", {
        className: x(Ar, o && Lr),
        children: _e(n.difficulties.get(), (e, t) =>
          b.jsx(
            fn,
            {
              ...e,
  ...
  Br = y.memo(function (e) {
    const t = R.aliases.last_stand.shared.Difficulty("resId"),
      a = g.useMemo(() => ({ rootId: t }), [t]);
    return b.jsx(he, { id: t, children: b.jsx(Er, { options: a, children: b.jsx(Tr, { ...e }) }) });
  }),
  Vr = g.createContext(void 0);
function Rr() {
  const e = g.useContext(Vr);
  if (!e)
...
const Or = {
  ...
  zr = "vehicle:filter:filter-button:reset-icon",
  Hr = g.forwardRef(function ({ children: e, className: t, ...a }, s) {
    return b.jsx(ge, {
      ...a,
      ref: s,
      classNames: { base: C(Or.filterButton, t) },
      size: ge.sizes.small,
      theme: a.theme,
      autoAlignContent: !1,
      children: e,
  ...
  Fr = w(
    g.forwardRef(function ({ current: e, total: t, classNames: a, onReset: s, ...n }, r) {
      ...
      return b.jsx(xe, {
        ...
        classNames: {
          base: C(Or.filterTrigger, m && Or.filterTrigger__activeFilter, a?.base),
          bulb: Or.bulb,
        ...
        children:
          ...
          (m
            ? b.jsxs("div", {
                className: C(Or.activeFilterContent, a?.content),
                children: [
                  ...
                  b.jsx("span", { className: Or.total, children: l.formatNumber("integral", t) }),
                  b.jsx(we, {
                    path: u,
                    className: Or.resetIcon,
                    onClick: (e) => {
                      (p.play("close", { target: zr, original: e }),
                        e.stopPropagation(),
                        i.reset(),
                        s?.());
                    },
                    onMouseEnter: (e) => {
                      p.play("mouse-enter", { target: zr, original: e });
                    },
                  }),
                ],
              })
            : b.jsx(we, { path: d, width: 24, height: 24 })),
      });
    }),
  ),
  qr = {
...
const Wr = Ne("IconContainer", "Icon_container_83f4dd0e"),
  $r = w(function (e) {
    const t = Sr(),
      a = yr().model.byIdUnsafe(e.id);
...
function Zr(e) {
  ...
  return b.jsx(r, {
    ...
    children: b.jsx(Ur, { className: e.classNames?.icon, value: n }),
  });
}
const Gr = (e) =>
    g.createElement(
  ...
  Yr = function (e) {
    ...
    return b.jsxs("div", {
      ...
      children: [
        b.jsx(Gr, { className: C(Kr.icon, Kr.icon__export) }),
        b.jsx(Xr, { className: C(Kr.icon, Kr.icon__exportDone) }),
      ],
    });
  },
  Jr = (e) =>
  ...
  ei = "EditButton_e0942ef0",
  ti = "EditButton_icon_a08c89e9",
  ai = te.resolve("strings");
function si({ id: e, className: t }) {
  const a = be(),
    s = Ee(),
    n = Ie({
      header: ai.readOrEmpty("playlists.edit_button.title"),
      body: ai.readOrEmpty("playlists.edit_button.body"),
    });
  return b.jsx("div", {
    ...n,
    className: C(ei, t),
    ...
    children: b.jsx(Jr, { className: ti }),
  });
}
const ni = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_";
const ri = "Item_background_5cb932c1",
  ii = "Item_c5163bf",
  oi = "Item_base__selected_5f6fcc69",
  li = "Item_button_8b3e738d",
  ci = "Item_selectedIcon_eb50b3a6",
  di = "Item_content_db9841ac",
  ui = "Item_title_3edba705",
  mi = "Item_actions_63add2d",
  pi = Ae({ container: "Item_alert_31c28fa6", icon: "Item_alertIcon_f872f769" }),
  _i = w(function (e) {
    const { playlist: t } = e,
      a = yr(),
      s = fe();
    return b.jsxs("div", {
      className: C(ii, a.model.currentId() === e.id && oi),
      children: [
        b.jsx("div", { className: ri }),
        b.jsxs(Pe, {
          className: li,
          onClick: () => {
          ...
          children: [
            b.jsxs("span", {
              className: di,
              children: [
                b.jsx(Ur, { value: "checked", className: ci }),
                b.jsx(Me, { text: t.title, className: ui }),
                b.jsx($r, { id: e.id, classNames: pi }),
              ],
            }),
            b.jsxs("span", {
              className: mi,
              ...
              children: [
                b.jsx(Yr, {
                  onCopy: function () {
                    const e = (function (e) {
                      if (0 === e.length) return ur("EMPTY_INPUT");
                      const t = (function (e) {
                          let t = e[0] ?? 0;
  ...
  hi = w(function (e) {
    const t = yr().model.byId(e.id);
    return "ok" === t.type && void 0 !== t.value
      ? b.jsx(_i, { playlist: t.value, id: e.id })
      : null;
  }),
  gi = w(function () {
    const e = yr(),
      t = fe();
    return b.jsxs("div", {
      className: C(ii, !e.model.currentId() && oi),
      children: [
        b.jsx("div", { className: ri }),
        b.jsx(Pe, {
          className: li,
  ...
  vi = "Content_icon_4da9c1eb",
  bi = "Content_trigger_4b0aad5c",
  xi = "Content_triggerText_2dc694b6",
  yi = w(function () {
    const e = yr().model.sortedIds();
    return b.jsxs("div", { children: [b.jsx(gi, {}), e.map((e) => b.jsx(hi, { id: e }, e))] });
  }),
  Ci = Ne("Divider", fi),
  wi = w(function (e) {
    const t = yr(),
    ...
    return b.jsxs(r, {
      ...
      children: [
        b.jsx(Wr, { className: vi, children: b.jsx(Ur, { value: s }) }),
        b.jsx("span", { className: xi, children: a.readOrEmpty("playlists.list.create") }),
      ],
    });
  }),
  Ni = function (e) {
    ...
    return b.jsxs(r, {
      ...
      children: [
        b.jsx(Wr, { className: vi, children: b.jsx(Ur, { value: s }) }),
        b.jsx("span", { className: xi, children: a.readOrEmpty("playlists.imports.trigger") }),
      ],
    });
  },
  ji = "Dropdown_popover_b5203d93",
  Ii = "Dropdown_scrollContent_7363dda3",
  ki = "Dropdown_bar_2d94e05e",
  Si = "Dropdown_area_a34c2ecf",
  Ei = "Dropdown_area__begin_af756086",
  Pi = "Dropdown_area__end_3b89247a",
  Mi = "Dropdown_list_41b8eefe",
  Ai = "Dropdown_triggers_b8372e20",
  Li = "Dropdown_currentTitle_11ba3707",
  Di = "Dropdown_trigger_f754201d",
  Ti = "Dropdown_currentTitleText_13099382",
  Bi = "Dropdown_alert_8195eae1",
  Vi = "Dropdown_alertIcon_61f05dd3",
  Ri = "Dropdown_arrow_5a21c825",
  Oi = "Dropdown_arrow__opened_ef9f7c1d",
  zi = te.resolve("strings"),
  Hi = [25, 25],
  Fi = Ae({ container: Bi, icon: Vi }),
  qi = w(function () {
    const { api: e } = Te(),
      [t, a] = Be(e, Hi),
      { opened: s } = fe();
    return (
      g.useEffect(() => {
        if (s) return Ve(() => Ve(e.recalculateContent));
      }, [s, e.recalculateContent]),
      b.jsx(Re, {
        className: C(Si, !t && Ei, !a && Pi),
            ...
            children: b.jsxs(Oe.Display, {
              ...
              children: [
                ...
                b.jsx("div", {
                  className: Mi,
                  children: b.jsxs(He, {
                    children: [b.jsx(qi, {}), b.jsx(Fe, { classNames: { base: ki } })],
                  }),
                }),
                b.jsx(Ci, {}),
                b.jsxs("div", { className: Ai, children: [b.jsx(wi, {}), b.jsx(Ni, {})] }),
              ],
            }),
          }),
        })
...
function Wi(e) {
  const t = fe();
  return b.jsx(Ur, { value: "arrow_down", className: C(Ri, t.opened && Oi, e.className) });
}
const $i = w(function (e) {
    const t = e.limit
      ? (function (e, t, a = "...") {
          return (
            ne(
    ...
    return b.jsxs("div", {
      ...
      children: [
        b.jsx(Me, { text: t, className: Ti }),
        e.id && b.jsx($r, { classNames: Fi, id: e.id, size: e.alertSize }),
      ],
    });
  }),
  Zi = w(function (e) {
    const t = wr(),
      a = t?.model.current(),
      s = be(),
      n = Ie({ header: a?.title, body: zi.readOrEmpty("playlists.trigger.explain") });
    if (!t || !1 === t.model.enabled.get()) return e.fallback;
    const r = e.asChild ? De : "div";
    return b.jsx(Oe.Trigger, {
      children: (t) =>
        b.jsx(b.Fragment, {
          children: b.jsxs(r, {
            ...t,
            ...
            children: [
              b.jsx(qe, { children: e.children }),
              a
                ? b.jsx($i, { limit: e.limit, id: a.id, title: a.title, alertSize: e.alertSize })
                : b.jsx($i, { title: zi.readOrEmpty("pages.titles.allVehicles") }),
              b.jsx(Wi, {}),
            ],
          }),
        }),
  ...
  eo = "isCommonProgression",
  to = [F.assault, F.universal, F.break, F.sniper, F.scout, F.support],
  ao = ["favorite", "premium", "elite", "canInstallAttachments", "own3DStyle", "rented"],
  so = [z.mediumTank, z.heavyTank, z["AT-SPG"]];
H(1, 12, q);
const no = "FilterPopover_popover_accae82b",
  ro = "FilterPopover_header_98e6ac8",
  io = "FilterPopover_playlistTrigger_fd8fa4b3",
  oo = "FilterPopover_playlistTitle_595e5af4",
  lo = "FilterPopover_playlistPortal_1868cfd6",
  co = "FilterPopover_currentValue_db69f42c",
  uo = "FilterPopover_body_9e82b944",
  mo = "FilterPopover_category_aa274a28",
  po = "FilterPopover_scroll_9704964d",
  _o = "FilterPopover_slash_5ea5aa2b",
  ho = "FilterPopover_toggleContainer_c7079ba8",
  go = "FilterPopover_toggleContainer__type_38a25c90",
  fo = "FilterPopover_toggle_747f4b53",
  vo = "FilterPopover_toggle__type_6486dde5",
  bo = "FilterPopover_nationWrapper_c9512daf",
  xo = "FilterPopover_nationIcon_2456921e",
  yo = "FilterPopover_toggle__activated_19a04a6d",
  Co = "FilterPopover_specialsIcons_5a3d8e7",
  wo = "FilterPopover_specialsIcons__favorite_c7792d3a",
  No = "FilterPopover_searchInputWrapper_dc7e630e",
  jo = "FilterPopover_search_19a04a6d",
  Io = "FilterPopover_inputField_a2989dce",
  ko = "FilterPopover_inputPlaceholder_5ac00a5",
  So = "FilterPopover_footer_b16000c8",
  Eo = "FilterPopover_footerButtons_69a472c1",
  Po = "FilterPopover_carouselIcon_a4555032",
  Mo = "FilterPopover_carouselIcon__active_29db43f9",
  Ao = "FilterPopover_carouselChanger_4432f804",
  Lo = v(function (e) {
    const t = Rr(),
      a = t.tooltipHeaderMap ?? Yi,
      s = t.tooltipBodyMap ?? Ji,
      n = te.resolve("strings"),
      r =
        e.tooltip.body !== Ki
          ? n.readOrEmpty(`tank_carousel_filter.tooltip.${s[e.tooltip.body]}.body`)
          : "",
      i = Ie({ header: n.readOrEmpty(`${a[e.tooltip.header]}`), body: r });
    return b.jsx(Do, { ...e, tooltip: e.tooltip.body !== Ki && i });
  }),
  Do = v(function (e) {
    const t = Rr(),
      a = t.filters.get(),
    ...
    return b.jsx(xe, {
      ...
      theme: ye.primary,
      size: Ce.extraSmall,
      className: C(fo, s && yo, e.className),
      activated: s,
      onClick: () => {
    ...
    children: to.map((e) =>
      b.jsx(
        Lo,
        {
          ...
          children: b.jsx(Ze, { roleKey: e, size: Ze.sizes.x24x24 }),
        },
        e,
      ),
    ),
...
function Bo(e) {
  return b.jsx("div", {
    className: C(ho, go, e.className),
    children: so.map((e) =>
      b.jsx(
        Lo,
        {
          tooltip: { header: e, body: Xi },
          event: { field: Bn, type: "regular", value: e },
          className: vo,
          children: b.jsx($e, { type: e, size: $e.sizes.x24x24 }),
        },
        e,
      ),
    ),
    ...
    children: e.orderedNations.map((e) =>
      b.jsx(
        Lo,
        {
          ...
          children: b.jsx("div", {
            className: bo,
            children: b.jsx(we, { className: xo, path: `flags.c_60x40.${e}` }),
          }),
        },
        e,
      ),
...
function Ro(e) {
  ...
  return b.jsx(
    Lo,
    {
      ...
      event: { field: On, type: "regular", value: e.special },
      children: b.jsx(we, { className: C(Co, "favorite" === e.special && wo), path: t }),
    },
    e.special,
  );
}
function Oo() {
  ...
  return b.jsx(Lo, {
    tooltip: { header: eo, body: eo },
    event: { field: zn, type: "regular", value: eo },
    children: b.jsx(we, { className: Co, path: e }),
  });
}
const zo = v(function (e) {
  const t = Rr(),
    a = t.specialIds ?? ao,
    s = Sr(),
  ...
  return b.jsxs("div", {
    className: C(ho, e.className),
    children: [
      c.map((e) => b.jsx(Ro, { imagePath: t.imagesMap?.[e] ?? e, special: e }, e)),
      n && b.jsx(Oo, {}),
      e.children,
    ],
  });
...
function Fo({ fieldClassName: e, value: t, ...a }) {
  const s = te.resolve("strings");
  return b.jsxs(Ge.Provider, {
    value: t,
    children: [
      b.jsx(Ho, {}),
      b.jsxs(Ge.Decoration, {
        className: C(jo, a.className),
        children: [
          b.jsx(Ge.Icon, { icon: Ge.icons.search }),
          b.jsx(Ge.Field, {
            ...a,
            className: Io,
            classNames: { placeholder: ko },
            maxLength: 50,
            placeholderVisibility: Xe.value,
            children: s.readOrEmpty("tank_carousel_filter.popover.label.searchNameVehicle"),
          }),
          t.length > 0 && b.jsx(Ge.ClearButton, {}),
        ],
      }),
    ],
  });
}
function qo({ current: e, total: t, className: a }) {
  const s = te.resolve("intl"),
    n = te.resolve("strings");
  return b.jsxs(Oe.Header, {
    className: C(ro, a),
    children: [
      b.jsx(Oe.Title, { children: b.jsx(Ue, { path: "tank_carousel_filter.popover.title" }) }),
      b.jsx(Oe.Subtitle, {
        children: b.jsx(Ue, {
          upgradeLegacy: !0,
          ...
          params: {
            count: b.jsxs("span", {
              children: [
                b.jsx("span", { className: co, children: s.formatNumber("integral", e) }),
                b.jsx("span", { className: _o, children: n.readOrEmpty("common.common.slash") }),
...
const Uo = g.memo(function (e) {
    return b.jsxs(Wo, {
      ...e,
      className: e.className ?? po,
      children: [
        b.jsx(Ue, { className: mo, path: "tank_carousel_filter.popover.label.specials" }),
        b.jsx(zo, { children: e.children }),
      ],
    });
  }),
  Wo = g.memo(function (e) {
    return b.jsx(He, {
      children: b.jsxs(We, {
        className: e.className,
        ...
        children: [
          b.jsx(Ue, { className: mo, path: "tank_carousel_filter.popover.label.vehicleTypes" }),
          b.jsx(Bo, {}),
          b.jsx(Ue, { className: mo, path: "tank_carousel_filter.popover.label.vehicleRole" }),
          b.jsx(To, {}),
          b.jsx(Ue, { className: mo, path: "tank_carousel_filter.popover.label.nations" }),
          b.jsx(Vo, { orderedNations: e.orderedNations }),
          e.children,
        ],
      }),
    });
  ...
  $o = v(function () {
    const e = Qn();
    function t(e) {
      e.key !== Qe.ESCAPE && e.stopPropagation();
    }
    return b.jsx(Fo, {
  ...
  Zo = v(function () {
    ...
    return b.jsx(qo, { current: a, total: t });
  }),
  Go = v(function ({ classNames: e }) {
    const t = te.resolve("strings"),
      a = Sr(),
            ...
            b.jsxs("div", {
              ...
              children: [
                b.jsx(Hr, {
                  ...
                  children: b.jsx(we, {
                    className: C(Po, 2 === a && Mo),
                    path: "hangar.filter.carousel_selector",
                  }),
                }),
                b.jsx("div", { ...r, className: No, children: b.jsx($o, {}) }),
              ],
            }),
          ],
        }),
  ...
  Ko = v(function ({
    ...
    return b.jsx(Vr.Provider, {
      value: o,
      children: b.jsx("div", {
        className: a?.base,
        children: b.jsxs(Oe, {
          children: [
            b.jsx(Go, { classNames: { trigger: a?.trigger, content: a?.triggerContent } }),
            b.jsx(Oe.Portal, {
              lazy: !0,
              position: t,
              pivot: e,
              children: b.jsx(ze, { children: b.jsx(Oe.Display, { className: no, children: n }) }),
            }),
          ],
        }),
      }),
  ...
  Qo = v(function (e) {
    ...
    return b.jsxs(Ko, {
      ...e,
      children: [
        b.jsx(Oe.Tip, { position: "bottom", size: "80rem", offset: "120rem" }),
        b.jsx(Oe.Close, {}),
        b.jsx(Zo, {}),
        b.jsx(Yo, {}),
        b.jsx(Xo, { children: b.jsx(Uo, { orderedNations: t }) }),
      ],
    });
  }),
  Yo = v(function () {
    ...
    return e && !1 !== e.model.enabled.get()
      ? b.jsxs(Oe, {
          children: [
            b.jsx(Ui, { className: lo, "data-popover-outside-click-whitelist-id": t }),
            b.jsx(Zi, {
              asChild: !0,
              className: io,
              fallback: null,
              limit: 15,
              children: b.jsx(ge, { theme: "secondary", classNames: { content: oo } }),
            }),
          ],
        })
      : null;
  ...
  Jo = (e) => {
    const t = e?.showDelay || 400,
      ...
      s = g.useRef(null),
      n = ke(),
      r = et({ ...e, showDelay: 0, args: a.current });
    return {
      containerRef: s,
      tooltipProps: {
        ...r,
          ...
          n.run(() => {
            if (s.current) {
              ...
              (Object.assign(a.current, e.args),
                (a.current.positionY = Math.floor(tt(t.y)) - 13),
                (a.current.positionX = Math.floor(tt(n?.x || t.x)) - 10));
            }
            r.onMouseEnter(i);
          }, t);
        },
...
function el() {
  const { screenWidthRem: e } = Ye();
  return e < Je.large.width;
}
const tl = y.createContext(void 0);
function al() {
  const e = g.useContext(tl);
...
const sl = "small",
  ...
  ul = "battlePass",
  ml = "missions",
  pl = { from: { y: 0, x: 0, opacity: 0, height: 0, width: 0 } };
function _l(e) {
  const t = new Map();
  for (let a = 0; a <= e.length; a++) {
    const s = e[a];
    t.set(s, { rowIndex: a, columnIndex: 0, size: rl });
  }
  return t;
}
function hl(e) {
...
const gl = { duration: 400, easing: hl };
const fl = 100,
  vl = { duration: 200, easing: hl };
function bl(e, t, a, s = !0) {
  ...
  return {
    from: c ? { ...n, opacity: 0 } : {},
    to: n,
    delay: c ? l + Math.max((o - i) * fl, 0) : Math.max((o - i - r) * fl, 0),
    config: gl,
  };
}
function xl(e) {
  return { to: { x: at(tt(e) + 100), opacity: 0 }, config: { duration: 300, easing: hl } };
}
function yl(e, t, a) {
  const s = e.dataset.id,
    ...
    r = t.getCardHeight(s);
  if (!n || !r) return "";
  const i = tt(n.getPropValue("opacity")),
    o = tt(n.getPropValue("height"));
  if (o < r || 0 === i) return "";
  const l = tt(n.getPropValue("width")),
    c = tt(n.getPropValue("y")),
    d = tt(n.getPropValue("x")),
    u = t.getCardSize(s) !== rl,
    m = Math.round(d),
    p = Math.round(d + l) - 1,
    _ = Math.round(c),
    h = {
...
const Cl = {
    [sl]: { gap: 0, cardHeight: 74, cardWidth: 241 },
    [nl]: { gap: 0, cardHeight: 74, cardWidth: 319 },
  },
  wl = { [rl]: 1, [il]: 0.5, [ol]: 1 / 3 };
function Nl(e, t) {
  return { ...Cl[e], ...t?.[e] };
}
class jl {
    ...
    return (
      this._sortedGroups.forEach(([s, n]) => {
        ...
        const {
          ...
          maxRowsAmount: u,
          layoutCreator: m,
        } = Nl(this._widgetConfig.size, n.adaptive);
        r > 0 && !t.has(s) && l && (r += at(l));
        const p = at(c),
          _ = o.filter((e) => this._cards.get(e)?.visible),
          h = (m || n.layoutCreator || _l)(_, this._widgetConfig.media);
        let g = 0;
        for (const t of o) {
          const s = h.get(t);
          if (!s) {
            e.animationProps.set(t, pl.from);
            continue;
          }
  ...
  getCardAnimationProps(e) {
    return this._layout.animationProps.get(e) || pl.from;
  }
  getCardRow(e) {
    return this._layout.cardToRow.get(e) || 0;
  }
  getCardSize(e) {
    return this._layout.cardSizes.get(e) || rl;
  }
  getCardHeight(e) {
    const t = this.getCard(e)?.groupId;
    if (!t) return;
    const a = this._widgetConfig.groups.get(t);
    return Nl(this._widgetConfig.size, a?.adaptive).cardHeight;
  }
  getMaxCardRow(e) {
  ...
  findMaxVisibleRowsInGroup(e) {
    ...
    for (let s = 0; s < this._sortedGroups.length; s++) {
      ...
      if (n === e) {
        const { maxRowsAmount: e } = Nl(this._widgetConfig.size, t.adaptive),
...
const Il = "Card_82475c",
  kl = "Card_borderHelper_9f37b536",
  Sl = "Card_border_a649c143",
  El = "Card_card__enabled_4c476d8b",
  Pl = {
    [ll]: function (e, t, a) {
      const s = bl(e, t, a, !1);
    ...
    [dl]: function (e, t, a) {
      const s = bl(e, t, a, !1);
      if (t.includes(e)) {
        const t = a.getCardAnimationProps(e).y + at(a.getCardHeight(e));
...
function Ml({
  ...
  const { enqueue: d, runDequeue: u } = (function () {
    ...
    p = g.useRef(r),
    _ = g.useRef(!1),
    h = g.useRef(new jl({ size: i, visibleRowsAmount: l, groups: t, media: o })),
    f = g.useRef(new Map()),
    v = st((e) => {
      const t = m.current?.querySelectorAll(`.${kl}`);
      t &&
        (function (e, t, a) {
          const s = new Set();
          a && (a.style.borderImageWidth = yl(a, t, s));
          ...
          Array.from(e)
            ...
            .forEach((e) => {
              e !== a && (e.style.borderImageWidth = yl(e, t, s));
            });
        })(t, h.current, e);
    }),
    x = st(async (e) => {
    ...
    y = st(async (e = !0) => {
      ...
      await x(({ id: s, settings: n }) => {
        ...
        return (
          ...
          { delay: e ? 0 : l * fl, to: r, immediate: e, config: gl }
        );
      });
    }),
    C = st(async (e, t = ll) => {
    ...
    w = st((e, t = !0) => !(t && !h.current.getCard(e)?.visible) && h.current.isCardDisplaying(e)),
    N = nt(),
    j = st((e, t) => {
            ...
            (o(r, (e) =>
              n.set(
                ...
                (function (e, t, a) {
                  ...
                  const n = "left" === t ? -1 : 1;
                  return { to: { x: s.x + at(50 * n), opacity: 0 }, config: vl };
                })(e, i, h.current),
              ),
            ),
              ...
              o(s, (e) =>
                n.set(
                  ...
                  (function (e, t, a) {
                    ...
                    const n = "left" === t ? -1 : 1;
                    return {
                      from: { ...s, x: s.x - at(50 * n), opacity: 0 },
                      to: { x: s.x, opacity: 1 },
                      delay: vl.duration,
                      config: vl,
                    };
      ...
      return {
        ...
        disappear: async (e) => {
          (h.current.updateCard(e, { visible: !1 }),
            await x((t) => {
              if (e === t.id) return xl(t.settings.getPropGoalValue("x"));
            }));
        },
        disappearGroups: async (e) => {
          ...
          (e.forEach((e) => {
            ...
            await x((e) => {
              ...
              if (-1 !== a)
                return { ...xl(e.settings.getPropGoalValue("x")), delay: fl * (t.length - a) };
            }));
        },
        updateBorders: v,
  ...
  return (
    ...
    b.jsx(tl.Provider, { value: k, children: b.jsx("div", { ref: m, children: e }) })
  );
}
const [Al, Ll] = V()(
    ({ observableModel: e }) => {
      const t = {
        ...
        a = O.structural(() =>
          t.plugins.values().map((e) => {
            ...
            return { url: t, dependencies: it(a) };
          }),
        ),
        s = O.primitive(() => t.selectedSlide.get());
      return {
        ...t,
        computes: {
          pathToPlugins: a,
          selectedSlide: s,
          isGroupVisible: (e) => it(t.visibleGroups.get()).includes(e),
          isSlideActive: (e) => it(t.slides.get()).some((t) => t.id === e),
        },
      };
    },
    ({ externalModel: e }) => ({
  ...
  Tl = Object.values(Dl).reduce((e, t) => ({ ...e, [t]: ot(t) }), {}),
  Bl = g.createContext(null);
function Vl() {
  const e = g.useContext(Bl);
...
function zl(e, ...t) {
  const a = (e, s) => {
    if (s === t.length) return lt(e);
    const n = t[s];
    return n in e && ((s === t.length - 1 || a(e[n], s + 1)) && delete e[n], lt(e));
  };
...
function Ul({ storage: e, id: t, emitter: a, providerCfg: s }) {
  Fl(e, t) || Wl({ id: t, emitter: a, providerCfg: s });
}
function Wl({ id: e, emitter: t, providerCfg: a }) {
  const s = a?.triggerId || e;
  (t.trigger(s, { id: e, ...a?.triggerParams }),
    a?.triggerCallback?.({ id: e, ...a?.triggerParams }));
}
function $l({ sound: e, soundCfg: t }) {
...
function Zl({ children: e }) {
  const t = nt(),
    ...
    n = g.useRef({}),
    r = ct(),
    i = st(({ id: e, animName: t, elementId: s = e }) => Fl(a, e, t, s)),
    o = st((e, t, s = e) => {
      zl(a, e, t, s);
    }),
    l = st(
    ...
    c = st(
      ({
        ...
        (l &&
          ...
          $l({ sound: r, soundCfg: o }));
      },
    ),
    d = st(({ id: e, animName: a, elementId: n = e, providerCfg: r = {} }) => {
      const i = t.on(Rl(e, a, n), () => {
        (zl(s, e, a, n), Ul({ storage: s, id: e, emitter: t, providerCfg: r }), i());
      });
      Ol(s, !0, e, a, n);
    }),
    u = st(({ complexId: e, id: a, animName: s, elementId: r = a, providerCfg: i }) => {
      const o = t.on(Rl(a, s, r), function () {
          (!(function ({
            storage: e,
            complexId: t,
            groupId: a,
            ...
            o &&
              (o.delete(n),
              o.size || zl(e, t, a, s),
              Ul({ storage: e, id: t, emitter: r, providerCfg: i }));
          })({
            storage: n,
            complexId: e,
            groupId: a,
        ...
        l = Hl(n, e, a, s);
      l ? l.add(r) : Ol(n, new Set().add(r), e, a, s);
    }),
    m = st(({ groupId: e, groupCfg: n, providerCfg: i, soundCfg: o }) => {
      (zl(s, e),
        i?.skip ||
          i?.skipTrigger ||
          ql(e, n, a, (t, a) => {
        ...
        $l({ sound: r, soundCfg: o }),
        i?.skip && !i?.skipTrigger && Wl({ id: e, emitter: t, providerCfg: i }));
    }),
    p = st(({ complexId: e, complexCfg: s, providerCfg: i, soundCfg: o }) => {
      if ((zl(n, e), !i?.skip && !i?.skipTrigger))
  ...
  return b.jsx(Bl.Provider, { value: _, children: e });
}
const Gl = "battlePass",
  Xl = "rewardPath",
  Kl = "missions",
  ...
  Yl = new Map([
    [Gl, { position: 0 }],
    [Xl, { position: 1, adaptive: { [sl]: { cardHeight: 107 }, [nl]: { cardHeight: 147 } } }],
    [Kl, { position: 2 }],
    [Ql, { position: 3, adaptive: { [sl]: { gap: 19 }, [nl]: { gap: 19 } } }],
  ]);
var Jl = ((e) => (
    (e.Intro = "intro"),
  ...
  ec = ((e) => ((e.Waiting = "waiting"), (e.Ready = "ready"), (e.Played = "played"), e))(ec || {});
const tc = g.forwardRef(function (
  {
    children: e,
    id: t,
    groupId: a,
  ...
  return (
    ...
    b.jsxs(j.div, {
      ...
      children: [
        b.jsx("div", { className: I(Sl, o?.border) }),
        e,
        b.jsx("div", { className: I(kl, o?.borderHelper), "data-id": t, ref: v }),
      ],
    })
  );
});
...
function sc({ registerAnimation: e, id: t, animName: a, elementId: s = t, config: n }) {
  g.useLayoutEffect(() => e?.({ id: t, animName: a, elementId: s, config: n }), [t, a, n, s, e]);
}
const nc = { from: { opacity: 0 }, config: { duration: 400, easing: hl } },
  rc = { from: { opacity: 0 }, to: { opacity: 1 } };
const ic = {
  ...
  oc = "widgetCardBorderFadeIn",
  lc = g.memo(function ({ id: e, elementId: t, size: a = rl, className: s }) {
    const { registerAnimation: n, emitter: r } = Vl(),
      i = st(() => r.trigger(Rl(e, oc, t), e, t)),
      { baseSpring: o, config: l } = (function (e) {
        const [t, a] = N(() => nc),
          s = st(({ immediate: t }) => {
            a.start({ ...rc, immediate: t, onRest: e });
          });
        return { baseSpring: t, config: g.useMemo(() => ({ start: s, skip: ee }), [s]) };
      })(i);
    return (
      sc({ id: e, elementId: t, registerAnimation: n, animName: oc, config: l }),
      b.jsx(j.div, {
        style: o,
        className: C(ic.base, ic[`base__${a}`], s),
        children: b.jsxs("div", {
          className: ic.helperContainer,
          children: [
            b.jsx("div", { className: C(ic.helper, ic.helper__one) }),
            b.jsx("div", { className: C(ic.helper, ic.helper__two) }),
            b.jsx("div", { className: C(ic.helper, ic.helper__three) }),
          ],
        }),
      })
    );
  }),
  cc = { to: { val: 100 }, config: { duration: 1e3, easing: hl } },
  dc = { from: { val: 100 }, to: { val: 0 } };
function uc(e) {
  return `brightness(${1 + e / 100}) contrast(${1 + (e / 100) * 0.5})`;
}
const mc = "bgContrastAnimation";
const pc = { from: { val: 0 }, config: { duration: 600, easing: hl } },
  _c = { from: { val: 0 }, to: { val: 50 } };
function hc(e) {
  return `${50 + e}% ${50 + e}%`;
}
const gc = "maskAnimation";
const fc = "maskAppearAnimationHook",
  vc = { [mc]: {}, [gc]: {}, [oc]: {} };
function bc({ id: e, elementId: t, onComplete: a }) {
  const { startGroupAnimation: s, registerAnimation: n, emitter: r } = Vl(),
    i = g.useCallback(() => r.trigger(Rl(e, mc, t), e, t), [t, r, e]),
    o = g.useCallback(() => r.trigger(Rl(e, gc, t), e, t), [t, r, e]),
    l = g.useCallback(
      async ({ immediate: s }) => {
        (await a?.(s), r.trigger(Rl(e, fc, t), e, t));
      },
      [t, r, e, a],
    ),
    { backgroundContrast: c, config: d } = (function (e) {
      const t = g.useCallback(() => e?.(), [e]),
        [a, s] = N(() => ({ ...cc, onRest: t })),
        n = g.useCallback((e) => s.start({ ...dc, immediate: e }), [s]),
        r = st(({ immediate: e }) => n(e));
      return { backgroundContrast: a, config: g.useMemo(() => ({ start: r, skip: ee }), [r]) };
    })(i),
    { maskPosition: u, config: m } = (function (e) {
      const t = g.useCallback(() => e?.(), [e]),
        [a, s] = N(() => ({ ...pc, onRest: t })),
        n = g.useCallback((e) => s.start({ ..._c, immediate: e }), [s]),
        r = st(({ immediate: e }) => n(e));
      return { maskPosition: a, config: g.useMemo(() => ({ start: r, skip: ee }), [r]) };
    })(o),
    p = st(async (t) => {
      s({
        groupId: e,
    ...
    _ = g.useMemo(() => ({ start: p, skip: ee }), [p]);
  return (
    sc({ id: e, elementId: t, registerAnimation: n, animName: fc, config: _ }),
    sc({ id: e, elementId: t, registerAnimation: n, animName: mc, config: d }),
    sc({ id: e, elementId: t, registerAnimation: n, animName: gc, config: m }),
    g.useMemo(() => ({ maskPosition: u, backgroundContrast: c }), [c, u])
  );
}
const xc = "battlePassCardId",
  yc = {
  ...
  Hc = function ({
    ...
    const i = n ? "purchased" : "basic",
      o = String(s).slice(-1),
      l = t === wc ? Nc : t === Nc ? Ic : t === jc ? Sc : t === Ic || t === kc ? Ec : Pc,
      c =
        e === Mc
          ? Lc
          : e === Ac
            ...
            : e === Lc
              ...
              : e === Dc
                ...
                : e === Tc || e === Bc
                  ...
                  : Oc,
      d =
        zc.readOrEmpty(`battlePass.emblem.shield.c_${s}.${i}.${ve(t, l)}`, "silent") ||
        zc.readOrEmpty(`battlePass.emblem.shield.default.${i}.${t}`),
      u =
        zc.readOrEmpty(`battlePass.emblem.icon.c_${s}.${i}.${ve(e, c)}`, "silent") ||
        zc.readOrEmpty(`battlePass.emblem.icon.default_${o}.${i}.${e}`);
    return b.jsxs("div", {
      className: C(yc.base, yc[`base__${a}`], r),
      children: [
        b.jsx("div", {
          className: C(yc.shield, yc[`shield__${t}`]),
          style: { backgroundImage: `url(${d})` },
        }),
        b.jsx("div", {
          className: C(yc.icon, yc[`icon__${e}`]),
          style: {
            backgroundImage: `url(${s > 0 ? u : zc.readOrEmpty(`battlePass.emblem.icon.not_chosen.${ve(e, Lc)}`)})`,
          },
        }),
      ],
    });
...
function Fc(e, t) {
  ...
  return { spring: a, config: g.useMemo(() => ({ start: n, skip: ee }), [n]) };
}
const [qc, Uc] = V()(
    ({ observableModel: e }) => {
      const t = {
        ...
        a = O.primitive(() => t.widgetState.get() === Jl.Completed);
  ...
  Wc = "Emblem_6b62c957",
  $c = "Emblem_base__paused_e22ad928",
  Zc = "Emblem_4187dd4f",
  Gc = "emblemFadeInAnimation",
  Xc = k(function ({ id: e, elementId: t, className: a }) {
    const { model: s } = Uc(),
      n = s.chapterID.get(),
      r = s.isBought.get(),
      { registerAnimation: i, emitter: o } = Vl(),
      l = st(() => o.trigger(Rl(e, Gc, t), e, t)),
      { spring: c, config: d } = Fc(0, l);
    return (
      sc({ id: e, elementId: t, registerAnimation: i, animName: Gc, config: d }),
      b.jsx("div", {
        className: C(Wc, s.isPaused.get() && $c, a),
...
function Kc(e, t) {
  const { readyForAnimations: a } = al();
  g.useEffect(() => {
    if (a.current) return e();
  }, t);
}
const Qc = te.resolve("images"),
  Yc = te.resolve("views"),
  Jc = te.resolve("strings"),
  ed = te.resolve("aliases"),
  td = te.resolve("videos"),
  ad = g.createContext(!1);
function sd(e, t, a, s, n, r) {
  const i = `${t}${a ? "_extra" : ""}${s ? "_holiday" : ""}${r ? "_small" : ""}`;
  return { seasonPath: `${e}.season_${n}.${i}`, defaultPath: `${e}.default.${i}` };
}
function nd(e, t, a, s, n) {
  const { seasonPath: r, defaultPath: i } = sd("battlePass.widget.background", e, t, a, s, n);
  return Qc.has(r) ? r : i;
}
function rd() {
...
function id(e, t) {
  return e && (t === Jl.Intro || t === Jl.Progression);
}
const od = k(function ({ useAdaptiveFormat: e = !0 }) {
    const { model: t } = Uc(),
      a = el(),
      s = a ? _t.format.compact : _t.format.default,
      n = t.timeLeft.get();
    return b.jsx(
      _t,
      { start: n, size: a ? _t.size.x16x16 : _t.size.x24x24, format: e ? s : _t.format.default },
      n,
    );
  }),
  ld = "Labels_e5066e86",
  cd = "Labels_title_d94e713e",
  dd = "Labels_subTitleWrapper_79f4007c",
  ud = "Labels_subTitleItem_b9fe06e5",
  md = "Labels_subTitle_c850cc3d",
  pd = "Labels_lockIcon_c336fd47",
  _d = "Labels_descriptionText_1d25fcad",
  hd = te.resolve("strings"),
  gd = "labelsFadeInAnimation",
  fd = k(function ({ id: e, elementId: t, className: a }) {
    const { model: s } = Uc(),
      n =
        ...
        s.computes.isCompleted()
          ...
          : i
            ...
            : r
              ...
              : "select_chapter");
    var r, i;
    const { registerAnimation: o, emitter: l } = Vl(),
      c = st(() => l.trigger(Rl(e, gd, t), e, t)),
      { spring: d, config: u } = Fc(1e3, c);
    sc({ id: e, elementId: t, registerAnimation: o, animName: gd, config: u });
    const {
      labelStyle: m,
      countdownStyle: p,
      lockStyle: _,
      ...
      const e = rd(),
        ...
        r = g.useRef(n),
        i = g.useRef(s),
        o = { duration: 400, easing: hl },
        [l, c] = N(() => ({ from: { opacity: s ? 1 : 0, x: 0 }, config: o })),
        [d, u] = N(() => ({ from: { opacity: n && !s ? 1 : 0, x: 0 }, config: o })),
        [m, p] = N(() => ({ from: { opacity: n || s ? 0 : 1, x: 0 }, config: o }));
      return (
        Kc(() => {
          ...
          const e = (e, t) => (e ? c : t ? u : p),
            ...
            a = e(s, n),
            o = [u, c, p];
          (Promise.all(t.start({ from: { opacity: 1, x: 0 }, to: { opacity: 0, x: at(40) } })).then(
            () => {
              (o.forEach((e) => {
                e.start({ from: { opacity: 0 }, immediate: !0 });
              }),
                a.start({ from: { opacity: 0, x: at(-20) }, to: { opacity: 1, x: 0 } }));
            },
          ),
            (r.current = n),
            (i.current = s));
    ...
    return s.widgetState.get() !== Jl.Progression || s.isPaused.get()
      ? b.jsxs(j.div, {
          style: d,
          className: C(ld, a),
          children: [
            b.jsx("div", {
              className: cd,
              children: hd.read("user_missions.battle_pass_widget.title"),
            }),
            b.jsxs("div", {
              className: dd,
              children: [
                b.jsxs(j.div, {
                  ...
                  className: C(ud, md),
                  children: [
                    b.jsx("div", { className: pd }),
                    hd.read("user_missions.battle_pass_widget.sub_title.unavailable"),
                  ],
                }),
                b.jsx(j.div, {
                  style: p,
                  className: ud,
                  children: b.jsx(od, { useAdaptiveFormat: !1 }),
                }),
                b.jsx(j.div, {
                  style: m,
                  className: C(ud, md),
                  children: b.jsx(ht, {
                    text: hd.read(`user_missions.battle_pass_widget.sub_title.${n}`),
                    classMix: C(_d),
...
function xd(e, t, a, s, n) {
  e.isUnmounting(xc) ||
    (t === ec.Ready
      ? e
          .enqueue(async () => {
            (a(Dl.umg_widget_event_appear), await e.appear([xc]), await bd(n));
          })
          .then(() => {
            s();
          })
      : t === ec.Played &&
        (e.updateCard(xc, { visible: !0 }), bd(n, !0), e.enqueue(async () => e.applyLayout())));
}
const yd = { duration: 700, easing: hl },
  Cd = { from: { translateX: "-160%" }, config: yd },
  wd = { from: { opacity: 0 }, config: yd },
  Nd = { from: { translateX: "-160%" }, to: { translateX: "160%" } },
  jd = { from: { opacity: 0 }, to: [{ opacity: 1 }, { opacity: 0, config: { duration: 1e3 } }] };
const Id = "HighlightAnimation_splashContainer_6f7161d2",
  kd = "HighlightAnimation_helperContainer_67199b30",
  Sd = "HighlightAnimation_a926f19b",
  Ed = "HighlightAnimation_helper_ab64de86",
  Pd = "HighlightAnimation_helper__one_bf874504",
  Md = "HighlightAnimation_helper__two_5ddebb7f",
  Ad = "HighlightAnimation_helper__three_e838fe5d",
  ...
  Dd = g.memo(function ({
    ...
    const { registerAnimation: r, emitter: i } = Vl(),
      o = st(() => i.trigger(Rl(e, Ld, t), e, t)),
      {
        highlightStyles: l,
        splashStyles: c,
        config: d,
        ...
        const [t, a] = N(() => Cd),
          [s, n] = N(() => wd),
          r = st(() => {
            (a.start({ ...Nd, reset: !0 }), n.start({ ...jd, reset: !0, onRest: e }));
          });
        return g.useMemo(
          () => ({ highlightStyles: t, splashStyles: s, config: { start: r, skip: ee } }),
          [t, s, r],
        );
      })(o);
    return (
      sc({ id: e, elementId: t, registerAnimation: r, animName: Ld, config: d }),
      b.jsxs(b.Fragment, {
        children: [
          a && b.jsx(j.div, { style: c, className: Id, children: s }),
          b.jsx("div", {
            className: C(Sd, n),
            children: b.jsxs(j.div, {
              ...
              className: kd,
              children: [
                b.jsx("div", { className: C(Ed, Pd) }),
                b.jsx("div", { className: C(Ed, Md) }),
                b.jsx("div", { className: C(Ed, Ad) }),
              ],
            }),
          }),
        ],
...
const Td = te.resolve("strings"),
  Bd = "progressionLabelsAnimation",
  Vd = k(function ({ className: e, id: t, elementId: a }) {
    const { spring: s, config: n } = (function () {
      ...
      { registerAnimation: r } = Vl();
    return (
      sc({ id: t, elementId: a, registerAnimation: r, animName: Bd, config: n }),
      b.jsxs(j.div, {
        style: s,
        className: C(ld, e),
        children: [
  ...
  Rd = { pointsEarned: 0, deltaLeft: 0, deltaWidth: 0, level: 0, immediate: !0 },
  Od = { from: { opacity: 1, x: 0 }, config: { duration: 400, easing: hl } },
  zd = { from: { opacity: 0 }, config: { duration: 200, easing: hl } },
  Hd = {
    init: { from: { opacity: 1, x: 0 }, config: { duration: 400, easing: hl } },
    paused: { from: { opacity: 1, x: 0 }, to: { opacity: 0, x: at(40) } },
    unPaused: { from: { opacity: 0, x: at(-20) }, to: { opacity: 1, x: 0 }, delay: 400 },
  },
  Fd = "progressOpacity";
const qd = "progressAnimation";
const Ud = "SelectRewardIcon_79dc47ef",
  Wd = "SelectRewardIcon_animatedIcon_7df05741",
  $d = "rewardIconAnimation",
  ...
  Kd = g.memo(function ({ id: e, className: t }) {
    const { registerAnimation: a } = Vl(),
      { play: s } = be(),
      ...
      l = st(({ isPaused: e }) => {
        e
          ? r.start(Gd)
          : (s(Dl.umg_widget_event_reward), r.start(Zd), o.start({ ...Xd, pause: !1, reset: !0 }));
      }),
      c = st(({ isPaused: e }) => {
    ...
    return (
      sc({ registerAnimation: a, id: e, animName: $d, config: d }),
      b.jsx(j.div, {
        style: { opacity: n },
        className: C(Ud, t),
        children: b.jsx(j.div, { style: i, className: Wd }),
      })
    );
  });
...
const Jd = { highlight: { id: xc, animName: Ld }, rewardIcon: { id: xc, animName: $d } };
function eu() {
  const e = bt(),
    t = al(),
    { model: a, controls: s } = Uc(),
    { play: n } = be(),
    r = a.isPaused.get(),
    i = a.level.get(),
  ...
  (!(function ({
    ...
    const { startAnimation: d, startGroupAnimation: u } = Vl();
    ut(() => {
      const m = n > 0,
        p = m && n != e.rewardsHash;
      if (t != e.level || a != e.pointsEarned) {
        const n = Yd(e, t, a, s);
        d({ id: xc, animName: qd, animCallParams: n });
      } else p && !r && d({ id: xc, animName: Ld });
      (m && d({ ...Jd.rewardIcon, providerCfg: { skip: !p }, animCallParams: { isPaused: r } }),
        d({ id: xc, animName: Fd, animCallParams: { isPaused: r }, providerCfg: { skip: !0 } }),
        d({ id: xc, animName: Bd, animCallParams: { isPaused: r }, providerCfg: { skip: !0 } }),
        xd(i, o, c, l, u));
    });
  })({
    level: i,
    ...
    (function ({
      ...
      const { startGroupAnimation: o } = Vl(),
        l = gt(t),
        c = gt(a),
        d = gt(s);
      (ac(!e, () => {
        (a === c && d === s) ||
          n.enqueue(async () => {
            (i(Dl.umg_widget_event_appear), await bd(o));
          });
      }),
        ac(!e, () => {
          t !== l && xd(n, t, i, r, o);
    ...
    (function ({
      ...
      ac(!e && r > 0 && -1 != o, () => {
        ...
        if (e && !l) {
          const e = Yd(t, a, s, n);
          i({ id: xc, animName: qd, animCallParams: e });
        } else l && i(Jd.highlight);
      });
    })({
      isFirstRender: e,
      lastSeenState: m,
    ...
    (function ({ isFirstRender: e, rewardsHash: t, isPaused: a }) {
      ...
      ac(!e, () => {
        const e = a != r,
          i = t > 0 && t != n;
        (e &&
          (s({ id: xc, animName: Fd, animCallParams: { isPaused: a } }),
          s({ id: xc, animName: Bd, animCallParams: { isPaused: a } })),
          (i || e) && s({ ...Jd.rewardIcon, animCallParams: { isPaused: a } }),
          i && !a && s(Jd.highlight),
          e && !a && s({ id: xc, animName: oc }));
      });
    })({ isFirstRender: e, rewardsHash: c, isPaused: r }));
}
const tu = k(function ({ className: e }) {
    const { model: t } = Uc();
    return t.isPaused.get() ? null : b.jsx(lc, { id: xc, className: e });
  }),
  au = "IntroOverlay_glow_5fc31c94",
  su = "IntroOverlay_hoverHelper_9cec2539",
  nu = "IntroOverlay_8d89d328",
  ru = "IntroOverlay_base__extraChapter_d35cc3d4",
  iu = "IntroOverlay_base__holiday_2f0d6d76",
  ou = "IntroOverlay_hoverHelper__withOverlay_ce4fe777",
  lu = "IntroOverlay_borderNoise_3087bf34",
  cu = k(function ({ className: e, withOverlay: t = !0 }) {
    const { model: a } = Uc();
    if (a.isPaused.get()) return null;
    const s =
        a.widgetState.get() === Jl.Intro
          ? a.hasExtraChapter.get()
          : a.isExtraChapter.get() || a.isExtraChapterHighlighted.get(),
      n = a.isHoliday.get();
    return b.jsxs("div", {
      className: C(nu, s && ru, n && iu, e),
      children: [
        b.jsx("div", { className: au }),
        b.jsx("div", { className: C(su, t && ou) }),
        b.jsx("div", { className: lu }),
      ],
    });
  }),
  du = k(function ({ id: e, elementId: t, className: a }) {
    const { model: s } = Uc(),
      { startAnimation: n } = Vl(),
      r = rd(),
      i = s.isExtraChapterHighlighted.get(),
      o = s.widgetState.get(),
      l = !i && o === Jl.Progression;
    return (
      Kc(() => {
        if (id(r, o)) {
          const t = o === Jl.Intro ? Dl.umg_widget_event_timer : Dl.umg_widget_event_timer_simple;
          n({ id: e, animName: Ld, soundCfg: t });
        }
      }, [r, o]),
      b.jsx(Dd, {
        id: e,
        ...
        children:
          ...
          b.jsxs(b.Fragment, {
            children: [
              b.jsx(cu, { id: e, className: a, withOverlay: !1 }),
              b.jsx(tu, { id: e, className: a }),
            ],
          }),
      })
    );
  }),
  uu = "CompletedOverlay_b04581f5";
const mu = "Intro_backgroundWrapper_8eb03c0d",
  pu = "Intro_background_e3bffd74",
  _u = "Intro_eda21734",
  hu = "Intro_base__paused_129a2cdc",
  gu = "Intro_backgroundSize_6e0dec55",
  fu = "Intro_icon_946c0059",
  vu = k(function ({ id: e, elementId: t, className: a }) {
    const { model: s } = Uc(),
      n = s.isPaused.get(),
      r = s.isHoliday.get(),
      { imagePath: i, videoPath: o } = (function (e = "bg") {
        ...
        return {
          imagePath: nd(e, t.hasExtraChapter.get(), t.isHoliday.get(), t.season.get(), a),
          videoPath: td.read(s),
        };
      })(),
      [l, c] = N(() => ({ from: { opacity: 0 }, config: { duration: 400, easing: hl } })),
      d = g.useCallback(
        async (e) => {
      ...
      { maskPosition: u, backgroundContrast: m } = bc({ id: e, elementId: t, onComplete: d });
    return b.jsxs(j.div, {
      style: { maskPosition: u.val.to((e) => hc(-e)), filter: m.val.to(uc) },
      className: C(_u, n && hu, a),
      children: [
        b.jsx(j.div, {
          style: { maskPosition: u.val.to(hc) },
          className: mu,
          children: o
            ? b.jsx("div", {
                className: gu,
                children: b.jsx(xt, { src: o, className: pu, autoplay: !0, loop: !0 }, o),
              })
            : b.jsx(we, { path: i, className: pu }),
        }),
        !r &&
          b.jsx(j.div, {
            style: l,
  ...
  bu = "Index_f505a04a",
  xu = g.memo(function (e) {
    return b.jsx(yt, { ...e, classNames: { background: bu } });
  }),
  yu = { from: { opacity: 1, x: 0 }, config: { duration: 400, easing: hl } },
  Cu = { from: { opacity: 0, x: at(-20) }, to: { opacity: 1, x: 0 } };
const wu = "Progression_de15ce34",
  Nu = "Progression_label_67b446d",
  ju = "Progression_levelWrapper_20ffa2cd",
  Iu = "Progression_countdownWrapper_32ed00dc",
  ku = "Progression_countdownSeparator_8d7ba9e7",
  Su = "Progression_progress_f05295ff",
  Eu = "Progression_pointsEarned_f0502458",
  Pu = "Progression_progressSeparator_9c752d50",
  Mu = "Progression_progressBar_9c5d3f74",
  Au = "Progression_levelPoints_f1c3b9c0",
  Lu = "Progression_delta_2b36b7f6",
  Du = "Progression_glow_bdccbc96",
  Tu = k(function ({ id: e, elementId: t, className: a }) {
    const { model: s } = Uc(),
      n = rd(),
      r = s.levelPoints.get(),
      ...
      { baseSpring: c } = (function ({ id: e, elementId: t }) {
        const { registerAnimation: a } = Vl(),
          [s, n] = N(() => Hd.init),
          r = st((e) => {
            e.isPaused ? n.start({ ...Hd.paused }) : n.start({ ...Hd.unPaused });
          }),
          i = st((e) => {
            e.isPaused
              ? n.start({ ...Hd.paused, immediate: !0 })
              : n.start({ ...Hd.unPaused, delay: 0, immediate: !0 });
          }),
          o = g.useMemo(() => ({ start: r, skip: i }), [i, r]);
        return (
          sc({ id: e, elementId: t, registerAnimation: a, animName: Fd, config: o }),
      ...
      })({ id: e, elementId: t }),
      {
        ...
        const { startAnimation: r, registerAnimation: i } = Vl(),
          [o, l] = g.useState(a),
          [c, d] = N(() => ({ ...Od })),
          [u, m] = N(() => ({ ...zd })),
          [p, _] = N(() => ({
            from: { pointsEarned: a, level: s, deltaLeft: ft(a, n), deltaWidth: 0 },
          })),
          h = st((e) => {
              ...
              _.start({
                to: async (e) => {
                  (await e({ deltaWidth: 0, deltaLeft: t.deltaLeft, immediate: !0 }),
                    ...
                    l(t.pointsEarned),
                    a &&
                      (await e({ ...Rd, level: t.level }),
                      l(0),
                      await Promise.all(
                        d.start({
                          to: async (t) => {
                            (await t({ x: at(40), opacity: 0 }),
                              await t({ x: at(-20), opacity: 0, immediate: !0 }),
                              r({ id: xc, animName: Ld }),
          ...
          f = g.useMemo(() => ({ start: h, skip: ee }), [h]);
        return (
          sc({ id: e, elementId: t, registerAnimation: i, animName: qd, config: f }),
          g.useMemo(
            () => ({
          ...
          children: [
            ...
            b.jsx(Ue, {
              ...
              params: {
                ...
                levelPoints: b.jsx("div", { className: Au, children: r }),
        ...
        r > 0 &&
          b.jsx(xu, {
            ...
            children: b.jsx(j.div, {
              ...
              className: Lu,
              children: b.jsx(j.div, { style: m, className: Du }),
            }),
          }),
      ],
    });
  }),
  Bu = "ProgressionOverlay_3554586a",
  Vu = "ProgressionOverlay_wrapper_db2f9b96",
  Ru = "ProgressionOverlay_base__paused_ecd0a7ba",
  Ou = "ProgressionOverlay_hoverHelper_9949a6b8",
  zu = k(function ({ className: e, id: t }) {
    const { model: a } = Uc(),
      s = a.isExtraChapterHighlighted.get(),
      n = S(s ? 1 : 0, { config: { duration: 400, easing: hl } });
    return (
      Kc(() => {
        n.start(s ? 1 : 0);
      }, [s, n]),
      b.jsxs("div", {
        className: I(Bu, a.isPaused.get() && Ru),
        children: [
          b.jsxs(j.div, {
            style: { opacity: n },
            className: Vu,
            children: [
              b.jsx(cu, { id: t, className: e, withOverlay: !1 }),
              b.jsx(tu, { id: t, className: e }),
            ],
          }),
          b.jsx(j.div, { style: { opacity: n.to((e) => 1 - e) }, className: I(e, Ou) }),
        ],
      })
    );
  }),
  Hu = "BattlePass_layer_1bbff8f0",
  Fu = "BattlePass_96294458",
  qu = "BattlePass_base__enabled_8ccab86c",
  Uu = "BattlePass_rewardIcon_25776ae1",
  Wu = new Map([
    [Jl.Intro, [vu, cu, fd, tu]],
    [Jl.Progression, [Tu, zu, Vd, Xc]],
    [
      Jl.Completed,
      [
        fd,
        function ({ className: e }) {
          return b.jsx("div", { className: I(uu, e) });
        },
        Xc,
      ],
    ],
  ...
  $u = k(function () {
    ...
    const { play: a } = be(),
      ...
      l = e.rewardsHash.get(),
      c = (function (e, t) {
        const a = ed.read((e) => e.user_missions.hangarWidget.BattlePass("resId"));
        return t
          ? {
              resId: a,
              contentId: Yc.read((e) =>
      ...
      { containerRef: d, tooltipProps: u } = Jo(c),
      m = n - 259200,
      [p, _] = g.useState(n > 0 && m <= 0),
      h = () => {
        o.current && ((o.current = !1), a(Dl.umg_widget_event_hover_loop_stop));
      };
    (g.useEffect(() => {
      if (m > 0) {
        _(!1);
      ...
      g.useEffect(() => {
        r && !i && a(Dl.umg_widget_event_inactive);
      }),
      mt(() => {
        (h(), t.widgetUnmounted());
      }));
    ...
    return b.jsxs(tc, {
      ...
      onMouseEnter: (e) => {
        (u.onMouseEnter(e),
          r ||
            (a("mouse-enter"),
            s === Jl.Intro && ((o.current = !0), a(Dl.umg_widget_event_hover_loop))));
      },
      onMouseLeave: () => {
        (u.onMouseLeave(), h());
      },
      ...
      children: [
        b.jsxs(ad.Provider, {
          value: p,
          children: [
            f && f.map((e, t) => b.jsx(e, { id: xc, className: Hu }, `${s}-${t}`)),
            b.jsx(du, { id: xc, className: Hu }),
          ],
        }),
        l > 0 && b.jsx(Kd, { id: xc, className: Uu }),
      ],
    });
  }),
  Zu = {
    rootId: te.resolve("aliases").read((e) => e.user_missions.hangarWidget.BattlePass("resId")),
  },
  Gu = g.memo(function () {
    return b.jsx(qc, { options: Zu, children: b.jsx($u, {}) });
  }),
  [Xu, Ku] = V()(
  ...
  rm = g.memo(function ({
    ...
    return b.jsxs("div", {
      className: C(am.base, n),
      children: [
        b.jsx("div", {
          className: C(am.current, am[`current__${s}`], r?.current),
          children: a ?? nm.formatNumber("integral", e),
        }),
        b.jsx("div", { className: C(am.slash, am[`slash__${s}`], r?.slash), children: "/" }),
        b.jsx("div", {
          className: C(am.total, am[`total__${s}`], r?.total),
          children: nm.formatNumber("integral", t),
        }),
      ],
    });
  }),
  im = te.resolve("strings"),
  om = te.resolve("images"),
  lm = "SpecConditionsIcons_ab3f13c7",
  cm = "SpecConditionsIcons_icon_d767e7b4";
function dm({ specConditions: e, className: t, ...a }) {
  return b.jsx("div", {
    ...a,
    className: C(lm, t),
    children: _e(e, (e) =>
      b.jsx(we, { width: 24, height: 24, path: e.iconPath, className: cm }, e.id),
    ),
  });
}
const um = { from: { y: 0, opacity: 1 }, config: { duration: 200, easing: hl } },
  mm = { from: { opacity: 0 }, config: { duration: 200, easing: hl } },
  pm = { to: { scale: 1, opacity: 1 }, config: { duration: 300, easing: hl } },
  _m = { to: { scale: 0, opacity: 0 }, config: { duration: 300, easing: hl } },
  hm = { opacity: 1, y: 0 };
const gm = (e) =>
    e >= 1e4
      ? "aboveTenThousand"
  ...
  vm = te.resolve("aliases"),
  bm = te.resolve("views"),
  xm = te.resolve("intl"),
  ym = te.resolve("images"),
  Cm = te.resolve("strings"),
  wm = vm.read((e) => e.user_missions.hangarWidget.Quests("resId")),
  Nm = bm.read((e) => e.mono.user_missions.tooltips.daily_quest_tooltip("resId")),
  jm = bm.read((e) => e.mono.user_missions.tooltips.weekly_quest_tooltip("resId")),
  Im = jt.Small,
  km = g.forwardRef(function (
    {
      id: e,
      animationId: t,
      totalProgress: a,
    ...
    const v = el(),
      ...
      w = Nt(
        ...
        (e) => void 0 !== im.read(e.textPath) && om.has(e.iconPath),
      );
    const I = d === Ju,
      k = ve(
      ...
      { containerRef: P, tooltipProps: M } = Jo(
        h ?? { args: { questID: e }, resId: wm, contentId: d === em ? jm : Nm },
      ),
      A = (() => {
        switch (d) {
          case Yu:
      ...
      L =
        d === em
          ? ((e, t) => {
              const a = im.readOrEmpty(`weekly_quests.condition.common.c_${e}`),
                s = im.readOrEmpty("weekly_quests.specialCondition.container"),
                n = im.readOrEmpty("weekly_quests.specialCondition.separator"),
                r = t.map((e) => im.readOrEmpty(e.textPath)).join(n);
        ...
        return (
          ...
          t &&
            s.push({
              size: Im,
              name: "more",
              image: `${ym.readOrEmpty(`quests.bonuses.${Im}.default`)}`,
              value: Pt(Cm.readOrEmpty("tooltips.quests.awards.additional.bottom"), {
                count: e.length - a,
              }),
            }),
          s
      ...
      })(u),
      {
        ...
        const r = t - a,
          ...
          [u, m] = N(() => ({
            ...
            config: { duration: 1e3, easing: hl },
          })),
          [p, _] = N(() => mm),
          [h, f] = N(() => pm),
          [v, b] = N(() => _m),
          [x, y] = E(s, () => ({
            to: { y: at(-15), opacity: 0 },
            config: { duration: 300, easing: hl },
          })),
          C = st(async (t) => {
            if (e > 0) {
              (_.start({ opacity: 1 }), l(Dl.umg_widget_quest_progress));
              const a = t < i,
                s = ft(a ? t : i, e);
              (await Promise.all(
                m.start({
                  from: { currentProgress: i, deltaLeft: s, deltaWidth: a ? ft(i - t, e) : 0 },
                  to: { currentProgress: t, deltaWidth: a ? 0 : ft(t, e) - s, deltaLeft: s },
          ...
          j = st(async (t, a) => {
            (C(e),
              t && (await vt(1e3)),
              await Promise.all(f.start(_m.to)),
              l(a ? Dl.umg_widget_quest_complete_secondary : Dl.umg_widget_quest_complete),
              await Promise.all(b.start(pm.to)),
              await Promise.all(d.start({ opacity: 0, y: at(15) })),
              l(a ? Dl.umg_widget_quest_reward_secondary : Dl.umg_widget_quest_reward),
              await Promise.all(y.start((e) => ({ ...hm, delay: 200 * e }))));
          });
        return (
          g.useImperativeHandle(n, () => ({ playProgressAnimation: w, playCompletedAnimation: j })),
          {
            contentStyle: c,
            progressStyle: u,
            deltaGlowStyle: p,
    ...
    return b.jsxs(tc, {
      ...
      ref: P,
      className: C(fm.base, r && fm.base__completed, fm[`base__${gm(a)}`]),
      onClick: _,
      children: [
        b.jsx(j.div, { style: { opacity: V.opacity }, className: fm.completeBg }),
        b.jsxs(j.div, {
          style: T,
          className: fm.contentWrapper,
          children: [
            b.jsx(j.div, { style: { opacity: V.opacity }, className: fm.completeBg }),
            b.jsx("div", { className: fm.hoverBg }),
            b.jsxs("div", {
              ...
              children: [
                b.jsx(j.div, {
                  style: B,
                  className: fm.icon,
                  children: b.jsx(we, { path: A, width: tm, height: tm }),
                }),
                b.jsx(j.div, {
                  style: V,
                  className: fm.icon,
            ...
            b.jsxs("div", {
              ...
              children: [
                b.jsxs(
                  "div",
                  {
                    className: C(fm.description, fm.description__noProgress),
                    children: [
                      b.jsx(ht, {
                        text: L,
                        classMix: C(fm.descriptionText, fm.condition, I && fm.condition__bonus),
                        isTruncationAvailable: !0,
                      }),
                      y &&
                        b.jsx(rm, {
                          ...
                          children: b.jsx(j.div, {
                            children: O.currentProgress.to((e) =>
                              xm.formatNumber("integral", Math.ceil(e)),
                            ),
                          }),
                        }),
                    ],
                ...
                y &&
                  b.jsx(xu, {
                    ...
                    children: b.jsx(j.div, {
                      ...
                      className: fm.delta,
                      children: b.jsx(j.div, { style: z, className: fm.glow }),
                    }),
                  }),
              ],
            }),
            d === em && b.jsx(dm, { specConditions: w, className: fm.specialConditions }),
            m > 0 &&
              b.jsx("div", {
                className: fm.countdown,
                children: b.jsx(
                  _t,
                  { start: m, format: v ? St.superCompact : St.default, size: kt.x24x24 },
                  m,
                ),
              }),
          ],
        ...
        b.jsx("div", {
          ...
          children: D.map((e, t) =>
            b.jsx(j.div, { style: R?.[t], children: b.jsx(Et, { ...e }) }, t),
          ),
        }),
      ],
    });
  ...
  Sm = "quest",
  Em = "dailyQuestsCompleted",
  Pm = { scale: 0, opacity: 0 },
  Mm = { duration: 500, easing: hl },
  Am = { from: Pm, to: { opacity: 1, scale: 1 } };
function Lm() {
  return { x: at(-20), opacity: 0 };
}
const Dm = g.forwardRef(function (
  ...
  const o = el(),
    ...
    { iconStyle: c, contentStyle: d } = (function (e, t, a) {
      const s = al().isVisible(e),
        [n, r] = N(() => ({ from: Pm, config: Mm })),
        [i, o] = N(() => ({ from: Lm(), config: Mm })),
        l = st((e = !1) => {
          (r.start({ ...Am, immediate: e }),
            o.start({ from: Lm(), to: { x: 0, opacity: 1 }, immediate: e }));
        }),
        c = st(() => {
          (r.start({ to: Pm, immediate: !0 }), o.start({ to: Lm(), immediate: !0 }));
        });
      return (
    ...
    { containerRef: u, tooltipProps: m } = Jo({
  ...
  return b.jsxs(tc, {
    ...
    children: [
      b.jsx(j.div, { style: { opacity: c.opacity }, className: fm.completeBg }),
      b.jsxs("div", {
        className: fm.contentWrapper,
        children: [
          b.jsx("div", {
          ...
          b.jsx(j.div, {
            ...
            className: fm.content,
            children: b.jsx("div", {
              className: C(fm.description, fm.description__allDailyDone),
              children: b.jsx(Ue, {
          ...
          !s &&
            b.jsx(j.div, {
              ...
              children: b.jsx(
                ...
                {
                  start: n,
                  format: o ? _t.format.superCompact : _t.format.default,
                  size: _t.size.x24x24,
                },
                n,
              ),
...
const Tm = {
    ...
    const { model: e, controls: t } = Ku(),
      ...
      { completedCardRef: n, cardRef: r } = (function () {
        const e = al(),
          ...
          b = st(async () => {
            (await e.disappear(Em), await e.appear([Sm], dl), a.current?.resetAnimations());
          }),
          x = st(async () => {
            (await e.disappear(r ? Em : Sm), await e.applyLayout(!1));
          }),
          y = st(async () => {
            await e.appear([r ? Em : Sm], dl);
          }),
          C = st(async () => {
            (e.updateCard(Sm, { visible: !r }), await e.applyLayout());
          }),
          w = (t) => {
        ...
        return (
          ac(u, () => {
            i ||
              (r && !o ? e.updateCard(Em, { visible: !0 }) : e.updateCard(Sm, { visible: !0 }),
              w(async () => {
                r && o ? await f() : l > 0 && (await v());
              }));
          }),
          ac(!u, () => {
            (i !== m && w(i ? x : y), r !== p && w(r ? f : b), _ !== c && w(v), h !== d && w(C));
          }),
          ...
          children: [
            b.jsx(
              km,
              {
                ...
                icon: _,
                animateCompletion: f,
                bonuses: _e(s, (e, t) => ({ index: t, probability: 0, ...e })),
                currentProgress: m,
                totalProgress: p,
                tooltipParams: {
                  resId: R.aliases.last_stand.shared.Quests("resId"),
  ...
  Vm = { rootId: R.aliases.last_stand.shared.Quests("resId") };
function Rm() {
  return b.jsx(Xu, { options: Vm, children: b.jsx(Bm, {}) });
}
const [Om, zm] = V()(
    ({ observableModel: e }) => ({ root: e.object() }),
    ({ externalModel: e }) => ({ click: e.createCallbackNoArgs("onClick") }),
  ),
  Hm = "RewardPathCard_7eef0090",
  Fm = "RewardPathCard_bg_9821a919",
  qm = "RewardPathCard_base__small_7eef0090",
  Um = "RewardPathCard_timer_94e2e2c9",
  Wm = "RewardPathCard_emblem_7a89e4d2",
  $m = "RewardPathCard_emblem__completed_e576acda",
  Zm = "RewardPathCard_emblemProgress_a19969b5",
  Gm = "RewardPathCard_progress_d0091339",
  Xm = "RewardPathCard_progressValue_ee07807f",
  Km = "RewardPathCard_currentProgress_def0d0e",
  Qm = Tt,
  Ym = v(function () {
    ...
    const { containerRef: u, tooltipProps: m } = Jo({
    ...
    return b.jsxs(tc, {
      ...
      children: [
        ...
        b.jsx("div", {
          className: C(Wm, n && $m),
          children: b.jsx("div", { className: Zm, children: a }),
        }),
        b.jsxs("div", {
          className: Gm,
          children: [
            b.jsx(Ue, {
              ...
              params: {
                value: b.jsx("div", { className: Km, children: r }),
                maxValue: s,
                storyPoint: b.jsx(xn, { size: xn.sizes.s16x16 }),
              },
            }),
            b.jsx(Dt, {
              size: Dt.sizes.medium,
              value: 0 === s ? 1 : r,
              maxValue: Math.max(s, 1),
              status: Dt.statuses.doneInactive,
              children: b.jsx(Dt.Fill, {}),
            }),
          ],
        }),
      ],
  ...
  Jm = { rootId: R.aliases.last_stand.shared.RewardPath("resId") };
function ep() {
  return b.jsx(Om, { options: Jm, children: b.jsx(Ym, {}) });
}
const [tp, ap] = V()(ee, ({ externalModel: e }) => ({ click: e.createCallbackNoArgs("onClick") })),
  sp = "ShopCard_3a4dd01f",
  np = "ShopCard_bg_7b45baea",
  rp = "ShopCard_text_3bedaa3d",
  ip = "ShopCard_base__small_3a4dd01f";
function op() {
  const e = el(),
    { play: t } = be(),
    a = ap(),
    { containerRef: s, tooltipProps: n } = Jo({
  ...
  return b.jsx(tc, {
    ...
    children: b.jsx("div", {
      ...
      children: b.jsx(ht, {
        ...
        isTruncationAvailable: !0,
        alignContent: Bt.Center,
      }),
    }),
  });
}
const lp = { rootId: R.aliases.last_stand.shared.Shop("resId") };
function cp() {
  return b.jsx(tp, { options: lp, children: b.jsx(op, {}) });
}
const dp = "HangarWidget_3b2c10a",
  up = v(function ({ className: e }) {
    const { model: t } = Ll(),
      a = (function (e) {
        const t = al(),
          a = g.useRef([]),
        ...
        return (
          g.useEffect(() => {
            Y.shallow(n, e) || a.current.push(e);
          }),
          g.useEffect(() => {
            if (s.current) return;
      ...
      })({ [Gl]: t.computes.isGroupVisible(Gl) });
    return b.jsxs("div", {
      className: C(dp, e),
      children: [
        a.battlePass && b.jsx(Vt, { children: b.jsx(Gu, {}) }),
        b.jsx(ep, {}),
        b.jsx(Rm, {}),
        b.jsx(cp, {}),
      ],
  ...
  mp = { rootId: te.resolve("aliases").read((e) => e.last_stand.shared.Gsw("resId")) };
  ...
  return b.jsx(Rt, {
    ...
    children: b.jsx(Ot, {
      children: b.jsx(Zl, {
        children: b.jsx(Ml, {
          groups: Yl,
          children: b.jsx(Al, { options: mp, children: b.jsx(up, { className: e }) }),
        }),
      }),
    }),
  });
}
const _p = "AllVehiclesButton_3837d663",
  hp = "AllVehiclesButton_grid_64f1c816",
  gp = "AllVehiclesButton_content_75d29fb4";
function fp(e) {
  const t = be(),
    a = te.resolve("strings"),
    s = Ee(),
  ...
  return b.jsxs(ge, {
    ...
    children: [
      ...
      b.jsx(zt, {
        ...
        silent: !0,
        classNames: { content: gp },
        children: b.jsx(zt.Code, {}),
      }),
    ],
  });
}
const [vp, bp] = V()(
  ...
  Cp = "/hangar/allVehicles",
  wp = "/hangar/editVehiclePlaylists",
  [Np, jp, Ip] = V("SettingsProvider")(
    (e) => {
      const t = e.observableModel.primitives(["crewEnabled", "ttcEnabled"], "allVehicles"),
        a = O.primitive(() => Boolean(e.initial.selectedVehicle()));
      return {
        ...t,
        computed: {
          crewEnabled: O.primitive(() => a() && t.crewEnabled.get()),
          ttcEnabled: O.primitive(() => a() && t.ttcEnabled.get()),
          noSelectedVehicle: a,
        },
      };
    },
...
function kp() {
  return g.useContext(Ip.Context);
}
const Sp = Ft(s({ key: c(), name: c() })),
  Ep = Ft(d(s({ value: i([m(), c()]), state: c() }))),
  Pp = "boost",
  Mp = "reduce",
  Ap = "none";
function Lp(e, t, a) {
...
function Bp(e) {
  return _e(e, ({ value: e, name: t, tooltipID: a, ...s }) => ({
    ...s,
    tooltipId: a,
    values: Ep(e),
    kpiBonusParams: t ? Sp(t) : { key: "", name: "" },
  }));
}
function Vp(e, t) {
...
const Xp = {
  ...
  Kp = te.resolve("strings"),
  Qp = te.resolve("images"),
  Yp = te.resolve("aliases"),
  Jp = te.resolve("intl");
function e_({
  id: e,
  values: t,
  ...
  const o = y.useMemo(() => ({ tooltipId: r, paramId: e }), [r, e]),
    l = qt({
      resId: 0 !== a ? a : Yp.read((e) => e.hangar.shared.VehicleParams("resId")),
      args: o,
    });
  return b.jsxs("div", {
    className: C(Xp.base, s && Xp.base__moduleInstalled, i),
    ...l,
    children: [
      b.jsx("div", {
        className: Xp.valueContainer,
          ...
          b.jsxs(
            y.Fragment,
            {
              children: [
                a > 0 &&
                  b.jsx("div", {
                    className: Xp.separator,
                    children: Kp.readOrEmpty("common.common.slash"),
                  }),
                b.jsx("div", {
                  className: C(Xp.value, Xp[`value__${t}`]),
                  children: Jp.formatReal("woZeroDigits", e),
                }),
              ],
            },
            `${e}-${t}-${a}`,
      ...
      b.jsx("div", {
        className: Xp.icon,
        style: { backgroundImage: `url(${Qp.readOrEmpty(`vehParams.small.${e}`)})` },
      }),
      b.jsx("div", { className: Xp.description, children: Vp(e, n) }),
    ],
  });
}
const t_ = "DetailsContainer_b85372ff",
  a_ = "DetailsContainer_params_9bf7e9a4",
  s_ = "DetailsContainer_separator_f28e38c",
  n_ = "DetailsContainer_detail_141e9abe";
function r_(e, t) {
  return t !== Gp.None && Ut(e, (e) => e.state === Gp.None);
}
function i_({ params: e, rootId: t, extraParams: a, highlightType: s, className: n }) {
  return b.jsx("div", {
    className: C(t_, n),
    children: b.jsxs("div", {
      className: a_,
      children: [
        _e(e, (e) =>
          g.createElement(e_, {
            ...
            key: e.id,
            className: n_,
            moduleInstalled: r_(e.values, s),
          }),
        ),
        a.length > 0 && b.jsx("div", { className: s_ }),
        _e(a, (e) =>
          g.createElement(e_, {
            ...e,
            rootId: t,
...
function o_(e, t) {
  const a = Wt(e, (e) => e.currentPercent > 0) ?? 0,
    s = Wt(t, (e) => e.currentPercent > 0) ?? 0,
    n = Wt(e, (e) => e.modifiedPercent > 0) ?? 0,
    r = Wt(t, (e) => e.modifiedPercent > 0) ?? a;
  return e.map((t, i) => {
    ...
    return {
      currentIndicator: u_({ percent: o, delay: c }),
      boostIndicator: u_({ percent: l, delay: c }),
      reduceIndicator: u_({ delay: c }),
    };
  });
}
function l_(e, t) {
  const a = Wt(e, (e) => e.currentPercent > 0) ?? 0,
    s = Wt(t, (e) => e.currentPercent > 0) ?? 0,
    n = Wt(t, (e) => e.modifiedPercent > 0),
    r = $t(t, (e) => e.modifiedPercent > 0) ?? 0;
  return e.map((e, t) => {
    ...
    return {
      currentIndicator: u_({ percent: i, delay: o }),
      boostIndicator: u_({ delay: l }),
      reduceIndicator: u_({ delay: l }),
    };
  });
}
function c_(e, t) {
  if (0 === t.length)
    return e.map((e, t) => ({
      currentIndicator: u_({ percent: e?.currentPercent, delay: t * d_ }),
      boostIndicator: u_(),
      reduceIndicator: u_({ percent: e?.modifiedPercent, delay: t * d_ }),
    }));
  const a = $t(e, (e) => e.modifiedPercent > 0) ?? 0,
    s = (() => {
      const a = Wt(t, (e) => e.currentPercent > 0) ?? 0,
        s = Wt(t, (e) => e.modifiedPercent > 0) ?? a;
      return s > (Wt(e, (e) => e.modifiedPercent > 0) ?? 0)
        ? s
        : ($t(t, (e) => e.modifiedPercent > 0) ?? a);
    })();
  return e.map((t, n) => {
    const r = e[n]?.currentPercent ?? 0,
      i = e[n]?.modifiedPercent ?? 0,
      o = (function (e, t, a) {
        return t > a ? (e > a ? (e - a) * d_ : 0) : t < a && e < a ? (a - e) * d_ : 0;
      })(n, a, s);
    return {
      currentIndicator: u_({ percent: r, delay: o }),
      boostIndicator: u_({ delay: o }),
      reduceIndicator: u_({ percent: i, delay: o }),
    };
  });
}
const d_ = 100,
  u_ = (e = {}) => ({ percent: e.percent ?? 0, delay: e.delay ?? 0 });
const m_ = "Indicator_be35e8ce",
  p_ = "Indicator_baseIndicator_804d6503",
  __ = "Indicator_filledIndicatorsContainer_87d2b117",
  h_ = "Indicator_currentIndicator_6d6696af",
  g_ = "Indicator_boostIndicator_1f6d9ad3",
  f_ = "Indicator_reduceIndicator_e33f4fcd",
  v_ = "Indicator_layersContainer_1a6c98e2",
  b_ = "Indicator_currentIndicatorLayer_c81bba7d",
  x_ = "Indicator_reduceIndicatorLayer_d5b54d90",
  y_ = "Indicator_boostIndicatorLayer_d7d74a2f",
  C_ = (e, t) => d_ * ((t - e) / 100);
function w_({ className: e, currentIndicator: t, reduceIndicator: a, boostIndicator: s }) {
  const n = gt({
    ...
    o = P({
      ...
      to: { width: `${a.percent}%` },
      delay: r ? a.delay + Math.abs(C_(n.boostIndicator, s.percent)) : a.delay,
      config: {
        duration: n.boostIndicator === s.percent ? d_ : Math.abs(C_(n.reduceIndicator, a.percent)),
      },
    }),
    l = P({
      from: { width: `${n.boostIndicator}%` },
      to: { width: `${s.percent}%` },
      delay: i ? s.delay + Math.abs(C_(n.reduceIndicator, a.percent)) : s.delay,
      config: {
        duration: n.reduceIndicator === a.percent ? d_ : Math.abs(C_(n.boostIndicator, s.percent)),
      },
    }),
    c = P({
      from: { width: `${n.currentIndicator}%` },
      to: { width: `${t.percent}%` },
      delay: r ? t.delay + Math.abs(C_(n.boostIndicator, s.percent)) : t.delay,
      config: {
        duration: n.boostIndicator === s.percent ? d_ : Math.abs(C_(n.currentIndicator, t.percent)),
      },
    });
  return b.jsxs("div", {
    className: C(m_, e),
    children: [
      b.jsx("div", { className: p_ }),
      b.jsxs("div", {
        className: __,
        children: [
          b.jsx(M.div, { className: h_, style: c }),
          b.jsx(M.div, { className: f_, style: o }),
          b.jsx(M.div, { className: g_, style: l }),
        ],
      }),
      b.jsxs("div", {
        className: v_,
        children: [
          b.jsx(M.div, { className: b_, style: c }),
          b.jsx(M.div, { className: x_, style: o }),
          b.jsx(M.div, { className: y_, style: l }),
        ],
      }),
    ],
  });
}
const N_ = "IndicatorContainer_f7506048",
  j_ = "IndicatorContainer_indicator_b72c4e50";
function I_({ indicatorList: e, status: t }) {
  const a = (function (e, t, a) {
    return a === Pp ? o_(t, e) : a === Mp ? c_(t, e) : l_(t, e);
  })(gt(e) ?? [], e, t);
  return b.jsx("div", {
    className: N_,
    children: a.map((e, t) =>
...
const k_ = "ParamsType_d8788f0e",
  S_ = "ParamsType_icon_5f8d4ad",
  E_ = "ParamsType_type_cdb8f019",
  P_ = "relativeArmor",
  M_ = "relativeCamouflage",
  A_ = "relativeMobility",
  L_ = "relativePower",
  D_ = "relativeVisibility",
  T_ = {
    [P_]: (e) =>
      g.createElement(
        "svg",
...
function B_({ type: e }) {
  ...
  if (a)
    return b.jsxs("div", {
      className: k_,
      children: [
        b.jsx(a, { className: S_ }),
        b.jsx("div", { className: E_, children: t.readOrEmpty(`menu.tank_params.${e}`) }),
      ],
    });
  console.error(`Unknown ttc param ${e}`);
}
const V_ = "Section_5872c61",
  R_ = "Section_container_5872c61",
  O_ = "Section_header_53353a5a",
  z_ = "Section_detailsContainer_41624a97",
  H_ = "Section_arrow_931be12",
  F_ = "Section_arrow__opened_9ccaa82",
  q_ = te.resolve("aliases"),
  U_ = w(function ({
    indicatorList: e,
    status: t,
    type: a,
    ...
    const [d, u] = y.useState(s),
      ...
      { api: p } = Te(),
      _ = be(),
      { controls: h, rootId: g } = Op();
    mt(() => clearTimeout(m.current));
    const f = y.useMemo(() => ({ tooltipId: l, paramId: a, extendedTooltip: !0 }), [a, l]),
      v = qt({
        resId: 0 !== g ? g : q_.read((e) => e.hangar.shared.VehicleParams("resId")),
        args: f,
      });
    return b.jsx("div", {
      className: C(V_, n),
            ...
            children: b.jsxs("div", {
              ...
              children: [
                b.jsxs("div", {
                  ...
                  children: [
                    b.jsx(B_, { type: a }),
                    b.jsx(Zt.Arrow, { className: C(H_, d && F_) }),
                  ],
                }),
                b.jsx(I_, { indicatorList: e, status: t }),
              ],
            }),
          }),
          b.jsx(Zt.AnimatedDetails, {
            ...
            children: b.jsx(i_, { ...c, rootId: g, params: i, extraParams: o, className: z_ }),
          }),
        ],
      }),
    });
  ...
  $_ = w(function ({ indicatorAmount: e, classNames: t }) {
    const { model: a } = Op(),
      { api: s } = Te(),
      [n, r] = Be(s);
    return b.jsxs(b.Fragment, {
      children: [
        b.jsx(Re, {
          classNames: {
            wrapper: W_.scrollWrapper,
            content: C(W_.scrollContent, W_[`scrollContent__${Zp(n, r)}`]),
          },
          children: b.jsx("div", {
            className: W_.sections,
            children: a.computes
              .sectionParams(e)
              .map((e) =>
                g.createElement(U_, { ...e, key: e.type, className: W_.section, classNames: t }),
              ),
          }),
        }),
        b.jsx(Fe, { classNames: { base: W_.verticalBar } }),
      ],
    });
  }),
  Z_ = w(function ({ indicatorAmount: e = 10, className: t, classNames: a }) {
    const { model: s } = Op(),
      n = be(),
      r = s.computes
        .sectionParams(e)
    ...
    return (
      ...
      b.jsx("div", {
        className: C(W_.base, t),
        children: b.jsx(He, { children: b.jsx($_, { indicatorAmount: e, classNames: a }) }),
      })
    );
  });
var G_ = ((e) => (
  ...
  Q_ = ((e) => ((e.Unknown = "unknown"), (e.Random = "random"), (e.Comp7 = "comp7"), e))(Q_ || {}),
  Y_ = ((e) => ((e[(e.Common = 0)] = "Common"), (e[(e.Legendary = 1)] = "Legendary"), e))(Y_ || {});
const [J_, eh] = V("OptionalDevicesAssistantModel")(
    ({ observableModel: e }) => {
      const t = {
          ...e.primitives(["state"]),
        ...
        a = () =>
          _e(t.optionalDevicesAssistantPresets.get(), (e) => ({
            ...e,
            optionalDevicesAssistantItems: _e(e.optionalDevicesAssistantItems, (e) => ({
              ...e,
              items: _e(e.items, q),
            })),
          })),
          ...
          Gt(
            ...
            (t, a) => {
              if (a.presetType.mType === e) {
                const e = _e(a.optionalDevicesAssistantItems, (e) => ({
                  ...e,
                  items: _e(e.items, q),
                }));
                t.push(...e);
        ...
        n = O.primitive(() => s(1).sort((e, t) => t.popularity - e.popularity)),
        r = O.primitive(() => s(0).sort((e, t) => t.popularity - e.popularity));
      return {
        ...t,
        computes: {
          modeType: () => {
            const e = Y_.Common || Y_.Legendary,
  ...
  th = "PopularLoadouts_905d92af",
  ah = "PopularLoadouts_base__legendary_44c73d25",
  sh = "PopularLoadouts_lipsIcon_94b94918",
  nh = "PopularLoadouts_base__linked_44c73d25",
  rh = "PopularLoadouts_lips_f8140539",
  ih = "PopularLoadouts_base__noDataLegendary_44c73d25",
  oh = "PopularLoadouts_row_empty_79f784c5",
  lh = "PopularLoadouts_noDataLegendary_8871a45c",
  ch = "PopularLoadouts_noData_44c73d25",
  dh = "PopularLoadouts_vehicleNotAvailable_6aaecb23",
  uh = "PopularLoadouts_noData_text_44c73d25",
  mh = "PopularLoadouts_vehicleNotAvailable_text_f6a0ffe8",
  ph = "PopularLoadouts_scrollWrapper_f6e40aea",
  _h = "PopularLoadouts_scroll_5547fb14",
  hh = "PopularLoadouts_verticalBar_4b7df3ca",
  gh = "PopularLoadouts_background_59528a5b",
  fh = "PopularLoadouts_onslaughtBackground_87fd615d",
  vh = "PopularLoadouts_backgroundWrapper_ceadd975",
  bh = "PopularLoadouts_backgroundWrapper__noData_577b30c5",
  xh = "PopularLoadouts_border_bb3c99b0",
  yh = "PopularLoadouts_container_7ca114a3",
  Ch = "PopularLoadouts_row_41e986f6",
  wh = "PopularLoadouts_row_images_11958d34",
  Nh = "PopularLoadouts_row_images__hovered_6d465f9f",
  jh = "PopularLoadouts_row_image_44c73d25",
  Ih = "PopularLoadouts_row_emptySlot_19879be4",
  kh = "PopularLoadouts_popularity_85b17be2",
  Sh = "PopularLoadouts_popularity__visible_99ebbe75",
  Eh = "PopularLoadouts_lipsWrapper_f6e40aea",
  Ph = "PopularLoadouts_footer_e8f21254",
  Mh = "PopularLoadouts_footer_wrapper_2b5337f0",
  Ah = "PopularLoadouts_footer_wrapper_title_ddd0fc04",
  Lh = "PopularLoadouts_footer_wrapper_pagination_f70ced5f",
  Dh = "PopularLoadouts_dot1_859b9d81",
  Th = "PopularLoadouts_dot2_290c1eaf",
  Bh = "PopularLoadouts_dot1__active_44c73d25",
  Vh = "PopularLoadouts_dot2__active_22013c6c",
  Rh = "PopularLoadouts_footer_arrowWrapper_2b51cfb1",
  Oh = "PopularLoadouts_footer_arrowLeft_44c73d25",
  zh = "PopularLoadouts_footer_arrowRight_f495386";
function Hh(e) {
  return (t = e) !== G_.Empty &&
...
function qh({ popularity: e, optionalDevice: t, isHovered: a }) {
  const s = g.useMemo(() => t.map(Hh).concat(new Array(3).fill(null)).slice(0, 3), [t]),
    n = 0 === t.length;
  return b.jsxs("div", {
    className: C(Ch, n && oh),
    children: [
      ...
      b.jsx("div", {
        className: C(wh, a && Nh),
        children: s.map((e, t) =>
          e ? b.jsx(we, { className: jh, path: e }, t) : b.jsx("div", { className: Ih }, t),
        ),
      }),
    ],
  });
}
const Uh = te.resolve("aliases"),
  Wh = te.resolve("views"),
  $h = te.resolve("strings"),
  Zh = k(function ({
    ...
    const o = be(),
      [l, c] = g.useState(!1),
      { model: d, controls: u } = eh(),
      m = d.computes.modeType() === Q_.Comp7,
      p = l && !a,
      ...
      y = et({
        resId: Uh.read((e) => e.hangar.shared.OptionalDevicesAssistant("resId")),
        contentId: Wh.read((e) => e.lobby.tanksetup.tooltips.PopularLoadoutsTooltip("resId")),
    ...
    function N() {
      const e = n === Y_.Common ? Y_.Legendary : Y_.Common;
    ...
    return b.jsxs(b.Fragment, {
      children: [
        b.jsx("div", { className: xh }),
        s &&
          b.jsx("div", {
            className: lh,
            children: $h.readOrEmpty("tank_setup.popularLoadouts.noDataLegendary"),
          }),
        b.jsx("div", { className: gh }),
        m && b.jsx("div", { className: fh }),
        b.jsx("div", {
          className: ph,
          children: b.jsxs(He, {
            children: [
              ...
              b.jsx(Fe, { classNames: { base: hh } }),
            ],
          }),
        }),
        b.jsx("div", { className: xh }),
        b.jsx("div", { className: rh }),
        b.jsxs("div", {
          className: Ph,
          children: [
            b.jsx("div", {
              ...
              onMouseEnter: I,
              onClick: j,
              children: b.jsx("div", { className: Oh, onClick: N }),
            }),
            b.jsxs("div", {
              className: Mh,
              children: [
                b.jsxs("div", {
                  ...
                  className: Eh,
                  children: [
                    b.jsx("div", { className: sh }),
                    b.jsx("div", { className: Ah, children: w }),
                  ],
                }),
                b.jsxs("div", {
                  className: Lh,
                  children: [
                    b.jsx("div", { className: C(Dh, 0 === n && Bh) }),
                    b.jsx("div", { className: C(Th, 1 === n && Vh) }),
                  ],
                }),
              ],
            }),
            b.jsx("div", {
              ...
              onMouseEnter: I,
              onClick: j,
              children: b.jsx("div", { className: zh, onClick: N }),
            }),
          ],
        }),
      ],
  ...
  Gh = k(function () {
    const { model: e } = eh(),
      [t, a] = g.useState(e.selectedPreset.get().mType || Y_.Common),
      s = e.computes.optionalDevicesResultTypeForPreset(t),
      n = s === K_.Linked,
      r = s === K_.Combined,
      i = n || r,
      o = s === K_.NoData && Y_.Legendary,
      l = e.state.get() === X_.NoDataAtAll,
      c = e.state.get() === X_.NotSuitableVehicle;
    return b.jsxs("div", {
      className: C(th, t === Y_.Legendary && ah, i && nh, o && ih),
      children: [
        b.jsx("div", { className: C(vh, (l || c) && bh) }),
        b.jsx(Zh, {
  ...
  Xh = "EquipmentAssistant_c5998863",
  Kh = k(function ({ className: e }) {
    const { model: t } = eh(),
      a = t.state.get() === X_.Hidden;
    return b.jsx("div", {
      className: C(Xh, e),
  ...
  Qh = "TankInfo_5a43ab26",
  Yh = "TankInfo_ttc_b7c2d1d7",
  Jh = "TankInfo_techParams_3f23a8c3",
  eg = "TankInfo_text_3d2affa7",
  tg = "TankInfo_equipmentAssistant_6633e061",
  ag = "TankInfo_vehicleInfo_6633e061",
  sg = "TankInfo_summary_1066f4ee",
  ng = "TankInfo_accordionDetails_e30a5dd6",
  rg = te.resolve("aliases"),
  ig = Ne("LoadoutScreenTankInfo"),
  og = Ae({ summary: sg, accordionDetails: ng }),
  lg = k(function ({ rootId: e, className: t, children: a }) {
    const s = Sr().model.selectedVehicle(),
      n = Sr().model.selectedVehicleStatistics();
    if (s && n)
      return b.jsxs(ig, {
        className: C(Qh, t),
        children: [
          b.jsxs(Xt, {
            className: ag,
            children: [
              b.jsx(Xt.Level, { className: eg, value: s.level }),
              Kt(s.type) && b.jsx(Xt.Type, { type: s.type, premium: n.elite }),
              b.jsx(Xt.Name, { className: eg, children: s.shortName }),
            ],
          }),
          b.jsx("div", {
            className: Yh,
            children: b.jsx(Rp, {
              options: { rootId: e ?? rg.read((e) => e.hangar.shared.VehicleParams("resId")) },
              children: b.jsx(Z_, { className: Jh, classNames: og }),
            }),
          }),
          a,
        ],
...
function cg({ className: e }) {
  const t = rg.read((e) => e.hangar.shared.OptionalDevicesAssistant("resId"));
  return b.jsx(J_, { options: { rootId: t }, children: b.jsx(Kh, { className: C(tg, e) }) });
}
const dg = k(function ({ className: e }) {
    const t = Ee().location.startsWith("/hangar/loadout/equipment");
    return b.jsx(lg, { className: e, children: t && b.jsx(cg, {}) });
  }),
  ug = "ScreenWrapper_39a2fe74",
  mg = "ScreenWrapper_inner_f586f6da",
  pg = "ScreenWrapper_content_42e9ccec",
  _g = "ScreenWrapper_info_b6387d23",
  hg = "ScreenWrapper_flag_bc3e1d2e",
  gg = te.resolve("aliases"),
  fg = Ne("LoadoutScreenWrapper", ug),
  vg = Ne("ScreenWrapperInfo", _g),
  bg = Ne("ScreenWrapperContent", pg);
const xg = g.createContext({ ttcEnabled: !1 });
function yg({ classNames: e, children: t }) {
  const a = Sr().model.selectedVehicle();
  return b.jsxs(fg, {
    className: e?.base,
    children: [
      a && b.jsx(we, { className: C(hg, e?.flag), path: `flags.c_600x450.${X(a.nationId)}` }),
      b.jsx("div", { className: mg, children: t }),
    ],
  });
}
const Cg = k(function ({ classNames: e, children: t }) {
    const a = (function () {
        const e = Sr().model.selectedVehicle(),
          t = kp(),
          a = gg.read((e) => e.hangar.shared.VehicleParams("resId")),
          s = Qt(a);
        return Boolean(e) && (!t || t.model.computed.ttcEnabled()) && s;
      })(),
      s = g.useMemo(() => ({ ttcEnabled: a }), [a]);
    return b.jsx(xg.Provider, {
      value: s,
      children: b.jsxs(yg, {
        classNames: { base: e?.base, flag: e?.flag },
        children: [
          b.jsx(bg, { className: e?.content, children: t }),
          b.jsx(vg, { className: e?.info, children: a && b.jsx(dg, { className: e?.tankInfo }) }),
        ],
      }),
    });
  }),
  wg = { buySlot: "buySlot", buyTank: "buyTank", restoreTank: "restoreTank", rentTank: "rentTank" },
  Ng = {
    [wg.buySlot]: "buy_slot",
    [wg.buyTank]: "buy_vehicle_new",
    [wg.restoreTank]: "restore_vehicle",
    [wg.rentTank]: "wot_plus_slot",
  },
  jg = (e, t) => ({
    left: [...(t != Ir ? [wg.rentTank] : [])],
    right: [wg.buyTank, ...(e > 0 ? [wg.restoreTank] : []), wg.buySlot],
  }),
  Ig = (e) => e in wg;
function kg(e, t) {
  return g.useMemo(() => {
...
function Sg(e, t, a, s, n, r) {
  ...
  g.useLayoutEffect(() => {
    ...
    o();
    return new Yt().add(e.events.on("resizeHandled", o)).add(e.events.on("recalculateContent", o))
      .dispose;
  }, [t, e, a, s, r, n]);
}
const Eg = -1,
  [Pg, Mg, { Context: Ag }] = V("ManageableVehiclePlaylistsModel")(
    (a) => {
      const s = {
          ...a.observableModel.primitives({ intCD: "vehicleId" }),
          displayedVehicleId: e.box(Eg),
      ...
      return (
        ...
        ),
        {
          ...
          computeds: {
            ...
            empty: O.primitive(() => s.vehicleId.get() === Eg),
            sortedPlaylists: n,
            hasChanges: O.primitive(() => s.changesInPlaylistSelection.size > 0),
            enabled: O.primitive(() => a.requires.playlists.model.enabled.get()),
          },
        }
      );
    },
    (e) => ({
      ...
      save: a(() => {
        ...
        for (const s of e.model.changesInPlaylistSelection) {
          const a = mr(e.requires.playlists.model.byId(s));
    ...
    { useRequires: () => ({ vehicles: ar(), playlists: yr(), vehicleStatistics: er() }) },
  ),
  Lg = () => g.useContext(Ag),
  Dg = (e) =>
    g.createElement(
  ...
  Tg = "Buttons_937965ba",
  Bg = "Buttons_right_268130b5",
  Vg = "Buttons_button_aeef4019",
  Rg = "Buttons_button__create_61690fd8",
  Og = "Buttons_icon_378ba619",
  zg = te.resolve("strings"),
  Hg = w(function () {
    const { model: e, controls: t } = Mg();
    return b.jsxs("div", {
      className: C(Tg),
      children: [
        b.jsx(Jt, {
          body: zg.readOrEmpty("playlists.managaeble_playlists.buttons.create.tooltipBody"),
          children: b.jsx(ge, {
            className: C(Vg, Rg),
            theme: ge.themes.secondary,
            size: ge.sizes.extraSmall,
            autoAlignContent: !1,
            onClick: () => {
              (t.goToCreatePlaylist([e.displayedVehicleId.get()]), t.reset());
            },
            children: b.jsx(Dg, { className: Og }),
          }),
        }),
        b.jsxs("div", {
          className: Bg,
          children: [
            b.jsx(ge, {
              ...
              children: b.jsx(Me, {
                text: zg.readOrEmpty("playlists.managaeble_playlists.buttons.cancel.title"),
              }),
            }),
            b.jsx(ge, {
              className: Vg,
              ...
              children: b.jsx(Me, {
                text: zg.readOrEmpty("playlists.managaeble_playlists.buttons.save.title"),
              }),
            }),
          ],
        }),
  ...
  Fg = "Item_itemBackground_f5007fc6",
  qg = "Item_c5163bf",
  Ug = "Item_checkbox_cfffba80",
  Wg = "Item_item__checked_5f6fcc69",
  $g = "Item_check_a68580c8",
  Zg = "Item_checkboxLabel_885d0061",
  Gg = w(function ({ id: e, title: t, checked: a }) {
    const { controls: s } = Mg();
    return b.jsxs("div", {
      className: C(qg, a && Wg),
      children: [
        b.jsx("div", { className: Fg }),
        b.jsx(ea, {
          checked: a,
          onCheckedChange: () => s.togglePlaylist(e),
          size: ta.small,
          className: Ug,
          classNames: { label: Zg, check: $g },
          children: b.jsx(Me, { text: t }),
        }),
      ],
    });
  }),
  Xg = "List_152fbdf4",
  Kg = "List_scrollWrapper_e69e8089",
  Qg = "List_scrollContent_30662217",
  Yg = "List_scrollbar_611defd3",
  Jg = w(function () {
    const { model: e } = Mg(),
    ...
    return b.jsxs("div", {
      ...
      children: [
        b.jsx(aa, {
          classNames: { wrapper: Kg, content: Qg },
          children: _e(t, ({ id: e, title: t, selected: a }) =>
            b.jsx(Gg, { id: e, title: t, checked: a }, e),
          ),
        }),
        b.jsx(Fe, { classNames: { base: Yg } }),
      ],
    });
  }),
  ef = "Vehicle_name_f5f779f6",
  tf = "Vehicle_level_c03ad304",
  af = "Vehicle_type_9905a21f",
  sf = w(function () {
    const { model: e } = Mg(),
    ...
    return b.jsxs(Xt, {
      children: [
        b.jsx(Xt.Level, { value: t.level, className: tf }),
        Kt(t.type) &&
          b.jsx(Xt.Type, {
            size: Xt.Type.sizes.x24x24,
            className: af,
            type: t.type,
            premium: t.elite,
          }),
        b.jsx(Me, { text: t.fullName, className: ef }),
        a !== sa && b.jsx(Xt.Role, { size: Xt.Role.sizes.x16x16, roleKey: a }),
      ],
    });
  }),
  nf = "Styles_display_f2930fa3",
  rf = "Styles_header_dcb2494f",
  of = "Styles_body_504cd01f",
  lf = "Styles_title_ece3f15e",
  cf = te.resolve("strings");
...
function uf({ className: e }) {
  return b.jsxs(Oe.Body, {
    className: C(of, e),
    children: [
      b.jsx(Oe.Divider, {}),
      b.jsx(He, { children: b.jsx(Jg, {}) }),
      b.jsx(Oe.Divider, {}),
      b.jsx(Hg, {}),
    ],
  });
}
const mf = g.memo(function ({ vehicleId: e, tipSize: t, className: a, children: s, ...n }) {
    return b.jsxs(Oe.Display, {
      ...n,
      className: C(nf, a),
      children: [b.jsx(Oe.Tip, { size: t }), b.jsx(Oe.Close, {}), s],
    });
  }),
  pf = w(({ children: e }) => {
    const t = fe(),
      ...
      s = ke(),
      n = na(),
      { model: r, controls: i } = Mg(),
      o = r.vehicleId.get(),
      l = r.displayedVehicleId.get(),
      [c, d] = g.useState(!1),
      [u, m] = g.useState(!1),
      p = st(() => {
        (m(!0), t.open(), s.run(() => m(!1), ra));
      }),
      _ = st(() => {
        (m(!0),
          t.close(),
  ...
  _f = (e) => `manageable-vehicle-playlists-model-${e}`,
  hf = w(function ({ children: e, position: t, freeSpaceRem: a, tipSize: s }) {
    const { model: n, controls: r } = Mg(),
      i = n.displayedVehicleId.get(),
      o = ia("rem"),
      l = st((e, { callerBounding: t }) => {
    ...
    return (
      g.useEffect(() => {
        d && u === Eg && c !== Eg && (r.goToCreatePlaylist([c]), r.reset());
      }, [u, c, d, r]),
      d
        ? null
        : b.jsx(Oe, {
              ...
              children: [
                b.jsx(Oe.Portal, {
                  ...
                  children:
                    ...
                    b.jsxs(
                      mf,
                      { vehicleId: i, tipSize: s, children: [b.jsx(df, {}), b.jsx(uf, {})] },
                      i,
                    ),
                }),
                e,
...
const gf = "Content_7ccb81a0",
  ff = "Content_disabledOverlay_a8908196",
  vf = "Content_base__disabled_da09528a",
  bf = "Content_base__selected_da09528a",
  xf = "Content_base__empty_da09528a";
function yf({ children: e, selected: t, disabled: a, empty: s }) {
  return b.jsxs("div", {
    "data-name": "Content",
    className: C(gf, s && xf, t && bf, a && vf),
    children: [e, a && b.jsx("div", { className: ff })],
  });
}
const Cf = "Slot_977dd8f1",
  wf = "Slot_base__wrapper_ae3081b5",
  Nf = "Slot_base__disabled_334cc10f",
  jf = "Slot_base__empty_d386066c",
  If = "Slot_content_1a27c8cf",
  kf = "Slot_base__active_71f19f5c",
  Sf = "Slot_base__selected_71f19f5c",
  Ef = "Slot_selected_6e9f21df",
  Pf = "Slot_selected__border_e2a17304",
  Mf = g.memo(function ({
    children: e,
    selected: t = !1,
    disabled: a = !1,
    ...
    return b.jsx("div", {
      ...r,
      "data-name": "Slot",
      className: C(Cf, s && kf, t && Sf, a && Nf, i && jf, wf, n),
      children: b.jsxs("div", {
        className: If,
        children: [
          b.jsx(yf, { selected: t, disabled: a, empty: i, children: e }),
          t && b.jsx("div", { className: C(Ef, Pf) }),
          b.jsx("div", { className: Ef }),
        ],
      }),
    });
  }),
  Af = "ActionCards_wrapper_690d669a",
  Lf = "ActionCards_text_cdbc926",
  Df = "ActionCards_wrapper__double_70640c01",
  Tf = "ActionCards_content_a46de8cf",
  Bf = "ActionCards_content__buySlot_a70e9708",
  Vf = "ActionCards_icon_f8219d70",
  Rf = "ActionCards_contentIcon_166df330",
  Of = "ActionCards_currency_ac7c654f",
  zf = "ActionCards_discount_967a7825",
  Hf = {
    [Nr]: "menu.tankCarousel.wotPlusSelectionPending",
    [jr]: "menu.tankCarousel.wotPlusSelectionAvailable",
  },
  Ff = w(function ({ type: e }) {
    const t = Sr(),
      ...
      return b.jsx("div", {
        ...
        children: b.jsx(la, {
          ...
          children: b.jsx(ua, {
            ...
            size: ca.extraSmall,
            reverse: !0,
            classNames: { base: C(Tf, Bf), icon: Rf },
            children: s,
          }),
        }),
      });
    if (e === wg.rentTank) {
      const e = Hf[o];
      return e ? b.jsx(Ue, { className: Lf, upgradeLegacy: !0, path: e }) : null;
    }
    return b.jsxs("div", {
      className: Tf,
      children: [
...
function qf({ type: e, width: t, height: a, doubleRow: s, className: n }) {
  ...
  const d = te.resolve("strings"),
    u = ve(`hangar.carousel.actionCards.x48x48.${e}`, `hangar.carousel.actionCards.x96x96.${e}`),
    m = Ie({
      header: d.readOrEmpty(`tooltips.tanks_carousel.${Ng[e]}.header`),
      body: d.readOrEmpty(`tooltips.tanks_carousel.${Ng[e]}.body`),
    }),
    p = ma(
      "actionSlotPrice",
      g.useMemo(() => [[o], [l]], [o, l]),
  ...
  return b.jsx(Mf, {
    ...
    onClick: function (t) {
      ...
      const a = {
        [wg.buySlot]: r.controls.buySlot,
        [wg.buyTank]: r.controls.goBuyVehicle,
        [wg.restoreTank]: r.controls.goRecoverVehicle,
        [wg.rentTank]: r.controls.selectTelecomRentalVehicle,
      }[e];
    ...
    children: b.jsxs("div", {
      ...
      children: [
        ...
        b.jsx("div", {
          className: Lf,
          children: b.jsx(Ue, { path: `menu.tankCarousel.vehicleStates.${e}` }),
        }),
        b.jsx(Ff, { type: e }),
      ],
    }),
...
const Uf = {
  ...
  Wf = {
    inactive: Uf.base__inactive,
    activating: Uf.base__activating,
    active: Uf.base__active,
    deactivating: Uf.base__deactivating,
  };
function $f({ className: e, doubleRow: t, state: a = "inactive", isCornerHidden: s = !1 }) {
  return "inactive" === a
    ? null
    : b.jsxs("div", {
        className: C(Uf.base, a && Wf[a], t && Uf.base__double, e),
        children: [
          b.jsx("div", { className: Uf.glow }),
          !s && b.jsx("div", { className: Uf.corner }),
          b.jsx("div", { className: Uf.arrow }),
          [Uf.triangle__1, Uf.triangle__2, Uf.triangle__3].map((e) =>
            b.jsx("div", { className: C(Uf.triangle, e) }, e),
          ),
        ],
      });
}
const Zf = "Background_1089bc1c",
  Gf = "Background_wotPlus_3cf6035a",
  Xf = "Background_crystal_6112fa42",
  Kf = "Background_bpBonus_cf76872",
  Qf = "Background_multiplier_284cda6c",
  Yf = "Background_flag_beb58b8",
  Jf = "Background_base__double_26effab7",
  ev = "Background_flag__active_de322c1b",
  tv = "Background_vehicle_23ef6e2b",
  av = "Background_vehicle__dimmed_7f14a6c7",
  sv = "Background_crystal__limit_61072361",
  nv = Ne("Favorite", "Background_favorite_d98f92cc", {
    variants: { active: { true: "Background_favorite__active_7f14a6c7" } },
  });
function rv({ nationId: e, selected: t, active: a, className: s }) {
  return b.jsx(we, {
    className: C(Yf, t || (a && ev), s),
    path: `hangar.carousel.cards.flags.x400x300.${X(e)}`,
    position: "top left",
  });
}
const iv = w(function ({ vehicle: e, statistic: t, validBP: a, doubleRow: s, classNames: n }) {
  const r = nn()?.model,
    i = r?.isCrystalEarnEnabled.get() ?? !0,
    o =
      (Mt(t?.numberOfCrystalEarned ?? [], 1) ?? 0) <= (Mt(t?.numberOfCrystalEarned ?? [], 0) ?? 0),
    l = t?.proBoostActive,
    c = t?.fromWotPlus,
    d = i && e.crystalEarning && !c,
    u = gt(l),
    m = (r?.isDailyMultipliedXpEnabled.get() ?? !0) && rn(Number(t?.bonusMultiplier)),
    p = g.useMemo(
  ...
  return b.jsxs(b.Fragment, {
    children: [
      c && b.jsx("div", { className: C(Gf, n?.wotPlus) }),
      b.jsx($f, { state: p, className: n?.proBoostIcon, doubleRow: s, isCornerHidden: d }),
      d && b.jsx("div", { className: C(Xf, o && sv, n?.crystal) }),
      t?.bpSpecial && a && b.jsx("div", { className: C(Kf, n?.bpBonus) }),
      m && b.jsx("div", { className: Qf }),
    ],
  });
});
function ov({
  ...
  return b.jsxs("div", {
    ...o,
    className: C(Zf, i && Jf, o.className),
    children: [
      b.jsx(rv, { nationId: e.nationId, active: s, selected: r }),
      b.jsx(pa, { className: C(tv, ((n?.status && n.status !== on) || a) && av), name: e.name }),
      b.jsx(iv, { vehicle: e, statistic: n, validBP: t, doubleRow: i }),
      b.jsx(nv, { active: e.favorite }),
    ],
  });
}
const lv = "Bonuses_8169b4b3",
  cv = "Bonuses_bonus_91f120c3",
  dv = "Bonuses_bonus__active_2364401e",
  uv = "Bonuses_bonusIcon_b65fb47f",
  mv = "Bonuses_bonusValue_322db074",
  pv = "Bonuses_bonusValue__highlighted_4bcc07c6",
  _v = "Bonuses_rent_ea11a7e4",
  hv = "Bonuses_base__double_ca1cd57b",
  gv = "Bonuses_icon_3991db74",
  fv = "Bonuses_text_a556857c",
  vv = te.resolve("strings");
function bv({
  bonusMultiplier: e,
  vehicleId: t,
  restBonusEnabled: a,
  ...
  return b.jsxs("div", {
    className: C(cv, e !== ln && dv, s),
    ...i,
    children: [
      b.jsx("div", { className: C(uv, n?.icon) }),
      b.jsx("div", {
        className: C(mv, n?.value, r && pv),
        children: `${vv.readOrEmpty("common.multiplierSmall")}${e}`,
      }),
    ],
  });
}
const xv = w(function ({ vehicle: e, statistic: t, doubleRow: a, ...s }) {
    const n = nn()?.model.isDailyMultipliedXpEnabled.get() ?? !0;
    return b.jsxs("div", {
      ...s,
      className: C(lv, a && hv, s.className),
      children: [
        n &&
          t &&
          b.jsx(bv, {
  ...
  Cv = Ne("VehicleName", {
    element: (e) => b.jsx(Xt.Name, { ...e }),
    className: yv.text,
    cva: { variants: { premium: { true: yv.text__premium } } },
  });
function wv({ statistic: e, vehicle: t, className: a, status: s }) {
  const n = te.resolve("views"),
  ...
  return b.jsxs("div", {
    className: C(
      yv.battlePass,
      e.maxBpScore > 0 && yv.battlePass__active,
      e.bpSpecial && yv.battlePass__bonus,
      a,
    ),
    onMouseEnter: function (e) {
      o?.onMouseEnter(e);
    ...
    children: [
      b.jsxs("div", {
        className: yv.bpPoints,
        children: [
          b.jsx("div", {
            className: yv.points,
            children: ha.formatNumber("integral", e.bpProgress),
          }),
          b.jsx("div", {
            className: C(yv.points, yv.points__slash),
            children: i.readOrEmpty("common.common.slash"),
          }),
          b.jsx("div", {
            className: yv.points,
            children: ha.formatNumber("integral", e.maxBpScore),
          }),
          b.jsx("div", { className: yv.bpShadow }),
        ],
      }),
      b.jsx("div", { className: yv.bpIcon }),
    ],
  });
}
function Nv({ statistic: e, elite: t, vehicle: a, selected: s, classNames: n, className: r }) {
  return b.jsxs("div", {
    className: C(yv.details, r),
    children: [
      e &&
        b.jsx(Xt.Prestige, {
          ...
          type: e.prestigeType,
          direction: ga.left,
          className: C(yv.prestige, s && yv.prestige__active, n?.prestige),
        }),
      b.jsx(Xt.Level, { className: C(yv.text, yv.text__level, n?.level), value: a.level }),
      Kt(a.type) &&
        b.jsx(Xt.Type, {
          type: a.type,
          premium: t || e?.elite,
...
function jv({ vehicle: e, className: t, classNames: a }) {
  const s = un[e.id],
  ...
  return b.jsxs("div", {
    className: C(
      yv.identifier,
      yv[`identifier__${s}`],
      n && yv.identifier__changeNation,
      r && yv.identifier__rent,
      t,
    ),
    children: [
      b.jsx(Cv, {
        className: a?.name,
        premium: e.premium,
        children: b.jsx(Me, { className: yv.truncatedText, text: e.shortName }),
      }),
      (s || n) &&
        b.jsx("div", {
          className: C(
            yv.identifierIcon,
            yv[`identifierIcon__${s}`],
            n && yv.identifierIcon__changeNation,
            a?.icon,
          ),
        }),
    ],
...
const Iv = w(function ({ vehicle: e, statistic: t, selected: a, doubleRow: s, ...n }) {
    const r = Sr(),
      i = r.model.bpState.active.get(),
      o = r.model.bpState.status.get();
    return b.jsxs("div", {
      ...n,
      className: C(yv.base, s && yv.base__double, n.className),
      children: [
        t && cn(i, o, t) && b.jsx(wv, { vehicle: e, statistic: t, status: o }),
        b.jsxs(Xt, {
          className: yv.info,
          children: [
            b.jsx(Nv, { vehicle: e, statistic: t, selected: a }),
            b.jsx(jv, { vehicle: e }),
          ],
        }),
      ],
...
function Sv({ status: e, classNames: t, className: a }) {
  const s = te.resolve("images"),
    n = ve(
      `hangar.carousel.cards.alerts.${mn[e]}`,
      `hangar.carousel.cards.alerts.${mn[e]}_upscale`,
    ),
    r = ve(
  ...
  return b.jsxs("div", {
    className: C(kv.alert, a),
    children: [
      b.jsx(we, { className: C(kv.alertIcon, t?.icon), path: s.has(n) ? n : r }),
      b.jsx(Ue, {
        upgradeLegacy: !0,
        className: C(kv.alertText, i && kv.alertText__light, t?.text),
        path: `menu.tankCarousel.vehicleStates.${e}`,
        params: { icon: b.jsx(we, { path: "library.premium_small", width: 34, height: 16 }) },
      }),
    ],
  });
}
function Ev({ statistic: e, doubleRow: t, ...a }) {
  return e.status === on
    ? null
    : b.jsx("div", {
        ...a,
        className: C(kv.base, t && kv.base__double, a.className),
        children: b.jsx(Sv, { status: e.status }),
      });
}
Ne("Disable", kv.disable);
const Pv = "Card_e79008fd",
  Mv = "Card_base__double_f8b7f334",
  Av = "Card_content_a6141b08",
  Lv = "Card_border_e9cb9a85",
  Dv = te.resolve("views"),
  Tv = te.resolve("aliases"),
  Bv = w(function ({
    vehicleId: e,
    selected: t = !1,
    doubleRow: a,
...
function Rv({
  ...
  const [i, o] = g.useState(n),
    ...
    d = et({
      resId: Tv.read((e) => e.hangar.shared.VehiclesInventory("resId")),
      contentId: Dv.read((e) => e.mono.hangar.vehicle_tooltip("resId")),
      ...
      : b.jsxs("div", {
          ...
          children: [
            b.jsxs("div", {
              className: Av,
              children: [
                b.jsx(Iv, { vehicle: e, selected: a, statistic: t, doubleRow: s }),
                b.jsx(xv, { vehicle: e, statistic: t, doubleRow: s }),
              ],
            }),
            b.jsx(Ev, { statistic: t, doubleRow: s }),
          ],
        })
  );
}
const Ov = {};
function zv({ cardHeight: e, className: t }) {
  return b.jsx(Mf, {
    className: t,
    style: { height: `${e}px` },
    children: b.jsx("div", { className: Ov.vehicleSlot }),
  });
}
const Hv = w(function ({ vehicleId: e, cardHeight: t, className: a }) {
  const s = Sr().model.selectedVehicle(),
    n = s?.id,
    r = (function (e) {
      const t = Lg(),
      ...
      return g.useMemo(() => {
        if (a && !s) return { "data-popover-trigger-id": _f(e), onMouseDown: n };
      }, [s, a, n, e]);
    })(Number(e)),
    i = g.useMemo(() => ({ height: `${t}px` }), [t]);
  return void 0 === e
    ? (console.error("VehicleId is not defined"), b.jsx(zv, { className: C(Lv, a), cardHeight: t }))
    : e === zp
      ? b.jsx(zv, { className: C(Lv, a), cardHeight: t })
      : Ig(e)
        ? b.jsx(qf, { className: C(Lv, a), type: e, height: t })
        : b.jsx(Vt, {
            failure: () => b.jsx(zv, { className: C(Lv, a), cardHeight: t }),
            children: b.jsx(Bv, {
              ...r,
              concurrent: !0,
              vehicleId: e,
...
function qv({ children: e, ...t }) {
  const { api: a } = Te();
  return b.jsx(ya, { ...t, api: a, className: Fv.content, children: e });
}
const Uv = w(function (e) {
    const t = Sr(),
      a = wr(),
      s = kp(),
      { api: n } = Te(),
      [r, i] = Be(n),
      { upscale: o, screenHeightRem: l } = Ye(),
      c = a?.model.current(),
      d = t.model.current.list(),
      u = c && 0 === d.length,
      m = s?.model.computed.ttcEnabled(),
      p = l > Je.extraLarge.height && !o;
    return b.jsxs("div", {
      className: C(Fv.scroll, p && Fv.scroll__noUpscaleExtraLarge, Fv[`scroll__${Zp(r, i)}`]),
      children: [
        b.jsx(Re, {
          ...e,
          classNames: {
            ...e.classNames,
            wrapper: Fv.scrollWrapper,
            content: C(Fv.scrollContent, u && Fv.scrollContent__empty),
          },
          children: e.children,
        }),
        !n.disabled &&
          b.jsx(Fe, { classNames: { base: C(Fv.verticalBar, m && Fv.verticalBar__ttc) } }),
      ],
    });
  }),
  Wv = w(function ({ extraColumns: e = 0 }) {
    const t = Sr(),
      a = wr(),
      s = Lg(),
      { api: n } = Te(),
      ...
      { activeSlotsAmount: N, activeSlotsIds: j } =
        ...
        g.useMemo(() => {
          ...
          return {
            activeSlotsAmount: e,
            activeSlotsIds: [...k, ...I, ...S, ...Array(0 === a ? t : a).fill(zp)],
          };
        }, [k, P, I, E, S]));
    var I, k, S, E, P;
    return (
      ...
      b.jsxs(b.Fragment, {
        children: [
          b.jsx(xa, {
            api: n,
            elementHeight: c - at(1),
            direction: "vertical",
            totalElements: j.length,
            wrappers: { Content: qv },
            renderScroll: (e) => b.jsx(Uv, { ...e, style: { "--card-width": 100 / l + "%" } }),
            itemsPerRow: l,
            renderElement: (e) =>
              b.jsx(Hv, { vehicleId: j[e], cardHeight: c, className: Fv.card }, j[e] ?? e),
          }),
          s &&
            s.model.computeds.enabled() &&
            b.jsx(hf, { freeSpaceRem: 0, tipSize: "32rem", position: "right" }),
        ],
      })
    );
  }),
  ...
  Gv = "EmptyStateMessage_description_5a4f259e",
  Xv = te.resolve("strings"),
  Kv = w(function (e) {
    const t = wr(),
      a = Sr(),
      s = t?.model.current();
    ...
    return b.jsxs("div", {
      className: C($v, e.className),
      children: [
        b.jsx("div", {
          className: Zv,
          children: Xv.readOrEmpty(`playlists.empty_state.${r}.title`),
        }),
        b.jsx("div", {
          className: Gv,
          children: Xv.readOrEmpty(`playlists.empty_state.${r}.body`),
        }),
      ],
    });
  });
function Qv(e) {
  return { id: e.id, tankmanId: e.tankmanId, roles: it(e.roles) };
}
const Yv = "disabled",
  [Jv, eb] = V("CrewModel")(
    ({ observableModel: e }) => {
      const t = {
          ...
          crew: e.transform(Ca("id", Na), "crew"),
        },
        a = O.structural(() => wa(t.slots.get(), Qv)),
        s = O.model((e) => t.crew.get()[e]),
        n = O.primitive((e) => {
          const t = s(e);
          return (t?.newPerksCount ?? 0) + (t?.newBonusPerksCount ?? 0);
        }),
        r = O.primitive(() => t.state.get() === Yv);
...
const rb = {
  ...
  ib = "Profile_491a8220",
  ob = "Profile_roles_2d239199",
  lb = "Profile_role_b3df2c53",
  cb = "Profile_name_5c9b6f18",
  db = "Profile_name__maxLevel_85270e75",
  ub = te.resolve("strings"),
  mb = te.resolve("aliases");
function pb({ role: e = "", className: t }) {
  const a = rb[e];
  if (a) return b.jsx(a, { className: t });
  console.error(`Unknown role type ${e}`);
}
function _b({ roles: e, name: t, perksAmount: a, progress: s }) {
  const { tankmanId: n, slotId: r } = nb(),
    i = g.useMemo(
  ...
  return b.jsxs("div", {
    ...
    children: [
      b.jsx(Ia, {
        params: { resId: mb.read((e) => e.hangar.shared.Crew("resId")), args: i },
        className: ob,
        children: _e(e, (e, t) => b.jsx(pb, { role: e, className: lb }, t)),
      }),
      t
        ? b.jsx(Me, { className: C(cb, 6 === a && s === tb && db), text: t })
        : b.jsx(Ue, {
            upgradeLegacy: !0,
            className: cb,
            path: "crew_widget.emptySlot.chooseTankman",
            params: { role: ub.readOrEmpty(`item_types.tankman.roles.objectiveCase.${e && e[0]}`) },
          }),
    ],
  });
}
function hb({ skinId: e, customizedSkin: t }) {
  return t ? `tankmen.icons.big.crewSkins.${ka(e)}` : `tankmen.icons.big.${ka(e)}`;
}
const gb = "Tankman_content_4548f2cf",
  fb = "Tankman_94b49163",
  vb = "Tankman_base__bonusPerk_dc2caccc",
  bb = "Tankman_content__empty_d0544ce1",
  xb = "Tankman_content__emptyRed_83bc592f",
  yb = g.memo(function (e) {
    const { customizedSkin: t, bonusPerk: a, skinId: s, className: n, animation: r } = e;
    return b.jsx("div", {
      className: C(fb, a && vb, n),
      children: s
        ? b.jsx(we, { className: gb, fit: "cover", path: hb({ skinId: s, customizedSkin: t }) })
        : b.jsxs(b.Fragment, {
            children: [
              b.jsx("div", { className: C(gb, bb) }),
              b.jsx(j.div, { className: C(gb, xb), style: r }),
            ],
          }),
    });
  }),
  ...
  wb = te.resolve("strings"),
  Nb = k(function () {
    const { model: e, controls: t } = eb(),
      a = be(),
      s = e.computes.disabled(),
      n = e.vehicleNation.get();
    return b.jsx(Sa, {
      params: {
        header: wb.readOrEmpty(`tooltips.hangar.crew.rudy.dog.${n}.header`),
        body: wb.readOrEmpty(`tooltips.hangar.crew.rudy.dog.${n}.body`),
      },
      asChild: !0,
      children: b.jsxs("div", {
        className: Cb.base,
        ...
        children: [
          b.jsx(yb, { customizedSkin: !1, skinId: "ussr_dog_1" }),
          b.jsxs("div", {
            className: Cb.block,
            children: [
              b.jsxs("div", {
                ...
                children: [
                  b.jsx("div", {
                    className: Cb.roles,
                    children: b.jsx(pb, { role: ab, className: Cb.role }),
                  }),
                  b.jsx("div", {
                    className: Cb.name,
                    children: wb.readOrEmpty(`menu.hangar.crew.rody.dog.${n}.name`),
                  }),
                ],
              }),
              b.jsx(ge, {
                className: Cb.dogDetails,
                theme: ge.themes.secondary,
                size: ge.sizes.small,
                onClick: (e) => {
                ...
                children: b.jsx("div", {
                  className: Cb.detailsText,
                  children: wb.readOrEmpty("crew.dogPawTooltip.details.body"),
                }),
              }),
            ],
          }),
          b.jsx("div", { className: C(Cb.disabled, s && Cb.overlay__active) }),
        ],
      }),
    });
  }),
  jb = "retrainingProgress",
...
const Sb = "new_skill",
  ...
  Fb = [Vb, Tb];
function qb(e) {
  return e.find((e) => e.bonus === tb)?.name;
}
function Ub(e) {
  const {
      id: t,
  ...
  for (let u = 0; u < s; u++) {
    const e = n !== tb && u === s - 1 ? Ea.learning : Ea.learned;
    d.push({ id: t, name: Sb, state: e, vehEfficacy: r, efficacy: i, role: o, nativeTank: l });
  }
  return d;
}
function Wb(e) {
...
function $b(e) {
  ...
  return o.sort((e, t) =>
    e.state === Ea.learning && t.state !== Ea.learning
      ? 1
      : e.state !== Ea.learning && t.state === Ea.learning
        ? -1
        : e.name === Sb && t.name !== Sb
...
const Zb = "EfficiencyIndicator_d9560b90",
  Gb = "EfficiencyIndicator_base__bonus_a4144984",
  Xb = "EfficiencyIndicator_percent_147766be",
  Kb = "EfficiencyIndicator_icon_fb03a020",
  Qb = te.resolve("intl"),
  Yb = te.resolve("aliases");
function Jb({ bonusPerks: e, skillsEfficiency: t, className: a }) {
  const { tankmanId: s, slotState: n } = nb(),
    r = Qb.formatNumber("integral", 100 * t),
    i = g.useMemo(
      () => ({ tooltipId: n === Ib ? "crewSkillUntrained" : "skillsEfficiency", tankmanID: s }),
      [n, s],
    );
  return b.jsx(Ia, {
    params: { resId: Yb.read((e) => e.hangar.shared.Crew("resId")), args: i },
    className: C(Zb, e && Gb, a),
    children: (() => {
      switch (n) {
        case Ib:
          return b.jsx("div", { className: Kb });
        case jb:
          return b.jsx("div", {
            className: Xb,
            children: b.jsx(Ue, {
...
const ex = te.resolve("aliases"),
  tx = te.resolve("views"),
  ax = te.resolve("strings");
function sx({
  children: e,
  bonus: t,
  name: a,
  ...
  return i
    ? t
      ? b.jsx(Sa, {
          params: {
            header: ax.readOrEmpty("crew.matrix.skillTooltip.bonus.available.header"),
            body: ax.readOrEmpty("crew.matrix.skillTooltip.bonus.available.text"),
          },
          className: o,
          children: e,
        })
      : b.jsx(Pa, {
          params: {
            contentId: tx.read((e) => e.lobby.crew.tooltips.EmptySkillTooltip("resId")),
...
function rx(e) {
  ...
  return b.jsxs(sx, {
    className: C(u, nx.base, c && nx.base__bonus, nx[`base__${p}`]),
    newPerk: m,
    bonus: c,
    name: t.includes(Eb) ? Eb : t,
    index: l,
    role: i,
    tankmanId: r,
    children: [
      b.jsx("div", { className: nx.background }),
      b.jsx("div", { className: nx.border }),
      Fb.includes(p) && b.jsx("div", { className: nx.newPerkBackground }),
      m
        ? b.jsx("div", { className: nx.icon })
        : b.jsx(we, { className: nx.icon, path: `tankmen.skills.big.${t}` }),
      Hb.includes(p) && b.jsx("div", { className: nx.disabledOverlay }),
    ],
  });
}
const ix = "Row_94492f2a",
  ox = "Row_training_87a055fa",
  lx = "Row_trainingIcon_478b64c1",
  cx = "Row_container_6520803b",
  dx = "Row_container__compression_f3e2cd48",
  ux = "Row_currentProgress_4c0ce954",
  mx = te.resolve("strings");
function px({
  perks: e,
  bonusPerk: t = !1,
  quickTraining: a,
    ...
    children: [
      e.map((a, s) =>
        b.jsx(
          "div",
          {
            className: C(cx, e.length > 6 && 8 !== s && dx),
            children: b.jsx(rx, { ...a, index: s, bonusPerk: t }),
          },
          s,
        ),
      ),
      ...
      !t &&
        ...
        b.jsx(Sa, {
          params: {
            header: mx.readOrEmpty("crew_widget.tooltip.buttonsBar.acceleratedTraining_on.header"),
            body: mx.readOrEmpty("crew_widget.tooltip.buttonsBar.acceleratedTraining_on.body"),
          },
          className: ox,
          children: b.jsx("div", { className: lx }),
        }),
    ],
  });
}
...
function hx({ tankman: e, className: t }) {
  const { slotState: a } = nb();
  return b.jsxs("div", {
    className: C(_x.base, t),
    children: [
      a &&
        a !== kb &&
        b.jsx(Jb, {
          className: _x.efficiency,
      ...
      b.jsxs("div", {
        ...
        children: [
          ...
          e.bonusPerks.length > 0 &&
            b.jsx(px, {
              className: C(_x.row, _x.row__bonus),
              perks: $b(e),
...
const gx = "Slot_tooltipArea_cfc61e36",
  fx = "Slot_823ddf0",
  vx = "Slot_base__disabled_d386066c",
  bx = "Slot_base__bonusPerk_37755a1",
  xx = "Slot_block_5a0436c4",
  yx = "Slot_block__empty_891e9635",
  Cx = "Slot_perks_658d46a",
  wx = "Slot_perks__warning_de96a8ff",
  Nx = "Slot_vehicleInfo_b3de9df4",
  jx = "Slot_vehicleInfo__active_c2f01f1b",
  Ix = "Slot_overlay_a7b614c0",
  kx = "Slot_overlay__active_4dbffa31",
  Sx = "Slot_overlay__bonusPerk_7bdbfd9e",
  Ex = "Slot_overlay__hover_b85ae7f7",
  Px = "Slot_overlay__warning_8fedfb92",
  Mx = "Slot_overlay__disabled_cd31780",
  Ax = te.resolve("aliases"),
  Lx = k(function ({ tankmanId: e, roles: t, id: a, tankmanAnimation: s }) {
    const [n, r] = g.useState(!1),
      i = be(),
      { model: o, controls: l } = eb(),
    ...
    return b.jsx(sb.Provider, {
      value: y,
      children: b.jsxs("div", {
        onMouseDown: v?.onMouseDown,
        onMouseEnter: function () {
          (!c && y && i.play("mouse-enter", { target: "crew-widget:slot:mouse-enter" }), r(!0));
        },
        onMouseLeave: () => r(!1),
        onClick: function () {
          c || (i.play("click", { target: "crew-widget:slot" }), l.openCrew(a));
        },
        className: C(fx, c && vx, t.length > 1 && bx),
        children: [
          m &&
            b.jsx(Ia, {
              params: { resId: Ax.read((e) => e.hangar.shared.Crew("resId")), args: x },
              className: gx,
            }),
          b.jsx("div", { className: C(Ix, Ex, n && kx) }),
          b.jsx("div", { className: C(Ix, Px, f && kx) }),
          b.jsx(yb, {
          ...
          b.jsxs("div", {
            ...
            children: [
              ...
              p
                ? b.jsx(hx, { tankman: p, className: C(Cx, f && wx) })
                : b.jsx(Ue, {
                    upgradeLegacy: !0,
                    className: C(Nx, n && jx),
                    path: `crew_widget.vehicleWithName.${Ma(d)}`,
                    params: { name: u.replace(/<img.*?>/, "") },
                  }),
            ],
          }),
          b.jsx("div", { className: C(Ix, Mx, c && kx, p?.bonusPerks.length && Sx) }),
        ],
      }),
    });
  }),
  Dx = "CrewWidget_647da81c",
  Tx = "CrewWidget_divider_1cced5f6",
  Bx = k(function ({ className: e }) {
    const { model: t } = eb(),
      a = t.withDog.get(),
      s = t.computes.slots(),
      [n, r] = N(
            ...
            b.jsxs(
              "div",
              {
                children: [
                  ...
                  b.jsx("div", { className: Tx }),
                ],
              },
              e.id,
            ),
          ),
          a && b.jsxs(b.Fragment, { children: [b.jsx(Nb, {}), b.jsx("div", { className: Tx })] }),
        ],
      })
    );
  }),
  Vx = te.resolve("aliases");
function Rx({ className: e }) {
  return b.jsx(Jv, {
    options: { rootId: Vx.read((e) => e.hangar.shared.Crew("resId")) },
    children: b.jsx(Bx, { className: e }),
  });
}
const Ox = "Divider_9939af4b";
function zx(e) {
  return b.jsx(we, { path: "ui.noise", className: C(Ox, e.className), fit: "cover" });
}
function Hx({ children: e, className: t }) {
  ...
  return a.length <= 1
    ...
    : b.jsx(b.Fragment, {
        children: a
          .filter((e) => e)
          .map((e, a) =>
            b.jsxs(y.Fragment, { children: [a > 0 && b.jsx(zx, { className: t }), e] }, a),
          ),
      });
}
const Fx = w(function (e) {
    const t = Rr(),
      a = t.tooltipHeaderMap ?? En,
      s = t.tooltipBodyMap ?? Pn,
      n = te.resolve("strings"),
      r =
        e.tooltip.body !== kn
          ? n.readOrEmpty(`tank_carousel_filter.tooltip.${s[e.tooltip.body]}.body`)
          : "",
      i = Ie({ header: n.readOrEmpty(`${a[e.tooltip.header]}`), body: r });
    return b.jsx(qx, { ...e, tooltip: e.tooltip.body !== kn && i });
  }),
  qx = w(function (e) {
    const t = Rr(),
      a = t.filters.get(),
    ...
    return b.jsx(xe, {
      ...
      theme: ye.primary,
      size: Ce.extraSmall,
      className: C(Or.toggle, s && Or.toggle__activated, e.className),
      activated: s,
      onClick: () => {
        (t.change(e.event), e.tooltip && e.tooltip.onClick());
      },
...
function Ux(e) {
  return b.jsx("div", {
    className: C(Or.toggleContainer, e.className),
    children: An.map((e) =>
      b.jsx(
        Fx,
        {
          tooltip: { header: e, body: jn },
          event: { type: "role", role: e },
          children: b.jsx(Ze, { roleKey: e, size: Ze.sizes.x24x24, className: Or.icon }),
        },
        e,
      ),
    ),
...
function Wx(e) {
  return b.jsx("div", {
    className: C(Or.toggleContainer, Or.toggleContainer__type, e.className),
    children: Dn.map((e) =>
      b.jsx(
        Fx,
        {
          tooltip: { header: e, body: In },
          event: { field: Bn, type: "regular", value: e },
  ...
  return b.jsx("div", {
    ...
    children: e.orderedNations.map((e) =>
      b.jsx(
        Fx,
        {
          tooltip: { header: e, body: Sn },
          event: { field: Vn, type: "regular", value: e },
          children: b.jsx("div", {
            className: Or.nationWrapper,
            children: b.jsx(we, { className: Or.nationIcon, path: `flags.c_60x40.${e}` }),
          }),
        },
        e,
      ),
  ...
  return b.jsx("div", {
    ...
    children: Tn.map((e) =>
      b.jsx(
        Fx,
        {
          tooltip: { header: "tier", body: kn },
          event: { field: Rn, type: "regular", value: `level_${e}` },
          children: b.jsx(Aa, { className: Or.vehicleLevel, value: e }),
        },
        e,
      ),
    ),
...
function Gx(e) {
  ...
  return b.jsx(
    Fx,
    {
      ...
      event: { field: On, type: "regular", value: e.special },
      children: b.jsx(we, {
        className: C(Or.specialsIcons, "favorite" === e.special && Or.specialsIcons__favorite),
        path: t,
      }),
    },
    e.special,
...
function Xx() {
  ...
  return b.jsx(Fx, {
    tooltip: { header: Mn, body: Mn },
    event: { field: zn, type: "regular", value: Mn },
    children: b.jsx(we, { className: Or.specialsIcons, path: e }),
  });
}
const Kx = w(function (e) {
  const t = Rr(),
    a = t.specialIds ?? Ln,
    s = Sr(),
    n = s.model.bpState.active.get(),
  ...
  return b.jsxs("div", {
    className: C(Or.toggleContainer, e.className),
    children: [
      c.map((e) => b.jsx(Gx, { imagePath: t.imagesMap?.[e] ?? e, special: e }, e)),
      n && b.jsx(Xx, {}),
      e.children,
    ],
  });
...
function Yx({ fieldClassName: e, value: t, ...a }) {
  const s = te.resolve("strings");
  return b.jsxs(Ge.Provider, {
    value: t,
    children: [
      b.jsx(Qx, {}),
      b.jsxs(Ge.Decoration, {
        className: C(Or.search, a.className),
        children: [
          b.jsx(Ge.Icon, { icon: Ge.icons.search }),
          b.jsx(Ge.Field, {
            ...a,
...
function Jx({ current: e, total: t, className: a }) {
  const s = te.resolve("intl"),
    n = te.resolve("strings");
  return b.jsxs(Oe.Header, {
    className: C(Or.header, a),
    children: [
      b.jsx(Oe.Title, { children: b.jsx(Ue, { path: "tank_carousel_filter.popover.title" }) }),
      b.jsx(Oe.Subtitle, {
        children: b.jsx(Ue, {
...
const ey = g.memo(function (e) {
    return b.jsxs(ty, {
      ...e,
      className: e.className ?? Or.scroll,
      children: [
        b.jsx(Ue, { className: Or.category, path: "tank_carousel_filter.popover.label.specials" }),
        b.jsx(Kx, { children: e.children }),
      ],
    });
  }),
  ty = g.memo(function (e) {
    return b.jsx(He, {
      children: b.jsxs(We, {
        className: e.className,
        barClassNames: e.barClassNames,
        ...
        children: [
          ...
          b.jsx(Ux, {}),
          b.jsx(Ue, { className: Or.category, path: "tank_carousel_filter.popover.label.nations" }),
          b.jsx($x, { orderedNations: e.orderedNations }),
          b.jsx(Ue, { className: Or.category, path: "tank_carousel_filter.popover.label.levels" }),
          b.jsx(Zx, {}),
          e.children,
        ],
      }),
  ...
  sy = w(function () {
    const e = Sr(),
      t = e.model.vehicles.amount(),
      a = e.model.current.amount();
    return b.jsx(Jx, { current: a, total: t });
  }),
  ny = w(function ({ classNames: e }) {
    const t = te.resolve("strings"),
      a = Sr(),
      s = a.model.vehicles.amount(),
      n = a.model.current.amount(),
            ...
            b.jsxs("div", {
              ...
              children: [
                b.jsx(Hr, {
                  ...
                  children: b.jsx(we, {
                    className: C(Or.carouselIcon, 2 === a && Or.carouselIcon__active),
                    path: "hangar.filter.carousel_selector",
                  }),
                }),
                b.jsx("div", { ...r, className: Or.searchInputWrapper, children: b.jsx(ay, {}) }),
              ],
            }),
          ],
        }),
  ...
  iy = w(function ({
    ...
    return b.jsx(Vr.Provider, {
      ...
      children: b.jsx("div", {
        ...
        children: b.jsxs(Oe, {
          children: [
            b.jsx(ny, { classNames: { trigger: a?.trigger, content: a?.triggerContent } }),
            b.jsx(Oe.Portal, {
              lazy: !0,
              position: t,
              pivot: e,
              children: b.jsx(ze, {
                children: b.jsx(Oe.Display, { className: Or.popover, children: n }),
              }),
            }),
          ],
        }),
  ...
  oy = w(function (e) {
    ...
    return b.jsxs(iy, {
      ...
      children: [
        ...
        b.jsx(sy, {}),
        b.jsx(ly, {}),
        b.jsx(ry, { children: b.jsx(ey, { orderedNations: t }) }),
      ],
    });
  }),
  ly = w(function () {
  ...
  uy = "Header_1ce47eda",
  my = "Header_base__ttcDisabled_bc60795e",
  py = "Header_title_ae11a84e",
  _y = "Header_playlist_2dc961b7",
  hy = "Header_toggles_ecb415bd",
  gy = "Header_toggle_a0b149a9",
  fy = "Header_text_aace6b88",
  vy = "Header_icon_dbebe5f6",
  by = "Header_editPlaylist_86a9c19a",
  xy = "Header_divider_696b4d0d",
  yy = te.resolve("strings"),
  Cy = k(function (e) {
    const t = kp(),
      a = t?.model.computed.ttcEnabled();
    return b.jsxs("div", {
      className: C(uy, !a && my, e.className),
      children: [b.jsx(wy, {}), b.jsx(Ny, {})],
    });
  }),
  wy = k(function () {
    const e = kp(),
            ...
            b.jsxs(Hx, {
              ...
              children: [
                b.jsx(Zi, {
                  alertSize: "lg",
                  className: _y,
                  fallback: b.jsx(Ue, { className: _y, path: "pages.titles.allVehicles" }),
                  limit: i.letterLimit,
                }),
                void 0 !== r && b.jsx(si, { id: r, className: by }),
              ],
            }),
          ],
        }),
      ...
      ? b.jsxs("div", {
          ...
          children: [
            b.jsxs(xe, {
              ...
              className: gy,
              children: [
                b.jsx(cy, { className: vy }),
                b.jsx("div", {
                  className: fy,
                  children: yy.readOrEmpty("hangar.myVehicles.buttons.crewToggle"),
                }),
              ],
            }),
            b.jsxs(xe, {
              ...
              className: gy,
              children: [
                b.jsx(dy, { className: vy }),
                b.jsx("div", {
                  className: fy,
                  children: yy.readOrEmpty("hangar.myVehicles.buttons.ttcToggle"),
                }),
              ],
            }),
          ],
  ...
  Iy = { paths: ["/:hangar/"], exact: !1 },
  ky = Ta(Np, { rootId: te.resolve("aliases").read((e) => e.hangar.shared.Settings("resId")) });
k(function () {
  Ay();
  const e = Sr();
  return b.jsx(ky, {
    ...
    children: b.jsx(Py, {
      children: b.jsxs(Ey, {
        children: [b.jsx(Cy, {}), b.jsx(My, {}), b.jsx(Kv, { className: jy.emptyMessage })],
      }),
    }),
  });
});
const Sy = k(function (e) {
    const t = kp();
    return t?.model.computed.crewEnabled()
      ? b.jsx("div", {
          className: C(jy.crewColumn, e.className),
          children: b.jsx(Rx, { className: jy.crewWidget }),
        })
      : null;
  }),
  Ey = function (e) {
    return b.jsxs("div", {
      className: C(jy.crewWrapper, e.className),
      children: [b.jsx(Sy, {}), b.jsx("div", { className: jy.content, children: e.children })],
    });
  },
  Py = k(function (e) {
    const t = kp(),
    ...
    return b.jsx(Cg, {
      classNames: {
        base: C(jy.wrapper, !a && jy.wrapper__crewDisabled, !s && jy.wrapper__ttcDisabled),
        info: C(jy.wrapperInfo, !s && jy.wrapperInfo__ttcDisabled),
        content: C(jy.wrapperContent, s && jy.wrapperContent__ttc),
      },
      children: e.children,
    });
  }),
  My = k(function (e) {
    const t = Sr().model.selectedVehicle(),
      a = kp(),
      s = g.useContext(xg),
      n = (() => {
    ...
    return b.jsx("div", {
      className: C(jy.listWrapper, !t && jy.listWrapper__empty, e.className),
      children: b.jsx(He, { children: b.jsx(Wv, { extraColumns: n }) }),
    });
  });
function Ay(e) {
  const t = Ee(),
  ...
  (Va(n ? Ht.SPACE : Ht.NONE, (e) => {
    (a.play("hot-key", { target: "hangar:all_vehicles:all_vehicles", original: e }), r());
  }),
    va(n ? Ht.ESCAPE : Ht.NONE, () => {
      r();
    }));
}
const Ly = "Header_1ce47eda",
  Dy = "Header_base__ttcDisabled_bc60795e",
  Ty = "Header_title_ae11a84e",
  By = "Header_playlist_8759383d",
  Vy = v(function (e) {
    const t = kp(),
      a = t?.model.computed.ttcEnabled();
    return b.jsxs("div", {
      className: C(Ly, !a && Dy, e.className),
      children: [b.jsx(Ry, {}), b.jsx(Ny, {})],
    });
  }),
  Ry = v(function () {
    const e = kp(),
        ...
        b.jsxs(Oe, {
          children: [
            ...
            b.jsx(Zi, {
              alertSize: "lg",
              className: By,
              fallback: b.jsx(Ue, { className: By, path: "pages.titles.allVehicles" }),
              limit: n.letterLimit,
            }),
          ],
        }),
...
function Hy() {
  ...
  return b.jsx("div", {
    ...
    children: b.jsx(ky, {
      ...
      children: b.jsx(Py, {
        children: b.jsxs(Ey, {
          children: [b.jsx(Vy, {}), b.jsx(My, {}), b.jsx(Kv, { className: zy })],
        }),
      }),
    }),
  });
}
const Fy = "Background_blackScreen_8059ab48",
  qy = "Background_video_b750298c",
  Uy = "Background_backgroundComponent_3b6d25c7",
  Wy = "Background_slideWrapper_6ecb9d33",
  $y = "Background_slideWrapper__blur_d29995f3",
  Zy = "Background_slideWrapper__unblur_131674f0",
  Gy = "Background_content_f712e555",
  Xy = "Background_content__switchShake_ffdcccaf",
  Ky = "Background_blackScreen__show_7f14a6c7",
  Qy = "Background_blackScreen__hide_e9f8dfb3",
  Yy = "Background_video__hide_e9f8dfb3",
  Jy = "Background_video__show_7f14a6c7",
  eC = y.memo(function ({
    baseRef: e,
    activeIndex: t,
    isAnimationStart: a,
      ...
      b.jsx("div", {
        ...
        children: b.jsxs("div", {
          ...
          children: [
            ...
            b.jsx("div", { className: C(Fy, a ? Ky : Qy) }),
            b.jsx(Cn, {
              src: R.videos.last_stand.slide_overlay(),
              className: C(qy, s ? Jy : Yy),
              paused: !s,
              rotated: a,
            }),
          ],
  ...
  oC = 245,
  lC = {
    default: { single: iC, double: iC },
    breakpoints: {
      medium: { single: 224 },
      large: { single: oC, double: oC },
      extraLarge: { single: 302 },
    },
  },
  cC = { empty: "ActiveSlots_empty_9aab1ce1" };
function dC({ width: e, className: t }) {
  return b.jsx("div", {
    ...
    children: b.jsx(Mf, {
      className: t,
      style: { width: `${e}px` },
      children: b.jsx("div", { className: cC.vehicleSlot }),
    }),
  });
}
const uC = {
...
function mC({ direction: e, className: t, ...a }) {
  return b.jsx(ge, {
    ...a,
    classNames: {
      base: C(uC.button, uC[`button__${e}`], t),
    ...
    children: b.jsx(we, { path: "hangar.carousel.buttonArrow", className: uC.icon }),
  });
}
mC.direction = { right: "right", left: "left" };
const pC = {
...
function hC({ itemWidth: e, api: t, children: a }) {
  ...
  return b.jsxs("div", {
    className: pC.navButtonWrapper,
    children: [
      b.jsx(mC, {
        direction: mC.direction.left,
        onMouseDown: _C(() => p(-1)),
        onMouseUp: _,
        onMouseLeave: _,
        className: C(pC.navButton, pC.navButton__left, u && pC.navButton__hidden),
      }),
      b.jsx("div", {
        className: C(
          pC.mask,
          pC[`mask__${((h = c), (f = d), h || f ? (h ? (f ? rC : sC) : aC) : nC)}`],
        ),
        children: a,
      }),
      b.jsx(mC, {
        direction: mC.direction.right,
        onMouseDown: _C(() => p(1)),
        onMouseUp: _,
        onMouseLeave: _,
        className: C(pC.navButton, pC.navButton__right, m && pC.navButton__hidden),
      }),
    ],
  });
  var h, f;
}
const gC = { base: "CarouselScroll_3690a837", areaContent: "CarouselScroll_areaContent_f5dd7772" },
  fC = "dragging",
  vC = "idle";
function bC({
  api: e,
  ...
  const { animationScroll: o, applyScroll: l, setDisabled: c } = e,
    d = Ra(e, za.horizontal, void 0, { gapBeforeStart: 5 });
  return (
    g.useEffect(() => {
      i?.(d.type === fC);
    }, [d.type, i]),
    ...
    g.useEffect(
      () =>
        Ve(() => {
          d.type === vC && o.scrollPosition.idle && l(o.scrollPosition.get());
        }),
      [o.scrollPosition, d, l],
    ),
    b.jsx("div", {
      className: C(gC.base, a),
      children: b.jsxs(Oa, {
        className: s?.base,
        classNames: {
          wrapper: C(gC.areaWrapper, s?.wrapper),
          content: C(gC.areaContent, s?.content),
        },
        children: [t, n],
      }),
    })
...
const xC = "CarouselSkeleton_1ac002e3",
  yC = "CarouselSkeleton_content_b18f8dd7",
  CC = "CarouselSkeleton_scroll_badf82c7";
function wC(e) {
  return b.jsx("div", { ...e, className: C(yC, e.className) });
}
function NC({
  api: e,
  widthElement: t,
  ...
  return b.jsx("div", {
    ...
    children: b.jsx(hC, {
      ...
      children: b.jsx(xa, {
        ...
        totalElements: a,
        wrappers: { Content: wC },
        className: C(CC, i?.scroll),
        renderScroll: (t) =>
          b.jsx(bC, { ...t, api: e, disabled: s, onDraggingState: n, children: t.children }),
        renderElement: (e) => (r ? r(e) : b.jsx(dC, { className: i?.element, width: t })),
      }),
    }),
  });
}
function jC({ api: e, carouselRows: t }) {
  const a = (function (e) {
      const t = Da(lC.default, lC.breakpoints);
      return at(2 === e ? t.double : t.single);
    })(t),
  ...
  return (
    g.useLayoutEffect(() => {
      ...
      s();
      return new Yt().add(e.events.on("resizeHandled", s)).add(e.events.on("recalculateContent", s))
        .dispose;
    }, [e, a, t]),
    s
  );
}
const IC = "Card_e79008fd",
  kC = "Card_base__double_f8b7f334",
  SC = "Card_content_a6141b08",
  EC = "Card_storyPoint_8a1ca16d",
  PC = "Card_storyPoint__double_a0605ebf",
  MC = "Card_storyPoint__selected_d7c0931a",
  AC = te.resolve("views"),
...
function BC({
  ...
  const [i, o] = g.useState(n),
    ...
    m = et({
      resId: LC.read((e) => e.hangar.shared.VehiclesInventory("resId")),
      contentId: AC.read((e) => e.mono.hangar.vehicle_tooltip("resId")),
      args: y.useMemo(() => ({ inventoryId: e?.inventoryId }), [e?.inventoryId]),
    }),
    p = et({
          ...
          children: [
            d.model.get(e.id)?.isActive &&
              b.jsx("div", {
                ...p,
                children: b.jsx(xn, {
                  classNames: { base: C(EC, s && PC, a && MC) },
                  size: xn.sizes.s24x24,
                }),
              }),
            b.jsxs("div", {
              ...m,
...
function RC({ width: e, className: t }) {
  return b.jsx("div", {
    className: VC.empty,
    children: b.jsx(Mf, {
      className: t,
      style: { width: `${e}px` },
      children: b.jsx("div", { className: VC.vehicleSlot }),
    }),
  });
}
function OC({ slotId: e, width: t, currentVehicleId: a, double: s, className: n }) {
  return void 0 === e
    ? null
    : Ig(e)
      ? b.jsx(qf, { className: C(Lv, n), type: e, width: t, doubleRow: s })
      : e === zp
        ? b.jsx(RC, { className: C(Lv, n), width: t })
        : b.jsx(DC, {
            vehicleId: e,
            selected: e === a,
            doubleRow: s,
...
function zC({ chunkedSlots: e, classNames: t, ...a }) {
  return void 0 === e
    ? null
    : b.jsx("div", {
        className: VC.doubleSlots,
        children: e.map((e, s) =>
          b.jsx(OC, { ...a, slotId: e, className: C(VC.slot__double, t?.slot) }, s),
        ),
      });
}
const HC = "Carousel_draggingOverlay_2ac699b0",
  FC = "Carousel_9b3e04da",
  qC = "Carousel_base__visible_24d53d12",
  UC = "Carousel_card_5449ec9a",
  WC = "Carousel_card__inactive_c59331d9",
  $C = v(function () {
    const [e, t] = g.useState(!1),
      { api: a } = Ha(),
      s = Sr(),
      n = Qn().model.carouselRowCount.get(),
      ...
      { currentIndex: d } = kg(o, c?.id),
      u = s.model.slots.recover.get(),
      { carouselRows: m, cardWidth: p, visibleSlots: _ } = jC({ api: a, carouselRows: n }),
      { activeSlotsAmount: h, activeSlotsIds: f } = (function (e, t, a, s) {
        return g.useMemo(() => {
          ...
          return {
            activeSlotsAmount: r,
            activeSlotsIds: [...n.left, ...e, ...n.right, ...Array(i).fill(tC)],
          };
        }, [a, e, t, s]);
      })(o, _, u, i),
      v =
        ...
        g.useMemo(() => {
          ...
          return (1 === e.at(-1)?.length && e.at(-1)?.push(tC), e);
        }, [x]));
    var x;
    (g.useEffect(() => {
      const e = Fa(500, !0, () =>
      ...
      })(d, l, s.controls.select, m, 0 === o.length || r));
    ...
    return b.jsxs(b.Fragment, {
      children: [
        b.jsx(NC, {
          ...
          disabled: _ > h,
          onDraggingState: t,
          classNames: { base: C(FC, y && qC), element: C(UC, e && WC) },
          renderElement: (t) => {
            const a = C(UC, e && WC);
            return 2 === m
              ? b.jsx(Vt, {
                  failure: () => b.jsx(RC, { className: a, width: p }),
                  children: b.jsx(
                    zC,
                    {
                      chunkedSlots: v[t],
        ...
        A.createPortal(e && b.jsx("div", { className: HC }), document.body),
      ],
    });
  }),
  ZC = (function () {
  ...
  KC = "EntryPoint_753f2d36",
  QC = "EntryPoint_content_86a8cd1c",
  YC = g.lazy(() =>
    XC(() => import("../../../chunks/entry_point.js"), __vite__mapDeps([0, 1]), import.meta.url),
  );
function JC() {
  ...
  return b.jsx(he, {
    ...
    children: b.jsx(g.Suspense, {
      children: b.jsx("div", {
        className: KC,
        children: b.jsx("div", { className: QC, children: b.jsx(YC, {}) }),
      }),
    }),
  });
}
const ew = g.memo(function ({ lootBoxEntryEnabled: e }) {
    return b.jsxs(Vt, { children: [b.jsx(qa, { children: b.jsx($C, {}) }), e && b.jsx(JC, {})] });
  }),
  tw = g.createContext(void 0);
function aw() {
  const e = g.useContext(tw);
  return (
    ne(void 0 !== e, "To use hook useEditPlaylist() please add EditPlaylistProvider Provider"),
    e
  );
}
const sw = w(function ({ id: e, playlistState: a = vr, vehicleIds: s = [], children: n }) {
  const r = yr(),
    [i, o] = g.useState(a === vr),
    l = mr(r.model.byId(e)),
    c = g.useRef(l);
      ...
      return {
        ...
        updateTitle: (t) => {
          s({
            ...
            title: (t =
              0 === (t = t.trim()).length ? lr(r.model.titles(), "playlists.unnamedTemplate") : t),
          });
        },
      };
    function t(e) {
      const t = !(
        c.current && ((a = c.current), (s = e), a.title === s.title && Y.shallow(a.list, s.list))
      );
      var a, s;
  ...
  return (
    ...
    d ? b.jsx(tw.Provider, { value: d, children: n }) : null
  );
});
function nw(e) {
  return b.jsx("svg", {
...
const rw = "PreviewCard_6db624e2",
  iw = "PreviewCard_lacksOverlay_351c6284",
  ow = "PreviewCard_border_b785c03e",
  lw = "PreviewCard_unknownOverlay_1039cb2e",
  cw = "PreviewCard_unknownVehicle_90371983",
  dw = "PreviewCard_about_a93f2c02",
  uw = "PreviewCard_base__lacks_90371983",
  mw = "PreviewCard_content_48ec5d54",
  pw = "PreviewCard_info_b7433b0",
  _w = "PreviewCard_icon_8d50cd85",
  hw = "PreviewCard_aboutText_920fe732",
  gw = "PreviewCard_overlay_10333cbb",
  fw = "PreviewCard_remove_dcd51e1a",
  vw = te.resolve("strings"),
  bw = w(function ({ vehicleId: e, scroll: t, children: a, ...s }) {
    const n = yr(),
    ...
    return b.jsxs("div", {
      ...s,
      className: C(rw, !l && uw, s.className),
      onMouseEnter: function (e) {
      ...
      "data-item-id": e,
      children: [
        b.jsx("div", { className: ow }),
        r
          ? b.jsxs("div", {
              className: mw,
              children: [
                b.jsx(ov, { vehicle: r, doubleRow: !1, active: !0 }),
                b.jsx(xw, { vehicle: r, elite: c }),
              ],
            })
          : b.jsxs("div", {
              className: mw,
              children: [
                b.jsx(Wa, { size: "x380x304", className: cw }),
                b.jsx("div", { className: lw, children: vw.readOrEmpty("playlists.card.unknown") }),
              ],
            }),
        ...
        b.jsxs("div", {
          ...
          children: [
            b.jsx(Pe, {
              ...
              children: b.jsx(Ur, { value: "card_close" }),
            }),
            !l &&
              r &&
              b.jsxs(ge, {
                ...
                children: [
                  b.jsx(nw, { className: _w, width: d, height: d }),
                  b.jsx("span", {
                    className: hw,
                    children: vw.readOrEmpty("playlists.card.about_vehicle"),
                  }),
                ],
              }),
          ],
...
function xw({ vehicle: e, elite: t }) {
  return b.jsxs(Xt, {
    className: pw,
    children: [
      b.jsx(Nv, { elite: t, vehicle: e }),
      b.jsx(Cv, { premium: e.premium, children: e.shortName }),
    ],
  });
}
const yw = {
...
const Cw = w(function () {
    ...
    const i = r.virtualItem.getAttribute("data-drop-area"),
      o = Xa(r.virtualItem.getAttribute("data-drop-item"));
    if (void 0 !== o)
      return b.jsxs("div", {
        className: yw.base,
        ref: s,
        style: { width: 0, height: 0, display: "none" },
        children: [b.jsx(bw, { vehicleId: o, className: yw.item }), b.jsx(ww, { dnd: n })],
      });
    console.warn(`An item with the id ${o} is not found in the container ${i}`);
  }),
  ww = w(function (e) {
    return b.jsx("div", {
      className: C(yw.removeOverlay, !e.dnd.state.overArea && yw.removeOverlay__show),
      children: b.jsx(Ur, { value: "close_48" }),
    });
  }),
  Nw = "Filter_18c313bf",
  jw = "Filter_search_2ab99031",
  Iw = "Filter_searchField_696a1acc",
  kw = "Filter_searchPlaceHolder_1ffe980c",
  Sw = "Filter_trigger_7e59b07e",
  Ew = "Filter_popover_1f6b0cd2",
  Pw = "Filter_header_36310677",
  Mw = "Filter_body_b75e3f7b",
  Aw = "Filter_scroll_aff9469e",
  Lw = w(function () {
    const e = te.resolve("strings"),
      t = Rr(),
      a = t.search.get();
    return b.jsx(Ge.Provider, {
      value: a,
      children: b.jsxs(Ge.Decoration, {
        className: jw,
        children: [
          b.jsx(Ge.Icon, { icon: Ge.icons.search }),
          b.jsx(Ge.Field, {
  ...
  Dw = w(function () {
    ...
    return b.jsx(Oe.Trigger, {
      children: (e) =>
        b.jsx("div", { ...n, className: Sw, children: b.jsx(Fr, { ...e, current: s, total: a }) }),
    });
  }),
  Tw = w(function () {
    const e = yr().model.nationsOrder.get();
    return b.jsxs(Oe.Body, {
      className: Mw,
      children: [
        b.jsx(Oe.Divider, {}),
        b.jsx(ey, { scrollClassNames: { content: Aw }, orderedNations: e }),
      ],
    });
  }),
  Bw = w(function () {
      ...
      children: [
        ...
        b.jsx(Oe.Portal, {
          ...
          children: b.jsx(ze, {
            children: b.jsxs(Oe.Display, {
              className: Ew,
              children: [b.jsx(Oe.Tip, {}), b.jsx(Oe.Close, {}), b.jsx(Bw, {}), b.jsx(Tw, {})],
            }),
          }),
        }),
      ],
  ...
  Rw = "Footer_66922b8b",
  Ow = "Footer_base__manual_fa053ebe",
  zw = "Footer_button_5b899796",
  Hw = {
    default: { size: ge.sizes.extraSmall },
    breakpoints: { medium: { size: ge.sizes.small } },
  },
  Fw = w(function (e) {
    const t = te.resolve("strings"),
      a = Da(Hw.default, Hw.breakpoints),
      s = yr();
    return b.jsxs("div", {
      className: C(Rw, Ow, e.className),
      children: [
        b.jsx(ge, {
    ...
    g.useEffect(() => {
      if (t)
        return new Yt()
          ...
          .add(Ka(window, "mouseup", () => a(void 0))).dispose;
    }, [e, t]),
    {
      onClick: st((e) => {
        e.button === Qa.left && a({ ...e });
      }),
    }
  );
}
const $w = {
  ...
  Zw = w(function ({ id: e, children: t, disabled: a, ...s }) {
    ...
    return b.jsx("div", {
      ...s,
      "data-drop-item": e,
      className: C($w.draggableItem, i === e && $w.draggableItem__dragging, "js-draggable-item"),
      onMouseDown: (e) => {
        a || r.onClick(e);
      },
      children: t,
  ...
  Gw = te.resolve("strings"),
  Xw = [25, 25],
  Kw = w(function (e) {
    const t = yr().model.byIdFull(e.id);
    return (
      ne(
        void 0 !== t,
      ...
      b.jsx(He, {
        children:
          0 === t.list.length
            ? b.jsxs(Yw, {
                className: $w.stateInfo,
                children: [
                  b.jsx("div", {
                    className: $w.title,
                    children: Gw.readOrEmpty("playlists.editScreen.create.title"),
                  }),
                  b.jsx("div", {
                    className: $w.description,
                    children: Gw.readOrEmpty("playlists.editScreen.create.body"),
                  }),
                ],
              })
            : b.jsx(Qw, { playlist: t }),
    ...
    return b.jsx(xa, {
      ...
      renderScroll: (e) =>
        b.jsx("div", {
          ...
          children: b.jsx(We, {
            ...e,
            areaClassName: C($w.area, !s && $w.area__begin, !n && $w.area__end),
            scrollClassNames: { wrapper: $w.scrollWrapper, content: $w.scrollContent },
            children: e.children,
          }),
        }),
      renderElement: (t) => {
        ...
        return b.jsx(Zw, {
          id: a.toString(),
          "data-drop-area": "grid",
          children: b.jsx(bw, { className: $w.card, vehicleId: a }, a),
        });
      },
    });
  }),
  Yw = w(function (e) {
    ...
    return (
      ...
      b.jsxs(Ya.DropArea, {
        ...
        ref: a,
        "data-drop-area": "grid",
        className: C($w.content, n && $w.content__dragging, e.className),
        children: [e.children, b.jsx("div", { className: $w.dndSeparator, ref: s })],
      })
    );
  }),
  Jw = "Background_476ee51e",
  eN = "Background_flag_bc133c8d",
  tN = "Background_vehicle_7973c233",
  aN = "Background_favorite_e48910a";
function sN({ vehicle: e }) {
  const t = te.resolve("images"),
    a = `vehicle.x190x152.${yr().model.vehicleImage(e.vehicleId)}`;
  return b.jsxs("div", {
    className: C(Jw),
    children: [
      b.jsx("div", {
        className: eN,
        style: {
          backgroundImage: `url(${t.readOrEmpty(`hangar.carousel.cards.flags.x400x300.${X(e.nationId)}`)})`,
        },
      }),
      b.jsx("div", {
        className: tN,
      ...
      e.favorite && b.jsx("div", { className: aN }),
    ],
  });
}
const nN = "VehicleInformation_b9ce6636",
  rN = "VehicleInformation_base__selected_49aec79f",
  iN = "VehicleInformation_vehicleInfo_3bdce6bd",
  oN = "VehicleInformation_text_12254eae",
  lN = "VehicleInformation_text__level_2431a30a",
  cN = "VehicleInformation_text__name_90468cf8",
  dN = "VehicleInformation_text__premium_c5399345",
  uN = w(function ({ vehicle: e, selected: t }) {
    const a = yr().model.isElite(e.id),
      s = e.premium;
    return b.jsxs("div", {
      className: C(nN, t && rN),
      children: [
        ...
        b.jsxs(Xt, {
          className: iN,
          children: [
            b.jsx(Xt.Level, { className: C(oN, lN), value: e.level }),
            Kt(e.type) && b.jsx(Xt.Type, { type: e.type, premium: a, size: Xt.Type.sizes.x24x24 }),
            b.jsx(Xt.Name, { className: C(oN, cN, s && dN), children: e.shortName }),
          ],
        }),
      ],
    });
  }),
  mN = "Card_border_aaf47988",
  pN = "Card_content_7f4f270",
  _N = "Card_actionIcon_538a4b93",
  hN = "card_close",
  gN = "card_add",
  fN = Ne("Slot", "Card_a05790e2", {
    variants: {
...
function vN(e) {
  return b.jsx(fN, {
    ...
    empty: !0,
    children: b.jsx("div", { className: mN }),
  });
}
const bN = w(function ({
    vehicle: e,
    ...
    return b.jsxs(fN, {
      ...
      children: [
        b.jsx("div", { className: mN }),
        e &&
          b.jsxs("div", {
            className: pN,
            children: [
              b.jsx(uN, { selected: s, vehicle: e }),
              "" !== _ && b.jsx(Ur, { className: _N, value: h }),
            ],
          }),
      ],
    });
  ...
  xN = "List_4152ee6b",
  yN = "List_draggableItem_b1a74246",
  CN = "List_bar_97761f22",
  wN = "List_base__scrollDisabled_5974b0a7",
  NN = "List_area_b33ed98",
  jN = "List_area__begin_daa99987",
  IN = "List_area__end_9baec685",
  kN = w(function ({ id: e, children: t, disabled: a, soundTarget: s, ...n }) {
    const r = Ww(),
      i = be(),
      o = Za(),
...
const SN = [25, 25],
  EN = w(function (e) {
    const { api: t } = Te(),
      ...
      i = n.model.filtered(),
      o = Da({ height: 48 }, { large: { height: 64 } }),
      l = at(o.height),
      c = aw(),
    ...
    return (
        ...
        function a() {
          ...
          s >= 0
            ? (t.setDisabled(!0),
              ...
              p(Math.ceil(s / l) + 1),
              a.classList.add(wN))
            : (t.setDisabled(!1), p(0), a.classList.remove(wN));
        }
      ...
      b.jsx(xa, {
        ...
        renderScroll: (e) =>
          b.jsx(Re, { ...e, className: C(NN, !a && jN, !s && IN), children: e.children }),
        renderElement: (e) => {
          const a = i[e];
          if (!a) return b.jsx(vN, { height: l });
  ...
  PN = g.memo(function (e) {
    ...
    return b.jsx("div", {
      ...
      children: b.jsxs(He, {
        children: [
          b.jsx(EN, { baseRef: t, id: e.id }),
          b.jsx("div", { className: CN, children: b.jsx(Fe, {}) }),
        ],
      }),
    });
  }),
  MN = "Name_decoration_82a70e4e",
  AN = "Name_placeholder_36222a38";
...
const DN = w(function () {
    const e = aw(),
      ...
      n = st(() => e.updateTitle(a)),
      r = Ja(n, [n], 400);
    return b.jsx(Ge.Provider, {
      value: a,
      children: b.jsx(LN, {
        children: b.jsx(Ge.Field, {
          maxLength: 100,
          classNames: { placeholder: AN },
          onChange: function (e) {
            (s(e.target.value), r());
          },
  ...
  TN = "Edit_2f911444",
  BN = "Edit_side_32fb5102",
  VN = "Edit_base__manual_c860fbd9",
  RN = "Edit_topSide_a248754f",
  ON = "Edit_sideSeparator_8ffe56a3",
  zN = "Edit_main_9d89cd47",
  HN = "Edit_topMain_206241af",
  FN = "Edit_header_c18f180d",
  qN = "Edit_iconTrashCan_80d1a58c",
  UN = "Edit_grid_54c57624",
  WN = "Edit_footer_f4d6b753",
  $N = w(function ({ className: e }) {
    const t = yr(),
      a = aw(),
      s = a.id,
      n = a.playlist(),
      r = te.resolve("strings"),
      i = Za();
    mt(t.controls.filters.reset);
    const o = g.useMemo(
      () => ({
    ...
    return n
      ? b.jsxs(Ya.DragArea, {
          className: C(TN, VN, i.item && "dragging", e),
          children: [
            b.jsxs("div", {
              className: BN,
              children: [
                b.jsx("div", {
                  className: RN,
                  children: b.jsx(Vr.Provider, {
                    value: o,
                    children: b.jsx(Oe, { children: b.jsx(Vw, {}) }),
                  }),
                }),
                b.jsx("div", { className: ON }),
                b.jsx(PN, { id: s }),
              ],
            }),
            b.jsxs("div", {
              ...
              children: [
                  ...
                  children: b.jsxs("div", {
                    ...
                    children: [
                      ...
                      b.jsxs(ge, {
                        ...
                        size: "small",
                        children: [
                          b.jsx(Ur, { className: qN, value: "trash_can" }),
                ...
                b.jsx("div", { className: UN, children: b.jsx(Kw, { id: s }) }),
                b.jsx(Fw, {
                  className: WN,
  ...
  ZN = w(function ({ className: e, ...t }) {
    return b.jsx(sw, {
      ...
      children: b.jsxs(Ya, {
        children: [
          b.jsx($N, { className: e }),
          b.jsx(Ya.VirtualItem, { here: !0, children: b.jsx(Cw, {}) }),
        ],
      }),
    });
  }),
  GN = "EditPlaylist_e665e2a0";
function XN() {
  const e = Ee();
  va(Ht.ESCAPE, () => {
    e.goBack();
  ...
  const t = g.useMemo(() => {
    try {
      return h(br, JSON.parse(e.params));
    } catch (t) {
      return void console.error(t);
    }
  }, [e.params]);
  return t
    ? b.jsx(ZN, { className: GN, ...t })
    : (console.error("Expected params for Edit screen, but got", t), null);
}
const KN = "EditPlaylist_e113984";
function QN() {
  return b.jsx("div", { className: KN, children: b.jsx(XN, {}) });
}
const YN = "optDevices",
  JN = "shells",
  ej = "consumables",
  ...
  lj = "gunner_smoothTurret",
  cj = "driver_virtuoso",
  dj = "driver_smoothDriving",
  uj = "fireFighting",
  mj = "naturalCover",
  pj = "gunner_rancorous",
  _j = "loader_pedant",
  hj = "commander_practical",
  gj = "commander_enemyShotPredictor";
function fj(e) {
  const t = Mt(e, 0);
  if (t) return { name: t.name, special: t.rank === _n.GOLD };
}
function vj(e) {
  return {
...
function xj(e) {
  return {
    ...
    specialization: e.specializations
      ...
      : void 0,
    mainMechanic: e.mechanics ? fj(e.mechanics) : void 0,
  };
  var t, a;
}
const yj = [tj, "battleAbilities"],
  [Cj, wj] = V("AmmunitionPanelModel")(
    (e) => {
      const { observableModel: t } = e,
        ...
        s = O.structural(() => wa(a.groups.get(), (e.initial && e.initial.fromGroupModel) ?? vj)),
        n = O.primitive((e, t) => a.selectedSlot.get() === e && a.selectedSection.get() === t),
        r = O.primitive((e) => a.selectedSection.get() === e),
        i = O.primitive((e) => {
          for (const t of s()) for (const a of t.sections) if (a.name === e) return a.slots.length;
          return 0;
        }),
        o = O.primitive((e) => !yj.includes(e) && r(e) && i(e) > 1),
        l = O.structural(() => {
        ...
        c = O.model((e) => s()[e]),
        d = O.model((e, t) => c(e)?.sections[t]),
        u = O.model((e, t, a) => d(e, t)?.slots[a]);
      return {
        ...a,
        vehicleId: O.primitive(() => {
  ...
  Nj = g.createContext(null);
function jj({ children: e, index: t, sectionName: a }) {
  const s = g.useRef(a),
    n = (function () {
      const e = g.useContext(Nj);
      return (ne(null !== e, "useContext must be used with in GroupContext"), e);
    })(),
    r = g.useRef(n.typeToIndex),
    [i, o] = N(() => ({ from: { x: 0 }, config: { tension: 600, friction: 50 } }));
  return (
    g.useLayoutEffect(() => {
      const e = r.current,
        n = void 0 === e[a];
    ...
    b.jsx(j.div, { style: i, children: e })
  );
}
const [Ij, kj] = V("PresetSwitcherProvider")(
    ({ observableModel: e }) => ({ root: e.object() }),
    ({ externalModel: e }) => ({ switch: e.createCallbackNoArgs("onSwitch") }),
  ),
  Sj = "PresetChanger_51555039",
  Ej = "PresetChanger_button_c38e75d1",
  Pj = "PresetChanger_buttonImg_8ef67256";
function Mj(e) {
  const t = R.aliases.last_stand.shared.PresetsSwitcher("resId"),
    a = g.useMemo(() => ({ rootId: t }), [t]);
  return b.jsx(he, { id: t, children: b.jsx(Ij, { options: a, children: b.jsx(Aj, { ...e }) }) });
}
function Aj({ disabled: e }) {
  const { controls: t } = kj(),
    a = Ie({
  ...
  return b.jsx("div", {
    ...
    children: b.jsx(ge, {
      ...
      children: b.jsx("div", { className: Pj }),
    }),
  });
}
const Lj = "select",
  ...
  Bj = "swap",
  Vj = "demount",
  Rj = "demount_from_setup",
  Oj = "demount_from_setups",
  zj = "destroy",
  Hj = "upgrade",
  Fj = "add_one",
  qj = "drag_drop";
...
function $j(e) {
  return {
    priceID: e.priceID,
    price: Wj(e.price),
    previousPrice: Wj(e.defPrice),
    discount: Wj(e.discount),
  };
}
const Zj = (e) => ({
  ...
  prices: wa(e.price, (e) => Uj(e)),
});
function Gj(e) {
  return { name: e.name, correct: e.isCorrect, clickable: e.isClickable };
}
function Xj(e) {
  return { dynamic: e.isDynamic, specializations: ((t = e.specializations), _e(t, Gj)) };
  var t;
}
function Kj(e) {
  return {
    ...
    highlightType: e.highlightType,
    price: $j(e.price),
    specializations: Xj(e.specializations),
  };
}
function Qj(e) {
  return {
...
const [Yj, Jj] = V("ConsumablesModel")(
  ({ observableModel: e }) => {
    const t = {
        ...e.primitives(["autoloadEnabled", "hasChanges"]),
        consumables: e.arrayClone("consumables"),
        dealData: e.transform((e) => Zj(e), "dealPanel"),
        prices: e.transform((e) => _e(e, Uj), "dealPanel.price"),
      },
      a = O.structural(() => {
      ...
      s = O.primitive(() => wa(t.consumables.get(), Qj)),
      n = O.model((e) => es(s(), (t) => t.intCD === e));
    return { ...t, computes: { consumables: s, consumableById: n, dealData: a } };
  },
  ({ model: e, externalModel: t }) => ({
    unmount: t.createCallback(
      (e, t) => ({ intCD: e, currentSlotId: t, actionType: Dj, type: ej }),
      "onSlotAction",
    ),
    actionSlot: t.createCallback((e) => ({ ...e, type: ej }), "onSlotAction"),
    swapSlots: t.createCallback((e) => ({ ...e, actionType: qj }), "onSlotAction"),
...
function tI(e) {
  return { localeName: e.localeName, values: ((t = e.values), _e(t, eI)) };
  var t;
}
function aI(e) {
  return { title: e.title, items: _e(e.items, tI) };
}
function sI(e) {
  return {
    ...Kj(e),
    ...
    bonuses: aI(e.bonuses),
  };
}
const [nI, rI] = V("EquipmentsModel")(
  ({ observableModel: t }) => {
    const a = {
        standardEquipments: t.transform((e) => _e(e, sI), "simpleEquipments"),
        improvedEquipments: t.transform((e) => _e(e, sI), "deluxEquipments"),
        bountyEquipments: t.transform((e) => _e(e, sI), "trophyEquipments"),
        experimentalEquipments: t.transform((e) => _e(e, sI), "modernizedEquipments"),
        ...
        dealData: t.transform((e) => Zj(e), "dealPanel"),
        prices: t.transform((e) => _e(e, Uj), "dealPanel.price"),
      },
      s = O.structural(() => {
      ...
      n = O.model((e, t) => es(a[t].get(), (t) => t.intCD === e)),
      r = O.model(() => {
        ...
        return 0 === e.size
          ? t
          : (function (e, t) {
              return ts(e, (e) => e.specializations.specializations.some((e) => t.has(e.name)));
            })(t, e);
      });
    return {
      ...a,
  ...
  ({ model: e, externalModel: t }) => ({
    unmount: t.createCallback(
      (e, t) => ({ intCD: e, currentSlotId: t, actionType: Dj, type: YN }),
      "onSlotAction",
    ),
    actionSlot: t.createCallback((e) => ({ ...e, type: YN }), "onSlotAction"),
    swapSlots: t.createCallback((e) => ({ ...e, actionType: qj }), "onSlotAction"),
...
const [oI, lI] = V("InstructionsModel")(
    (a) => {
      const s = {
        ...
        n = {
          ...
          dealData: a.observableModel.transform((e) => Zj(e), "dealPanel"),
          prices: a.observableModel.transform((e) => _e(e, Uj), "dealPanel.price"),
        };
      (a.cleanup(
        t(() => {
          const e = Gt(s.crewInstructions.get(), (e, t) => ((e[t.intCD] = iI(t)), e), {});
          f(() => n.crewInstructions.set(e));
        }),
      ),
        a.cleanup(
          t(() => {
            const e = Gt(s.equipmentInstructions.get(), (e, t) => ((e[t.intCD] = iI(t)), e), {});
            f(() => n.equipmentInstructions.set(e));
          }),
        ),
        a.cleanup(
          t(() => {
            const e = wa(s.equipmentInstructions.get(), (e) => iI(e));
            f(() => n.equipmentInstructionsArray.set(e));
          }),
        ),
        a.cleanup(
          t(() => {
            const e = wa(s.crewInstructions.get(), (e) => iI(e));
            f(() => n.crewInstructionsArray.set(e));
          }),
        ));
      const r = O.structural(() => {
        ...
        o = O.model((e, t) => {
          ...
          return (ne(void 0 !== a, `There is no instructionItems with ${e} intCD`), a);
        });
      return { ...n, computes: { instructionById: i, instructionByIntCD: o, dealData: r } };
    },
    ({ model: e, externalModel: t }) => ({
      unmount: t.createCallback(
        (e, t) => ({ intCD: e, currentSlotId: t, actionType: Dj, type: tj }),
        "onSlotAction",
      ),
      confirm: t.createCallbackNoArgs("dealPanel.onDealConfirmed"),
      cancel: t.createCallbackNoArgs("dealPanel.onDealCancelled"),
      ...
      actionSlot: t.createCallback((e) => ({ ...e, type: tj }), "onSlotAction"),
    }),
  ),
  cI = "notMounted",
  dI = "mounted",
  uI = "mountedMoreThanOne";
function mI(e) {
  return e.isMounted ? (e.isMountedMoreThanOne ? uI : dI) : cI;
}
function pI(e, t) {
  let a = [];
  const s = Mt(e, 0);
  return (
    s &&
      (a = ts(s.values, (e) => !!e.mechanic && e.mechanic !== hn.UNKNOWN).map(
        ({ mechanic: e, state: a }) => {
          const s = es(t, (t) => t.mechanic === e),
            n = s ? s.columnConfigs : void 0,
            r = n ? es(n, (e) => e.state === a) : void 0;
          return {
            mechanic: e,
            state: a,
    ...
    {
      columnDefs: a,
      rows: _e(e, ({ paramName: e, values: t, metricValue: a }) => ({
        paramName: e,
        metricValue: a,
        values: _e(t, ({ state: e, value: t, mechanic: a }) => ({
          state: e,
          value: t,
          mechanic: a,
        })),
...
function _I(e) {
  return {
    ...
    mountedState: mI(e),
    properties: pI(e.propertiesList, e.mechanicsSubtypes),
    itemPrice: Uj(e.itemPrice),
    price: $j(e.price),
    totalPrice: $j(e.totalPrice),
    mainMechanic: fj(e.mechanics),
  };
}
const hI = ["shellCalibration"],
  gI = ["shellCalibration", "lowChargeShot"],
  [fI, vI] = V("ShellsProvider")(
    ({ observableModel: e }) => {
      const t = {
          ...e.primitives({
          ...
          shells: e.transform((e) => _e(e, _I), "shells"),
          dealData: e.transform((e) => Zj(e), "dealPanel"),
          prices: e.transform((e) => _e(e, Uj), "dealPanel.price"),
        },
        a = O.structural(() => {
        ...
        s = O.model((e) => Mt(t.shells.get(), e)),
        n = O.model((e) => es(t.shells.get(), (t) => t.intCD === e)),
        r = O.primitive((e) => void 0 !== es(t.shells.get(), (t) => t.intCD === e)),
        i = O.shallow(() => _e(t.shells.get(), (e) => e.intCD)),
        o = O.primitive(() =>
          as(
            t.shells.get(),
            ({ properties: e }) =>
              e.columnDefs.length > 0 && e.columnDefs.every((e) => !hI.includes(e.mechanic)),
          ),
        ),
        l = O.primitive(() =>
          Math.max(..._e(t.shells.get(), ({ properties: e }) => e.rows.length)),
        );
      return {
        ...t,
        computes: {
    ...
    ({ model: e, externalModel: t }) => ({
      swapSlots: t.createCallback((e) => ({ ...e, actionType: Bj }), "onSlotAction"),
  ...
  bI = g.createContext(null);
const xI = "Animated_90a4d541",
  yI = function ({ children: e, index: t, id: a }) {
    const s = g.useRef(a),
      n = (function () {
        const e = g.useContext(bI);
        return (ne(null !== e, "useContext must be used with in SectionContext"), e);
      })(),
      r = g.useRef(n.idToSlot),
      [i, o] = P(() => ({ from: { x: 0 }, config: { tension: 300, friction: 20 } }));
    return (
      g.useLayoutEffect(() => {
        const e = r.current,
          i = void 0 === e[a];
        ...
        const c = l < t ? -1 : 1;
        o.start({ from: { x: c * at(50) }, to: { x: 0 } });
        const d = Ve(n.onSwiped);
        return () => {
      ...
      b.jsx(M.div, { className: xI, style: i, children: e })
    );
  },
  CI = "equipmentTrophy",
  wI = "equipmentTrophyBasic",
  NI = "equipmentTrophyUpgraded",
  jI = "battleBoosterReplace",
  II = "battleBooster",
  kI = "equipmentPlus",
  SI = "builtInEquipment",
  EI = "equipmentModernized";
function PI(e) {
  switch (e) {
    case ss.extraSmall:
    case ss.small:
...
function AI(e) {
  switch (e) {
    case II:
      return ns.directiveBooster;
    case jI:
      return ns.directiveSubstitute;
    case SI:
      return ns.builtInEquipment;
    case kI:
      return ns.improved;
    case EI:
      return ns.experimental;
    case CI:
    case wI:
    case NI:
      return ns.trophy;
...
const LI = "KEY_NONE",
  ...
  BI = ({ children: e }) => {
    ...
    return b.jsx(TI.Provider, {
      value: s,
      children: b.jsx(DI.Provider, { value: t, children: e }),
    });
  },
  VI = () => g.useContext(DI);
function RI(e, t, a, s) {
...
const OI = k(function ({ children: e, itemPosition: t, itemWidth: a, onDrop: s }) {
  ...
  zI = k(function ({ children: e, onDrop: t, renderDraggingItem: a, dataDropArea: s }) {
    const n = Za(),
      r = g.useRef(null),
      [i, o] = g.useState(0),
      [l, c] = g.useState(0);
    return (
      ...
      b.jsxs(b.Fragment, {
        children: [
          b.jsx(Ya.DragArea, {
            ref: r,
            children: b.jsx(Ya.DropArea, { "data-drop-area": s, children: e }),
          }),
          b.jsx(Ya.VirtualItem, {
            container: r.current ?? void 0,
            children: b.jsx(OI, { itemPosition: i, itemWidth: l, onDrop: t, children: a }),
          }),
        ],
      })
    );
  }),
  HI = function ({ children: e, onDrop: t, renderDraggingItem: a, dataDropArea: s }) {
    return b.jsx(Ya, {
      children: b.jsx(zI, { onDrop: t, renderDraggingItem: a, dataDropArea: s, children: e }),
    });
  },
  FI = "DragAndDrop_draggableItem_e7d74af8",
  qI = "DragAndDrop_draggableItem__dragging_b849a88",
  UI = "DragAndDrop_draggableItem__undraggable_7c876195",
  WI = "DragAndDrop_draggableItem__locked_2b4f1390",
  $I = k(function ({ itemId: e, undraggable: t, className: a, dataDropArea: s, children: n }) {
    const r = Za();
    os(r.reset, [r]);
    ...
    return b.jsx("div", {
      "data-drop-item": e,
      className: C(FI, o && WI, t && UI, l && qI, a),
      "data-drop-area": s,
      onMouseDown: (e) => {
        e.button === Qa.left && (r.start(e), e.preventDefault());
      },
      children: n,
    });
  }),
  ZI = "UnmountButton_442d081e",
  GI = "UnmountButton_base__hover_e2b863f3",
  XI = "UnmountButton_image_5b9a272b";
function KI({ onClick: e, className: t }) {
...
const QI = "Consumable_98851be5",
  YI = "Consumable_slot_523f223e",
  JI = "Consumable_slot__disabled_10fdd4ec",
  ek = "Consumable_slot__grabbing_f0e6559a",
  tk = "Consumable_hotKeyLabel_a0918925",
  ak = "Consumable_text_fd7e74cf",
  sk = "Consumable_unmountButton_43731923",
  nk = "Consumable_unmountButton__hidden_250735bc",
  rk = "Consumable_selectedOverlay_fd3226e6",
  ik = te.resolve("strings"),
  ok = te.resolve("aliases"),
  lk = `${ej}DropArea`,
  ck = k(function ({ slot: e, disabled: t, selected: a, withKey: s = !1, onClick: n }) {
    const r = be(),
      { model: i, controls: o } = Jj(),
      l = wj().model,
      c = Ee(),
      d = VI(),
      u = c.location.endsWith(rj) ? i.computes.consumableById(e.intCD) : e,
      [m, p] = g.useState(!1),
      _ = Da(
        { value: ss.small },
        { large: { value: ss.large }, extraLarge: { value: ss.extraLarge } },
      ),
      h = ik.readOrEmpty(`readable_key_names.${e.keyName}`),
      f = s && h && e.keyName != LI,
      v = qt({
        resId: ok.read((e) => e.hangar.shared.Loadout("resId")),
        args: g.useMemo(() => ({ slotId: e.id, slotType: ej }), [e]),
      }),
      x = g.useMemo(() => ({ disabled: t || void 0 === u?.imageName }), [u?.imageName, t]),
      y = fa(
        c.location.endsWith(rj) ? "tankSetupConsumableSlot" : "tankSetupHangarConsumableSlot",
        g.useMemo(
          () => ({
            intCD: e.intCD,
            slotType: ej,
            ...
            emitterUID: window.subViews.get(ok.read((e) => e.hangar.shared.Consumables("resId")))
              .uid,
          }),
          [e],
        ),
    ...
    return (
      g.useEffect(() => {
        N.item?.getAttribute("data-drop-area") === lk && p(d === e.id);
      }, [N.item, d, e.id]),
      b.jsxs("div", {
        ...v,
        ...w,
        ...
        children: [
          b.jsx(cs, {
            className: C(YI, t && JI, j && ek),
            classNames: { selectedOverlay: rk },
            size: PI(_.value || ss.small),
            hovered: m,
            selected: a,
            disabled: t,
            ...
            onMouseLeave: function () {
              (void 0 !== d && N.item?.getAttribute("data-drop-area") === lk) || p(!1);
            },
            dataDropItem: e.id,
            children: b.jsx(yI, {
              id: e.intCD,
              ...
              children: u?.imageName
                ? b.jsx($I, {
                    undraggable: !l.computes.sectionDraggable(ej),
                    itemId: e.id,
                    dataDropArea: lk,
                    children: b.jsx(ds, {
                      name: u.imageName,
                      size: MI(_.value || ss.small),
                      overlayType: AI(e.overlayType),
                    }),
                  })
                : b.jsx(cs.Empty, {}),
            }),
          ...
          f &&
            b.jsx("div", {
              className: tk,
              children: b.jsx("div", { className: ak, children: b.jsx(Me, { text: h }) }),
            }),
          !e.installed &&
            b.jsx(KI, { onClick: () => o.unmount(e.intCD, e.id), className: C(sk, j && nk) }),
        ],
      })
    );
  }),
  dk = "SpecializationType_9d3d37d7",
  uk = "SpecializationType_icon_91ea8b3b",
  mk = "SpecializationType_icon__visible_ca41ac0a",
  pk = "SpecializationType_icon__active_f79ff1ce",
  _k = "stealth",
  hk = "survivability",
  gk = "firepower",
  fk = "mobility",
...
function yk({ specialization: e, active: t, classNames: a }) {
  const s = xk[`${e}${vk}`],
    n = xk[`${e}${bk}`];
  if (s && n)
    return b.jsxs("div", {
      className: C(dk, a?.base),
      children: [
        b.jsx(s, { className: C(uk, pk, t && mk, a?.activeIcon) }),
        b.jsx(n, { className: C(uk, !t && mk, a?.inactiveIcon) }),
      ],
    });
  console.error(`Unknown specialization type ${e}`);
}
const Ck = "Specialization_border_1d1ddf4e",
  wk = "Specialization_borderImage_2bbc40a2",
  Nk = "Specialization_576f60ad",
  jk = "Specialization_base__button_e1e80f41",
  Ik = "Specialization_border__visible_2df74c11",
  kk = "Specialization_borderImage__visible_258796cf",
  Sk = "Specialization_icon_453cdca5",
  Ek = "Specialization_base__disabled_12d00a3f",
  Pk = "Specialization_base__active_12d00a3f",
  Mk = Ne("Specialization"),
  Ak = k(function ({ specialization: e, className: t, id: a, disabled: s = !1 }) {
    const n = be(),
      { controls: r } = wj(),
    ...
    g.useEffect(() => {
      if (l.current !== a)
        return (
          (l.current = a),
          e.active
            ? Ve(() => n.play("on", { target: "loadout-panel:slot:equipment:specialization" }))
            : void 0
        );
    }, [n, e.active, a]);
    const c = g.useMemo(() => [e.type, e.dynamic, e.clickable], [e]),
      d = ma("hangarSlotSpec", c);
    return b.jsxs(Mk, {
      className: C(Nk, o && jk, s && Ek, e.active && Pk, t),
      onClick: function (e) {
        (d.onClick(),
          o &&
      ...
      children: [
        b.jsx("div", { className: C(Ck, o && Ik) }),
        b.jsx("div", { className: C(wk, o && kk) }),
        b.jsx(yk, { specialization: e.type, active: e.active, classNames: { base: Sk } }),
      ],
    });
  }),
  Lk = "Equipment_cd6073b3",
  Dk = "Equipment_slot_cd6073b3",
  Tk = "Equipment_slot__disabled_13198c7d",
  Bk = "Equipment_slot__grabbing_49feaf7f",
  Vk = "Equipment_specialization_95709e3f",
  Rk = "Equipment_unmountButton_7376ff29",
  Ok = "Equipment_unmountButton__hidden_f9f46440",
  zk = "Equipment_selectedOverlay_866b638b",
...
const Uk = k(function ({ slot: e, disabled: t, selected: a, onClick: s }) {
    const { breakpoint: n } = Ye(),
      ...
      p = qt({
        resId: Hk.read((e) => e.hangar.shared.Loadout("resId")),
        args: g.useMemo(() => ({ slotId: e.id, slotType: YN }), [e]),
      }),
      _ = g.useMemo(() => ({ disabled: t || -1 === e?.intCD }), [e?.intCD, t]),
      h = fa(
        d.location.endsWith(aj)
        ...
        g.useMemo(
          () => ({
            ...
            itemInstalledSetupSlotIdx: e.id,
            isMountedMoreThanOne: e.mountedMoreThanOne,
            emitterUID: window.subViews.get(Hk.read((e) => e.hangar.shared.Equipments("resId")))
              .uid,
          }),
          [e],
        ),
    ...
    return (
      ...
      g.useEffect(() => {
        (x && p?.onMouseLeave(), !x && void 0 !== u && o && p?.onMouseEnter(null));
      }, [u, x, o, p]),
      g.useEffect(() => {
        v.item?.getAttribute("data-drop-area") === Fk && l(u === e.id);
      }, [v.item, u, e.id]),
      b.jsxs("div", {
        className: Lk,
        children: [
          b.jsx("div", {
            ...
            onMouseLeave: function () {
              ((void 0 !== u && v.item?.getAttribute("data-drop-area") === Fk) || l(!1),
                p?.onMouseLeave());
            },
            children: b.jsx(cs, {
              className: C(Dk, t && Tk, x && Bk),
              classNames: { selectedOverlay: zk },
              size: PI(m.value || ss.small),
              hovered: o,
              disabled: t,
              onClick: function (t) {
                !a &&
                  ...
                  e.specialization?.type &&
                    ...
                    c.play("click", { target: qk(e.specialization.type), original: t }),
                  p?.onClick());
              },
              selected: a,
              ...
              children: b.jsx(yI, {
                ...
                children: e.imageName
                  ? b.jsx($I, {
                      undraggable: !i.computes.sectionDraggable(YN),
                      itemId: e.id,
                      dataDropArea: Fk,
                      children: b.jsx(ds, {
                        name: e.imageName,
          ...
          !e.installed &&
            b.jsx(KI, { onClick: () => r.unmount(e.intCD, e.id), className: C(Rk, x && Ok) }),
        ],
      })
    );
  }),
  Wk = "Instuction_ab7d27c7",
  $k = "Instuction_slot_ab7d27c7",
  Zk = "Instuction_slot__disabled_179c0b6b",
  Gk = "Instuction_warningImage_138cc840",
  Xk = "Instuction_warningImage__disabled_7d252f0",
  Kk = "Instuction_selectedOverlay_f19fc301",
  Qk = "Instuction_item_e5ebc3b8",
  Yk = "Instuction_item__withAttention_80199f58",
...
const tS = k(({ slot: e, disabled: t, selected: a, onClick: s }) => {
    const { model: n, controls: r } = lI(),
    ...
    const m = qt({
        ...
        args: g.useMemo(() => ({ slotId: e.id, slotType: tj }), [e]),
      }),
      p = g.useMemo(() => ({ disabled: t || void 0 === i?.imageName }), [i?.imageName, t]),
      _ = fa(
        d.location.endsWith(sj) ? "tankSetupBattleBoosterSlot" : "tankSetupHangarBattleBoosterSlot",
        g.useMemo(
          () => ({
            intCD: e.intCD,
            slotType: tj,
            ...
            isMounted: e.installed,
            isMountedMoreThanOne: e.mountedMoreThanOne,
            emitterUID: window.subViews.get(Jk.read((e) => e.hangar.shared.Instructions("resId")))
              .uid,
          }),
          [e],
        ),
    ...
    return (
      g.useEffect(() => {
        e.installed ||
          ...
          i?.imageName && e.overlayType === jI && c.play("on", { target: eS(i.imageName) }),
      ...
      b.jsxs("div", {
        ...
        children: [
          b.jsx(cs, {
            ...
            selected: a,
            disabled: t,
            size: PI(u.value || ss.small),
            "data-test-id": `instructionSlot-${e.id}`,
            children:
              i?.imageName &&
              b.jsx(ds, {
                className: C(Qk, e.withAttention && Yk),
                name: i.imageName,
                size: MI(u.value || ss.small),
                overlayType: AI(e?.overlayType),
              }),
          }),
          i?.imageName &&
          ...
          !e.installed && b.jsx(KI, { onClick: () => r.unmount(e.intCD, e.id) }),
        ],
      })
    );
  }),
  aS = "Shell_hoverOverlay_714f24ee",
  sS = "Shell_4f8ed17c",
  nS = "Shell_icon_229c2d6f",
  rS = "Shell_base__locked_7aaeeab0",
  iS = "Shell_base__selected_7aaeeab0",
  oS = "Shell_icon__dragging_7aaeeab0",
  lS = "Shell_container_cd11209e",
  cS = "Shell_container__key_d0643ec3",
  dS = "Shell_container__count_25e66fc6",
  uS = "Shell_container__disabled_d9eea9c4",
  mS = "Shell_text_d3fedf21",
  pS = "Shell_text__empty_7aaeeab0",
  _S = "Shell_text__disabled_7aaeeab0",
  hS = "Shell_shellMechanic_9bc785c8",
  gS = "Shell_shellMechanicPosition_bbe64f90",
  fS = "x20x20",
  vS = "x24x24",
  bS = "x40x40";
function xS({ mechanic: e, className: t }) {
  const a = Da({ size: fS }, { extraLarge: { size: vS } }),
    s = ve(a.size, bS);
  return b.jsx("div", {
    className: C(hS, t),
    style: {
  ...
  jS = k(function ({
    ...
    const { model: o } = vI(),
      ...
      m = qt({
        ...
        args: g.useMemo(() => ({ slotId: r.id, slotType: JN }), [r.id]),
      }),
      p = Da({ value: CS }, { large: { value: wS }, extraLarge: { value: NS } }).value,
      _ = g.useMemo(() => ({ disabled: e }), [e]),
      h = fa(
        l.location.endsWith(nj) ? "tankSetupShellItem" : "tankSetupHangarShellSlot",
        g.useMemo(
          () => ({
            intCD: r.intCD,
            slotType: JN,
            ...
            emitterUID: us(yS.read((e) => e.hangar.shared.Shells("resId"))).uid,
            shellsCounts: i,
          }),
          [r, i],
        ),
    ...
    if (!f) return;
    const v = te.resolve("strings").readOrEmpty(`readable_key_names.${r.keyName}`),
      x = a && v && r.keyName !== LI;
    return b.jsxs("div", {
      ...m,
      ...h,
      className: C(sS, u && rS, t && iS, n),
      "data-test-id": `shellSlot-${r.id}`,
      children: [
        x &&
          b.jsx("div", {
            className: C(lS, cS),
            children: b.jsx("div", { className: mS, children: b.jsx(Me, { text: v }) }),
          }),
        b.jsxs(yI, {
          id: r.intCD,
          index: r.id,
            ...
            b.jsx($I, {
              ...
              children: b.jsxs(we, {
                ...
                children: [
                  ...
                  f.mainMechanic &&
                    !gI.includes(f.mainMechanic.name) &&
                    b.jsx(xS, { mechanic: f.mainMechanic, className: gS }),
                ],
              }),
            }),
            void 0 !== f.count && b.jsx(IS, { count: f.count, empty: s, disabled: e }),
          ],
        }),
      ],
    });
  }),
  IS = function ({ count: e, empty: t, disabled: a }) {
    return b.jsx("div", {
      className: C(lS, dS, a && uS),
      children: b.jsx("div", { className: C(mS, a && _S, t && pS), children: e }),
    });
  },
  kS = {
...
function SS({ hovered: e, selected: t }) {
  return b.jsxs(b.Fragment, {
    children: [
      t && b.jsx("div", { className: kS.selectedOverlay }),
      b.jsx(we, { fit: "cover", path: "loadout.shells_warning_glow", className: kS.warningGlow }),
      b.jsx("div", { className: C(kS.warningOverlay, e && !t && kS.warningOverlay__hover) }),
    ],
  });
}
function ES({
  ...
  return b.jsxs(cs, {
    classNames: {
      slot: C(kS.slot, t.warning && !n && kS.slot__customBackground),
      content: kS.content,
      selectedOverlay: kS.selectedSlotOverlay,
    },
    size: PI(d.value || ss.small),
    ...
    onMouseLeave: () => l(!1),
    children: [
      t.warning && b.jsx(SS, { hovered: o && !n, selected: r }),
      e.map((e) =>
        b.jsx(
          jS,
          {
      ...
      t.warning && b.jsx("div", { className: kS.warningOverlay }),
    ],
  });
}
const PS = k(function ({
    ...
    const { model: i } = wj(),
      ...
      d = Da({ value: CS }, { large: { value: wS }, extraLarge: { value: NS } }).value;
    if (!l) return null;
    const u = ts(l.slots ?? [], (e) => e.intCD > 0);
    return b.jsx("div", {
      className: kS.base,
      children: b.jsx(HI, {
        dataDropArea: `${JN}DropArea`,
        ...
        renderDraggingItem: (e) =>
          b.jsxs(we, {
            ...
            children: [
              b.jsx("div", { className: aS }),
              u[e]?.mainMechanic &&
                !gI.includes(u[e].mainMechanic.name) &&
                b.jsx(xS, { mechanic: u[e].mainMechanic, className: gS }),
            ],
          }),
        children: b.jsx(ES, {
          shells: u,
  ...
  MS = "Divider_44f20b3a",
  AS = "Divider_dividerImage_9dcc5cfc";
...
const DS = k(function ({
    ...
    const d = (function ({ slotToComponent: e = OS, sectionType: t = "default" }) {
    ...
    return d
      ? b.jsx(d, {
          ...
          disabled: o,
          selected: l,
          withKey: t === ej && i.computes.isSectionSelected(t),
          onClick: r,
        })
      : null;
  }),
  TS = "AmmunitionPanel_slots_d69454c1",
  BS = k(function ({ groupIndex: e, sectionIndex: t, slotToComponent: a, onClick: s }) {
    const { controls: n } = Jj(),
      { controls: r } = rI(),
      { breakpoint: i } = Ye(),
      o = Da(
          ...
          children: b.jsx(HI, {
            ...
            onDrop: (e, t) => {
              c.type === ej
                ...
                : c.type === YN && r.swapSlots({ leftID: t, rightID: e });
            },
            renderDraggingItem: (e) => {
              const t = c.slots[e];
              if (t)
                return c.type === ej
                  ? b.jsx(ds, {
                      name: t.imageName,
                      size: MI(o.value || ss.small),
                      overlayType: AI(t.overlayType),
                    })
                  : c.type === YN
                    ? b.jsx(ds, {
                        name: t.imageName,
  ...
  VS = te.resolve("aliases"),
  RS = { [JN]: PS, default: BS },
  OS = { [ej]: ck, [tj]: tS, [YN]: Uk },
  zS = (e) => ({ options: { rootId: e } }),
  HS = {
    providersData: [
      { provider: Yj, props: zS(VS.read((e) => e.hangar.shared.Consumables("resId"))) },
      { provider: oI, props: zS(VS.read((e) => e.hangar.shared.Instructions("resId"))) },
      { provider: nI, props: zS(VS.read((e) => e.hangar.shared.Equipments("resId"))) },
      {
        provider: Cj,
        props: {
          options: { rootId: VS.read((e) => e.hangar.shared.Loadout("resId")) },
          initial: {},
        },
      },
      { provider: fI, props: zS(VS.read((e) => e.hangar.shared.Shells("resId"))) },
    ],
    sectionToComponent: RS,
    slotToComponent: OS,
  },
  FS = g.createContext(HS);
function qS({
  sectionToComponent: e = HS.sectionToComponent,
  slotToComponent: t = HS.slotToComponent,
  providersData: a = HS.providersData,
  children: s,
}) {
  const n = g.useMemo(() => ({ sectionToComponent: e, slotToComponent: t }), [e, t]),
    r = new ms().add(BI).addWithProps(FS.Provider, { value: n });
  return (
    a.forEach((e) => {
...
const US = "Section_border_f048a346",
  WS = "Section_borderImage_a85bea48",
  $S = "Section_acf53d2f",
  ZS = "Section_base__battleBoosters_492e7c5f",
  GS = v(function ({ index: e, vehicleId: t, groupIndex: a, onSectionClick: s }) {
    const n = g.useContext(FS),
      { model: r } = wj(),
      i = r.disabled.get(),
    ...
    const u = (function ({ sectionToComponent: e = RS, sectionType: t = "default" }) {
      return e[t] ?? e.default;
    })({ sectionToComponent: n.sectionToComponent, sectionType: o.type });
    return b.jsxs("div", {
      className: C($S, o.type === tj && ZS),
      children: [
        o.type !== JN &&
          b.jsxs(b.Fragment, {
            children: [b.jsx("div", { className: US }), b.jsx("div", { className: WS })],
          }),
        u &&
          b.jsx(bI.Provider, {
            value: d,
  ...
  XS = "AmmunitionPanel_1e2712ac",
  KS = "AmmunitionPanel_group_a19909f2",
  QS = v(function ({ className: e, onSectionClick: t, vehicleId: a }) {
    const { model: s } = wj(),
      n = s.computes.groups(),
      r = g.useMemo(
        () => ({
              ...
              children: dt(
                ...
                (r, l) =>
                  b.jsxs(
                    ...
                    {
                      children: [
                        0 === o && l === n.length - 1 && b.jsx(Mj, { disabled: s.disabled.get() }),
                        b.jsx(jj, {
                          index: l,
                          sectionName: r.name,
                          children: b.jsx(GS, {
  ...
  YS = "Ability_emptyOverlay_4b58118f",
  JS = "Ability_f85eb27a",
  eE = "Ability_slot_6301ffc3",
  tE = "Ability_slot__disabled_28a206fc",
  aE = "Ability_slot__grabbing_48b2b603",
  sE = "Ability_slot__empty_8223f0fe",
  nE = "Ability_hotKeyLabel_cc1f067c",
  rE = "Ability_text_a4e07283",
  iE = "Ability_unmountButton_304e9a8d",
  oE = "Ability_unmountButton__hidden_9ecd6f1",
  lE = "Ability_selectedOverlay_799bff1a",
  cE = "Ability_emptySlot_2bc17d5e",
  dE = "Ability_emptySlot__hovered_913d5cab",
  uE = "Ability_emptyContent_9a9263e5",
  mE = "Ability_emptyContent__hovered_d65f6077",
  pE = te.resolve("strings"),
  _E = te.resolve("aliases"),
  hE = "ls_consumablesDropArea",
  gE = v(function ({ slot: e, disabled: t, selected: a, onClick: s }) {
    const n = be(),
      { model: r, controls: i } = Jj(),
      o = wj().model,
      l = Ee(),
      c = VI(),
      d = l.location.endsWith(TE.LSConsumables) ? r.computes.consumableById(e.intCD) : e,
      [u, m] = g.useState(!1),
      p = Da(
        { value: ss.small },
        { large: { value: ss.large }, extraLarge: { value: ss.extraLarge } },
      ),
      _ = pE.readOrEmpty(`readable_key_names.${e.keyName}`),
      h = DE(l.location) && _ && e.keyName != LI,
      f = qt({
        resId: _E.read((e) => e.hangar.shared.Loadout("resId")),
        args: g.useMemo(() => ({ slotId: e.id, slotType: TE.LSConsumables }), [e]),
      }),
      v = g.useMemo(() => ({ disabled: t || void 0 === d?.imageName }), [d?.imageName, t]),
      x = fa(
        l.location.endsWith(TE.LSConsumables)
          ? "tankSetupConsumableSlot"
          : "tankSetupLSHangarConsumableSlot",
        g.useMemo(
          () => ({
            intCD: e.intCD,
            slotType: TE.LSConsumables,
            fieldType: 1,
            installedSlotId: e.id,
            itemInstalledSetupIdx: e.itemInstalledSetupIdx,
            itemInstalledSetupSlotIdx: e.id,
    ...
    g.useEffect(() => {
      w.item?.getAttribute("data-drop-area") === hE && m(c === e.id);
    }, [w.item, c, e.id]);
    const j = !d?.imageName,
      I = MI(p.value || ss.small),
      k = _s[I];
    return b.jsxs("div", {
      ...f,
      ...y,
      ...
      children: [
        b.jsx(cs, {
          className: C(eE, t && tE, N && aE, j && sE),
          classNames: { selectedOverlay: lE },
          size: PI(p.value || ss.small),
          hovered: u,
          selected: a,
          disabled: t,
          "data-test-id": `equipmentSlot-${e.id}`,
          ...
          onMouseLeave: function () {
            (void 0 !== c && w.item?.getAttribute("data-drop-area") === hE) || m(!1);
          },
          dataDropItem: e.id,
          children: b.jsx(yI, {
            id: e.intCD,
            ...
            children: j
              ? b.jsxs("div", {
                  ...
                  children: [
                    b.jsx("div", { className: YS }),
                    b.jsx(cs.Empty, { className: C(uE, u && mE) }),
                  ],
                })
              : b.jsx($I, {
                  undraggable: !o.computes.sectionDraggable(TE.LSConsumables),
                  itemId: e.id,
                  dataDropArea: hE,
                  children: b.jsx(ds, {
                    name: d.imageName,
        ...
        h &&
          b.jsx("div", {
            className: nE,
            children: b.jsx("div", { className: rE, children: b.jsx(Me, { text: _ }) }),
          }),
        !e.installed &&
          b.jsx(KI, { onClick: () => i.unmount(e.intCD, e.id), className: C(iE, N && oE) }),
      ],
    });
  }),
  fE = "Abilities_warningOverlay_eb2ce40",
  vE = "Abilities_slots_cd2031b9",
  bE = v(function ({ groupIndex: e, sectionIndex: t, slotToComponent: a, onClick: s }) {
    const { controls: n } = Jj(),
      { model: r } = wj(),
      i = Da(
        { value: ss.small },
                ...
                b.jsxs(
                  g.Fragment,
                  {
                    children: [
                      ...
                      o.warning && b.jsx("div", { className: fE }),
                    ],
                  },
                  n.id,
                ),
  ...
  xE = {
    ...
    shellMechanic: "Shell_shellMechanic_bbe64f90",
  ...
  yE = te.resolve("aliases"),
  CE = "small",
  wE = "x64x64",
  NE = "medium",
  jE = v(function ({ selected: e = !1, withKey: t = !1, className: a, slot: s, disabled: n }) {
    const { model: r } = vI(),
      i = Ee(),
      o = qt({
        resId: yE.read((e) => e.hangar.shared.Loadout("resId")),
        args: g.useMemo(() => ({ slotId: s.id, slotType: JN }), [s.id]),
      }),
      l = Da({ value: CE }, { large: { value: wE }, extraLarge: { value: NE } }).value,
      c = g.useMemo(() => ({ disabled: n }), [n]),
      d = fa(
        i.location.endsWith(nj) ? "tankSetupShellItem" : "tankSetupHangarShellSlot",
        g.useMemo(
          () => ({
            intCD: s.intCD,
            slotType: JN,
            ...
            emitterUID: us(yE.read((e) => e.hangar.shared.Shells("resId"))).uid,
          }),
          [s],
        ),
        c,
    ...
    if (!u) return;
    const m = te.resolve("strings").readOrEmpty(`readable_key_names.${s.keyName}`),
      p = DE(i.location) && m && s.keyName !== LI;
    return b.jsxs("div", {
      ...o,
      ...d,
      className: C(xE.base, e && xE.base__selected, a),
      "data-test-id": `shellSlot-${s.id}`,
      children: [
        p &&
          b.jsx("div", {
            className: C(xE.container, xE.container__key),
            children: b.jsx("div", { className: xE.text, children: b.jsx(Me, { text: m }) }),
          }),
        b.jsxs(yI, {
          id: s.intCD,
          index: s.id,
          children: [
            b.jsx($I, {
              ...
              children: b.jsxs(we, {
                ...
                className: xE.icon,
                children: [
                  b.jsx("div", { className: xE.hoverOverlay }),
                  u.mainMechanic &&
                    b.jsx(xS, { mechanic: u.mainMechanic, className: xE.shellMechanic }),
                ],
              }),
            }),
            b.jsx("div", { className: xE.infinity }),
          ],
        }),
      ],
    });
  ...
  IE = "Shells_31052845",
  kE = "Shells_slot_56a45e0f",
  SE = "Shells_slot__customBackground_c8785d51",
  EE = "Shells_shell_7d5bc35b",
  PE = "Shells_content_8e80e668",
  ME = "Shells_selectedSlotOverlay_b0aea0d4";
function AE({
  shells: e,
  section: t,
  groupIndex: a,
  ...
  return b.jsx(cs, {
    classNames: { slot: C(kE, !r && SE), content: PE, selectedOverlay: ME },
    size: PI(c.value || ss.small),
    hovered: !1,
    selected: i,
    disabled: r,
    onClick: function (e) {
      i ||
        r ||
        !o ||
        (o(t.type, { slotIndex: 0, groupIndex: a, sectionIndex: s }),
        l.play("click", { target: "loadout-panel:slot", original: e }));
    },
    children: e.map((e) =>
      b.jsx(jE, { className: EE, selected: i, disabled: r, withKey: n, slot: e, empty: d }, e.id),
    ),
  });
}
const LE = v(function ({
  ...
  const { model: r } = wj(),
    ...
    o = Da({ value: CE }, { large: { value: wE }, extraLarge: { value: NE } }).value;
  if (!i) return null;
  const l = ts(i.slots ?? [], (e) => e.intCD > 0);
  return b.jsx("div", {
    className: IE,
    children: b.jsx(HI, {
      dataDropArea: `${JN}DropArea`,
      renderDraggingItem: (e) =>
        b.jsx(we, {
          ...
          className: C(xE.icon, xE.icon__dragging),
          children: b.jsx("div", { className: xE.hoverOverlay }),
        }),
      children: b.jsx(AE, {
        shells: l,
        section: i,
...
const TE = { LSConsumables: "ls_consumables" },
  BE = { [JN]: LE, [TE.LSConsumables]: bE, default: BS },
  VE = { [YN]: Uk, [tj]: tS, [TE.LSConsumables]: gE },
  RE = {
    providersData: [
      { provider: nI, props: { options: { rootId: R.aliases.hangar.shared.Equipments("resId") } } },
      { provider: fI, props: { options: { rootId: R.aliases.hangar.shared.Shells("resId") } } },
      {
        provider: Yj,
    ...
    sectionToComponent: BE,
    slotToComponent: VE,
  },
  OE = {
    providersData: [...RE.providersData],
    sectionToComponent: { ...RE.sectionToComponent },
    slotToComponent: { ...RE.slotToComponent },
  },
  zE = (e) =>
    g.createElement(
      "svg",
  ...
  HE = "DogPaw_84e7ee48",
  FE = "DogPaw_icon_5261d625",
  qE = te.resolve("strings");
function UE({ onClick: e }) {
  const t = Ie({ body: qE.readOrEmpty("crew.dogPawTooltip.details.body") });
  return b.jsx(ge, {
    ...t,
    theme: ge.themes.secondary,
    size: ge.sizes.small,
    ...
    children: b.jsx(zE, { className: FE }),
  });
}
const WE = "NoTankmanBackground_e7a5353b",
  $E = "NoTankmanBackground_base__hover_be4aa02",
  ZE = "NoTankmanBackground_selectedOverlay_6eff1022",
  GE = "NoTankmanBackground_selectedOverlayPattern_313f5cd4",
  XE = "NoTankmanBackground_pattern_f007ac5a";
function KE({ hover: e, selected: t }) {
  return b.jsxs("div", {
    className: C(WE, e && $E),
    children: [
      t &&
        b.jsxs(b.Fragment, {
          children: [b.jsx("div", { className: ZE }), b.jsx("div", { className: GE })],
        }),
      b.jsx(we, { path: "loadout.crew.no_tankman_pattern", className: XE }),
    ],
  });
}
const QE = {
  ...
  tP = "selected",
  aP = "default";
function sP({ skinId: e, customizedSkin: t }) {
  return e
    ? t
      ? `tankmen.icons.big.crewSkins.${ka(e)}`
      : `tankmen.icons.big.${ka(e)}`
    : "loadout.crew.no_tankman_red";
}
const nP = Ne("Tankman", QE.base),
  rP = g.memo(function ({
    skinId: e,
    customizedSkin: t,
    disabled: a,
    ...
    const c = a ? YE : r ? eP : n ? JE : s ? tP : aP,
      d = !e;
    return b.jsxs(nP, {
      ...l,
      className: C(o, QE[`base__${c}`], i && !a && e && QE.base__hover),
      children: [
        a && b.jsx("div", { className: QE.disabledOverlay }),
        s &&
          b.jsxs(b.Fragment, {
            children: [
              b.jsx("div", { className: QE.selectedOverlay }),
              b.jsx("div", { className: QE.selectedOverlayPattern }),
            ],
          }),
        n && b.jsx("div", { className: QE.warningOverlay }),
        d && !a && b.jsx(KE, { hover: i, selected: s }),
        b.jsx(we, {
          fit: "cover",
          className: C(
            QE.content,
            a && (n || !e ? QE.content__disabledWarning : QE.content__disabled),
          ),
          path: sP({ skinId: e, customizedSkin: t }),
        }),
        d && !a && b.jsx("div", { className: QE.noTankmanOverlay }),
        n &&
          b.jsx(we, { className: QE.warningGlow, fit: "cover", path: "loadout.crew.alert_glow" }),
      ],
    });
  }),
  iP = "Slot_154c229b",
  oP = "Slot_base__noState_71f19f5c",
  lP = "Slot_base__disabled_d386066c",
  cP = "Slot_base__dog_d386066c",
  dP = "Slot_statusBlock_ccea62a7",
  uP = "Slot_statusBlock__dogPaw_1bc38cf2",
  mP = "Slot_statusBlock__disabled_1d609e12",
  pP = "Slot_statusOverlay_e74c1f89",
  _P = "Slot_statusIcon_fe4620f1",
  hP = "Slot_statusIcon__role_3c0a5c22",
  gP = "Slot_statusIcon__untrainedPenalty_2d3a3a74",
  fP = "Slot_retrainingProgress_10d488a1",
  vP = "Slot_newPerk_88d9a967",
  bP = "Slot_newPerk__disabled_1d609e12",
  xP = "Slot_glowBg_e3e687b5",
  yP = te.resolve("strings"),
  CP = "DogSlot",
  wP = Ne("DogSlot", C(iP, cP), { variants: { state: { true: lP } } }),
  NP = k(function () {
    const [e, t] = g.useState(!1),
      a = be(),
      { model: s, controls: n } = eb(),
      r = s.computes.disabled(),
      i = s.vehicleNation.get(),
      o = Ie({
        header: yP.readOrEmpty(`tooltips.hangar.crew.rudy.dog.${i}.header`),
        body: yP.readOrEmpty(`tooltips.hangar.crew.rudy.dog.${i}.body`),
      });
    const l = Ja(() => n.showDogInfo(), [n], 400);
    return b.jsxs(wP, {
      state: r,
      children: [
        b.jsx(rP, {
          ...
          skinId: "ussr_dog_1",
          onClick: function () {
            (r || a.play("dog-slot-click", { target: CP }), o?.onClick());
          },
          onMouseEnter: function (e) {
            (r || (t(!0), a.play("mouse-enter", { target: CP })), o?.onMouseEnter(e));
          },
          onMouseLeave: function () {
            (t(!1), o?.onMouseLeave());
          },
        }),
        b.jsx("div", { className: C(dP, uP, r && mP), children: b.jsx(UE, { onClick: l }) }),
      ],
    });
  }),
  jP = "NewPerk_count_dccb920a",
  IP = "NewPerk_iconPlus_4dc7d532",
  kP = "NewPerk_iconGlow_2e9bc817",
  SP = Ne("NewPerk", "NewPerk_2d8eff13");
function EP({ className: e, count: t, baseRef: a }) {
  return b.jsxs(SP, {
    ref: a,
    className: e,
    children: [
      t > 1 && b.jsx("div", { className: jP, children: t }),
      b.jsx("div", { className: IP, "data-test-id": "newPerk" }),
      b.jsx(we, { path: "loadout.crew.plus_perks_glow", width: 65, height: 68, className: kP }),
    ],
  });
}
const PP = (e) =>
  ...
  MP = "RetrainingProgress_7ce4f314",
  AP = "RetrainingProgress_background_accc6ddf",
  LP = "RetrainingProgress_content_b4685fd0",
  DP = "RetrainingProgress_icon_f4b2dc6",
  TP = te.resolve("intl"),
  BP = Ne("RetrainingProgress", MP);
function VP({ value: e, className: t }) {
  const a = TP.formatNumber("integral", 100 * e);
  return b.jsxs(BP, {
    className: t,
    children: [
      b.jsx("div", { className: AP }),
      b.jsxs("div", {
        className: LP,
        children: [
          b.jsx(PP, { className: DP }),
          b.jsx(Ue, { upgradeLegacy: !0, path: "common.percentValue", params: { value: a } }),
        ],
      }),
    ],
  });
...
const RP = {
  ...
  OP = te.resolve("images"),
  zP = Ne("Perk");
function HP({ value: e, main: t, ...a }) {
  const s = t ? "components.button.default_border_pattern_radius_4" : "loadout.crew.dashed_border";
  return b.jsxs(zP, {
    ...a,
    children: [
      t && b.jsx("div", { className: RP.border }),
      b.jsx("div", {
        className: C(RP.borderImage, t && RP.borderImage__noise),
        style: { borderImageSource: `url(${OP.readOrEmpty(s)})` },
      }),
      e,
    ],
  });
}
const FP = Ne("TankmanLevel", RP.base);
function qP({ perkValue: e, bonusPerkValue: t }) {
  return b.jsxs(FP, {
    children: [
      b.jsx(HP, { className: RP.perk, value: e, main: !0 }),
      void 0 !== t && b.jsx(HP, { className: C(RP.perk, RP.perk__bonus), value: t, main: !1 }),
    ],
  });
}
const UP = (e) =>
...
const GP = k(function ({
    ...
    const [o, l] = g.useState(!1),
      ...
      v = (function (e, t) {
        if (e)
          return e.currentVehicleSkillsEfficiency < 1
            ? e.insideNativeTank || -1 !== e.currentVehicleSkillsEfficiency
              ? ZP.retrainingProgress
              : ZP.unsuitableTankman
            : e.perks.length > 0 || (t && t > 0)
              ? ZP.withPerks
              : ZP.default;
      })(_, f),
      x = v === ZP.retrainingProgress || v === ZP.unsuitableTankman,
      y = _ && h > 0,
      [w, N] = hs();
    const j = fa(
        "crewMember",
      ...
      I = gs(
        "crew_info",
        g.useMemo(
          () => ({ tankman: _ ?? {}, resId: WP.read((e) => e.mono.hangar.tooltips("resId")) }),
          [_],
        ),
    ...
    return b.jsxs("div", {
      ...
      onMouseEnter: function (e) {
        (I.onMouseEnter(e), m || (l(!0), n || c.play("mouse-enter", { target: $P })));
      },
      onMouseLeave: function () {
        (I.onMouseLeave(), l(!1));
      },
      onClick: function () {
        (I.onClick(), m || (c.play("crew-slot-click", { target: $P }), u.openCrew(a), r && r(e)));
      },
      className: C(iP, m && lP, (!v || v === ZP.default || !ZP[v]) && oP),
      "data-test-id": `crewSlot-${e}`,
      children: [
        y &&
          b.jsxs(b.Fragment, {
            children: [
              b.jsx(EP, { baseRef: N, count: h, className: C(vP, m && bP) }),
              !m && b.jsx("div", { className: xP }),
            ],
          }),
        b.jsx(rP, {
          hovered: o && !n,
            ...
            children: (() => {
              if (!_)
                return (
                  ...
                  b.jsxs(b.Fragment, {
                    children: [
                      b.jsx("div", { className: pP }),
                      b.jsx(gn, { className: C(_P, hP), role: s }),
                    ],
                  })
                );
              switch (v) {
                case ZP.unsuitableTankman:
                  return b.jsxs(b.Fragment, {
                    children: [
                      b.jsx("div", { className: pP }),
                      b.jsx(UP, { className: C(_P, gP) }),
                    ],
                  });
                case ZP.retrainingProgress:
                  return b.jsx(VP, { value: _.currentVehicleSkillsEfficiency, className: fP });
                case ZP.withPerks:
                  return b.jsx(qP, { perkValue: _.perks.length, bonusPerkValue: f });
                default:
  ...
  XP = "CrewPanel_border_2ccbfb54",
  KP = "CrewPanel_borderImage_50acd0ba",
  QP = "CrewPanel_slots_57c050b6",
  YP = "CrewPanel_slotWrapper_acbcfc00",
  JP = Ne("CrewPanel", "CrewPanel_82d22bfe"),
  eM = k(
    g.forwardRef(function (e, t) {
      ...
      return b.jsxs(JP, {
        ...
        children: [
          b.jsx("div", { className: XP }),
          b.jsx("div", { className: KP }),
          b.jsxs("div", {
            className: QP,
            children: [
              r.map((e, t) =>
              ...
              i && b.jsxs("div", { className: YP, children: [b.jsx(LS, {}), b.jsx(NP, {})] }),
            ],
          }),
        ],
      });
  ...
  tM = { "crew-slot-click": ot("yes1"), "dog-slot-click": ot("rudy") },
  aM = "LoadoutPanel_crewPanel_b90a22ab",
  sM = new ms().addWithProps(fs, { overrides: tM }),
  nM = { rootId: te.resolve("aliases").read((e) => e.hangar.shared.Crew("resId")) };
function rM() {
  return sM.render(b.jsx(Jv, { options: nM, children: b.jsx(eM, { className: aM }) }));
}
const iM = Ne("LoadoutPanel"),
  oM = g.forwardRef(function ({ children: e, className: t, ...a }, s) {
    return b.jsx(iM, { className: t, ref: s, ...a, children: e });
  }),
  lM = "LoadoutPanel_765a4f59",
  cM = "LoadoutPanel_base__screenMode_2cf03a87",
  dM = "LoadoutPanel_ammunitionPanel_baf41791";
function uM({ className: e, screenMode: t, onClick: a }) {
  const s = { [tj]: yp.instructions, [YN]: yp.equipments, [TE.LSConsumables]: yp.abilities },
    n = st((e, t) => {
      const n = vs(s, e);
      n && a(n, t);
    });
  return b.jsxs(oM, {
    className: C(lM, t && cM, e),
    children: [
      b.jsx(rM, {}),
      b.jsx(qS, { ...OE, children: b.jsx(QS, { className: dM, onSectionClick: n }) }),
    ],
  });
}
const mM = "Standard",
  ...
  gM = "Equipment",
  fM = "Crew",
  vM = "SpecializationFilter_48673c87",
  bM = "SpecializationFilter_content_f790a5c2",
  xM = te.resolve("strings"),
  yM = {
    [oj.Firepower]: "loadout:ammunition_setup:specialization-filter:firepower",
    [oj.Survivability]: "loadout:ammunition_setup:specialization-filter:survivability",
    [oj.Stealth]: "loadout:ammunition_setup:specialization-filter:stealth",
    [oj.Mobility]: "loadout:ammunition_setup:specialization-filter:mobility",
  },
  CM = k(function ({ specialization: e, className: t }) {
    const a = be(),
      { model: s, controls: n } = rI(),
      r = s.standardEquipmentsFilters.get().has(e),
      i = gt(r),
      o = Ie({
        header: xM.readOrEmpty(`tank_setup.categories.${e}`),
        body: xM.readOrEmpty(`tank_setup.categories.body.${e}`),
      }),
      l = Ja(() => n.updateFilters(e), [n, e], 400);
    return (
      g.useEffect(() => {
        (r && !1 === i && a.play("on", { target: yM[e] }),
          r ||
            !0 !== i ||
      ...
      b.jsx(xe, {
        ...o,
        className: C(vM, t),
        classNames: { content: bM },
        fullSizeContent: !0,
        theme: ye.primary,
        size: Ce.extraSmall,
        activated: r,
        onClick: l,
        children: b.jsx(yk, { specialization: e, active: r }),
      })
    );
  }),
  ...
  SM = "deluxe",
  EM = "modernized",
  PM = { [mM]: IM, [pM]: kM, [_M]: SM, [hM]: EM };
function MM({ id: e, label: t, className: a }) {
  const s = PM[e],
    n = et(
      g.useMemo(
        () => ({
          contentId: NM.read((e) => e.lobby.tanksetup.tooltips.SetupTabTooltipView("resId")),
          resId: wM.read((e) => e.hangar.shared.Equipments("resId")),
          disabled: !s,
          args: { name: s },
        }),
        [s],
  ...
  return b.jsx(bs.Tab, {
    ...
    tabId: e,
    className: a,
    children: b.jsx(Me, { text: jM.toUpperCase(t) }),
  });
}
const AM = "TabsNavigation_tabsNavigation_f7e0f60f",
  LM = "TabsNavigation_tabsSwitcher_d52f26be",
  DM = "TabsNavigation_tab_48ab20da",
  TM = "TabsNavigation_tab__active_676bc101",
  BM = ({
    tabsList: e,
    activeTab: t,
    theme: a,
    ...
    b.jsx("div", {
      ...
      children: b.jsx(bs, {
        ...
        children: b.jsx(bs.Switcher, {
          className: LM,
          children: e.map(({ id: e, label: a }) =>
            b.jsx(MM, { id: e, label: a, className: C(DM, t === a && TM) }, e),
          ),
        }),
      }),
    }),
  ...
  RM = te.resolve("strings"),
  OM = k(({ className: e }) => {
    const { model: t, controls: a } = rI(),
      s = ma("equipCoinInfo"),
      n = Ie({
    ...
    return b.jsxs("div", {
      className: C(VM.workbenchPanel, e),
      children: [
        b.jsx(ua, {
          ...s,
          reverse: !0,
          type: xs.equipCoin,
          classNames: { base: VM.currency, icon: VM.currencyIcon },
        ...
        b.jsx("div", {
          ...
          children: b.jsx(ge, {
            className: VM.button,
            classNames: { content: VM.buttonContent },
            ...
            children: RM.readOrEmpty("tank_setup.experimentalEquipCoinBlock.name"),
          }),
        }),
      ],
    });
  ...
  HM = { [pM]: "trophy", [hM]: "modernized" };
function FM({ introductionType: e }) {
  const t = HM[e],
    a = te.resolve("strings");
  return b.jsx(Ue, {
    split: !0,
    ...
    params: {
      currencyName:
        e !== pM
          ? b.jsx("span", {
              className: zM.currency,
              children: a.readOrEmpty(`tank_setup.introduction.currency.${t}`),
            })
          : "",
      currencyIcon: b.jsx("span", { className: L(zM.icon, zM[`icon__currency-${t}`]) }),
    },
    path: `tank_setup.introduction.message.${t}`,
    className: zM.message,
  });
}
const qM = { [pM]: "trophy", [hM]: "modernized" },
  UM = { [pM]: "modules.trophyOverlay", [hM]: "modules.modernizedOverlay" };
function WM({ introductionType: e }) {
  const t = te
      .resolve("strings")
      .readOrEmpty(`tank_setup.introduction.title.withoutEquipments.${qM[e]}`),
    a = UM[e];
  return b.jsxs("div", {
    className: zM.base,
    children: [
      ...
      b.jsxs("div", {
        className: zM.description,
        children: [
          b.jsx("div", { className: zM.title, children: t }),
          b.jsx(FM, { introductionType: e }),
        ],
      }),
    ],
  });
}
const $M = "ls_consumables",
  ZM = {
    smallRepairkit: 1,
    smallMedkit: 2,
    handExtinguishers: 3,
...
const GM = "Action_ab2a2b2e",
  XM = "Action_base__disabled_b9b41a41",
  KM = "Action_button_4133ceee",
  QM = "Action_icon_f3030341",
  YM = te.resolve("images"),
  JM = te.resolve("strings"),
  eA = ["cancel", "undo"],
  tA = (e, t) => (2 === t ? `${e}_last_modernized` : `${e}_modernized`),
  aA = g.forwardRef(function (
    {
      actionType: e,
      imageSource: t,
      modernized: a,
    ...
    const u = a ? tA(e, s) : e,
      ...
      p = g.useMemo(
        () => ({
          backgroundImage: `url(${t || YM.readOr(`loadout.actions.${u}`, () => YM.readOrEmpty(`tanksetup.actions.${u}`))})`,
        }),
        [u, t],
      );
    const _ = Ie(
      g.useMemo(() => {
        if (m) return { body: r };
        const t = ((e, t, a, s) => (a ? "demount_plus" : s ? tA(e, t) : e))(e, s, n, a);
        return {
          header: JM.readOrEmpty(`tank_setup.tooltips.action.title.${t}`),
          body: eA.includes(t)
            ? void 0
            : JM.readOrEmpty(`tank_setup.tooltips.action.description.${o || t}`),
        };
      }, [e, m, r, n, a, s, o]),
    );
    return b.jsx("div", {
      ..._,
      className: C(GM, m && XM, l),
      children: b.jsx(ge, {
        ref: d,
        autoAlignContent: !1,
        theme: ys.secondary,
        ...
        children: b.jsx("div", { className: QM, style: p }),
      }),
    });
  }),
  sA = {
  ...
  nA = te.resolve("strings");
function rA({ availableActions: e, buyMoreDisabled: t, onActionClick: a, className: s }) {
  return b.jsxs("div", {
    className: C(sA.base, sA["base__" + (e.length ? "shown" : "hidden")], s),
    children: [
      e.includes(Fj) &&
        b.jsx(aA, {
          actionType: Fj,
          disabled: t,
          onClick: a,
          className: sA.actionItem,
          disabledTooltipText: nA.readOrEmpty("tank_setup.dealPanel.tooltip.notEnough"),
        }),
      e.includes(Tj) && b.jsx(aA, { actionType: Tj, onClick: a, className: sA.actionItem }),
      e.includes(Dj) && b.jsx(aA, { actionType: Dj, onClick: a, className: sA.actionItem }),
    ],
  });
}
function iA(e) {
...
const lA = "Price_c00fc2b8",
  cA = "Price_icon_10cf08bf",
  dA = "Price_icon__reverse_74b70497",
  uA = "Price_value_7bb80c7b";
function mA({
  price: e,
  previousPrice: t,
  withZeroValue: a,
  ...
  const i = Da({ value: ca.extraSmall }, { small: { value: ca.small } });
  return b.jsx("div", {
    className: lA,
    children: e.map(
            ...
            children: [
              ...
              b.jsx(la, {
                ...
                children: b.jsx(ua, {
                  ...
                  reverse: n,
                  enough: l,
                  classNames: { icon: C(cA, n && dA), base: uA },
                  children: e,
                }),
              }),
            ],
...
const pA = "Storage_icon_f8835a96",
  _A = "Storage_icon__reverse_aada9c9e",
  hA = "Storage_value_edb11ec6";
function gA({ itemsInStorage: e, valueFirst: t }) {
  return b.jsx(ua, {
    type: xs.depot,
    reverse: t,
    size: ca.small,
    enough: Boolean(e),
    classNames: { base: hA, icon: C(pA, t && _A) },
    children: e,
  });
}
const fA = {
...
function vA({
  ...
  return b.jsx("div", {
    className: C(fA.base, fA["base__" + (s ? "shown" : "hidden")], r),
    children: t
      ? b.jsx(we, { path: o, width: 24, height: 24 })
      : i
        ? b.jsx(gA, { itemsInStorage: n })
        : e && b.jsx(mA, { ...e, valueFirst: !0 }),
  });
}
const bA = "LoadoutItem_49fa5e5c",
  xA = "LoadoutItem_base__hoverless_a07e4977",
  yA = "LoadoutItem_content_b29d68c8",
  CA = "LoadoutItem_base__disabled_404624aa",
  wA = "LoadoutItem_image_2b6b3694",
  NA = "LoadoutItem_nameWrapper_ac53f36d",
  jA = "LoadoutItem_name_f6b620d8",
  IA = "LoadoutItem_specializations_8e86b08",
  kA = "LoadoutItem_options_fe0297a6",
  SA = "LoadoutItem_actions_bfa3b2fd",
  EA = "LoadoutItem_text_b7eb40cc",
  PA = "LoadoutItem_text__short_192105ec",
  MA = [Bj, Dj, Tj, Lj],
  AA = Ne("ConsumablesItem", bA),
  LA = { colorTag: "#64ba21", whiteSpanish: "rgba(var(--color-general-primary-rgb), 0.9)" },
  DA = function ({ intCD: e, selected: t, item: a, controls: s }) {
    const {
        name: n,
        imageName: r,
        overlayType: i,
      ...
      v = g.useMemo(() => {
        ...
        return u || !f
          ? e
          : (t || e.add(Bj), l || (e.add(Fj), (p > 0 || m) && !_ ? e.add(Tj) : e.add(Dj)), e);
      }, [u, f, t, l, p, m, _]),
      x = g.useCallback(
        (t) => {
    ...
    const [y, w] = oA(o, LA);
    return b.jsx(AA, {
      className: C(u && CA, ((i === SI && t) || u) && xA),
      onClick: function () {
        if ((i === SI && t) || u) return;
        const e = MA.find((e) => v.has(e));
        x(e || Lj);
      },
      children: b.jsxs("div", {
        className: yA,
        children: [
          b.jsx("div", {
            className: wA,
            children: b.jsx(ds, { name: r, overlayType: iA(i), size: ds.sizes.s180x135 }),
          }),
          b.jsx("div", { className: NA, children: b.jsx("div", { className: jA, children: n }) }),
          b.jsx(ws, { className: C(EA, v.size > 0 && PA), text: y, upgradeLegacy: !0, params: w }),
          b.jsx(vA, {
            show: 0 === v.size,
            itemsInStorage: p,
            mounted: m || _,
  ...
  TA = k((e) => {
    const { model: t, controls: a } = Jj(),
      s = t.computes.consumableById(e.intCD);
    if (s) return b.jsx(DA, { ...e, item: s, controls: a });
  }),
  BA = te.resolve("images");
function VA({
  modernized: e,
  level: t,
  onActionClick: a,
  ...
  const c = (n || r) && o.includes(Hj),
    d = o.length && (o[0] !== Hj || c);
  return b.jsxs("div", {
    className: C(sA.base, sA["base__" + (d ? "shown" : "hidden")], l),
    children: [
      o.includes(Tj) && b.jsx(aA, { actionType: Tj, onClick: a, className: sA.actionItem }),
      o.includes(Dj) && b.jsx(aA, { actionType: Dj, onClick: a, className: sA.actionItem }),
      c &&
        b.jsx(aA, {
          actionType: Hj,
          level: t,
      ...
      o.includes(Vj) &&
        b.jsx(aA, { actionType: Vj, onClick: a, className: sA.actionItem, freeToDemount: s }),
      o.includes(Rj) &&
        b.jsx(aA, {
          actionType: Rj,
          onClick: a,
          className: sA.actionItem,
          freeToDemount: s,
          imageSource: BA.readOrEmpty("loadout.actions.demount"),
        }),
      o.includes(Oj) && b.jsx(aA, { actionType: Oj, onClick: a, className: sA.actionItem }),
      (e || !s) &&
        o.includes(zj) &&
        b.jsx(aA, {
          actionType: zj,
...
const RA = te.resolve("strings"),
  OA = { calcValue: 0, isPositive: !0, valueKey: "default" };
function zA({ values: e, localeName: t }) {
  const a = ts(e, ({ valueKey: e }) => e === t).pop();
  if (!a) return OA;
...
function HA(e) {
  const { calcValue: t, isPositive: a, valueKey: s } = zA(e),
    n = a ? "+" : "",
    r = Ns(t, 1),
    i = RA.readOrEmpty("tank_setup.kpi.bonus.valueTypes.default"),
    o = RA.readOr(`tank_setup.kpi.bonus.valueTypes.${s}`, () => i);
  return `${n}${o !== i ? `${r} ${o}` : `${r}${o}`}`;
}
function FA(e, t = !1) {
  return t || zA(e).isPositive
    ? RA.readOrEmpty(`tank_setup.kpi.bonus.positive.${e.localeName}`)
    : RA.readOrEmpty(`tank_setup.kpi.bonus.negative.${e.localeName}`);
}
const qA = "Bonuses_2e425c2b",
  UA = "Bonuses_bonus_1137ce2e",
  WA = "Bonuses_effect_9904936e",
  $A = "Bonuses_text_3e69479c",
  ZA = "Bonuses_unit_dd3c8074",
  GA = "Bonuses_base__special_ca1cd57b",
  XA = "Bonuses_icon_bf2ddda6",
  KA = te.resolve("strings");
function QA({ effect: e, special: t, bonuses: a }) {
  const s = Da({ value: e ? 2 : 3 }, { large: { value: e ? 3 : 4 } });
  return b.jsxs("div", {
    className: C(qA, t && GA),
    children: [
      e &&
        b.jsxs("div", {
          ...
          children: [
            b.jsxs("span", {
              className: WA,
              children: [
                b.jsx("span", { className: XA }),
                KA.readOrEmpty("tank_setup.effects.name"),
              ],
            }),
            b.jsx(Me, { text: e, className: $A }),
          ],
        }),
      _e(
        a.items,
        (e, t) =>
          ...
          b.jsxs(
            "div",
            {
              className: UA,
              children: [
                b.jsx("span", { className: ZA, children: HA(e) }),
                b.jsx(Me, { text: FA(e), className: $A }),
              ],
            },
            t,
          ),
...
const YA = "Specializations_c4673376",
  JA = "Specializations_item_64ba5e4a",
  eL = "Specializations_specializationType_b4c7a75d",
  tL = "Specializations_inactiveIcon_45a44cf7",
  aL = Ne("Specializations");
function sL({ specializations: e, className: t }) {
  return b.jsx(aL, {
    className: C(YA, t),
    children: _e(e, ({ name: e, correct: t }, a) =>
      b.jsx(
        "div",
        {
          className: JA,
          children: b.jsx(yk, {
            specialization: e,
            active: t,
            classNames: { base: eL, inactiveIcon: t ? void 0 : tL },
          }),
        },
        `${e}${a}`,
      ),
...
const rL = Ne("EquipmentsItem", bA),
  iL = function ({ intCD: e, selected: t, item: a, controls: s }) {
    const {
        activeSpecsMask: n,
        name: r,
        imageName: i,
      ...
      { availableActions: M } = g.useMemo(() => {
        ...
        return (
          S &&
            ...
            (t || e.add(Bj),
            f
              ? (((a = v), a ? [Rj, Oj] : [Vj]).forEach((t) => {
                  e.add(t);
                }),
                e.add(zj))
              : e.add(((e, t, a) => ((e > 0 || t) && !a ? Tj : Dj))(x, f, y))),
          w && !h && e.add(Hj),
          { availableActions: e }
        );
      }, [S, h, w, t, f, v, x, y]),
      ...
      L = g.useCallback(() => {
        ...
        A(void 0 !== e && e !== Hj ? e : Lj);
      }, [M, A, h]),
      D = M.values().next().value;
    return b.jsx(rL, {
      className: C(h && CA, h && xA),
      onClick: L,
      children: b.jsxs("div", {
        className: yA,
        children: [
          b.jsx("div", {
            ...
            children: b.jsx(ds, {
              name: i,
              overlayType: iA(m),
              size: ds.sizes.s180x135,
              level: u ? nL(m) : l,
            }),
          }),
          b.jsx("div", { className: NA, children: b.jsx("div", { className: jA, children: r }) }),
          d && b.jsx(QA, { effect: c ?? void 0, bonuses: d, special: n > 0 }),
          b.jsx(vA, {
            mounted: f || y,
            itemsInStorage: x,
            price: k,
            ...
            className: kA,
            show: 0 === M.size || (D === Hj && !E.hover && !E.selected && !S),
          }),
          b.jsx(VA, {
            className: SA,
            modernized: p,
          ...
          !P && b.jsx(sL, { specializations: o.specializations, className: IA }),
        ],
      }),
    });
  },
  oL = k((e) => {
    ...
    if (s) return b.jsx(iL, { ...e, item: s, controls: a });
    console.error("Unable to render equipment item", e.intCD, e.type);
  }),
  lL = Ne("InstructionsItem", bA),
  cL = { Equipment: "equipmentInstructions", Crew: "crewInstructions" },
  dL = { colorTag: "#64ba21", whiteSpanish: "rgba(var(--color-general-primary-rgb), 0.9)" },
  uL = function ({ intCD: e, item: t, controls: a }) {
    const {
        name: s,
        imageName: n,
        overlayType: r,
      ...
      f = g.useMemo(() => {
        const e = new Set();
        return (d || !h || (o && e.add(Fj), (m > 0 || u) && !p ? e.add(Tj) : e.add(Dj)), e);
      }, [d, h, o, m, u, p]),
      v = g.useCallback(
        (t) => {
      ...
      x = g.useCallback(() => {
        d || (f.has(Dj) ? v(Dj) : f.has(Tj) ? v(Tj) : v(Lj));
      }, [f, v, d]),
      [y, w] = oA(i, dL);
    return b.jsx(lL, {
      className: C(d && CA, d && xA),
      onClick: x,
      children: b.jsxs("div", {
        className: yA,
        children: [
          b.jsx("div", {
            className: wA,
            children: b.jsx(ds, { name: n, overlayType: iA(r), size: ds.sizes.s180x135 }),
          }),
          b.jsx("div", { className: NA, children: b.jsx("div", { className: jA, children: s }) }),
          b.jsx(ws, { className: C(EA, f.size > 0 && PA), text: y, upgradeLegacy: !0, params: w }),
          b.jsx(vA, {
            show: 0 === f.size,
            itemsInStorage: m,
  ...
  mL = k((e) => {
    const { model: t, controls: a } = lI(),
      s = e.type && t.computes.instructionByIntCD(e.intCD, e.type);
    if (s) return b.jsx(uL, { ...e, item: s, controls: a });
  });
const pL = { card: "AmmunitionCard_card_2bd54c54" },
  _L = te.resolve("aliases");
const hL = v(function ({ card: e, type: t, currentTab: a, className: s }) {
    const { model: n } = wj(),
      {
        mounted: r,
        disabled: i,
      ...
      v = !r && -1 !== o && _ !== o,
      x = ma(
        t === sj ? "battleBoosterBlock" : "hangarCardModule",
        g.useMemo(() => [l, _], [l, _]),
        g.useMemo(() => ({ resId: _L.read((e) => e.hangar.shared.Loadout("resId")) }), []),
      ),
      y = qt({
        resId: _L.read((e) => e.hangar.shared.Loadout("resId")),
        args: g.useMemo(
          () => ({ intCD: l, slotId: _, slotType: $M, tooltipId: "hangarCardModule" }),
          [l, _],
        ),
      }),
      C = g.useMemo(
              ...
              switch (e) {
                case $M:
                  return {
                    ...
                    emitterUID: window.subViews.get(
                      _L.read((e) => e.hangar.shared.Consumables("resId")),
                    ).uid,
                  };
                case rj:
                  return {
                ...
                case sj:
                  return {
                    ...
                    slotType: tj,
                    emitterUID: window.subViews.get(
                      _L.read((e) => e.hangar.shared.Instructions("resId")),
                    ).uid,
                  };
                default:
                  return {
                    ...
                    slotType: YN,
                    emitterUID: window.subViews.get(
                      _L.read((e) => e.hangar.shared.Equipments("resId")),
                    ).uid,
                  };
              }
            })();
      ...
      j = (function ({ intCD: e, selected: t, ammunitionType: a, currentTab: s = "" }) {
        switch (a) {
          case aj: {
            const a = vs(ij, s);
            return a ? b.jsx(oL, { intCD: e, selected: t, type: a }) : null;
          }
          case rj:
          case $M:
            return b.jsx(TA, { intCD: e, selected: t });
          case sj: {
            const t = vs(cL, s);
            return t ? b.jsx(mL, { intCD: e, type: t }) : null;
          }
          default:
            return null;
        }
    ...
    if (j)
      return b.jsx("div", {
        ...
        children: b.jsx(Is, {
          ...N,
          className: pL.card,
          classNames: { status: { icon: pL.statusIcon } },
          status: h,
          statusReason: t !== rj ? c : void 0,
          active: v,
          selected: f,
          disabled: i,
          "data-test-id": l,
...
function fL({ cards: e, currentTab: t, type: a }) {
  const s = Ss();
  return (
    g.useEffect(() => Ve(s.recalculate), [e?.length, s.recalculate]),
    b.jsx(b.Fragment, {
      children: e.map((e) =>
        b.jsx(hL, { className: gL.card, card: e, type: a, currentTab: t }, e.intCD),
      ),
    })
  );
}
const vL = "top",
  ...
  xL = "both",
  yL = "none";
const CL = v(function ({ currentTab: e, type: t, className: a }) {
  const [s, n] = y.useState(yL),
    { api: r } = Te();
  y.useLayoutEffect(() => {
    const e = () => {
      ...
      n(
        (function (e, t, a) {
          return e <= t ? yL : a <= 10 ? bL : t + a >= e - 10 ? vL : xL;
        })(e, t, a),
      );
    };
    return (
  ...
  const i = gt(e),
    o = gt(t),
    l = st(() => {
      ((o && t !== o) || (t === aj && i && e !== i)) && r.applyScroll(0, { immediate: !0 });
    });
  y.useEffect(() => {
    l();
  }, [l, t, e]);
  const c = (function (e, t) {
    ...
    switch (e) {
      ...
      case rj:
        return a.computes
          .consumables()
          .sort((e, t) => (ZM[e.itemName] ?? 1 / 0) - (ZM[t.itemName] ?? 1 / 0));
      case sj:
        switch (t) {
          case gM:
  ...
  return b.jsxs("div", {
    className: C(gL.scrollContainer, gL[`scrollContainer__${s}`], a),
    children: [
      b.jsx(Re, {
        classNames: { wrapper: gL.scrollWrapper, content: gL.scrollContent },
        children:
          c && 0 !== c.length
            ? b.jsx(Es, {
                className: gL.container,
                trashhold: `${t}-${e}`,
                children: b.jsx(fL, { cards: c, currentTab: e, type: t }),
              })
            : t !== aj || (e !== hM && e !== pM)
              ? void 0
              : b.jsx(WM, { introductionType: e }),
      }),
      b.jsx(Fe, { classNames: { base: gL.verticalBar } }),
    ],
  });
});
function wL(e) {
  return b.jsx(He, { children: b.jsx(CL, { ...e }) });
}
const NL = "ConfirmationPanel_afa99a14",
  jL = "ConfirmationPanel_currencies_7544112d",
  IL = "ConfirmationPanel_plus_335af158",
  kL = "ConfirmationPanel_buttons_ad07fa9b",
  SL = (e) => e > 0,
  EL = Ne("LeftBlock", "ConfirmationPanel_leftBlock_798f4c44"),
  PL = Ne("Currencies", jL),
  ML = Ne("Buttons", kL),
  AL = Ne("ConfirmationPanel", NL);
function LL(e) {
  return b.jsx(PL, {
    className: e.className,
    children: g.Children.map(e.children, (e, t) =>
      b.jsxs(b.Fragment, { children: [SL(t) && b.jsx("div", { className: IL }), e] }),
    ),
  });
}
AL.Left = EL;
const DL = "DealPanel_icon_f0ce4668",
  TL = "DealPanel_value_438c7871";
function BL(e, t) {
  return t === xs.gold ? ha.formatNumber("gold", e) : ha.formatNumber("integral", e);
}
const VL = g.memo(function ({ type: e, price: t }) {
    const a = Da({ value: ca.small }, { large: { value: ca.medium } }),
      s = Ie({
        body: te
          .resolve("strings")
  ...
  RL = "DealPanel_leftBlock_e9fb0b4a",
  OL = "DealPanel_leftBlock__active_53e6aee9",
  zL = "DealPanel_checkbox_c6267a54",
  HL = "DealPanel_checkbox__active_edd6c82d",
  FL = "DealPanel_checkboxLabel_7df5996",
  qL = "DealPanel_buttonWrapper_e6c7f6fe",
  UL = "DealPanel_button_d186abe4",
  WL = "DealPanel_buttonContent_25d6c73c",
  ...
  KL = "boosters",
  QL = "repair";
const YL = { [sj]: KL, [nj]: XL, [rj]: GL, [$M]: GL },
  JL = v(function ({ type: e, className: t }) {
    const a = Da({ value: ta.small }, { large: { value: ta.medium } }),
      { model: s, controls: n } = Jj(),
      { model: r, controls: i } = lI(),
      { model: o, controls: l } = rI(),
      { model: c, controls: d } = vI(),
      { controls: u, model: m } = (() => {
        switch (e) {
          case aj:
      ...
      p = Ie({ body: $L.readOrEmpty("tank_setup.dealPanel.tooltip.notEnough") }),
      _ = YL[e],
      h = Ie(
        g.useMemo(
          () =>
            _ === QL
              ? {
                  header: $L.readOrEmpty(`tank_setup.tooltip.autoRenewal.header.${_}`),
                  body: $L.readOrEmpty(`tank_setup.tooltip.autoRenewal.body.${_}`),
                }
              : _ === GL
                ? {
                    header: $L.readOrEmpty("tank_setup.tooltip.autoRenewal.header.general"),
                    body: $L.readOrEmpty("tank_setup.tooltip.autoRenewal.body.LSConsumables"),
                  }
                : _ && _ !== ZL
                  ? {
                      header: $L.readOrEmpty("tank_setup.tooltip.autoRenewal.header.general"),
        ...
        ? b.jsxs(AL, {
            ...
            children: [
              b.jsx(ea, {
                ...
                children: $L.readOrEmpty("tank_setup.dealPanel.autoRenew"),
              }),
              b.jsxs(AL.Left, {
                className: C(RL, v && OL),
                children: [
                  b.jsx(LL, {
                    children: f.prices.map((e, t) => {
                      ...
                      return b.jsx(VL, { type: a, price: e }, t);
                    }),
                  }),
                  b.jsxs(ML, {
                    children: [
                      b.jsx("div", {
                        ...
                        children: b.jsx(ge, {
                          className: UL,
                          classNames: { content: WL },
                          disabled: (!f.canConfirm || f.disabled) && v,
                          onClick: u.confirm,
                          theme: ys.primary,
                          size: a.value,
                          "data-test-id": "dealPanelApply",
                          children: $L.readOrEmpty("tank_setup.dealPanel.button.apply"),
                        }),
                      }),
                      b.jsx("div", {
                        className: qL,
                        children: b.jsx(ge, {
                          ...
                          children: $L.readOrEmpty("tank_setup.dealPanel.button.cancel"),
                        }),
                      }),
                    ],
                  }),
  ...
  eD = "AmmunitionSetup_14321dac",
  tD = "AmmunitionSetup_ammunitionHeader_7df5ac92",
  aD = "AmmunitionSetup_dealPanel_64ad50ed",
  sD = "AmmunitionSetup_tabsNavigation_4504ff3c",
  nD = "AmmunitionSetup_tabsNavigation__hidden_a99bfa94",
  rD = "AmmunitionSetup_specializationFilters_35de8d81",
  iD = "AmmunitionSetup_specializationFilter_38bef0cf",
  oD = {
    [aj]: [
      { id: mM, labelKey: "tank_setup.tabs.simple" },
      { id: pM, labelKey: "tank_setup.tabs.trophy" },
      { id: _M, labelKey: "tank_setup.tabs.deluxe" },
      { id: hM, labelKey: "tank_setup.tabs.modernized" },
    ],
    [sj]: [
      { id: gM, labelKey: "tank_setup.tabs.optDevice" },
      { id: fM, labelKey: "tank_setup.tabs.crew" },
    ],
  },
  lD = { [aj]: mM, [sj]: gM },
  cD = te.resolve("strings");
function dD(e) {
  switch (e) {
    case II:
      return gM;
...
const uD = Object.values(oj),
  mD = v(function ({ type: e }) {
    const t = be(),
      { model: a } = wj(),
      { controls: s } = rI(),
      ...
      f = gt(e);
    (g.useEffect(() => {
      (p !== o || (r && (m !== i || n !== _))) && u(dD(r?.type) || lD[e]);
    }, [m, p, _, r, i, o, n, e]),
      g.useEffect(() => {
        s.clearFilters();
      }, [e, s]),
      ...
      mt(() => clearTimeout(c.current)));
    const v = g.useMemo(
        () =>
          (function (e) {
            return (
              oD[e]?.map(({ id: e, labelKey: t }) => ({ id: e, label: cD.readOrEmpty(t) })) ?? []
            );
          })(e),
        [e],
      ),
      x = Da({ size: Ls.small }, { large: { size: Ls.medium }, extraLarge: { size: Ls.large } });
    return b.jsxs("div", {
      className: eD,
      children: [
        e !== nj &&
          b.jsxs(b.Fragment, {
            children: [
                    ...
                    switch (d) {
                      case mM:
                        return b.jsx("div", {
                          className: rD,
                          children: uD.map((e, t) =>
                            b.jsx(CM, { specialization: e, className: iD }, t),
                          ),
                        });
                      case hM:
                        return b.jsx(OM, {});
              ...
              b.jsx(wL, { currentTab: d, type: e }),
            ],
          }),
        b.jsx(JL, { className: aD, type: e }),
      ],
    });
  }),
  pD = "LoadoutScreen_background_27176b85",
  _D = "LoadoutScreen_4d05852e",
  hD = "LoadoutScreen_screenWrapper_d869840d",
  gD = "LoadoutScreen_info_c568de1c",
  fD = te.resolve("aliases");
function vD(e, t) {
...
const bD = new ms()
    .addWithProps(
      Yj,
      vD((e) => e.hangar.shared.Consumables("resId"), fD),
    )
    .addWithProps(
      oI,
      vD((e) => e.hangar.shared.Instructions("resId"), fD),
    )
    .addWithProps(
      nI,
      vD((e) => e.hangar.shared.Equipments("resId"), fD),
    )
    .addWithProps(
      Cj,
      vD((e) => e.hangar.shared.Loadout("resId"), fD),
    )
    .addWithProps(
      fI,
      vD((e) => e.hangar.shared.Shells("resId"), fD),
    ),
  xD = new ms()
    .addWithProps(
      Kn,
      vD((e) => e.hangar.shared.VehicleFilters("resId"), fD),
    )
    .addWithProps(
      Jn,
      vD((e) => e.hangar.shared.VehiclesStatistics("resId"), fD),
    )
    .addWithProps(
      tr,
      vD((e) => e.hangar.shared.VehiclesInfo("resId"), fD),
    )
    .add(sr)
    .addWithProps(
      kr,
      vD((e) => e.hangar.shared.VehiclesInventory("resId"), fD),
    );
function yD(e) {
  const t = Ee();
  va(Ht.ESCAPE, () => {
  ...
  return b.jsxs("div", {
    ...
    children: [
      ...
      xD.render(
        b.jsx(Cg, {
          classNames: { base: hD, info: gD },
          children: void 0 !== a && bD.render(b.jsx(mD, { type: a })),
        }),
      ),
    ],
  });
...
const CD = "disabled",
  ...
  RD = "forts",
  OD = te.resolve("intl"),
  zD = te.resolve("strings"),
  HD = {
    [AD]: "tooltips.header.battleType",
    [kD]: "tooltips.header.buttons.tournaments",
    [LD]: "tooltips.header.buttons.profile",
  },
  FD = {
    [SD]: "tooltips.header.buttons.clans.turnedOff",
    [MD]: "tooltips.header.buttons.personalMissionsDisabled",
    [RD]: "tooltips.header.buttons.forts.turnedOff",
  };
function qD(e) {
  return OD.toUpperCase(
    zD.readOrEmpty(`menu.headerButtons.${TD[e]}`) ||
      zD.readOrEmpty(`menu.headerButtons.${e}`) ||
      `{${e}}`,
  );
}
function UD({
  ...
  const c = be(),
    ...
    u = Ie(
      g.useMemo(
        () =>
          (function (e, t) {
            const a = ((t && FD[e]) || HD[e]) ?? `tooltips.header.buttons.${e}`;
            return { header: zD.readOrEmpty(`${a}.header`), body: zD.readOrEmpty(`${a}.body`) };
          })(d ? RD : e, t === CD),
        [e, t, d],
      ),
    ),
    m = ma("techtreeDiscount"),
    p = n && "techtree" === e ? m : u;
  const _ = o ?? `${l}.battleTypes.c_64x64.${s}`;
  return b.jsx("div", {
    ...p,
    className: C(VD.base, VD[`base__${t}State`], VD[`base__${e}Name`]),
    "data-test-id": e,
    onMouseEnter: function (e) {
      (p.onMouseEnter(e),
        t !== CD && c.play("mouse-enter", { target: "main-menu-widget:menu-item", original: e }));
    },
    onClick: function (a) {
      (p.onClick(),
        t !== CD && (i(e), c.play("click", { target: "main-menu-widget:menu-item", original: a })));
    },
    children: (() => {
      switch (e) {
        case AD:
          return b.jsxs(b.Fragment, {
            children: [
              b.jsxs("div", {
                className: VD.modeSelector,
                children: [
                  b.jsx("div", { className: VD.label, children: qD(e) }),
                  a && b.jsx("div", { className: VD.modeName, children: OD.toUpperCase(a) }),
                  b.jsx("div", { className: VD.modeIcon, style: { backgroundImage: `url(${_})` } }),
                ],
              }),
              b.jsx(BD, { className: VD.arrow }),
            ],
          });
        case SD:
          return b.jsxs("div", {
            className: VD.titleWrapper,
            children: [
              r &&
                b.jsx("div", { style: { backgroundImage: `url(${r})` }, className: VD.clanEmblem }),
              b.jsx("div", { className: VD.title, children: qD(d ? "clan" : e) }),
            ],
          });
        default:
          return b.jsx("div", {
            className: VD.titleWrapper,
            children: b.jsx("div", { className: VD.title, children: qD(e) }),
          });
      }
    })(),
  });
...
const [WD, $D] = V()(
  ...
  ZD = "MainMenu_222da7b7",
  GD = k(function ({ className: e, battleTypesPath: t, modeIconPath: a }) {
    const { model: s, controls: n } = $D(),
      r = s.menuItems.get(),
      i = s.modeName.get(),
      o = s.modeId.get(),
...
function XD(e) {
  ...
  return b.jsx(WD, {
    ...n,
    children: b.jsx(GD, { className: t, battleTypesPath: a, modeIconPath: s }),
  });
}
function KD(e) {
  const t = R.aliases.hangar.shared.MainMenu("resId"),
    a = { rootId: t };
  return b.jsx(he, { id: t, children: b.jsx(XD, { options: a, ...e }) });
}
const QD = "VehicleInfo_49e7c3f8",
  YD = "VehicleInfo_info_d41f9c10",
  JD = "VehicleInfo_info__active_373a807e",
  eT = "VehicleInfo_text_c1878dd2",
  tT = "VehicleInfo_role_f8aa1650",
  aT = v(function () {
    const e = Sr().model.selectedVehicle(),
      t = Sr().model.selectedVehicleStatistics(),
      { breakpoint: a } = Ye(),
      s = vn(e?.vehicleId);
    if (e && t)
      return b.jsx("div", {
        ...
        children: b.jsxs(Xt, {
          ...(e.role === bn && s),
          className: C(YD, e.role === bn && JD),
          children: [
            b.jsx(Xt.Level, { className: eT, value: e.level }),
            Kt(e.type) &&
              b.jsx(Xt.Type, {
                type: e.type,
                premium: t.elite,
                size: a.weight <= Je.large.weight ? Xt.Type.sizes.x48x48 : Xt.Type.sizes.x64x64,
              }),
            b.jsx(Xt.Name, { className: eT, children: e.shortName }),
            0 !== e.role &&
              e.role !== bn &&
              b.jsx(Xt.Role, {
                ...s,
  ...
  uT = ["locked", "active", "lockedActive", "incompatibleVehicle", "incompatibleMode"],
  mT = {
    [dT.nationChange]: nT.read((e) => e.vehicle_menu.default.NationChange("resId")),
    [dT.aboutVehicle]: nT.read((e) => e.vehicle_menu.default.AboutVehicle("resId")),
    [dT.repairs]: nT.read((e) => e.vehicle_menu.default.Repairs("resId")),
    [dT.fieldModification]: nT.read((e) => e.vehicle_menu.default.FieldModification("resId")),
    [dT.vehSkillTree]: nT.read((e) => e.vehicle_menu.default.VehSkillTree("resId")),
    [dT.compare]: nT.read((e) => e.vehicle_menu.default.Compare("resId")),
    [dT.research]: nT.read((e) => e.vehicle_menu.default.Research("resId")),
    [dT.armorInspector]: nT.read((e) => e.vehicle_menu.default.ArmorInspector("resId")),
    [dT.easyEquip]: nT.read((e) => e.vehicle_menu.default.EasyEquip("resId")),
    [dT.crewRetrain]: nT.read((e) => e.vehicle_menu.default.CrewRetrain("resId")),
    [dT.quickTraining]: nT.read((e) => e.vehicle_menu.default.QuickTraining("resId")),
    [dT.crewOut]: nT.read((e) => e.vehicle_menu.default.CrewOut("resId")),
    [dT.crewBack]: nT.read((e) => e.vehicle_menu.default.CrewBack("resId")),
    [dT.crewAutoReturn]: nT.read((e) => e.vehicle_menu.default.CrewAutoReturn("resId")),
    [dT.customization]: nT.read((e) => e.vehicle_menu.default.Customization("resId")),
    [dT.proBoost]: nT.read((e) => e.vehicle_menu.default.ProBoost("resId")),
  },
  pT = Object.values(dT);
const _T = {
...
const fT = "warning",
  ...
  wT = {
    ...
    crew: [mT.crewRetrain, mT.quickTraining, mT.crewOut, mT.crewBack],
  };
const NT = s({
    state: c(),
    counter: m(),
    ...
    researchItems: r(d(c())),
    params: r(
      s({ tooltipKey: r(c()), expirationTimestamp: r(m()), vehicle: r(c()), isActive: r(D()) }),
    ),
  }),
  [jT, IT] = V("VehicleMenuModel")(
    ({ observableModel: t, requires: { vehicleInfo: a } }) => {
      const s = { opened: e.box(!1), screenID: e.box(null), menuItems: t.dict("menuEntries") },
        n = O.structural((e) => {
          ...
          try {
            return h(NT, JSON.parse(t));
          } catch (a) {
            return (console.error(a), { state: xT, counter: -1 });
          }
        }),
        r = O.shallow(() => {
          const { researchItems: e } = n(mT.research);
          return e ? ce(e, (e, t) => gT(e) - gT(t))[0] : void 0;
        }),
        i = O.shallow((e) => {
          const t = a.model.selectedVehicleStatistics()?.status;
          if (t === pn.battle) return xT;
          const s = [];
          let r = !1;
          for (const a of e) {
            const e = n(a);
            if ((s.push(e.state), e.state === vT)) return vT;
            e.state === fT && (r = !0);
          }
          const i = s.every((e) => e === xT);
          return ((o = i), r ? fT : o ? xT : bT);
          var o;
        });
    ...
    { useRequires: () => ({ vehicleInfo: Sr() }) },
  ),
  [kT, ST] = V("KeyBindingsProvider")((e) => ({
    vehicleMenu: {
      ...e.observableModel.primitives({ upgrades: dT.vehSkillTree }, "vehicleMenu"),
      ...e.observableModel.primitives(
        {
          retrainCrew: dT.crewRetrain,
          quickTraining: dT.quickTraining,
          returnCrew: dT.crewBack,
          aboutVehicle: dT.aboutVehicle,
          upgrades: dT.fieldModification,
          compare: dT.compare,
          research: dT.research,
          armor: dT.armorInspector,
          quickService: dT.easyEquip,
          customization: dT.customization,
        },
        "vehicleMenu",
      ),
    },
  })),
  ET = "MenuButton_base__disabled_2d840da1",
  PT = "MenuButton_base__opened_d9d84dd",
  MT = "MenuButton_background_80afe673",
  AT = "MenuButton_background__hidden_a0ead688",
  LT = "MenuButton_overlay_fdbd550d",
  DT = "MenuButton_arrow_5a0b183c",
  TT = "MenuButton_icon_e994a077",
  BT = Ne("MenuButton", {
    element: "div",
    className: "MenuButton_3f57027c",
    cva: { variants: { state: { [xT]: ET, opened: PT } } },
  }),
  VT = te.resolve("strings"),
  RT = te.resolve("views"),
  OT = k(function ({
    type: e,
    opened: t,
    ...
    const u = ST(),
      ...
      x = v?.[e]?.get(),
      y = x ? Ds(x) : void 0,
      { stateReason: w } = f.computes.getMenuItem(mT.crewBack),
      N = a === xT,
      j = t ? "opened" : a,
      I = ve(r, "upscale"),
      k = (e === lT && s) || N ? bT : a,
      S = N ? bT : k,
      E = Ie({ body: VT.readOrEmpty("crew_operations.return.error.noPrevious") }),
      P = gs(
        "simple",
        g.useMemo(
          () => ({
            resId: RT.read((e) => e.mono.tooltips.tooltips("resId")),
            header: VT.readOrEmpty(`hangar.vehicleMenu.menuButton.tooltip.${e}.header`),
            body: VT.readOrEmpty(`hangar.vehicleMenu.menuButton.tooltip.${e}.body`),
            keyButtonCode: y,
            keyButtonTitle: VT.readOrEmpty("hangar.vehicleMenu.menuButton.tooltip.hotkey.title"),
          }),
          [e, y],
        ),
      );
    ...
    const M = N && e === lT && w === sT ? E : N ? void 0 : P;
    return b.jsxs(BT, {
      ...d,
      ...M,
      state: j,
          ...
          b.jsxs(b.Fragment, {
            children: [
              b.jsx(we, {
                ...
                className: C(MT, (m || t) && AT, l?.background),
              }),
              b.jsx(we, {
                path: `hangar.vehicleMenu.${I}.btn_${k}_opened`,
                className: C(MT, !t && AT, l?.backgroundOpened),
              }),
              !t &&
                b.jsx(we, {
                  path: `hangar.vehicleMenu.${I}.btn_${k}_hover`,
                  className: C(MT, !m && AT, l?.backgroundHovered),
                }),
            ],
          }),
        e !== cT &&
          !t &&
          b.jsx(we, { path: `hangar.vehicleMenu.${I}.arrow_${S}`, className: C(DT, l?.arrow) }),
        (!t || N) &&
          b.jsx(we, { path: `hangar.vehicleMenu.${I}.${e}_${n}`, className: C(TT, l?.icon) }),
        N &&
          b.jsx(we, { path: `hangar.vehicleMenu.${I}.btn_disabled`, className: C(LT, l?.overlay) }),
      ],
    });
  }),
  zT = {
  ...
  HT = te.resolve("strings"),
  FT = te.resolve("intl"),
  qT = (e) => {
    const [t, a] = Bs(Vs(Rs(e), Os()), ["h", "m"]);
    return `${((s = t), String(Math.max(parseInt(s), 0)).padStart(2, "0"))}:${((e) => String(Math.max(parseInt(e, 10) || 0, 1)).padStart(2, "0"))(a)}`;
    var s;
  },
  UT = k(function ({ id: e, size: t = rT, researchItem: a, onClick: s }) {
    const n = be(),
      { model: r } = IT(),
      { state: i, stateReason: o, counter: l, params: c } = r.computes.getMenuItem(e),
      d = ve(t, "upscale"),
      u = ST().model.vehicleMenu,
      m = (function (e) {
        const t = pT.find((t) => mT[t] === e);
        return (ne(void 0 !== t, `Unknown menu item id = ${e}`), t);
      })(e),
      p = u?.[m]?.get(),
      _ = p ? Ds(p) : void 0,
      h = Ie({ body: HT.readOrEmpty("crew_operations.return.error.noPrevious") }),
      g = Ie({
        body: HT.readOrEmpty("crew_operations.return.warning.memberDemobilized.tooltip.body"),
      }),
      f = c?.expirationTimestamp,
      v = c?.tooltipKey,
      x = e === mT.proBoost && v && ((y = v), uT.includes(y));
    var y;
    const w = f ? qT(f) : "",
      N = x ? HT.readOrEmpty(`hangar.vehicleMenu.proBoostTooltips.${v}.header`) : "",
      j = x
        ? Ts(HT.readOrEmpty(`hangar.vehicleMenu.proBoostTooltips.${v}.body`), {
            time: w,
            vehicle: c?.vehicle ?? "",
          })
        : "",
      I = Ie({ header: N, body: j });
    if (i === yT) return null;
    return b.jsx("div", {
      className: zT.base,
      ...(e === mT.crewBack &&
        (i === xT && o === sT ? h : i === bT && "crewMembersRetired" === o ? g : void 0)),
      ...(x && I),
      children: b.jsxs("div", {
        className: C(zT.inner, zT[`inner__${i}`]),
        onClick: function (t) {
          i !== xT && (n.play("click", { target: "vehicle-menu-widget:item", original: t }), s(e));
        },
        onMouseEnter: function (e) {
          i !== xT && n.play("mouse-enter", { target: "vehicle-menu-widget:item", original: e });
        },
        "data-test-id": m,
        children: [
          b.jsx("div", { className: zT.hover }),
          b.jsxs("div", {
            className: zT.sideBorders,
            children: [
              b.jsx("div", { className: C(zT.sideBorder, zT.sideBorder__left) }),
              b.jsx("div", { className: C(zT.sideBorder, zT.sideBorder__right) }),
            ],
          }),
          b.jsx("div", {
            className: zT.icon,
            children: b.jsx(we, {
              path: `hangar.vehicleMenu.${d}.${m}${i === fT && a && e === mT.research ? `_${_T[a]}` : i === bT || i === xT ? "" : `_${i}`}`,
              className: zT.iconImage,
            }),
          }),
          b.jsxs("div", {
            className: C(zT.title, _ && zT.title__hasHotkey),
            children: [
              b.jsx(Ue, {
                ...
                params:
                  e === mT.proBoost
                    ? c?.isActive
                      ? {
                          activeOrCountdown: HT.readOrEmpty(
              ...
              l > 0 &&
                b.jsx(Ue, {
                  ...
                  params: { count: FT.formatNumber("integral", l) },
              ...
              _ &&
                b.jsx(zt, {
                  ...
                  classNames: {
                    base: zT.hotKey,
                    background: zT.hotKeyBackground,
                    border: zT.hotKeyBorder,
                    content: zT.hotKeyContent,
                  },
                  children: b.jsx(zt.Code, {}),
                }),
            ],
          ...
          e === mT.crewBack &&
            ...
            b.jsx(we, { path: "hangar.vehicleMenu.icon_alert", className: zT.warningIcon }),
          i === xT && b.jsx("div", { className: zT.disabledOverlay }),
        ],
      }),
    });
  }),
  WT = "MenuList_border_478c22c4",
  $T = "MenuList_bottom_c28a1943",
  ZT = "MenuList_cea03bfd",
  GT = "MenuList_content_102c53c8",
  XT = "MenuList_checkbox_d5741047",
  KT = "MenuList_label_8b8f8c2a",
  QT = "MenuList_checkbox__checked_5a4f974e",
  YT = "MenuList_checkbox__disabled_5a4f974e",
  JT = "MenuList_topItem_6a7889e4",
  eB = "MenuList_autoReturn_841be836",
  tB = "MenuList_divider_af7e286c",
  aB = "MenuList_bottomBorder_bad1a96",
  sB = "MenuList_notch_265b362a",
  nB = k(function ({ buttonState: e, size: t, className: a }) {
    const { model: s, controls: n } = IT(),
      r = s.opened.get(),
      i = s.screenID.get(),
    ...
    if (!i) return;
    const { state: u, stateReason: m } = s.computes.getMenuItem(mT.crewAutoReturn),
      p = u === yT;
    const _ = e === vT || e === fT ? e : "default",
      h = u === bT;
    return (
      i !== cT &&
      d(
        (e, s) =>
          ...
          b.jsxs(j.div, {
            ...
            children: [
                      ...
                      children: [
                        b.jsx("div", {
                          ...
                          children: b.jsx(ea, {
                            checked: h,
                            disabled: p,
                            onCheckedChange: () => n.navigateTo(mT.crewAutoReturn),
                            size: ta.small,
                            className: C(XT, h && QT, p && YT),
                            classNames: { label: KT },
              ...
              b.jsx("div", { className: WT }),
              b.jsxs("div", {
                className: $T,
                children: [
                  b.jsx(we, { path: `hangar.vehicleMenu.menu_bottom_left_${_}`, className: aB }),
                  b.jsx("div", { className: sB }),
                  b.jsx(we, { path: `hangar.vehicleMenu.menu_bottom_right_${_}`, className: aB }),
                ],
              }),
            ],
          }),
  ...
  rB = new Set(["text", "search", "url", "tel", "email", "password", "number"]);
const iB = k(function () {
    const e = ST().model.vehicleMenu,
      t = be(),
      { model: a, controls: s } = IT(),
      n = a.opened.get();
    (va(n ? "Escape" : "NONE", s.close), va(n ? "Space" : "NONE", s.close));
    for (const [r, i] of Object.entries(e)) {
      const e = Ds(i.get()),
        o = mT[r],
        { state: l } = a.computes.getMenuItem(o);
      Va(l === xT || l === yT ? "NONE" : e, (e) => {
        var a;
        e.shiftKey ||
          e.altKey ||
          e.ctrlKey ||
  ...
  lB = { rootId: te.resolve("aliases").read((e) => e.hangar.shared.KeyBindings("resId")) },
  cB = k(function ({ className: e, keyBindingsProviderOptions: t = lB }) {
    const { model: a, controls: s } = IT(),
      n = a.screenID.get(),
      r = a.computes.getButtonState,
      i = a.computes.researchItem(),
      { state: o } = a.computes.getMenuItem(mT.crewAutoReturn),
      { state: l } = a.computes.getMenuItem(mT.crewBack),
      { state: c } = a.computes.getMenuItem(mT.fieldModification),
      { state: d } = a.computes.getMenuItem(mT.vehSkillTree),
      { state: u } = a.computes.getMenuItem(mT.easyEquip),
      { state: m } = a.computes.getMenuItem(mT.quickTraining),
      { state: p } = a.computes.getMenuItem(mT.customization),
      { state: _ } = a.computes.getMenuItem(mT.proBoost),
      h = zs(
        g.useCallback(() => {
          s.close();
        }, [s]),
      ),
      f = Da({ value: rT }, { large: { value: iT } }),
      v = r(wT[lT]),
      x = { [oT]: r(wT[oT]), [lT]: v, [cT]: p };
    function y(e) {
      if (e === oT) {
        const e = x[oT] === xT ? "_disable" : "";
        if (x[oT] === vT) return x[oT];
        if (u === fT) return `${dT.easyEquip}${e}`;
        if (i) return `${_T[i]}${e}`;
        if (c === fT) return `${dT.fieldModification}${e}`;
        if (d === fT) return `${dT.vehSkillTree}${e}`;
        if (_ === fT) return `${dT.proBoost}${e}`;
      } else if (e === lT) {
        if (m === fT) return fT;
        if (l === vT || l === fT) return "default";
        if (o === bT && x[lT] !== fT) return "autoReturn";
      }
      return "default";
    }
    function w(e) {
      e !== cT ? (n === e ? s.close() : s.open(e)) : s.navigateTo(mT.customization);
    }
    return (
      g.useEffect(() => {
        n === lT && v === xT && s.close();
      ...
      b.jsx(kT, {
        ...
        children: b.jsxs("div", {
          ref: h,
          className: C(oB.base, e),
          children: [
            n !== cT &&
              b.jsx("div", {
                className: C(oB.menu, n && oB[`menu__${n}`]),
                children: b.jsx(nB, { buttonState: n ? r(wT[n]) : bT, size: f.value }),
              }),
            CT.map((e) =>
              b.jsx(
                OT,
                {
                  ...
                  opened: n === e,
                  buttonState: x[e],
                  crewBackWarning: m !== fT && (l === vT || l === fT),
                  iconPostfix: y(e),
                  size: f.value,
                  onClick: w,
                },
  ...
  dB = "VehicleMenu_menu_58d4b43e",
  uB = "VehicleMenu_menu__screenMode_bf623a9b",
  mB = "VehicleMenu_menuWidget_f0798397";
function pB({ className: e, screenModeEnabled: t }) {
  const a = te.resolve("aliases").read((e) => e.hangar.shared.VehicleMenu("resId")),
    s = g.useMemo(() => ({ rootId: a }), [a]);
  return b.jsx(jT, {
    options: s,
    children: b.jsx("div", {
      className: C(dB, t && uB, e),
      children: b.jsx(cB, { className: mB }),
    }),
  });
}
const _B = "HangarApp_content_3e0636ca",
  hB = "HangarApp_bg_59e8707a",
  gB = "HangarApp_vignette_a27c4c31",
  fB = "HangarApp_a8d6dd11",
  vB = "HangarApp_parallaxRef_7051ab1d",
  bB = "HangarApp_vehicleInfo_c748b13a",
  xB = "HangarApp_carousel_bc4dc752",
  yB = "HangarApp_carousel__double_5f5d7e60",
  CB = "HangarApp_carouselButtons_9b3870c0",
  wB = "HangarApp_filterPopover_4cb0cbc4",
  NB = "HangarApp_filterTrigger_f42a2633",
  jB = "HangarApp_filterTriggerContent_1e779ddb",
  IB = "HangarApp_content__screenMode_98bf9678",
  kB = "HangarApp_mainMenu_64bb8bc5",
  SB = "HangarApp_aboutBtn_2908872",
  EB = "HangarApp_narrationBtn_b7142cef",
  PB = "HangarApp_narrationBtnText_6b7efacb",
  MB = "HangarApp_narrationImage_80b7c7e9",
  AB = "HangarApp_aboutWrapper_6a36926",
  LB = "HangarApp_info_1c5d1fb7",
  DB = "HangarApp_difficulty_6ac6ab0f",
  TB = "HangarApp_userMissions_302b2356",
  BB = [yp.equipments, yp.instructions, yp.abilities, Cp, xp],
  VB = [Cp, xp],
  RB = v(function () {
    const { model: e, controls: t } = bp(),
      { selectedStory: a, isInfoEnabled: s, isLootBoxEntryPointEnabled: n } = e.root.get(),
      r = Ee(),
      i = Qn(),
      o = Sr().model.current.intCD.get(),
      l = r.location === xp,
      [c, d] = g.useState(!1),
      [u, m] = g.useState(!1),
      p = g.useRef(null);
    ...
    const _ = g.useCallback(() => {
      ...
      v = o !== en,
      x = i.model.carouselRowCount.get(),
      y = BB.includes(r.location) && v,
      w = VB.includes(r.location) && v,
      N = Da({ size: ge.sizes.extraSmall }, { extraLarge: { size: ge.sizes.small } });
    return b.jsxs("div", {
      className: fB,
      children: [
        b.jsxs(Fs, {
          children: [
            b.jsx(qs, { path: `${yp.root}/:page`, component: yD }),
            b.jsx(qs, { path: wp, component: QN }),
            b.jsx(qs, { path: Cp, component: Hy }),
          ],
        }),
        b.jsx("div", { className: vB, ref: p }),
        b.jsxs("div", {
          className: C(_B, !l && IB),
          children: [
            l &&
              b.jsxs(b.Fragment, {
                children: [
                  ...
                  b.jsx("div", { className: gB }),
                  b.jsx(KD, { className: kB }),
                  b.jsxs("div", {
                    className: AB,
                    children: [
                      s &&
                        b.jsx(Jt, {
                          ...
                          children: b.jsx(ge, {
                            ...
                            onClick: t.openAbout,
                            autoAlignContent: !1,
                            children: b.jsx("div", { className: LB }),
                          }),
                        }),
                      b.jsx(Jt, {
                  ...
                  b.jsx(pp, { className: TB }),
                ],
              }),
            v && l && w && b.jsx("div", { className: bB, children: b.jsx(aT, {}) }),
            w && b.jsx(pB, { screenModeEnabled: r.location.endsWith(Cp) }),
            y &&
              b.jsx(uM, {
            ...
            l &&
              b.jsxs("div", {
                className: C(xB, 2 === x && yB),
                children: [
                  b.jsxs("div", {
                    className: CB,
                    children: [
                      b.jsx(Qo, { classNames: { base: wB, trigger: NB, triggerContent: jB } }),
                      b.jsx(fp, { route: Cp }),
                    ],
                  }),
                  b.jsx(ew, { lootBoxEntryEnabled: n }),
                ],
              }),
          ],
        }),
  ...
  OB = te.resolve("aliases");
function zB(e, t) {
  return { options: { rootId: t.read(e) } };
}
const HB = Us([Qs, Ys, Js, { click: { "ls_loadout:preset-switcher": Ks } }]);
$s(
  new ms()
    .addWithProps(Rt, { soundsOverrides: HB })
    .add(Ws)
    .addWithProps(
      Kn,
      zB((e) => e.hangar.shared.VehicleFilters("resId"), OB),
    )
    .addWithProps(
      Jn,
      zB((e) => e.hangar.shared.VehiclesStatistics("resId"), OB),
    )
    .addWithProps(
      tr,
      zB((e) => e.hangar.shared.VehiclesInfo("resId"), OB),
    )
    .add(sr)
    .addWithProps(
      xr,
      zB((e) => e.hangar.shared.VehiclePlaylists("resId"), OB),
    )
    .addWithProps(
      kr,
      zB((e) => e.hangar.shared.VehiclesInventory("resId"), OB),
    )
    .addWithProps(wn, { options: { rootId: R.aliases.last_stand.shared.VehiclesDaily("resId") } })
    .add(vp)
    .render(b.jsx(RB, {})),
)
  .then(() => Zs(document.getElementById("root")))
  .then(() => Gs())
  .then(() => Xs(!1))
  .then(() => Hs(!1));
