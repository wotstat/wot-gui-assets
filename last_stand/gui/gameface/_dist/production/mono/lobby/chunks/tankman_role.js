...
const n = -1,
  ...
  L = "56833",
  m = "51201",
  p = { [H]: "alpha", [A]: "alpha", [m]: "super", [L]: "super" },
  R = {
...
function g(e, t, a) {
  return !(!e || t === i || !a) && a.status !== R.unsuitableToQueue && a.maxBpScore > 0;
}
function S(e) {
  return e > 2;
}
...
var N = ((e) => (
  ...
  O = ((e) => ((e.UNDEFINED = "undefined"), (e.SILVER = "silver"), (e.GOLD = "gold"), e))(O || {});
const v = "TankmanRole_3bb08c81",
  b = {
    [C.commander]: (t) =>
      e.createElement(
        "svg",
      ...
      e.createElement(
        ...
        e.createElement(
          ...
          e.createElement(
            ...
            e.createElement("rect", { width: 18, height: 18, fill: "white" }),
          ),
        ),
      ),
    [C.gunner]: (t) =>
...
function M({ role: e = "", className: l }) {
  const C = b[e];
  if (C) return t.jsx(C, { className: a(v, l) });
