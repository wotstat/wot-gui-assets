...
import { N as C, _o as l, gi as t, pr as a, yo as i } from "./lib.js";
var n = e(i()),
  o = "disabled",
  r = "paused",
  s = "readyToSelect",
  d = "pending",
  [u, h, c] = a()(({ observableModel: e }) => ({
    ...e.primitives(["isCrystalEarnEnabled", "isDailyMultipliedXpEnabled", "isInfiniteAmmo"]),
  })),
  _ = () => (0, n.useContext)(c.Context),
  E = "undamaged",
  H = "54033",
  A = "50705",
  T = "56833",
  p = "51201",
  L = { [H]: "alpha", [A]: "alpha", [p]: "super", [T]: "super" },
  R = {
  ...
  g = {
    ...
    [R.damaged]: "repair",
    [R.rentable]: "rental",
    [R.rentableAgain]: "rental",
    [R.rentalIsOver]: "rental",
    [R.tooHeavy]: "notSuitable",
    [R.unsuitableToQueue]: "notSuitable",
    [R.unsuitableToUnit]: "notSuitable",
    [R.inPrebattle]: "inPlatoon",
    [R.battle]: "inBattle",
    [R.wot_plus_exclusive_vehicle_disabled]: "notSuitable",
  };
function S(e, C, l) {
  return !(!e || "disabled" === C || !l) && l.status !== R.unsuitableToQueue && l.maxBpScore > 0;
}
function w(e) {
  return e > 2;
}
        ...
        children: [
          ...
          (0, v.jsx)("defs", {
            children: (0, v.jsx)("clipPath", {
              ...
              children: (0, v.jsx)("rect", { width: 18, height: 18, fill: "white" }),
            }),
          }),
        ],
      }),
...
function m({ role: e = "", className: C }) {
  const t = b[e];
  if (t) return (0, v.jsx)(t, { className: l(x, C) });
