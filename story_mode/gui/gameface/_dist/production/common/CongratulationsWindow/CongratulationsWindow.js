        ...
        const k = {
          ...
          C = (e) => {
            ...
            const o = (() => {
              ...
              l = o.mediaHeight,
              c = o.mediaSize;
            return a().createElement("div", y({ className: b()(n, k[s], T[l], O[c]) }, i), t);
          },
          A = ["children"],
          H = (e) => {
            let t = e.children,
                        ...
                        observableModel: {
                          array: (t, n) => {
                            const r = null != n ? n : l(t),
                              a = me.observable.box(r, { equals: _e });
                            return (
                              "real" === e &&
                                s.subscribe(
                          ...
                          primitives: (t, n) => {
                            ...
                            if (Array.isArray(t)) {
                              const a = t.reduce(
                                (e, t) => ((e[t] = me.observable.box(r[t], {})), e),
                                {},
                              );
                              return (
                                "real" === e &&
                            ...
                            }
                            {
                              const a = t,
                                i = Object.entries(a),
                                o = i.reduce(
                                  (e, [t, n]) => ((e[n] = me.observable.box(r[t], {})), e),
                                  {},
                                );
                              return (
                                "real" === e &&
