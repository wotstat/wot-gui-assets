...
function pipe(e, t, u, n, r, s, o, a, i) {
  switch (arguments.length) {
    ...
    case 8:
      return a(o(s(r(n(u(t(e)))))));
    case 9:
      return i(a(o(s(r(n(u(t(e))))))));
    default: {
      let e = arguments[0];
...
function compose(e, t, u, n, r, s, o, a, i) {
  switch (arguments.length) {
    case 1:
      return e;
    case 2:
    ...
    case 8:
      return function () {
        return a(o(s(r(n(u(t(e.apply(this, arguments))))))));
      };
    case 9:
      return function () {
        return i(a(o(s(r(n(u(t(e.apply(this, arguments)))))))));
      };
  }
}
...
function makeLoggerProxy(e, t = []) {
  return "object" != typeof e || null === e
    ...
    : new Proxy(e, {
        get: (e, u) =>
          "function" == typeof e[u] ? e[u].bind(e) : makeLoggerProxy(e[u], [...t, u]),
      });
}
  ...
  const o = reactExports.useRef({ status: statuses.idle, resId: e, timeoutId: 0 }),
    [a, i] = reactExports.useMemo(() => {
      ...
      const d = {
        ...
        show: l,
        rerun: function () {
          o.current.status !== statuses.idle && (n ? d.hide() : i());
        },
      };
      return [
        d,
...
function cloneModel(e, { shallow: t = !0, depth: u = 0, maxDepth: n = 32 } = {}) {
  ...
  if ("object" === s) {
    ...
    const s = {};
    for (const e of Object.keys(r)) s[e] = cloneModel(r[e], o);
    return s;
  }
...
function createObservableModel(e, t, u) {
  ...
  const r = (r, s, o = DEFAULT_BOX_CONFIG) => {
      const a = observable.box(r(u(s)), o);
      return ("real" === t && e.subscribe((e) => n.push(() => a.set(r(e))), s), a);
    },
    s = (r, s) => {
  ...
  return {
    ...
    primitives: (r, s) => {
      ...
      }
      {
        const u = r,
          a = Object.entries(u),
          i = a.reduce((e, [t, u]) => ((e[u] = observable.box(o[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              n.push(() =>
...
const initializeModelWithContext =
    ...
    (t, u, n) => {
      ...
      function s(s) {
        const { mode: o, options: a, children: i, mocks: l } = s,
          c = useMockContext(),
          d = o ?? c.mode,
          E = l ?? c.mocks,
          ...
          m = n?.useRequires?.(),
          A = useEvent((r, o, a) => {
            const i = "real" !== r && a ? createMockInstance(a.getter, o) : create(o, { name: e }),
              l = (e) => ("mocks" === r ? a?.getter(e, o) : i.readByPath(e)),
              ...
              A = { ...d, mode: r, model: E, externalModel: i, cleanup: c, requires: m },
              h = "mocks" === r && a?.controls ? a.controls(A) : {};
            return {
              model: E,
              controls: { ...u?.(A), ...h },
              externalModel: i,
          ...
          [f, F] = reactExports.useState(d);
        reactExports.useEffect(() => {
          F(d);
        }, [d]);
        const [g, _] = reactExports.useState(() => A(f, a, E));
        return (
          reactExports.useEffect(() => {
            h.current ? _(A(f, a, E)) : (h.current = !0);
          }, [A, E, f, a?.context, a?.initializer, a?.getRoot, a?.rootId]),
          reactExports.useEffect(
            () => () => {
  ...
  render(e) {
    return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
      children: this.items.reduceRight(
        (e, [t, u], n) => reactExports.createElement(t, { ...u, key: n }, e),
        e,
      ),
    });
  }
    ...
    return jsxRuntimeExports.jsxs(HeadlessButton, {
      ...
      children: [
        ...
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$5.content, s && styles$5.content__fontAligned, o?.content),
          children: e,
        }),
      ],
    });
...
const defaultBrackets = { start: "{{", end: "}}" },
  FormatText = reactExports.memo(function (e) {
    const {
      ...
      m = clsx(styles$4.base, s && styles$4.base__fullSize, l.className);
    return e.inline
      ? (console.warn(
...
const MultilineOverflow = reactExports.forwardRef(function (
  ...
  reactExports.useEffect(() => {
    ...
    function r() {
      ...
      if (s === r) y(!1);
        ...
        for (
          n.style.visibility = "", n.style.left = `${r.x}px`, n.style.top = `${r.y}px`;
          s >= 0;
          s--
        ) {
          ...
          if (
            ...
            !(t.offsetLeft + t.offsetWidth + u.offsetWidth > e.clientWidth)
          )
            break;
        }
        for (let t = 0; t <= s; t++) {
          ...
          const r = cloneNode(u);
          r ? n.appendChild(r) : console.warn("Unexpected type of target node", u);
        }
  ...
  const D = isSerializableParams(u),
    v = useParamTooltip(
      "format_text",
        ...
        (t[u] = (function (t) {
          return (u) => {
            ...
            return (
              ...
              n(),
              () => {
                r && (o(), window.removeEventListener(s, a), (e.listeners -= 1), n(), (r = !1));
              }
            );
          };
        })(u)),
    ...
    const u = _useLog(e, t),
      ...
      l = reactExports.useCallback(
        (e, t = 0, s, o) => {
          ...
          if (void 0 === a) return;
          (void 0 !== r.current.get(e) && i(e), n.current.delete(e));
          const l = (getDate() - a) / MILLISECONDS;
          l <= t || ((o = addTimeSpent(o, l)), u(e, s, o));
        },
        [n, r, u, i],
      );
    return [(e) => s(e), (e, t, u, n) => l(e, t, u, n), () => o(), (e) => a(e), (e) => i(e)];
  },
...
const NORMALIZE_OVERLAYS_LIST = ["attachment"],
  ...
  SimpleTooltip = ({ children: e, body: t, header: u, note: n, alert: r, args: s, ...o }) => {
    ...
    return jsxRuntimeExports.jsx(Tooltip, {
      contentId: getTooltipContentId(s?.hasHtmlContent),
      ...
      reactExports.useEffect(
        () =>
          createLayoutReadyInEffect(() => {
            const e = d.current;
            if (!c || !e || !s) return void (e?.cohFastSeek && (e.cohFastSeek = !1));
                  ...
                  r.forEach((t, n) => {
                    void 0 !== r[n] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        ...
                        return e({ time: t, name: `${o ? u : `${DEFAULT_NAME_KEYFRAME$1}_${n}`}` });
                      });
                  });
                }
              });
                ...
                if (d.current) {
                  ...
                  r.forEach((t, n) => {
                    void 0 !== r[n] &&
                      ...
                      e.changeKeyframeHandlers.forEach((e) => {
                        const u = Object.keys(o ?? {})[n];
                        return e({ time: t, name: `${o ? u : `${DEFAULT_NAME_KEYFRAME}_${n}`}` });
                      });
                  });
                }
              });
...
const getRegionalDateTime = RegionalDateTime.getRegionalDateTime,
  ...
  DateTime = ({
    ...
    isConvertedToLocal: u = !0,
  }) =>
    Object.values(DateTimeFormatsEnum).includes(t)
      ? getRegionalDateTime(e, t, u)
      : getFormattedDateTime(e, t, u),
  ...
  TooltipDecorator = React.forwardRef(function (
    { children: e, className: t, theme: u = "default", ...n },
    r,
  ) {
...
export {
  ...
  ExtendedText as E,
  FormatText as F,
  DateTimeFormatsEnum as G,
  mapRange as H,
  ImageSize as I,
  JSXBuilder as J,
  TooltipDecorator as K,
  useCountdown as L,
