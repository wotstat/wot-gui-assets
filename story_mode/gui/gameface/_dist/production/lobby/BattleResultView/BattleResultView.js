(() => {
      ...
      6952: (e, u, t) => {
        ...
        const c = i.O.client.getSize("rem"),
          ...
          m = (e) => {
            ...
            const n = (0, r.useContext)(F),
              ...
              v = { extraLarge: D, large: h, medium: C, small: g, extraSmall: p };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.largeWidth && A) return a(u, t, v);
              if (t.mediumWidth && d) return a(u, t, v);
              if (t.smallWidth && m) return a(u, t, v);
              if (t.extraSmallWidth && B) return a(u, t, v);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        const y = {
          ...
          M = (e) => {
            ...
            const a = w(),
              ...
              o = a.mediaHeight,
              s = a.mediaSize;
            return n().createElement("div", x({ className: h()(t, y[i], L[o], k[s]) }, r), u);
          },
          T = ["children"],
          S = (e) => {
            let u = e.children,
        ...
        class z extends n().PureComponent {
          ...
          render() {
            const e = this.props,
              ...
              B = h()(G.goto, null == o ? void 0 : o.goto);
        ...
        const Q = (0, r.memo)(
          ({
            ...
            const i = h()("Background_base_94", a && "Background_base__blur_69", e);
            return n().createElement(
              "div",
              { className: i, style: { backgroundImage: `url(${u})` } },
                ...
                const l = (0, r.useRef)([]),
                  c = (e, t, r) => {
                    ...
                    const a = (function ({
                        ...
                        observableModel: {
                          array: (u, t) => {
                            const r = null != t ? t : s(u),
                              n = ee.observable.box(r, { equals: J });
                            return (
                              "real" === e &&
                                o.subscribe(
                                  (0, ee.action)((e) => n.set(e)),
                                  u,
                                ),
                              n
                            );
                          ...
                          primitives: (u, t) => {
                            ...
                            if (Array.isArray(u)) {
                              const n = u.reduce(
                                (e, u) => ((e[u] = ee.observable.box(r[u], {})), e),
                                {},
                              );
                              return (
                                "real" === e &&
                            ...
                            }
                            {
                              const n = u,
                                a = Object.entries(n),
                                i = a.reduce(
                                  (e, [u, t]) => ((e[t] = ee.observable.box(r[u], {})), e),
                                  {},
                                );
                              return (
                                "real" === e &&
                      ...
                      A = { mode: e, model: E, externalModel: o, cleanup: c };
                    return {
                      model: E,
            ...
            const p = (0, r.useRef)({
              ...
              b = (0, r.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (se(t, F, { isMouseEvent: !0, on: !0, arguments: oe(n) }, v),
                  h && h(),
        ...
        const De = ({ children: e, tooltipArgs: u, className: t }) => {
          ...
          return a || o
            ? n().createElement(le, Be({}, u, { contentId: a || o }), r)
            : n().createElement(Ae, u, r);
        };
        var he = t(9050),
          Ce = t.n(he);
        let ge;
        ...
        const we = {
          ...
          ye = ({ elementList: e, textBlock: u, key: t }) => {
            ...
            return r
              ? fe[r]
                ? n().createElement(
                    "span",
                    { key: t, "data-block-type": u.blockType, className: fe[r] },
                    e,
                  )
                : n().createElement(
                    "span",
                    { key: t, "data-block-type": u.blockType, style: xe(r) },
                    e,
                  )
              ...
              e.childList.forEach((n, a) => {
                ...
                if (((e) => void 0 !== e.childList)(n)) {
                  const e = n,
                    ...
                    t = ke(e, Le[u], i);
                  r.push(...t);
                } else r.push(u({ elementList: [n], textBlock: e, key: i }));
              }),
              r
            );
          },
          ...
          Se = (e, u = "") => {
            ...
            return (
              Me(
                ...
                /(\n+|[\xa0\ufeff]+)/g,
                (e) => {
                  t.push({ blockType: pe.Word, colorTag: u, childList: Te(e) });
                },
                (e) => {
                  const r = e[0],
                    n = we[r.charAt(0)];
          ...
          Oe = (e, u) => {
            ...
            if (e.blockType === pe.NoBreakWrapper) (e.childList.push(r), t.push(e));
            else {
              const u = Object.assign({}, e, { childList: e.childList.splice(-1) });
              (e.childList.length > 0 && t.push(e),
                t.push({ blockType: pe.NoBreakWrapper, colorTag: "", childList: [u, r] }));
            }
          ...
          Ne = (e, u = {}) => {
            ...
            const t = ((e) => {
              ...
              })(((r = e), r.replace(/&nbsp;/g, " ")).replace(/&zwnbsp;/g, "\ufeff"), u),
            );
            var r;
            return ((e) => {
              const u = [];
            ...
            for (let l = t; l >= 0; l--) {
              ...
              }
              {
                const e = t.children,
                  c = u[l],
                  A = c.props.children,
                  d = We(e, A, e.length - 1, r, a, i),
                  F = d[0],
                  _ = d[1];
                if (!(F < 0)) {
                  const e = A.slice(0, F);
                  ((s = n().cloneElement(c, c.props, e, _)), (o = l));
                  break;
                }
                a -= E.length;
              }
          ...
          Ue = n().memo(
            ({
              ...
              targetId: s,
              justifyContent: l = ve.FlexStart,
              alignContent: c = ve.FlexStart,
              truncateIdentify: E = "...",
            }) => {
                        ...
                        const l = a.children,
                          c = ((e, u) => {
                            ...
                            for (; r - t >= 0;) {
                              ...
                              Pe(e[n], u) ? (r = n - 1) : (t = n + 1);
                            }
                            return t - 1;
                          })(l, i);
                        if (c < 0) return [n, !1];
                        const E = We(l, n, c, o, r.length, r),
                          A = E[0],
                          d = E[1];
        ...
        const je = (0, r.memo)(({ icon: e, value: u, name: t }) => {
            const r =
              w().mediaSize >= p.Medium
                ? R.images.story_mode.gui.maps.icons.battleResult.icons.large.$dyn(e)
                : R.images.story_mode.gui.maps.icons.battleResult.icons.$dyn(e);
            return n().createElement(
              "div",
          ...
          $e = (0, Z.observer)(() => {
            ...
            return n().createElement(
              ...
              Array.isArray(u) ? u.map(t) : u.map((e, u, r) => t(null == e ? void 0 : e.value, u))),
            );
            var u, t;
          }),
          ze = (0, Z.observer)(() => {
            ...
            return n().createElement(
              "div",
              {
                className: h()(
                  ...
                  e.root.isVictory.get() && "BattleResultVehicle_base__victory_20",
                ),
              },
              ...
              n().createElement(Ue, {
                ...
                text: e.root.vehicleName.get(),
              }),
              n().createElement(Ue, {
                classMix: "BattleResultVehicle_playerStatus_f1",
                text: e.root.playerStatus.get(),
              }),
            );
          }),
          Ke = (0, Z.observer)(() => {
        ...
        engine.whenReady.then(() => {
          N().render(
            n().createElement(ne, null, n().createElement(S, null, n().createElement(Ke, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6952));
