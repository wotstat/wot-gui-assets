(() => {
  ...
  var __webpack_modules__ = {
      67: (u, e, t) => {
        ...
        var a = {};
        (t.r(a), t.d(a, { getBgUrl: () => m, getTextureUrl: () => c }));
        var n = {};
        function o(u) {
          return (e) => (
            engine.on(u, e),
      ...
      596: (u, e, t) => {
        ...
        function B(u, e, t, r, i, a, n) {
          ...
          o.done ? e(E) : Promise.resolve(E).then(r, i);
        }
        const C = (u) => ({
            ...
            sendShowPopOverEvent: (u, e, t, r, i = R.invalid("resId"), a) => {
              const n = m.O.view.getViewGlobalPosition(),
                ...
                d = {
                  ...
                  y: m.O.view.pxToRem(A) + n.y,
                  width: m.O.view.pxToRem(F),
                  height: m.O.view.pxToRem(l),
                };
              h(E.POP_OVER, {
                isMouseEvent: !0,
                contentID: u,
      ...
      319: (u, e, t) => {
        ...
        const A = n.O.client.getSize("rem"),
          F = A.width,
          l = A.height,
          d = Object.assign({ width: F, height: l }, s(F, l, o)),
        ...
        const O = i().forwardRef(function (u, e) {
          ...
          return (
            ...
            i().createElement(
              "div",
              w({}, s, {
                className: g()(v.base, v[`base__theme-${E}`], a),
                ref: function (u) {
          ...
          return (
            _(() => {
              if (
                ...
                const t = (u) => {
                  ...
                  r = ((u) => {
                    const e = ((u) => {
                        ...
                        return { modelPrefix: i, modelPath: x(i, ""), resId: r };
                      })(),
                      t = e.modelPrefix,
                      r = u.split(".");
                    if (r.length > 0) {
                ...
                l.current = k.addCallback(r, t, o, e === H.Deep);
              }
            }),
            (0, r.useEffect)(() => {
              if (e !== H.None)
        ...
        (y.Sw.instance,
          (function (u) {
            ((u.FAKE_MODIFIER = "fakeModifier"),
              ...
              (u.PIERCING_POWER_FIRST = "piercingPowerFirst"),
              (u.PIERCING_POWER_LAST = "piercingPowerLast"),
              ...
              (u.ARMOR_DAMAGE = "armorDamage"),
              (u.DEVICE_DAMAGE = "deviceDamage"),
              ...
              (u.THERMAL_VISION_DISTANCE = "thermalVisionDistance"));
          })(V || (V = {})),
          (function (u) {
            ((u.UNDEFINED = "undefined"),
              ...
              (u.POINTS_PER_SECOND = "points_per_second"));
          })(W || (W = {})),
          (function (u) {
        ...
        class z {}
        ((z.multiplierToPercent = (u) => 100 * u - 100),
          (z.radiansToDegrees = (u) => u * (180 / Math.PI)),
          (z.metPerSecondToKmPerHour = (u) => 3.6 * u),
        ...
        ((Y.percent = (u, e, t) => {
          ...
          (Y.pointsPerSecond = (u, e, t) => {
            const r = Y.default(u, e, t);
            return b(
              S(R.strings.modifier_formatter.modifier.format.points_per_second(), { value: r }),
            );
          }),
          (Y.hitpoints = (u, e, t) => {
            const r = Y.default(u, e, t);
          ...
          (Y.metersPerSecond = (u, e, t) => {
            const r = Y.default(u, e, t);
            return b(
              S(R.strings.modifier_formatter.modifier.format.meters_per_second(), { value: r }),
            );
          }),
          (Y.degreesPerSecond = (u, e, t) => {
            const r = Y.default(u, e, t);
            return b(
              S(R.strings.modifier_formatter.modifier.format.degrees_per_second(), { value: r }),
            );
          }),
          (Y.meterPerSecondSquared = (u, e, t) => {
            const r = Y.default(u, e, t);
            return b(
              S(R.strings.modifier_formatter.modifier.format.meter_per_second_squared(), {
                value: r,
              }),
            );
          }),
        ...
        const $ = {
          ...
          physTypes: {
            ...
            [W.MILLIMETERS]: {
              overrides: [],
              defaultNumberOfDecimals: 0,
              defaultFormatter: Y.millimeters,
            },
            [W.SECONDS]: {
              overrides: [
                {
            ...
            [W.DEVIATION]: {
              overrides: [
                {
                  condition: j.useType.oneOf(G.VAL),
                  valueConverter: z.probabilityToPercent,
                  numberOfDecimals: 0,
                  prefixForPositiveValue: "",
        ...
        class Q {
          constructor() {
            ((this.formatRestriction = (u, e) => {
              const t = Object.assign({}, u, { value: e, useType: G.VAL });
        ...
        const J = "ModifierParameter_base_84",
          ...
          tu = ({ value: u }) => {
            if (u.useType === G.UNDEFINED)
              return i().createElement(
                "div",
                { className: J },
                i().createElement("div", { className: "ModifierParameter_paramIcon_ff" }),
                i().createElement("div", { className: uu }, eu(u.resName)),
              );
            const e = g()(
            ...
            return i().createElement(
              ...
              i().createElement(
                "div",
                { className: uu },
                i().createElement("div", null, eu(u.resName)),
                ((u, e) => {
                  const t = ((u, e) => {
                      ...
                      return "string" != typeof r
                        ...
                        : b(
                            S(
                              ...
                              { restriction: S(r, { value: u.formatRestriction(e, t.value) }) },
                            ),
                          );
                    }
                    return null;
          ...
          au = R.strings.battle_modifiers.modifiersDomainTooltip.subtitle,
          nu = iu("name"),
          ou = iu("description"),
          Eu = () => {
            const u = U("model"),
            ...
            return i().createElement(
              ...
              i().createElement(
                ...
                i().createElement(
                  ...
                  i().createElement("div", { className: "App_icon_7c", style: ru(e) }),
                  i().createElement(
                    "div",
                    { className: "App_headerText_b7" },
                    i().createElement("div", { className: "App_title_21" }, nu(e)),
                    i().createElement("div", { className: "App_description_d2" }, ou(e)),
                  ),
                ),
                ...
                i().createElement(
                  ...
                  i().createElement(
                    ...
                    ((r = e),
                    (a = t.length),
                    "stepRepairPoint" === r ? au.short() : 1 === a ? au.single() : au.plural()),
                  ),
                  i().createElement(
                    "div",
                    { className: "App_paramsList_4b" },
                    t.map(({ value: u }, e) => i().createElement(tu, { value: u, key: e })),
                  ),
                ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          f().render(
            i().createElement(B, null, i().createElement(Eu, null)),
    ...
    (__webpack_require__.O = (u, e, t, r) => {
      if (!e) {
        ...
        for (E = 0; E < deferred.length; E++) {
          for (var [e, t, r] = deferred[E], a = !0, n = 0; n < e.length; n++)
            (!1 & r || i >= r) &&
