...
class w {
  ...
  readOr(e, t, n = "silent") {
    const r = e.startsWith("R.images") ? e : _(this.prefix, e),
      o = (function (e, t) {
        const n = t.split(".");
...
class C {
  ...
  readOr(e, t, n = "silent") {
    const r = e.startsWith("R.strings") ? e : _(this.prefix, e),
      o = N(r, void 0, e.startsWith("R.strings") ? window : this.root);
    return void 0 === o ? ("silent" !== n && b(`Resource not found: ${r}`, n), t()) : o;
  }
  readOrEmpty(e, t = "warn") {
    return this.readOr(e, () => "", t);
  ...
  readOrThrow(e) {
    const t = e.startsWith("R.strings") ? e : _(this.prefix, e),
  ...
  pluralOr(e, t, n, r = "silent") {
    const o = e.startsWith("R.strings") ? e : _(this.prefix, e),
      s = N(o, t, e.startsWith("R.strings") ? window : this.root);
...
class D {
  ...
  readOr(e, t, n = "silent") {
    const r = e.startsWith("R.videos") ? e : _(this.prefix, e),
      o = (function (e, t) {
        const n = t.split(".");
...
g.register({
  ...
  videos: r(() => new D(window.R.videos)).singleton(),
  views: n(
    class {
      read(e) {
...
const M = Symbol("Duration");
function B(e) {
  return "object" == typeof e && null !== e && e[M] === M;
}
function O(e) {
  return { [M]: M, value: e, unit: "millis" };
}
const L = O(0);
function I(e) {
  return { [M]: M, value: e, unit: "seconds" };
}
const F = {
    millis: (e) => e,
    seconds: (e) => 1e3 * e,
...
const W = k(function (e, t) {
  ...
  q = {
    DD: (e) => Math.floor($(e)).toString().padStart(2, "0"),
    D: (e) => Math.floor($(e)).toString(),
    WW: (e) => Math.floor(H(e)).toString().padStart(2, "0"),
    W: (e) => Math.floor(H(e)).toString(),
    hh: (e) =>
      Math.floor(j(e) % 24)
        .toString()
        .padStart(2, "0"),
    ...
    ss: (e) =>
      Math.floor(z(e) % 60)
        .toString()
        .padStart(2, "0"),
    h: (e) => Math.floor(j(e) % 24).toString(),
    m: (e) => Math.floor(U(e) % 60).toString(),
    s: (e) => Math.floor(z(e) % 60).toString(),
...
const J = K("clientResized"),
  ee = K("self.onScaleUpdated"),
  te = K("clientMinimized"),
  ne = { down: K("mousedown"), up: K("mouseup"), move: K("mousemove") };
const re = (function () {
...
const ie = {
  ...
  ce = { ...Object.keys(ae).reduce((e, t) => ((e[t] = () => se(ae[t])), e), {}), sound: se },
...
const he = (e) => {
  ...
  pe = (e, t) => {
    ...
    if (void 0 !== t) {
      const { args: r, ...o } = t;
      return void 0 !== r
        ? viewEnv.handleViewEvent({ __Type: n, type: e, ...o, arguments: he(r) })
  ...
  _e = {
    ...
    tooltip: {
      open(e, t, n = 0, r) {
        (pe(de, { contentID: t, decoratorID: n, targetID: e, isMouseEvent: !0, on: !0, args: r }),
          ge.set(`${e}-${t}`, { targetID: e, contentID: t }));
      },
      hide(e, t, n = 0) {
        (pe(de, { contentID: t, decoratorID: n, targetID: e, on: !1 }), ge.delete(`${e}-${t}`));
      },
      hideAll() {
...
function xe(e, t, n, r, o, s, i, a, c) {
  switch (arguments.length) {
    ...
    case 6:
      return function () {
        return s(o(r(n(t(e.apply(this, arguments))))));
      };
    case 7:
      return function () {
        return i(s(o(r(n(t(e.apply(this, arguments)))))));
      };
    case 8:
      return function () {
        return a(i(s(o(r(n(t(e.apply(this, arguments))))))));
      };
    case 9:
      return function () {
        return c(a(i(s(o(r(n(t(e.apply(this, arguments)))))))));
      };
  }
}
...
function Re(e, t = []) {
  return "object" != typeof e || null === e
    ? e
    : new Proxy(e, {
        get: (e, n) => ("function" == typeof e[n] ? e[n].bind(e) : Re(e[n], [...t, n])),
      });
}
...
function Ne(
  {
    initializer: e = !0,
    rootId: t = 0,
    getRoot: n = "true" === Te.PUBLIC_DEBUG_MODEL_ACCESS ? xe(Pe, Re) : Pe,
    context: r = "model",
  } = {},
  { name: o = "DataLayer" } = {},
) {
...
const Oe = { NONE: -1, ALT: 18, ESCAPE: 27, SPACE: 32 };
function Le(e, t) {
...
const Qe = ["I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CD", "D", "CM", "M"],
  ...
  Je = ["ko", "no"].includes(g.resolve("langCode"));
function et(e) {
  return e <= 0
    ...
    : Je
      ...
      : (function (e) {
          ...
          let t = "";
          for (let n = Ke.length - 1; n >= 0; n--) {
            let r = Ke[n];
            for (; void 0 !== r && e >= r;) ((t += Qe[n]), (e -= r));
          }
          return t;
        })(e);
}
...
const ut = new Set(["zh_cn", "zh_sg", "zh_tw", "ja", "ko", "th"]);
const lt = o.createContext(void 0);
const dt = {
  ...
  ft = {
    ...
    small: { weight: 1, name: dt.small, className: "mediaSmall", width: 1366, height: 768 },
    medium: { weight: 2, name: dt.medium, className: "mediaMedium", width: 1600, height: 900 },
    large: { weight: 3, name: dt.large, className: "mediaLarge", width: 1920, height: 1080 },
    extraLarge: {
      weight: 4,
      name: dt.extraLarge,
...
var mt,
  ...
  pt,
  gt =
    (((mt = gt || {})[(mt.Small = ft.small.width)] = "Small"),
    (mt[(mt.Medium = ft.medium.width)] = "Medium"),
    (mt[(mt.Large = ft.large.width)] = "Large"),
    (mt[(mt.ExtraLarge = ft.extraLarge.width)] = "ExtraLarge"),
    mt),
  _t =
    (((ht = _t || {})[(ht.Small = ft.small.width)] = "Small"),
    (ht[(ht.Medium = ft.medium.width)] = "Medium"),
    (ht[(ht.Large = ft.large.width)] = "Large"),
    (ht[(ht.ExtraLarge = ft.extraLarge.width)] = "ExtraLarge"),
    ht),
  bt =
    (((pt = bt || {})[(pt.Small = ft.small.height)] = "Small"),
    (pt[(pt.Medium = ft.medium.height)] = "Medium"),
    (pt[(pt.Large = ft.large.height)] = "Large"),
    (pt[(pt.ExtraLarge = ft.extraLarge.height)] = "ExtraLarge"),
    pt);
const wt = Object.values(ft);
function yt(e, t) {
...
const Et = () => {
  ...
  return (function (e, t, n) {
    const r = wt.reduce(
      ...
      s = r[o],
      i = s.names[s.names.length - 1] ?? dt.extraSmall,
      a = ft[i],
      c = r.width.names,
      u = r.height.names,
      l = c[c.length - 1] ?? dt.extraSmall,
      d = u[u.length - 1] ?? dt.extraSmall,
      f = { width: ft[l].width, height: ft[d].height };
    return {
      mediaClass: yt(o, r),
      breakpoint: a,
      screenWidthRem: e,
  ...
  })(e.width, e.height, ye(1));
};
function vt({ children: e }) {
  const [t, n] = o.useState(Et);
  return (
    o.useLayoutEffect(() => {
      function e() {
        n(Et);
    ...
    s.jsx(lt.Provider, { value: t, children: e })
  );
}
function xt() {
  return (function () {
...
function St({ children: e, className: t, ...n }) {
  const { mediaClass: r, upscale: o } = xt();
  return s.jsx("div", {
...
function Tt({ children: e, ...t }) {
  return s.jsx(vt, { children: s.jsx(St, { ...t, children: e }) });
}
function Rt(e, t) {
  return (function (e, t, n) {
...
function Pt(e, t) {
  return xt().upscale ? t : e;
}
function Nt(e, t) {
  const n = xt();
  return t
    ? Object.values(ft).reduce(
...
function Dt(e) {
  ...
  return (
    ...
    o.useCallback((...e) => (0, t.current)(...e), Ct)
  );
}
const At = (e, t, n = !0) => {
  const r = Dt((e) => {
...
const Bt = () => {
  ...
  Ot = o.createContext(void 0);
function Lt(e, t, n, r = !1) {
  const s = ze(e),
    i = Dt((e) => {
      ve() || (n(e), Ee(), r && e.stopPropagation());
    }),
    a = (function () {
    ...
    c = o.useMemo(() => a[t].register(s, i), [a, t, s, i]);
  o.useEffect(() => c, [c]);
}
function It(e, t, n = !1) {
  return Lt(ze(e), "keydown", t, n);
}
function Ft(e) {
  const t = o.useMemo(Bt, []),
    n = o.useMemo(Bt, []);
  o.useEffect(() => {
    function e(e) {
  ...
  return s.jsx(Ot.Provider, { value: r, children: e.children });
}
function zt(e) {
  return It(Ie.ESCAPE, e);
}
function Ut() {
  return (function (e = Ie.ESCAPE) {
    return It(ze(e), _e.closeView, !0);
  })(Ie.ESCAPE);
}
const jt = (e, t) => {
    o.useEffect(() => {
...
function Gt(e, t, n) {
  ...
  return (o.useEffect(() => r.cancel, [r]), r);
}
...
function qt({
  ...
  const a = o.useRef({ status: Xt, resId: e, timeoutId: 0 }),
    [c, u] = o.useMemo(() => {
      let o = null;
      function c() {
        r ||
          ("display" === a.current.status && (_e.tooltip.hide(e, t, n), (a.current.status = Xt)),
          (a.current.status = Vt),
          window.clearTimeout(a.current.timeoutId),
          (a.current.timeoutId = window.setTimeout(u, i)));
      }
      function u() {
        ((a.current.status = Yt), _e.tooltip.open(e, t, n, s), o && Wt.set(o, d));
      }
      function l() {
        if (
          (window.clearTimeout(a.current.timeoutId),
          a.current.status === Yt && _e.tooltip.hide(e, t, n),
          (a.current.status = Xt),
          o)
        ) {
          Wt.delete(o);
          let e = o.parentElement;
          for (; e && !Wt.has(e);) e = e.parentElement;
          if (e) {
            Wt.get(e).show();
          }
          o = null;
      ...
      const d = {
        ...
        show: u,
        rerun: function () {
          a.current.status !== Xt && (r ? d.hide() : c());
        },
      };
      return [
        d,
...
function Qt({ alert: e, body: t, header: n, note: r, hasHtmlContent: s, disabled: i }) {
...
const Jt = o.createContext(null);
function en({ severity: e = "warn", overrides: t, silent: n = !1, children: r }) {
  const i = o.useMemo(() => ({ ...Kt, ...t }), [t]),
    a = o.useMemo(
      () => ({
        play: function (t, r) {
          if (n) return;
  ...
  return s.jsx(Jt.Provider, { value: a, children: r });
}
function tn() {
  const e = o.useContext(Jt);
...
const nn = new Set(["number", "string", "boolean", "bigint", "undefined", "function"]),
  ...
  on = new Set(["Dict"]);
function sn(e, { shallow: t = !0, depth: n = 0, maxDepth: r = 32 } = {}) {
  const o = e,
    s = typeof e;
  if (n > r) throw new Error(`Too deeply nested to copy. Max is ${r}.`);
  if (nn.has(s)) return o;
  if (null === o) return o;
  const i = { depth: n + 1, maxDepth: r };
  if (Array.isArray(o)) return o.map((e) => sn(e, i));
  if ("object" === s) {
    const r = o.constructor?.name ?? "UNKNOWN";
    if (Array.isArray(e)) return e.map((e) => sn(e, i));
    if ("CoherentArrayProxy" === r) return e.map((e) => sn(e.value, i));
    if ("Dict" === r) return;
    if ("UNKNOWN" === r) return;
    ...
    const s = {};
    for (const e of Object.keys(o)) s[e] = sn(o[e], i);
    return s;
  }
  return (console.error("Incorrect value to clone model", o), o);
}
const an = { deep: !1, equals: ke },
  cn = { cloneItem: !0 },
  un = { shallow: !1 };
class ln {
  constructor(e, t = cn) {
    ...
    for (let o = 0; o < r.length; o++) {
      const t = r[o];
      n[t] = c.box(this.takeItem(e, t), an);
    }
    ((this._keys = c.set(new Set(r))), (this._data = c.box(n, an)));
  }
  _data;
  _keys;
  get keys() {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      o in n
        ? null === s
          ...
          : n[o].set(s)
        : null !== s && ((n[o] = c.box(s, an)), this._keys.add(o), this.set(n));
    }
  }
  entries() {
  ...
  takeItem(e, t) {
    const n = e.get(t);
    return this.options.cloneItem ? sn(n, un) : n;
  }
  set = u((e) => {
    this._data.set(e);
  });
...
const dn = o.createContext({ mode: "real" }),
  fn = { equals: ke, deep: !1 };
function mn(e, t, n) {
  const r = [];
...
const hn =
    ...
    (t, n, r) => {
      ...
      function a(a) {
          ...
          _ = Dt((o, s, i) => {
            const c =
              ...
              f = t({
                ...
                requires: g,
                externalModel: c,
                observableModel: mn(c, o, u),
                cleanup: l,
              }),
              m = { ...d, mode: o, model: f, externalModel: c, cleanup: l, requires: g },
              h = "mocks" === o && i?.controls ? i.controls(m) : {};
            return {
              model: f,
              controls: { ...n?.(m), ...h },
              externalModel: c,
        ...
        const [E, v] = o.useState(() => _(w, u, h));
        return (
          o.useEffect(() => {
            b.current ? v(_(w, u, h)) : (b.current = !0);
          }, [_, h, w, u?.context, u?.initializer, u?.getRoot, u?.rootId]),
          o.useEffect(
            () => () => {
          ...
          s.jsx(i.Provider, { value: E, children: l })
        );
      }
      return (
        (a.displayName = e),
...
async function gn(
  ...
  (o && engine.enableImmediateLayout(!0),
    ...
    f.createRoot(t).render(s.jsx(i, { children: s.jsx(Ft, { children: e }) })),
    r &&
      (!(function (e) {
        function t() {
...
o.forwardRef(function (e, t) {
  ...
  return (
    ...
    s.jsx("div", { ...e, ref: pn([t, n]) })
  );
});
const wn = o.createContext(void 0);
function yn() {
  const e = o.useContext(wn);
  if (!e)
...
const vn = {
  ...
  xn = (({
    ...
    return (u = {}) => {
      const { settings: l = vn } = u,
        [d, f] = o.useState(!1),
        m = o.useRef(null),
        h = o.useRef(null),
        p = o.useRef({ wrapper: 0, container: 0 }),
        g = o.useMemo(() => {
          const e = {},
          ...
          function (e, { immediate: t = !1, reset: n = !0 } = {}) {
            ...
            b.scrollPosition.goal !== o &&
              w.start({
                ...
                from: { scrollPosition: c(r, b.scrollPosition.get()) },
                onChange: () => {
                  i && _();
                },
              });
          },
          [b.scrollPosition, w, l.animationConfig, _],
        ),
        v = o.useCallback(
          function (e) {
            const t = m.current,
        ...
        x = o.useCallback(
          ...
          [b.scrollPosition, v, g, d],
        ),
        S = o.useCallback(
          function () {
            const e = m.current;
            e && (E(c(e, b.scrollPosition.goal), { immediate: !0 }), g.trigger("resizeHandled"));
          },
          [E, b.scrollPosition.goal, g],
        );
      At(h, (e) => {
        const t = e.target;
      ...
      const T = Dt(function () {
          ...
          if (!t) return;
          const n = e(t),
            r = h.current ? s(h.current) : 0;
          if (p.current.container !== n || p.current.wrapper !== r) {
            const e = c(t, b.scrollPosition.goal);
            (e !== b.scrollPosition.goal && E(e, { immediate: !0 }),
        ...
        R = Ht();
      o.useEffect(() => Be(window, "resize", () => R.run(S)), [S, R]);
      return o.useMemo(
        () => ({
          getWrapperSize: () => (h.current ? s(h.current) : void 0),
  ...
  Sn = { horizontal: "horizontal", vertical: "vertical" },
  Tn = {
...
function Nn(e) {
  ...
  o.useEffect(() => {
    n || e.dragging
      ? l.start({
          to: e.styles.opened,
          onRest() {
            t.current?.classList.add(Tn.base__active);
          },
        })
      : l.start({
          to: e.styles.closed,
          delay: 500,
          onRest() {
            t.current?.classList.remove(Tn.base__active);
          },
        });
      ...
      "number" == typeof t &&
        (function (e, t) {
          ...
          if (n instanceof HTMLElement) {
            if (0 === t) return (n.classList.add(Pn), void n.classList.remove(Rn));
            if (e.isBoundThumb(t)) return (n.classList.remove(Pn), void n.classList.add(Rn));
            (n.classList.remove(Pn), n.classList.remove(Rn));
          }
        })(e, t);
    });
  o.useEffect(() => f.run(h));
  ...
  return (
    ...
    s.jsxs(m.div, {
      ref: pn([t, e.thumbRef]),
      className: i(Tn.base, Tn[`base__${e.direction}`], e.className),
      style: u,
      onMouseEnter: () => r(!0),
      onMouseLeave: () => r(!1),
      children: [
        s.jsx("div", { className: Tn.background }),
        s.jsx("div", { className: Tn.border }),
        s.jsx("div", { className: Tn.innerBorder }),
        s.jsx("div", { className: Tn.icon }),
      ],
    })
  );
}
...
function Dn(e, t, n, r, s) {
  ...
  return (
    o.useEffect(() => {
      if (!i.pending) return;
      const t = re.move(function ([t]) {
          const o = n.contentRef.current;
          if (!o) return;
          const a = r.current,
            u = e.current;
          if (!o || !a || !u) return;
          const l = s(t, i, { parent: a, thumb: u }),
    ...
    }, [n, i.offset, i.pending, c, u, e, r, i, s]),
    u
  );
}
const An = "disable",
  kn = "scroll-active";
function Mn({ api: e, baseRef: t }) {
  const n = Ht(),
    r = Dt(function () {
      const n = e.getWrapperSize(),
        r = e.getContainerSize();
      if (null === t.current || void 0 === r || void 0 === n) return;
      1 === Math.min(1, n / r || 1) ? t.current.classList.remove(kn) : t.current.classList.add(kn);
    });
  (o.useEffect(() => n.run(r)),
    o.useEffect(() => {
      function t() {
...
function Bn(e, t) {
  const n = e.getBoundingClientRect(),
    r = t === Sn.horizontal ? n.x : n.y;
  return { start: r, end: t === Sn.horizontal ? r + n.width : r + n.height };
}
function On(e, t, n, r, s, i, a) {
  const c = tn(),
    u = s.stepTimeout || 100,
    [l, d] = (function (e, t, n = []) {
      const r = o.useRef(0),
  ...
  const f = o.useCallback(
      (e) => {
        e.target.classList.contains(An) ||
          (c.play("click", { target: "Scroll:Back", original: e }), l(En.Next));
      },
      [l, c],
    ),
    m = o.useCallback(
      (e) => {
        e.target.classList.contains(An) ||
          (c.play("click", { target: "Scroll:Forward", original: e }), l(En.Prev));
      },
      [l, c],
    ),
    h = o.useCallback(
      (o) => {
        const u = e.current,
          ...
          d = n.current,
          h = r.current;
        if (!(u && l && d && h && 0 === o.button)) return;
        const p = (function (e, t, n, r, o, s) {
            return {
              occurredEvent: s === Sn.horizontal ? e.screenX : e.screenY,
              bar: Bn(t, s),
              thumb: Bn(n, s),
              backButton: Bn(r, s),
              forwardButton: Bn(o, s),
            };
          })(o, u, l, d, h, a),
        ...
        if (g) i({ pending: !0, offset: p.occurredEvent - p.thumb.start });
        else if (_) {
          ((p.occurredEvent > p.thumb.start ? En.Prev : En.Next) === En.Next ? f : m)(o);
        } else {
        ...
        c.play("click", { target: "Scroll:" + (g ? "thumb" : _ ? "button" : ""), original: o });
      },
      [e, t, n, r, c, a, i, f, m, s],
    ),
    p = o.useCallback(
...
const Ln = "HorizontalBar_rail_37858d8f",
  In = "HorizontalBar_4df27ac3",
  Fn = "HorizontalBar_track_649dc296",
  zn = "HorizontalBar_rail__left_1a906b4e",
  Un = "HorizontalBar_rail__right_cd24364e",
  jn = "HorizontalBar_button__right_e8f0aa2d",
  $n = "HorizontalBar_button__left_da330e13",
  Hn = "HorizontalBar_button_cbabd91",
  Gn = { closed: { height: "3rem", top: "4rem" }, opened: { height: "11rem", top: "0rem" } },
  Wn = (e, t) => Math.max(ye(13), e.offsetWidth * t),
  Vn = o.memo(function ({ classNames: e = {}, onDrag: t = Ae }) {
    const n = o.useRef(null),
      r = o.useRef(null),
      a = o.useRef(null),
      c = o.useRef(null),
    ...
    const p = Dt(
      ...
      g = Dt((e) => e - (c.current.offsetWidth - u.current.offsetWidth) >= -0.5),
      _ = o.useCallback(
        (e) => ("dragStart" === e.type ? m(!0) : "dragEnd" === e.type && m(!1), t(e)),
        [t],
      ),
      b = Dn(u, _, h, c, p),
      w = Dt(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
        const r = c.current,
          o = l.current,
          s = d.current;
        if (!r || !o || !s) return;
        const i = ye(5);
        ((o.style.width = `${t - i + n}px`),
          (s.style.width = r.offsetWidth - e - t - i - n + "px"));
      }),
      { handleMouseEnter: y, handleMouseDownTrack: E } = On(n, u, a, r, h, b, Sn.horizontal);
    return s.jsxs("div", {
      className: i(In, e.base),
      ref: n,
      onWheel: h.handleMouseWheel,
      onMouseDown: E,
      onMouseEnter: y,
      children: [
        s.jsx("div", { ref: r, className: i(Hn, $n, e.leftButton) }),
        s.jsxs("div", {
          ref: c,
          className: i(Fn, e.track),
          children: [
            s.jsx("div", { ref: l, className: i(Ln, zn, e.leftRail) }),
            s.jsx(Nn, {
              dragging: f,
              api: h,
              calculateOffset: p,
            ...
            s.jsx("div", { ref: d, className: i(Ln, Un, e.rightRail) }),
          ],
        }),
        s.jsx("div", { ref: a, className: i(Hn, jn, e.rightButton) }),
      ],
    });
  }),
  Xn = {
...
function Yn({ className: e, classNames: t, children: n }) {
  const { api: r } = yn();
  return s.jsx("div", {
    className: i(Xn.base, e),
    children: s.jsx("div", {
      className: i(Xn.wrapper, t?.wrapper),
      onWheel: r.handleMouseWheel,
      ref: r.wrapperRef,
      children: s.jsx("div", {
        className: i(Xn.content, t?.content),
        ref: r.contentRef,
        children: n,
      }),
    }),
...
((Yn.Bar = Vn),
  (Yn.Default = ({
    ...
    const { api: l } = yn(),
      d = o.useMemo(() => {
        const e = n || {};
        return { ...e, base: i(Xn.base, e.base) };
      }, [n]);
    return s.jsxs("div", {
      className: i(Xn.defaultScroll, t),
      onWheel: l.handleMouseWheel,
      children: [
        s.jsx("div", {
          className: i(Xn.defaultScrollArea, r),
          children: s.jsx(Yn, { className: c, classNames: a, children: e }),
        }),
        s.jsx(Vn, { onDrag: u, classNames: d }),
      ],
    });
  }));
const qn = "horizontal",
...
function Kn(e, t) {
  switch (t) {
    ...
    case Qn:
      return e.screenY;
    default:
      qe(!1, `Such drag direction ${t} is not supported`);
  }
}
const Zn = { type: "idle" };
function Jn(e, t, n, r) {
  ...
  return (
    ...
    o.useEffect(() => {
      ...
      const r = re.move(([e]) => {
        ...
        o = re.up(() => m({ type: "scrollComplete" }));
      return () => {
        (r(), o());
      };
    }, [u.scrollPosition, s, h, t, f, g, i]),
    o.useEffect(() => {
      ...
      const e = re.move(([e, r]) => {
        ...
        if (null === o || null === l || ("inside" === r && d < 0)) return;
        const h = l.offsetLeft,
          p = "inside" === r ? d : d - h,
          g = f.positionFrom - p,
          _ = f.previousScrollPosition + g;
        a.start({
          scrollPosition: c(o, _),
          from: { scrollPosition: u.scrollPosition.get() },
          ...n,
        });
      });
      const r = re.up(function () {
        m({ type: "scrollComplete" });
      });
      return () => {
        (e(), r());
      };
    }, [u.scrollPosition, c, s, f, a, i, n, t]),
    o.useEffect(() => {
    ...
    }, [u.scrollPosition, f.type, l]),
    o.useEffect(() => {
      if (d) return;
      const e = s.current;
      if (!e) return;
      const n = (e) => {
        if (e.button !== st) return;
        const n = Kn(e, t);
        (p(n),
          m(
            void 0 === g || g <= 0
    ...
    }, [u.scrollPosition, s, d, t, g]),
    f
  );
}
function er({ settings: e, children: t }) {
  const n = xn({ settings: e }),
    r = o.useMemo(() => ({ api: n }), [n]);
  return s.jsx(wn.Provider, { value: r, children: t });
}
const tr = o.createContext(void 0);
const nr = "VerticalBar_rail_3d663c9",
  rr = "VerticalBar_7187fa00",
  or = "VerticalBar_track_ff482708",
  sr = "VerticalBar_rail__top_ee531f43",
  ir = "VerticalBar_rail__bottom_3eaa33b1",
  ar = "VerticalBar_button__bottom_6880f123",
  cr = "VerticalBar_button__top_b8383775",
  ur = "VerticalBar_button_7b0e4aca",
  lr = { closed: { width: "3rem", left: "3rem" }, opened: { width: "9rem", left: "0rem" } },
  dr = (e, t) => Math.max(ye(13), e.offsetHeight * t);
o.memo(function ({ classNames: e = {}, onDrag: t = Ae }) {
  const n = o.useRef(null),
    r = o.useRef(null),
    a = o.useRef(null),
    c = o.useRef(null),
    ...
    [f, m] = o.useState(!1),
    { api: h } = (function () {
      const e = o.useContext(tr);
      if (!e)
        throw new Error("useVerticalScroll must be used within a Scroll.Vertical.Base component");
      return e;
    })();
  Mn({ baseRef: n, api: h });
  const p = Dt((e) => e - (c.current.offsetHeight - u.current.offsetHeight) >= -0.5),
    g = Dt(
      (e, t, { parent: n }) =>
    ...
    w = Dt(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: n }) => {
      ...
      if (!r || !o || !s) return;
      const i = ye(5);
      ((o.style.height = `${t - i + n}px`),
        (s.style.height = r.offsetHeight - e - t - i - n + "px"));
    }),
    { handleMouseEnter: y, handleMouseDownTrack: E } = On(n, u, r, a, h, b, Sn.vertical);
  return s.jsxs("div", {
    className: i(rr, e.base),
    ref: n,
    onWheel: h.handleMouseWheel,
    onMouseDown: E,
    onMouseEnter: y,
    children: [
      s.jsx("div", { ref: r, className: i(ur, cr, e.topButton) }),
      s.jsxs("div", {
        ref: c,
        className: i(or, e.track),
        children: [
          s.jsx("div", { ref: l, className: i(nr, sr, e.topRail) }),
          s.jsx(Nn, {
            dragging: f,
            api: h,
            calculateOffset: g,
          ...
          s.jsx("div", { ref: d, className: i(nr, ir, e.bottomRail) }),
        ],
      }),
      s.jsx("div", { ref: a, className: i(ur, ar, e.bottomButton) }),
    ],
  });
});
const fr = { primary: "primary", secondary: "secondary", custom: "custom" },
  mr = { extraSmall: "extraSmall", small: "small", medium: "medium", large: "large" };
function hr(e, t, n) {
  ...
  const a = h(t, n),
    c = o.forwardRef(function (t, n) {
      return s.jsx("div", { "data-name": e, ...pr(i, t), ref: n, className: a(t) });
    });
...
const gr = hr("Button", { element: "button", className: "HeadlessButton_df8536fc" }),
  _r = o.forwardRef(function (
    {
      children: e,
      onClick: t,
      onMouseEnter: n,
    ...
    return s.jsx(gr, {
      ...
      onMouseEnter: function (e) {
        (o || i || u.play("mouse-enter", { target: r || "Button", original: e }), n?.(e));
      },
      onClick: function (e) {
        o || (i || u.play("click", { target: r || "Button", original: e }), t?.(e));
      },
      children: e,
    });
  }),
  ...
  wr = o.forwardRef(function (
    ...
    return s.jsxs(_r, {
      ...
      className: i(
        ...
        br[`base__size-${t}`],
        br[`base__theme-${n}`],
        r ? br.base__disabled : br.base__enabled,
        u,
        c?.base,
      ),
      onClick: function (e) {
      ...
      children: [
        s.jsx("div", { className: i(br.background, c?.background) }),
        s.jsx("div", { className: i(br.border, c?.border) }),
        s.jsx("div", { className: i(br.overlay, c?.overlay) }),
        s.jsx("div", {
          className: i(br.content, a && br.content__fontAligned, c?.content),
          children: e,
        }),
      ],
    });
  });
((wr.themes = fr), (wr.sizes = mr));
const yr = {
  ...
  Er = { medium: "medium", small: "small", extraSmall: "extraSmall" },
  vr = { [Er.medium]: "x96x96", [Er.small]: Er.medium, [Er.extraSmall]: "x32x32" };
function xr({
  size: e = Er.medium,
  ...
  const a = Pt(yr[`base__${e}`], yr[`base__${vr[e]}`]);
  return s.jsx("div", {
    className: p(yr.base, a, r),
    onMouseEnter: () => {
      (ce.sound(t), o?.());
    },
    onClick: () => {
...
var Sr = ((e) => (
  ...
  Pr = ((e) => ((e.BATTLE_BOOSTER = "battleBooster"), e))(Pr || {}),
  Nr = ((e) => (
    (e.ATTACHMENT_RARE = "rare"),
    (e.ATTACHMENT_EPIC = "epic"),
    (e.ATTACHMENT_LEGENDARY = "legendary"),
...
(Sr.Items,
  ...
  Sr.NaturalCover,
  Sr.BpCoin,
  Sr.BattlePassSelectToken,
  Sr.BattlaPassFinalAchievement,
  Sr.BattleBadge,
  Sr.BonusX5,
  Sr.CrewBonusX3,
  Sr.EpicSelectToken,
  Sr.Comp7TokenWeeklyReward,
  Sr.DeluxeGift,
  Sr.BattleBoosterGift,
  Sr.OptionalDevice,
  Sr.TmanToken,
  Sr.Pet,
  Sr.Gold,
  ...
  Sr.PremiumPlus,
  Sr.Premium);
const Cr = [Tr.Small, Tr.Big],
  Dr = (e, t) => {
    if (void 0 === t || !Cr.includes(e)) return null;
    switch (t) {
      case Rr.BATTLE_BOOSTER:
      case Rr.BATTLE_BOOSTER_REPLACE:
        return Pr.BATTLE_BOOSTER;
    }
  },
  Ar = (e) => {
  ...
  return Array.isArray(e)
    ? (function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          const r = e[n],
            i = e[n + 1];
          if ("string" != typeof i || !zr.test(i)) {
            t.push(jr(r));
            continue;
          }
          const a = Ur(i.slice(1));
          (t.push(
            s.jsxs(
              o.Fragment,
              { children: [s.jsxs("span", { className: Or.nowrap, children: [jr(r), i[0]] }), a] },
              Fr(),
            ),
          ),
            (n += 1));
    ...
    : "string" == typeof e
      ? s.jsx(o.Fragment, { children: Ur(e) }, Fr())
      : e;
}
const $r = {
  class: function (e, ...t) {
...
function Vr(e, t) {
  for (let n = 0; n < e.length; n++) {
    if ("$" === e[n]) {
      let r = n + 1;
      for (; r < e.length && !Wr(e[r]);) r++;
      const o = e.slice(n + 1, r),
        s = t[o];
      if (s) return Vr(e.replace(`$${o}`, String(s)), t);
    }
  }
  return e;
}
function Xr(e, t) {
  const n = [];
  for (let r = 0; r < e.length; r++) n[r] = Vr(e[r], t);
  return n;
}
const Yr = ["number", "string", "undefined"];
function qr(e, t, n = {}, r = !0) {
  r && (Ir = 0);
  const i = [];
  function a(e) {
    if (Yr.includes(typeof e)) {
      const t = i.at(-1);
  ...
  for (const c of e)
    if (c.type === kr) a(c.value);
    else if (c.type === Br)
      null === n[c.name] || Yr.includes(typeof n[c.name])
        ? a(n[c.name] ?? `{{${c.name}}}`)
        : i.push(s.jsx(o.Fragment, { children: n[c.name] }, `var-${c.name}-${c.instanceId}`));
    else if (c.type === Mr) {
      const e = qr(c.children, t, n, !1),
        r = Gr(Xr(c.attrs, n), e, t);
      i.push(r);
    }
  return i;
}
...
const Jr = { start: "{{", end: "}}" },
  eo = o.memo(function (e) {
    const {
      ...
      h = o.useMemo(() => (e.formatters ? { ...$r, ...e.formatters } : $r), [e.formatters]),
      p = o.useMemo(
        () =>
          (function (e, t) {
            const n = [],
            ...
            for (let c = 0; c < e.length; c++) {
              ...
              if (u === t.start[0] && e.slice(c, c + t.start.length) === t.start)
                (o &&
                  (r.length > 0
                    ? r[r.length - 1].node.children.push({ type: kr, value: o })
                    : n.push({ type: kr, value: o }),
                  (o = "")),
                  (s = !0),
                  (c += t.start.length - 1));
      ...
      g = o.useMemo(() => qr(p, h, e.params), [p, h, e.params]),
      _ = i(Or.base, c && Or.base__fullSize, f.className);
    return e.inline
      ? (console.warn(
      ...
      : s.jsx("span", { ...f, className: _, children: g });
  });
function to({ path: e, ...t }) {
  return s.jsx(eo, { text: g.resolve("strings").readOrEmpty(e), ...t });
}
function no(e) {
  return (
    !(null != e && !["string", "number", "boolean"].includes(typeof e)) ||
    (!o.isValidElement(e) && !!Array.isArray(e) && e.every(no))
  );
}
const ro = "MultilineOverflow_ec9f8e47",
  oo = "MultilineOverflow_content_b539970d";
function so(e) {
...
const io = o.forwardRef(function (
  {
    text: e,
    brackets: t,
    params: n,
  ...
  o.useEffect(() => {
    ...
    function o() {
      ...
      (r.remove(),
        (r.className = i(oo, t.children[0].className)),
        (r.innerHTML = ""),
      ...
      if (s === o) T(!1);
        ...
        const o =
          ...
          { x: (c = e.getBoundingClientRect()).x - a.x, y: c.y - a.y });
        for (
    ...
    return (
      s.observe(t),
      new Me()
        .add(Be(window, "resize", o))
        .add(s.disconnect.bind(s))
        .add(r.remove.bind(r)).dispose
    );
  }, [E, e]);
  const R = (function (e) {
      return !e || Object.values(e).every(no);
    })(n),
    P = (function (e, t, n) {
      return qt({
        ...n,
        disabled: n?.disabled,
        contentId: g.resolve("aliases").read((e) => e.common.tooltip.Param("resId")),
        args: o.useMemo(() => ({ type: e, params: JSON.stringify(t), resId: t.resId }), [t, e]),
      });
    })(
      "format_text",
      o.useMemo(
        () => ({
          ...
          upgradeLegacy: a,
          brackets: t,
          resId: g.resolve("views").read((e) => e.mono.tooltips.tooltips("resId")),
        }),
        [e, t, c, a, n, R],
      ),
    ),
  ...
  return s.jsxs("div", {
    ...
    children: [
      s.jsx(eo, {
        ...
        formatters: r,
        className: p?.text,
        style: { ...w, visibility: S ? "hidden" : void 0 },
      }),
      s.jsx("div", {
        ref: x,
...
const ao = o.forwardRef(function (
    {
      src: e,
      className: t,
      autoplay: n = !1,
    ...
    return (
      kt(() => {
        let e = !1;
        return le.onDisplayChanged((t, n) => {
          const r = m.current;
      ...
      o.useEffect(
        () =>
          Xe(() => {
            const e = m.current;
            if (!f || !e || !a) return void (e?.cohFastSeek && (e.cohFastSeek = !1));
      ...
      o.useEffect(() => {
        if (f && m.current) {
          const e = { changeTimeHandlers: [], changeKeyframeHandlers: [], changeTimeLoop: Ae },
            t = () => {
              let t = 0;
          ...
          const n = (t) => (
            ...
            o = () => m.current?.currentTime,
            s = () => m.current?.duration,
            i = (e) => {
              m.current && (m.current.currentTime = De(0, m.current.duration, e));
            },
            u = () => m.current?.play(),
            l = () => m.current?.pause(),
            d = () => {
            ...
            h = () =>
              m.current?.cohGetKeyframeTimestamps ? m.current.cohGetKeyframeTimestamps() : [],
            p = (e) => {
              (i(e), u());
            },
            g = (e) => {
            ...
            b = (e, t) => (
              m.current?.addEventListener(e, t),
      ...
      s.jsx("video", { src: e, className: t, style: r, loop: i, ref: m, onClick: u, ...l })
    );
  }),
  co = o.memo(ao),
  uo = {
    ...
    o.useEffect(() => {
      const e = (e) => {
        u((o) => {
          ...
          const s = "countdown" === t ? V(o.current, e) : W(o.current, e),
            i = { ...o, current: s };
          return (
            B(r) &&
              ("countdown" === t
                ? Y(V(s, n), r) && ((i.current = r), (i.running = !1))
                : X(W(s, n), r) && ((i.current = r), (i.running = !1))),
            i
          );
        });
      };
...
const zo = "NotificationWrapper_6fe65b7",
  ...
  $o = o.forwardRef(function ({ text: e, tooltipParams: t, className: n, ...r }, a) {
    const c = Qt({ header: t?.header, body: t?.body || e }),
      ...
      f = o.useCallback(() => {
        u.current &&
          d(u.current.scrollWidth - Math.ceil(u.current.getBoundingClientRect().width) > 0);
      }, []);
    var m, h;
    return (
      o.useEffect(() => {
