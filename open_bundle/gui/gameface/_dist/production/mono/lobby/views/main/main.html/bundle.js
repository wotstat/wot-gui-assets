    ...
    return r.jsx("div", {
      ...
      children: v.isLow()
        ...
        : r.jsx(i.div, {
            className: l(aa, e),
            style: _,
            children: r.jsx(Je, { parallaxConfig: n }),
          }),
    });
  }),
    ...
    return r.jsxs("div", {
      ...
      children: [
        r.jsx("div", {
          ...
          children: r.jsx("div", {
            className: na,
            style: { backgroundImage: `url(${n("main.done")})` },
          }),
        }),
      ...
      K.includes(e.name)
        ? r.jsx(
            S,
            {
              type: e.name,
              reverse: !0,
              children: r.jsx("div", { className: fa, children: e.label }),
            },
            `${e.name}_${a}`,
          )
        : null,
...
const nt = "Cell_4eaa0f36",
  ot = n.forwardRef(function (
    { cell: e, showProbabilities: a, style: t = {}, className: s = "", ...n },
    o,
  ) {
...
((ot.Border = function ({ bundleType: e, style: a = {}, className: t = "" }) {
  ...
  return r.jsx("div", {
    className: l(qa, t),
    style: { borderImageSource: `url(${s("main.cell.border")})`, ...a },
  });
}),
  (ot.AnimationState = function ({
    template: e,
    bundleType: a,
    animationType: t,
    className: s = "",
        ...
        : s
          ? r.jsx(
              ot.AnimationState,
              {
                template: p.template,
                bundleType: d,
                className: it.cellSelection,
                animationType: s,
              },
              a,
            )
          : e
            ? r.jsx(ot.ProbabilityState, {
                bundleType: d,
                value: p.probability,
                className: it.probability,
              })
            : void 0,
    ...
    return (
      ...
      r.jsxs("div", {
        ...
        children: [
          ...
          k(a.cells.get(), (e) =>
            r.jsx(dt, { name: e.name, showProbabilities: u, className: ut }, e.name),
          ),
        ],
      })
    );
        ...
        r.jsxs("div", {
          ...
          children: [
            ...
            r.jsxs("div", {
              ...
              children: [r.jsx(pt, { className: bt.layout }), c],
            }),
          ],
        }),
