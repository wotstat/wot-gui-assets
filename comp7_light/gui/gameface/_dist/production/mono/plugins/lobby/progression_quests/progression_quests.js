...
!(function (e, t) {
  ...
  function Ae({ severity: t = "warn", overrides: n, silent: r = !1, children: a }) {
  ...
  var At = new RegExp("rgb" + It(Tt, Tt, Tt)),
    St = new RegExp("rgba" + It(Tt, Tt, Tt, Tt)),
    kt = new RegExp("hsl" + It(Tt, Pt, Pt)),
  ...
  var En = Symbol.for("Animated:node"),
    ...
    Nn = class extends In {
      ...
      _addToPayload(e) {
        kn.dependencies && Wt(e) && kn.dependencies.add(e);
        const t = Pn(e);
        t && at(t, (e) => this.add(e));
      }
    },
  ...
  function jn(e) {
    return (bn(e) ? Sn : An).create(e);
  }
  function On(e) {
    const t = Cn(e);
    return t ? t.constructor : st.arr(e) ? Mn : bn(e) ? Sn : An;
  }
  var Dn = (e, t) => {
      ...
      return s.forwardRef((r, a) => {
        const o = s.useRef(null),
          ...
          [c, l] = (function (e, t) {
            ...
            return ((e = new Nn(e)), (kn.dependencies = null), [e, n]);
          })(r, t),
          u = vn(),
          d = () => {
            const e = o.current;
  ...
  var ps = class extends Error {
    ...
    Rs = class extends _s {
          ...
          actions: {
            pause: () => {
              vs(this) ||
                (xs(this, !0),
                dt(a.pauseQueue),
                ks(this, "onPause", cs(this, Es(this, this.animation.to)), this));
            },
            resume: () => {
              vs(this) &&
                (xs(this, !1),
                ...
                dt(a.resumeQueue),
                ks(this, "onResume", cs(this, Es(this, this.animation.to)), this));
            },
      ...
      _onStart() {
        ...
        e.changed || ((e.changed = !0), ks(this, "onStart", cs(this, Es(this, e.to)), this));
      }
      _onChange(e, t) {
      ...
      _stop(e, t) {
        if (ys(this)) {
          ...
          (dt(this._pendingCalls, s), n.changed && ((n.changed = !1), ks(this, "onRest", s, this)));
        }
      }
    };
  function Es(e, t) {
  ...
  function Qs(e, t) {
    const n = st.fun(e),
      [[r], a] = (function (e, t, n) {
        const r = st.fun(t) && t;
        r && !n && (n = []);
        const a = s.useMemo(() => (r || 3 == arguments.length ? Hs() : void 0), []),
          o = s.useRef(0),
          i = vn(),
          c = s.useMemo(
            () => ({
  ...
  function Xs(e, t, n) {
    const r = st.fun(t) && t,
      ...
      m = s.useMemo(() => (r || 3 == arguments.length ? Hs() : void 0), []),
      h = it(e),
      _ = [],
      g = s.useRef(null),
      b = a ? null : g.current;
  ...
  function xr({
    ...
    const i = s.useRef({ status: vr, resId: e, timeoutId: 0 }),
      [c, l] = s.useMemo(() => {
        ...
        function c() {
          r ||
            ("display" === i.current.status && (Q.tooltip.hide(e, t, n), (i.current.status = vr)),
            (i.current.status = yr),
            window.clearTimeout(i.current.timeoutId),
            (i.current.timeoutId = window.setTimeout(l, o)));
        }
        function l() {
          ((i.current.status = wr), Q.tooltip.open(e, t, n, a), s && br.set(s, d));
        }
        function u() {
          if (
            (window.clearTimeout(i.current.timeoutId),
            i.current.status === wr && Q.tooltip.hide(e, t, n),
            (i.current.status = vr),
            s)
          ) {
            br.delete(s);
  ...
  const Dr = "TruncateText_dcb41d92",
    Br = s.forwardRef(function ({ text: t, tooltipParams: n, className: r, ...a }, o) {
      ...
      return (
        ...
        e.jsx("div", { ...a, ref: ke([o, c]), className: A(Dr, r), ...(l ? i : {}), children: t })
      );
    }),
  ...
  const qr = { primary: "primary", secondary: "secondary", custom: "custom" },
    ...
    Wr = s.forwardRef(function (
      ...
      return e.jsxs(Hr, {
        ...
        children: [
          e.jsx("div", { className: A(Qr.background, i?.background) }),
          e.jsx("div", { className: A(Qr.border, i?.border) }),
          e.jsx("div", { className: A(Qr.overlay, i?.overlay) }),
          e.jsx("div", {
            className: A(Qr.content, o && Qr.content__fontAligned, i?.content),
            children: t,
          }),
        ],
      });
  ...
  const Yr = "Action_6c7b0c76",
    ...
    na = s.forwardRef(function ({ classNames: t, className: n, ...s }, r) {
      return e.jsxs(ta, {
        ...s,
        className: A(t?.base, n),
        ref: r,
        children: [
          e.jsx("div", { className: A(Kr, t?.background) }),
          e.jsx("div", { className: A(Jr, t?.mask) }),
          e.jsx("div", { className: A(ea, t?.border) }),
          s.children,
        ],
      });
    }),
  ...
  const Na = { start: "{{", end: "}}" },
    Ma = s.memo(function (t) {
      const {
        ...
        p = s.useMemo(() => (t.upgradeLegacy ? ka(t.text) : t.text), [t.text, t.upgradeLegacy]),
        ...
        _ = A(fa.base, i && fa.base__fullSize, d.className);
      return t.inline
        ? (console.warn(
  ...
  function Ha({
    ...
    return e.jsx(ja, {
      ...
      params: {
        ...
        totalClass: A(za, o?.total),
        labelClass: s && A(La, o?.label),
      },
    });
  }
  function Qa({
  ...
  function Ya({
    ...
    return e.jsxs(ca, {
      className: A(Wa.card, s && Wa.card__disabled, l),
      ...d,
      children: [
        e.jsxs(ca.Header, {
          onClick: a,
          className: A(Wa.cardHeader, u?.header?.base),
          classNames: {
            ...u?.header,
            background: A(Wa.cardHeaderBackground, u?.header?.background),
            border: A(Wa.cardHeaderBorder, u?.header?.border),
          },
          children: [
            e.jsxs("div", {
              className: A(Wa.head, u?.head),
              children: [
                e.jsxs("div", {
                ...
                void 0 !== o &&
                  e.jsx(ca.Action, {
                    ...
                    className: A(Wa.action, u?.action),
                    tooltipParams: r,
                  }),
              ],
            }),
            e.jsx("div", {
              className: A(Wa.tail, u?.tail),
              children: void 0 !== c && e.jsx(Ha, { ...c }),
            }),
          ],
        }),
        void 0 !== i && e.jsx(ca.Content, { className: A(Wa.content, u?.content), children: i }),
  ...
  const eo = s.forwardRef(function (
    ...
    s.useEffect(() => {
      ...
      function r() {
        ...
        (s.remove(),
          (s.className = A(Ka, e.children[0].className)),
          (s.innerHTML = ""),
  ...
  const bo = "Delta_eb295acb",
          ...
          e.jsxs(hr.div, {
            ...
            children: [
              e.jsxs(hr.div, {
                ...
                className: A(a?.outside, vo, C > 0 && wo),
                children: [
                  e.jsx(hr.div, {
                    style: { width: f.width.to((e) => `${e}%`) },
                    className: A(a?.inside, xo, C > 0 && Ro),
                  }),
                  l.children,
                ],
              }),
    ...
    Io = hr(Re),
    Ao = s.memo(function ({ filledPattern: t, animationConfig: n, className: r }) {
      const a = po(),
    ...
    So = s.memo(function ({
      ...
      return (
        ...
        e.jsxs("div", {
          className: A(Co.base, r),
          children: [
            e.jsx(hr.div, { className: n?.fill, style: { width: m.width.to((e) => `${e}%`) } }),
            o.children ??
              e.jsxs(e.Fragment, {
                children: [
                  e.jsx(Ao, { filledPattern: t, className: n?.filledPattern, animationConfig: a }),
  ...
  ((So.Filled = Ao), (So.Done = Po));
  const ko = { above: "above", below: "below" },
    No = {
  ...
  function Mo({ position: t, value: n, children: s, className: r, classNames: a }) {
    const o = po();
    return e.jsxs("div", {
      className: A(No.step, No[`step__${t}`], r),
      style: { left: (n / o.maxValue) * 100 + "%" },
      children: [
        t === ko.below && e.jsx("div", { className: A(No.indicator, a?.indicator) }),
        void 0 !== s && e.jsx("div", { className: A(No.label, a?.label), children: s }),
        t === ko.above && e.jsx("div", { className: A(No.indicator, a?.indicator) }),
      ],
    });
  }
          ...
          children: fe(t.count, (s) => {
            ...
            return e.jsx(
              Mo,
              {
                position: t.position,
                value: r,
                className: A(t.classNames?.step, a && t.classNames?.completed),
  ...
  const Do = "PreviewDelta_86b01c3e",
    ...
    Lo = s.forwardRef(function ({ value: t, classNames: n, ...s }, r) {
      ...
      return e.jsxs("div", {
        ...
        ref: r,
        className: A(Do, s.className),
        children: [
          e.jsx("div", {
            style: { left: `${u}%`, width: `${d}%`, ...s.style },
            className: A(n?.negative, Bo, "negative" === i && $o),
          }),
          e.jsx("div", {
            style: { left: `${u}%`, width: `${d}%`, ...s.style },
            className: A(n?.positive, Fo, "positive" === i && Uo),
          }),
        ],
      });
    });
  ...
  const qo = {
    ...
    Go = function ({
      ...
      return e.jsx(zo, {
        ...
        children: e.jsxs(Vo, {
          size: t,
          className: A(r, o.value === o.maxValue && s !== oo.doneInactive && qo.base__done),
          children: [
            e.jsx("div", { className: A(qo.border, qo[`border__${t}`], a?.border) }),
            e.jsx("div", { className: A(qo.background, a?.background) }),
    ...
    Wo = s.memo(function ({ progressBar: t, fill: n, delta: s, wrapperSpringProps: r }) {
      ...
      return e.jsx(Go, {
        ...
        children: e.jsxs(hr.div, {
          ...
          children: [
            e.jsx(Go.Fill, { ...n }),
            void 0 !== s && e.jsx(Go.Delta, { ...s, steps: s?.steps ?? Qo }),
          ],
        }),
      });
    }),
  ...
  const li = {
    ...
    Root: function ({ condition: t, ...n }) {
      return e.jsx(ni.Provider, {
        ...
        children: e.jsx("div", {
          ...n,
          className: A(oi.content, t.completed && oi.content__completed),
        }),
      });
    },
        ...
        children: [
          void 0 !== c &&
            e.jsx("div", {
              ...
              className: A(oi.titleIcon, c.default.isGold && oi.titleIcon__gold),
            }),
  ...
  const wi = _i(vi),
    ...
    Mi = ({
      ...
      const _ = Ni.has(a) ? Ni.get(a) : a,
        g = ((e, t) => {
          if (void 0 === t || !Ai.includes(e)) return null;
          switch (t) {
                ...
                children: [
                  g &&
                    e.jsx("div", {
                      ...
                      style: {
                        backgroundImage: `url(${ki.readOrEmpty(`quests.bonuses.${_}.${g}_highlight`)})`,
                      },
                    }),
                  n &&
                    e.jsx("div", {
                  ...
                  b &&
                    e.jsx("div", {
                      ...
                      style: {
                        backgroundImage: `url(${ki.readOrEmpty(`quests.bonuses.${_}.${b}_overlay`)})`,
                      },
                    }),
                ],
              }),
    ...
    Li = s.memo(function ({
      ...
      const p = f.resolve("strings"),
        ...
        _ =
          ...
          })(ka(p.readOrEmpty("tooltips.quests.awards.additional.bottom")), {
            count: t.length - (a || 0),
          });
      return e.jsx("div", {
  ...
  const qi = "AnimatedRewards_glowContainer_82630782",
    ...
    Hi = "AnimatedRewards_glow_3a2cd010",
    Qi = "AnimatedRewards_glowImage_4ecce597",
      ...
      return (
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsx(hr.div, {
              style: f,
              className: A(Gi, c?.rewardsWrapper),
              children: e.jsx(zi, {
                ...l,
                maxRewardsCount: r,
                bonuses: a,
            ...
            e.jsx("div", {
              className: A(qi, c?.glowContainer),
              children: fe(r ? Math.min(r, a.length) : a.length, (t) =>
                e.jsx(
                  hr.div,
                  {
                    ...
                    children: e.jsx(
                      Re,
                      { path: "post_battle.progression.reward_glow", className: Qi },
                      t,
                    ),
                  },
                  t,
  ...
  function cc(t) {
    return "none" === t.type
      ? e.jsx("div", { className: A(oi.separator, oi.separator__none, t.className) })
      : "union" === t.type
        ? e.jsx("div", { className: A(oi.separator, oi.separator__union, t.className) })
        : "or" === t.type
          ? e.jsxs("div", {
              className: A(oi.separator, oi.separator__or, t.className),
              children: [
          ...
          : e.jsx("div", {
              className: A(oi.separator, oi.separator__and, t.className),
  ...
  const mc = "R.images.gui.maps.icons.post_battle.general_quest",
    ...
    _c = s.memo(function (t) {
      ...
      return e.jsxs("div", {
        className: A(oi.groups, l > 4 && oi.groups__overflow, l > 1 && oi[p]),
        children: [
          e.jsx("div", {
  ...
  function gc({ completed: t, progress: n, animation: r, immediateAnimation: a, target: o, ...i }) {
    ...
    return e.jsx(ri.Provider, {
      ...
      children: e.jsx(Ya, {
        ...
        className: A(oi.base, t && oi.base__completed, i.className),
  ...
  var yc = ((e) => ((e.Done = "done"), (e.Locked = "notAvailable"), (e.Active = ""), e))(yc || {});
  function vc(e) {
  ...
  function Pc(e, t) {
    if ("items" in e)
      return {
        type: "items",
        separate: ((n = e.conditionType), "or" === n || "and" === n ? n : "none"),
        groups: le(e.items, (e) => Pc(e, t)),
      };
    var n;
    const s = {
      type: "item",
      ...
      condition: {
        icon:
          ((r = e.iconKey),
          {
            default: { path: Cc.readOrEmpty(`userMissions.missionIcons.c_32.${r}_silver`) },
            large: { path: Cc.readOrEmpty(`userMissions.missionIcons.c_80.${r}_silver`) },
          }),
        title: e.titleData,
    ...
    return (
      e.total > 0 &&
        (s.condition.progression = { current: e.current, total: e.total, earned: e.earned }),
      s
    );
  }
  const [Ic, Ac] = (
            ...
            le(t.quests.get(), (e) => {
              ...
              return {
                ...
                groups: {
                  ...
                  separate: "none",
                  groups: de([
                    e.postBattleCondition.items.length > 0 && Pc(e.postBattleCondition, t),
                    e.bonusCondition.items.length > 0 && Pc(e.bonusCondition, t),
                  ]),
                },
    ...
    Sc = "ProgressionQuests_divider_5040669c",
    kc = "ProgressionQuests_headerBackground_78383aa5",
    Nc = "ProgressionQuests_head_20b48055",
    Mc = f.resolve("aliases"),
    jc = f.resolve("strings"),
    Oc = { rootId: Mc.read((e) => e.comp7_light.shared.BattleResultsProgressionQuests("resId")) },
    Dc = i.observer(function ({ animation: t, immediateAnimation: n }) {
      const { model: r, controls: a } = Ac(),
        o = Se(),
        i = () => {
          const e = r.quests();
          if (e.length > 0) {
            const t = e[0];
            a.navigate(t.id, t.type);
          }
        };
      return e.jsx(gc, {
        title: jc.readOrEmpty("comp7_light.battleResult.missionsProgress.progression.title"),
        onButtonAction: i,
        onClick: (e) => {
          (o.play("click", { original: e, target: "progression-quests:mission-card" }), i());
        },
        classNames: { header: { background: kc }, head: Nc },
        animation: t,
        immediateAnimation: n,
        actionTooltipParams: { body: jc.readOrEmpty("battle_results.progression.linkBtn.info") },
        children: e.jsx("div", {
          children: le(r.quests(), (t, n, r) =>
            e.jsxs(
              s.Fragment,
              {
                children: [
                  e.jsx(gc.Groups, {
                    ...
                    questId: t.id,
                    completed: t.completed,
                    rewardsTooltipResId: Oc.rootId,
                  }),
                  r.length - 1 !== n && e.jsx(Ce, { classNames: { base: Sc } }),
                ],
              },
              t.id,
            ),
          ...
          try {
            const s = xc(
              `${(function (e, t = "/") {
                ...
                return e;
              })(t)}/progression_quests.css`,
            );
            (n.add(s.cleanup), await s.promise.catch(console.error));
            const r = X(Oc, { name: "ProgressionQuestsProgressDataLayer" }),
              a =
                ...
                (function (e, t) {
                  ...
                  return !1;
                })(r.readByPath("commonQuests"), (e) => e.status === yc.Done));
            return {
              animated: !0,
              component: Bc,
              notifications: a
