  ...
  __using = (e, t, s) => {
    ...
    null != t
      ? ("object" != typeof t && "function" != typeof t && __typeError("Object expected"),
        s && (r = t[__knownSymbol("asyncDispose")]),
        void 0 === r && ((r = t[__knownSymbol("dispose")]), s && (a = r)),
        "function" != typeof r && __typeError("Object not disposable"),
        a &&
          (r = function () {
            try {
              a.call(this);
  ...
  __callDispose = (e, t, s) => {
    var r =
        "function" == typeof SuppressedError
          ...
          : function (e, t, s, r) {
              return (
                ((r = Error(s)).name = "SuppressedError"),
                (r.error = e),
                (r.suppressed = t),
                r
              );
            },
      a = (e) => (t = s ? new r(e, t, "An error was suppressed during disposal") : ((s = !0), e)),
      n = (r) => {
        for (; (r = e.pop());)
          try {
            var o = r[1] && r[1].call(r[2]);
            if (r[0]) return Promise.resolve(o).then(n, (e) => (a(e), n()));
          } catch (i) {
            a(i);
          }
        if (s) throw t;
...
import {
  ...
  I as is,
  J as custom,
  K as useLocalObservable,
  L as runInAction$1,
  M as useReactTable,
  N as observable$1,
  O as getPaginationRowModel,
  P as getSortedRowModel,
  Q as getCoreRowModel,
  S as observer,
} from "./vendor.js";
...
function readFromR$1(e, t, s) {
  ...
  return n && "function" == typeof n[a] ? (t ? n[a](t) : n[a]()) : void 0;
}
class StringsRClassProvider {
  ...
  pluralOr(e, t, s, r = "silent") {
    const a = e.startsWith("R.strings") ? e : concatWithPath(this.prefix, e),
      n = readFromR$1(a, t, e.startsWith("R.strings") ? window : this.root);
    return void 0 === n
      ? ("silent" !== r && logBySeverity$1(`Resource not found: ${a}`, r), s())
      : n;
  }
...
const easings = {
  ...
  bezier: (e, t, s, r) => (a) =>
    ...
    3 * (1 - a) * a * a * s +
    a * a * a * r,
  cubicBezier: (e, t, s, r) => (a) => {
    const n = findTForX(a, e, s);
    return 3 * t * (1 - n) ** 2 * n + 3 * r * (1 - n) * n ** 2 + n ** 3;
  },
};
...
function findTForX(e, t, s, r = 1e-5) {
  let a = e;
  for (let n = 0; n < 8; n++) {
    const n = bezierX(a, t, s) - e;
    if (Math.abs(n) < r) return a;
    const o = bezierXDerivative(a, t, s);
        ...
        (t[s] = (function (t) {
          return (s) => {
            ...
            return (
              ...
              r(),
              () => {
                (n(), window.removeEventListener(a, o), (e.listeners -= 1), r());
              }
            );
          };
        })(s)),
...
function initExternalPaddings$1(e) {
  function t() {
    const { top: t, right: s, bottom: r, left: a } = viewEnv.getExternalPaddingsRem();
...
function pipe(e, t, s, r, a, n, o, i, u) {
  switch (arguments.length) {
    case 1:
      return e;
    case 2:
    ...
    case 6:
      return n(a(r(s(t(e)))));
    case 7:
      return o(n(a(r(s(t(e))))));
    case 8:
      return i(o(n(a(r(s(t(e)))))));
    case 9:
      return u(i(o(n(a(r(s(t(e))))))));
    default: {
      let e = arguments[0];
  ...
  (function () {
    if (!self.fetch) {
      ...
      (c.call(d.prototype),
        ...
        (self.fetch = function (t, s) {
          var a;
          return (
            (a = d.prototype.isPrototypeOf(t) && !s ? t : new d(t, s)),
                ...
                if (4 === n.readyState) {
                  ...
                  if (e < 100 || e > 599) s(new TypeError("Network request failed"));
                    ...
                    var r = {
                      ...
                      a = "response" in n ? n.response : n.responseText;
                    t(new m(a, r));
                  }
                }
              }
              ("cors" === a.credentials && (n.withCredentials = !0),
                ...
                n.send(void 0 === a._bodyInit ? null : a._bodyInit));
            })
          );
        }),
    ...
    function d(e, t) {
      ...
      if (
        ...
        (this.method = ((r = t.method || "GET"), (a = r.toUpperCase()), s.indexOf(a) > -1 ? a : r)),
...
function filterMap(e, t, s) {
  ...
  for (let a = 0; a < e.length; a++) {
    const n = unsafeGet(e, a);
    t(n, a, e) && r.push(s(n, a, e));
  }
  return r;
}
...
const LOWER_ALPHABET = "abcdefghijklmnopqrstuvwxyz",
  ...
  createString =
    ...
    (t, s = int(-Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER)) => {
      const r = e.length;
      let a = s;
      const n = () => ((a = (9301 * a + 49297) % 233280), a / 233280);
      let o = "";
      for (let i = 0; i < t; i++) {
        const t = Math.abs(Math.floor(n() * r));
        o += e[t % e.length];
      }
      return o;
    };
...
function eq(e, t, s, r, a) {
  ...
  (s < 0 && (s = -1), (a = a || []));
  let c = (r = r || []).length;
  for (; c--;) if (r[c] === i) return a[c] === u;
  if ((r.push(e), a.push(t), l)) {
    if (((c = i.length), c !== u.length)) return !1;
    for (; c--;) if (!eq(i[c], u[c], s - 1, r, a)) return !1;
  } else {
    ...
    for (; c--;) {
      ...
      if (!Object.prototype.hasOwnProperty.call(u, t) || !eq(i[t], u[t], s - 1, r, a)) return !1;
    }
  }
  ...
  createApi = () => {
    ...
    return {
      ...
      register: function (e, r) {
        ...
        const a = t(e);
        return (a.includes(r) || a.push(r), () => s(e, r));
      },
      unregister: s,
...
function useHandleKey(e, t, s, r = !1) {
  const a = normalizeKeyCode(e),
    ...
    o = useApi$2(),
    i = reactExports.useMemo(() => o[t].register(a, n), [o, t, a, n]);
...
function useRepeatCallback(e, t, s = []) {
  ...
  return [
    reactExports.useCallback((s) => {
      (0 !== r.current && a(), (r.current = window.setInterval(() => e(s, !0), t)), e(s, !1));
    }, n),
    a,
  ];
}
    ...
    reactExports.useMemo(() => {
      ...
      return {
        call: function (n) {
          ...
          const o = Date.now();
          o - r.current < e ||
            (t && (a.current(), (a.current = noop)),
            (r.current = o),
            (s.current = window.setTimeout(() => {
              (a.current(), (s.current = 0));
            }, e)));
        },
        cancel: function () {
...
function useTicker(e) {
  const { type: t, tick: s, limit: r } = e,
    ...
    n = e.start ?? zero,
    o = toMillis(s),
    [i, u] = reactExports.useState({ current: n, running: a }),
  ...
  reactExports.useEffect(() => {
    const e = (e) => {
      u((a) => {
        ...
        const n = "countdown" === t ? subtract(a.current, e) : add$1(a.current, e),
          o = { ...a, current: n };
        return (
          isDuration(r) &&
            ("countdown" === t
              ? lt(subtract(n, s), r) && ((o.current = r), (o.running = !1))
              : gt(add$1(n, s), r) && ((o.current = r), (o.running = !1))),
          o
        );
      });
    };
    ...
    return () => {
      (window.clearInterval(l.current), a());
    };
  }, [r, s, o, i.running, t]);
...
function watchResizes(e, t) {
  ...
  function a() {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      isEqual(o, a) || ((r[t] = o), (n = !0));
    }
    (n && t(r), (s = requestAnimationFrame(a)));
  }
  return {
    start() {
      a();
    ...
    [i, u] = reactExports.useMemo(() => {
      ...
      function l() {
        ((o.current.status = statuses.display),
          sendEvent$1.tooltip.open(e, t, s, a),
...
function SoundsProvider({ severity: e = "warn", overrides: t, silent: s = !1, children: r }) {
  const a = reactExports.useMemo(() => ({ ...soundConfig, ...t }), [t]),
    n = reactExports.useMemo(
      () => ({
        play: function (t, r) {
          if (s) return;
          const n = a[t];
          n ? n(r) : logBySeverity(`There is no sound for event: ${t}`, e);
        },
        settings: { plays: a, severity: e, silent: s },
      }),
      [a, e, s],
    );
  return jsxRuntimeExports.jsx(Context$5.Provider, { value: n, children: r });
}
function useSounds() {
...
function useContextMenu({
  ...
  const o = useSounds(),
    [{ hide: i }, u] = reactExports.useMemo(() => {
      function i() {
        a || sendEvent$1.contextMenu.open(e, t, s, r);
      }
      return [
        {
          hide: function () {
...
function useAdjustScreenWidth(e = "extend") {
  const t = useScreenSize(),
    [s, r] = reactExports.useState(calculate(t.width, e));
  return (
    reactExports.useEffect(() => {
      r(calculate(t.width, e));
    }, [e, t.width]),
    s
  );
}
function useExternalPaddings(e = "px") {
  ...
  return (
    ...
    reactExports.useMemo(
      ...
      [e, a, t.left, t.right, t.top, t.bottom],
    )
  );
}
...
function cloneModel(e, { shallow: t = !0, depth: s = 0, maxDepth: r = 32 } = {}) {
  ...
  if (nonConvertingTypes.has(n)) return a;
  if (null === a) return a;
  ...
  if ("object" === n) {
    ...
    const n = {};
    for (const e of Object.keys(a)) n[e] = cloneModel(a[e], o);
    return n;
  }
...
class DLDict {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      a in s
        ? null === n
          ...
          : s[a].set(n)
        : null !== n && ((s[a] = observable.box(n, MOBX_OPTIONS)), this._keys.add(a), this.set(s));
    }
  }
  entries() {
  ...
  reduce(e, t) {
    ...
    for (const a of this.keys.values()) s = e(s, r[a].get(), a);
    return s;
  }
  takeItem(e, t) {
    const s = e.get(t);
...
function createObservableModel(e, t, s) {
  ...
  const a = (a, n, o = DEFAULT_BOX_CONFIG) => {
      const i = observable.box(a(s(n)), o);
      return ("real" === t && e.subscribe((e) => r.push(() => i.set(a(e))), n), i);
    },
    n = (a, n) => {
      const o = new DLDict(s(a), n);
      return ("real" === t && e.subscribe((e, t) => r.push(() => o.update(e, t)), a), o);
    },
    o = (a, n) => {
      const o = observable.box(s(a) ?? n, DEFAULT_BOX_CONFIG);
  ...
  return {
    ...
    primitives: (a, n) => {
      const o = s(n);
      if (Array.isArray(a)) {
        const s = a.reduce((e, t) => ((e[t] = observable.box(o[t], {})), e), {});
        return (
          "real" === t &&
            e.subscribe((e) => {
              r.push(() =>
...
const initializeModelWithContext =
    (e = "DataLayerProvider") =>
    (t, s, r) => {
      const a = reactExports.createContext(null);
      function n(n) {
        const { mode: o, options: i, children: u, mocks: l } = n,
          ...
          m = r?.useRequires?.(),
          f = useEvent((a, o, i) => {
            const u = "real" !== a && i ? createMockInstance(i.getter, o) : create(o, { name: e }),
              l = (e) => ("mocks" === a ? i?.getter(e, o) : u.readByPath(e)),
              c = (e) => _.current.push(e),
              d = "initial" in n && { initial: r?.initial?.(n.initial) },
              p = t({
                ...d,
                mode: a,
                readByPath: l,
              ...
              f = { ...d, mode: a, model: p, externalModel: u, cleanup: c, requires: m },
              E = "mocks" === a && i?.controls ? i.controls(f) : {};
            return {
              model: p,
              controls: { ...s?.(f), ...E },
              externalModel: u,
          ...
          [g, h] = reactExports.useState(d);
        reactExports.useEffect(() => {
          h(d);
        }, [d]);
        const [b, x] = reactExports.useState(() => f(g, i, p));
        return (
          reactExports.useEffect(() => {
            E.current ? x(f(g, i, p)) : (E.current = !0);
          ...
          jsxRuntimeExports.jsx(a.Provider, { value: b, children: u })
        );
      }
      return (
        (n.displayName = e),
...
const base$10 = "HeadlessButton_df8536fc",
  styles$1b = { base: base$10 },
  HeadlessButtonBase = defineStyledComponent("Button", {
    element: "button",
    className: styles$1b.base,
  }),
  HeadlessButton = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(HeadlessButtonBase, {
      ...
      onMouseEnter: function (e) {
        (a || n || u.play("mouse-enter", { target: r || "Button", original: e }), s?.(e));
      },
      onClick: function (e) {
        a || (n || u.play("click", { target: r || "Button", original: e }), t?.(e));
      },
      children: e,
    });
  }),
  ...
  fadeIn$q = "Button_fadeIn_6bcdc8c",
  fadeInThreeQuarters$q = "Button_fadeInThreeQuarters_6bcdc8c",
  fadeInHalf$q = "Button_fadeInHalf_6bcdc8c",
  fadeOut$q = "Button_fadeOut_6bcdc8c",
  fadeInWithScale$q = "Button_fadeInWithScale_6bcdc8c",
  slideUp$q = "Button_slideUp_6bcdc8c",
  scale$q = "Button_scale_6bcdc8c",
  raysAppearance$q = "Button_raysAppearance_6bcdc8c",
  rotate$q = "Button_rotate_6bcdc8c",
  glowAppearance$q = "Button_glowAppearance_6bcdc8c",
  highlightAppearance$q = "Button_highlightAppearance_6bcdc8c",
  blink$q = "Button_blink_6bcdc8c",
  slideUpIn$q = "Button_slideUpIn_6bcdc8c",
  styles$1a = {
  ...
  Button$1 = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(HeadlessButton, {
      ...
      className: clsx(
        styles$1a.base,
        styles$1a[`base__size-${t}`],
        styles$1a[`base__theme-${s}`],
        r ? styles$1a.base__disabled : styles$1a.base__enabled,
        i,
        o?.base,
      ),
      onClick: function (e) {
      ...
      children: [
        jsxRuntimeExports.jsx("div", { className: clsx(styles$1a.background, o?.background) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$1a.border, o?.border) }),
        jsxRuntimeExports.jsx("div", { className: clsx(styles$1a.overlay, o?.overlay) }),
        jsxRuntimeExports.jsx("div", {
          className: clsx(styles$1a.content, n && styles$1a.content__fontAligned, o?.content),
          children: e,
        }),
      ],
    });
        ...
        (t[s] = (function (t) {
          return (s) => {
            ...
            return (
              ...
              r(),
              () => {
                a && (o(), window.removeEventListener(n, i), (e.listeners -= 1), r(), (a = !1));
              }
            );
          };
        })(s)),
...
class DataTracker {
  ...
  addCallback(e, t, s = 0, r = !0) {
    ...
    const a = env.view.addModelObserver(e, s, r);
    return (
      a > 0
        ? ((this._callbacks[a] = t),
...
const makeGlobalBoundingBox = (e) => ({
  ...
  sendShowPopOverEvent = (e, t, s, r, a = R.invalid("resId"), n) => {
...
const FormatNumber = ({ value: e, format: t = "integral" }) => {
  ...
  getDogTypeImage$1 = (e, t, s) => {
    ...
    if (r) {
      const a = R.images.gui.maps.icons.dogtags.$dyn(t).$dyn(r),
        n = a.$dyn(s);
      return n ? `${n}` : `${a.$dyn(DOG_TAG_DEFAULT_ICON_NAME$1[e])}`;
    }
    return (
      console.error(
  ...
  getRewardImage$1 = (e, t = ImageSize$1.Small) => {
    const { name: s, type: r, value: a, icon: n, item: o, dogTagType: i } = e,
      u = getSizeFolder$1(t);
    switch (s) {
      case "basic":
      case "plus":
      ...
      case "premium":
      case "premium_plus":
        return `R.images.gui.maps.icons.quests.bonuses.${t}.${s}_${a}`;
      case "items":
      ...
      case "dogTagComponents":
        return getDogTypeImage$1(i, t, n);
      case "dossier_badge":
  ...
  getRewardTooltipConfig$1 = (e, t, s) => {
  ...
  getFromCallStack = (e = 1) => {
    ...
    return (
      ...
      { callerUrl: a, caller: s, stack: t, resId: r }
    );
  },
  SHOW_DELAY_MIN = 100,
...
const handleViewEvent = (e, t, s = {}, r = 0) => {
  ...
  Tooltip$2 = ({
    ...
    const f = reactExports.useRef({
      ...
      E = reactExports.useMemo(() => d || getFromCallStack().resId, [d]),
  ...
  SimpleTooltip$1 = ({ children: e, body: t, header: s, note: r, alert: a, args: n, ...o }) => {
    const i = reactExports.useMemo(() => {
      const e = { ...n, body: t, header: s, note: r, alert: a };
  ...
  DynamicTooltipWrapper = ({ children: e, tooltipArgs: t, className: s }) => {
    ...
    const { contentId: a } = t;
    return a
      ? jsxRuntimeExports.jsx(Tooltip$2, { ...t, contentId: a, children: r })
      : jsxRuntimeExports.jsx(BackportTooltip$1, { ...t, children: r });
  },
  base$_ = "Reward_c5dc614c",
  base__s48x48$1 = "Reward_base__s48x48_ab59d545",
  base__small$b = "Reward_base__small_69779e9c",
  base__s80x80$1 = "Reward_base__s80x80_ab59d545",
  base__big$2 = "Reward_base__big_4733a488",
  base__s128x100$1 = "Reward_base__s128x100_fb15aafa",
  base__s180x135$1 = "Reward_base__s180x135_16cc707b",
  base__s232x174$1 = "Reward_base__s232x174_e32aac73",
  base__s296x222$1 = "Reward_base__s296x222_c9fbf416",
  base__s400x300$1 = "Reward_base__s400x300_76ba5081",
  base__s600x450$1 = "Reward_base__s600x450_aba4634a",
  tooltipWrapper$1 = "Reward_tooltipWrapper_5c2caa5a",
  icon$c = "Reward_icon_ae345d69",
  overlay$4 = "Reward_overlay_ff0a7872",
  base__normalize = "Reward_base__normalize_ab59d545",
  highlight$1 = "Reward_highlight_ac5e429a",
  image$1 = "Reward_image_d9c7ed84",
  info$1 = "Reward_info_29e76ef9",
  info__multi$1 = "Reward_info__multi_14b911c",
  info__credits$1 = "Reward_info__credits_a7e7bbe",
  info__gold$1 = "Reward_info__gold_c2d9d72c",
  info__bptaler = "Reward_info__bptaler_ab59d545",
  info__crystal$1 = "Reward_info__crystal_ec55d024",
  info__premiumTank$1 = "Reward_info__premiumTank_67c21f6d",
  title$2 = "Reward_title_50579ad9",
  timer$1 = "Reward_timer_98cb5bca",
  fadeIn$p = "Reward_fadeIn_ab59d545",
  fadeInThreeQuarters$p = "Reward_fadeInThreeQuarters_ab59d545",
  fadeInHalf$p = "Reward_fadeInHalf_ab59d545",
  fadeOut$p = "Reward_fadeOut_ab59d545",
  fadeInWithScale$p = "Reward_fadeInWithScale_ab59d545",
  slideUp$p = "Reward_slideUp_ab59d545",
  scale$p = "Reward_scale_ab59d545",
  raysAppearance$p = "Reward_raysAppearance_ab59d545",
  rotate$p = "Reward_rotate_ab59d545",
  glowAppearance$p = "Reward_glowAppearance_ab59d545",
  highlightAppearance$p = "Reward_highlightAppearance_ab59d545",
  blink$p = "Reward_blink_ab59d545",
  slideUpIn$p = "Reward_slideUpIn_ab59d545",
  styles$19 = {
    base: base$_,
  ...
  Reward$1 = ({
    ...
    const _ = getBottomHighlight$1(r, a),
      m = getOverlay$1(a),
      f = getFormattedValue$1(n, o);
    return jsxRuntimeExports.jsxs("div", {
      className: cx(
        styles$19.base,
        styles$19[`base__${r}`],
        NORMALIZE_OVERLAYS_LIST.includes(e) && styles$19.base__normalize,
        l,
      ),
      style: u,
      children: [
        jsxRuntimeExports.jsx(DynamicTooltipWrapper, {
          tooltipArgs: d,
          className: styles$19.tooltipWrapper,
          children: jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
            children: [
              jsxRuntimeExports.jsxs("div", {
                className: cx(styles$19.image, c?.image),
                children: [
                  _ &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$19.highlight, c?.highlight),
                      style: {
                  ...
                  t &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$19.icon, c?.rewardIcon),
                      style: { backgroundImage: `url(${t})` },
                    }),
                  m &&
                    jsxRuntimeExports.jsx("div", {
                      className: cx(styles$19.overlay, c?.overlay),
                      style: {
              ...
              f &&
                jsxRuntimeExports.jsx("div", {
                  className: cx(
                    styles$19.info,
                    styles$19[`info__${e}`],
                    o === ValueTypes$1.MULTI && styles$19.info__multi,
                    c?.info,
                  ),
                  children: f,
                }),
              i &&
                jsxRuntimeExports.jsx("div", {
                  className: cx(styles$19.title, c?.title),
                  children: i,
                }),
            ],
          }),
        ...
        s &&
          jsxRuntimeExports.jsx(DynamicTooltipWrapper, {
            ...
            children: jsxRuntimeExports.jsx("div", {
              className: cx(styles$19.timer, c?.periodicIcon),
            }),
          }),
      ],
    });
...
function createGridImgSourceGetter(e) {
  ...
  return (r) => {
    const a = r % s,
      n = (a % t.columns) * e.width,
      o = Math.trunc(a / t.columns) * e.height;
    return { path: e.getChunkPath(Math.trunc(r / s)), x: n, y: o };
  };
}
...
const CanvasSequence = reactExports.memo(function ({
    ...
    const m = reactExports.useRef(null),
      [f, E] = reactExports.useState(!0);
    return (
      reactExports.useEffect(
        () => createLayoutReadyInEffect(() => createLayoutReadyInEffect(() => E(!1))),
        [],
      ),
      reactExports.useEffect(() => {
        const e = m.current;
              ...
              const e = generateImages(o, i, s),
                ...
                l = window.setInterval(() => {
                  const s = t(),
                    n = e.get(s);
                  n
                    ? (a?.(s, n), r(n), s === i && (d?.(), u || (c?.(), window.clearInterval(l))))
  ...
  generateImages = (e, t, s) => {
    ...
    for (let n = e; n <= t; n++) {
      const e = s(n),
        t = a[e.path];
      if (t) r.set(n, createFrameImage(e, t));
      else {
        const t = new Image();
        ((a[e.path] = t),
          (t.src = e.path),
...
const convertNbsp = (e) => e.replace(/&nbsp;/g, " "),
  ...
  splitEuropean = (e, t = 0) => {
    ...
    const r = new RegExp(
      ...
      a = convertNbsp(e);
    return (splitAndFormat(a, /( )/, t).forEach((e) => (s = s.concat(splitAndFormat(e, r, 0)))), s);
  },
  splitChinese = (() => {
    const e = new RegExp(
      [
  ...
  base$Z = "Formattext_bb80854d",
  styles$18 = { base: base$Z },
  FormatText$1 = ({
    binding: e,
    text: t = "",
    classMix: s,
  ...
  base$Y = "Tooltip_6d997cee",
  decorator = "Tooltip_decorator_b3486d4e",
  styles$17 = { base: base$Y, decorator: decorator },
  Base$u = defineStyledComponent("Base", styles$17.base),
  Decorator = defineStyledComponent("Decorator", styles$17.decorator),
    ...
    if (l === t.start[0] && e.slice(u, u + t.start.length) === t.start) {
      ...
      if (e.startsWith("@")) {
        const t = e.slice(1).trim(),
          a = { type: NodeTypes.Tag, attrs: t.split("|"), instanceId: ++i, children: [] };
        if (r.length > 0) {
          r[r.length - 1].node.children.push(a);
        } else s.push(a);
        r.push({ node: a, startIndex: s.length });
...
const COLORS =
  ...
  styles$16 = { COLORS: COLORS, base: base$X, base__fullSize: base__fullSize, nowrap: nowrap },
  legacyColors = new Set(styles$16.COLORS?.split(", ") ?? []);
let keyId = 0;
function takeKey() {
  return ++keyId;
}
...
function applyFunction(e, t, s, r) {
  const a = s.map((t) => {
    ...
    n = r[t];
  return n ? n(e, ...a) : (console.error(`Function ${t} is not registered`), e);
}
function applyFunctions(e, t, s) {
  return e.reduce((e, t) => {
    const [r, ...a] = parseArguments(t.trim());
    return r ? applyFunction(e, r, a, s) : e;
  }, t);
}
function isEnd(e) {
  ...
  for (let s = 0; s < e.length; s++) {
    if ("$" === e[s]) {
      ...
      const a = e.slice(s + 1, r),
        n = t[a];
      if (n) return resolveAttrParams(e.replace(`$${a}`, String(n)), t);
    }
  }
  return e;
}
...
const defaultBrackets = { start: "{{", end: "}}" },
  FormatText = reactExports.memo(function (e) {
    const {
      ...
      m = clsx(styles$16.base, n && styles$16.base__fullSize, l.className);
    return e.inline
      ? (console.warn(
...
const formats = {
  ...
  types$4 = { accent: "accent", cooldown: "cooldown" },
  ...
  for (let r = 0; r < t.items.length; ++r)
    (t.separator &&
      ...
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          { className: cx(styles$15.detailedSeparator, styles$15[`detailedSeparator__${e}`]) },
          "separator",
        ),
      ),
      s.push(
        jsxRuntimeExports.jsx(
          "span",
          {
            className: cx(styles$15.item, styles$15[`item__${e}`]),
            children: t.items[r]
              ?.split(" ")
              .map((t, s) =>
                jsxRuntimeExports.jsx(
                  "span",
                  { className: cx(styles$15.part, styles$15[`part__${e}`]), children: t },
                  `part_${s}`,
                ),
              ),
          },
...
function defaultFormatter(e, t) {
  ...
  return (
    a[s] === MINUTES_FORMAT && 0 === Number(e[s])
      ...
      : (n.items = [s, s + 1].map((t) => LOCALE_FORMATTERS[a[t]]?.(e[t]))),
    n
  );
}
function compactFormatter(e, t) {
  const s = e.length,
    ...
    a = { separator: !1, items: [] };
  for (let n = 0; n < s; ++n)
    if (Number(e[n]) > 0) return ((a.items = [LOCALE_FORMATTERS[r[n]]?.(e[n])]), a);
...
const formatValue = (e, t) => FORMATTER[t]?.(format$2(e, FORMAT_PARTS[t]), t),
  base$W = "Timer_dac0a0aa",
  icon$b = "Timer_icon_a61415df",
...
function Timer({
  ...
  limit: t = 0,
  tick: s = 1,
  size: r = sizes$h.x24x24,
  type: a = types$4.accent,
  ...
  return jsxRuntimeExports.jsxs("div", {
    className: cx(styles$14.base, i),
    children: [
      jsxRuntimeExports.jsx("div", {
        className: cx(styles$14.icon, styles$14[`icon__${r}`], styles$14[`icon__${a}`], u?.icon),
      }),
...
((Timer.format = formats), (Timer.size = sizes$h), (Timer.type = types$4));
...
function ModelRouterProvider({
  ...
  const o = reactExports.useRef([]),
    ...
    u = reactExports.useMemo(
      () => create({ context: s, getRoot: r, initializer: a, rootId: n }),
      [s, r, a, n],
    ),
  ...
  Img = withResolvePath(
    reactExports.forwardRef(function (e, t) {
      ...
      return e.unknown
        ...
        : jsxRuntimeExports.jsx("img", { ...u, ref: t, src: a, width: s, height: r });
    }),
  ),
...
const border$7 = "Popover_border_d0a76717",
...
function Portal({
  ...
  reactExports.useEffect(() => {
    ...
    const t = document.querySelector(`[data-popover-trigger-id="${c.id}"]`),
      a = e.querySelector(`[data-popover-display-id="${c.id}"]`);
    if (!t || !a) return;
    const n = watchResizes([t, e, document.body], ([t, a, n]) => {
      if (!c.opened) return void _(void 0);
      if (!1 === i(c, { callerBounding: t, containerBounding: a, bodyBounding: n })) return;
      const o = getUpdatedPosition(r, m, t, a, n);
      (_(o),
        updatePosition(s, f, o, m, t, a, n, e),
        runInAction(() => {
          (c.trigger.setBounding(t), c.portal.setBounding(a), c.portal.setPosition(o));
        }));
    });
    return (n.start(), n.stop);
  }, [c, i, m, s, f, c.id, c.portal, c.trigger, r, c.opened]);
    ...
    reactExports.useEffect(() => {
      ...
      function s(e) {
        ...
        const r = `[data-popover-trigger-id="${c.id}"]`,
          a = `[data-popover-outside-click-whitelist-id="${c.id}"]`;
        return !(
          t === s ||
          t.contains(s) ||
          s.matches(r) ||
...
function getUpdatedPosition(e, t, s, r, a) {
  return ("top" === e && s.top - r.height - t.top < 0) ||
    ("bottom" === e && s.bottom + r.height + t.bottom > a.height) ||
    ("left" === e && s.left - r.width - t.left < 0) ||
    ("right" === e && s.right + r.width + t.right > a.width)
    ? oppositePositions[e]
    : e;
}
function applyTransform(e, t, s, r, a) {
  ((e = clamp$1(s.left, a.width - r.offsetWidth - s.right, e)),
    (t = clamp$1(s.top, a.height - r.offsetHeight - s.bottom, t)),
    (r.style.transform = `translate(${e}px, ${t}px)`));
}
function updatePosition(e, t, s, r, a, n, o, i) {
  if ("top" === s) {
    const s = (n.width - a.width) * e;
    applyTransform(a.left - s, a.top - n.height - t, r, i, o);
  } else if ("bottom" === s) {
    const s = (n.width - a.width) * e;
    applyTransform(a.left - s, a.bottom + t, r, i, o);
  } else if ("left" === s) {
    const s = a.left - n.width - t,
      u = (n.height - a.height) * e;
...
const base$U = "PopoverTip_163a336f",
  ...
  Tip = reactExports.forwardRef(({ ...e }, t) => {
    const s = reactExports.useRef(null),
      ...
      [a, n] = reactExports.useState(e.size),
      ...
      c = useEvent((t, s, r) => {
        let a = o;
        if ((e.position || ((a = oppositePositions[r]), i(a)), !e.size)) {
          const e = isVerticalPosition(a)
    ...
    return (
      ...
      jsxRuntimeExports.jsxs("div", {
        ...
        ref: assignRefs([t, s]),
        style: {
          width: (verticals.includes(o) && a) || "1rem",
          height: (horizontals.includes(o) && a) || "1rem",
...
const Slot$1 = React.forwardRef((e, t) => {
  const { children: s, ...r } = e,
    a = React.Children.toArray(s),
    n = a.find(isSlottable);
  if (n) {
...
const SlotClone = React.forwardRef((e, t) => {
  ...
  if (React.isValidElement(s)) {
    const e = getElementRef(s),
      a = mergeProps(r, s.props);
    return (
      s.type !== React.Fragment && (a.ref = t ? assignRefs([t, e]) : e),
      React.cloneElement(s, a)
    );
  }
...
function mergeProps(e, t) {
  ...
  for (const r in t) {
    ...
    r.startsWith("on")
      ...
      : "style" === r
        ? (s[r] = { ...a, ...n })
        : "className" === r && (s[r] = [a, n].filter(Boolean).join(" "));
  }
  return s;
}
  ...
  createApiHook = ({
    ...
    return (i = {}) => {
      const { settings: u = defaultSettings } = i,
        ...
        b = reactExports.useCallback(
          function (e, { immediate: t = !1, reset: s = !0 } = {}) {
            ...
            if (!r) return;
            const a = o(r, e);
            E.scrollPosition.goal !== a &&
              g.start({
                scrollPosition: a,
                immediate: t,
                reset: s,
                config: u.animationConfig,
                from: { scrollPosition: o(r, E.scrollPosition.get()) },
                onChange: () => {
                  n && f();
                },
              });
          },
          [E.scrollPosition, g, u.animationConfig, f],
        ),
        ...
        y = reactExports.useCallback(
          function (e) {
            l ||
              (0 !== e.deltaY && x(r(e)),
              d.current && m.trigger("mouseWheel", e, E.scrollPosition, t(d.current)));
          },
          [E.scrollPosition, x, m, l],
        ),
        $ = reactExports.useCallback(
          function () {
            const e = d.current;
            e && (b(o(e, E.scrollPosition.goal), { immediate: !0 }), m.trigger("resizeHandled"));
          },
          [b, E.scrollPosition.goal, m],
        );
      ...
      const A = useEvent(function () {
          ...
          if (!t) return;
          const s = e(t),
            r = p.current ? a(p.current) : 0;
          if (_.current.container !== s || _.current.wrapper !== r) {
            const e = o(t, E.scrollPosition.goal);
            (e !== E.scrollPosition.goal && b(e, { immediate: !0 }),
        ...
        v = useSkipFrame();
      reactExports.useEffect(() => addEventListener(window, "resize", () => v.run($)), [$, v]);
      return reactExports.useMemo(
        () => ({
          getWrapperSize: () => (p.current ? a(p.current) : void 0),
...
function useScrollBounding(e, [t, s] = IGNORE_DEFAULT) {
  const [r, a] = reactExports.useState(!0),
...
function useBarDragging(e, t, s, r, a) {
  ...
  return (
    reactExports.useEffect(() => {
      ...
      const t = mouse.move(function ([t]) {
          ...
          const u = r.current,
            l = e.current;
          if (!o || !u || !l) return;
          const c = a(t, n, { parent: u, thumb: l }),
    ...
    }, [s, n.offset, n.pending, i, u, e, r, n, a]),
    u
  );
}
...
function getCoordinate(e, t, s, r, a, n) {
  return {
    ...
    backButton: getElementCoordinates(r, n),
    forwardButton: getElementCoordinates(a, n),
  };
}
function useBarHandlers(e, t, s, r, a, n, o) {
  const i = useSounds(),
    u = a.stepTimeout || CLAMPED_ARROW_STEP_TIMEOUT_DEFAULT,
    [l, c] = useRepeatCallback((e) => a.applyStepTo(e), u, [a]);
  reactExports.useEffect(
    () => (
    ...
    _ = reactExports.useCallback(
      (u) => {
        ...
        const f = getCoordinate(u, l, c, _, m, o),
          E = f.thumb.start <= f.occurredEvent && f.occurredEvent <= f.thumb.end,
          g =
        ...
        if (E) n({ pending: !0, offset: f.occurredEvent - f.thumb.start });
        else if (g) {
        ...
        i.play("click", { target: "Scroll:" + (E ? "thumb" : g ? "button" : ""), original: u });
      },
      [e, t, s, r, i, o, n, d, p, a],
    ),
...
const rail$1 = "HorizontalBar_rail_37858d8f",
  ...
  Bar$1 = reactExports.memo(function ({ classNames: e = {}, onDrag: t = noop }) {
    ...
    const p = useEvent(
      ...
      E = useEvent(({ thumbSize: e, thumbOffset: t, newBouncingCorrection: s }) => {
        const r = n.current,
          a = i.current,
          o = u.current;
        if (!r || !a || !o) return;
        const l = remToPx$1(THUMB_TO_RAIL_OFFSET$1);
        ((a.style.width = `${t - l + s}px`),
          (o.style.width = r.offsetWidth - e - t - l - s + "px"));
      }),
      { handleMouseEnter: g, handleMouseDownTrack: h } = useBarHandlers(
        s,
        o,
        a,
        r,
...
function useScrollByDragElements(e, t, s, r) {
  ...
  return (
    ...
    }, [u.scrollPosition, i, a, d, o, n, s, t]),
    reactExports.useEffect(() => {
...
function Base$t({ settings: e, children: t }) {
...
function matchPath(e, t) {
  ...
  for (const n of s) {
    ...
    if (o) {
      const o = `/${a.slice(0, t.length).join("/")}`,
        i = e === o;
      if (r && !i) continue;
  ...
  return (
    reactExports.Children.forEach(e, (e) => {
      ...
      const s = e.props,
        n = t ? `${t}${s.path}` : s.path;
      if (void 0 !== a) return;
      const o = matchPath(r, { paths: [n], exact: s.exact });
      o && (a = { child: e, match: o });
    }),
    a
...
const states = { default: "default", alert: "alert", error: "error", done: "done" },
  ...
  sizes$g = { medium: "medium", large: "large" },
  icons = { search: "search" },
  defaultConfig = { type: types$2.text, size: sizes$g.medium, state: states.default, disabled: !1 },
...
function useInputInstance({ value: e, size: t, type: s, state: r, disabled: a }) {
...
const disabledOverlay$2 = "Input_disabledOverlay_3e980046",
  ...
  Decoration = reactExports.forwardRef(function ({ className: e, children: t, ...s }, r) {
    ...
    return jsxRuntimeExports.jsxs("div", {
      ...
      onMouseEnter: function (e) {
        (a.play("mouse-enter", { target: soundPlayEventTarget, original: e }), s.onMouseEnter?.(e));
      },
      onClick: function (e) {
...
const Placeholder = reactExports.forwardRef(function (
  ...
  Message = reactExports.forwardRef(function (
    { className: e, type: t = messageTypes.alert, visible: s = !0, children: r, ...a },
    n,
  ) {
...
const Input = reactExports.forwardRef(function (
  { value: e, state: t, disabled: s, type: r, size: a, ...n },
  o,
) {
  ...
  ToggleBase = reactExports.forwardRef(function (e, t) {
    ...
    return jsxRuntimeExports.jsx(Base$r, {
      ...
      onMouseEnter: function (t) {
        (s.play("mouse-enter", { target: Base$r.displayName, original: t }), e.onMouseEnter?.(t));
      },
      onClick: function (t) {
        (s.play("click", { target: Base$r.displayName, original: t }), e.onClick?.(t));
      },
      children: e.children,
    });
  }),
...
const SvgAssaultX16X16 = (e) =>
  ...
  VehicleRole = reactExports.forwardRef(function (
    { roleKey: e, size: t = sizes$f.x24x24, classNames: s, ...r },
    a,
  ) {
...
VehicleRole.sizes = sizes$f;
const sizes$e = { x24x24: "x24x24", x48x48: "x48x48", x64x64: "x64x64", x96x96: "x96x96" },
  ...
  VehicleType = reactExports.forwardRef(function (
    ...
    const o = useUpscale(sizes$e[t], upscaledSizes[t]);
...
function createTooltipComponent(e, t) {
  function s({ asChild: t, params: s, disabled: r, ...a }) {
    const n = t ? Slot$1 : "div",
      o = e(r ? { ...s, disabled: r } : s);
    return jsxRuntimeExports.jsx(n, { ...a, ...o });
  }
...
function CardContextProvider({
  ...
  const o = reactExports.useMemo(
    () => ({ selected: e, hover: t, disabled: s, multiple: r, status: a }),
    [s, t, r, e, a],
  );
...
const SMALL_SIZE_BREAKPOINT = 100,
  ...
  Status = ({ reason: e, classNames: t }) => {
    const s = reactExports.useRef(null),
      [r, a] = React.useState(!1),
      n = `base__${useCardContext().status}${r ? "Small" : ""}`,
      o = React.useCallback(() => {
        const e = s.current?.getBoundingClientRect();
  ...
  Base$o = defineStyledComponent("Card", cardStyles.base, {
    variants: {
  ...
  Card = reactExports.forwardRef(function (
    ...
    const [_, m] = reactExports.useState(!1),
      f = useSounds(),
      E = useCardsWrapperContextOptional(),
      g = a || u;
    return jsxRuntimeExports.jsx(Base$o, {
      ...
      disableMouse: a,
      active: t,
      className: clsx(cardStyles.card, l, E?.enabled && cardStyles.base__wrapped),
...
function getRectangleEdges(e) {
  let { x: t, y: s, width: r, height: a } = e;
  const n = Point(t, s),
    o = Point(t + r, s),
    i = Point(t + r, s + a),
    u = Point(t, s + a);
...
function buildContourPath(e) {
  ...
  for (e.splice(0, 1); e.length > 0;) {
    ...
    const s = e[t],
      l = a;
    (a.x <= o.x ? (u = PADDING) : (u === PADDING && (n.y -= 2 * PADDING), (u = -PADDING)),
      a.y >= o.y ? (i = PADDING) : (i === PADDING && (n.x -= 2 * PADDING), (i = -PADDING)),
      (a = { x: a.x + i, y: a.y + u }),
      r.push(a),
      (o = l),
      (n = a),
  ...
  return (u === PADDING && i === PADDING && (n = { ...n, x: n.x - 2 * PADDING }), r.push(s), r);
}
...
class LinesOptimizer {
  ...
  lines = new Map();
  addLine(e, t, s, r, a) {
    const n = `${s === LINE_THICKNESS ? VERTICAL : HORIZONTAL}-${s === LINE_THICKNESS ? Math.round(e) : Math.round(t)}-${a}`;
          ...
          if (n)
            if (r) {
              const s = n.x + n.width,
                r = t.x + t.width;
              t.x >= n.x && t.x <= s
                ? (n = { ...n, width: Math.max(r, s) - n.x })
                : (e.push(n), (n = t));
            } else {
              const s = n.y + n.height,
                r = t.y + t.height;
              t.y >= n.y && t.y <= s
                ? (n = { ...n, height: Math.max(r, s) - n.y })
                : (e.push(n), (n = t));
            }
          else n = t;
        }),
...
const Lines = reactExports.memo(
    ({ containerRef: e, generation: t, border: s, cardSelector: r }) => {
      const [a, n] = reactExports.useState([]),
        o = useEvent(() => {
          const t = e.current;
          if (!t) return;
          const a = t.getBoundingClientRect(),
            o = buildLines(t.querySelectorAll(`.${r || cardStyles.card}`), a, s);
          n(o ?? []);
        });
      return (
  ...
  CardsWrapper = reactExports.forwardRef(function (
      ...
      (e) => {
        ...
        if (s.length > 0) {
          const r = t.getBoundingClientRect(),
            a = s.length;
          a !== u.current.length && (u.current = Array.from(s));
          const n = `${Math.round(r.width)}x${Math.round(r.height)}-${a}|${e}`;
          d(n);
        } else d("");
      },
      [n],
    ...
    const _ = reactExports.useMemo(() => ({ recalculate: p, enabled: a }), [p, a]);
  ...
  Discount = React.forwardRef(function (
    { color: e = colors.red, className: t, classNames: s, size: r = sizes$c.large, ...a },
    n,
  ) {
...
((Discount.colors = colors), (Discount.sizes = sizes$c));
const background$6 = "Checkbox_background_ae1fc797",
  ...
  HeadlessCheckbox = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Base$m, {
      ...
      onMouseEnter: function (e) {
        (l.play("mouse-enter", { target: Base$m.displayName, original: e }), a?.(e));
      },
      onClick: function (t) {
        (l.play("click", { target: Base$m.displayName, original: t }), n?.(t), o(!e));
      },
      children: r,
    });
  });
...
function UnknownVehicleImage({ size: e = sizes$a.x380x304, ...t }) {
  return jsxRuntimeExports.jsx(Base$l, { ...t, size: e, path: `vehicle.${e}.tank_empty` });
}
const VehicleImage = reactExports.forwardRef(function (
  { size: e = sizes$a.x380x304, name: t, width: s, height: r, className: a, ...n },
  o,
) {
  ...
  return i.has(u)
    ...
    : (console.warn(`Fail to retrieve icon maps/icons/vehicle/${e}/${getVehicleImageKey(t)}`),
      jsxRuntimeExports.jsx(UnknownVehicleImage, { size: e, className: a, width: s, height: r }));
});
...
function calculateRangeRows(e, t, s) {
  ...
  const n = Math.ceil((a / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    o = Math.max(0, Math.ceil(r / s) - Math.floor(n * SAFETY_FACTOR));
...
function calculateRangeItems(e, t, s) {
  ...
  const n = Math.ceil((a / s) * PERCENT_OF_VISIBLE_ELEMENTS),
    o = clamp$1(0, t, Math.ceil(r / s) - Math.floor(n * SAFETY_FACTOR));
  return [o, Math.min(t, o + n)];
}
const initVisibleRange = [0, 0];
function useVisibleRange(e, t, s, r, a) {
...
function HorizontalList({
  ...
  const l = useVisibleRange(s, t, i, () => calculateRangeItems(s, e, r), e),
    c = a?.Element ?? reactExports.Fragment,
  ...
  return l(
    {
      ...
      children: jsxRuntimeExports.jsxs(f, {
        children: [
          ...
          mapRange(g, Math.max(g, E), (e) => jsxRuntimeExports.jsx(m, { children: u(e) }, e)),
          jsxRuntimeExports.jsx("div", {
...
function Base$k({ children: e, onClick: t, onMouseEnter: s, ...r }) {
  ...
  return jsxRuntimeExports.jsx(StyledBase, {
    ...r,
    onMouseEnter: function (e) {
      (o || a.play("mouse-enter", { target: n, original: e }), s?.(e));
    },
    onClick: function (e) {
      (o || a.play("click", { target: n, original: e }), t?.(e));
    },
    children: e,
  });
}
function KeyButtonProvider({
  ...
  useHandleKeyup(a ? keyStringCodes.NONE : normalizeKeyCode(e), t);
  const o = reactExports.useMemo(
    () => ({ keyCode: e, onActive: t, silent: s, soundTarget: r, idle: a }),
    [e, t, r, s, a],
  );
...
const SwitcherContext = reactExports.createContext(void 0);
...
const sizes$9 = { small: "small", medium: "medium" },
  ...
  Switcher$1 = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(SwitcherContext.Provider, {
      value: g,
      children: jsxRuntimeExports.jsxs(Base$j, {
        ...d,
        ref: p,
        type: e,
        size: n,
        ...
        onMouseEnter: function (e) {
          (E.play("mouse-enter", { target: Base$j.displayName, original: e }), s?.(e));
        },
        onClick: function (e) {
...
const sizes$8 = {
  ...
  Base$i = defineStyledComponent("LoadoutItem", { element: Image$1 });
...
const LoadoutItem = reactExports.forwardRef(function (
  {
    ...
    overlayPath: s,
    size: r,
    overlayType: a = overlayTypes.none,
    level: n,
    classNames: o,
    className: i,
    width: u,
  ...
  const p =
    ...
    _ = (() => {
      ...
      return overlayTypesWithoutLevel.includes(a)
        ...
        : n
          ? `components.loadout_item.overlays.${e}.${a}_${n}_level`
...
function DragAndDrop({
  ...
  (useEmitterSubscribe(o, "onStart", s),
    ...
    useEmitterSubscribe(o, "onOver", a),
  ...
  const l = reactExports.useMemo(() => {
    function e(e, s) {
      const r = u.dragArea ?? document.body,
        a = pxToRem$1(e.clientX - u.startPoint.x),
        n = pxToRem$1(e.clientY - u.startPoint.y);
      return t
        ? (function (e, t, s, r) {
            const a = e.getBoundingClientRect(),
              n = t.getBoundingClientRect(),
              o = a.left - (u.startPoint.x - u.offsetPoint.x),
              i = a.top - (u.startPoint.y - u.offsetPoint.y);
            return {
              x: clamp$1(o, a.width - n.width + o, s),
              y: clamp$1(i, a.height - n.height + i, r),
            };
          })(r, s, a, n)
        : { x: a, y: n };
    }
    function s(t) {
      ...
      if (s) {
        ...
        (runInAction(() => {
          s &&
            ((s.style.transform = `translate(${r}px, ${a}px)`),
            (u.currentPosition = { x: r, y: a }));
        }),
    ...
    function a(e) {
      const t = u.virtualItem,
        s = e.target,
        a = u.dropAreas.find((e) => e === s || e.contains(s)) ?? null;
      (r(), o.trigger("onDrop", e, a, t, u));
    }
    function n(e) {
      const t = e.target;
...
const base$s = "Cbutton_24fc9a0c",
  ...
  Button = ({
    ...
    const m = reactExports.useRef(null),
      [f, E] = reactExports.useState(c),
      [g, h] = reactExports.useState(!1);
    return (
      reactExports.useEffect(() => {
        function e(e) {
          f && null !== m.current && !m.current.contains(e.target) && E(!1);
        }
        return (
      ...
      jsxRuntimeExports.jsxs("div", {
        ...
        onMouseDown: function (e) {
          ...
          (null !== _ && t && playSound(_),
            o && o(e),
            c && (s || (m.current && (m.current.focus(), E(!0)))),
            t && h(!0));
        },
    ...
    function a() {
      ...
      if (n === a) y(!1);
        ...
        for (let t = 0; t <= n; t++) {
          ...
          const a = cloneNode(s);
          a ? r.appendChild(a) : console.warn("Unexpected type of target node", s);
        }
...
function ProgressBarProvider(e) {
  const [t, s] = reactExports.useState(Math.min(e.value, e.maxValue)),
    [r, a] = reactExports.useState(e.maxValue),
    n = usePrevious(t),
    o = usePrevious(r),
  ...
  const d = reactExports.useMemo(
    ...
    [t, r, i, a, c, e.size, e.animationEnabled],
  );
...
const multiValueTypes = [
  ...
  getRewardImage = (e, t = ImageSize.Small) => {
    ...
    switch (s) {
      ...
      case "premium":
      case "premium_plus":
        return `R.images.gui.maps.icons.quests.bonuses.${u}.${s}_${a}`;
      case "items":
  ...
  base__small$7 = "Reward_base__small_3eddf28d",
...
const base$h = "Progressbardeltagrow_c42a7a2c",
  ...
  WithAnimationLineComponent = ({ onComplete: e, onEndAnimation: t, ...s }) => {
    const [r, a] = reactExports.useState(!1),
  ...
  WithStackAnimationLineComponent = ({ onEndAnimation: e, ...t }) => {
    const s = reactExports.useRef({}),
      ...
      a = "number" == typeof s.current.from ? s.current.from : t.from;
    return (
      (s.current.from = a),
  ...
  WithoutAnimationLine = ({ size: e, value: t, lineRef: s, disabled: r, onComplete: a }) => {
  ...
  ProgressBarLineComponent = ({
    ...
    return o.withStack
      ...
      : jsxRuntimeExports.jsx(WithAnimationLine, { ...c }, `${a}-${t}-${n}`);
  },
...
function SceneWrapper({
  ...
  function f(e) {
    if (!_.current) return;
    const { left: t, right: s, top: r, bottom: a } = _.current.getBoundingClientRect();
    return !(e.clientX < t || e.clientY < r || e.clientX > s || e.clientY > a);
  }
  function E(e) {
    return e.buttons === MOUSE_BUTTONS_LEFT$1 && f(e) && a;
  }
  return (
    reactExports.useEffect(() => {
      m(i && l);
    ...
    jsxRuntimeExports.jsx("div", {
      ...
      onMouseDown: function (e) {
        (e.preventDefault(), E(e) && (u(!0), c(!0), p({ x: e.clientX, y: e.clientY })));
      },
      onMouseMove: function (e) {
      ...
      onWheel: function (e) {
        if ((e.preventDefault(), !a || !f(e))) return;
        const s = e.deltaY < 0;
        t({ dx: 0, dy: 0, dz: s ? -DELTA_Z : DELTA_Z });
      },
      onMouseOver: function (e) {
        (s({ isOver3dScene: !0 }), E(e) && (u(!0), p({ x: e.clientX, y: e.clientY })));
      },
      onMouseOut: function () {
...
const themes = { primary: "primary", custom: "custom" },
  ...
  HeadlessTab = reactExports.forwardRef(function (
    { theme: e, size: t, tabId: s, active: r, children: a, onClick: n, onMouseEnter: o, ...i },
    u,
  ) {
    const l = useSounds();
    return jsxRuntimeExports.jsx(Base$e, {
      ...
      onMouseEnter: function (e) {
        (r !== s && l.play("mouse-enter", { target: Base$e.displayName, original: e }), o?.(e));
      },
      onClick: function (e) {
        (r !== s && l.play("click", { target: Base$e.displayName, original: e }), n?.(e));
      },
      children: a,
    });
  });
function Tab({ tabId: e, classNames: t, className: s, children: r, ...a }) {
...
function Tabs({ active: e, theme: t, size: s, children: r, onActiveChange: a }) {
...
function SliderProvider({
  ...
  const { value: i, percentage: u, maxValue: l, setValue: c } = useProgressBar(),
    ...
    f = useEvent((e, t, s, r = BASE_COMPONENT_NAME, a = !1) => {
      t > e
        ? _.play(a ? "increaseAmount" : "increaseAmountRoll", { target: r, original: s })
        : t < e && _.play(a ? "decreaseAmount" : "decreaseAmountRoll", { target: r, original: s });
    }),
    E = useEvent((e) => {
  ...
  const b = useEvent(function (t) {
      const s = E(i + e * Math.sign(t.deltaY));
      f(i, s, t);
    }),
    x = useEvent(function (e, t) {
      ((t = E(t)), f(i, t, e, "Controls", !0));
    }),
...
const base$c = "Controls_9c96becc",
  ...
  Thumb = reactExports.forwardRef(function (
    { className: e, classNames: t, buttonClassNames: s, onMouseDown: r, ...a },
    n,
  ) {
...
async function loadPlugin(e) {
  ...
  try {
    ...
    const a = await import(e);
    if (!is(schema, a)) throw new Error(`Not is plugin ${e}`);
    const n = await a.default.plugin({ id: s, url: e });
    return (
      plugins.set(s, n),
      r.resolve(n),
      {
...
function TableProvider({
  ...
  const f = useReactTable({
      ...
      getPaginationRowModel: a ? getPaginationRowModel() : void 0,
      initialState: o,
      state: { sorting: r, rowSelection: n, pagination: a },
      ...i,
    }),
    E = reactExports.useMemo(
      () => ({
  ...
  return jsxRuntimeExports.jsx(TableContext.Provider, { value: E, children: e });
}
const base$5 = "Table_85be883a",
  ...
  Base$a = defineStyledComponent("ContentResponsiveTableCell", styles$5.cell),
  ContentResponsiveCell = observer(function (e) {
    ...
    const { className: t, style: s, cell: r, ...a } = e,
      n = reactExports.useRef(null),
      ...
      jsxRuntimeExports.jsx(
        Base$a,
        {
          className: clsx(
            ...
            o && tableParts.header === r.tablePart && styles$5.sortable,
            t,
          ),
          style: {
            ...s,
          ...
          ...a,
          children: jsxRuntimeExports.jsx("div", {
            className: styles$5.contentResponsiveCellWrapper,
  ...
  Base$9 = defineStyledComponent("ScreenResponsiveTableCell", styles$5.cell);
  ...
  return (
    ...
    jsxRuntimeExports.jsx(
      Base$9,
      {
        ...
        className: clsx(
          r.column.columnDef.meta?.className,
          i && tableParts.header === r.tablePart && styles$5.sortable,
          t,
        ),
        style: {
          ...s,
...
const Base$8 = defineStyledComponent("StaticTableCell", styles$5.cell);
function StaticCell(e) {
  ...
  return (
    ...
    jsxRuntimeExports.jsx(Base$8, {
      ...
      style: { ...s, width: r.size, opacity: n ? 1 : 0 },
      ...a,
      children: e.children,
    })
  );
...
const Base$7 = defineStyledComponent("Table", styles$5.base),
  Header = defineStyledComponent("TableHeader", styles$5.header),
  Body = defineStyledComponent("TableBody", styles$5.body),
  Footer = defineStyledComponent("TableFooter", styles$5.footer),
  Row = defineStyledComponent("TableRow", styles$5.row),
  Table = reactExports.forwardRef(function (e, t) {
    return jsxRuntimeExports.jsx(Base$7, { ref: t, ...e, children: e.children });
  });
((Table.Header = Header),
  (Table.Body = Body),
  (Table.Footer = Footer),
...
const sizes$3 = { x24x24: "24x24", x32x32: "32x32", x48x48: "48x48" },
  ...
  Base$6 = defineStyledComponent("PlayerInfoAnonymizer", { element: Image$1 }),
...
const base$4 = "PlayerInfo_89eea88b",
  ...
  Base$5 = defineStyledComponent("PlayerInfoBadge", { element: Image$1 }),
  Badge = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsx(Base$5, {
      ...
      width: r,
      height: a,
      className: clsx(styles$4.badge, n),
    });
  });
function ClanTag({ size: e, className: t, children: s, ...r }) {
  return jsxRuntimeExports.jsx("div", {
    ...r,
    className: clsx(styles$4.clanTag, e && styles$4[`clanTag__${e}`], t),
    children: s,
  });
}
Badge.sizes = sizes$2;
const sizes$1 = { x64x28: "64x28", x34x16: "34x16", x26x16: "26x16", x10x10: "10x10" },
  ...
  Base$4 = defineStyledComponent("PlayerInfoIgr", { element: Image$1 }),
...
function Name({ size: e, className: t, children: s }) {
  return jsxRuntimeExports.jsx("div", {
    className: clsx(styles$4.name, e && styles$4[`name__${e}`], t),
    children: s,
  });
}
...
const sizes = { default: "default", regular: "regular", medium: "medium", big: "big" },
  ...
  Base$3 = defineStyledComponent("StripeBadgeIcon", { element: Image$1 }),
  ...
  Base$2 = defineStyledComponent("StripeIcon", { element: Image$1 }),
  StripeIcon = reactExports.forwardRef(function (
    ...
    return s
      ? jsxRuntimeExports.jsx(Base$2, {
          ...i,
          ref: u,
          path: r,
          width: a,
          height: n,
          className: clsx(styles$4.stripeBadge, o),
        })
      : null;
  }),
  sizesConfig = { badge: sizesConfig$2, stripe: sizesConfig$1 },
  Base$1 = defineStyledComponent("PlayerInfoStripe", styles$4.stripe),
  Stripe = reactExports.forwardRef(function (
    ...
    return jsxRuntimeExports.jsxs(Base$1, {
      ...o,
      ref: i,
      className: clsx(c && styles$4[`stripe__${e}`], r),
      children: [
...
const Base = defineStyledComponent("AccountInfo", styles$4.base),
  Wrapper = defineStyledComponent("AccountInfoWrapper", styles$4.base),
  PlayerInfo = reactExports.forwardRef((e, t) => jsxRuntimeExports.jsx(Base, { ref: t, ...e }));
...
const RewardComponent = ({ reward: e, size: t }) => {
    ...
    return s
      ? jsxRuntimeExports.jsx(s, {
          ...
          children: jsxRuntimeExports.jsx(Reward$1, { size: t, ...e }),
        })
      : jsxRuntimeExports.jsx(Reward$1, { size: t, ...e });
  },
  ...
  Rewards = ({
    ...
    const c = r && r < e.length,
      d = cx(styles$3.reward, s && styles$3.reward__vertical, n),
      p = c ? r : e.length;
    return jsxRuntimeExports.jsxs("div", {
      className: cx(styles$3.base, s && styles$3.base__vertical, a),
      children: [
        e
          .slice(0, p)
          .map((e, s) =>
  ...
  moveLine = ({ horizontalScrollPosition: e, leftOffset: t }, s, { container: r, line: a }) => {
    const n = Math.max(0, Math.floor(r.offsetWidth * s) - MAX_WIDTH),
      o = (e - getLeftOffset(r, t)) | 0,
      i = clamp(0, n, o);
    a.style.transform = `translateX(${i}px)`;
  },
  moveBackground = ({ horizontalScrollPosition: e, leftOffset: t }, s, r) => {
    const a = (e - getLeftOffset(s, t)) | 0,
      n = clamp(0, s.offsetWidth, a);
          ...
          children: [
            jsxRuntimeExports.jsx("div", {
              ...
              children: jsxRuntimeExports.jsx("div", {
                ...
                ref: u,
                children: jsxRuntimeExports.jsx(ProgressBarBackground, { size: n.size }),
              }),
            }),
...
export {
  ...
  useResizeLayoutReady as dA,
  isValidBreakpoint as dB,
  useAdjustScreenWidth as dC,
  createTargetOverrides as dD,
  injectGFPlugins as dE,
  unwrapItem as dF,
  formatString as dG,
  Alignment as dH,
  Rewards as dI,
  constFalse as dJ,
  FormattedValue as dK,
  formatValue as dL,
  Tooltip$2 as dM,
  getInitialApi as dN,
  AnimationType as dO,
  OptimizedProgressBar as dP,
  BlueNoise as dQ,
  useHorizontalDrag as dR,
  Bar$1 as dS,
  getRewardTooltipConfig$1 as dT,
  getRewardValueType$1 as dU,
  getRewardImage$1 as dV,
  ProgressBar as dW,
  ONE_WEEK as dX,
  ONE_DAY$1 as dY,
  ONE_HOUR$1 as dZ,
  ...
  sizes$4 as dc,
  Bubble as dd,
  useTabsContext as de,
  useRefResizeObserver as df,
  isReactComponent as dg,
  fromModel$1 as dh,
  fromAccountModel as di,
  loadPlugin as dj,
  useLayoutReady as dk,
  Img as dl,
  GradientText as dm,
  useMeasure as dn,
  measureTypes as dp,
  remove as dq,
  getSize$1 as dr,
  columnBehaviours as ds,
  PlayerInfo as dt,
  useBackportContextMenu as du,
  Table as dv,
  tableParts as dw,
  useTableContext as dx,
  Direction as dy,
  TableProvider as dz,
  Tooltip$1 as e,
  BackportTooltip$1 as e0,
  FormatTextWithColorTags as e1,
  getRewardTooltipConfig as e2,
  Rewards$1 as e3,
  Specials as e4,
  createSimpleGetter as e5,
  createMockControls as e6,
  compare as e7,
  greaterThanOrEqual as e8,
  days as e9,
  CountdownStyle as ea,
  Counter as eb,
  TextButton as ec,
  fromMs as ed,
  computeds as f,
  graphicsQuality as g,
  defineStyledComponent as h,
