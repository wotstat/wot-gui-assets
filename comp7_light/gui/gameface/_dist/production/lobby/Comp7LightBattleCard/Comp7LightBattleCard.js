  ...
  var __webpack_modules__ = {
      ...
      618: (e, u, a) => {
        ...
        const W = ({
            ...
            const l =
              o && e ? ((c = e), u.replace(/\{\w+\}/g, (e) => String(c[e.slice(1, -1)]))) : u;
            var c;
        ...
        const U = (e, u = !1) =>
            u && 1 === e ? j.B0 : `b${Math.min(Math.max(Math.floor(e), 0), 6)}`,
          V = {},
          K = (...e) => {
            let u = [];
        ...
        const Fe = ({ children: e, tooltipArgs: u, className: a }) => {
          ...
          const r = u.contentId;
          return r
            ? A().createElement(te, ge({}, u, { contentId: r }), t)
            : A().createElement(ne, u, t);
        };
        var Ce = a(311);
        const De = {
        ...
        const pe = {
            [he.NBSP]: Be.NoBreakSymbol,
            [he.ZWNBSP]: Be.NoBreakSymbol,
            [he.NEW_LINE]: Be.LineBreak,
          },
          ...
          ke = ({ elementList: e, textBlock: u, key: a }) => {
            ...
            return t
              ...
              : A().createElement(
                  "span",
                  { key: a, "data-block-type": u.blockType, className: we },
                  e,
                );
          },
          Te = {
        ...
        const Ve = {
            [Ae.LowRisk]: be.Normal,
            [Ae.MediumRisk]: be.Alert,
            [Ae.HighRisk]: be.Blocker,
          },
          Ke = R.strings.mode_selector.mode,
          qe = ({
            size: e,
            performanceRisk: u = Ae.LowRisk,
            modeName: a,
            cut: t,
            textFolder: _,
          }) => {
        ...
        const bu = (e) => {
          ...
          const Ne = r()(
            ...
            ye = r()(
              $.footer,
              (ne || J) && !ee && Ae && ou.footer__anim,
              null == y ? void 0 : y.footer,
            ),
            Se = r()($.formatText, $[`formatText__${Q}`]),
            Re = r()(ou.darken, ee && ou.darken__show),
            Oe = r()(
              ou.widgetOverlay,
              !Fe && ou.widgetOverlay__hide,
        ...
        const Hu = (e) => (e ? { left: 0 } : { right: 0 }),
          ...
          Gu = (0, b.memo)(
            ({
              ...
              const f = (0, b.useMemo)(
                  () => Object.assign({ width: "100%" }, ju(e), Hu(s)),
                  [s, e],
                ),
                h = (0, b.useMemo)(() => Object.assign({ width: "0%" }, ju(e), Hu(s)), [s, e]),
                p = (0, b.useMemo)(
                  () => Object.assign({ width: "0%" }, zu(s, t), ju(e)),
                  [t, s, e],
                ),
                x = (0, b.useMemo)(
          ...
          Da = ({ size: e, isCompletedProgression: u }) => {
            ...
            return A().createElement(
              ...
              A().createElement("div", {
                ...
                style: {
                  backgroundImage: `url(${u ? Ca.logo_completed() : Ca.logo_incomplete()})`,
                },
              }),
            );
          };
