  ...
  var __webpack_modules__ = {
      ...
      176: (e, u, t) => {
                  ...
                  l().createElement(
                    ...
                    l().createElement("div", {
                      className: o()(
                        ...
                        p && "WindowDecorator_frame__focused_cfdc3",
                      ),
                    }),
                    l().createElement(I, {
                      title: e,
        ...
        const H = (e) => e.replace(/&nbsp;/g, " "),
          ...
          j = (e, u, t = V.left) => e.split(u).reduce(t === V.left ? $ : W, []),
          U = (() => {
            const e = new RegExp(
              [
        ...
        const Te = (e) => {
            ...
            const c = o()(Se.base, t, u && Se.base__active);
            return l().createElement(
              "div",
              { className: c },
              l().createElement(
                b,
                xe({}, i, { type: "secondary", size: a, mixClass: Se[`${s}`] }),
                l().createElement("span", { className: Se.content }, n),
              ),
              l().createElement("div", { className: Se.overlay }),
              l().createElement("div", { className: Se.indicator }),
            );
          },
          Me = ((0, i.memo)(Te), (0, i.createContext)(null)),
          Oe = () => (0, i.useContext)(Me),
          Re = { contentId: R.views.lobby.platoon.AlertTooltip("resId"), isEnabled: !0 };
        function Ie() {
          return (
            (Ie = Object.assign
              ? Object.assign.bind()
        ...
        const Ke = ({ children: e, tooltipArgs: u, className: t }) => {
            ...
            if (u.header || u.body) return l().createElement(x, u, n);
            const r = u.contentId;
            return r
              ? l().createElement(N, Ye({}, u, { contentId: r }), n)
              : l().createElement(Ge, u, n);
          },
          Xe = (e) => {
            let u,
              t = null;
              ...
              return (
                ...
                l().createElement(
                  ...
                  l().createElement(
                    ...
                    B && l().createElement("div", { className: ru.disabled }),
                  ),
                )
              );
            },
        ...
        const wu = mu({
          ...
          Tu = (0, i.memo)(
            ({ api: e, classNames: u = {}, getStepByRailClick: t = Su, onDrag: n = Nu }) => {
              const r = (0, i.useRef)(null),
                a = (0, i.useRef)(null),
                c = (0, i.useRef)(null),
                d = (0, i.useRef)(null),
          ...
          Ou = ({
            ...
            const E = (0, i.useMemo)(() => {
                const e = n || {};
                return Object.assign({}, e, { base: o()(Mu.base, e.base) });
              }, [n]),
              m = (0, i.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
            return l().createElement(
              "div",
              { className: o()(Mu.defaultScroll, t), onWheel: u.handleMouseWheel },
              l().createElement(
                "div",
                { className: o()(Mu.area, r) },
                l().createElement(Ru, { className: a, classNames: s, api: m }, e),
              ),
              l().createElement(Tu, { getStepByRailClick: c, api: u, onDrag: d, classNames: E }),
            );
          },
          Ru = ({ className: e, classNames: u, children: t, api: n }) => (
            ...
            l().createElement(
              "div",
              { className: o()(Mu.base, e), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
              l().createElement(
                "div",
                { className: o()(Mu.content, null == u ? void 0 : u.content), ref: n.contentRef },
                t,
              ),
            )
          );
        ...
        const qu = ({
          ...
          Yu = ({
            ...
            return l().createElement(
              "div",
              { id: b, className: o()(Gu.base, Gu[`base__${u}`], s) },
              l().createElement(
                Vu,
          ...
          Xu = (0, i.memo)(
            ({
              ...
              const G = (0, i.useCallback)(() => {
                ...
                const e = u && u.current,
                  ...
                  n =
                    ...
                    t;
                n !== M.current.listAbove && ((M.current.listAbove = n), V(n));
              }, [u]);
              (0, i.useEffect)(() => Xe(() => Xe(G)), [G, a, t.length]);
              const Y = (0, i.useCallback)(
                ...
                Q = (0, i.useMemo)(() => t.filter((e) => H.includes(e.id)), [t, H]),
                ee = _ ? _(Q) : void 0;
              return l().createElement(
                "div",
                {
        ...
        const ot = () => {
            ...
            return l().createElement(
              ...
              a ? l().createElement(We, null) : l().createElement(He, null),
        ...
        const Ft = ({ rating: e }) =>
          ...
          pt = (e, u) => Ct(R.images.gui.maps.icons.vehicle.c_420x307.$dyn(Dt(u).toLowerCase())),
          Bt = (e, u) =>
        ...
        const St = { [vt.default]: "c_64x24", [vt.x48]: "c_68x28" },
          ...
          xt = ({
            ...
            const A = R.images.gui.maps.icons.library.badges.strips.$dyn(St[E]),
              ...
              b = u ? `[${u}]` : "",
              p = o()(yt.base, yt[`base__${E}`], a && yt.base__inverted),
              B = o()(yt.userName, m),
              f = o()(yt.clanTag, _),
              v = e !== d,
              g = s ? `${d}${b}` : d,
            ...
            e.type === Ot.UNDEFINED
              ...
              : l().createElement(
                  ...
                  l().createElement(
                    ...
                    l().createElement("div", {
                      className: It.icon,
                      style: { backgroundImage: `url(${Vt(e)})` },
                    }),
                    e.type !== Ot.MAXIMUM &&
        ...
        const on = ({ slot: e, isHorizontal: u, isShort: t }) => {
          ...
          cn = () => {
            ...
            const n = Q(),
              ...
              b = Oe(),
              p = null != (e = null == b ? void 0 : b.subViewComponent) ? e : Fe,
            ...
            return (
              ...
              l().createElement(
                ...
                l().createElement(
                  "div",
                  { className: o()("App_base_cb80c", ln(B, c, d)) },
                  l().createElement(
                    "div",
                              ...
                              var e,
                                t = (function (e, u) {
                                  ...
                                  if (
                                    ...
                                    (t = (function (e, u) {
                                      if (e) {
                                        if ("string" == typeof e) return An(e, u);
                                        var t = {}.toString.call(e).slice(8, -1);
                                        return (
                                          "Object" === t &&
                                            e.constructor &&
                      ...
                      d = (({ observableModel: e }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (u, t) => {
                            const n = l(t);
                            if (Array.isArray(u)) {
                              const r = u.reduce((e, u) => ((e[u] = _n.LO.box(n[u], {})), e), {});
                              return (
                                "real" === e &&
                                  i.subscribe(
                                    (0, _n.aD)((e) => {
                            ...
                            }
                            {
                              const r = u,
                                a = Object.entries(r),
                                o = a.reduce((e, [u, t]) => ((e[t] = _n.LO.box(n[u], {})), e), {});
                              return (
                                "real" === e &&
                                  i.subscribe(
                                    (0, _n.aD)((e) => {
          ...
          bn =
            ...
            ({ children: e }) =>
              l().createElement(
                ...
                {
                  value: {
                    subViewComponent: (e) => l().createElement(fe, e),
        ...
        engine.whenReady.then(() => {
          (En().render(
            l().createElement(bn, null, l().createElement(Cn, null, l().createElement(cn, null))),
