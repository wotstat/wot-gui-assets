import { Q as e, r as s, j as t, f as a } from "./vendor.js";
import {
  b as o,
  du as n,
  dv as r,
  ...
  W = e(function ({ className: e, classNames: o }) {
    ...
    s.useLayoutEffect(() => {
      ...
      if ((L({ duration: t, style: a }), a === u.Extended)) {
        const s = d(m(t + 1), g(1));
        e = setTimeout(() => L((e) => ({ ...e, style: u.Long })), Math.min(s, h));
      }
      return () => {
    ...
    return (
      s.useEffect(() => {
        ...
        return (
          (e.src = E),
          (e.onload = () => {
            (z({ path: E, height: e.height, width: e.width }), O(!0));
          }),
          (e.onerror = () => {
            O(!0);
          }),
                  ...
                  (W || $) &&
                    t.jsxs("div", {
                      ...
                      children: [
                        ...
                        $ && t.jsx(v, { className: a(C.countdown, o?.countdown), ...$ }),
                      ],
                    }),
                ],
              }),
