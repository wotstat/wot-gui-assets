...
(self.webpackChunkgameface = self.webpackChunkgameface || []).push([
  ["lib/fun_random.vendors"],
  {
    ...
    248: (t, e, n) => {
          ...
          return (
            ...
            (t.prototype.spawnPromise = function (t, e) {
              ...
              t.then(
                function (t) {
                  i ||
                    ((n = t), r.removeChild(e), r.send((0, u.g5)((0, h.Sl)(e, t), { origin: e })));
                },
                function (t) {
                  if (!i) {
                    r.removeChild(e);
            ...
            (t.prototype.spawnActivity = function (t) {
              ...
              if (e) {
                ...
                s.M || (0, u.ZK)(!1, "No implementation found for activity '".concat(t.type, "'"));
            }),
      ...
      (((x = O || (O = {}))[(x.Effect = 1)] = "Effect"),
        (x[(x.LayoutEffect = 2)] = "LayoutEffect"));
      var B = function (t, e) {
    ...
    242: (t, e, n) => {
      ...
      class f {
        ...
        *getBlocks(t, e) {
          ...
          if (2 === n) return;
          if (3 === n)
            return (e && e.hasText() && (yield e, (e.textNodes = [])), void s(!t.firstChild));
          s(1 === n || 0 === n);
          const r = !e || 1 === n,
            i = r ? new l(t) : e;
          s(i);
        ...
        applyToParagraph(t) {
          ...
          if ((s(r.length > 0), s(r.reduce((t, e) => t + e.length, 0) === n.length), r.length <= 1))
            return;
          const i = [];
          let a = 0;
    ...
    305: (t, e, n) => {
      ...
      function dt(t, e, n, r) {
        ...
        if (n.set) {
          ...
          return r === t.target_
            ? null ===
              t.defineProperty_(e, {
                configurable: !se.safeDescriptors || t.isPlainObject_,
                set: c,
              })
              ? 0
              : 2
        ...
        if (r !== t.target_ && "function" == typeof n.value)
          return w(n.value)
            ? ((null == (s = this.options_) ? void 0 : s.autoBind) ? Je.bound : Je).make_(
                t,
                e,
                n,
                r,
              )
            : ((null == (a = this.options_) ? void 0 : a.autoBind) ? Ae.bound : Ae).make_(
                t,
                e,
                n,
                r,
        ...
        return n.get
          ...
          : n.set
            ...
            : ("function" == typeof n.value &&
              ...
              (!1 === (null == (o = this.options_) ? void 0 : o.deep) ? Wt.ref : Wt).extend_(
                t,
                e,
                n,
                r,
        ...
        return !0 === t.deep
          ...
          : !1 === t.deep
            ...
            : (e = t.defaultDecorator) &&
                null != (n = null == (r = e.options_) ? void 0 : r.enhancer)
              ? n
              : G;
        var e, n, r;
      }
      ...
      var Pt,
        ...
        kt = 1,
        Nt =
          null != (St = null == (Ut = s(function () {}, "name")) ? void 0 : Ut.configurable) && St,
      ...
      var Lt,
        It = (function (t) {
          ...
          return (
            ...
            (n.set = function (t) {
              (this.value_,
                (t = this.prepareNewValue_(t)) !== se.UNCHANGED && this.setNewValue_(t));
            }),
        ...
        Xt = (function () {
          function t(t) {
            ((this.dependenciesState_ = Ht.NOT_TRACKING_),
              ...
              (this.equals_ =
                t.equals || (t.compareStructural || t.struct ? F.structural : F.default)),
      ...
      function Jt(t, e, n) {
        ...
        if (((se.trackingDerivation = t), se.inBatch++, !0 === se.disableErrorBoundaries))
          i = e.call(n);
        else
          try {
            i = e.call(n);
      ...
      var pe = (function () {
          ...
          return (
            ...
            (e.dispose = function () {
              this.isDisposed_ ||
                ((this.isDisposed_ = !0), this.isRunning_ || (fe(), Zt(this), he()));
            }),
      ...
      function nn(t) {
        return (function (t, e) {
          return (
            !!t &&
            (void 0 !== e
              ? !!Fn(t) && t[H].values_.has(e)
              : Fn(t) || !!t[H] || X(t) || me(t) || Kt(t))
          );
        })(t);
      }
      function rn(t) {
          ...
          return (
            ...
            (e.spliceWithArray_ = function (t, e, n) {
              ...
              if (
                ...
                (e =
                  1 === arguments.length ? i - t : null == e ? 0 : Math.max(0, Math.min(e, i - t))),
                void 0 === n && (n = l),
                cn(this))
              ) {
                var o = fn(this, {
            ...
            (e.set_ = function (t, e) {
              ...
              if (t < n.length) {
                ...
                (e = this.enhancer_(e, i)) !== i &&
                  ((n[t] = e), this.notifyArrayChildUpdate_(t, e, i));
      ...
      var wn = {
        ...
        reverse: function () {
          return (
            se.trackingDerivation && r(37, "reverse"),
      ...
      var kn,
        ...
        Mn = (function () {
          ...
          return (
            ...
            (e.delete = function (t) {
              var e = this;
              if ((this.keysAtom_, cn(this) && !fn(this, { type: jn, object: this, name: t })))
                return !1;
              if (this.has_(t)) {
                var n = hn(this),
                  r = n
      ...
      var Cn = (function () {
        ...
        Hn = (function () {
          ...
          return (
            ...
            (e.get_ = function (t) {
              return (
                se.trackingDerivation && !E(this.target_, t) && this.has_(t),
                this.target_[t]
              );
            }),
      ...
      function sr(t, e, n, r, i) {
        ...
        switch (a) {
          ...
          case "[object Symbol]":
            return (
              "undefined" != typeof Symbol && Symbol.valueOf.call(t) === Symbol.valueOf.call(e)
            );
          case "[object Map]":
          case "[object Set]":
            n >= 0 && n++;
    ...
    36: (t, e, n) => {
      ...
      function s(t, e, n, r) {
        var s,
          u = (0, i.j)(t.src),
          c =
            null === (s = null == e ? void 0 : e.options.services) || void 0 === s
              ? void 0
              : s[u.type],
        ...
        _ = (function () {
          ...
          return (
            ...
            (t.prototype.resolveTransition = function (t, e, n, i) {
              ...
              var W = (0, r.CR)(
                  (0, l.yC)(this, e, m, n, w, this.machine.config.preserveActionOrder),
                  2,
                ),
                B = W[0],
                T = W[1],
                          ...
                          o.M ||
                            (function (t, e, n) {
                              var r = n.slice(0, -1).some(function (t) {
                                ...
                                i = e === v ? "the transient event" : "event '".concat(e, "'");
                              (0, a.ZK)(
                                !r,
          ...
          for (var b = (0, r.XA)(v), m = b.next(); !m.done; m = b.next())
            if ("compound" !== (W = m.value).type || (_.get(W) && _.get(W).length)) {
              if ("parallel" === W.type)
                try {
                  for (
                    var w = ((u = void 0), (0, r.XA)(a(W))), O = w.next();
                    !O.done;
                    O = w.next()
                  ) {
                    var x = O.value;
    ...
    322: (t, e, n) => {
      ...
      function O(t) {
        return (
          t instanceof Promise || !(null === t || (!E(t) && "object" != typeof t) || !E(t.then))
        );
      }
      function x(t) {
        return (
