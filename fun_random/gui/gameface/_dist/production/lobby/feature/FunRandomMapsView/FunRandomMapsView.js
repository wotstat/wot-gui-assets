(() => {
  var __webpack_modules__ = {
      ...
      1996: (u, e, t) => {
        ...
        const m = c.O.client.getSize("rem"),
          d = m.width,
          _ = m.height,
          D = Object.assign({ width: d, height: _ }, F(d, _, E)),
          ...
          g = (u) => {
            ...
            const r = (0, a.useContext)(B),
              ...
              f = { extraLarge: _, large: D, medium: g, small: p, extraSmall: h };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && E) return l(e, t, f);
              if (t.largeWidth && A) return l(e, t, f);
              if (t.mediumWidth && F) return l(e, t, f);
              if (t.smallWidth && m) return l(e, t, f);
              if (t.extraSmallWidth && d) return l(e, t, f);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        const p = (0, a.memo)(({ children: u }) => {
          const e = (0, a.useContext)(B),
            ...
            i = (0, a.useCallback)((u, e) => {
              ...
              n(Object.assign({ width: t, height: r }, F(t, r, E)));
            }, []);
          (((u) => {
        ...
        const $ = (u) =>
            (function (u, e) {
              return Array.isArray(u)
                ? u.map(e)
                : u.map((u, t, r) => e(null == u ? void 0 : u.value));
            })(u, (u) => Object.assign({}, u)),
          z = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: r, children: n, mocks: i }) {
                  ...
                  l = (u, t, r) => {
                    ...
                    const a = (function ({
                      ...
                      E = (({ observableModel: u }) => {
                        const e = {
                            root: u.object(),
                            primitives: u.primitives(["assetsPointer"]),
                        ...
                        return Object.assign({}, e, {
                          computes: {
                            getMaps: t,
                            getSelectedMapPoints: r,
                            getSelectedMapModifiers: n,
                          },
                        });
                      })({
                        mode: u,
                ...
                return (
                  (0, a.useEffect)(() => {
                    E.current ? D(l(F, r, i)) : (E.current = !0);
                  }, [i, F, r]),
                  (0, a.useEffect)(() => {
                    m(u);
                  }, [u]),
                  ...
                  o().createElement(t.Provider, { value: _ }, n)
                );
              },
              () => (0, a.useContext)(t),
            ];
            ...
            onMapSelect: u.createCallback((u) => ({ selectedMap: u }), "onSwitchSelected"),
            onNextMap: u.createCallbackNoArgs("onNextMap"),
            onPrevMap: u.createCallbackNoArgs("onPrevMap"),
            onViewSwitch: u.createCallbackNoArgs("onViewSwitch"),
          })),
          X = z[0],
          K = z[1];
        function Y(u) {
        ...
        class J extends o().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              F = f()(q.base, q[`base__${a}`], q[`base__${n}`], null == i ? void 0 : i.base),
              m = f()(q.icon, q[`icon__${a}`], q[`icon__${n}`], null == i ? void 0 : i.icon),
              d = f()(q.glow, null == i ? void 0 : i.glow),
              _ = f()(q.caption, q[`caption__${a}`], null == i ? void 0 : i.caption),
              D = f()(q.goto, null == i ? void 0 : i.goto);
        ...
        const uu = (0, a.memo)(
            ({ closeControl: u, showInfoControl: e, titleText: t, subTitleText: r }) =>
              o().createElement(
                "div",
                ...
                o().createElement("div", { className: "Header_title_fe" }, t),
                o().createElement("div", { className: "Header_subTitle_65" }, r),
              ),
          ),
          eu = "InfoBlock_blockContent_c6",
          tu = "InfoBlock_blockContent__emptyBg_1b",
          ru = "InfoBlock_blockIconWrapper_46",
          nu = "InfoBlock_blockIcon_27",
          au = "InfoBlock_modsInfoText_81",
          ou = "InfoBlock_modsInfoText__emptyText_81";
        var iu = t(9887),
          su = t.n(iu);
        const lu = ["xl", "lg", "md", "sm", "xs"],
          cu = (u) => u.includes("_") && ((u) => lu.includes(u))(u.split("_").at(-1)),
          Eu = [w.ExtraLarge, w.Large, w.Medium, w.Small, w.ExtraSmall],
          Au = (u, e) =>
        ...
        const Du = {
          ...
          gu = Fu((u) => {
            let e = u.className,
              ...
              _ = u.row,
              D = u.flexDirection,
              B = void 0 === D ? (d ? "column" : _ && "row") || void 0 : D,
              C = u.flexStart,
              g = u.center,
              p = u.flexEnd,
              h = u.spaceBetween,
            ...
            return o().createElement(
              "div",
              _u({ className: f()(mu.base, ...U, e), style: G }, I),
              H,
            );
          });
        let pu;
        ...
        const fu = (u, e, t) => {
          ...
          bu = (u, e, t = pu.left) => u.split(e).reduce(t === pu.left ? fu : vu, []),
          wu = (() => {
            const u = new RegExp(
        ...
        const Ru = Object.keys(Lu()),
          ...
          Wu = Fu((u) => {
            ...
            return o().createElement(
              ...
              Nu(
                {
                  className: f()(yu.base, t && yu[t], p, r),
                  style: g,
                  mt: !0 === l ? Hu[t || "paragraph-P16"].mt : l,
                  mr: !0 === E ? Hu[t || "paragraph-P16"].mr : E,
                  mb: !0 === F ? Hu[t || "paragraph-P16"].mb : F,
                  ml: !0 === d ? Hu[t || "paragraph-P16"].ml : d,
                },
                B,
              ),
          ...
          Gu = {
            base: "ModsList_base_b2",
            modsLine: "ModsList_modsLine_92",
            modsBlock: "ModsList_modsBlock_33",
            modsIcon: "ModsList_modsIcon_43",
            modsIcon__last: "ModsList_modsIcon__last_b2",
            iconHoverBg: "ModsList_iconHoverBg_bd",
            modsSeparator: "ModsList_modsSeparator_56",
        ...
        const $u = (u, e, t = {}, r = 0) => {
          ...
          Xu = (0, a.memo)(({ line: u, isLast: e }) =>
            o().createElement(
              "div",
              { className: Gu.base },
              o().createElement(
                "div",
                { className: Gu.modsLine },
                u.map((e, t) => {
                  const r = t === u.length - 1;
                  return o().createElement(
                    "div",
                    { key: `mod_icon_${t}`, className: Gu.modsBlock },
                    o().createElement(
                      zu,
                      {
                        contentId:
                          R.views.battle_modifiers.lobby.tooltips.ModifiersDomainTooltipView(
                            "resId",
                          ),
                        args: { modifiersDomain: e.type },
                      },
                      o().createElement(
                        "div",
                        {
                          className: f()(
                            Gu.modsIcon,
                            Gu.modsIcon__infoBlock,
                            r && Gu.modsIcon__last,
                          ),
                          style: {
                            backgroundImage: `url('${R.images.battle_modifiers.gui.maps.icons.feature.domains.c_64x64.$dyn(hu(e.type))}')`,
                          },
                        },
                        o().createElement("div", { className: Gu.iconHoverBg }),
                      ),
                    ),
                    !r && o().createElement("div", { className: Gu.modsSeparator }),
                  );
                }),
              ),
              !e && o().createElement("div", { className: Gu.lineSeparator }),
            ),
          ),
          Ku = R.strings.fun_random.mapsView.infoBlock,
          Yu = (0, a.memo)(({ className: u, mapMods: e, mapPoints: t }) => {
            const r =
              ((n = e),
              5,
              Array.from({ length: Math.ceil(n.length / 5) }, (u, e) =>
                n.slice(5 * e, 5 * (e + 1)),
              ));
            var n;
            const a = e.length > 0,
            ...
            return o().createElement(
              "div",
              { className: f()("InfoBlock_base_45", u) },
              o().createElement(
                "div",
                { className: f()(eu, !a && tu) },
                o().createElement(
                  "div",
                  { className: "InfoBlock_firstBlockContent_9e" },
                  a
                    ? o().createElement(
                        o().Fragment,
                        null,
                        o().createElement(Wu, {
                          className: "InfoBlock_availableModsTitle_9b",
                          text: Ku.firstBlock.title(),
                        }),
                        o().createElement("div", { className: "InfoBlock_separatorLine_c6" }),
                        o().createElement(
                          "div",
                          { className: "InfoBlock_firstBlockMods_59" },
                          r.map((u, e) =>
                            o().createElement(Xu, {
                              key: `map_mods_line${e}`,
                              line: u,
                ...
                o().createElement(
                  ...
                  { className: ru },
                  o().createElement("div", {
                    className: f()(nu, "InfoBlock_blockIcon__firstBlock_f7"),
                  }),
                ),
              ),
              o().createElement(
                "div",
                { className: f()(eu, "InfoBlock_blockContent__secondBlock_df", !i && tu) },
                o().createElement(
                  "div",
                  { className: "InfoBlock_secondBlockContent_15" },
                  i
                    ? o().createElement(
                        o().Fragment,
                        null,
                        o().createElement(
                          "div",
                          { className: "InfoBlock_infoTitle_b8" },
                          o().createElement("div", { className: "InfoBlock_modsIcon_41" }),
                          o().createElement(Wu, {
                            className: "InfoBlock_infoTitleText_83",
                            text: Ku.secondBlock.repairZone.title(),
                          }),
                        ),
                        o().createElement("div", { className: "InfoBlock_modsInfoSeparator_ea" }),
                        o().createElement(Wu, {
                          className: au,
                          text: Ku.secondBlock.repairZone.description(),
                        }),
                      )
                    : o().createElement(Wu, {
                        className: f()(au, ou),
                        text: Ku.secondBlock.empty(),
                      }),
                ),
                o().createElement(
                  "div",
                  { className: ru },
                  o().createElement("div", {
                    className: f()(nu, "InfoBlock_blockIcon__secondBlock_9f"),
                  }),
                ),
              ),
            );
          }),
          qu = ({ className: u, selectedMap: e, points: t }) => {
            const r = R.images.gui.maps.icons.map.$dyn(hu(`c_${e.id}`)),
              n = R.strings.arenas.$dyn(hu(`c_${e.id}`)),
              a = n ? n.$dyn("name") : "";
            return o().createElement(
              "div",
              { className: f()("MapBlock_base_4b", u) },
              o().createElement(Wu, { className: "MapBlock_mapTitle_1d", text: a }),
              o().createElement(
                "div",
                { className: "MapBlock_map_68", style: { backgroundImage: `url('${r}')` } },
                t.map((u) =>
                  o().createElement(
                    zu,
                    {
                      key: `map_point_${u.id}`,
                      contentId:
                        R.views.fun_random.lobby.tooltips.FunRandomMapsDomainTooltip("resId"),
                      args: { modifiersDomain: u.type },
                    },
                    o().createElement(
                      "div",
                      {
                        className: "MapBlock_mapPoints_d1",
                        style: { left: `${u.positionX}%`, top: `${u.positionY}%` },
                      },
                      o().createElement("div", { className: "MapBlock_pointShadow_4a" }),
                    ),
                  ),
                ),
              ),
        ...
        function ue(u) {
          ...
          return (
            ...
            (0, a.useCallback)((...u) => (0, e.current)(...u), Ju)
          );
        }
        function ee(u, e, t = []) {
        ...
        const ae = {
            ...
            return (s = {}) => {
              const l = s.settings,
                ...
                _ = (0, re.useSpring)(() => ({
                  ...
                  onChange: (u) => {
                    const e = A.current;
                    e && (t(e, u), m.trigger("change", u), o && d());
                  },
          ...
          ie = oe({
            ...
            getDirection: (u) => (u.deltaY > 1 ? ne.Next : ne.Prev),
          ...
          Ae = () => {},
          Fe = (u, e) => Math.max(20, u.offsetWidth * e),
          me = (0, a.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = Ee, onDrag: r = Ae }) => {
              const n = (0, a.useRef)(null),
                ...
                _ = () => {
                  ...
                  const a = u.animationScroll.scrollPosition.get(),
                    o = Math.min(1, r / n),
                    E = Qu(0, 1, a / (n - r)),
                    A = (e.offsetWidth - Fe(e, o)) * E;
                  ((t.style.transform = `translateX(${0 | A}px)`),
                    ((u) => {
                      if (i.current && s.current && l.current && c.current) {
                        if (0 === u)
                          return (i.current.classList.add(le), void s.current.classList.remove(le));
                        if (
                          ((e = l.current),
                          (t = c.current),
                          u - (e.offsetWidth - t.offsetWidth) >= -0.5)
                        )
                          return (i.current.classList.remove(le), void s.current.classList.add(le));
                        var e, t;
                ...
                (0, a.useEffect)(() => {
                  ...
                  const e = (e) => {
                      ...
                      const a = l.current,
                        o = c.current;
                      if (!n || !a || !o) return;
                      const i = e.screenX - F.offset - a.getBoundingClientRect().x,
                    ...
                    t = () => {
                      (window.removeEventListener("mousemove", e), d(ce));
                    };
                  return (
              ...
              const B = ee((e) => u.applyStepTo(e), E, [u]),
                C = B[0],
                g = B[1];
              (0, a.useEffect)(
                () => (
              ...
              const p = (u) => {
                u.target.classList.contains(le) || Y("highlight");
              };
              return o().createElement(
                "div",
                {
                  className: f()("HorizontalBar_base_49", e.base),
                  ref: n,
                  onWheel: u.handleMouseWheel,
                },
                o().createElement("div", {
                  className: f()("HorizontalBar_leftButton_5f", e.leftButton),
                  onMouseDown: (u) => {
                    u.target.classList.contains(le) || 0 !== u.button || (Y("play"), C(ne.Next));
                  },
                  onMouseUp: g,
                  ref: i,
                  onMouseEnter: p,
                ...
                o().createElement(
                  "div",
                  {
                    className: f()("HorizontalBar_track_0d", e.track),
                    onMouseDown: (e) => {
                      const r = c.current;
                      r &&
                        0 === e.button &&
                        ...
                        e.target === r
                          ...
                          : ((e) => {
                            ...
                            })(e.screenX > r.getBoundingClientRect().x ? ne.Prev : ne.Next));
                    },
                    ref: l,
                    onMouseEnter: p,
                  },
                  o().createElement("div", {
                    ref: c,
                    className: f()("HorizontalBar_thumb_fd", e.thumb),
                  }),
                  o().createElement("div", { className: f()("HorizontalBar_rail_32", e.rail) }),
                ),
                o().createElement("div", {
                  className: f()("HorizontalBar_rightButton_03", e.rightButton),
                  onMouseDown: (u) => {
                    u.target.classList.contains(le) || 0 !== u.button || (Y("play"), C(ne.Prev));
                  },
                  onMouseUp: g,
                  ref: s,
                  onMouseEnter: p,
          ...
          _e = ({
            ...
            const E = (0, a.useMemo)(() => {
                const u = r || {};
                return Object.assign({}, u, { base: f()(de.base, u.base) });
              }, [r]),
              A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
            return o().createElement(
              "div",
              { className: f()(de.defaultScroll, t), onWheel: e.handleMouseWheel },
              o().createElement(
                "div",
                { className: f()(de.defaultScrollArea, n) },
                o().createElement(De, { className: s, api: A, classNames: i }, u),
              ),
              o().createElement(me, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
            );
          },
          De = ({ api: u, className: e, classNames: t, children: r, style: n }) => (
            (0, a.useEffect)(() => Zu(u.recalculateContent)),
            o().createElement(
              "div",
              { className: f()(de.base, e), style: n },
              o().createElement(
                "div",
                {
                  className: f()(de.wrapper, null == t ? void 0 : t.wrapper),
                  onWheel: u.handleMouseWheel,
                  ref: u.wrapperRef,
                },
                o().createElement(
                  "div",
                  { className: f()(de.content, null == t ? void 0 : t.content), ref: u.contentRef },
                  r,
                ),
              ),
            )
        ...
        ((De.Bar = me),
          (De.Default = _e),
          (De.SeniorityAwards = ({ api: u, className: e, classNames: t, children: r }) => (
            (0, a.useEffect)(() => Zu(u.recalculateContent)),
            o().createElement(
              "div",
              { className: f()(de.base, e) },
              o().createElement(
                "div",
                { className: f()(de.wrapper, null == t ? void 0 : t.wrapper), ref: u.wrapperRef },
                o().createElement(
                  "div",
                  { className: f()(de.content, null == t ? void 0 : t.content), ref: u.contentRef },
                  r,
        ...
        const Be = oe({
          ...
          be = (u, e) => Math.max(20, u.offsetHeight * e),
          we = (0, a.memo)(
            ({ api: u, classNames: e = {}, getStepByRailClick: t = fe, onDrag: r = pe }) => {
              const n = (0, a.useRef)(null),
                i = (0, a.useRef)(null),
                s = (0, a.useRef)(null),
                l = (0, a.useRef)(null),
                ...
                D = ue(() => {
                  ...
                  const a = u.animationScroll.scrollPosition.get(),
                    o = Math.min(1, r / n),
                    E = Qu(0, 1, a / (n - r)),
                    A = (e.offsetHeight - be(e, o)) * E;
                  ((t.style.transform = `translateY(${0 | A}px)`),
                    ((u) => {
                      if (i.current && s.current && l.current && c.current) {
                        if (0 === u)
                          return (i.current.classList.add(ge), void s.current.classList.remove(ge));
                        if (
                          ((e = l.current),
                          (t = c.current),
                          u - (e.offsetHeight - t.offsetHeight) >= -0.5)
                        )
                          return (i.current.classList.remove(ge), void s.current.classList.add(ge));
                        var e, t;
                ...
                (0, a.useEffect)(() => {
                  ...
                  const e = (e) => {
                      ve(u, (t) => {
                        ...
                        if (!n || !a || !o) return;
                        const i = e.screenY - F.offset - n.getBoundingClientRect().y,
              ...
              const C = ee((e) => u.applyStepTo(e), E, [u]),
                g = C[0],
                p = C[1];
              (0, a.useEffect)(
                () => (
              ...
              const h = (u) => {
                u.target.classList.contains(ge) || Y("highlight");
              };
              return o().createElement(
                "div",
                {
                  className: f()("VerticalBar_base_f3", e.base),
                  ref: n,
                  onWheel: u.handleMouseWheel,
                },
                o().createElement("div", {
                  className: f()("VerticalBar_topButton_d7", e.topButton),
                  onMouseDown: (u) => {
                    u.target.classList.contains(ge) || 0 !== u.button || (Y("play"), g(ne.Next));
                  },
                  ref: i,
                  onMouseEnter: h,
                }),
                o().createElement(
                  "div",
                  {
                    className: f()("VerticalBar_track_df", e.track),
                    onMouseDown: (e) => {
                      const r = c.current;
                      var n;
                      r &&
                  ...
                  o().createElement("div", { className: f()("VerticalBar_rail_43", e.rail) }),
                ),
                o().createElement("div", {
                  className: f()("VerticalBar_bottomButton_06", e.bottomButton),
                  onMouseDown: (u) => {
                    u.target.classList.contains(ge) || 0 !== u.button || (Y("play"), g(ne.Prev));
                  },
                  onMouseUp: p,
                  ref: s,
                  onMouseEnter: h,
          ...
          Se = ({
            ...
            const E = (0, a.useMemo)(() => {
                const u = r || {};
                return Object.assign({}, u, { base: f()(Me.base, u.base) });
              }, [r]),
              A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
            return o().createElement(
              "div",
              { className: f()(Me.defaultScroll, t), onWheel: e.handleMouseWheel },
              o().createElement(
                "div",
          ...
          xe = ({ className: u, classNames: e, children: t, api: r }) => (
            ...
            o().createElement(
              "div",
              { className: f()(Me.base, u), ref: r.wrapperRef, onWheel: r.handleMouseWheel },
              o().createElement(
                "div",
                { className: f()(Me.content, null == e ? void 0 : e.content), ref: r.contentRef },
                t,
              ),
            )
          );
        ...
        const Le = { Vertical: n, Horizontal: r },
          ...
          We = (0, a.memo)(({ className: u, mapData: e, selectMapControl: t }) => {
            const r = (0, a.useState)(!1),
              ...
              i = r[1],
              s = e.isSelected,
              l = R.images.gui.maps.icons.map.$dyn(hu(`c_${e.id}`)),
              c = R.strings.arenas.$dyn(hu(`c_${e.id}`)),
              E = c ? c.$dyn("name") : "",
              A = f()(
                "MapCard_base_25",
                s && "MapCard_base__selected_01",
                n && !s && "MapCard_base__hovered_e5",
                u,
              );
            return o().createElement(
              "div",
              ...
              o().createElement("div", { className: "MapCard_mapBorder_bb" }),
              n && !s && o().createElement("div", { className: "MapCard_hoverBlur_cf" }),
              o().createElement(Wu, { className: "MapCard_mapName_45", text: E }),
            );
          });
        var Ge = t(5521);
        const Ue = (u) => {
        ...
        const Ve = R.strings.fun_random.mapsView.carousel.title,
          $e = (0, a.memo)(
            ({
              ...
              (!(function (u, e, t) {
                  ...
                  (0, a.useEffect)(() => {
                    ...
                    const u = c.O.client.events.mouse.move(([u, t]) => {
                        ...
                        const c = "inside" === t ? u.clientX : u.clientX - l.offsetLeft,
                          E = A.positionFrom - c,
                          F = A.previousScrollPosition + E;
                        o.start(
                          Object.assign(
                            {
                              scrollPosition: i(a, F),
                ...
                (0, a.useEffect)(() => {
                  ...
                  return (
                    ...
                    i.events.on("recalculateContent", u),
                    i.events.on("resizeHandled", u),
                    () => {
                      (i.events.off("change", u),
                        i.events.off("recalculateContent", u),
                        i.events.off("resizeHandled", u));
                    }
                  );
                }, [i, d.left, d.right]));
              const _ = f()(
              ...
              return o().createElement(
                "div",
                { className: f()("MapsCarousel_base_c6", u && "MapsCarousel_base__hovered_8b") },
                o().createElement("div", { className: "MapsCarousel_bg_44" }),
                o().createElement(
                  "div",
                  { className: "MapsCarousel_carouselTitle_71" },
                  o().createElement(
                    "div",
                    { className: f()(Te, "MapsCarousel_carouselTitleLine__left_04") },
                    !u && o().createElement("div", { className: Ne }),
                  ),
                  o().createElement(Wu, {
                ...
                o().createElement(
                  "div",
                  { className: "MapsCarousel_carouselContent_e0" },
                  o().createElement(
                    Le.Horizontal.Area,
                    { api: i, classNames: { wrapper: g } },
                    o().createElement(
                      "div",
                      { className: "MapsCarousel_mapsWrapper_74" },
                      e.map((u, r) =>
                        o().createElement(We, {
                          key: `carousel_map_${u.id}`,
                          className: !(r === e.length - 1) && "MapsCarousel_mapCardPosition_7c",
                          mapData: u,
                          selectMapControl: t,
                        }),
                      ),
                  ...
                  o().createElement("div", {
                    className: _,
                    onClick: () => {
                      i.applyStepTo(ne.Next);
                    },
                  }),
                  o().createElement("div", {
                    className: D,
                    onClick: () => {
                      i.applyStepTo(ne.Prev);
                    },
                  }),
                ),
              );
          ...
          ze = {
            base: "MapsView_base_5c",
            mapMapsPrev: "MapsView_mapMapsPrev_f8",
            shadow: "MapsView_shadow_48",
            shadow__visible: "MapsView_shadow__visible_cd",
            content: "MapsView_content_a8",
            infoBlockPosition: "MapsView_infoBlockPosition_2b",
            mapBlockPosition: "MapsView_mapBlockPosition_9f",
            carouselWrapper: "MapsView_carouselWrapper_2d",
            carouselWrapper__hovered: "MapsView_carouselWrapper__hovered_b1",
            carousel: "MapsView_carousel_f4",
            footerShadow: "MapsView_footerShadow_cf",
          },
          Xe = "NavigationButton_borderLine_fc",
          Ke = "NavigationButton_icon_fe",
        ...
        const Ze = R.views.common.tooltip_window.simple_tooltip_content,
          Qe = (u) => {
            ...
            const c = (0, a.useMemo)(() => {
              const u = Object.assign({}, s, { body: t, header: r, note: n, alert: i });
          ...
          Je = R.strings.fun_random.navigationButton,
          ut = R.images.fun_random.gui.maps.icons.feature.navigation_button,
          et = (0, a.memo)(({ nextView: u, onMapSwitch: e }) =>
            o().createElement(
              Qe,
              { header: Je.tooltip.header.$dyn(u), body: Je.tooltip.body.$dyn(u) },
              o().createElement(
                "div",
                ...
                o().createElement(
                  ...
                  o().createElement("div", { className: "NavigationButton_glow_e9" }),
                  o().createElement("div", {
                    className: f()(Xe, "NavigationButton_borderLine__top_e4"),
                  }),
                  o().createElement("div", {
                    className: f()(Xe, "NavigationButton_borderLine__bottom_3e"),
                  }),
                ),
                o().createElement(
                  "div",
                  ...
                  o().createElement(
                    ...
                    o().createElement("div", {
                      className: Ke,
                      style: { backgroundImage: `url('${ut.$dyn(`${u}_default`)}')` },
                    }),
                    o().createElement("div", {
                      className: f()(Ke, "NavigationButton_icon__hovered_b8"),
                      style: { backgroundImage: `url('${ut.$dyn(`${u}_hover`)}')` },
                    }),
                  ),
                  o().createElement(Wu, {
        ...
        const nt = (0, I.Pi)(() => {
            const u = K(),
              ...
              n = r[0],
              i = r[1],
              s = e.computes.getMaps(),
              l = e.computes.getSelectedMapPoints(),
              c = e.computes.getSelectedMapModifiers(),
              E = e.selectedMap.get(),
              A = rt[E.id] || `c_${E.id}`,
              F = R.images.gui.maps.icons.map.screen.$dyn(hu(A)),
              m = R.strings.fun_random.sub_modes.$dyn(e.primitives.assetsPointer.get()),
              d = m ? m.$dyn("userName").quoted() : "";
            var _;
            return (
              (_ = t.onClose),
              je(Ge.n.ESCAPE, _),
              o().createElement(
                ...
                { className: ze.base },
                o().createElement("div", {
                  className: ze.mapMapsPrev,
                  style: { backgroundImage: `url(${F})` },
                }),
                o().createElement(uu, {
                  titleText: R.strings.fun_random.mapsView.title(),
                  subTitleText: d,
                  closeControl: t.onClose,
                  showInfoControl: t.onInfo,
                }),
                o().createElement(
                  "div",
                  ...
                  o().createElement(
                    ...
                    o().createElement(Yu, {
                      className: ze.infoBlockPosition,
                      mapMods: c,
                      mapPoints: l,
                    }),
                    o().createElement(qu, {
                      className: ze.mapBlockPosition,
                      selectedMap: E,
                      points: l,
                    }),
                  ),
                ),
                o().createElement("div", { className: f()(ze.shadow, n && ze.shadow__visible) }),
                o().createElement(
                  "div",
                  {
                    className: f()(ze.carouselWrapper, n && ze.carouselWrapper__hovered),
                    onMouseEnter: () => {
                      i(!0);
                    },
                    onMouseLeave: () => {
                  ...
                  o().createElement($e, {
                    isHover: n,
                    mapList: s,
                    handleSelectMap: t.onMapSelect,
                    nextMapControl: t.onNextMap,
                    prevMapControl: t.onPrevMap,
                  }),
                ),
                o().createElement("div", { className: ze.footerShadow }),
                o().createElement(et, {
                  nextView: tt.ProgressionView,
                  onMapSwitch: t.onViewSwitch,
                }),
              )
            );
          }),
          at = () =>
            o().createElement("div", { className: "App_base_24" }, o().createElement(nt, null));
        engine.whenReady.then(() => {
          s().render(
            o().createElement(X, null, o().createElement(H, null, o().createElement(at, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1996));
