  ...
  var __webpack_modules__ = {
      ...
      4179: (u, e, t) => {
        ...
        function c(u, e, t, n, A, E, F) {
          ...
          i.done ? e(r) : Promise.resolve(r).then(n, A);
        }
        const l = (u) => ({
      ...
      8269: (u, e, t) => {
        ...
        (_.Sw.instance,
          (function (u) {
            ((u[(u.Before = 0)] = "Before"),
              (u[(u.Active = 1)] = "Active"),
              (u[(u.NotPrimeTime = 2)] = "NotPrimeTime"),
              (u[(u.After = 3)] = "After"));
          })(p || (p = {})));
        const f = {
            playHighlight() {
          ...
          T = R.images.fun_random.gui.maps.icons.feature.asset_packs,
          y = (u, e) => ("string" == typeof e ? u.$dyn(e) : e.reduce((u, e) => u.$dyn(e), u)),
          O = {
            endDate: "DateText_endDate_53",
            base__wideSmall: "DateText_base__wideSmall_4e",
            base__thinSmall: "DateText_base__thinSmall_01",
            base__thinExtraSmall: "DateText_base__thinExtraSmall_c8",
            glowText: "DateText_glowText_1d",
            timerIcon: "DateText_timerIcon_e5",
            base__disabled: "DateText_base__disabled_3b",
          },
          S = (u) => {
          ...
          M = (u) => {
            const e = S(u),
              t = e.day,
              n = e.month;
            return D(R.strings.fun_random.entryPoint.startDate(), {
              day: t,
          ...
          x = (u) => {
            const e = S(u),
              t = e.day,
              n = e.month;
            return D(R.strings.fun_random.entryPoint.endDate(), {
              day: t,
              month: R.strings.menu.dateTime.months.$num(n + 1),
            });
          },
          k = ({ state: u, startTime: e, leftTime: t, endTime: n, currentSize: E }) => {
            const F = ((u, e, t, n) => {
              ...
              i = F[0],
              a = F[1],
              s = [p.NotPrimeTime, p.After].includes(u),
              o = r()(O[`base__${E}`], s && O.base__disabled);
            return A().createElement(
              "div",
              { className: r()(o, O.endDate, a && !s && O.glowText) },
              a && A().createElement("div", { className: O.timerIcon }),
              i,
            );
          },
          N = {
            subtitle: "SubTitle_subtitle_b2",
            base__wideSmall: "SubTitle_base__wideSmall_b6",
            base__thinSmall: "SubTitle_base__thinSmall_3c",
            base__thinExtraSmall: "SubTitle_base__thinExtraSmall_c4",
          },
          L = ({ state: u, currentSize: e }) =>
            A().createElement(
              "div",
              { className: r()(N.subtitle, N[`base__${e}`]) },
              ((u) => {
                switch (u) {
                  case p.NotPrimeTime:
                    return R.strings.fun_random.entryPoint.notPrimeTimes.status();
                  case p.After:
                    return R.strings.fun_random.entryPoint.seasonFinished.status();
                  default:
                    return "";
                }
              })(u),
          ...
          U = {
            base: "App_base_15",
            bg: "App_bg_a1",
            "zoom-in": "App_zoom-in_ad",
            "brightness-in": "App_brightness-in_85",
            base__disabled: "App_base__disabled_a2",
            "brightness-in-dis": "App_brightness-in-dis_b2",
            shadow: "App_shadow_1a",
            header: "App_header_b9",
            base__wideSmall: "App_base__wideSmall_1d",
            base__thinSmall: "App_base__thinSmall_39",
            base__thinExtraSmall: "App_base__thinExtraSmall_5c",
            hoverEffect: "App_hoverEffect_d1",
            active: "App_active_7c",
            disabled: "App_disabled_33",
            "zoom-out": "App_zoom-out_fe",
            "brightness-out": "App_brightness-out_1f",
          };
        let I;
        !(function (u) {
          ((u.Big = "big"),
        ...
        const $ = {
          ...
          z = () => {
            const u = b(),
              ...
              o = $[`${s.width}*${s.height}`],
              D = [p.NotPrimeTime, p.After].includes(F),
              B = ((u, { poFileName: e, assetsPointer: t, isSubMode: n } = {}) => {
                const A = e ? R.strings.$dyn(e) : R.strings.fun_random;
                if (!A || "string" == typeof A) throw Error("Incorrect 'poFileName' argument");
                const E = n ? "sub_modes" : "modes",
                  F = (t ? A.$dyn(E)[t] : A) || A.$dyn(E)[void 0];
                return u
                  ? { staticTexts: y(A, u), dynamicTexts: y(F, u) }
                  : { staticTexts: A, dynamicTexts: F };
              ...
              l = { backgroundImage: `url(${c.entry_point.$dyn(o)})` },
              m = {
                backgroundImage: `url(${R.images.fun_random.gui.maps.icons.feature.entry_point.hover.$dyn(`${o}_hover`)})`,
              };
            return A().createElement(
              "div",
              {
              ...
              A().createElement("div", { className: U.bg, style: l }),
              A().createElement("div", { className: U.shadow }),
              A().createElement("div", {
                className: r()(U.hoverEffect, W(F, E) && U.active, D && U.disabled),
                style: m,
              }),
        ...
        engine.whenReady.then(() => {
          F().render(A().createElement(z, null), document.getElementById("root"));
        });
      },
    },
    ...
    (__webpack_require__.O = (u, e, t, n) => {
      if (!e) {
        ...
        for (r = 0; r < deferred.length; r++) {
          for (var [e, t, n] = deferred[r], E = !0, F = 0; F < e.length; F++)
            (!1 & n || A >= n) &&
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); r < E.length; r++)
            ((A = E[r]), __webpack_require__.o(u, A) && u[A] && u[A][0](), (u[A] = 0));
