  ...
  var u,
    e = {
      ...
      6993: (u, e, t) => {
        "use strict";
        var A = {};
        (t.r(A), t.d(A, { mouse: () => p, onResize: () => h }));
        var E = {};
        (t.r(E),
          t.d(E, {
            events: () => A,
        ...
        var F = {};
        (t.r(F), t.d(F, { getBgUrl: () => w, getTextureUrl: () => S }));
        var r = {};
        (t.r(r),
          t.d(r, {
            addModelObserver: () => W,
        ...
        var D = t(6179),
          ...
          i = t.n(n),
          B = t(3282);
        const C = "App_separator_50",
          l = "App_descriptionText_dd";
        var o = t(6483),
          m = t.n(o),
          s = t(9887),
          d = t.n(s);
        ...
        const uu = Object.keys(L).reduce(
            (u, e) => ((u[e] = () => viewEnv.getShowingStatus() === L[e]), u),
            {},
          ),
          eu = {
            set: (u, e) => {
        ...
        const Du = Au.client.getSize("rem"),
          au = Du.width,
          nu = Du.height,
          iu = Object.assign({ width: au, height: nu }, ru(au, nu, Eu)),
          Bu = (0, D.createContext)(iu),
          Cu = ["children"],
          lu = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            const A = (0, D.useContext)(Bu),
              ...
              h = { extraLarge: m, large: s, medium: d, small: g, extraSmall: _ };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && i) return c(e, t, h);
              if (t.largeWidth && B) return c(e, t, h);
              if (t.mediumWidth && C) return c(e, t, h);
              if (t.smallWidth && l) return c(e, t, h);
              if (t.extraSmallWidth && o) return c(e, t, h);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, D.memo)(({ children: u }) => {
          ...
          return a().createElement(Bu.Provider, { value: r }, u);
        }),
          (function (u) {
        ...
        const vu = {
          ...
          wu = hu((u) => {
            let e = u.className,
              ...
              w =
                void 0 === S
                  ? (_ ? "flex-start" : h && "center") || (x && "flex-end") || void 0
                  : S,
              L = u.alignSelf,
              y = u.wrap,
              M = u.flexWrap,
            ...
            const j = (0, D.useMemo)(() => {
              ...
              }, [t, A, r, i, C, o, N, P, L, g, R, b, w]),
              X = j.computedStyle,
              z = j.computedClassNames;
            return a().createElement(
              "div",
              fu({ className: m()(xu.base, ...z, e), style: X }, G),
              W,
            );
          });
        let Lu;
            ...
            null === e
              ...
              : a().createElement(
                  ...
                  e.split("\n").map((e, E) =>
                    a().createElement(
                      "div",
                      { className: m()("FormatText_base_d0", t), key: `${e}-${E}` },
                      ((u, e, t) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                          t && u in t
                            ? t[u]
        ...
        const Xu = Object.keys(Nu()),
          ...
          Uu = hu((u) => {
            ...
            return a().createElement(
              ...
              ju(
                {
                  className: m()(Wu.base, t && Wu[t], x, A),
                  style: h,
        ...
        const Ju = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: A, children: E, mocks: F }) {
                        ...
                        return {
                          subscribe: (t, F) => {
                            const D = "string" == typeof F ? `${A}.${F}` : A,
                              a = Au.view.addModelObserver(D, e, !0);
                      ...
                      i = (({ observableModel: u }) => {
                        const e = { root: u.object() },
                          t = (0, Zu.computedFn)(
                            () => {
                              return (
                                (u = e.root.get().modifiers),
                                (t = (u) => ({
                                  physicalType: u.physicalType,
                                  resName: u.resName,
                                  value: u.value,
                                })),
                                Array.isArray(u)
                        ...
                        return Object.assign({}, e, { computes: { getModifierParameter: t } });
                      })({
                        mode: u,
                        readByPath: a,
                        externalModel: D,
                          ...
                          primitives: (e, t) => {
                            ...
                            }
                            {
                              const E = e,
                                F = Object.entries(E),
                                r = F.reduce(
                                  (u, [e, t]) => ((u[t] = Yu.observable.box(A[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                ...
                return (
                  (0, D.useEffect)(() => {
                    i.current ? s(n(C, A, F)) : (i.current = !0);
                  }, [F, C, A]),
                  (0, D.useEffect)(() => {
                    l(u);
                  }, [u]),
        ...
        let Ae;
        !(function (u) {
          ((u.SECONDS = "seconds"), (u.POINTS_PER_SECOND = "points_per_second"));
        })(Ae || (Ae = {}));
        const Ee = {
            [Ae.SECONDS]: R.strings.fun_random.domainTooltip.modifier.format.seconds(),
            [Ae.POINTS_PER_SECOND]:
              R.strings.fun_random.domainTooltip.modifier.format.points_per_second(),
          },
          Fe = R.strings.fun_random.domainTooltip,
          re = (0, B.observer)(() => {
            const u = ee().model.computes.getModifierParameter();
            return a().createElement(
              "div",
              { className: "App_base_33" },
              a().createElement(Uu, { className: "App_title_9f", text: Fe.title.repair_zone() }),
              a().createElement(Uu, {
                className: "App_mainText_86",
                text: Fe.description.repair_zone(),
              }),
              u.length > 0 &&
                a().createElement(
                  a().Fragment,
                  ...
                  a().createElement(
                    "div",
                    { className: "App_modifiersContainer_47" },
                    u.map((u) =>
                      a().createElement(
                        "div",
                        { key: `modifier_${u.physicalType}`, className: "App_modifiersWrapper_82" },
                        a().createElement(
                          "div",
                          { className: "App_modifiersValueWrapper_99" },
                          a().createElement(Uu, {
                            className: "App_modifiersValue_5f",
                            text: te(Ee[u.physicalType], u.value),
                          }),
                        ),
                        a().createElement(Uu, {
                          className: "App_modifiersName_85",
                          text: R.strings.battle_modifiers.modifier.name.$dyn(u.resName),
                        }),
                      ),
                    ),
                  ),
              ...
              a().createElement(Uu, { className: l, text: Fe.additionalFirst.repair_zone() }),
              a().createElement(Uu, { className: l, text: Fe.additionalSecond.repair_zone() }),
              a().createElement(Uu, { className: l, text: Fe.additionalThird.repair_zone() }),
              a().createElement(
                "div",
                { className: "App_imageWrapper_e7" },
                a().createElement("div", { className: "App_image_85" }),
              ),
            );
          });
        const De = {
        ...
        const ie = a().forwardRef(function (u, e) {
          let t = u.children,
            A = u.className,
            E = u.theme,
          ...
          return (
            ...
            a().createElement(
              "div",
              ne({}, r, {
                className: m()(De.base, De[`base__theme-${F}`], A),
                ref: function (u) {
        ...
        engine.whenReady.then(() => {
          i().render(
            a().createElement(ue, null, a().createElement(ie, null, a().createElement(re, null))),
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); n < r.length; n++)
            ((F = r[n]), A.o(u, F) && u[F] && u[F][0](), (u[F] = 0));
          return A.O(i);
        },
        t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
    })());
  var E = A.O(void 0, [503], () => A(6993));
  E = A.O(E);
})();
