(() => {
  var u,
    e = {
      ...
      1561: (u, e, A) => {
        ...
        var t = {};
        (A.r(t), A.d(t, { getBgUrl: () => c, getTextureUrl: () => h }));
        var D = {};
        (A.r(D),
          A.d(D, {
            addModelObserver: () => b,
        ...
        const uu = Q.client.getSize("rem"),
          eu = uu.width,
          Au = uu.height,
          Eu = Object.assign({ width: eu, height: Au }, J(eu, Au, Z)),
          Fu = (0, r.createContext)(Eu),
          tu = ["children"],
          Du = (u) => {
            let e = u.children,
              A = (function (u, e) {
            ...
            const E = (0, r.useContext)(Fu),
              ...
              c = { extraLarge: s, large: d, medium: g, small: _, extraSmall: h };
            if (A.extraLarge || A.large || A.medium || A.small || A.extraSmall) {
              ...
              if (A.extraLargeWidth && i) return n(e, A, c);
              if (A.largeWidth && C) return n(e, A, c);
              if (A.mediumWidth && l) return n(e, A, c);
              if (A.smallWidth && m) return n(e, A, c);
              if (A.extraSmallWidth && o) return n(e, A, c);
              if (!(
                A.extraLargeWidth ||
                A.largeWidth ||
                A.mediumWidth ||
        ...
        const ru = (0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(Fu),
            ...
            t = (0, r.useCallback)((u, e) => {
              const A = Q.view.pxToRem(u),
                E = Q.view.pxToRem(e);
              F(Object.assign({ width: A, height: E }, J(A, E, Z)));
            }, []);
          (((u) => {
          ...
          return B().createElement(Fu.Provider, { value: D }, u);
        });
        var Bu = A(6483),
          au = A.n(Bu),
          iu = A(926),
        ...
        const gu = {
          ...
          _u = {
            [mu.ExtraSmall]: "",
            [mu.Small]: nu().SMALL_HEIGHT,
            [mu.Medium]: `${nu().SMALL_HEIGHT} ${nu().MEDIUM_HEIGHT}`,
            [mu.Large]: `${nu().SMALL_HEIGHT} ${nu().MEDIUM_HEIGHT} ${nu().LARGE_HEIGHT}`,
            [mu.ExtraLarge]: `${nu().SMALL_HEIGHT} ${nu().MEDIUM_HEIGHT} ${nu().LARGE_HEIGHT} ${nu().EXTRA_LARGE_HEIGHT}`,
          },
          hu = {
            [Cu.ExtraSmall]: "",
            [Cu.Small]: nu().SMALL,
            [Cu.Medium]: `${nu().SMALL} ${nu().MEDIUM}`,
            [Cu.Large]: `${nu().SMALL} ${nu().MEDIUM} ${nu().LARGE}`,
            [Cu.ExtraLarge]: `${nu().SMALL} ${nu().MEDIUM} ${nu().LARGE} ${nu().EXTRA_LARGE}`,
          },
          cu = (u) => {
            let e = u.children,
              A = u.className,
            ...
            const F = ou(),
              ...
              D = F.mediaHeight,
              r = F.mediaSize;
            return B().createElement("div", du({ className: au()(A, gu[t], _u[D], hu[r]) }, E), e);
          },
          xu = ["children"],
          pu = (u) => {
            let e = u.children,
            ...
            return B().createElement(ru, null, B().createElement(cu, A, e));
          };
        function fu(u, e) {
        ...
        const Mu = ["xl", "lg", "md", "sm", "xs"],
          wu = (u) => u.includes("_") && ((u) => Mu.includes(u))(u.split("_").at(-1)),
          bu = [Cu.ExtraLarge, Cu.Large, Cu.Medium, Cu.Small, Cu.ExtraSmall],
          Hu = (u, e) =>
            Object.keys(u).reduce((A, E) => {
              ...
              return (
                void 0 === F ||
                  ((u, e) => Mu.some((A) => void 0 !== e[`${u}_${A}`]))(E, u) ||
                  (A[E] = F),
                A
              );
            }, {}),
          Tu = (u, e = Hu) => {
            const A = (
              (u, e = Hu) =>
              (A) => {
                const E = ou().mediaSize,
                  F = (0, r.useMemo)(() => e(A, E), [A, E]);
                return B().createElement(u, F);
              }
            )(u, e);
            return B().memo((e) =>
        ...
        const Gu = {
          ...
          Pu = Tu((u) => {
            let e = u.className,
              ...
              s = u.row,
              d = u.flexDirection,
              g = void 0 === d ? (o ? "column" : s && "row") || void 0 : d,
              _ = u.flexStart,
              h = u.center,
              c = u.flexEnd,
              x = u.spaceBetween,
              ...
              v =
                void 0 === L
                  ? (_ ? "flex-start" : h && "center") || (c && "flex-end") || void 0
                  : L,
              M = u.alignSelf,
              w = u.wrap,
              b = u.flexWrap,
              H = void 0 === b ? (w ? "wrap" : void 0) : b,
              T = u.grow,
              R = u.shrink,
              y = u.flex,
            ...
            const P = (0, r.useMemo)(() => {
                const u = { mt: D, mr: i, mb: C, ml: m },
                  e = ((u) =>
                    Wu.reduce((e, A) => {
                      const E = u[A];
                      return E && "number" != typeof E ? e.concat(Gu[!0 === E ? "MD" : E][A]) : e;
                    }, []))(u),
                  F = ((u) =>
                    Wu.reduce((e, A) => {
                      const E = u[A];
                      return ("number" == typeof E && (e[Iu[A]] = E + "rem"), e);
                    }, {}))(u);
                return {
                  computedStyle: Object.assign({}, G, F, {
                    width: void 0 !== A && "number" == typeof A ? A + "rem" : A,
                    height: void 0 !== E && "number" == typeof E ? E + "rem" : E,
                    flex: O,
                    alignSelf: M,
                    display: g || v ? "flex" : void 0,
                    flexDirection: g,
                    flexWrap: H,
                    justifyContent: S,
                    alignItems: v,
              ...
              }, [A, E, D, i, C, m, G, O, M, g, H, S, v]),
              N = P.computedStyle,
              X = P.computedClassNames;
            return B().createElement(
              "div",
              Ou({ className: au()(Ru.base, ...X, e), style: N }, I),
              W,
            );
          });
        let Nu;
        ...
        const Xu = (u, e, A) => {
          ...
          ju = (u, e, A = Nu.left) => u.split(e).reduce(A === Nu.left ? Xu : $u, []),
          zu = (() => {
            const u = new RegExp(
          ...
          Uu = ({ binding: u, text: e = "", classMix: A, alignment: E = Nu.left }) =>
            null === e
              ...
              : B().createElement(
                  ...
                  e.split("\n").map((e, F) =>
                    B().createElement(
                      "div",
                      { className: au()("FormatText_base_d0", A), key: `${e}-${F}` },
                      ((u, e, A) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                          A && u in A
                            ? A[u]
        ...
        const qu = Object.keys(Vu()),
          ...
          Fe = Tu((u) => {
            ...
            return B().createElement(
              ...
              Zu(
                {
                  className: au()(Yu.base, A && Yu[A], c, E),
                  style: h,
                  mt: !0 === a ? Ae[A || "paragraph-P16"].mt : a,
                  mr: !0 === n ? Ae[A || "paragraph-P16"].mr : n,
                  mb: !0 === l ? Ae[A || "paragraph-P16"].mb : l,
                  ml: !0 === o ? Ae[A || "paragraph-P16"].ml : o,
                },
                g,
              ),
              void 0 !== d ? B().createElement(Uu, Zu({}, d, { text: e })) : e,
            );
          }),
          te = (0, r.memo)(({ progress: u }) => {
            const e = 100 * u + "%";
            return B().createElement(
              "div",
              { className: "ProgressBar_base_8e" },
              B().createElement("div", { className: "ProgressBar_line_2c", style: { width: e } }),
            );
          }),
          De = R.strings.white_tiger.battleLoading,
          re = {
            [Z.extraSmall.width]: "s1366x768",
            [Z.small.width]: "s1366x768",
            [Z.medium.width]: "s1920x1080",
            [Z.large.width]: "s1920x1080",
            [Z.extraLarge.width]: "s2560x1440",
          },
          Be = () => {
            const u = (0, r.useState)(0),
              ...
              A = u[1],
              E = ou().mediaSize,
              F = (0, r.useMemo)(() => (model.isBoss ? "boss" : "hunter"), []),
              t = (0, r.useMemo)(() => Su.int(1, 2), []),
              D = (0, r.useMemo)(
                () => ({
                  backgroundImage: `url('R.images.white_tiger.gui.maps.icons.backgrounds.battleLoading.${re[E]}.${F}_${t}')`,
                }),
                [E, F, t],
              );
            (0, r.useEffect)(() => {
            ...
            const a = (0, r.useMemo)(() => Su.boolean(), []),
              i = (0, r.useMemo)(
                () => De.header.$dyn(F).$dyn(a ? model.vehicleName : "common"),
                [F, a],
              ),
              n = (0, r.useMemo)(
                () => De.description.$dyn(F).$dyn(a ? model.vehicleName : "common"),
                [F, a],
              );
            return B().createElement(
              "div",
              { className: "App_base_d8", style: D },
              B().createElement(Fe, { className: "App_title_4a", text: i }),
              B().createElement(Fe, { className: "App_description_3d", text: n }),
              B().createElement(
                "div",
                { className: "App_progress_df", "data-bind-progress": "{{model.progress}}" },
                B().createElement(te, { progress: e }),
              ),
            );
          };
        engine.whenReady.then(() => {
          i().render(
            B().createElement(pu, null, B().createElement(Be, null)),
  ...
  function E(u) {
    ...
    var t = (A[u] = { exports: {} });
    return (e[u].call(t.exports, t, t.exports, E), t.exports);
  }
  ((E.m = e),
    (u = []),
    (E.O = (e, A, F, t) => {
      if (!A) {
        ...
        for (i = 0; i < u.length; i++) {
          for (var [A, F, t] = u[i], r = !0, B = 0; B < A.length; B++)
    ...
    (() => {
      ...
      var e = (e, A) => {
          var F,
            ...
            a = 0;
          if (D.some((e) => 0 !== u[e])) {
            for (F in r) E.o(r, F) && (E.m[F] = r[F]);
            if (B) var i = B(E);
          }
          for (e && e(A); a < D.length; a++)
            ((t = D[a]), E.o(u, t) && u[t] && u[t][0](), (u[t] = 0));
          return E.O(i);
        },
        A = (self.webpackChunkgameface = self.webpackChunkgameface || []);
      (A.forEach(e.bind(null, 0)), (A.push = e.bind(null, A.push.bind(A))));
    })());
  var F = E.O(void 0, [503], () => E(1561));
  F = E.O(F);
})();
