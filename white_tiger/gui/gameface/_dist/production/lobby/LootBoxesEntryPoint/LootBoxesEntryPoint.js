(() => {
  var __webpack_modules__ = {
      ...
      8418: (u, e, t) => {
        ...
        const s = A.O.client.getSize("rem"),
          l = s.width,
          B = s.height,
          c = Object.assign({ width: l, height: B }, D(l, B, F)),
          ...
          m = (u) => {
            ...
            const n = (0, r.useContext)(_),
              ...
              p = { extraLarge: m, large: d, medium: h, small: g, extraSmall: w };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraSmallWidth && c) return i(e, t, p);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        const d = (0, r.memo)(({ children: u }) => {
          ...
          return n().createElement(_.Provider, { value: o }, u);
        });
        var h = t(6483),
          g = t.n(h),
          w = t(926),
        ...
        const M = {
          ...
          y = (u) => {
            ...
            const a = f(),
              ...
              i = a.mediaHeight,
              A = a.mediaSize;
            return n().createElement("div", L({ className: g()(t, M[E], T[i], O[A]) }, r), e);
          },
          P = ["children"],
          H = (u) => {
            let e = u.children,
        ...
        const W = (u) => (0 === u ? window : window.subViews.get(u)),
            ...
            return [
              function ({ mode: u = "real", options: a, children: E, mocks: i }) {
                const F = (0, r.useRef)([]),
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : i(e),
                              n = I.observable.box(r, { equals: k });
                            return (
                              "real" === u &&
                                E.subscribe(
                                  (0, I.action)((u) => n.set(u)),
                                  e,
                                ),
                              n
                            );
                  ...
                  l = s[0],
                  B = s[1],
                  c = (0, r.useState)(() => o(u, a, i)),
                  _ = c[0],
                  C = c[1];
                return (
                  (0, r.useEffect)(() => {
                    D.current ? C(o(l, a, i)) : (D.current = !0);
                  }, [i, l, a]),
                  (0, r.useEffect)(() => {
                    B(u);
                  }, [u]),
          ...
          })(0, ({ externalModel: u }) => ({ click: u.createCallbackNoArgs("onWidgetClick") })),
          U = G[0],
          j = G[1];
        var X = t(3282);
        function K(u) {
            ...
            const w = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (w.current.isVisible && w.current.timeoutId) ||
                  (z(t, B, { isMouseEvent: !0, on: !0, arguments: q(n) }, p),
                  d && d(),
                    ...
                    Object.assign(
                      {
                        onMouseEnter:
                          ...
                          (u) => {
                            (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                              ((w.current.timeoutId = window.setTimeout(v, o ? 100 : 400)),
                              a && a(u),
                              f && f(u));
                          }),
                        onMouseLeave: ((u) => (e) => {
                        ...
                        onClick: ((u) => (e) => {
                          (!1 === s && x(), null == A || A(e), null == u || u(e));
                        })(e.props.onClick),
                        onMouseDown: ((u) => (e) => {
                          (!1 === s && x(), null == i || i(e), null == u || u(e));
                        })(e.props.onMouseDown),
                      },
                      g,
                    ),
            ...
            return (
              (0, r.useEffect)(() => {
                ...
                switch (C) {
                  ...
                  case "stop":
                    return (function () {
                      const u = 0 === D && h ? { path: h, x: 0, y: 0 } : a(D),
                        e = new Image();
                      e.src = u.path;
                      const r = () => t(eu(u, e));
                      return (
              ...
              n().createElement("canvas", Q({}, g, { width: e, height: t, ref: w }))
            );
          }),
          uu = (u, e) => {
            let t = u;
        ...
        (!(function (u) {
          ...
          ru.BOSS_2025,
          ru.BOSS_SPECIAL);
        const au = { Hunter: nu.HUNTER, Boss: nu.BOSS, Tank: nu.TANK };
        function Eu(u) {
          const e = u.chunk,
            t = e.rows * e.columns;
          return (r) => {
        ...
        const iu = 96,
          Au = {
            ...
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_276x212",
          },
          Fu = {
            width: 276,
            height: 212,
            ...
            chunk: { count: 1, rows: 12, columns: 8 },
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_276x212_active",
          },
          ou = {
            width: 240,
            height: 180,
            ...
            chunk: { count: 1, rows: 12, columns: 8 },
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_240x180",
          },
          Du = {
            width: 240,
            height: 180,
            ...
            chunk: { count: 1, rows: 12, columns: 8 },
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_240x180_active",
          },
          su = {
            width: 152,
            height: 120,
            ...
            chunk: { count: 1, rows: 12, columns: 8 },
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_152x120",
          },
          lu = {
            width: 152,
            height: 120,
            ...
            chunk: { count: 1, rows: 12, columns: 8 },
            getChunkPath: () =>
              "R.images.white_tiger.gui.maps.icons.entryBoxPoint.fx.sequence_152x120_active",
          };
        var Bu = t(9887),
          cu = t.n(Bu);
        const _u = ["xl", "lg", "md", "sm", "xs"],
          Cu = (u) => u.includes("_") && ((u) => _u.includes(u))(u.split("_").at(-1)),
          mu = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
          du = (u, e) =>
            Object.keys(u).reduce((t, r) => {
              ...
              return (
                void 0 === n ||
                  ((u, e) => _u.some((t) => void 0 !== e[`${u}_${t}`]))(r, u) ||
                  (t[r] = n),
                t
              );
            }, {}),
        ...
        const vu = {
          ...
          fu = hu((u) => {
            let e = u.className,
              ...
              _ = u.row,
              C = u.flexDirection,
              m = void 0 === C ? (c ? "column" : _ && "row") || void 0 : C,
              d = u.flexStart,
              h = u.center,
              w = u.flexEnd,
              p = u.spaceBetween,
              ...
              S =
                void 0 === f
                  ? (d ? "flex-start" : h && "center") || (w && "flex-end") || void 0
                  : f,
              L = u.alignSelf,
              M = u.wrap,
              T = u.flexWrap,
              ...
              y = u.shrink,
              P = u.flex,
              H = void 0 === P ? (R || y ? `${R ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : P,
              k = u.style,
              I = u.children,
              N = (function (u, e) {
                if (null == u) return {};
            ...
            const W = (0, r.useMemo)(() => {
              ...
              }, [t, a, A, o, s, B, k, H, L, m, O, b, S]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return n().createElement(
              "div",
              pu({ className: g()(gu.base, ...U, e), style: G }, N),
              I,
            );
          });
        let Su;
        ...
        const Lu = (u, e, t) => {
          ...
          Tu = (u, e, t = Su.left) => u.split(e).reduce(t === Su.left ? Lu : Mu, []),
          Ou = (() => {
            const u = new RegExp(
          ...
          yu = ({ binding: u, text: e = "", classMix: t, alignment: a = Su.left }) =>
            null === e
        ...
        const Wu = Object.keys(Hu()),
          ...
          Vu = hu((u) => {
            ...
            return n().createElement(
              ...
              Nu(
                {
                  className: g()(ku.base, t && ku[t], w, a),
                  style: h,
              ...
              void 0 !== C ? n().createElement(yu, Nu({}, C, { text: e })) : e,
            );
          }),
          $u = {
            base: "Key_base_3b",
            base__second: "Key_base__second_97",
            keyImage: "Key_keyImage_c9",
            count: "Key_count_17",
            flareWrapper: "Key_flareWrapper_c2",
            flare: "Key_flare_7a",
            "flare-animation": "Key_flare-animation_ec",
          },
          qu = R.strings.lootboxes.wtEntryPoint,
          zu = R.images.white_tiger.gui.maps.icons.entryBoxPoint,
          Yu = (0, r.memo)(({ name: u, boxesCount: e, isSecond: t = !1, hasNew: r = !1 }) => {
            const a = u === au.Boss,
              E = ((u, e) => (e > 0 ? zu.$dyn(u) : zu.$dyn(u + "_empty")))(u, e),
              i = { backgroundImage: `url(${E})` },
              A = { maskImage: `url(${E})` },
              F = e > 999 ? "999+" : e,
              o = g()($u.base, t && $u.base__second, a && $u.base__boss);
            return n().createElement(
              "div",
              { className: o },
              n().createElement(
                "div",
                { className: $u.keyImage, style: i },
                e > 0 &&
                  n().createElement(Vu, {
                    className: $u.count,
                    text: qu.count(),
              ...
              r &&
                n().createElement(
                  "div",
                  { className: $u.flareWrapper, style: A },
                  n().createElement("div", { className: $u.flare }),
                ),
            );
          }),
          Zu = (0, X.observer)(() => {
            const u = j(),
              ...
              t = u.controls,
              a = e.root.get(),
              E = a.hunterLootBoxesCount,
              i = a.bossLootBoxesCount,
              F = a.hunterHasNew,
              o = a.bossHasNew,
              D = (0, r.useRef)(null),
              s = f().mediaSize,
              l = ((u) => {
                switch (u) {
                  case v.ExtraSmall:
                  case v.Small:
                    return { width: su.width, height: su.height };
                  case v.Medium:
                  case v.Large:
                    return { width: ou.width, height: ou.height };
                  default:
                    return { width: Au.width, height: Au.height };
                }
              })(s),
              B = (0, r.useMemo)(
                () =>
            ...
            return (
                            ...
                            (e = (() => {
                              if (D.current) {
                                const u = D.current.getBoundingClientRect(),
                                  e = A.O.view.getSize("rem"),
                                  t = (e.width - A.O.view.pxToRem(u.width)) / 2,
                                  r = (e.height - A.O.view.pxToRem(u.height)) / 2;
              ...
              n().createElement(
                ...
                n().createElement(J, {
                  ...
                  frameCount: iu,
                  loop: !0,
                  className: "App_sequence_c2",
                }),
                n().createElement(
                  "div",
                  { className: "App_keys_e1" },
                  n().createElement(Yu, { name: au.Hunter, boxesCount: E, hasNew: F }),
                  n().createElement(Yu, { name: au.Boss, boxesCount: i, isSecond: !0, hasNew: o }),
                ),
                n().createElement(
                  Y,
                  { contentId: R.views.white_tiger.lobby.tooltips.LootBoxesTooltipView("resId") },
                  n().createElement("div", {
                    ref: D,
                    className: "App_inputArea_bb",
                    onClick: t.click,
                    onMouseEnter: () => {
                      K("ev_white_tiger_hangar_lootbox_rollover");
                    },
                    onMouseLeave: () => {
                      K("ev_white_tiger_hangar_lootbox_rollout");
                    },
                  }),
                ),
              )
        ...
        engine.whenReady.then(() => {
          E().render(
            n().createElement(U, null, n().createElement(H, null, n().createElement(Zu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(8418));
