(() => {
  var __webpack_modules__ = {
      ...
      3400: (u, e, t) => {
            ...
            const p = (0, r.useRef)({
              ...
              b = (0, r.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (G(t, _, { isMouseEvent: !0, on: !0, arguments: W(n) }, v),
                  d && d(),
        ...
        class q extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              l = g()($.base, $[`base__${a}`], $[`base__${E}`], null == i ? void 0 : i.base),
              _ = g()($.icon, $[`icon__${a}`], $[`icon__${E}`], null == i ? void 0 : i.icon),
              B = g()($.glow, null == i ? void 0 : i.glow),
              c = g()($.caption, $[`caption__${a}`], null == i ? void 0 : i.caption),
              C = g()($.goto, null == i ? void 0 : i.goto);
            return n().createElement(
              "div",
              Y(
                {
              ...
              "info" !== a && n().createElement("div", { className: $.shine }),
              n().createElement(
                "div",
                { className: _ },
        ...
        const iu = {
          ...
          ou = ru((u) => {
            ...
            const W = (0, r.useMemo)(() => {
              ...
              }, [t, E, A, o, s, _, k, P, L, m, O, x, M]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return n().createElement(
              "div",
              au({ className: g()(nu.base, ...U, e), style: G }, N),
              I,
            );
          });
        let Du;
        ...
        const su = (u, e, t) => {
          ...
          _u = (u, e, t = Du.left) => u.split(e).reduce(t === Du.left ? su : lu, []),
          Bu = (() => {
            const u = new RegExp(
          ...
          Cu = ({ binding: u, text: e = "", classMix: t, alignment: E = Du.left }) =>
            null === e
        ...
        const vu = Object.keys(du()),
          ...
          Lu = ru((u) => {
            ...
            return n().createElement(
              ...
              pu(
                {
                  className: g()(hu.base, t && hu[t], p, E),
                  style: h,
        ...
        const Ru = (u) => (0 === u ? window : window.subViews.get(u)),
          yu = ((u, e) => {
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : i(e),
                              n = Tu.observable.box(r, { equals: Su });
                            return (
                              "real" === u &&
                                a.subscribe(
            ...
            onAboutClicked: u.createCallbackNoArgs("onAboutClicked"),
          })),
          Hu = yu[0],
          Pu = yu[1],
          ku = {
            base: "App_base_a7",
            infoButton: "App_infoButton_79",
            ...
            member__hunter_4: "App_member__hunter_4_17",
            type: "App_type_d1",
            name: "App_name_27",
            description: "App_description_c0",
            perk: "App_perk_07",
          },
          Iu = R.strings.white_tiger,
          Nu = (0, k.observer)(() => {
            const u = Pu(),
              e = u.model,
              t = u.controls,
              ...
              A = E.tankmanID,
              F = E.invID,
              o = Iu.crewPanel.role.$dyn(A),
              D = Iu.crewPanel.slogan.$dyn(A),
              s = (0, r.useMemo)(() => ({ tooltipId: "crewPerkGf", invID: F }), [F]),
              l = g()(ku.member, ku[`member__${A}`]);
            return n().createElement(
              "div",
              { className: ku.base },
              n().createElement(
                "div",
                { className: ku.infoButton },
                n().createElement(q, {
                  caption: Iu.hangar.about(),
                  type: "info",
              ...
              n().createElement(
                ...
                n().createElement(
                  ...
                  n().createElement(Lu, { className: ku.type, text: o }),
                  n().createElement(Lu, { className: ku.name, text: a }),
                  n().createElement(Lu, { className: ku.description, text: D }),
                  i &&
                    n().createElement(
                      V,
                      { args: s },
                      n().createElement("div", { className: ku.perk }),
                    ),
                ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          a().render(
            n().createElement(Hu, null, n().createElement(P, null, n().createElement(Nu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3400));
