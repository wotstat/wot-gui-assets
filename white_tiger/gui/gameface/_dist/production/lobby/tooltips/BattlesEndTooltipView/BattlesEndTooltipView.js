(() => {
  var __webpack_modules__ = {
      ...
      2121: (u, e, t) => {
        ...
        const B = E().forwardRef(function (u, e) {
          ...
          return (
            ...
            E().createElement(
              "div",
              l({}, B, {
                className: n()(D.base, D[`base__theme-${F}`], a),
                ref: function (u) {
        ...
        const C = (u, e, t) => {
          ...
          c = (u, e, t = _.left) => u.split(e).reduce(t === _.left ? C : m, []),
          d = (() => {
            const u = new RegExp(
        ...
        const M = i.O.client.getSize("rem"),
          O = M.width,
          L = M.height,
          y = Object.assign({ width: O, height: L }, S(O, L, f)),
          P = (0, r.createContext)(y),
          H = ["children"],
          N = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && D) return w(e, t, h);
              if (t.largeWidth && o) return w(e, t, h);
              if (t.mediumWidth && l) return w(e, t, h);
              if (t.smallWidth && B) return w(e, t, h);
              if (t.extraSmallWidth && s) return w(e, t, h);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(P),
            ...
            F = (0, r.useCallback)((u, e) => {
              ...
              A(Object.assign({ width: t, height: r }, S(t, r, f)));
            }, []);
          (((u) => {
          ...
          return E().createElement(P.Provider, { value: n }, u);
        }),
          (function (u) {
        ...
        const U = ["xl", "lg", "md", "sm", "xs"],
          ...
          j = [k.ExtraLarge, k.Large, k.Medium, k.Small, k.ExtraSmall],
          K = (u, e) =>
        ...
        const q = {
          ...
          Q = X((u) => {
            ...
            const I = (0, r.useMemo)(() => {
              ...
              }, [t, a, i, o, B, _, N, H, S, d, L, w, T]),
              U = I.computedStyle,
              G = I.computedClassNames;
            return E().createElement("div", z({ className: n()(Y.base, ...G, e), style: U }, W), k);
          }),
          J = ({ binding: u, text: e = "", classMix: t, alignment: a = _.left }) =>
            null === e
        ...
        const au = Object.keys(eu()),
          ...
          ou = X((u) => {
            ...
            return E().createElement(
              ...
              Eu(
                {
                  className: n()(tu.base, t && tu[t], p, a),
                  style: g,
                  mt: !0 === D ? iu[t || "paragraph-P16"].mt : D,
                  mr: !0 === l ? iu[t || "paragraph-P16"].mr : l,
                  mb: !0 === s ? iu[t || "paragraph-P16"].mb : s,
                  ml: !0 === C ? iu[t || "paragraph-P16"].ml : C,
                },
                d,
              ),
              void 0 !== c ? E().createElement(J, Eu({}, c, { text: e })) : e,
            );
          }),
          lu = {
          ...
          su = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
          _u = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
          Cu = (0, r.memo)(({ text: u, binding: e, classMix: t }) => {
                ...
                ((n = n.replace(t, `%(${F})`)),
                  (A[F] = lu[u]
                    ? E().createElement(
                        "span",
                        { className: lu[u] },
                        E().createElement(J, { text: o, binding: e }),
                      )
                    : E().createElement(
                        "span",
                        { style: a(u) },
            ...
            return E().createElement(J, { text: n, classMix: t, binding: A });
          });
        function mu() {
          return !1;
        }
        ...
        const hu = (u) => (0 === u ? window : window.subViews.get(u)),
          gu = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: a, children: A, mocks: F }) {
                const n = (0, r.useRef)([]),
                  D = (u, t, r) => {
                    var E;
                    const a = (function ({
                        ...
                        return {
                          subscribe: (t, a) => {
                            const F = "string" == typeof a ? `${r}.${a}` : r,
                              n = i.O.view.addModelObserver(F, e, !0);
                      ...
                      o = (({ observableModel: u }) => {
                        const e = Object.assign({}, u.primitives(["endDate"]));
                  ...
                  B = l[0],
                  s = l[1],
                  _ = (0, r.useState)(() => D(u, a, F)),
                  C = _[0],
                  m = _[1];
                return (
                  (0, r.useEffect)(() => {
                    o.current ? m(D(B, a, F)) : (o.current = !0);
                  }, [F, B, a]),
                  (0, r.useEffect)(() => {
                    s(u);
                  }, [u]),
          ...
          pu = gu[0],
          xu = gu[1],
          vu = R.strings.tooltips.WtEventBattlesEndTooltipView,
          bu = (0, s.observer)(() => {
            const u = xu().model.endDate.get();
            return E().createElement(
              "div",
              { className: "Content_base_28" },
              E().createElement(ou, { text: vu.title(), className: "Content_title_f1" }),
              E().createElement(ou, {
                text: vu.description(),
                className: "Content_description_b1",
              }),
              E().createElement("div", { className: "Content_divider_90" }),
              E().createElement(Cu, {
                classMix: "Content_portals_d5",
                text: vu.portals(),
                binding: { date: x(u, g.FULL_DATE_TIME, !0) },
              }),
            );
          }),
          wu = () => E().createElement(B, null, E().createElement(bu, null));
        engine.whenReady.then(() => {
          A().render(
            E().createElement(pu, null, E().createElement(wu, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2121));
