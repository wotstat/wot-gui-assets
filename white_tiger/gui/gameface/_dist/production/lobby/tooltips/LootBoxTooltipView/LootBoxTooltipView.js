(() => {
  var __webpack_modules__ = {
      ...
      1645: (u, e, t) => {
                  ...
                  l = (u, t, r) => {
                    ...
                    const a = (function ({
                      ...
                      A = (({ observableModel: u }) => {
                        const e = {
                            root: u.object(),
                            vehicleNames: u.array("vehicleNames", []),
                            bonuses: u.array("bonuses", []),
                          },
                          t = (0, g.computedFn)(() => C(e.bonuses.get()), { equals: D }),
                          r = (0, g.computedFn)(() => C(e.vehicleNames.get()), { equals: D });
                        return Object.assign({}, e, {
                          computes: { getVehicles: r, getBonuses: t },
                        });
                      })({
                        mode: u,
                        readByPath: s,
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : s(e),
                              n = _.observable.box(r, { equals: D });
                            return (
                              "real" === u &&
                                i.subscribe(
                                  (0, _.action)((u) => n.set(u)),
                                  e,
                                ),
                              n
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const n = e.reduce(
                                (u, e) => ((u[e] = _.observable.box(r[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const n = e,
                                a = Object.entries(n),
                                s = a.reduce(
                                  (u, [e, t]) => ((u[t] = _.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
        ...
        const w = (u, e, t) => {
          ...
          S = (u, e, t = v.left) => u.split(e).reduce(t === v.left ? w : f, []),
          x = (() => {
            const u = new RegExp(
          ...
          T = ["zh_cn", "zh_sg", "zh_tw"],
          P = ({ binding: u, text: e = "", classMix: t, alignment: a = v.left }) =>
            null === e
        ...
        const U = E.O.client.getSize("rem"),
          H = U.width,
          G = U.height,
          W = Object.assign({ width: H, height: G }, I(H, G, N)),
          X = (0, r.createContext)(W),
          j = ["children"],
          q = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && l) return L(e, t, g);
              if (t.largeWidth && A) return L(e, t, g);
              if (t.mediumWidth && F) return L(e, t, g);
              if (t.smallWidth && c) return L(e, t, g);
              if (t.extraSmallWidth && D) return L(e, t, g);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(X),
            ...
            s = (0, r.useCallback)((u, e) => {
              ...
              i(Object.assign({ width: t, height: r }, I(t, r, N)));
            }, []);
          (((u) => {
          ...
          return n().createElement(X.Provider, { value: o }, u);
        }),
          (function (u) {
        ...
        const V = ["xl", "lg", "md", "sm", "xs"],
          ...
          Q = [Y.ExtraLarge, Y.Large, Y.Medium, Y.Small, Y.ExtraSmall],
          Z = (u, e) =>
        ...
        const ru = {
          ...
          iu = J((u) => {
            ...
            const H = (0, r.useMemo)(() => {
              ...
              }, [t, a, E, A, c, _, k, N, T, C, y, f, x]),
              G = H.computedStyle,
              W = H.computedClassNames;
            return n().createElement(
              "div",
              tu({ className: o()(uu.base, ...W, e), style: G }, U),
              I,
            );
          });
        var su = t(3532),
        ...
        const Fu = Object.keys(ou()),
          ...
          du = J((u) => {
            ...
            return n().createElement(
              ...
              Au(
                {
                  className: o()(Eu.base, t && Eu[t], h, a),
                  style: p,
                  mt: !0 === l ? mu[t || "paragraph-P16"].mt : l,
                  mr: !0 === F ? mu[t || "paragraph-P16"].mr : F,
                  mb: !0 === D ? mu[t || "paragraph-P16"].mb : D,
                  ml: !0 === m ? mu[t || "paragraph-P16"].ml : m,
                },
                C,
              ),
              void 0 !== d ? n().createElement(P, Au({}, d, { text: e })) : e,
            );
          });
        var Cu = t(4179);
        const gu = [
            ...
            const h = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (hu(t, D, { isMouseEvent: !0, on: !0, arguments: pu(n) }, b),
                  C && C(),
        ...
        const yu = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return n().createElement(Ru, e, r);
          const a = e.contentId,
            i = e.args,
            s = null == i ? void 0 : i.contentId;
          return a || s
            ? n().createElement(bu, Pu({}, e, { contentId: a || s }), r)
            : n().createElement(fu, e, r);
        };
        let Ou, Mu, Lu, Nu, ku, Iu, Uu, Hu, Gu;
        var Wu;
        (!(function (u) {
          ((u.Items = "items"),
        ...
        const qu = ["engravings", "backgrounds"],
          ...
          $u = (u, e = Lu.Small) => {
            ...
            switch (t) {
              ...
              case Ou.LbStyleProgress:
                return zu(a, e, Gu.ProgressionStyle);
              default:
          ...
          Ku = ({
            ...
            return n().createElement(
              "div",
              { className: o()(Vu.base, Vu[`base__${r}`], l), style: E },
              n().createElement(
                yu,
                ...
                n().createElement(
                  ...
                  n().createElement(
                    "div",
                    { className: o()(Vu.image, null == A ? void 0 : A.image) },
                    D &&
                      n().createElement("div", {
                        className: o()(Vu.highlight, null == A ? void 0 : A.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: o()(Vu.icon, null == A ? void 0 : A.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      n().createElement("div", {
                        className: o()(Vu.overlay, null == A ? void 0 : A.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: c },
                  n().createElement("div", {
                    className: o()(Vu.timer, null == A ? void 0 : A.periodicIcon),
                  }),
                ),
            );
          };
        ...
        !(function (u) {
          ((u.Gold = "gold"),
            ...
            (u.PersonalBook = "personalBook"));
        })(Zu || (Zu = {}));
        const Ju = (u, e) => (u === Zu.PremiumPlus ? { name: "premium_plus_universal" } : e),
          ue = [Zu.Gold, Zu.Credits, Zu.FreeXP, Zu.Style3d, Zu.Style, Zu.PersonalBook],
          ee = [Zu.Crystal, Zu.Gold, Zu.Credits, Zu.PremiumPlus, Zu.Style, Zu.WtEventTicket],
          te = {
            base: "Content_base_7e",
            title: "Content_title_7d",
            icon: "Content_icon_f4",
            icon__hunter: "Content_icon__hunter_fe",
            specialSlotWrapper: "Content_specialSlotWrapper_92",
            vehicleImg: "Content_vehicleImg_37",
            vehicleNames: "Content_vehicleNames_43",
            wrapper: "Content_wrapper_13",
            subtitle: "Content_subtitle_91",
            subtitle__vehicles: "Content_subtitle__vehicles_a4",
            description: "Content_description_ba",
            rewardItemWrapper: "Content_rewardItemWrapper_dd",
            rewardsWrapper: "Content_rewardsWrapper_65",
            separator: "Content_separator_aa",
          };
        function re() {
          return (
            (re =
        ...
        const ne = R.strings.event.lootBoxTooltip,
          ae = (u, e) => (e ? u.hunter() : u.boss()),
          ie = (0, y.observer)(() => {
            const u = b().model,
              e = u.root.get().isHunterLootBox,
              t = u.computes.getBonuses(),
              r = u.computes.getVehicles(),
              a = ((u, e) => {
                const t = e ? [...new Set(ee)] : [...new Set(ue)],
                  r = new Map();
                for (
                  var n,
                    a = (function (u, e) {
                ...
                for (var s = 0, o = t; s < o.length; s++) {
                  const u = o[s],
                    e = r.get(u);
                  if (u !== Zu.PremiumPlus && !e) continue;
                  const t = Ju(u, e);
                  i.push({ name: u, image: $u(t, Lu.Big) });
                }
                return i.slice(0, 6);
              })(t, e),
              i = o()(te.icon, e && te.icon__hunter);
            return n().createElement(
              "div",
              { className: te.base },
              n().createElement(du, { className: te.title, text: ae(ne.title, e) }),
              n().createElement("div", { className: i }),
              n().createElement(
                "div",
                { className: te.wrapper },
                n().createElement("div", { className: te.subtitle }, ne.howItWorks.title()),
                n().createElement(
                  "div",
                  { className: te.description },
                  ae(ne.howItWorks.description, e),
                ),
              ),
              n().createElement(
                "div",
                { className: te.wrapper },
                n().createElement(P, { classMix: te.subtitle, text: ae(ne.howToGet.title, e) }),
                n().createElement(P, {
                  classMix: te.description,
                  text: ae(ne.howToGet.description, e),
                }),
              ),
              n().createElement(
                "div",
                { className: te.wrapper },
                n().createElement(P, {
                  classMix: o()(te.subtitle, te.subtitle__vehicles),
                  text: ae(ne.whatInside.title, e),
                }),
                !e &&
                  n().createElement(
                    "div",
                    { className: te.specialSlotWrapper },
                    n().createElement("div", { className: te.vehicleImg }),
                    n().createElement(du, { text: r.join(", "), className: te.vehicleNames }),
                  ),
                n().createElement("div", { className: te.separator }),
                n().createElement(
                  "div",
                  { className: te.rewardsWrapper },
                  a.map((u, e) =>
                    n().createElement(
                      "div",
                      { className: te.rewardItemWrapper, key: e },
                      n().createElement(Ku, re({ size: Lu.S48x48, className: te.reward }, u)),
                    ),
                  ),
                ),
                n().createElement(du, { text: ne.otherRewards(), className: te.description }),
              ),
            );
          }),
          se = () => n().createElement(c, null, n().createElement(ie, null));
        engine.whenReady.then(() => {
          i().render(
            n().createElement(h, null, n().createElement(se, null)),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1645));
