(() => {
  var __webpack_modules__ = {
      ...
      6933: (u, e, t) => {
        ...
        const F = n().forwardRef(function (u, e) {
          let t = u.children,
            a = u.className,
            i = u.theme,
          ...
          return (
            ...
            n().createElement(
              "div",
              c({}, F, {
                className: o()(l.base, l[`base__theme-${s}`], a),
                ref: function (u) {
            ...
            return (
              d(() => {
                if (
                          ...
                          const e = _(),
                            ...
                            n =
                              window.__feature && window.__feature !== t && t
                                ? `subViews.${t}`
                                : "";
                          return { modelPrefix: n, modelPath: g(n, ""), resId: r };
                        })(),
                        t = e.modelPrefix,
                        r = u.split(".");
                      if (r.length > 0) {
                  ...
                  c.current = p.addCallback(r, t, s, e === h.Deep);
                }
              }),
              (0, r.useEffect)(() => {
                if (e !== h.None)
                  return () => {
                    p.removeCallback(c.current, s);
                  };
              }, [s, e]),
              l
            );
        ...
        const v = (u, e, t = {}, r = 0) => {
          ...
          S = (u) => {
            ...
            const b = (0, r.useRef)({
              ...
              S = (0, r.useMemo)(() => C || _().resId, [C]),
              x = (0, r.useCallback)(() => {
                (b.current.isVisible && b.current.timeoutId) ||
                  (v(t, m, { isMouseEvent: !0, on: !0, arguments: w(n) }, S),
                  g && g(),
                    ...
                    Object.assign(
                      {
                        ...
                        onClick: ((u) => (e) => {
                          (!1 === c && R(), null == o || o(e), null == u || u(e));
                        })(e.props.onClick),
                        onMouseDown: ((u) => (e) => {
                          (!1 === c && R(), null == s || s(e), null == u || u(e));
                        })(e.props.onMouseDown),
                      },
                      h,
                    ),
              ...
              M(
                {
                  contentId:
                    ...
                    A ? y.SimpleTooltipHtmlContent("resId") : y.SimpleTooltipContent("resId")),
        ...
        const k = ({ children: u, tooltipArgs: e, className: t }) => {
          ...
          if (e.header || e.body) return n().createElement(L, e, r);
          const a = e.contentId,
            i = e.args,
            s = null == i ? void 0 : i.contentId;
          return a || s
            ? n().createElement(S, N({}, e, { contentId: a || s }), r)
            : n().createElement(P, e, r);
        };
        let I, U, H, G, W, $, X, z, j;
        var Y, q, V;
        (((V = I || (I = {})).Items = "items"),
          ...
          (V.PostStamp = "giftsystem_5_stamp"),
          (V.Quests = "quests"),
          (V.ArmoryCoin = "armory_coin"),
          (V.PremiumPlusUniversal = "premium_plus_universal"),
          (V.DogTagType = "dogTagComponents"),
          (V.GoldenTicket = "goldenticket"),
          (V.LbStyleProgress = "lbStyleProgress"),
          (V.RewardsSlots = "rewardsSlots"),
          (V.WtStamp = "stamp"),
          (V.WtHunter = "wt_hunter"),
          (V.WtBoss = "wt_boss"),
          (V.WtHunterCollection = "hunter_collection"),
          (V.WtTicket = "wtevent_ticket"),
          (V.WtMainPrizeDiscount = "main_prize_discount"),
          (V.WtTicket25 = "wtevent_ticket25"),
          (function (u) {
            ((u.Gold = "gold"),
              (u.Credits = "credits"),
              (u.Crystal = "crystal"),
        ...
        const Q = [
          ...
          Z = [I.Gold, I.Credits, I.Crystal, I.FreeXp],
          J = [I.BattlePassPoints],
          uu = [I.PremiumPlus, I.Premium];
        let eu;
        !(function (u) {
          ((u.s16 = "16"),
            (u.s32 = "32"),
        ...
        const tu = ["engravings", "backgrounds"],
          ...
          iu = ({
            ...
            const m = ((u) => {
              ...
              D = ((u, e) => {
                ...
                switch (e) {
                  ...
                  case G.CURRENCY:
                  case G.NUMBER:
                    return n().createElement(K, { format: "integral", value: Number(u) });
                  case G.PREMIUM_PLUS: {
                    const e = Number(u);
            ...
            return n().createElement(
              "div",
              { className: o()(au.base, au[`base__${r}`], l), style: E },
              n().createElement(
                k,
                { tooltipArgs: c, className: au.tooltipWrapper },
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(
                    "div",
                    { className: o()(au.image, null == A ? void 0 : A.image) },
                    m &&
                      n().createElement("div", {
                        className: o()(au.highlight, null == A ? void 0 : A.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: o()(au.icon, null == A ? void 0 : A.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      n().createElement("div", {
                        className: o()(au.overlay, null == A ? void 0 : A.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: F },
                  n().createElement("div", {
                    className: o()(au.timer, null == A ? void 0 : A.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const Eu = (u, e, t) => {
          ...
          Au = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? Eu : lu, []),
          cu = (() => {
            const u = new RegExp(
          ...
          mu = ({ binding: u, text: e = "", classMix: t, alignment: a = su.left }) =>
            null === e
        ...
        const Bu = ({ size: u = Du.Default, classMix: e }) =>
            n().createElement("div", { className: o()(_u.background, _u[`background__${u}`], e) }),
          Cu = {
          ...
          hu = (0, r.memo)(
            ({
              ...
              return n().createElement(
                ...
                E && n().createElement(gu, { size: u }),
              );
            },
          ),
          bu = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
        ...
        const Su = (0, r.memo)(
          ...
          Ou = (0, r.memo)(
            ({
              ...
              const h = (0, r.useMemo)(
                  () => Object.assign({ width: "100%" }, Pu(u), Ru(c)),
                  [c, u],
                ),
                b = (0, r.useMemo)(() => Object.assign({ width: "0%" }, Pu(u), Ru(c)), [c, u]),
                f = (0, r.useMemo)(
                  () => Object.assign({ width: "0%" }, Tu(c, a), Pu(u)),
                  [a, c, u],
                ),
                w = (0, r.useMemo)(
                  () => Object.assign({ width: `${Math.abs(s - a)}%` }, Tu(c, a), Pu(u)),
                  [a, c, s, u],
                );
              if (D) return null;
              const v = o()(
        ...
        const Nu = (0, r.memo)((u) => {
            ...
            switch (a.animationSettings.type) {
              case du.Simple:
                return n().createElement(xu, Lu({}, a, { onEndAnimation: E, isComplete: s }));
              case du.Growing:
                return n().createElement(Mu, Lu({}, a, { onEndAnimation: E, isComplete: s }));
              default:
                return null;
            }
          }),
        ...
        const Uu = (0, r.memo)((u) => {
          ...
          return (
            (a.current.from = s),
            n().createElement(Nu, Iu({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
          );
        });
        function Hu() {
          return (
        ...
        const Gu = (0, r.memo)(
            ({
              ...
              return i.withStack
                ? n().createElement(Uu, l)
                : n().createElement(Nu, Hu({ key: `${a}-${e}` }, l));
            },
          ),
          Wu = (u) => ({
          ...
          zu = (u, e, t) => ("number" == typeof t ? (Xu(0, e, t) / e) * 100 : u),
          ju = {
            bgImageBase: "R.images.gui.maps.icons.components.progress_bar.pattern_grey",
            line: {
              bgColorBase: "#f50",
          ...
          qu = (0, r.memo)(
            ({
              ...
              const D = ((u, e, t) =>
                (0, r.useMemo)(() => {
                  const r = (Xu(0, e, u) / e) * 100;
                  return { value: r, deltaFrom: zu(r, e, t) };
                }, [t, e, u]))(l, u, A);
              return n().createElement(
                "div",
                { className: o()(_u.base, _u[`base__${t}`]), style: Wu(e) },
                !s && n().createElement(Bu, { size: t, classMix: E }),
                n().createElement(Gu, {
                  size: t,
                  lineRef: c,
                  disabled: i,
        ...
        const ee = E.O.client.getSize("rem"),
          te = ee.width,
          re = ee.height,
          ne = Object.assign({ width: te, height: re }, ue(te, re, Zu)),
          ae = (0, r.createContext)(ne),
          ie = ["children"],
          se = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && l) return Qu(e, t, g);
              if (t.largeWidth && A) return Qu(e, t, g);
              if (t.mediumWidth && c) return Qu(e, t, g);
          ...
          (0, r.memo)(({ children: u }) => {
            const e = (0, r.useContext)(ae),
              ...
              s = (0, r.useCallback)((u, e) => {
                ...
                i(Object.assign({ width: t, height: r }, ue(t, r, Zu)));
              }, []);
            (d(() => {
            ...
            return n().createElement(ae.Provider, { value: o }, u);
          }),
          ((Ae = oe || (oe = {}))[(Ae.ExtraSmall = Zu.extraSmall.width)] = "ExtraSmall"),
          (Ae[(Ae.Small = Zu.small.width)] = "Small"),
          (Ae[(Ae.Medium = Zu.medium.width)] = "Medium"),
          (Ae[(Ae.Large = Zu.large.width)] = "Large"),
          (Ae[(Ae.ExtraLarge = Zu.extraLarge.width)] = "ExtraLarge"),
          (function (u) {
            ((u[(u.ExtraSmall = Zu.extraSmall.width)] = "ExtraSmall"),
              (u[(u.Small = Zu.small.width)] = "Small"),
              (u[(u.Medium = Zu.medium.width)] = "Medium"),
              (u[(u.Large = Zu.large.width)] = "Large"),
              (u[(u.ExtraLarge = Zu.extraLarge.width)] = "ExtraLarge"));
          })(Ee || (Ee = {})),
          (function (u) {
            ((u[(u.ExtraSmall = Zu.extraSmall.height)] = "ExtraSmall"),
              (u[(u.Small = Zu.small.height)] = "Small"),
              (u[(u.Medium = Zu.medium.height)] = "Medium"),
              (u[(u.Large = Zu.large.height)] = "Large"),
              (u[(u.ExtraLarge = Zu.extraLarge.height)] = "ExtraLarge"));
          })(le || (le = {})));
        const ce = ["xl", "lg", "md", "sm", "xs"],
          Fe = (u) => u.includes("_") && ((u) => ce.includes(u))(u.split("_").at(-1)),
          ...
          De = (u, e = _e) => {
            ...
            return n().memo((e) =>
              Object.keys(e).some((u) => Fe(u) && void 0 !== e[u])
                ? n().createElement(t, e)
                : n().createElement(u, e),
            );
          },
        ...
        const ge = {
          ...
          be = De((u) => {
            ...
            const H = (0, r.useMemo)(() => {
              ...
              }, [t, a, E, A, F, _, k, N, R, C, O, v, x]),
              G = H.computedStyle,
              W = H.computedClassNames;
            return n().createElement(
              "div",
              Ce({ className: o()(de.base, ...W, e), style: G }, U),
              I,
            );
          });
        var fe = t(3532),
        ...
        const Re = Object.keys(we()),
          ...
          Le = De((u) => {
            ...
            return n().createElement(
              ...
              xe(
                {
                  className: o()(ve.base, t && ve[t], h, a),
                  style: p,
              ...
              void 0 !== B ? n().createElement(mu, xe({}, B, { text: e })) : e,
            );
          });
        let Ne;
        var ke;
        (((ke = Ne || (Ne = {})).SHORT_DATE = "short-date"),
        ...
        (Date.now(),
          ((He = Ie || (Ie = {})).BOSS = "boss"),
          (He.BOSS_2025 = "boss_2025"),
          (He.BOSS_SPECIAL = "boss_special"),
          (He.HUNTER = "hunter"),
          (function (u) {
        ...
        const Ge = (u, e) => {
            const t = (function (u = 0) {
              ...
              a = t.minutes;
            return r >= 1
              ? ou(e.days(), { days: r, hours: n })
              : n >= 1
                ? ou(e.hours(), { hours: n, minutes: a })
                : a >= 1
                  ? ou(e.minutes(), { minutes: a })
                  : e.lessMinute();
          },
          We = (u, e) =>
            u.name === I.WtMainPrizeDiscount
              ? `R.images.gui.maps.icons.quests.bonuses.${H.Big}.${u.name + "_" + e}`
              : ((u, e = H.Small) => {
                  const t = u.name,
                    r = u.type,
                    n = u.value,
                  ...
                  switch (t) {
                    ...
                    case I.LbStyleProgress:
                      return nu(a, e, j.ProgressionStyle);
                    default:
        ...
        let $e;
        !(function (u) {
          ((u[(u.High = 1)] = "High"), (u[(u.Medium = 2)] = "Medium"), (u[(u.Low = 3)] = "Low"));
        })($e || ($e = {}));
        const Xe = "PerformanceWarning_title_f1",
          ze = ({ performanceRisk: u }) => {
            const e = {
                titleClasses: Xe,
                title: R.strings.event.tooltips.informative.title(),
                description: R.strings.event.tooltips.informative.subtitle(),
              },
              t =
                {
                  [$e.Low]: e,
                  [$e.Medium]: {
                    titleClasses: o()(Xe, "PerformanceWarning_title__medium_db"),
                    title: R.strings.event.tooltips.medium_risk.title(),
                    description: R.strings.event.tooltips.medium_risk.subtitle(),
                  },
                  [$e.High]: {
                    titleClasses: o()(Xe, "PerformanceWarning_title__high_19"),
                    title: R.strings.event.tooltips.high_risk.title(),
                    description: R.strings.event.tooltips.high_risk.subtitle(),
                  },
                }[u] || e,
              r = t.title,
              a = t.titleClasses,
            ...
            return n().createElement(
              "div",
              { className: "PerformanceWarning_base_06" },
              n().createElement("div", { className: a }, r),
              n().createElement("div", { className: "PerformanceWarning_description_e2" }, i),
            );
          };
        function je() {
          return (
        ...
        const Ye = R.strings.tooltips.WtProgressionEntryPointTooltip,
          qe = (u) => {
            if (u.name === I.WtMainPrizeDiscount && u.icon) {
              const e = u.icon.split("_");
              return Number(e[e.length - 1]) + 10;
            }
            return 0;
          },
          Ve = () => {
            const u = b(),
              e = u.isProgressionCompleted,
              t = u.stageCurrent,
              r = u.commonCurrent,
              a = u.commonTotal,
              i = u.stampsCurrent,
              ...
              A = ((u) =>
                ...
                Array.isArray(c)
                  ? c.map(F)
                  : c.map((u, e, t) => F(null == u ? void 0 : u.value, e, t))),
              );
            var c, F;
            return n().createElement(
              "div",
              { className: "Content_base_43" },
              n().createElement("div", { className: "Content_heading_5b" }, Ye.title()),
              o >= 0 &&
                n().createElement(mu, {
                  classMix: "Content_timeLeft_64",
                  binding: {
                    timeLeft: n().createElement(Le, {
                      text: Ge(o, Ye.duration),
                      className: "Content_timeLeft_accent_28",
                    }),
                  },
                  text: Ye.subtitle(),
                }),
              e &&
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement("div", { className: "Content_image_f6" }),
                  n().createElement("div", { className: "Content_completed_8a" }, Ye.completed()),
                ),
              !e &&
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement("div", { className: "Content_currentStage_3c" }, t),
                  n().createElement(
                    "div",
                    { className: "Content_currentStage_description_24" },
                    Ye.currentStage(),
                  ),
                  n().createElement(
                    "div",
                    { className: "Content_progress_9b" },
                    n().createElement(qu, { value: r, maxValue: a, theme: $u }),
                  ),
                  n().createElement(
                    "div",
                    { className: "Content_stamps_37" },
                    n().createElement(mu, {
                      binding: { stampsCurrent: i, stampsMax: s },
                      text: Ye.stampsFormat(),
                    }),
                    n().createElement("img", {
                      className: "Content_stamps_icon_43",
                      src: R.images.white_tiger.gui.maps.icons.tooltips.points_icon(),
                    }),
                  ),
                  n().createElement(
                    "div",
                    { className: "Content_rewards_wrapper_5a" },
                    n().createElement(
                      "div",
                      { className: "Content_rewards_title_a0" },
                      Ye.stageAwards(),
                    ),
                    l &&
                      n().createElement(
                        "div",
                        { className: "Content_rewards_group_58" },
                        A.map((u, e) =>
                          n().createElement(iu, je({ key: e, className: "Content_reward_32" }, u)),
                        ),
                      ),
                  ),
                ),
              E && !e && n().createElement(ze, { performanceRisk: E }),
            );
          },
          Ke = () => n().createElement(F, null, n().createElement(Ve, null));
        engine.whenReady.then(() => {
          i().render(n().createElement(Ke, null), document.getElementById("root"));
        });
      },
    },
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(6933));
