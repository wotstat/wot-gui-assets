(() => {
  var u,
    e = {
      ...
      4037: (u, e, t) => {
        "use strict";
        var r = {};
        (t.r(r), t.d(r, { mouse: () => d, onResize: () => s }));
        var A = {};
        (t.r(A),
          t.d(A, {
            events: () => r,
        ...
        var E = {};
        (t.r(E), t.d(E, { getBgUrl: () => x, getTextureUrl: () => f }));
        var F = {};
        (t.r(F),
          t.d(F, {
            addModelObserver: () => T,
        ...
        const s = C("clientResized"),
          c = { down: C("mousedown"), up: C("mouseup"), move: C("mousemove") },
          d = (function () {
                ...
                const F = (0, n.useRef)([]),
                  D = (u, t, r) => {
                    ...
                    const E = (function ({
                        ...
                        return {
                          subscribe: (t, E) => {
                            const n = "string" == typeof E ? `${r}.${E}` : r,
                              a = Z.view.addModelObserver(n, e, !0);
                            return (A.set(a, t), u && t(F(E)), a);
                          },
                          readByPath: F,
                          createCallback: (u, e) => {
                            const t = F(e);
                        ...
                        observableModel: {
                          array: (e, t) => {
                            const r = null != t ? t : a(e),
                              A = o.observable.box(r, { equals: l });
                            return (
                              "real" === u &&
                                n.subscribe(
                                  (0, o.action)((u) => A.set(u)),
                                  e,
                                ),
                              A
                            );
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const A = e.reduce(
                                (u, e) => ((u[e] = o.observable.box(r[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const A = e,
                                E = Object.entries(A),
                                F = E.reduce(
                                  (u, [e, t]) => ((u[t] = o.observable.box(r[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                      ...
                      B = { mode: u, model: i, externalModel: n, cleanup: D };
                    return {
                      model: i,
                  ...
                  C = B[0],
                  m = B[1],
                  s = (0, n.useState)(() => D(u, r, E)),
                  c = s[0],
                  d = s[1];
                return (
                  (0, n.useEffect)(() => {
                    i.current ? d(D(C, r, E)) : (i.current = !0);
                  }, [E, C, r]),
                  (0, n.useEffect)(() => {
                    m(u);
                  }, [u]),
        ...
        const Du = a().forwardRef(function (u, e) {
          let t = u.children,
            r = u.className,
            A = u.theme,
          ...
          return (
            ...
            a().createElement(
              "div",
              au({}, F, {
                className: Eu()(Fu.base, Fu[`base__theme-${E}`], r),
                ref: function (u) {
                  ((i.current = u), "function" == typeof e ? e(u) : e && (e.current = u));
                },
              }),
              a().createElement("div", { className: Fu.decorator }, t),
            )
          );
        });
        var iu = t(3282),
        ...
        const cu = Z.client.getSize("rem"),
          du = cu.width,
          gu = cu.height,
          hu = Object.assign({ width: du, height: gu }, su(du, gu, Cu)),
          _u = (0, n.createContext)(hu),
          fu = ["children"],
          xu = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && i) return ou(e, t, h);
              if (t.largeWidth && B) return ou(e, t, h);
              if (t.mediumWidth && l) return ou(e, t, h);
              if (t.smallWidth && o) return ou(e, t, h);
              if (t.extraSmallWidth && C) return ou(e, t, h);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, n.memo)(({ children: u }) => {
          const e = (0, n.useContext)(_u),
            ...
            E = (0, n.useCallback)((u, e) => {
              const t = Z.view.pxToRem(u),
                r = Z.view.pxToRem(e);
              A(Object.assign({ width: t, height: r }, su(t, r, Cu)));
            }, []);
          (((u) => {
          ...
          return a().createElement(_u.Provider, { value: F }, u);
        }),
          (function (u) {
        ...
        const wu = ["xl", "lg", "md", "sm", "xs"],
          ...
          yu = [pu.ExtraLarge, pu.Large, pu.Medium, pu.Small, pu.ExtraSmall],
          Lu = (u, e) =>
        ...
        const Ou = {
          ...
          Nu = Mu((u) => {
            let e = u.className,
              ...
              w =
                void 0 === b
                  ? (g ? "flex-start" : h && "center") || (_ && "flex-end") || void 0
                  : b,
              S = u.alignSelf,
              y = u.wrap,
              L = u.flexWrap,
              ...
              R = u.shrink,
              H = u.flex,
              O = void 0 === H ? (T || R ? `${T ? 1 : 0} ${R ? 1 : 0} auto` : void 0) : H,
              P = u.style,
              W = u.children,
              N = (function (u, e) {
                if (null == u) return {};
            ...
            const G = (0, n.useMemo)(() => {
              ...
              }, [t, r, F, i, l, C, P, O, S, d, M, v, w]),
              j = G.computedStyle,
              k = G.computedClassNames;
            return a().createElement(
              "div",
              Hu({ className: Eu()(Tu.base, ...k, e), style: j }, N),
              W,
            );
          });
        let Gu;
        ...
        const ju = (u, e, t) => {
          ...
          Iu = (u, e, t = Gu.left) => u.split(e).reduce(t === Gu.left ? ju : ku, []),
          Xu = (() => {
            const u = new RegExp(
          ...
          Ku = ({ binding: u, text: e = "", classMix: t, alignment: r = Gu.left }) =>
            null === e
              ...
              : a().createElement(
                  ...
                  e.split("\n").map((e, A) =>
                    a().createElement(
                      "div",
                      { className: Eu()("FormatText_base_d0", t), key: `${e}-${A}` },
                      ((u, e, t) =>
                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) =>
                          t && u in t
                            ? t[u]
          ...
          re = Mu((u) => {
            ...
            const g = (0, n.useMemo)(() => {
                const u = te(A),
                  ...
                  t = u.colorStyle,
                  r = void 0 === t ? {} : t;
                return { computedStyle: Object.assign({}, s, r), colorClassName: e };
              }, [s, A]),
              h = g.computedStyle,
              _ = g.colorClassName;
            return a().createElement(
              ...
              Yu(
                {
                  className: Eu()(Uu.base, t && Uu[t], _, r),
                  style: h,
        ...
        const Fe = (0, n.forwardRef)(function (u, e) {
            ...
            return (
                                  ...
                                  if (
                                    (e !== r &&
                                      (u.changeTimeHandlers.forEach((u) =>
                                        u({ currentTime: r, duration: A }),
                                      ),
                                      (e = r)),
                                    d.current.paused || !c || !l)
                                  )
                                    return;
                                  const E = d.current.cohGetKeyframeTimestamps();
                                  E.forEach((e, t) => {
                                    r > E[t] - 0.02 &&
                                      r < E[t] &&
                                      u.changeKeyframeHandlers.forEach((u) => {
                                        const r = Object.keys(null != o ? o : {})[t];
                                        return u({ time: e, name: `${o ? r : `Point_${t}`}` });
                                      });
                                  });
                                }
                              })(),
              ...
              a().createElement(
                "video",
                Ee({ src: t, className: r, style: F, loop: i, ref: d, onClick: C, onError: m }, s),
              )
            );
          }),
          ne = (0, n.memo)(Fe),
          ae = "Content_textWrapper_11",
          De = "Content_subtitle_12",
          ie = "Content_text_19",
          Be = R.strings.event.WtEventAmmunitionTooltipView,
          le = R.images.gui.maps.icons.artefact,
          oe = R.images.white_tiger.gui.maps.icons.ability,
          Ce = Eu()(ae, "Content_textWrapper__hasGradient_ef"),
          me = (0, iu.observer)(() => {
            const u = ru().model.root.get(),
              ...
              A = u.subtitle,
              E = u.text,
              F = u.additionalInfoText,
              n = R.videos.wt_event.ability.$dyn(e),
              D = oe.$dyn(e),
              i = { backgroundImage: `url(${le.$dyn(e)})` },
              B = Eu()("Content_base_d2", n && "Content_base__hasVideo_35");
            return a().createElement(
              "div",
              { className: B },
              a().createElement("div", { className: "Content_icon_89", style: i }),
              a().createElement(re, { className: "Content_title_20", text: t }),
              a().createElement(re, { className: "Content_description_71", text: r }),
              n
                ? a().createElement(
                    a().Fragment,
                    null,
                    a().createElement(
                      "div",
                      { className: "Content_videoContainer_93" },
                      D &&
                        a().createElement("div", {
                          className: "Content_videoImg_c4",
                          style: { backgroundImage: `url(${D})` },
                        }),
                      a().createElement(ne, {
                        className: "Content_video_fb",
                        src: n,
                        autoplay: !0,
                        loop: !0,
                      }),
                    ...
                    a().createElement(
                      "div",
                      { className: ae },
                      a().createElement(re, { className: De, text: A }),
                      a().createElement(Ku, { text: E, classMix: ie }),
                    ),
                    F &&
                      a().createElement(
                        "div",
                        { className: "Content_additionalTextWrapper_a3" },
                        a().createElement(re, { className: De, text: Be.additionalInfoTitle() }),
                        a().createElement(Ku, { text: F, classMix: ie }),
                      ),
                  )
                : a().createElement(
                    "div",
                    { className: Ce },
                    a().createElement(re, { className: De, text: A }),
                    a().createElement(Ku, { classMix: ie, text: E }),
                  ),
            );
          }),
          se = () => a().createElement(Du, null, a().createElement(me, null));
        engine.whenReady.then(() => {
          i().render(
            a().createElement(tu, null, a().createElement(se, null)),
  ...
  function r(u) {
    ...
    var E = (t[u] = { exports: {} });
    return (e[u].call(E.exports, E, E.exports, r), E.exports);
  }
  ((r.m = e),
    (u = []),
    (r.O = (e, t, A, E) => {
      if (!t) {
        ...
        for (i = 0; i < u.length; i++) {
          for (var [t, A, E] = u[i], n = !0, a = 0; a < t.length; a++)
            (!1 & E || F >= E) && Object.keys(r.O).every((u) => r.O[u](t[a]))
              ? t.splice(a--, 1)
              : ((n = !1), E < F && (F = E));
          if (n) {
            u.splice(i--, 1);
