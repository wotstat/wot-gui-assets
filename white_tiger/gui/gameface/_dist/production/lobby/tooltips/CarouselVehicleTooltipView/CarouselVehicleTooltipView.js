  ...
  var __webpack_modules__ = {
      ...
      3694: (u, e, t) => {
        ...
        const l = A().forwardRef(function (u, e) {
            ...
            return (
              ...
              A().createElement(
                "div",
                o({}, l, {
                  className: n()(D.base, D[`base__theme-${a}`], r),
                  ref: function (u) {
                ...
                const t = (u) => {
                  ...
                  E = ((u) => {
                    const e = ((u) => {
                        ...
                        return { modelPrefix: A, modelPath: d(A, ""), resId: E };
                      })(),
                      t = e.modelPrefix,
                      E = u.split(".");
                    if (E.length > 0) {
        ...
        const L = i.O.client.getSize("rem"),
          M = L.width,
          O = L.height,
          T = Object.assign({ width: M, height: O }, S(M, O, b)),
          ...
          (0, E.memo)(({ children: u }) => {
            const e = (0, E.useContext)(P),
              ...
              a = (0, E.useCallback)((u, e) => {
                ...
                F(Object.assign({ width: t, height: E }, S(t, E, b)));
              }, []);
            (_(() => {
        ...
        const Du = Object.keys(Fu()),
          ...
          _u = X((u) => {
            ...
            return A().createElement(
              ...
              void 0 !== c ? A().createElement(Au, iu({}, c, { text: e })) : e,
            );
          }),
          mu = {
            base: "Content_base_22",
            content: "Content_content_ba",
            base__boss_2025: "Content_base__boss_2025_42",
            base__boss_special: "Content_base__boss_special_04",
          ...
          du = () => A().createElement(l, null, A().createElement(cu, null));
        engine.whenReady.then(() => {
          F().render(A().createElement(du, null), document.getElementById("root"));
        });
      },
    },
