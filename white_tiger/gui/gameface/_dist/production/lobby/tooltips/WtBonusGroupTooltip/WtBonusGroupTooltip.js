  ...
  var __webpack_modules__ = {
      ...
      2743: (u, e, t) => {
        ...
        const D = n().forwardRef(function (u, e) {
          ...
          return (
            ...
            n().createElement(
              "div",
              F({}, D, {
                className: o()(A.base, A[`base__theme-${s}`], a),
                ref: function (u) {
        ...
        const g = E.O.client.getSize("rem"),
          p = g.width,
          h = g.height,
          b = Object.assign({ width: p, height: h }, C(p, h, B)),
          ...
          S = (u) => {
            ...
            const n = (0, r.useContext)(v),
              ...
              p = { extraLarge: _, large: B, medium: d, small: C, extraSmall: g };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && A) return m(e, t, p);
              if (t.largeWidth && l) return m(e, t, p);
              if (t.mediumWidth && F) return m(e, t, p);
              if (t.smallWidth && D) return m(e, t, p);
              if (t.extraSmallWidth && c) return m(e, t, p);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        ((0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(v),
            ...
            s = (0, r.useCallback)((u, e) => {
              ...
              i(Object.assign({ width: t, height: r }, C(t, r, B)));
            }, []);
          (((u) => {
        ...
        let mu, Bu, du, Cu, gu, pu, hu, bu, vu;
        ...
        const wu = [
          ...
          Su = [mu.Gold, mu.Credits, mu.Crystal, mu.FreeXp],
          fu = [mu.BattlePassPoints],
          xu = [mu.PremiumPlus, mu.Premium];
        let Ru;
        !(function (u) {
          ((u.s16 = "16"),
            (u.s32 = "32"),
        ...
        const Tu = ["engravings", "backgrounds"],
          ...
          Ou = (u, e = du.Small) => {
            ...
            switch (t) {
              ...
              case mu.StyleProgress:
              case mu.LbStyleProgress:
                return Mu(a, e, vu.ProgressionStyle);
              default:
            ...
            return [
              function ({ mode: u = "real", options: a, children: i, mocks: s }) {
                const o = (0, r.useRef)([]),
                  ...
                  D = F[0],
                  c = F[1],
                  _ = (0, r.useState)(() => A(u, a, s)),
                  m = _[0],
                  B = _[1];
                return (
                  (0, r.useEffect)(() => {
                    l.current ? B(A(D, a, s)) : (l.current = !0);
                  }, [s, D, a]),
                  (0, r.useEffect)(() => {
                    c(u);
                  }, [u]),
          ...
          Lu = yu[0],
          Nu = yu[1],
          ku = R.strings.tooltips.wtBonusGroupTooltip.header,
          Iu = R.images.gui.maps.icons.quests.bonuses.small,
          Uu = n().memo(({ bonusGroup: u }) => {
            const e = { backgroundImage: `url(${Iu.$dyn(u)})` };
            return n().createElement(
              "div",
            ...
            const h = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (Wu(t, c, { isMouseEvent: !0, on: !0, arguments: Gu(n) }, b),
                  C && C(),
              ...
              zu(
                {
                  contentId:
                    ...
                    l ? Vu.SimpleTooltipHtmlContent("resId") : Vu.SimpleTooltipContent("resId")),
        ...
        const Zu = ({ children: u, tooltipArgs: e, className: t }) => {
            ...
            return a || s
              ? n().createElement(Xu, Qu({}, e, { contentId: a || s }), r)
          ...
          ue = ({
            ...
            return n().createElement(
              "div",
              { className: o()(Ju.base, Ju[`base__${r}`], A), style: E },
              n().createElement(
                Zu,
                { tooltipArgs: F, className: Ju.tooltipWrapper },
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(
                    "div",
                    { className: o()(Ju.image, null == l ? void 0 : l.image) },
                    c &&
                      n().createElement("div", {
                        className: o()(Ju.highlight, null == l ? void 0 : l.highlight),
                        style: {
                    ...
                    e &&
                      n().createElement("div", {
                        className: o()(Ju.icon, null == l ? void 0 : l.rewardIcon),
                        style: { backgroundImage: `url(${e})` },
                      }),
                    _ &&
                      n().createElement("div", {
                        className: o()(Ju.overlay, null == l ? void 0 : l.overlay),
                        style: {
              ...
              t &&
                n().createElement(
                  ...
                  { tooltipArgs: D },
                  n().createElement("div", {
                    className: o()(Ju.timer, null == l ? void 0 : l.periodicIcon),
                  }),
                ),
            );
          };
        ...
        const te = n().memo(({ bonus: u }) =>
            n().createElement(
              ...
              ((u) =>
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement(ue, ee({}, u, { size: du.Small })),
                  n().createElement(su, {
                    text: u.label,
          ...
          re = "App_divider_b5",
          ne = R.strings.tooltips.wtBonusGroupTooltip,
          ae = (0, ou.observer)(() => {
            const u = Nu().model,
            ...
            return n().createElement(
              ...
              n().createElement(Uu, { bonusGroup: e }),
              t
                .slice(0, 4)
                .map((u, e) =>
                  n().createElement(
        ...
        engine.whenReady.then(() => {
          i().render(
            n().createElement(Lu, null, n().createElement(D, null, n().createElement(ae, null))),
