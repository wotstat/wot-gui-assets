(() => {
  var __webpack_modules__ = {
      ...
      3463: (u, e, t) => {
        ...
        const l = r().forwardRef(function (u, e) {
            ...
            return (
              ...
              r().createElement(
                "div",
                o({}, l, {
                  className: n()(D.base, D[`base__theme-${a}`], A),
                  ref: function (u) {
                ...
                const t = (u) => {
                  ...
                  E = ((u) => {
                    const e = ((u) => {
                        ...
                        return { modelPrefix: r, modelPath: d(r, ""), resId: E };
                      })(),
                      t = e.modelPrefix,
                      E = u.split(".");
                    if (E.length > 0) {
                      ...
                      return (
                        E.reduce((e, E) => {
                          const r = C(d(t, `${e}.${E}`), window);
                          return c(r)
                            ? (u.push(r.id), `${e}.${E}.value`)
                            : (u.push(E), `${e}.${E}`);
                        }),
                        u.reduce((u, e) => u + "." + e)
                      );
        ...
        const v = (u, e, t) => {
          ...
          f = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? v : x, []),
          b = (() => {
            const u = new RegExp(
          ...
          S = ["zh_cn", "zh_sg", "zh_tw"],
          L = ({ binding: u, text: e = "", classMix: t, alignment: A = w.left }) =>
            null === e
        ...
        const H = i.O.client.getSize("rem"),
          k = H.width,
          W = H.height,
          I = Object.assign({ width: k, height: W }, N(k, W, P)),
          G = (0, E.createContext)(I),
          U = ["children"],
          j = (u) => {
            let e = u.children,
              t = (function (u, e) {
            ...
            const r = (0, E.useContext)(G),
              ...
              h = { extraLarge: C, large: _, medium: m, small: c, extraSmall: d };
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && D) return T(e, t, h);
              if (t.largeWidth && B) return T(e, t, h);
              if (t.mediumWidth && o) return T(e, t, h);
              if (t.smallWidth && l) return T(e, t, h);
              if (t.extraSmallWidth && s) return T(e, t, h);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
          ...
          (0, E.memo)(({ children: u }) => {
            const e = (0, E.useContext)(G),
              ...
              a = (0, E.useCallback)((u, e) => {
                ...
                F(Object.assign({ width: t, height: E }, N(t, E, P)));
              }, []);
            (_(() => {
              engine.on("clientResized", a);
            }),
              (0, E.useEffect)(() => () => engine.off("clientResized", a), [a]));
            const n = (0, E.useMemo)(() => Object.assign({}, A), [A]);
            return r().createElement(G.Provider, { value: n }, u);
          }),
          (function (u) {
        ...
        const z = ["xl", "lg", "md", "sm", "xs"],
          ...
          Y = [X.ExtraLarge, X.Large, X.Medium, X.Small, X.ExtraSmall],
          $ = (u, e) =>
            Object.keys(u).reduce((t, E) => {
              ...
              return (
                void 0 === r ||
                  ((u, e) => z.some((t) => void 0 !== e[`${u}_${t}`]))(E, u) ||
                  (t[E] = r),
                t
              );
            }, {}),
        ...
        const eu = {
          ...
          ru = Z((u) => {
            let e = u.className,
              ...
              M = u.wrap,
              O = u.flexWrap,
              R = void 0 === O ? (M ? "wrap" : void 0) : O,
              T = u.grow,
              P = u.shrink,
              y = u.flex,
              N = void 0 === y ? (T || P ? `${T ? 1 : 0} ${P ? 1 : 0} auto` : void 0) : y,
              H = u.style,
              k = u.children,
              W = (function (u, e) {
                if (null == u) return {};
            ...
            const I = (0, E.useMemo)(() => {
                const u = { mt: i, mr: B, mb: l, ml: C },
                  e = ((u) =>
                    tu.reduce((e, t) => {
                      const E = u[t];
                      return E && "number" != typeof E ? e.concat(eu[!0 === E ? "MD" : E][t]) : e;
                    }, []))(u),
                  E = ((u) =>
                    tu.reduce((e, t) => {
                      const E = u[t];
                      return ("number" == typeof E && (e[Eu[t]] = E + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [t, A, i, B, l, C, H, N, L, d, R, f, S]),
              G = I.computedStyle,
              U = I.computedClassNames;
            return r().createElement(
              "div",
              uu({ className: n()(Q.base, ...U, e), style: G }, W),
              k,
            );
          });
        var Au = t(3532),
        ...
        const Du = Object.keys(Fu()),
          ...
          _u = Z((u) => {
            ...
            return r().createElement(
              ...
              iu(
                {
                  className: n()(au.base, t && au[t], p, A),
                  style: g,
              ...
              void 0 !== c ? r().createElement(L, iu({}, c, { text: e })) : e,
            );
          }),
          mu = "Content_description_23",
          cu = R.strings.event.WtGuaranteedRewardTooltipView,
          du = () => {
            const u = p("model"),
              e = u.tanks,
              t = u.guaranteedReward,
              A = (0, E.useMemo)(
                () => ({
                  portalRuns: r().createElement(L, {
                    text: cu.portalRuns(),
                    binding: { count: t.guaranteedTankAttemptCount },
                    classMix: "Content_highlight_64",
                  }),
                }),
            ...
            return r().createElement(
              "div",
              { className: "Content_base_31" },
              r().createElement(_u, { className: "Content_title_12", text: cu.title() }),
              r().createElement(L, {
                text: t.isIgnored ? cu.allCollected() : cu.description(),
                binding: A,
                classMix: mu,
              }),
              !t.isIgnored &&
                r().createElement(
                  "div",
                  { className: "Content_portalRunsLeftWrapper_8d" },
                  r().createElement("div", { className: "Content_divider_46" }),
                  r().createElement(
                    "div",
                    { className: "Content_runsCounterWrapper_8e" },
                    r().createElement(_u, {
                      className: "Content_portalRunsCounter_7c",
                      text: t.leftAttemptsCount.toString(),
                    }),
                    r().createElement(_u, {
                      className: "Content_portalRunsLeft_6f",
                      text: cu.portalRunsLeft(),
                    }),
                  ),
                  r().createElement("div", { className: "Content_dividerBottom_52" }),
                ),
              r().createElement(_u, { className: "Content_subtitle_66", text: cu.vehiclesTitle() }),
              r().createElement(_u, { className: mu, text: cu.vehiclesDescription() }),
              r().createElement(
                "div",
                { className: "Content_tanks_1a" },
                r().createElement("div", { className: "Content_tankBg_aa" }),
                r().createElement(
                  "div",
                  { className: "Content_tanksList_68" },
                  e.map(({ value: u }, t) =>
                    r().createElement(
                      "div",
                      { key: t, className: "Content_tank_c1" },
                      `${u}${t < e.length - 1 ? "," : ""}`,
                    ),
                  ),
                ),
              ...
              r().createElement(_u, {
                className: "Content_footerTitle_45",
                text: cu.footerTitle(),
              }),
              r().createElement(_u, { className: "Content_footerDesc_74", text: cu.footerDesc() }),
            );
          },
          hu = () => r().createElement(l, null, r().createElement(du, null));
        engine.whenReady.then(() => {
          F().render(r().createElement(hu, null), document.getElementById("root"));
        });
      },
    },
  ...
  ((__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.O = (u, e, t, E) => {
      ...
      E = E || 0;
      for (var n = deferred.length; n > 0 && deferred[n - 1][2] > E; n--)
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(3463));
