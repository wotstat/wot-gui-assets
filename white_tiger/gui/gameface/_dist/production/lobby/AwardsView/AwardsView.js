  ...
  var __webpack_modules__ = {
      ...
      971: (u, e, t) => {
        ...
        const c = o.O.client.getSize("rem"),
          ...
          B = (u) => {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.smallWidth && _) return s(e, t, b);
        ...
        const C = (0, r.memo)(({ children: u }) => {
          ...
          return n().createElement(m.Provider, { value: l }, u);
        });
        var g = t(6483),
          p = t.n(g),
          h = t(926),
        ...
        const M = {
          ...
          P = (u) => {
            ...
            const a = x(),
              ...
              s = a.mediaHeight,
              o = a.mediaSize;
            return n().createElement("div", T({ className: p()(t, M[i], L[s], y[o]) }, r), e);
          },
          O = ["children"],
          k = (u) => {
            let e = u.children,
            ...
            return n().createElement(C, null, n().createElement(P, t, e));
          };
        function I() {
          return !1;
        }
        ...
        const W = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: a, children: i, mocks: s }) {
                const E = (0, r.useRef)([]),
                  l = (u, t, r) => {
                    ...
                    const a = (function ({
                      ...
                      A = (({ observableModel: u }) => {
                        const e = { root: u.object(), mainRewards: u.array("mainRewards", []) },
                          t = (0, G.computedFn)(
                            () => {
                              return (
                                (u = e.mainRewards.get()),
                        ...
                        return Object.assign({}, e, { computes: { getMainRewards: t } });
                      })({
                        mode: u,
                        readByPath: s,
                        externalModel: i,
                ...
                return (
                  (0, r.useEffect)(() => {
                    A.current ? d(l(F, a, s)) : (A.current = !0);
                  }, [s, F, a]),
                  (0, r.useEffect)(() => {
                    _(u);
                  }, [u]),
        ...
        class uu extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              F = p()(Z.base, Z[`base__${i}`], Z[`base__${a}`], null == s ? void 0 : s.base),
              _ = p()(Z.icon, Z[`icon__${i}`], Z[`icon__${a}`], null == s ? void 0 : s.icon),
              D = p()(Z.glow, null == s ? void 0 : s.glow),
              m = p()(Z.caption, Z[`caption__${i}`], null == s ? void 0 : s.caption),
        ...
        const eu = ({ onClose: u, label: e, classMix: t }) =>
            n().createElement(
              "div",
          ...
          tu = ({ opacity: u }) => {
            const e = { opacity: `${u}` };
            return n().createElement("div", { className: "Gradient_base_c7", style: e });
          },
          ru = ({ animationDelayStepsCount: u = 1, children: e }) =>
            n().createElement(
              "div",
              {
        ...
        const iu = (0, r.memo)(function (u) {
            ...
            return (
              ...
              n().createElement("canvas", au({}, p, { width: e, height: t, ref: h }))
            );
          }),
          su = (u, e) => {
            let t = u;
        ...
        const cu = ["xl", "lg", "md", "sm", "xs"],
          Fu = (u) => u.includes("_") && ((u) => cu.includes(u))(u.split("_").at(-1)),
          _u = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
          Du = (u, e) =>
        ...
        const gu = {
          ...
          bu = mu((u) => {
            ...
            const U = (0, r.useMemo)(() => {
              ...
              }, [t, a, o, l, c, _, I, k, T, B, L, f, S]),
              G = U.computedStyle,
              W = U.computedClassNames;
            return n().createElement(
              "div",
              Cu({ className: p()(du.base, ...W, e), style: G }, H),
              N,
            );
          });
        let vu;
        ...
        const wu = (u, e, t) => {
          ...
          xu = (u, e, t = vu.left) => u.split(e).reduce(t === vu.left ? wu : fu, []),
          Su = (() => {
            const u = new RegExp(
        ...
        const ku = Object.keys(Lu()),
          ...
          Wu = mu((u) => {
            ...
            return n().createElement(
              ...
              Ou(
                {
                  className: p()(yu.base, t && yu[t], h, a),
                  style: g,
                  mt: !0 === E ? Uu[t || "paragraph-P16"].mt : E,
                  mr: !0 === A ? Uu[t || "paragraph-P16"].mr : A,
                  mb: !0 === F ? Uu[t || "paragraph-P16"].mb : F,
                  ml: !0 === D ? Uu[t || "paragraph-P16"].ml : D,
                },
                B,
              ),
              void 0 !== d ? n().createElement(Mu, Ou({}, d, { text: e })) : e,
            );
          }),
          $u = ({ title: u, status: e }) =>
            n().createElement(
              "div",
              { className: "Header_base_f4" },
              n().createElement(Wu, { className: "Header_title_b0", text: u }),
              n().createElement(Wu, { className: "Header_status_ef", text: e }),
            );
        let Xu, ju, qu, Yu, zu, Vu, Ku, Zu, Qu;
        var Ju, ue, ee;
        (!(function (u) {
          ((u.Items = "items"),
          ...
          ((ee = Yu || (Yu = {})).MULTI = "multi"),
          (ee.CURRENCY = "currency"),
          (ee.PREMIUM_PLUS = "premium_plus"),
          (ee.NUMBER = "number"),
          (ee.STRING = "string"),
          ((ue = zu || (zu = {})).BATTLE_BOOSTER = "battleBooster"),
          (ue.BATTLE_BOOSTER_REPLACE = "battleBoosterReplace"),
          (ue.BUILT_IN_EQUIPMENT = "builtInEquipment"),
          (ue.EQUIPMENT_PLUS = "equipmentPlus"),
          (ue.EQUIPMENT_TROPHY_BASIC = "equipmentTrophyBasic"),
          (ue.EQUIPMENT_TROPHY_UPGRADED = "equipmentTrophyUpgraded"),
          (ue.EQUIPMENT_MODERNIZED_UPGRADED_1 = "equipmentModernized_1"),
          (ue.EQUIPMENT_MODERNIZED_UPGRADED_2 = "equipmentModernized_2"),
          (ue.EQUIPMENT_MODERNIZED_UPGRADED_3 = "equipmentModernized_3"),
          (ue.PROGRESSION_STYLE_UPGRADED_1 = "progressionStyleUpgraded_1"),
          (ue.PROGRESSION_STYLE_UPGRADED_2 = "progressionStyleUpgraded_2"),
          (ue.PROGRESSION_STYLE_UPGRADED_3 = "progressionStyleUpgraded_3"),
          (ue.PROGRESSION_STYLE_UPGRADED_4 = "progressionStyleUpgraded_4"),
          ((Vu || (Vu = {})).BATTLE_BOOSTER = "battleBooster"),
          ((Ju = Ku || (Ku = {})).BATTLE_BOOSTER = "battleBooster"),
          (Ju.BATTLE_BOOSTER_REPLACE = "battleBoosterReplace"),
          (Ju.BUILT_IN_EQUIPMENT = "builtInEquipment"),
          (Ju.EQUIPMENT_PLUS = "equipmentPlus"),
          (Ju.EQUIPMENT_TROPHY_BASIC = "equipmentTrophyBasic"),
          (Ju.EQUIPMENT_TROPHY_UPGRADED = "equipmentTrophyUpgraded"),
          (Ju.EQUIPMENT_MODERNIZED_UPGRADED_1 = "equipmentModernized_1"),
          (Ju.EQUIPMENT_MODERNIZED_UPGRADED_2 = "equipmentModernized_2"),
          (Ju.EQUIPMENT_MODERNIZED_UPGRADED_3 = "equipmentModernized_3"),
          (Ju.PROGRESSION_STYLE_UPGRADED_1 = "progressionStyleUpgraded_1"),
          (Ju.PROGRESSION_STYLE_UPGRADED_2 = "progressionStyleUpgraded_2"),
          (Ju.PROGRESSION_STYLE_UPGRADED_3 = "progressionStyleUpgraded_3"),
          (Ju.PROGRESSION_STYLE_UPGRADED_4 = "progressionStyleUpgraded_4"),
          (function (u) {
          ...
          ie = (u, e = qu.Small) => {
            ...
            switch (t) {
              ...
              case Xu.LbStyleProgress:
                return se(a, e, Qu.ProgressionStyle);
              default:
        ...
        let oe, Ee;
        (!(function (u) {
          ((u.Valuable = "valuable"), (u.PostBattle = "postBattle"), (u.Default = ""));
        })(oe || (oe = {})),
          (function (u) {
            ((u.PREMIUM_PLUS = "premium_plus"),
              (u.CAMOUFLAGE = "camouflage"),
              (u.PROJECTION_DECAL = "projectionDecal"),
              (u.INSCRIPTION = "inscription"),
              (u.CRYSTAL = "crystal"),
              (u.CUSTOMIZATIONS = "customizations"),
              (u.STYLE = "style"),
              (u.EMBLEM = "emblem"),
              (u.GOLD = "gold"),
              (u.MAIN_PRIZE_DISCOUNT = "main_prize_discount"),
              (u.CREDITS = "credits"),
              (u.FREE_XP = "freeXP"));
          })(Ee || (Ee = {})));
        const le = {
            [v.ExtraLarge]: qu.S400x300,
            [v.Large]: qu.S400x300,
            [v.Medium]: qu.S296x222,
            [v.Small]: qu.S296x222,
            [v.ExtraSmall]: qu.S296x222,
          },
          Ae = {
            [v.ExtraLarge]: qu.S600x450,
            [v.Large]: qu.S600x450,
            [v.Medium]: qu.S400x300,
            [v.Small]: qu.S400x300,
            [v.ExtraSmall]: qu.S400x300,
          },
          ce = (u, e, t) => (e ? oe.PostBattle : u && 1 === t ? oe.Valuable : oe.Default);
        var Fe = t(5659);
        const _e = [
          "children",
          "contentId",
            ...
            const h = (0, r.useRef)({
              ...
              v = (0, r.useCallback)(() => {
                (h.current.isVisible && h.current.timeoutId) ||
                  (me(t, _, { isMouseEvent: !0, on: !0, arguments: De(n) }, b),
                  C && C(),
              ...
              Ce(
                {
                  contentId:
                    ...
                    A ? ge.SimpleTooltipHtmlContent("resId") : ge.SimpleTooltipContent("resId")),
        ...
        const Te = (u) => (u.tooltipType, xe(u, we)),
          Me = (u) => {
            let e = u.children,
              t = u.wrap,
              r = xe(u, fe);
            const a = t ? n().createElement("div", null, e) : e;
            return r.tooltipType === Se.Simple
              ? n().createElement(pe, Te(r), a)
              : r.tooltipType === Se.Backport
                ? n().createElement(ve, Te(r), a)
                : ((u) => u.tooltipType === Se.Base)(r)
                  ? n().createElement(de, Te(r), a)
                  : e;
          },
          Re = ({ value: u }) =>
            n().createElement(Wu, {
              className: "Counter_base_49",
              text: R.strings.quests.bonuses.customization.value(),
          ...
          Le = {
            ...
            base__valuable: "Reward_base__valuable_fe",
          ...
          ye = (u) => ({ appear: 1600 + 300 * u, enter: 600 }),
          Pe = ({
            name: u,
            label: e,
            icon: t,
            ...
            const F = p()(Le.base, l && Le[`base__${l}`], c),
              _ = x().mediaSize,
              D =
                E === Se.Base
                  ? {
                  ...
                  : { tooltipType: Se.Backport, args: { tooltipId: a } },
              m = (0, r.useCallback)(() => {
                K("ev_white_tiger_hangar_lootbox_reward_tape_appears_generic");
              }, []),
              d = (u) => p()(F, Le[u]),
              B = (0, r.useMemo)(() => {
                const e = l === oe.Valuable;
                return ((u, e, t, r) => {
                  const n = t ? Ae[r] : le[r],
                    a = (u) =>
                      ((u, e) => ({
                        backgroundImage: `url('R.images.gui.maps.icons.quests.bonuses.${e}.${u}')`,
                      }))(String(u), n);
                  switch (!0) {
                    case u === Ee.PREMIUM_PLUS:
                    case e === Ee.CRYSTAL:
                    case e === Ee.CAMOUFLAGE:
                    case e === Ee.CUSTOMIZATIONS:
                    case e === Ee.GOLD:
                    case e.includes(Ee.MAIN_PRIZE_DISCOUNT):
                      return a(e);
                    case e.includes(Ee.CAMOUFLAGE):
                      return a(Ee.CAMOUFLAGE);
                    case e.includes(Ee.PROJECTION_DECAL):
                      return a(Ee.PROJECTION_DECAL);
                    case e.includes(Ee.INSCRIPTION):
                      return a(Ee.INSCRIPTION);
                    case e.includes(Ee.STYLE):
                      return a(Ee.STYLE);
                    case e.includes(Ee.EMBLEM):
                      return a(Ee.EMBLEM);
                    default:
                      return { backgroundImage: `url('${ie({ name: u, icon: e }, n)}')` };
                  }
                })(u, t, e, _);
              }, [u, t, l, _]);
            return n().createElement(
              Fe.uT,
              { in: !0, appear: !0, timeout: ye(s), onEntered: m },
              (u) =>
                n().createElement(
                  Me,
                  D,
                  n().createElement(
                    ...
                    n().createElement(
                      "div",
                      { className: Le.rewardImage, style: B },
                      o &&
                        n().createElement(Wu, {
                          className: Le.currency,
                          text: Y.Z5.getNumberFormat(i, Y.B3.INTEGRAL),
                        }),
                      i > 1 && A && !o && n().createElement(Re, { value: i }),
                      n().createElement(Wu, { className: Le.rewardText, text: e }),
                    ),
                  ),
                ),
            );
        ...
        const ke = ({ isValuableReward: u, isPostBattle: e, mainRewards: t, classMix: r }) =>
            n().createElement(
              "div",
              { className: p()("MainRewards_base_f3", r) },
              n().createElement(
                "div",
                { className: "MainRewards_content_89" },
                n().createElement(
                  "div",
                  { className: "MainRewards_rewards_0c" },
                  n().createElement(
                    "div",
                    { className: "MainRewards_rewardsList_68" },
                    t.map((t, r) =>
                      n().createElement(
                        Pe,
                        Oe(
                          ...
                          (({
                            ...
                            const i = "wt_boss" === u ? "base" : "backport",
                              s = "premium_plus" !== u,
                              o = u === Ee.CRYSTAL || u === Ee.CREDITS || u === Ee.FREE_XP;
                            return {
                              name: u,
                              label: a,
                              icon: (({ name: u, icon: e, value: t }) =>
                                e || ("premium_plus" === u ? `${u}_${t}` : u))({
                                name: u,
                                icon: t,
                                value: e,
                              }),
                          ...
                          { rewardState: ce(u, e, r), classMix: "MainRewards_reward_5c" },
                        ),
                      ),
                    ),
                  ),
          ...
          const m = (0, r.useRef)(null),
            ...
            k = p()(
              ...
              Ie[`base__${a}`],
              {
                ...
                [Ie.base__firstHover]: w,
              },
              s,
            ),
            I = p()(Ie.state, Ie.state__default);
          return (
            (0, r.useEffect)(
              () => (
            ...
            n().createElement(
              ...
              a !== Ne.ghost &&
                n().createElement(
                  n().Fragment,
                  null,
                  n().createElement("div", { className: Ie.back }),
                  n().createElement("span", { className: Ie.texture }),
                ),
              n().createElement(
                "span",
                { className: I },
                n().createElement("span", { className: Ie.stateDisabled }),
                n().createElement("span", { className: Ie.stateHighlightHover }),
                n().createElement("span", { className: Ie.stateHighlightActive }),
              ),
              n().createElement(
                "span",
        ...
        const Ge = (0, r.memo)(Ue),
          We = R.strings.event.WTEventAwardsView.mainRewards,
          $e = (0, r.memo)(({ onClose: u }) =>
            n().createElement(
              "div",
              { className: "RewardFooter_base_d2" },
              n().createElement(
                "div",
                { className: "RewardFooter_buttonHolder_26" },
                n().createElement(Ge, { size: He.medium, onClick: u }, We.button()),
              ),
            ),
          ),
          Xe = R.strings.event.WTEventAwardsView,
          je = {
            width: 400,
            height: 400,
            frameCount: 50,
            ...
            getChunkPath:
              ...
              (u) => `R.images.gui.maps.icons.sequence.sun_shine_big_sprite.sprite_${u}`),
          };
        const qe = (function (u) {
            const e = u.chunk,
              t = e.rows * e.columns;
          ...
          Ye = (0, j.observer)(() => {
            ...
            !(function ({
              ...
              V(u, e, t);
            })({ callback: () => o.O.view.sendEvent.close() });
            const E = (0, r.useCallback)(() => {
              o.O.view.sendEvent.close();
            }, []);
            return n().createElement(
              "div",
              { className: "App_base_de" },
              n().createElement(tu, { opacity: 0.6 }),
              n().createElement(
                ru,
                null,
                n().createElement(eu, { label: Xe.closeBtn(), onClose: E }),
              ),
              n().createElement("div", { className: "App_lines_99" }),
              n().createElement(
                "div",
                { className: "App_header_92" },
                n().createElement($u, { title: t, status: a }),
              ),
              n().createElement(
                "div",
                ...
                i &&
                  n().createElement(
                    ...
                    n().createElement(iu, {
                      ...
                      getImageSource: qe,
                      frameTime: 50,
                      className: "App_sunShineSequence_5a",
                    }),
                  ),
                n().createElement(ke, {
                  isValuableReward: i,
                  isPostBattle: s,
                  mainRewards: u.computes.getMainRewards(),
                  classMix: "App_mainRewards_56",
                }),
              ),
              n().createElement("div", { className: "App_ribbon_37" }),
              n().createElement($e, { onClose: E }),
            );
          });
        engine.whenReady.then(() => {
          i().render(
            n().createElement($, null, n().createElement(k, null, n().createElement(Ye, null))),
