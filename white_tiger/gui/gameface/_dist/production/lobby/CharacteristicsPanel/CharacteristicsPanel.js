(() => {
      ...
      4655: (u, e, t) => {
        ...
        const S = {
          ...
          y = (u) => {
            ...
            const a = f(),
              ...
              i = a.mediaHeight,
              A = a.mediaSize;
            return n().createElement("div", L({ className: g()(t, S[E], T[i], O[A]) }, r), e);
          },
          H = ["children"],
          P = (u) => {
            let e = u.children,
        ...
        class U extends n().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              l = g()(I.base, I[`base__${E}`], I[`base__${a}`], null == i ? void 0 : i.base),
              B = g()(I.icon, I[`icon__${E}`], I[`icon__${a}`], null == i ? void 0 : i.icon),
              _ = g()(I.glow, null == i ? void 0 : i.glow),
              c = g()(I.caption, I[`caption__${E}`], null == i ? void 0 : i.caption),
            ...
            return n().createElement(
              ...
              "info" !== E && n().createElement("div", { className: I.shine }),
              n().createElement(
                "div",
                { className: B },
        ...
        const K = (u) => (0 === u ? window : window.subViews.get(u)),
          $ = (u) => {
            return (
              (e = u || []),
              (t = (u) => (null !== u && "object" == typeof u ? Object.assign({}, u) : u)),
        ...
        const q = ((u, e) => {
                    ...
                    const a = (function ({
                      ...
                      D = (({ observableModel: u }) => {
                        const e = {
                          ...
                          t = (0, z.computedFn)(() => $(e.pros.get()), { equals: j }),
                          r = (0, z.computedFn)(() => $(e.cons.get()), { equals: j });
                        return Object.assign({}, e, { computes: { getPros: t, getCons: r } });
                      })({
                        mode: u,
                        readByPath: i,
                        externalModel: E,
            ...
            onLeaveClicked: u.createCallbackNoArgs("onLeaveClicked"),
          })),
          Y = q[0],
          Z = q[1];
        var Q = t(9887),
        ...
        const Au = {
          ...
          Du = nu((u) => {
            let e = u.className,
              ...
              M =
                void 0 === f
                  ? (d ? "flex-start" : h && "center") || (p && "flex-end") || void 0
                  : f,
              L = u.alignSelf,
              S = u.wrap,
              T = u.flexWrap,
            ...
            const W = (0, r.useMemo)(() => {
              ...
              }, [t, a, A, o, s, B, k, P, L, m, O, x, M]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return n().createElement(
              "div",
              iu({ className: g()(au.base, ...U, e), style: G }, I),
              N,
            );
          });
        let su;
        ...
        const lu = (u, e, t) => {
          ...
          _u = (u, e, t = su.left) => u.split(e).reduce(t === su.left ? lu : Bu, []),
          cu = (() => {
            const u = new RegExp(
              ...
              vu(
                {
                  ...
                  mb: !0 === l ? Mu[t || "paragraph-P16"].mb : l,
                  ml: !0 === _ ? Mu[t || "paragraph-P16"].ml : _,
                },
                m,
              ),
              void 0 !== C ? n().createElement(mu, vu({}, C, { text: e })) : e,
            );
          }),
          Tu = ({ text: u }) => n().createElement("div", { className: "Features_base_c8" }, u);
        var Ou = t(4179);
        const Ru = [
          "children",
          "contentId",
            ...
            const p = (0, r.useRef)({
              ...
              b = (0, r.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (Hu(t, B, { isMouseEvent: !0, on: !0, arguments: yu(n) }, v),
                  d && d(),
                        ...
                        onMouseEnter:
                          ...
                          (u) => {
                            (u.clientX === window.innerWidth && u.clientY === window.innerHeight) ||
                              ((p.current.timeoutId = window.setTimeout(b, o ? 100 : 400)),
                              a && a(u),
                              f && f(u));
                          }),
                        onMouseLeave: ((u) => (e) => {
          ...
          ku = (0, r.memo)(({ parameter: u, icon: e }) => {
            ...
            return n().createElement(
              ...
              n().createElement(
                ...
                n().createElement("span", { className: "Advantage_text_53" }, a),
              ),
            );
          });
        function Nu() {
        ...
        const Iu = ({ items: u }) =>
            n().createElement(
              n().Fragment,
              null,
              u.map((u, e) => n().createElement(ku, Nu({ key: e }, u))),
            ),
          Wu = "Panel_title_ef",
          Gu = "Panel_separator_f2",
          Uu = "Panel_itemList_cf",
          ju = R.strings.event.characteristicsPanel,
          Xu = ({ pros: u, cons: e, specialInfo: t }) =>
            n().createElement(
              "div",
              { className: "Panel_base_15" },
              n().createElement(Su, { className: Wu, text: ju.pros() }),
              n().createElement("div", { className: Uu }, n().createElement(Iu, { items: u })),
              n().createElement("div", { className: Gu }),
              n().createElement(Su, { className: Wu, text: ju.cons() }),
              n().createElement("div", { className: Uu }, n().createElement(Iu, { items: e })),
              n().createElement("div", { className: Gu }),
              n().createElement(Su, { className: Wu, text: ju.features() }),
              n().createElement("div", { className: Uu }, n().createElement(Tu, { text: t })),
            ),
          Vu = (0, k.observer)(() => {
            const u = Z(),
              e = u.model,
              t = u.controls,
              a = e.root.get().specialInfo,
              E = t.onLeaveClicked,
              i = (0, r.useRef)(null),
            ...
            return (
              ...
              n().createElement(
                ...
                n().createElement(Xu, {
                  pros: e.computes.getPros(),
                  cons: e.computes.getCons(),
                  specialInfo: a,
                }),
              )
            );
        ...
        engine.whenReady.then(() => {
          E().render(
            n().createElement(Y, null, n().createElement(P, null, n().createElement(Vu, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4655));
