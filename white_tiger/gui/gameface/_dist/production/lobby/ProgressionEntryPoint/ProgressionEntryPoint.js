(() => {
  var __webpack_modules__ = {
      ...
      1680: (u, e, t) => {
        ...
        const F = o.O.client.getSize("rem"),
          D = F.width,
          m = F.height,
          _ = Object.assign({ width: D, height: m }, l(D, m, A)),
          B = (0, r.createContext)(_),
          c = ["children"],
          d = (u) => {
            let e = u.children,
              t = (function (u, e) {
        ...
        const C = (0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(B),
            ...
            E = (0, r.useCallback)((u, e) => {
              ...
              i(Object.assign({ width: t, height: r }, l(t, r, A)));
            }, []);
          (((u) => {
          ...
          return n().createElement(B.Provider, { value: s }, u);
        });
        var g = t(6483),
          h = t.n(g),
          p = t(926),
        ...
        const L = {
          ...
          y = (u) => {
            ...
            const a = x(),
              ...
              E = a.mediaHeight,
              o = a.mediaSize;
            return n().createElement("div", M({ className: h()(t, L[i], T[E], O[o]) }, r), e);
          },
          P = ["children"],
          H = (u) => {
            let e = u.children,
          ...
          G = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: a, children: i, mocks: E }) {
                const A = (0, r.useRef)([]),
                  s = (u, t, r) => {
                    ...
                    const a = (function ({
                      ...
                      F = { mode: u, model: l, externalModel: i, cleanup: s };
                    return {
                      model: l,
                ...
                return (
                  (0, r.useEffect)(() => {
                    l.current ? c(s(D, a, E)) : (l.current = !0);
                  }, [E, D, a]),
                  (0, r.useEffect)(() => {
                    m(u);
                  }, [u]),
            ...
            const p = (0, r.useRef)({
              ...
              f = (0, r.useCallback)(() => {
                (p.current.isVisible && p.current.timeoutId) ||
                  (q(t, m, { isMouseEvent: !0, on: !0, arguments: K(n) }, b),
                  C && C(),
        ...
        const J = ["xl", "lg", "md", "sm", "xs"],
          ...
          eu = [f.ExtraLarge, f.Large, f.Medium, f.Small, f.ExtraSmall],
          tu = (u, e) =>
        ...
        const Eu = {
          ...
          su = ru((u) => {
            let e = u.className,
              ...
              B = u.row,
              c = u.flexDirection,
              d = void 0 === c ? (_ ? "column" : B && "row") || void 0 : c,
              C = u.flexStart,
              g = u.center,
              p = u.flexEnd,
              b = u.spaceBetween,
              ...
              L = u.wrap,
              R = u.flexWrap,
              T = void 0 === R ? (L ? "wrap" : void 0) : R,
              O = u.grow,
              y = u.shrink,
              P = u.flex,
              H = void 0 === P ? (O || y ? `${O ? 1 : 0} ${y ? 1 : 0} auto` : void 0) : P,
              k = u.style,
              I = u.children,
              N = (function (u, e) {
                if (null == u) return {};
            ...
            const W = (0, r.useMemo)(() => {
              ...
              }, [t, a, o, s, F, m, k, H, M, d, T, w, S]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return n().createElement(
              "div",
              iu({ className: h()(nu.base, ...U, e), style: G }, N),
              I,
            );
          });
        let lu;
        ...
        const Fu = (u, e, t) => {
          ...
          mu = (u, e, t = lu.left) => u.split(e).reduce(t === lu.left ? Fu : Du, []),
          _u = (() => {
            const u = new RegExp(
          ...
          cu = ({ binding: u, text: e = "", classMix: t, alignment: a = lu.left }) =>
            null === e
        ...
        const bu = Object.keys(Cu()),
          ...
          Mu = ru((u) => {
            ...
            return n().createElement(
              ...
              pu(
                {
                  className: h()(gu.base, t && gu[t], p, a),
                  style: g,
                  mt: !0 === A ? xu[t || "paragraph-P16"].mt : A,
              ...
              void 0 !== c ? n().createElement(cu, pu({}, c, { text: e })) : e,
            );
          }),
          Lu = {
        ...
        const Ou = ({ size: u = Ru.Default, classMix: e }) =>
            n().createElement("div", { className: h()(Lu.background, Lu[`background__${u}`], e) }),
          yu = {
          ...
          ku = (0, r.memo)(
            ({
              ...
              return n().createElement(
                ...
                n().createElement("div", { className: Hu.gradient }),
                o && n().createElement(Pu, { size: u }),
              );
            },
          ),
          Iu = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: i }) => {
        ...
        const Uu = (0, r.memo)(
            ({
              ...
              return _
                ...
                : n().createElement(
                    ...
                    n().createElement(
                      "div",
                      { style: B ? d : C, className: "ProgressBarDeltaSimple_delta_99" },
          ...
          Vu = (0, r.memo)(
            ({
              ...
              const p = (0, r.useMemo)(
                  () => Object.assign({ width: "100%" }, Xu(u), zu(l)),
                  [l, u],
                ),
                b = (0, r.useMemo)(() => Object.assign({ width: "0%" }, Xu(u), zu(l)), [l, u]),
                f = (0, r.useMemo)(
                  () => Object.assign({ width: "0%" }, $u(l, a), Xu(u)),
                  [a, l, u],
                ),
                v = (0, r.useMemo)(
                  () => Object.assign({ width: `${Math.abs(E - a)}%` }, $u(l, a), Xu(u)),
                  [a, l, E, u],
                );
              if (_) return null;
              const w = h()(
              ...
              return n().createElement(
                ...
                n().createElement(
                  "div",
                  { style: d ? b : p, className: "ProgressBarDeltaGrow_glow_68" },
                  n().createElement(Pu, { size: i }),
                ),
              );
            },
        ...
        const Zu = (0, r.memo)((u) => {
            ...
            switch (a.animationSettings.type) {
              case Tu.Simple:
                return n().createElement(ju, Yu({}, a, { onEndAnimation: A, isComplete: E }));
              case Tu.Growing:
                return n().createElement(Ku, Yu({}, a, { onEndAnimation: A, isComplete: E }));
              default:
                return null;
            }
          }),
        ...
        const ue = (0, r.memo)((u) => {
          ...
          return (
            (a.current.from = E),
            n().createElement(Zu, Ju({}, t, { onEndAnimation: i, key: `${E}-${t.to}`, from: E }))
          );
        });
        function ee() {
          return (
        ...
        const te = (0, r.memo)(
            ({
              ...
              return i.withStack
                ...
                : n().createElement(Zu, ee({ key: `${a}-${e}` }, s));
            },
          ),
          re = (u) => ({
          ...
          ie = (u, e, t) => ("number" == typeof t ? (ae(0, e, t) / e) * 100 : u),
          Ee = {
            bgImageBase: "R.images.gui.maps.icons.components.progress_bar.pattern_grey",
            line: {
              bgColorBase: "#f50",
            ...
            ({
              ...
              const _ = ((u, e, t) =>
                (0, r.useMemo)(() => {
                  ...
                  return { value: r, deltaFrom: ie(r, e, t) };
                }, [t, e, u]))(A, u, s);
              return n().createElement(
                "div",
                { className: h()(Lu.base, Lu[`base__${t}`]), style: re(e) },
                !E && n().createElement(Ou, { size: t, classMix: o }),
                n().createElement(te, {
                  size: t,
                  lineRef: l,
                  disabled: i,
          ...
          Fe = (0, z.observer)(() => {
            const u = j(),
              ...
              t = u.controls,
              a = e.root.get(),
              i = a.currentProgression,
              E = a.totalProgression,
              A = i === E,
              s = x().mediaSize;
            (0, r.useEffect)(
              () =>
                ((u) => {
                  ...
                  return (
                    (t = requestAnimationFrame(() => {
                      t = requestAnimationFrame(() => {
                        ((t = null),
                          (e = void o.O.view.setSidePaddingsRem({
                            left: le[s],
                            right: le[s],
                            top: 0,
                            bottom: se[s],
            ...
            const l = h()("App_base_17", A && "App_base__allCollected_e0");
            return n().createElement(
              Y,
              {
              ...
              n().createElement(
                "div",
                {
                  className: l,
                  onMouseEnter: () => {
                    $("ev_white_tiger_hangar_collection_rollover");
                  },
                  onMouseLeave: () => {
                    $("ev_white_tiger_hangar_collection_rollout");
                  },
                  onClick: t.click,
                },
                n().createElement(
                  "div",
                  { className: "App_bgWrapper_df" },
                  n().createElement("div", { className: "App_bg_d6" }),
                  n().createElement("div", { className: "App_bgHover_bf" }),
                ),
                !A &&
                  n().createElement(
                    "div",
                    { className: "App_progressWrapper_29" },
                    n().createElement(Mu, {
                      className: "App_progressValue_f3",
                      text: String(i + 1),
                    }),
                    n().createElement(
                      "div",
                      { className: "App_progressBarWrapper_7a" },
                      n().createElement(Ae, { size: Ru.Default, value: i, maxValue: E, theme: ne }),
                    ),
                  ),
              ),
            );
        ...
        engine.whenReady.then(() => {
          i().render(
            n().createElement(U, null, n().createElement(H, null, n().createElement(Fe, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(1680));
