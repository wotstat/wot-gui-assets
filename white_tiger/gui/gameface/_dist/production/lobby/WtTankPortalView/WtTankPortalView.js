(() => {
  var __webpack_modules__ = {
      ...
      2715: (u, e, t) => {
        ...
        const A = s.O.client.getSize("rem"),
          _ = A.width,
          F = A.height,
          D = Object.assign({ width: _, height: F }, c(_, F, l)),
          ...
          B = (u) => {
            ...
            if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
              ...
              if (t.extraLargeWidth && c) return i(e, t, p);
              if (t.largeWidth && A) return i(e, t, p);
              if (t.mediumWidth && _) return i(e, t, p);
              if (t.smallWidth && F) return i(e, t, p);
              if (t.extraSmallWidth && D) return i(e, t, p);
              if (!(
                t.extraLargeWidth ||
                t.largeWidth ||
                t.mediumWidth ||
        ...
        const C = (0, n.memo)(({ children: u }) => {
          const e = (0, n.useContext)(d),
            ...
            i = (0, n.useCallback)((u, e) => {
              ...
              o(Object.assign({ width: t, height: n }, c(t, n, l)));
            }, []);
          (((u) => {
        ...
        const S = {
          ...
          y = (u) => {
            ...
            const r = w(),
              ...
              i = r.mediaHeight,
              s = r.mediaSize;
            return a().createElement("div", M({ className: g()(t, S[o], T[i], k[s]) }, n), e);
          },
          O = ["children"],
          P = (u) => {
            let e = u.children,
        ...
        const W = (u) => (0 === u ? window : window.subViews.get(u)),
          G = ((u, e) => {
            ...
            return [
              function ({ mode: u = "real", options: r, children: o, mocks: i }) {
                const l = (0, n.useRef)([]),
                      ...
                      c = (({ observableModel: u }) => {
                        ...
                        observableModel: {
                          ...
                          primitives: (e, t) => {
                            ...
                            if (Array.isArray(e)) {
                              const a = e.reduce(
                                (u, e) => ((u[e] = H.observable.box(n[e], {})), u),
                                {},
                              );
                              return (
                                "real" === u &&
                            ...
                            }
                            {
                              const a = e,
                                r = Object.entries(a),
                                i = r.reduce(
                                  (u, [e, t]) => ((u[t] = H.observable.box(n[e], {})), u),
                                  {},
                                );
                              return (
                                "real" === u &&
                  ...
                  _ = A[0],
                  F = A[1],
                  D = (0, n.useState)(() => E(u, r, i)),
                  d = D[0],
                  m = D[1];
                return (
                  (0, n.useEffect)(() => {
                    c.current ? m(E(_, r, i)) : (c.current = !0);
                  }, [i, _, r]),
                  (0, n.useEffect)(() => {
                    F(u);
                  }, [u]),
            ...
            previewTank: u.createCallbackNoArgs("onPreviewTank"),
            runPortal: u.createCallbackNoArgs("onRunPortal"),
          })),
          U = G[0],
          V = G[1];
        var j = t(3282),
        ...
        const Z = ["xl", "lg", "md", "sm", "xs"],
          ...
          J = [v.ExtraLarge, v.Large, v.Medium, v.Small, v.ExtraSmall],
          uu = (u, e) =>
            Object.keys(u).reduce((t, n) => {
              ...
              return (
                void 0 === a ||
                  ((u, e) => Z.some((t) => void 0 !== e[`${u}_${t}`]))(n, u) ||
                  (t[n] = a),
                t
              );
            }, {}),
        ...
        const ru = {
          ...
          su = eu((u) => {
            ...
            const W = (0, n.useMemo)(() => {
                const u = { mt: s, mr: E, mb: A, ml: F },
                  e = ((u) =>
                    ou.reduce((e, t) => {
                      const n = u[t];
                      return n && "number" != typeof n ? e.concat(ru[!0 === n ? "MD" : n][t]) : e;
                    }, []))(u),
                  n = ((u) =>
                    ou.reduce((e, t) => {
                      const n = u[t];
                      return ("number" == typeof n && (e[iu[t]] = n + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [t, r, s, E, A, F, N, P, M, B, k, f, L]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return a().createElement(
              "div",
              au({ className: g()(tu.base, ...U, e), style: G }, I),
              H,
            );
          });
        let lu;
        ...
        const Eu = (u, e, t) => {
          ...
          Au = (u, e, t = lu.left) => u.split(e).reduce(t === lu.left ? Eu : cu, []),
          _u = (() => {
            const u = new RegExp(
          ...
          Du = ({ binding: u, text: e = "", classMix: t, alignment: r = lu.left }) =>
            null === e
        ...
        const gu = Object.keys(mu()),
          ...
          wu = eu((u) => {
            ...
            return a().createElement(
              ...
              hu(
                {
                  className: g()(Bu.base, t && Bu[t], b, r),
                  style: h,
                  mt: !0 === l ? xu[t || "paragraph-P16"].mt : l,
                  mr: !0 === c ? xu[t || "paragraph-P16"].mr : c,
                  mb: !0 === _ ? xu[t || "paragraph-P16"].mb : _,
                  ml: !0 === D ? xu[t || "paragraph-P16"].ml : D,
                },
                B,
              ),
              void 0 !== m ? a().createElement(Du, hu({}, m, { text: e })) : e,
            );
          });
        function Lu(u) {
        ...
        const yu = (0, n.memo)((u) => {
            ...
            const v = (0, n.useState)(!1),
              ...
              R = (0, n.useCallback)(
                (u) => {
                  T && null !== y.current && !y.current.contains(u.target) && k(!1);
                },
                [T],
              );
            ((0, n.useEffect)(
            ...
            const P = (0, n.useCallback)(
              ...
              V = g()(
                ...
                x && Mu.base__mouseDown,
                L && Mu.base__hovered,
                T && Mu.base__focused,
                null == F ? void 0 : F.base,
              ),
              j = g()(Mu.icon, Mu[`icon__${_}`], null == F ? void 0 : F.icon),
              X = g()(Mu.label, null == F ? void 0 : F.label);
            return a().createElement(
              "div",
              Tu(
                {
          ...
          Ou = (0, n.createContext)({
            discountTokenCount: 0,
            discountPerToken: 0,
            maxDiscountTokenCount: 0,
          }),
          Ru = [
            "children",
            "contentId",
            ...
            const b = (0, n.useRef)({
              ...
              v = (0, n.useCallback)(() => {
                (b.current.isVisible && b.current.timeoutId) ||
                  (Nu(t, F, { isMouseEvent: !0, on: !0, arguments: Pu(a) }, p),
                  C && C(),
              ...
              f = (0, n.useCallback)((u) => {
                b.current.isVisible &&
                  ...
                  (b.current.hideTimerId = window.setTimeout(() => {
                    ...
                    e && !e.isSameNode(b.current.prevTarget) && x();
                  }, 200)));
              }, []);
            return (
              (0, n.useEffect)(() => {
        ...
        const qu = (u) => (u.tooltipType, zu(u, $u)),
          Zu = (u) => {
            let e = u.children,
              t = u.wrap,
              n = zu(u, Ku);
            const r = t ? a().createElement("div", null, e) : e;
            return n.tooltipType === Yu.Simple
              ? a().createElement(Uu, qu(n), r)
              : n.tooltipType === Yu.Backport
                ? a().createElement(Xu, qu(n), r)
                : ((u) => u.tooltipType === Yu.Base)(n)
                  ? a().createElement(Hu, qu(n), r)
                  : e;
          },
          Qu = R.strings.event.WtEventPortals,
          Ju = ({ onClick: u, isViewActive: e = !0 }) => {
            const t = w().mediaSize >= v.Medium,
              r = (0, n.useRef)(null),
              o = (0, n.useRef)(null),
              i = { tooltipType: Yu.Simple, body: Qu.buyButtonTooltip() };
            return a().createElement(
              Zu,
              i,
              a().createElement(
                ...
                a().createElement("div", { className: "BuyButton_image_9e", ref: r }),
        ...
        class ne extends a().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              _ = g()(ue.base, ue[`base__${o}`], ue[`base__${r}`], null == i ? void 0 : i.base),
              F = g()(ue.icon, ue[`icon__${o}`], ue[`icon__${r}`], null == i ? void 0 : i.icon),
              D = g()(ue.glow, null == i ? void 0 : i.glow),
              d = g()(ue.caption, ue[`caption__${o}`], null == i ? void 0 : i.caption),
              m = g()(ue.goto, null == i ? void 0 : i.goto);
            return a().createElement(
              "div",
              te(
                {
              ...
              "info" !== o && a().createElement("div", { className: ue.shine }),
              a().createElement(
                "div",
                { className: F },
        ...
        const ae = ({ onClose: u, label: e, classMix: t }) =>
            a().createElement(
              "div",
              { className: g()("CloseButton_base_1c", t) },
              a().createElement(ne, {
          ...
          ie = R.strings.wt_portals.disabled,
          se = ({ animationDelayStepsCount: u = 1 }) => {
          ...
          const d = (0, n.useRef)(null),
            ...
            P = g()(
              ...
              le[`base__${r}`],
              {
                ...
                [le[`base__${e}`]]: e,
                [le.base__focus]: B,
                [le.base__highlightActive]: b,
                [le.base__firstHover]: x,
              },
              i,
            ),
        ...
        (!(function (u) {
          ...
          Fe.BOSS_2025,
          Fe.BOSS_SPECIAL);
        const de = { Hunter: De.HUNTER, Boss: De.BOSS, Tank: De.TANK },
          me = R.strings.event.WtEventPortals.inside,
          Be = ({ type: u, lootBoxesCount: e, mixClass: t }) => {
            const n = u === de.Hunter,
              r = g()("LootBoxesCount_base_37", n && "LootBoxesCount_base__hunter_e3", t),
              o = {
                number: a().createElement(
                  Hu,
                  {
                    contentId: R.views.white_tiger.lobby.tooltips.LootBoxTooltipView("resId"),
                    args: { isHunterLootBox: n },
                  },
                  a().createElement(
                    "div",
            ...
            return 0 === e
              ? a().createElement(wu, { className: r, text: me.currentKeysAmountIs0[u]() })
              : a().createElement(wu, {
                  className: r,
                  text: me.currentKeysAmount[u](),
                  format: { binding: o },
                });
          },
          Ce = {
          ...
          he = R.strings.wt_portals.insidePortal,
          ge = (0, n.memo)(
            ({
              isControlsDisabled: u,
              onPriceChange: e,
              count: t,
              activePrice: n,
              keyTooltipArgs: r,
              ...
              const c = 5 === t,
                ...
                D = F
                  ? a().createElement(wu, {
                      className: g()(Ce.runPrice, Ce.runPriceAll),
                      text: he.allPossible(),
                    })
                  : a().createElement(wu, {
                      className: Ce.runPrice,
                      text: he.count(),
                      format: {
                        binding: {
                          multi: a().createElement(wu, {
                            className: Ce.runPriceMulti,
                            text: he.countMulti(),
                          }),
                          count: a().createElement(wu, {
                            className: Ce.runPriceValue,
                            text: t.toString(),
                          }),
                        },
                      },
                ...
                d = i
                  ? a().createElement(
                      ...
                      s &&
                        a().createElement(wu, {
                          className: Ce.oldPrice,
                          text: null == s ? void 0 : s.toString(),
                        }),
                      a().createElement(wu, {
                        className: Ce.runPriceLabel,
                        text: null == t ? void 0 : t.toString(),
                      }),
                      a().createElement("div", {
                        className: g()(Ce.priceValue, Ce.priceValueBoss),
                      }),
                    )
                  : a().createElement(
                      a().Fragment,
                      ...
                      a().createElement("div", { className: Ce.priceValue }),
                    );
              return l
                ? a().createElement(
                    Hu,
                    ...
                    a().createElement(
                      ...
                      a().createElement(
                        ...
                        D,
                        !F && a().createElement("div", { className: Ce.priceValue }),
                      ),
                    ),
                  )
                : a().createElement(
                    ...
                    a().createElement("div", { className: _ }, d),
                  );
            },
          ),
          be = R.strings.wt_portals.insideVehiclePortal,
          pe = ({ vehiclePrice: u, discount: e, lootBoxesCount: t, onGetVehicleClick: n }) => {
            const r = Math.round(u * (1 - e / 100)),
              o = r > t;
            return a().createElement(
              "div",
              { className: "Footer_base_fe" },
              a().createElement(
                "div",
                { className: "Footer_controlsSection_73" },
                a().createElement(
                  "div",
                  { className: "Footer_priceContainer_d2" },
                  a().createElement(ge, {
                    keyTooltipArgs: { isHunterLootBox: !1 },
                    lootBoxesCount: t,
                    isControlsDisabled: o,
                    discount: e,
                    oldPrice: u,
                    isTankPortal: !0,
                    count: r,
                ...
                a().createElement(
                  _e,
                  {
                    ...
                    size: ce.medium,
                    onClick: n,
                    mixClass: "Footer_getVehicleButton_4e",
                    disabled: o,
                    soundClick: "ev_white_tiger_hangar_lootbox_portals_launch",
                  },
                  be.buttonGetTank(),
                ),
                a().createElement(Be, { type: de.Boss, lootBoxesCount: t }),
              ),
            );
          },
          ...
          we = R.strings.menu.roleExp,
          Le = ({ name: u, level: e, type: t, role: n, nation: r }) => {
            const o = {
                backgroundImage: `url(${R.images.gui.maps.icons.flags.c_600x450.$dyn(r)})`,
              },
              i = {
            ...
            var s;
            const l = {
              backgroundImage: `url(${R.images.gui.maps.icons.roleExp.roles.c_24x24.$dyn(n)})`,
            };
            return a().createElement(
              "div",
              { className: "Vehicle_base_ce" },
              a().createElement("div", { className: "Vehicle_flag_1b", style: o }),
              a().createElement(
                "div",
                { className: "Vehicle_vehicle_98" },
                a().createElement(wu, {
                  className: "Vehicle_level_ee",
                  text:
                    ((E = e),
                    fe
                      ? `${E}`
                      : (function (u) {
                          ...
                          for (let t = xe.length - 1; t >= 0; t--)
                            for (; u >= xe[t];) ((e += ve[t]), (u -= xe[t]));
                          return e;
                        })(E)),
                }),
                a().createElement("div", { className: "Vehicle_type_9d", style: i }),
                a().createElement(wu, { className: "Vehicle_name_54", text: u }),
              ),
              "NotDefined" !== n &&
                a().createElement(
                  Hu,
                  ...
                  a().createElement(
                    "div",
                    { className: "Vehicle_role_9b" },
                    a().createElement("div", { className: "Vehicle_roleIcon_7a", style: l }),
                    a().createElement(wu, {
                      className: "Vehicle_roleText_7a",
                      text: we.roleName.$dyn(n),
                      format: { binding: { groupName: we.roleGroupName.$dyn(n) } },
                    }),
                  ),
                ),
            );
        ...
        const Se = {
                  ...
                  a().createElement(
                    ...
                    a().createElement("div", {
                      className: g()(
                        Se.discount,
                        Se["discount__" + u],
                        o < u && Se.discount__disabled,
                        o === u && Se.discount__active,
                      ),
                    }),
                  ),
                ),
          ...
          ke = R.strings.wt_portals.insideVehiclePortal.discount,
          ye = {
            [v.ExtraSmall]: Me.x48,
            [v.Small]: Me.x48,
            [v.Medium]: Me.x64,
          ...
          Oe = () => {
            const u = w().mediaSize,
              e = (0, n.useContext)(Ou),
              t = e.discountTokenCount,
              r = e.discountPerToken,
              o = e.maxDiscountTokenCount;
            return a().createElement(
              "div",
              { className: "Discount_base_22" },
              a().createElement(
                "div",
                { className: "Discount_titleContainer_ef" },
                a().createElement(wu, { text: ke.title(), className: "Discount_discountTitle_c0" }),
                a().createElement(
                  Uu,
                  { body: ke.tooltip() },
                  a().createElement("div", { className: "Discount_info_7b" }),
                ),
              ),
              a().createElement(Te, {
                discountTokenCount: t,
                discountPerToken: r,
                maxDiscountTokenCount: o,
                size: ye[u],
                className: "Discount_discountTickets_a3",
              }),
            );
          },
          Re = R.strings.wt_portals.insideVehiclePortal,
          Pe = ({ tankName: u, tankNation: e, tankLevel: t, tankType: r, tankRoleName: o }) => {
            const i = (0, n.useContext)(Ou),
              s = i.discountTokenCount * i.discountPerToken;
            return a().createElement(
              "div",
              { className: "TankPortal_base_6c" },
              a().createElement(Le, { name: u, level: t, type: r, role: o, nation: e }),
              Boolean(s) &&
                a().createElement(
                  "div",
                  { className: "TankPortal_discountContainer_59" },
                  a().createElement("div", { className: "TankPortal_discountBg_da" }),
                  a().createElement(wu, {
                    text: Re.redDiscount(),
                    className: "TankPortal_discount_16",
                    format: { binding: { discount: s } },
                  }),
                ),
              a().createElement(
                "div",
                { className: "TankPortal_footer_97" },
                a().createElement(wu, {
                  text: Re.description(),
                  className: "TankPortal_description_0a",
                }),
                a().createElement(Oe, null),
              ),
            );
          },
          Ne = R.strings.wt_portals,
          He = (0, j.observer)(() => {
            const u = V(),
              e = u.model,
              t = u.controls,
              ...
              l = r.mainPrize,
              E = r.portalRun,
              c = l.discountTokenCount,
              A = l.discountPerToken,
              _ = l.maxDiscountTokenCount,
              F = c * A,
              D = () => {
            ...
            const d = (0, n.useMemo)(
              () => ({ discountTokenCount: c, discountPerToken: A, maxDiscountTokenCount: _ }),
              [c, A, _],
            );
            return a().createElement(
              Ou.Provider,
              ...
              a().createElement(
                "div",
                { className: "App_base_dd" },
                a().createElement("div", { className: "App_bg_b1" }),
                a().createElement(wu, { text: Ne.title.tank(), className: "App_title_d5" }),
                a().createElement(
                  "div",
                  { className: "App_tankPortalWrapper_5b" },
                  a().createElement(
                    "div",
                    { className: "App_tankPortal_61" },
                    a().createElement(Pe, {
                      tankName: l.tankName,
                      tankNation: l.tankNation,
                      tankLevel: l.tankLevel,
                      tankType: l.tankType,
                      tankRoleName: l.tankRoleName,
                    }),
                  ),
                ),
                a().createElement(
                  ...
                  a().createElement(re, { onClick: t.goBack, goto: i }),
                  a().createElement(ae, { onClose: D }),
                  o && a().createElement(Ju, { onClick: t.buyLootBoxes }),
                ),
                o
                  ? a().createElement(pe, {
                      vehiclePrice: E.attemptPrice,
                      discount: F,
                      lootBoxesCount: E.lootBoxesCount,
                      onGetVehicleClick: t.runPortal,
                    })
                  : a().createElement(
                      "div",
                      { className: "App_errorHint_3f" },
                      a().createElement(se, null),
                    ),
                a().createElement(
                  "div",
                  { className: "App_preview_40" },
                  a().createElement(yu, { onClick: t.previewTank }),
                ),
              ),
            );
          });
        engine.whenReady.then(() => {
          o().render(
            a().createElement(U, null, a().createElement(P, null, a().createElement(He, null))),
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(2715));
