(() => {
  var __webpack_modules__ = {
      ...
      1358: (u, e, t) => {
        ...
        class r {
          ...
          addCallback(u, e, t = 0, r = !0) {
            ...
            const E = a.O.view.addModelObserver(u, t, r);
            return (
              E > 0
                ? ((this._callbacks[E] = e),
      ...
      4179: (u, e, t) => {
        ...
        const b = r.instance,
          w = {
            ...
            sendShowPopOverEvent: (u, e, t, a, r = R.invalid("resId"), E) => {
      ...
      4120: (u, e, t) => {
          ...
          h = (0, a.memo)(({ children: u }) => {
            const e = (0, a.useContext)(c),
              ...
              i = (0, a.useCallback)((u, e) => {
                ...
                n(Object.assign({ width: t, height: a }, D(t, a, F)));
              }, []);
            (d(() => {
              engine.on("clientResized", i);
            }),
              (0, a.useEffect)(() => () => engine.off("clientResized", i), [i]));
            const o = (0, a.useMemo)(() => Object.assign({}, E), [E]);
        ...
        const T = {
          ...
          H = (u) => {
            ...
            const E = S(),
              ...
              i = E.mediaHeight,
              A = E.mediaSize;
            return r().createElement("div", L({ className: p()(t, T[n], O[i], y[A]) }, a), e);
          },
          k = ["children"],
          P = (u) => {
            let e = u.children,
            ...
            return (
              d(() => {
                if (
                          ...
                          const e = $(),
                            ...
                            r =
                              window.__feature && window.__feature !== t && t
                                ? `subViews.${t}`
                                : "";
                          return { modelPrefix: r, modelPath: K(r, ""), resId: a };
                        })(),
                        t = e.modelPrefix,
                        a = u.split(".");
                      if (a.length > 0) {
                  ...
                  s.current = V.addCallback(a, t, i, e === z.Deep);
                }
              }),
              (0, a.useEffect)(() => {
                if (e !== z.None)
                  return () => {
                    V.removeCallback(s.current, i);
                  };
              }, [i, e]),
              o
            );
          ...
          const c = (0, a.useRef)(null),
            ...
            k = p()(
              ...
              q[`base__${E}`],
              {
                ...
                [q[`base__${e}`]]: e,
                [q.base__focus]: m,
                [q.base__highlightActive]: g,
                [q.base__firstHover]: w,
              },
              i,
            ),
            P = p()(q.state, q.state__default);
          return (
            (0, a.useEffect)(
              () => (
        ...
        class ru extends r().PureComponent {
          ...
          render() {
            const u = this.props,
              ...
              l = p()(eu.base, eu[`base__${n}`], eu[`base__${E}`], null == i ? void 0 : i.base),
              _ = p()(eu.icon, eu[`icon__${n}`], eu[`icon__${E}`], null == i ? void 0 : i.icon),
              B = p()(eu.glow, null == i ? void 0 : i.glow),
              c = p()(eu.caption, eu[`caption__${n}`], null == i ? void 0 : i.caption),
              C = p()(eu.goto, null == i ? void 0 : i.goto);
            return r().createElement(
              ...
              "info" !== n && r().createElement("div", { className: eu.shine }),
              r().createElement(
                "div",
                { className: _ },
        ...
        const iu = ["xl", "lg", "md", "sm", "xs"],
          Au = (u) => u.includes("_") && ((u) => iu.includes(u))(u.split("_").at(-1)),
          Fu = [w.ExtraLarge, w.Large, w.Medium, w.Small, w.ExtraSmall],
          ou = (u, e) =>
        ...
        const Bu = {
          ...
          mu = Du((u) => {
            let e = u.className,
              ...
              S =
                void 0 === x
                  ? (d ? "flex-start" : h && "center") || (g && "flex-end") || void 0
                  : x,
              M = u.alignSelf,
              L = u.wrap,
              T = u.flexWrap,
            ...
            const W = (0, a.useMemo)(() => {
                const u = { mt: A, mr: o, mb: s, ml: _ },
                  ...
                  a = ((u) =>
                    cu.reduce((e, t) => {
                      const a = u[t];
                      return ("number" == typeof a && (e[Cu[t]] = a + "rem"), e);
                    }, {}))(u);
                return {
              ...
              }, [t, E, A, o, s, _, P, k, M, m, R, f, S]),
              G = W.computedStyle,
              U = W.computedClassNames;
            return r().createElement(
              "div",
              _u({ className: p()(su.base, ...U, e), style: G }, I),
              N,
            );
          });
        let du;
        ...
        const hu = (u, e, t) => {
          ...
          pu = (u, e, t = du.left) => u.split(e).reduce(t === du.left ? hu : gu, []),
          vu = (() => {
            const u = new RegExp(
          ...
          wu = ({ binding: u, text: e = "", classMix: t, alignment: E = du.left }) =>
            null === e
        ...
        const Tu = Object.keys(xu()),
          ...
          Pu = Du((u) => {
            ...
            return r().createElement(
              ...
              Lu(
                {
                  className: p()(Su.base, t && Su[t], g, E),
                  style: h,
                  mt: !0 === F ? Hu[t || "paragraph-P16"].mt : F,
                  mr: !0 === D ? Hu[t || "paragraph-P16"].mr : D,
                  mb: !0 === l ? Hu[t || "paragraph-P16"].mb : l,
                  ml: !0 === B ? Hu[t || "paragraph-P16"].ml : B,
                },
                m,
              ),
              void 0 !== C ? r().createElement(wu, Lu({}, C, { text: e })) : e,
            );
          }),
          Nu = "DescriptionBlock_description_58",
          Iu = (u) => ({
            __html: u.replace(/{newlineStart}/g, "<div>").replace(/{newlineEnd}/g, "</div>"),
          }),
          Wu = ({ title: u, description: e }) => {
            const t = e.includes("\n");
            return r().createElement(
              "div",
              { className: "DescriptionBlock_base_28" },
              r().createElement("span", { className: "DescriptionBlock_title_61" }, u),
              t
                ? r().createElement("div", { className: Nu }, r().createElement(wu, { text: e }))
                : r().createElement("div", { className: Nu, dangerouslySetInnerHTML: Iu(e) }),
            );
          },
          Gu = (u) =>
            new Promise((e, t) => {
              const a = new Image();
              ((a.src = u), a.addEventListener("load", e), a.addEventListener("error", t));
            }),
          Uu = {
            base: "App_base_12",
            base__forward: "App_base__forward_51",
            fadeTop: "App_fadeTop_03",
            fadeBot: "App_fadeBot_3a",
            base__backward: "App_base__backward_ea",
            base__out: "App_base__out_30",
            fadeOut: "App_fadeOut_8d",
            divider: "App_divider_5b",
            content: "App_content_4b",
            topContainer: "App_topContainer_c0",
            title: "App_title_de",
            videoContainer: "App_videoContainer_7a",
            video: "App_video_46",
            bottomContainer: "App_bottomContainer_5b",
            close: "App_close_31",
            more: "App_more_fd",
            cButton: "App_cButton_cd",
            exit: "App_exit_95",
            slideUp: "App_slideUp_b9",
            fadeIn: "App_fadeIn_f1",
            fadeInScale: "App_fadeInScale_a8",
            fadeInWithScale: "App_fadeInWithScale_ee",
            scale: "App_scale_34",
            raysAppearance: "App_raysAppearance_26",
            rotate: "App_rotate_5d",
          },
          $u = R.strings.event.WTEventWelcomeView.welcome,
          ju = () => {
            const u = Y("model"),
              e = u.onVideo,
              t = u.onClose,
              ...
              D = F[1],
              s = (0, a.useRef)(!1),
              l = (0, a.useRef)({ animationDirection: 0, videoClick: 0 }),
              _ = ((u) => {
                const e = (0, a.useState)("pending"),
                  t = e[0],
                  r = e[1];
                return (
                  (0, a.useEffect)(() => {
                ...
                "R.images.white_tiger.gui.maps.icons.welcome.youtube_button_small",
                "R.images.white_tiger.gui.maps.icons.welcome.youtube_button",
              ]),
              B = p()(Uu.topContainer, Uu.fadeTop),
              c = p()(Uu.bottomContainer, Uu.fadeBot),
              C = p()(Uu.base, o && Uu.base__out, i && Uu[`base__${i}`]),
              m = p()(Uu.close, Uu.fadeBot),
              d = (0, a.useCallback)(() => {
                (U("play"),
                  A("forward"),
                  (l.current.videoClick = window.setTimeout(() => {
                    (e(), (l.current.animationDirection = window.setTimeout(() => A(null), 500)));
                  }, 500)));
              }, [e]),
              h = (0, a.useCallback)(() => U("highlight"), []),
              g = (0, a.useCallback)(() => {
                (t(), D(!0));
              }, [t]);
            var v;
            return (
              ...
              (0, a.useEffect)(() => {
                (!E &&
                  s.current &&
                  (A("backward"),
                  (l.current.animationDirection = window.setTimeout(() => A(null), 500))),
                  (s.current = E));
              }, [E]),
              "done" === _
                ? r().createElement(
                    ...
                    r().createElement(
                      "div",
                      { className: B },
                      r().createElement("span", { className: Uu.title }, $u.title()),
                    ),
                    r().createElement(
                      "div",
                      { onClick: d, onMouseEnter: h, className: Uu.videoContainer },
                      r().createElement("div", { className: Uu.video }),
                      r().createElement(Pu, { className: Uu.more, text: $u.more() }),
                    ),
                    r().createElement(
                      "div",
                      { className: c },
                      r().createElement(
                        ...
                        r().createElement(Wu, {
                          title: $u.collection_title(),
                          description: $u.collection_text(),
                        }),
                        r().createElement("div", { className: Uu.divider }),
                        r().createElement(Wu, {
                          title: $u.asymmetry_title(),
                          description: $u.asymmetry_text(),
                        }),
                        r().createElement("div", { className: Uu.divider }),
                        r().createElement(Wu, {
                          title: $u.wt_welcome_title(),
                          description: $u.wt_welcome_text(),
                        }),
                      ),
                    ),
                    r().createElement(
                      ...
                      r().createElement(
                        uu,
                        { type: Z.primary, size: Q.medium, mixClass: Uu.cButton, onClick: g },
                        $u.confirm_btn(),
                      ),
                    ),
                  )
        ...
        engine.whenReady.then(() => {
          n().render(
            r().createElement(P, null, r().createElement(ju, null)),
    ...
    (__webpack_require__.O = (u, e, t, a) => {
      if (!e) {
        ...
        for (A = 0; A < deferred.length; A++) {
          for (var [e, t, a] = deferred[A], E = !0, n = 0; n < e.length; n++)
            (!1 & a || r >= a) &&
  ...
  var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(4120));
