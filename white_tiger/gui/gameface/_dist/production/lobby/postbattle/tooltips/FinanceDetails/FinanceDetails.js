(() => {
  ...
  var __webpack_modules__ = {
      ...
      4579: (u, e, t) => {
        ...
        const s = i().forwardRef(function (u, e) {
            let t = u.children,
              n = u.className,
              a = u.theme,
            ...
            return (
              ...
              i().createElement(
                "div",
                _({}, s, {
                  className: E()(A.base, A[`base__theme-${o}`], n),
                  ref: function (u) {
        ...
        (0, r.memo)(({ children: u }) => {
          const e = (0, r.useContext)(p),
            ...
            o = (0, r.useCallback)((u, e) => {
              ...
              a(Object.assign({ width: t, height: r }, B(t, r, D)));
            }, []);
          (((u) => {
          ...
          return i().createElement(p.Provider, { value: E }, u);
        });
        var b = t(4179);
        ...
        const k = {
          ...
          N = ({
            ...
            const l = E()(k.value, k[`value__${r}`], !n && k.value__notEnough),
              _ = E()(k.icon, k[`icon__${r}-${t}`]),
              s = E()(k.stock, o && k.stock__indent, e && k.stock__interactive),
              c = F && a > 0 && "+",
              D = E()(k.base, k[`base__${t}`]);
            return i().createElement(
              ...
              i().createElement(
                ...
                { className: l },
                c,
                i().createElement(f, { value: a, format: r === O.gold ? "gold" : "integral" }),
              ),
        ...
        const M = i().memo(N),
          ...
          H = ({
            ...
            const D = (function (u, e, t) {
                const i = (0, r.useContext)(p);
                let n = Object.entries(i).filter(([u, e]) => !0 === e && u in C);
              ...
              i().createElement(
                ...
                F &&
                  i().createElement(
                    ...
                    { className: W.factor },
                    "(",
                    i().createElement("span", { className: W.factorText }, F),
                    ")",
                  ),
              ),
              i().createElement("div", { className: W.separator }),
              g.map((u, e) => {
                const t = e > 0,
                  r = t && !u,
                  n = E()(W.wrapper, t && W.wrapper__double),
                  o = E()(W.value, ((u && 0 === u.amount) || a) && W.value__zero);
                if (r)
                  return i().createElement(
                    "div",
                    { key: e, className: n },
                ...
                if (u) {
                  ...
                  return i().createElement(
                    "div",
                    { key: a, className: n },
                    t && i().createElement("div", { className: W.separator }),
                    i().createElement(
                      "div",
                      { className: o },
                      i().createElement(M, {
                        ...
                        size: m,
                        showPlus: _,
                        type: ((F = u.type), ((u) => u in O)(F) ? F : O.credits),
                        value: u.amount,
                      }),
                    ),
                  );
          ...
          U = ({ currencyType: u, accountType: e, records: t }) => {
            const n = 0 === e,
              a = 1 === e,
              o = 2 === e,
              F = R.strings.postbattle_screen.tooltip.financeDetails,
              A = F.title.$dyn(u),
              l = n ? F.accountType.premiumPlus() : F.accountType.premiumNone(),
              _ = E()(I.titleIcon, I[`titleIcon__${u}`]),
              s = E()(I.accountTitle, a || o ? I.accountTitle__noPremium : I.accountTitle__premium),
            ...
            return i().createElement(
              ...
              i().createElement(
                ...
                i().createElement("div", { className: I.titleText }, A),
              ),
              t.map(({ value: e }, t) => {
                const r = e.stringID,
                  F = e.currencies,
                ...
                return i().createElement(
                  ...
                  D &&
                    i().createElement(
                      i().Fragment,
                      null,
                      i().createElement("div", { className: I.footerLip }),
                      n && i().createElement("div", { className: I.footerIconPremium }),
                      i().createElement("div", { className: s }, l),
                    ),
                  m && i().createElement("div", { className: h }),
                  i().createElement(H, {
                    text: String(r),
                    currency: B,
        ...
        function z() {
          const u = i().createElement(s, null, i().createElement(U, window.model));
          a().render(u, q);
        }
    ...
    (__webpack_require__.O = (u, e, t, r) => {
      if (!e) {
        ...
        for (E = 0; E < deferred.length; E++) {
          for (var [e, t, r] = deferred[E], n = !0, a = 0; a < e.length; a++)
            (!1 & r || i >= r) &&
    ...
    (() => {
      ...
      var e = (e, t) => {
          ...
          for (e && e(t); E < n.length; E++)
            ((i = n[E]), __webpack_require__.o(u, i) && u[i] && u[i][0](), (u[i] = 0));
