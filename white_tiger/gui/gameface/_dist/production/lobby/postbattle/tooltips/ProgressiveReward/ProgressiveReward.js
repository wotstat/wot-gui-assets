  ...
  var u,
    e = {
      3778: (u, e, F) => {
        ...
        const Eu = () => B().createElement("div", { className: "Separator_base_53" }),
          nu = {
        ...
        const tu = ({
            holderStyle: u = Du.DEFAULT,
            separatorTop: e = !1,
            separatorBottom: F = !1,
            className: A,
            children: E,
          }) => {
            const n = u === Du.DEFAULT;
            return B().createElement(
              "div",
              { className: i()(nu.base, !n && nu[`base__${u}`], A) },
              e && B().createElement(Eu, null),
              B().createElement("div", { className: nu.content }, E),
              F && B().createElement(Eu, null),
            );
          },
          Bu = {
        ...
        var ou, ru, Cu;
        function iu(u, e, F) {
          return i()(Bu.icon, Bu[`icon__${u}`], Bu[`icon__${e}`], F && Bu.icon__active);
        }
        (!(function (u) {
        ...
        const au = ({ maxSteps: u, currentStep: e, currentStepState: F }) => {
            const A = [];
            for (let E = 0; E < u; ++E) {
              const n = E === u - 1 ? Cu.BIG : Cu.NORMAL;
              let D,
                t = !1,
                o = "";
              (E < e
                ...
                : E > e
                  ? (D = ou.NOT_RECEIVED)
                  : ((t = !0),
                    (D = "received" === F ? ru.OPENED : ru.NOT_OPENED),
                    "prob_min" !== F && (o = Bu[`bgGlow__${Au(F)}`])),
                A.push(
                  B().createElement(
                    "div",
                    { className: Bu.reward, key: E },
                    B().createElement("div", { className: i()(Bu.bgGlow, o) }),
                    B().createElement("div", { className: iu(n, D, t) }),
                  ),
                ));
            }
            return B().createElement("div", { className: Bu.base }, A);
          },
          su = {
          ...
          cu = R.strings.tooltips.progressiveReward.widget,
          lu = ({ currentStepState: u, currentStep: e, maxSteps: F }) => {
            const A = i()(su.lock, su[`lock__${Au(u)}`]);
            return B().createElement(
              "div",
              { className: su.base },
              B().createElement(
                ...
                B().createElement(
                  ...
                  B().createElement(
                    ...
                    B().createElement("div", { className: su.title }, cu.header()),
                    B().createElement(
                      "div",
                      { className: su.progressionStatus },
                      B().createElement(au, { currentStep: e, maxSteps: F, currentStepState: u }),
                    ),
                  ),
                ),
              ),
              B().createElement(
                tu,
                { holderStyle: Du.PRIMARY },
                B().createElement("div", { className: su.description }, cu.body()),
              ),
            );
          },
          du = document.createElement("div");
        function vu() {
          const u = B().createElement(eu, null, B().createElement(lu, window.model));
          r().render(u, du);
        }
        ((window.onload = () => document.body.appendChild(du)),
          engine._BindingsReady && engine._WindowLoaded ? vu() : engine.on("Ready", vu));
      },
    },
    F = {};
  function A(u) {
  ...
  ((A.m = e),
    ...
    (() => {
      ...
      var e = (e, F) => {
          ...
          for (e && e(F); o < D.length; o++)
            ((n = D[o]), A.o(u, n) && u[n] && u[n][0](), (u[n] = 0));
          return A.O(r);
        },
